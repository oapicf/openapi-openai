...
public class CreateChatCompletionResponse {
   ...
   **/
  @ApiModelProperty(value = "The service tier used for processing the request. This field is only included if the `service_tier` parameter is specified in the request.")
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? createChatCompletionResponse.id == null : this.id.equals(createChatCompletionResponse.id)) &&
        ...
        (this.serviceTier == null ? createChatCompletionResponse.serviceTier == null : this.serviceTier.equals(createChatCompletionResponse.serviceTier)) &&
