...
public class CreateFineTuningJobRequest {
   ...
   **/
  @ApiModelProperty(required = true, value = "The ID of an uploaded file that contains training data.  See [upload file](/docs/api-reference/files/create) for how to upload a file.  Your dataset must be formatted as a JSONL file. Additionally, you must upload your file with the purpose `fine-tune`.  The contents of the file should differ depending on if the model uses the [chat](/docs/api-reference/fine-tuning/chat-input), [completions](/docs/api-reference/fine-tuning/completions-input) format, or if the fine-tuning method uses the [preference](/docs/api-reference/fine-tuning/preference-input) format.  See the [fine-tuning guide](/docs/guides/fine-tuning) for more details. ")
  ...
  public boolean equals(Object o) {
    ...
    return (this.model == null ? createFineTuningJobRequest.model == null : this.model.equals(createFineTuningJobRequest.model)) &&
        ...
        (this.method == null ? createFineTuningJobRequest.method == null : this.method.equals(createFineTuningJobRequest.method));
  }
