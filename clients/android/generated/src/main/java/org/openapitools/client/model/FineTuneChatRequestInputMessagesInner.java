...
public class FineTuneChatRequestInputMessagesInner {
  ...
  public boolean equals(Object o) {
    ...
    return (this.content == null ? fineTuneChatRequestInputMessagesInner.content == null : this.content.equals(fineTuneChatRequestInputMessagesInner.content)) &&
        (this.role == null ? fineTuneChatRequestInputMessagesInner.role == null : this.role.equals(fineTuneChatRequestInputMessagesInner.role)) &&
        (this.name == null ? fineTuneChatRequestInputMessagesInner.name == null : this.name.equals(fineTuneChatRequestInputMessagesInner.name)) &&
        (this.weight == null ? fineTuneChatRequestInputMessagesInner.weight == null : this.weight.equals(fineTuneChatRequestInputMessagesInner.weight)) &&
        (this.refusal == null ? fineTuneChatRequestInputMessagesInner.refusal == null : this.refusal.equals(fineTuneChatRequestInputMessagesInner.refusal)) &&
        (this.audio == null ? fineTuneChatRequestInputMessagesInner.audio == null : this.audio.equals(fineTuneChatRequestInputMessagesInner.audio)) &&
        (this.toolCalls == null ? fineTuneChatRequestInputMessagesInner.toolCalls == null : this.toolCalls.equals(fineTuneChatRequestInputMessagesInner.toolCalls)) &&
        (this.functionCall == null ? fineTuneChatRequestInputMessagesInner.functionCall == null : this.functionCall.equals(fineTuneChatRequestInputMessagesInner.functionCall)) &&
        (this.toolCallId == null ? fineTuneChatRequestInputMessagesInner.toolCallId == null : this.toolCallId.equals(fineTuneChatRequestInputMessagesInner.toolCallId));
  }
