...
public class MessageDeltaContentTextAnnotationsFileCitationObject {
  ...
  public boolean equals(Object o) {
    ...
    return (this.index == null ? messageDeltaContentTextAnnotationsFileCitationObject.index == null : this.index.equals(messageDeltaContentTextAnnotationsFileCitationObject.index)) &&
        (this.type == null ? messageDeltaContentTextAnnotationsFileCitationObject.type == null : this.type.equals(messageDeltaContentTextAnnotationsFileCitationObject.type)) &&
        (this.text == null ? messageDeltaContentTextAnnotationsFileCitationObject.text == null : this.text.equals(messageDeltaContentTextAnnotationsFileCitationObject.text)) &&
        (this.fileCitation == null ? messageDeltaContentTextAnnotationsFileCitationObject.fileCitation == null : this.fileCitation.equals(messageDeltaContentTextAnnotationsFileCitationObject.fileCitation)) &&
        (this.startIndex == null ? messageDeltaContentTextAnnotationsFileCitationObject.startIndex == null : this.startIndex.equals(messageDeltaContentTextAnnotationsFileCitationObject.startIndex)) &&
        (this.endIndex == null ? messageDeltaContentTextAnnotationsFileCitationObject.endIndex == null : this.endIndex.equals(messageDeltaContentTextAnnotationsFileCitationObject.endIndex));
  }
