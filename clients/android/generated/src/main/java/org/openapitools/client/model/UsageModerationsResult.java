...
public class UsageModerationsResult {
  ...
  public boolean equals(Object o) {
    ...
    return (this._object == null ? usageModerationsResult._object == null : this._object.equals(usageModerationsResult._object)) &&
        (this.inputTokens == null ? usageModerationsResult.inputTokens == null : this.inputTokens.equals(usageModerationsResult.inputTokens)) &&
        (this.numModelRequests == null ? usageModerationsResult.numModelRequests == null : this.numModelRequests.equals(usageModerationsResult.numModelRequests)) &&
        (this.projectId == null ? usageModerationsResult.projectId == null : this.projectId.equals(usageModerationsResult.projectId)) &&
        (this.userId == null ? usageModerationsResult.userId == null : this.userId.equals(usageModerationsResult.userId)) &&
        (this.apiKeyId == null ? usageModerationsResult.apiKeyId == null : this.apiKeyId.equals(usageModerationsResult.apiKeyId)) &&
        (this.model == null ? usageModerationsResult.model == null : this.model.equals(usageModerationsResult.model));
  }
