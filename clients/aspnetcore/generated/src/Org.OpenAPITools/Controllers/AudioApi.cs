...
{ 
    ...
    { 
        ...
        public virtual IActionResult CreateTranslation([Required()]IFormFile file, [FromForm][Required()]CreateTranscriptionRequestModel model, [FromForm (Name = "prompt")]string prompt, [FromForm (Name = "response_format")]AudioResponseFormat? responseFormat, [FromForm (Name = "temperature")]decimal? temperature)
        {
