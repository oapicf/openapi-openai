        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("2.3.0", new OpenApiInfo
                    {
                        Title = "OpenAI API",
                        Description = "OpenAI API (ASP.NET Core 8.0)",
                        TermsOfService = new Uri("https://openai.com/policies/terms-of-use"),
                        Contact = new OpenApiContact
                        {
                            Name = "Cliffano Subagio",
                            Url = new Uri("https://github.com/oapicf/openapi-openai"),
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/2.3.0/openapi.json", "OpenAI API");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "OpenAI API Original");
                });
            app.UseRouting();
