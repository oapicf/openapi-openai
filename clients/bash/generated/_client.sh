  ...
  args)
    case $line[1] in
      cancelFineTune)
        ...
        _op_arguments=(
          "fine_tune_id=:[PATH] The ID of the fine-tune job to cancel"
                    )
      ...
      listFineTuneEvents)
        local -a _op_arguments
        _op_arguments=(
          "fine_tune_id=:[PATH] The ID of the fine-tune job to get events for."
          "stream=true:[QUERY] Whether to stream events for the fine-tune job. If set to true,
...
If set to false, only events generated so far will be returned."
          "stream=false:[QUERY] Whether to stream events for the fine-tune job. If set to true,
events will be sent as data-only
[server-sent events](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events#Event_stream_format)
as they become available. The stream will terminate with a
&#39;data: [DONE]&#39; message when the job is finished (succeeded, cancelled,
...
If set to false, only events generated so far will be returned."
      ...
      retrieveFineTune)
        local -a _op_arguments
        _op_arguments=(
          "fine_tune_id=:[PATH] The ID of the fine-tune job"
                    )
        _describe -t actions 'operations' _op_arguments -S '' && ret=0
        ;;
      retrieveModel)
