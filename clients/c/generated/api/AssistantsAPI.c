...
AssistantsAPI_cancelRun(apiClient_t *apiClient, char *thread_id, char *run_id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/runs/{run_id}/cancel")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/runs/{run_id}/cancel");


    // Path Params
    long sizeOfPathParams_thread_id = strlen(thread_id)+3 + strlen(run_id)+3 + strlen("{ thread_id }");
    if(thread_id == NULL) {
        goto end;
    }
    ...
    // Path Params
    long sizeOfPathParams_run_id = strlen(thread_id)+3 + strlen(run_id)+3 + strlen("{ run_id }");
    if(run_id == NULL) {
        goto end;
    }
    ...
    run_object_t *elementToReturn = run_object_parseFromJSON(AssistantsAPIlocalVarJSON);
...
AssistantsAPI_createAssistant(apiClient_t *apiClient, create_assistant_request_t *create_assistant_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/assistants")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/assistants");
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    assistant_object_t *elementToReturn = assistant_object_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_createAssistantFile(apiClient_t *apiClient, char *assistant_id, create_assistant_file_request_t *create_assistant_file_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/assistants/{assistant_id}/files")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/assistants/{assistant_id}/files");


    // Path Params
    long sizeOfPathParams_assistant_id = strlen(assistant_id)+3 + strlen("{ assistant_id }");
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    assistant_file_object_t *elementToReturn = assistant_file_object_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_createMessage(apiClient_t *apiClient, char *thread_id, create_message_request_t *create_message_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/messages")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/messages");


    // Path Params
    long sizeOfPathParams_thread_id = strlen(thread_id)+3 + strlen("{ thread_id }");
    if(thread_id == NULL) {
        goto end;
    }
    char* localVarToReplace_thread_id = malloc(sizeOfPathParams_thread_id);
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    message_object_t *elementToReturn = message_object_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_createRun(apiClient_t *apiClient, char *thread_id, create_run_request_t *create_run_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/runs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/runs");
...
AssistantsAPI_createThread(apiClient_t *apiClient, create_thread_request_t *create_thread_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads");
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    thread_object_t *elementToReturn = thread_object_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_createThreadAndRun(apiClient_t *apiClient, create_thread_and_run_request_t *create_thread_and_run_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/runs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/runs");
...
AssistantsAPI_deleteAssistant(apiClient_t *apiClient, char *assistant_id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/assistants/{assistant_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/assistants/{assistant_id}");
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    delete_assistant_response_t *elementToReturn = delete_assistant_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_deleteAssistantFile(apiClient_t *apiClient, char *assistant_id, char *file_id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/assistants/{assistant_id}/files/{file_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/assistants/{assistant_id}/files/{file_id}");


    // Path Params
    long sizeOfPathParams_assistant_id = strlen(assistant_id)+3 + strlen(file_id)+3 + strlen("{ assistant_id }");
    if(assistant_id == NULL) {
        goto end;
    }
    char* localVarToReplace_assistant_id = malloc(sizeOfPathParams_assistant_id);
    ...
    // Path Params
    long sizeOfPathParams_file_id = strlen(assistant_id)+3 + strlen(file_id)+3 + strlen("{ file_id }");
    if(file_id == NULL) {
        goto end;
    }
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    delete_assistant_file_response_t *elementToReturn = delete_assistant_file_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_deleteThread(apiClient_t *apiClient, char *thread_id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}");
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    delete_thread_response_t *elementToReturn = delete_thread_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_getMessage(apiClient_t *apiClient, char *thread_id, char *message_id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/messages/{message_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/messages/{message_id}");


    // Path Params
    long sizeOfPathParams_thread_id = strlen(thread_id)+3 + strlen(message_id)+3 + strlen("{ thread_id }");
    if(thread_id == NULL) {
        goto end;
    }
    char* localVarToReplace_thread_id = malloc(sizeOfPathParams_thread_id);
    ...
    // Path Params
    long sizeOfPathParams_message_id = strlen(thread_id)+3 + strlen(message_id)+3 + strlen("{ message_id }");
    if(message_id == NULL) {
        goto end;
    }
...
AssistantsAPI_getMessageFile(apiClient_t *apiClient, char *thread_id, char *message_id, char *file_id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/messages/{message_id}/files/{file_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/messages/{message_id}/files/{file_id}");


    // Path Params
    long sizeOfPathParams_thread_id = strlen(thread_id)+3 + strlen(message_id)+3 + strlen(file_id)+3 + strlen("{ thread_id }");
    if(thread_id == NULL) {
        goto end;
    }
    char* localVarToReplace_thread_id = malloc(sizeOfPathParams_thread_id);
    ...
    // Path Params
    long sizeOfPathParams_message_id = strlen(thread_id)+3 + strlen(message_id)+3 + strlen(file_id)+3 + strlen("{ message_id }");
    if(message_id == NULL) {
        goto end;
    }
    char* localVarToReplace_message_id = malloc(sizeOfPathParams_message_id);
    ...
    // Path Params
    long sizeOfPathParams_file_id = strlen(thread_id)+3 + strlen(message_id)+3 + strlen(file_id)+3 + strlen("{ file_id }");
    if(file_id == NULL) {
        goto end;
    }
    char* localVarToReplace_file_id = malloc(sizeOfPathParams_file_id);
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    message_file_object_t *elementToReturn = message_file_object_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_getRun(apiClient_t *apiClient, char *thread_id, char *run_id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/runs/{run_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/runs/{run_id}");
...
AssistantsAPI_getRunStep(apiClient_t *apiClient, char *thread_id, char *run_id, char *step_id)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/runs/{run_id}/steps/{step_id}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/runs/{run_id}/steps/{step_id}");


    // Path Params
    long sizeOfPathParams_thread_id = strlen(thread_id)+3 + strlen(run_id)+3 + strlen(step_id)+3 + strlen("{ thread_id }");
    if(thread_id == NULL) {
        goto end;
    }
    char* localVarToReplace_thread_id = malloc(sizeOfPathParams_thread_id);
    ...
    // Path Params
    long sizeOfPathParams_run_id = strlen(thread_id)+3 + strlen(run_id)+3 + strlen(step_id)+3 + strlen("{ run_id }");
    if(run_id == NULL) {
        goto end;
    }
    char* localVarToReplace_run_id = malloc(sizeOfPathParams_run_id);
    ...
    // Path Params
    long sizeOfPathParams_step_id = strlen(thread_id)+3 + strlen(run_id)+3 + strlen(step_id)+3 + strlen("{ step_id }");
    if(step_id == NULL) {
        goto end;
    }
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    run_step_object_t *elementToReturn = run_step_object_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_listAssistantFiles(apiClient_t *apiClient, char *assistant_id, int *limit, openai_api_listAssistantFiles_order_e order, char *after, char *before)
{
    ...
    if (order)
    {
        ...
        keyPairQuery_order = keyValuePair_create(keyQuery_order, (void *)strdup(listAssistantFiles_ORDER_ToString(
        valueQuery_order)));
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    list_assistant_files_response_t *elementToReturn = list_assistant_files_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_listAssistants(apiClient_t *apiClient, int *limit, openai_api_listAssistants_order_e order, char *after, char *before)
{
    ...
    if (order)
    {
        keyQuery_order = strdup("order");
        valueQuery_order = (order);
        keyPairQuery_order = keyValuePair_create(keyQuery_order, (void *)strdup(listAssistants_ORDER_ToString(
        valueQuery_order)));
        list_addElement(localVarQueryParameters,keyPairQuery_order);
    }
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    list_assistants_response_t *elementToReturn = list_assistants_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_listMessageFiles(apiClient_t *apiClient, char *thread_id, char *message_id, int *limit, openai_api_listMessageFiles_order_e order, char *after, char *before)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/messages/{message_id}/files")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/messages/{message_id}/files");
    ...
    if (order)
    {
        keyQuery_order = strdup("order");
        valueQuery_order = (order);
        keyPairQuery_order = keyValuePair_create(keyQuery_order, (void *)strdup(listMessageFiles_ORDER_ToString(
        valueQuery_order)));
        list_addElement(localVarQueryParameters,keyPairQuery_order);
    }
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    list_message_files_response_t *elementToReturn = list_message_files_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_listMessages(apiClient_t *apiClient, char *thread_id, int *limit, openai_api_listMessages_order_e order, char *after, char *before, char *run_id)
{
    ...
    if (order)
    {
        keyQuery_order = strdup("order");
        valueQuery_order = (order);
        keyPairQuery_order = keyValuePair_create(keyQuery_order, (void *)strdup(listMessages_ORDER_ToString(
        valueQuery_order)));
        list_addElement(localVarQueryParameters,keyPairQuery_order);
    }
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    list_messages_response_t *elementToReturn = list_messages_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_listRunSteps(apiClient_t *apiClient, char *thread_id, char *run_id, int *limit, openai_api_listRunSteps_order_e order, char *after, char *before)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/runs/{run_id}/steps")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/runs/{run_id}/steps");
    ...
    if (order)
    {
        keyQuery_order = strdup("order");
        valueQuery_order = (order);
        keyPairQuery_order = keyValuePair_create(keyQuery_order, (void *)strdup(listRunSteps_ORDER_ToString(
        valueQuery_order)));
        list_addElement(localVarQueryParameters,keyPairQuery_order);
    }
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    list_run_steps_response_t *elementToReturn = list_run_steps_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_listRuns(apiClient_t *apiClient, char *thread_id, int *limit, openai_api_listRuns_order_e order, char *after, char *before)
{
    ...
    if (order)
    {
        keyQuery_order = strdup("order");
        valueQuery_order = (order);
        keyPairQuery_order = keyValuePair_create(keyQuery_order, (void *)strdup(listRuns_ORDER_ToString(
        valueQuery_order)));
        list_addElement(localVarQueryParameters,keyPairQuery_order);
    }
    ...
    //nonprimitive not container
    cJSON *AssistantsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    list_runs_response_t *elementToReturn = list_runs_response_parseFromJSON(AssistantsAPIlocalVarJSON);
    cJSON_Delete(AssistantsAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AssistantsAPI_submitToolOuputsToRun(apiClient_t *apiClient, char *thread_id, char *run_id, submit_tool_outputs_run_request_t *submit_tool_outputs_run_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/threads/{thread_id}/runs/{run_id}/submit_tool_outputs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/threads/{thread_id}/runs/{run_id}/submit_tool_outputs");
