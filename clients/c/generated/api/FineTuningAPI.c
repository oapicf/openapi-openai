...
FineTuningAPI_cancelFineTuningJob(apiClient_t *apiClient, char *fine_tuning_job_id)
{
    ...
    // create the path
    char *localVarPath = strdup("/fine_tuning/jobs/{fine_tuning_job_id}/cancel");
    ...
    // Path Params
    long sizeOfPathParams_fine_tuning_job_id = strlen(fine_tuning_job_id)+3 + sizeof("{ fine_tuning_job_id }") - 1;
    ...
    fine_tuning_job_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *FineTuningAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = fine_tuning_job_parseFromJSON(FineTuningAPIlocalVarJSON);
...
FineTuningAPI_createFineTuningJob(apiClient_t *apiClient, create_fine_tuning_job_request_t *create_fine_tuning_job_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/fine_tuning/jobs");
...
FineTuningAPI_listFineTuningEvents(apiClient_t *apiClient, char *fine_tuning_job_id, char *after, int *limit)
{
    ...
    // create the path
    char *localVarPath = strdup("/fine_tuning/jobs/{fine_tuning_job_id}/events");
    ...
    //}
    //nonprimitive not container
    list_fine_tuning_job_events_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *FineTuningAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = list_fine_tuning_job_events_response_parseFromJSON(FineTuningAPIlocalVarJSON);
        cJSON_Delete(FineTuningAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
FineTuningAPI_listFineTuningJobCheckpoints(apiClient_t *apiClient, char *fine_tuning_job_id, char *after, int *limit)
{
    ...
    // create the path
    char *localVarPath = strdup("/fine_tuning/jobs/{fine_tuning_job_id}/checkpoints");
    ...
    //}
    //nonprimitive not container
    list_fine_tuning_job_checkpoints_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *FineTuningAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = list_fine_tuning_job_checkpoints_response_parseFromJSON(FineTuningAPIlocalVarJSON);
        cJSON_Delete(FineTuningAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
FineTuningAPI_listPaginatedFineTuningJobs(apiClient_t *apiClient, char *after, int *limit)
{
    ...
    //}
    //nonprimitive not container
    list_paginated_fine_tuning_jobs_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *FineTuningAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = list_paginated_fine_tuning_jobs_response_parseFromJSON(FineTuningAPIlocalVarJSON);
        cJSON_Delete(FineTuningAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
FineTuningAPI_retrieveFineTuningJob(apiClient_t *apiClient, char *fine_tuning_job_id)
{
    ...
    // create the path
    char *localVarPath = strdup("/fine_tuning/jobs/{fine_tuning_job_id}");
