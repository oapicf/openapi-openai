...
------------ | ------------- | ------------- | -------------
**id** | **char \*** |  | 
**object** | **openai_api_batch_OBJECT_e** | The object type, which is always &#x60;batch&#x60;. | 
**endpoint** | **char \*** | The OpenAI API endpoint used by the batch. | 
**errors** | [**batch_errors_t**](batch_errors.md) \* |  | [optional] 
**input_file_id** | **char \*** | The ID of the input file for the batch. | 
**completion_window** | **char \*** | The time frame within which the batch should be processed. | 
**status** | **openai_api_batch_STATUS_e** | The current status of the batch. | 
**output_file_id** | **char \*** | The ID of the file containing the outputs of successfully executed requests. | [optional] 
**error_file_id** | **char \*** | The ID of the file containing the outputs of requests with errors. | [optional] 
...
**request_counts** | [**batch_request_counts_t**](batch_request_counts.md) \* |  | [optional] 
