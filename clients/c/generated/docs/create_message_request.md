...
**content** | [**create_message_request_content_t**](create_message_request_content.md) \* |  | 
**attachments** | [**list_t**](create_message_request_attachments_inner.md) \* | A list of files attached to the message, and the tools they should be added to. | [optional] 
