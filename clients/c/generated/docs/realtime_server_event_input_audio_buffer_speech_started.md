...
**type** | **openai_api_realtime_server_event_input_audio_buffer_speech_started_TYPE_e** | The event type, must be &#x60;input_audio_buffer.speech_started&#x60;. | 
...
**item_id** | **char \*** | The ID of the user message item that will be created when speech stops.  | 
