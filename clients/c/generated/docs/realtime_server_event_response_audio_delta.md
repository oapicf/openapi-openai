...
**type** | **openai_api_realtime_server_event_response_audio_delta_TYPE_e** | The event type, must be &#x60;response.audio.delta&#x60;. | 
...
**delta** | **char \*** | Base64-encoded audio data delta. | 
