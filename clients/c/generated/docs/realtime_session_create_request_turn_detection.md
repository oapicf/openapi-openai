...
------------ | ------------- | ------------- | -------------
**type** | **char \*** | Type of turn detection, only &#x60;server_vad&#x60; is currently supported.  | [optional] 
...
**create_response** | **int** | Whether or not to automatically generate a response when VAD is enabled. &#x60;true&#x60; by default.  | [optional] [default to true]
