...
cJSON *assistant_file_object_convertToJSON(assistant_file_object_t *assistant_file_object) {
    ...
    if(cJSON_AddStringToObject(item, "object", objectassistant_file_object_ToString(assistant_file_object->object)) == NULL)
    {
    goto fail; //Enum
    }
...
assistant_file_object_t *assistant_file_object_parseFromJSON(cJSON *assistant_file_objectJSON){
    ...
    assistant_file_object_local_var = assistant_file_object_create (
