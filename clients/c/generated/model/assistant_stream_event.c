...
assistant_stream_event_t *assistant_stream_event_create(
...
cJSON *assistant_stream_event_convertToJSON(assistant_stream_event_t *assistant_stream_event) {
    ...
    if(cJSON_AddStringToObject(item, "event", eventassistant_stream_event_ToString(assistant_stream_event->event)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if(cJSON_AddStringToObject(item, "data", dataassistant_stream_event_ToString(assistant_stream_event->data)) == NULL)
    {
    goto fail; //Enum
    }
...
assistant_stream_event_t *assistant_stream_event_parseFromJSON(cJSON *assistant_stream_eventJSON){
    ...
    assistant_stream_event_local_var = assistant_stream_event_create (
        eventVariable,
        dataVariable
        );
