...
static assistant_tools_function_t *assistant_tools_function_create_internal(
    ...
    assistant_tools_function_local_var->_library_owned = 1;
...
__attribute__((deprecated)) assistant_tools_function_t *assistant_tools_function_create(
    ...
    return assistant_tools_function_create_internal (
        type,
        function
        );
}
...
void assistant_tools_function_free(assistant_tools_function_t *assistant_tools_function) {
    ...
    if(assistant_tools_function->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "assistant_tools_function_free");
        return ;
    }
...
cJSON *assistant_tools_function_convertToJSON(assistant_tools_function_t *assistant_tools_function) {
    ...
    if(cJSON_AddStringToObject(item, "type", assistant_tools_function_type_ToString(assistant_tools_function->type)) == NULL)
    {
    goto fail; //Enum
    }
...
assistant_tools_function_t *assistant_tools_function_parseFromJSON(cJSON *assistant_tools_functionJSON){
    ...
    assistant_tools_function_local_var = assistant_tools_function_create_internal (
        typeVariable,
