...
static assistant_tools_retrieval_t *assistant_tools_retrieval_create_internal(
    ...
    assistant_tools_retrieval_local_var->_library_owned = 1;
    return assistant_tools_retrieval_local_var;
}

__attribute__((deprecated)) assistant_tools_retrieval_t *assistant_tools_retrieval_create(
    openai_api_assistant_tools_retrieval_TYPE_e type
    ) {
    return assistant_tools_retrieval_create_internal (
        type
        );
}
...
void assistant_tools_retrieval_free(assistant_tools_retrieval_t *assistant_tools_retrieval) {
    ...
    if(assistant_tools_retrieval->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "assistant_tools_retrieval_free");
        return ;
    }
...
cJSON *assistant_tools_retrieval_convertToJSON(assistant_tools_retrieval_t *assistant_tools_retrieval) {
    ...
    if(cJSON_AddStringToObject(item, "type", assistant_tools_retrieval_type_ToString(assistant_tools_retrieval->type)) == NULL)
    {
    goto fail; //Enum
    }
...
assistant_tools_retrieval_t *assistant_tools_retrieval_parseFromJSON(cJSON *assistant_tools_retrievalJSON){
    ...
    assistant_tools_retrieval_local_var = assistant_tools_retrieval_create_internal (
        typeVariable
        );
