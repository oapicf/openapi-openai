...
static assistants_api_named_tool_choice_t *assistants_api_named_tool_choice_create_internal(
    ...
    assistants_api_named_tool_choice_local_var->_library_owned = 1;
    return assistants_api_named_tool_choice_local_var;
}

__attribute__((deprecated)) assistants_api_named_tool_choice_t *assistants_api_named_tool_choice_create(
    openai_api_assistants_api_named_tool_choice_TYPE_e type,
    chat_completion_named_tool_choice_function_t *function
    ) {
    return assistants_api_named_tool_choice_create_internal (
        type,
        function
        );
}
...
void assistants_api_named_tool_choice_free(assistants_api_named_tool_choice_t *assistants_api_named_tool_choice) {
    ...
    if(assistants_api_named_tool_choice->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "assistants_api_named_tool_choice_free");
        return ;
    }
...
cJSON *assistants_api_named_tool_choice_convertToJSON(assistants_api_named_tool_choice_t *assistants_api_named_tool_choice) {
    ...
    if(cJSON_AddStringToObject(item, "type", assistants_api_named_tool_choice_type_ToString(assistants_api_named_tool_choice->type)) == NULL)
    {
    goto fail; //Enum
    }
...
assistants_api_named_tool_choice_t *assistants_api_named_tool_choice_parseFromJSON(cJSON *assistants_api_named_tool_choiceJSON){
    ...
    assistants_api_named_tool_choice_local_var = assistants_api_named_tool_choice_create_internal (
        typeVariable,
