...
static assistants_api_response_format_t *assistants_api_response_format_create_internal(
    ...
    assistants_api_response_format_local_var->_library_owned = 1;
    return assistants_api_response_format_local_var;
}

__attribute__((deprecated)) assistants_api_response_format_t *assistants_api_response_format_create(
    openai_api_assistants_api_response_format_TYPE_e type
    ) {
    return assistants_api_response_format_create_internal (
        type
        );
}
...
void assistants_api_response_format_free(assistants_api_response_format_t *assistants_api_response_format) {
    ...
    if(assistants_api_response_format->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "assistants_api_response_format_free");
        return ;
    }
...
cJSON *assistants_api_response_format_convertToJSON(assistants_api_response_format_t *assistants_api_response_format) {
    ...
    if(cJSON_AddStringToObject(item, "type", assistants_api_response_format_type_ToString(assistants_api_response_format->type)) == NULL)
    {
    goto fail; //Enum
    }
    }
...
assistants_api_response_format_t *assistants_api_response_format_parseFromJSON(cJSON *assistants_api_response_formatJSON){
    ...
    assistants_api_response_format_local_var = assistants_api_response_format_create_internal (
