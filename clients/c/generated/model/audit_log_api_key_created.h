/*
 * audit_log_api_key_created.h
 *
 * The details for events with this &#x60;type&#x60;.
 */

#ifndef _audit_log_api_key_created_H_
#define _audit_log_api_key_created_H_
...
typedef struct audit_log_api_key_created_t audit_log_api_key_created_t;

#include "audit_log_api_key_created_data.h"



typedef struct audit_log_api_key_created_t {
    char *id; // string
    struct audit_log_api_key_created_data_t *data; //model

    int _library_owned; // Is the library responsible for freeing this object?
} audit_log_api_key_created_t;
...
#endif /* _audit_log_api_key_created_H_ */
