/*
 * audit_log_project_updated_changes_requested.h
 *
 * The payload used to update the project.
 */

#ifndef _audit_log_project_updated_changes_requested_H_
#define _audit_log_project_updated_changes_requested_H_
...
typedef struct audit_log_project_updated_changes_requested_t audit_log_project_updated_changes_requested_t;




typedef struct audit_log_project_updated_changes_requested_t {
    char *title; // string

    int _library_owned; // Is the library responsible for freeing this object?
} audit_log_project_updated_changes_requested_t;
...
#endif /* _audit_log_project_updated_changes_requested_H_ */
