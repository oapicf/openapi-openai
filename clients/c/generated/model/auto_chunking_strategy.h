...
#ifndef _auto_chunking_strategy_H_
#define _auto_chunking_strategy_H_
...
typedef struct auto_chunking_strategy_t auto_chunking_strategy_t;


// Enum TYPE for auto_chunking_strategy

typedef enum  { openai_api_auto_chunking_strategy_TYPE_NULL = 0, openai_api_auto_chunking_strategy_TYPE__auto } openai_api_auto_chunking_strategy_TYPE_e;
...
typedef struct auto_chunking_strategy_t {
    openai_api_auto_chunking_strategy_TYPE_e type; //enum

    int _library_owned; // Is the library responsible for freeing this object?
} auto_chunking_strategy_t;
...
#endif /* _auto_chunking_strategy_H_ */
