...
chat_completion_request_assistant_message_t *chat_completion_request_assistant_message_create(
    char *content,
...
void chat_completion_request_assistant_message_free(chat_completion_request_assistant_message_t *chat_completion_request_assistant_message) {
    ...
    if (chat_completion_request_assistant_message->content) {
        free(chat_completion_request_assistant_message->content);
...
cJSON *chat_completion_request_assistant_message_convertToJSON(chat_completion_request_assistant_message_t *chat_completion_request_assistant_message) {
    ...
    if(chat_completion_request_assistant_message->content) {
    if(cJSON_AddStringToObject(item, "content", chat_completion_request_assistant_message->content) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(cJSON_AddStringToObject(item, "role", rolechat_completion_request_assistant_message_ToString(chat_completion_request_assistant_message->role)) == NULL)
    {
    goto fail; //Enum
    }
...
chat_completion_request_assistant_message_t *chat_completion_request_assistant_message_parseFromJSON(cJSON *chat_completion_request_assistant_messageJSON){
    ...
    chat_completion_request_assistant_message_local_var = chat_completion_request_assistant_message_create (
