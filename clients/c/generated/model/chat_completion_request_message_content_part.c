...
static chat_completion_request_message_content_part_t *chat_completion_request_message_content_part_create_internal(
    ...
    chat_completion_request_message_content_part_local_var->_library_owned = 1;
    return chat_completion_request_message_content_part_local_var;
}

__attribute__((deprecated)) chat_completion_request_message_content_part_t *chat_completion_request_message_content_part_create(
    openai_api_chat_completion_request_message_content_part_TYPE_e type,
    char *text,
    chat_completion_request_message_content_part_image_image_url_t *image_url
    ) {
    return chat_completion_request_message_content_part_create_internal (
        type,
        text,
        image_url
        );
...
void chat_completion_request_message_content_part_free(chat_completion_request_message_content_part_t *chat_completion_request_message_content_part) {
    ...
    if(chat_completion_request_message_content_part->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "chat_completion_request_message_content_part_free");
        return ;
    }
...
cJSON *chat_completion_request_message_content_part_convertToJSON(chat_completion_request_message_content_part_t *chat_completion_request_message_content_part) {
    ...
    if(cJSON_AddStringToObject(item, "type", chat_completion_request_message_content_part_type_ToString(chat_completion_request_message_content_part->type)) == NULL)
    {
    goto fail; //Enum
    }
...
chat_completion_request_message_content_part_t *chat_completion_request_message_content_part_parseFromJSON(cJSON *chat_completion_request_message_content_partJSON){
    ...
    chat_completion_request_message_content_part_local_var = chat_completion_request_message_content_part_create_internal (
        typeVariable,
