...
static chat_completion_request_message_content_part_text_t *chat_completion_request_message_content_part_text_create_internal(
    ...
    chat_completion_request_message_content_part_text_local_var->_library_owned = 1;
    return chat_completion_request_message_content_part_text_local_var;
}

__attribute__((deprecated)) chat_completion_request_message_content_part_text_t *chat_completion_request_message_content_part_text_create(
    openai_api_chat_completion_request_message_content_part_text_TYPE_e type,
    char *text
    ) {
    return chat_completion_request_message_content_part_text_create_internal (
        type,
        text
        );
}
...
void chat_completion_request_message_content_part_text_free(chat_completion_request_message_content_part_text_t *chat_completion_request_message_content_part_text) {
    ...
    if(chat_completion_request_message_content_part_text->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "chat_completion_request_message_content_part_text_free");
        return ;
    }
...
cJSON *chat_completion_request_message_content_part_text_convertToJSON(chat_completion_request_message_content_part_text_t *chat_completion_request_message_content_part_text) {
    ...
    if(cJSON_AddStringToObject(item, "type", chat_completion_request_message_content_part_text_type_ToString(chat_completion_request_message_content_part_text->type)) == NULL)
    {
    goto fail; //Enum
    }
...
chat_completion_request_message_content_part_text_t *chat_completion_request_message_content_part_text_parseFromJSON(cJSON *chat_completion_request_message_content_part_textJSON){
    ...
    chat_completion_request_message_content_part_text_local_var = chat_completion_request_message_content_part_text_create_internal (
        typeVariable,
