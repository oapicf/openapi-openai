/*
 * chat_completion_request_tool_message_content.h
 *
 * The contents of the tool message.
 */

#ifndef _chat_completion_request_tool_message_content_H_
#define _chat_completion_request_tool_message_content_H_
...
typedef struct chat_completion_request_tool_message_content_t chat_completion_request_tool_message_content_t;

#include "chat_completion_request_message_content_part_text.h"



typedef struct chat_completion_request_tool_message_content_t {

    int _library_owned; // Is the library responsible for freeing this object?
} chat_completion_request_tool_message_content_t;
...
#endif /* _chat_completion_request_tool_message_content_H_ */
