...
static chat_completion_request_user_message_t *chat_completion_request_user_message_create_internal(
    ...
    chat_completion_request_user_message_local_var->_library_owned = 1;
...
__attribute__((deprecated)) chat_completion_request_user_message_t *chat_completion_request_user_message_create(
    ...
    return chat_completion_request_user_message_create_internal (
        content,
        role,
        name
        );
...
void chat_completion_request_user_message_free(chat_completion_request_user_message_t *chat_completion_request_user_message) {
    ...
    if(chat_completion_request_user_message->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "chat_completion_request_user_message_free");
        return ;
    }
...
cJSON *chat_completion_request_user_message_convertToJSON(chat_completion_request_user_message_t *chat_completion_request_user_message) {
    ...
    if(cJSON_AddStringToObject(item, "role", chat_completion_request_user_message_role_ToString(chat_completion_request_user_message->role)) == NULL)
    {
    goto fail; //Enum
    }
...
chat_completion_request_user_message_t *chat_completion_request_user_message_parseFromJSON(cJSON *chat_completion_request_user_messageJSON){
    ...
    chat_completion_request_user_message_local_var = chat_completion_request_user_message_create_internal (
