...
cJSON *chat_completion_role_convertToJSON(openai_api_chat_completion_role__e chat_completion_role) {
...
openai_api_chat_completion_role__e chat_completion_role_parseFromJSON(cJSON *chat_completion_roleJSON) {
    if(!cJSON_IsString(chat_completion_roleJSON) || (chat_completion_roleJSON->valuestring == NULL)) {
        return 0;
    }
    return chat_completion_role_chat_completion_role_FromString(chat_completion_roleJSON->valuestring);
}
