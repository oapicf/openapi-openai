/*
 * chat_completion_stream_response_delta_function_call.h
 *
 * Deprecated and replaced by &#x60;tool_calls&#x60;. The name and arguments of a function that should be called, as generated by the model.
 */

#ifndef _chat_completion_stream_response_delta_function_call_H_
#define _chat_completion_stream_response_delta_function_call_H_
...
typedef struct chat_completion_stream_response_delta_function_call_t chat_completion_stream_response_delta_function_call_t;




typedef struct chat_completion_stream_response_delta_function_call_t {
    char *arguments; // string
    char *name; // string

} chat_completion_stream_response_delta_function_call_t;
...
#endif /* _chat_completion_stream_response_delta_function_call_H_ */
