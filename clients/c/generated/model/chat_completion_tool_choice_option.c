...
static chat_completion_tool_choice_option_t *chat_completion_tool_choice_option_create_internal(
    ...
    chat_completion_tool_choice_option_local_var->_library_owned = 1;
...
__attribute__((deprecated)) chat_completion_tool_choice_option_t *chat_completion_tool_choice_option_create(
    ...
    return chat_completion_tool_choice_option_create_internal (
        type,
        function
        );
}
...
void chat_completion_tool_choice_option_free(chat_completion_tool_choice_option_t *chat_completion_tool_choice_option) {
    ...
    if(chat_completion_tool_choice_option->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "chat_completion_tool_choice_option_free");
        return ;
    }
    listEntry_t *listEntry;
    if (chat_completion_tool_choice_option->function) {
        assistants_named_tool_choice_function_free(chat_completion_tool_choice_option->function);
...
cJSON *chat_completion_tool_choice_option_convertToJSON(chat_completion_tool_choice_option_t *chat_completion_tool_choice_option) {
    ...
    if(cJSON_AddStringToObject(item, "type", chat_completion_tool_choice_option_type_ToString(chat_completion_tool_choice_option->type)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    cJSON *function_local_JSON = assistants_named_tool_choice_function_convertToJSON(chat_completion_tool_choice_option->function);
...
chat_completion_tool_choice_option_t *chat_completion_tool_choice_option_parseFromJSON(cJSON *chat_completion_tool_choice_optionJSON){
    ...
    chat_completion_tool_choice_option_local_var = chat_completion_tool_choice_option_create_internal (
        typeVariable,
