...
static create_chat_completion_function_response_t *create_chat_completion_function_response_create_internal(
    char *id,
    list_t *choices,
    int created,
    char *model,
    ...
    create_chat_completion_function_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) create_chat_completion_function_response_t *create_chat_completion_function_response_create(
    ...
    return create_chat_completion_function_response_create_internal (
        id,
        choices,
        created,
        model,
...
void create_chat_completion_function_response_free(create_chat_completion_function_response_t *create_chat_completion_function_response) {
    ...
    if(create_chat_completion_function_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_chat_completion_function_response_free");
        return ;
    }
...
cJSON *create_chat_completion_function_response_convertToJSON(create_chat_completion_function_response_t *create_chat_completion_function_response) {
    ...
    if(cJSON_AddStringToObject(item, "object", create_chat_completion_function_response_object_ToString(create_chat_completion_function_response->object)) == NULL)
    {
    goto fail; //Enum
    }
...
create_chat_completion_function_response_t *create_chat_completion_function_response_parseFromJSON(cJSON *create_chat_completion_function_responseJSON){
    ...
    create_chat_completion_function_response_local_var = create_chat_completion_function_response_create_internal (
