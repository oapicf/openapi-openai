...
static create_chat_completion_response_t *create_chat_completion_response_create_internal(
    char *id,
    list_t *choices,
    int created,
    char *model,
    ...
    create_chat_completion_response_local_var->_library_owned = 1;
    return create_chat_completion_response_local_var;
}

__attribute__((deprecated)) create_chat_completion_response_t *create_chat_completion_response_create(
    char *id,
    list_t *choices,
    int created,
    char *model,
    ...
    return create_chat_completion_response_create_internal (
        id,
        choices,
        created,
        model,
...
void create_chat_completion_response_free(create_chat_completion_response_t *create_chat_completion_response) {
    if(NULL == create_chat_completion_response){
        return ;
    }
    if(create_chat_completion_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_chat_completion_response_free");
        return ;
    }
    listEntry_t *listEntry;
    if (create_chat_completion_response->id) {
...
cJSON *create_chat_completion_response_convertToJSON(create_chat_completion_response_t *create_chat_completion_response) {
    ...
    // create_chat_completion_response->choices
    if (!create_chat_completion_response->choices) {
        goto fail;
    }
    ...
    if (create_chat_completion_response->choices) {
    list_ForEach(choicesListEntry, create_chat_completion_response->choices) {
    cJSON *itemLocal = create_chat_completion_response_choices_inner_convertToJSON(choicesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(cJSON_AddStringToObject(item, "object", create_chat_completion_response_object_ToString(create_chat_completion_response->object)) == NULL)
    {
    goto fail; //Enum
    }
...
create_chat_completion_response_t *create_chat_completion_response_parseFromJSON(cJSON *create_chat_completion_responseJSON){
    ...
    create_chat_completion_response_t *create_chat_completion_response_local_var = NULL;

    // define the local list for create_chat_completion_response->choices
    ...
    // create_chat_completion_response->choices
    cJSON *choices = cJSON_GetObjectItemCaseSensitive(create_chat_completion_responseJSON, "choices");
    ...
    cJSON_ArrayForEach(choices_local_nonprimitive,choices )
    {
        ...
        create_chat_completion_response_choices_inner_t *choicesItem = create_chat_completion_response_choices_inner_parseFromJSON(choices_local_nonprimitive);
    ...
    create_chat_completion_response_local_var = create_chat_completion_response_create_internal (
