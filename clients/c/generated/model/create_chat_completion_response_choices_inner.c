...
static create_chat_completion_response_choices_inner_t *create_chat_completion_response_choices_inner_create_internal(
    ...
    create_chat_completion_response_choices_inner_local_var->_library_owned = 1;
...
__attribute__((deprecated)) create_chat_completion_response_choices_inner_t *create_chat_completion_response_choices_inner_create(
    ...
    return create_chat_completion_response_choices_inner_create_internal (
        finish_reason,
        index,
        message,
        logprobs
...
void create_chat_completion_response_choices_inner_free(create_chat_completion_response_choices_inner_t *create_chat_completion_response_choices_inner) {
    ...
    if(create_chat_completion_response_choices_inner->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_chat_completion_response_choices_inner_free");
        return ;
    }
...
cJSON *create_chat_completion_response_choices_inner_convertToJSON(create_chat_completion_response_choices_inner_t *create_chat_completion_response_choices_inner) {
    ...
    if(cJSON_AddStringToObject(item, "finish_reason", create_chat_completion_response_choices_inner_finish_reason_ToString(create_chat_completion_response_choices_inner->finish_reason)) == NULL)
    {
    goto fail; //Enum
    }
...
create_chat_completion_response_choices_inner_t *create_chat_completion_response_choices_inner_parseFromJSON(cJSON *create_chat_completion_response_choices_innerJSON){
    ...
    create_chat_completion_response_choices_inner_local_var = create_chat_completion_response_choices_inner_create_internal (
