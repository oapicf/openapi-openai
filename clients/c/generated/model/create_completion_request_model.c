...
static create_completion_request_model_t *create_completion_request_model_create_internal(
    ) {
    ...
    create_completion_request_model_local_var->_library_owned = 1;
    return create_completion_request_model_local_var;
}

__attribute__((deprecated)) create_completion_request_model_t *create_completion_request_model_create(
    ) {
    return create_completion_request_model_create_internal (
        );
}
...
void create_completion_request_model_free(create_completion_request_model_t *create_completion_request_model) {
    ...
    if(create_completion_request_model->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_completion_request_model_free");
        return ;
    }
...
create_completion_request_model_t *create_completion_request_model_parseFromJSON(cJSON *create_completion_request_modelJSON){
    ...
    create_completion_request_model_local_var = create_completion_request_model_create_internal (
        );
