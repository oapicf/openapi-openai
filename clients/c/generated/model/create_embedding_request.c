...
static create_embedding_request_t *create_embedding_request_create_internal(
    ...
    create_embedding_request_local_var->_library_owned = 1;
...
__attribute__((deprecated)) create_embedding_request_t *create_embedding_request_create(
    ...
    return create_embedding_request_create_internal (
        input,
        model,
        encoding_format,
        dimensions,
...
void create_embedding_request_free(create_embedding_request_t *create_embedding_request) {
    ...
    if(create_embedding_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_embedding_request_free");
        return ;
    }
...
cJSON *create_embedding_request_convertToJSON(create_embedding_request_t *create_embedding_request) {
    ...
    if(cJSON_AddStringToObject(item, "encoding_format", create_embedding_request_encoding_format_ToString(create_embedding_request->encoding_format)) == NULL)
    {
    goto fail; //Enum
    }
    }
...
create_embedding_request_t *create_embedding_request_parseFromJSON(cJSON *create_embedding_requestJSON){
    ...
    if (cJSON_IsNull(encoding_format)) {
    ...
    create_embedding_request_local_var = create_embedding_request_create_internal (
        input_local_nonprim,
        model_local_nonprim,
