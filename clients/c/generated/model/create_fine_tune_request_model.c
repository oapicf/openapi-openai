...
create_fine_tune_request_model_t *create_fine_tune_request_model_create(
    ...
    create_fine_tune_request_model_t *create_fine_tune_request_model_local_var = malloc(sizeof(create_fine_tune_request_model_t));
    if (!create_fine_tune_request_model_local_var) {
        return NULL;
    }

    return create_fine_tune_request_model_local_var;
}


void create_fine_tune_request_model_free(create_fine_tune_request_model_t *create_fine_tune_request_model) {
    if(NULL == create_fine_tune_request_model){
        return ;
    }
    listEntry_t *listEntry;
    free(create_fine_tune_request_model);
}
...
create_fine_tune_request_model_t *create_fine_tune_request_model_parseFromJSON(cJSON *create_fine_tune_request_modelJSON){
    ...
    create_fine_tune_request_model_t *create_fine_tune_request_model_local_var = NULL;


    create_fine_tune_request_model_local_var = create_fine_tune_request_model_create (
        );
