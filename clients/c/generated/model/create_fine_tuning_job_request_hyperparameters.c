...
static create_fine_tuning_job_request_hyperparameters_t *create_fine_tuning_job_request_hyperparameters_create_internal(
    ...
    create_fine_tuning_job_request_hyperparameters_local_var->_library_owned = 1;
...
__attribute__((deprecated)) create_fine_tuning_job_request_hyperparameters_t *create_fine_tuning_job_request_hyperparameters_create(
    ...
    return create_fine_tuning_job_request_hyperparameters_create_internal (
        batch_size,
...
void create_fine_tuning_job_request_hyperparameters_free(create_fine_tuning_job_request_hyperparameters_t *create_fine_tuning_job_request_hyperparameters) {
    ...
    if(create_fine_tuning_job_request_hyperparameters->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_fine_tuning_job_request_hyperparameters_free");
        return ;
    }
...
create_fine_tuning_job_request_hyperparameters_t *create_fine_tuning_job_request_hyperparameters_parseFromJSON(cJSON *create_fine_tuning_job_request_hyperparametersJSON){
    ...
    create_fine_tuning_job_request_hyperparameters_local_var = create_fine_tuning_job_request_hyperparameters_create_internal (
