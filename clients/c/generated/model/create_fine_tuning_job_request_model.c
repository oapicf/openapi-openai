...
create_fine_tuning_job_request_model_t *create_fine_tuning_job_request_model_create(
    ) {
...
create_fine_tuning_job_request_model_t *create_fine_tuning_job_request_model_parseFromJSON(cJSON *create_fine_tuning_job_request_modelJSON){
    ...
    create_fine_tuning_job_request_model_local_var = create_fine_tuning_job_request_model_create (
        );
