...
static create_image_request_model_t *create_image_request_model_create_internal(
    ) {
    ...
    create_image_request_model_local_var->_library_owned = 1;
...
__attribute__((deprecated)) create_image_request_model_t *create_image_request_model_create(
    ...
    return create_image_request_model_create_internal (
        );
}
...
void create_image_request_model_free(create_image_request_model_t *create_image_request_model) {
    ...
    if(create_image_request_model->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_image_request_model_free");
        return ;
    }
...
create_image_request_model_t *create_image_request_model_parseFromJSON(cJSON *create_image_request_modelJSON){
    ...
    create_image_request_model_local_var = create_image_request_model_create_internal (
        );
