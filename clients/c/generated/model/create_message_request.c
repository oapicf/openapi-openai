...
cJSON *create_message_request_convertToJSON(create_message_request_t *create_message_request) {
    ...
    if(cJSON_AddStringToObject(item, "role", rolecreate_message_request_ToString(create_message_request->role)) == NULL)
    {
    goto fail; //Enum
    }
...
create_message_request_t *create_message_request_parseFromJSON(cJSON *create_message_requestJSON){
    ...
    create_message_request_local_var = create_message_request_create (
        roleVariable,
