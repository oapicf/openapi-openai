...
static create_run_request_model_t *create_run_request_model_create_internal(
    ) {
    ...
    create_run_request_model_local_var->_library_owned = 1;
...
__attribute__((deprecated)) create_run_request_model_t *create_run_request_model_create(
    ...
    return create_run_request_model_create_internal (
        );
}
...
void create_run_request_model_free(create_run_request_model_t *create_run_request_model) {
    ...
    if(create_run_request_model->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_run_request_model_free");
        return ;
    }
...
create_run_request_model_t *create_run_request_model_parseFromJSON(cJSON *create_run_request_modelJSON){
    ...
    create_run_request_model_local_var = create_run_request_model_create_internal (
        );
