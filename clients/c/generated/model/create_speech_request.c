...
cJSON *create_speech_request_convertToJSON(create_speech_request_t *create_speech_request) {
    ...
    if(cJSON_AddStringToObject(item, "voice", voicecreate_speech_request_ToString(create_speech_request->voice)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if(cJSON_AddStringToObject(item, "response_format", response_formatcreate_speech_request_ToString(create_speech_request->response_format)) == NULL)
    {
    goto fail; //Enum
    }
    }
...
create_speech_request_t *create_speech_request_parseFromJSON(cJSON *create_speech_requestJSON){
    ...
    create_speech_request_local_var = create_speech_request_create (
        model_local_nonprim,
