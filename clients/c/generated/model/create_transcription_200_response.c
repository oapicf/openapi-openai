...
static create_transcription_200_response_t *create_transcription_200_response_create_internal(
    char *text,
    char *language,
    char *duration,
    list_t *words,
    ...
    create_transcription_200_response_local_var->_library_owned = 1;
    return create_transcription_200_response_local_var;
}

__attribute__((deprecated)) create_transcription_200_response_t *create_transcription_200_response_create(
    char *text,
    char *language,
    char *duration,
    list_t *words,
    ...
    return create_transcription_200_response_create_internal (
        text,
        language,
        duration,
        words,
...
void create_transcription_200_response_free(create_transcription_200_response_t *create_transcription_200_response) {
    ...
    if(create_transcription_200_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_transcription_200_response_free");
        return ;
    }
...
create_transcription_200_response_t *create_transcription_200_response_parseFromJSON(cJSON *create_transcription_200_responseJSON){
    ...
    create_transcription_200_response_local_var = create_transcription_200_response_create_internal (
