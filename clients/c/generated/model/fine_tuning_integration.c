...
fine_tuning_integration_t *fine_tuning_integration_create(
...
cJSON *fine_tuning_integration_convertToJSON(fine_tuning_integration_t *fine_tuning_integration) {
    ...
    if(cJSON_AddStringToObject(item, "type", typefine_tuning_integration_ToString(fine_tuning_integration->type)) == NULL)
    {
    goto fail; //Enum
    }
...
fine_tuning_integration_t *fine_tuning_integration_parseFromJSON(cJSON *fine_tuning_integrationJSON){
    ...
    fine_tuning_integration_local_var = fine_tuning_integration_create (
        typeVariable,
        wandb_local_nonprim
        );
