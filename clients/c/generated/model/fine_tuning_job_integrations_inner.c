...
fine_tuning_job_integrations_inner_t *fine_tuning_job_integrations_inner_create(
...
cJSON *fine_tuning_job_integrations_inner_convertToJSON(fine_tuning_job_integrations_inner_t *fine_tuning_job_integrations_inner) {
    ...
    if(cJSON_AddStringToObject(item, "type", typefine_tuning_job_integrations_inner_ToString(fine_tuning_job_integrations_inner->type)) == NULL)
    {
    goto fail; //Enum
    }
...
fine_tuning_job_integrations_inner_t *fine_tuning_job_integrations_inner_parseFromJSON(cJSON *fine_tuning_job_integrations_innerJSON){
    ...
    fine_tuning_job_integrations_inner_local_var = fine_tuning_job_integrations_inner_create (
        typeVariable,
        wandb_local_nonprim
        );
