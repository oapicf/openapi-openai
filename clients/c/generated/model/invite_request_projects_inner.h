/*
 * invite_request_projects_inner.h
 *
 * 
 */

#ifndef _invite_request_projects_inner_H_
#define _invite_request_projects_inner_H_
...
typedef struct invite_request_projects_inner_t invite_request_projects_inner_t;


// Enum ROLE for invite_request_projects_inner

typedef enum  { openai_api_invite_request_projects_inner_ROLE_NULL = 0, openai_api_invite_request_projects_inner_ROLE_member, openai_api_invite_request_projects_inner_ROLE_owner } openai_api_invite_request_projects_inner_ROLE_e;
...
typedef struct invite_request_projects_inner_t {
    char *id; // string
    openai_api_invite_request_projects_inner_ROLE_e role; //enum

    int _library_owned; // Is the library responsible for freeing this object?
} invite_request_projects_inner_t;
...
#endif /* _invite_request_projects_inner_H_ */
