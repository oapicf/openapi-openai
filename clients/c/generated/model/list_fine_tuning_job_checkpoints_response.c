...
list_fine_tuning_job_checkpoints_response_t *list_fine_tuning_job_checkpoints_response_create(
    list_t *data,
...
cJSON *list_fine_tuning_job_checkpoints_response_convertToJSON(list_fine_tuning_job_checkpoints_response_t *list_fine_tuning_job_checkpoints_response) {
    ...
    if(cJSON_AddStringToObject(item, "object", objectlist_fine_tuning_job_checkpoints_response_ToString(list_fine_tuning_job_checkpoints_response->object)) == NULL)
    {
    goto fail; //Enum
    }
...
list_fine_tuning_job_checkpoints_response_t *list_fine_tuning_job_checkpoints_response_parseFromJSON(cJSON *list_fine_tuning_job_checkpoints_responseJSON){
    ...
    list_fine_tuning_job_checkpoints_response_local_var = list_fine_tuning_job_checkpoints_response_create (
        dataList,
        objectVariable,
