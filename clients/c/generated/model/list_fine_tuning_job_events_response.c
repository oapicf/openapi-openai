...
static list_fine_tuning_job_events_response_t *list_fine_tuning_job_events_response_create_internal(
    list_t *data,
    ...
    list_fine_tuning_job_events_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) list_fine_tuning_job_events_response_t *list_fine_tuning_job_events_response_create(
    ...
    return list_fine_tuning_job_events_response_create_internal (
        data,
        object
        );
}
...
void list_fine_tuning_job_events_response_free(list_fine_tuning_job_events_response_t *list_fine_tuning_job_events_response) {
    ...
    if(list_fine_tuning_job_events_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "list_fine_tuning_job_events_response_free");
        return ;
    }
...
cJSON *list_fine_tuning_job_events_response_convertToJSON(list_fine_tuning_job_events_response_t *list_fine_tuning_job_events_response) {
    ...
    if(cJSON_AddStringToObject(item, "object", list_fine_tuning_job_events_response_object_ToString(list_fine_tuning_job_events_response->object)) == NULL)
    {
    goto fail; //Enum
    }
...
list_fine_tuning_job_events_response_t *list_fine_tuning_job_events_response_parseFromJSON(cJSON *list_fine_tuning_job_events_responseJSON){
    ...
    list_fine_tuning_job_events_response_local_var = list_fine_tuning_job_events_response_create_internal (
        dataList,
        objectVariable
        );
