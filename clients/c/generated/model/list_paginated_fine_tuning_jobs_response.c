...
list_paginated_fine_tuning_jobs_response_t *list_paginated_fine_tuning_jobs_response_create(
    list_t *data,
    int has_more,
...
cJSON *list_paginated_fine_tuning_jobs_response_convertToJSON(list_paginated_fine_tuning_jobs_response_t *list_paginated_fine_tuning_jobs_response) {
    ...
    if(cJSON_AddStringToObject(item, "object", objectlist_paginated_fine_tuning_jobs_response_ToString(list_paginated_fine_tuning_jobs_response->object)) == NULL)
    {
    goto fail; //Enum
    }
...
list_paginated_fine_tuning_jobs_response_t *list_paginated_fine_tuning_jobs_response_parseFromJSON(cJSON *list_paginated_fine_tuning_jobs_responseJSON){
    ...
    list_paginated_fine_tuning_jobs_response_local_var = list_paginated_fine_tuning_jobs_response_create (
        dataList,
        has_more->valueint,
        objectVariable
        );
