...
static list_runs_response_t *list_runs_response_create_internal(
    char *object,
    list_t *data,
    char *first_id,
    char *last_id,
    ...
    list_runs_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) list_runs_response_t *list_runs_response_create(
    ...
    return list_runs_response_create_internal (
        object,
        data,
        first_id,
        last_id,
...
void list_runs_response_free(list_runs_response_t *list_runs_response) {
    ...
    if(list_runs_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "list_runs_response_free");
        return ;
    }
...
list_runs_response_t *list_runs_response_parseFromJSON(cJSON *list_runs_responseJSON){
    ...
    list_runs_response_local_var = list_runs_response_create_internal (
