...
static list_threads_response_t *list_threads_response_create_internal(
    char *object,
    list_t *data,
    char *first_id,
    char *last_id,
    ...
    list_threads_response_local_var->_library_owned = 1;
    return list_threads_response_local_var;
}

__attribute__((deprecated)) list_threads_response_t *list_threads_response_create(
    char *object,
    list_t *data,
    char *first_id,
    char *last_id,
    ...
    return list_threads_response_create_internal (
        object,
        data,
        first_id,
        last_id,
...
void list_threads_response_free(list_threads_response_t *list_threads_response) {
    ...
    if(list_threads_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "list_threads_response_free");
        return ;
    }
...
list_threads_response_t *list_threads_response_parseFromJSON(cJSON *list_threads_responseJSON){
    ...
    list_threads_response_local_var = list_threads_response_create_internal (
