...
static message_content_image_file_object_t *message_content_image_file_object_create_internal(
    ...
    message_content_image_file_object_local_var->_library_owned = 1;
    return message_content_image_file_object_local_var;
}

__attribute__((deprecated)) message_content_image_file_object_t *message_content_image_file_object_create(
    openai_api_message_content_image_file_object_TYPE_e type,
    message_content_image_file_object_image_file_t *image_file
    ) {
    return message_content_image_file_object_create_internal (
        type,
        image_file
        );
}
...
void message_content_image_file_object_free(message_content_image_file_object_t *message_content_image_file_object) {
    ...
    if(message_content_image_file_object->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "message_content_image_file_object_free");
        return ;
    }
...
cJSON *message_content_image_file_object_convertToJSON(message_content_image_file_object_t *message_content_image_file_object) {
    ...
    if(cJSON_AddStringToObject(item, "type", message_content_image_file_object_type_ToString(message_content_image_file_object->type)) == NULL)
    {
    goto fail; //Enum
    }
...
message_content_image_file_object_t *message_content_image_file_object_parseFromJSON(cJSON *message_content_image_file_objectJSON){
    ...
    message_content_image_file_object_local_var = message_content_image_file_object_create_internal (
        typeVariable,
