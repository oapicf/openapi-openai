/*
 * message_content_image_url_object.h
 *
 * References an image URL in the content of a message.
 */

#ifndef _message_content_image_url_object_H_
#define _message_content_image_url_object_H_
...
typedef struct message_content_image_url_object_t message_content_image_url_object_t;

#include "message_content_image_url_object_image_url.h"

// Enum TYPE for message_content_image_url_object

typedef enum  { openai_api_message_content_image_url_object_TYPE_NULL = 0, openai_api_message_content_image_url_object_TYPE_image_url } openai_api_message_content_image_url_object_TYPE_e;
...
typedef struct message_content_image_url_object_t {
    openai_api_message_content_image_url_object_TYPE_e type; //enum
    struct message_content_image_url_object_image_url_t *image_url; //model

    int _library_owned; // Is the library responsible for freeing this object?
} message_content_image_url_object_t;
...
#endif /* _message_content_image_url_object_H_ */
