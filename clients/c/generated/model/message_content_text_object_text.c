...
static message_content_text_object_text_t *message_content_text_object_text_create_internal(
    char *value,
    list_t *annotations
    ) {
    ...
    message_content_text_object_text_local_var->_library_owned = 1;
    return message_content_text_object_text_local_var;
}

__attribute__((deprecated)) message_content_text_object_text_t *message_content_text_object_text_create(
    char *value,
    list_t *annotations
    ) {
    return message_content_text_object_text_create_internal (
        value,
        annotations
        );
}
...
void message_content_text_object_text_free(message_content_text_object_text_t *message_content_text_object_text) {
    ...
    if(message_content_text_object_text->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "message_content_text_object_text_free");
        return ;
    }
...
message_content_text_object_text_t *message_content_text_object_text_parseFromJSON(cJSON *message_content_text_object_textJSON){
    ...
    message_content_text_object_text_local_var = message_content_text_object_text_create_internal (
