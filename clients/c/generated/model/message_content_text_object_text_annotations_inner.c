...
message_content_text_object_text_annotations_inner_t *message_content_text_object_text_annotations_inner_create(
...
cJSON *message_content_text_object_text_annotations_inner_convertToJSON(message_content_text_object_text_annotations_inner_t *message_content_text_object_text_annotations_inner) {
    ...
    if(cJSON_AddStringToObject(item, "type", typemessage_content_text_object_text_annotations_inner_ToString(message_content_text_object_text_annotations_inner->type)) == NULL)
    {
    goto fail; //Enum
    }
...
message_content_text_object_text_annotations_inner_t *message_content_text_object_text_annotations_inner_parseFromJSON(cJSON *message_content_text_object_text_annotations_innerJSON){
    ...
    message_content_text_object_text_annotations_inner_local_var = message_content_text_object_text_annotations_inner_create (
        typeVariable,
