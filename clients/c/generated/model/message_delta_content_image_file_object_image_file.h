...
// Enum DETAIL for message_delta_content_image_file_object_image_file

typedef enum  { openai_api_message_delta_content_image_file_object_image_file_DETAIL_NULL = 0, openai_api_message_delta_content_image_file_object_image_file_DETAIL__auto, openai_api_message_delta_content_image_file_object_image_file_DETAIL_low, openai_api_message_delta_content_image_file_object_image_file_DETAIL_high } openai_api_message_delta_content_image_file_object_image_file_DETAIL_e;
...
typedef struct message_delta_content_image_file_object_image_file_t {
    char *file_id; // string
    openai_api_message_delta_content_image_file_object_image_file_DETAIL_e detail; //enum
