/*
 * message_delta_content_image_url_object_image_url.h
 *
 * 
 */

#ifndef _message_delta_content_image_url_object_image_url_H_
#define _message_delta_content_image_url_object_image_url_H_
...
typedef struct message_delta_content_image_url_object_image_url_t message_delta_content_image_url_object_image_url_t;


// Enum DETAIL for message_delta_content_image_url_object_image_url

typedef enum  { openai_api_message_delta_content_image_url_object_image_url_DETAIL_NULL = 0, openai_api_message_delta_content_image_url_object_image_url_DETAIL__auto, openai_api_message_delta_content_image_url_object_image_url_DETAIL_low, openai_api_message_delta_content_image_url_object_image_url_DETAIL_high } openai_api_message_delta_content_image_url_object_image_url_DETAIL_e;
...
typedef struct message_delta_content_image_url_object_image_url_t {
    char *url; // string
    openai_api_message_delta_content_image_url_object_image_url_DETAIL_e detail; //enum

    int _library_owned; // Is the library responsible for freeing this object?
} message_delta_content_image_url_object_image_url_t;
...
#endif /* _message_delta_content_image_url_object_image_url_H_ */
