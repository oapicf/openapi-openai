...
message_delta_content_text_annotations_file_citation_object_t *message_delta_content_text_annotations_file_citation_object_create(
    int index,
...
cJSON *message_delta_content_text_annotations_file_citation_object_convertToJSON(message_delta_content_text_annotations_file_citation_object_t *message_delta_content_text_annotations_file_citation_object) {
    ...
    if(cJSON_AddStringToObject(item, "type", typemessage_delta_content_text_annotations_file_citation_object_ToString(message_delta_content_text_annotations_file_citation_object->type)) == NULL)
    {
    goto fail; //Enum
    }
...
message_delta_content_text_annotations_file_citation_object_t *message_delta_content_text_annotations_file_citation_object_parseFromJSON(cJSON *message_delta_content_text_annotations_file_citation_objectJSON){
    ...
    message_delta_content_text_annotations_file_citation_object_local_var = message_delta_content_text_annotations_file_citation_object_create (
        index->valuedouble,
        typeVariable,
