/*
 * message_delta_content_text_annotations_file_path_object_file_path.h
 *
 * 
 */

#ifndef _message_delta_content_text_annotations_file_path_object_file_path_H_
#define _message_delta_content_text_annotations_file_path_object_file_path_H_
...
typedef struct message_delta_content_text_annotations_file_path_object_file_path_t message_delta_content_text_annotations_file_path_object_file_path_t;




typedef struct message_delta_content_text_annotations_file_path_object_file_path_t {
    char *file_id; // string

    int _library_owned; // Is the library responsible for freeing this object?
} message_delta_content_text_annotations_file_path_object_file_path_t;
...
#endif /* _message_delta_content_text_annotations_file_path_object_file_path_H_ */
