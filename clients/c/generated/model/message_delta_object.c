...
cJSON *message_delta_object_convertToJSON(message_delta_object_t *message_delta_object) {
    ...
    if(cJSON_AddStringToObject(item, "object", objectmessage_delta_object_ToString(message_delta_object->object)) == NULL)
    {
    goto fail; //Enum
    }
...
message_delta_object_t *message_delta_object_parseFromJSON(cJSON *message_delta_objectJSON){
    ...
    message_delta_object_local_var = message_delta_object_create (
