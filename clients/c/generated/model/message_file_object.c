...
cJSON *message_file_object_convertToJSON(message_file_object_t *message_file_object) {
    ...
    if(cJSON_AddStringToObject(item, "object", objectmessage_file_object_ToString(message_file_object->object)) == NULL)
    {
    goto fail; //Enum
    }
...
message_file_object_t *message_file_object_parseFromJSON(cJSON *message_file_objectJSON){
    ...
    message_file_object_local_var = message_file_object_create (
