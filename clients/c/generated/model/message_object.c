...
cJSON *message_object_convertToJSON(message_object_t *message_object) {
    ...
    if(cJSON_AddStringToObject(item, "object", objectmessage_object_ToString(message_object->object)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if(cJSON_AddStringToObject(item, "status", statusmessage_object_ToString(message_object->status)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if(cJSON_AddStringToObject(item, "role", rolemessage_object_ToString(message_object->role)) == NULL)
    {
    goto fail; //Enum
    }
