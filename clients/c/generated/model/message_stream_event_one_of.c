...
cJSON *message_stream_event_one_of_convertToJSON(message_stream_event_one_of_t *message_stream_event_one_of) {
    ...
    if(cJSON_AddStringToObject(item, "event", eventmessage_stream_event_one_of_ToString(message_stream_event_one_of->event)) == NULL)
    {
    goto fail; //Enum
    }
...
message_stream_event_one_of_t *message_stream_event_one_of_parseFromJSON(cJSON *message_stream_event_one_ofJSON){
    ...
    message_stream_event_one_of_local_var = message_stream_event_one_of_create (
        eventVariable,
        data_local_nonprim
        );
