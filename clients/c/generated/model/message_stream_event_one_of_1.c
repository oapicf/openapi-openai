...
static message_stream_event_one_of_1_t *message_stream_event_one_of_1_create_internal(
    ...
    message_stream_event_one_of_1_local_var->_library_owned = 1;
...
__attribute__((deprecated)) message_stream_event_one_of_1_t *message_stream_event_one_of_1_create(
    ...
    return message_stream_event_one_of_1_create_internal (
        event,
        data
        );
}
...
void message_stream_event_one_of_1_free(message_stream_event_one_of_1_t *message_stream_event_one_of_1) {
    ...
    if(message_stream_event_one_of_1->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "message_stream_event_one_of_1_free");
        return ;
    }
...
cJSON *message_stream_event_one_of_1_convertToJSON(message_stream_event_one_of_1_t *message_stream_event_one_of_1) {
    ...
    if(cJSON_AddStringToObject(item, "event", message_stream_event_one_of_1_event_ToString(message_stream_event_one_of_1->event)) == NULL)
    {
    goto fail; //Enum
    }
...
message_stream_event_one_of_1_t *message_stream_event_one_of_1_parseFromJSON(cJSON *message_stream_event_one_of_1JSON){
    ...
    message_stream_event_one_of_1_local_var = message_stream_event_one_of_1_create_internal (
        eventVariable,
        data_local_nonprim
        );
