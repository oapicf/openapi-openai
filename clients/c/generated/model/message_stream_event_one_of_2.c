...
cJSON *message_stream_event_one_of_2_convertToJSON(message_stream_event_one_of_2_t *message_stream_event_one_of_2) {
    ...
    if(cJSON_AddStringToObject(item, "event", eventmessage_stream_event_one_of_2_ToString(message_stream_event_one_of_2->event)) == NULL)
    {
    goto fail; //Enum
    }
...
message_stream_event_one_of_2_t *message_stream_event_one_of_2_parseFromJSON(cJSON *message_stream_event_one_of_2JSON){
    ...
    message_stream_event_one_of_2_local_var = message_stream_event_one_of_2_create (
        eventVariable,
        data_local_nonprim
        );
