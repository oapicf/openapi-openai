...
message_stream_event_one_of_3_t *message_stream_event_one_of_3_create(
...
cJSON *message_stream_event_one_of_3_convertToJSON(message_stream_event_one_of_3_t *message_stream_event_one_of_3) {
    ...
    if(cJSON_AddStringToObject(item, "event", eventmessage_stream_event_one_of_3_ToString(message_stream_event_one_of_3->event)) == NULL)
    {
    goto fail; //Enum
    }
...
message_stream_event_one_of_3_t *message_stream_event_one_of_3_parseFromJSON(cJSON *message_stream_event_one_of_3JSON){
    ...
    message_stream_event_one_of_3_local_var = message_stream_event_one_of_3_create (
        eventVariable,
        data_local_nonprim
        );
