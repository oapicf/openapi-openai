/*
 * project_api_key_list_response.h
 *
 * 
 */

#ifndef _project_api_key_list_response_H_
#define _project_api_key_list_response_H_
...
typedef struct project_api_key_list_response_t project_api_key_list_response_t;

#include "project_api_key.h"

// Enum OBJECT for project_api_key_list_response

typedef enum  { openai_api_project_api_key_list_response_OBJECT_NULL = 0, openai_api_project_api_key_list_response_OBJECT_list } openai_api_project_api_key_list_response_OBJECT_e;
...
typedef struct project_api_key_list_response_t {
    openai_api_project_api_key_list_response_OBJECT_e object; //enum
...
#endif /* _project_api_key_list_response_H_ */
