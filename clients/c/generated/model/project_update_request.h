/*
 * project_update_request.h
 *
 * 
 */

#ifndef _project_update_request_H_
#define _project_update_request_H_
...
typedef struct project_update_request_t project_update_request_t;




typedef struct project_update_request_t {
    char *name; // string

    int _library_owned; // Is the library responsible for freeing this object?
} project_update_request_t;
...
#endif /* _project_update_request_H_ */
