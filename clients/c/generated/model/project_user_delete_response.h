/*
 * project_user_delete_response.h
 *
 * 
 */

#ifndef _project_user_delete_response_H_
#define _project_user_delete_response_H_
...
typedef struct project_user_delete_response_t project_user_delete_response_t;


// Enum OBJECT for project_user_delete_response

typedef enum  { openai_api_project_user_delete_response_OBJECT_NULL = 0, openai_api_project_user_delete_response_OBJECT_organization.project.user.deleted } openai_api_project_user_delete_response_OBJECT_e;
...
typedef struct project_user_delete_response_t {
    openai_api_project_user_delete_response_OBJECT_e object; //enum
    char *id; // string
    int deleted; //boolean
...
#endif /* _project_user_delete_response_H_ */
