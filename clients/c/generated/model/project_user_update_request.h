/*
 * project_user_update_request.h
 *
 * 
 */

#ifndef _project_user_update_request_H_
#define _project_user_update_request_H_
...
typedef struct project_user_update_request_t project_user_update_request_t;


// Enum ROLE for project_user_update_request

typedef enum  { openai_api_project_user_update_request_ROLE_NULL = 0, openai_api_project_user_update_request_ROLE_owner, openai_api_project_user_update_request_ROLE_member } openai_api_project_user_update_request_ROLE_e;
...
typedef struct project_user_update_request_t {
    openai_api_project_user_update_request_ROLE_e role; //enum

    int _library_owned; // Is the library responsible for freeing this object?
} project_user_update_request_t;
...
#endif /* _project_user_update_request_H_ */
