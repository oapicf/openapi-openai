/*
 * realtime_response_usage_input_token_details.h
 *
 * Details about the input tokens used in the Response.
 */

#ifndef _realtime_response_usage_input_token_details_H_
#define _realtime_response_usage_input_token_details_H_
...
typedef struct realtime_response_usage_input_token_details_t realtime_response_usage_input_token_details_t;




typedef struct realtime_response_usage_input_token_details_t {
    int cached_tokens; //numeric
    int text_tokens; //numeric
    int audio_tokens; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} realtime_response_usage_input_token_details_t;
...
#endif /* _realtime_response_usage_input_token_details_H_ */
