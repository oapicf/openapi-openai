/*
 * realtime_server_event_response_audio_transcript_done.h
 *
 * Returned when the model-generated transcription of audio output is done streaming. Also emitted when a Response is interrupted, incomplete, or cancelled. 
 */

#ifndef _realtime_server_event_response_audio_transcript_done_H_
#define _realtime_server_event_response_audio_transcript_done_H_
...
typedef struct realtime_server_event_response_audio_transcript_done_t realtime_server_event_response_audio_transcript_done_t;


// Enum TYPE for realtime_server_event_response_audio_transcript_done

typedef enum  { openai_api_realtime_server_event_response_audio_transcript_done_TYPE_NULL = 0, openai_api_realtime_server_event_response_audio_transcript_done_TYPE_response.audio_transcript.done } openai_api_realtime_server_event_response_audio_transcript_done_TYPE_e;
...
typedef struct realtime_server_event_response_audio_transcript_done_t {
    char *event_id; // string
    openai_api_realtime_server_event_response_audio_transcript_done_TYPE_e type; //enum
...
} realtime_server_event_response_audio_transcript_done_t;
...
#endif /* _realtime_server_event_response_audio_transcript_done_H_ */
