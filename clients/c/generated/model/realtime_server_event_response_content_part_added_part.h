/*
 * realtime_server_event_response_content_part_added_part.h
 *
 * The content part that was added.
 */

#ifndef _realtime_server_event_response_content_part_added_part_H_
#define _realtime_server_event_response_content_part_added_part_H_
...
typedef struct realtime_server_event_response_content_part_added_part_t realtime_server_event_response_content_part_added_part_t;


// Enum TYPE for realtime_server_event_response_content_part_added_part

typedef enum  { openai_api_realtime_server_event_response_content_part_added_part_TYPE_NULL = 0, openai_api_realtime_server_event_response_content_part_added_part_TYPE_audio, openai_api_realtime_server_event_response_content_part_added_part_TYPE_text } openai_api_realtime_server_event_response_content_part_added_part_TYPE_e;
...
typedef struct realtime_server_event_response_content_part_added_part_t {
    openai_api_realtime_server_event_response_content_part_added_part_TYPE_e type; //enum
    char *text; // string
    char *audio; // string
    char *transcript; // string

    int _library_owned; // Is the library responsible for freeing this object?
} realtime_server_event_response_content_part_added_part_t;
...
#endif /* _realtime_server_event_response_content_part_added_part_H_ */
