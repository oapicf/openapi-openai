/*
 * realtime_session_create_request_turn_detection.h
 *
 * Configuration for turn detection. Can be set to &#x60;null&#x60; to turn off. Server  VAD means that the model will detect the start and end of speech based on  audio volume and respond at the end of user speech. 
 */

#ifndef _realtime_session_create_request_turn_detection_H_
#define _realtime_session_create_request_turn_detection_H_
...
typedef struct realtime_session_create_request_turn_detection_t realtime_session_create_request_turn_detection_t;




typedef struct realtime_session_create_request_turn_detection_t {
    char *type; // string
    double threshold; //numeric
    int prefix_padding_ms; //numeric
    int silence_duration_ms; //numeric
    int create_response; //boolean

    int _library_owned; // Is the library responsible for freeing this object?
} realtime_session_create_request_turn_detection_t;
...
#endif /* _realtime_session_create_request_turn_detection_H_ */
