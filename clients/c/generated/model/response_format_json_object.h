/*
 * response_format_json_object.h
 *
 * 
 */

#ifndef _response_format_json_object_H_
#define _response_format_json_object_H_
...
typedef struct response_format_json_object_t response_format_json_object_t;


// Enum TYPE for response_format_json_object

typedef enum  { openai_api_response_format_json_object_TYPE_NULL = 0, openai_api_response_format_json_object_TYPE_json_object } openai_api_response_format_json_object_TYPE_e;
...
typedef struct response_format_json_object_t {
    openai_api_response_format_json_object_TYPE_e type; //enum

    int _library_owned; // Is the library responsible for freeing this object?
} response_format_json_object_t;
...
#endif /* _response_format_json_object_H_ */
