...
static run_object_incomplete_details_t *run_object_incomplete_details_create_internal(
    ...
    run_object_incomplete_details_local_var->_library_owned = 1;
    return run_object_incomplete_details_local_var;
}

__attribute__((deprecated)) run_object_incomplete_details_t *run_object_incomplete_details_create(
    openai_api_run_object_incomplete_details_REASON_e reason
    ) {
    return run_object_incomplete_details_create_internal (
        reason
        );
}
...
void run_object_incomplete_details_free(run_object_incomplete_details_t *run_object_incomplete_details) {
    ...
    if(run_object_incomplete_details->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_object_incomplete_details_free");
        return ;
    }
...
cJSON *run_object_incomplete_details_convertToJSON(run_object_incomplete_details_t *run_object_incomplete_details) {
    ...
    if(cJSON_AddStringToObject(item, "reason", run_object_incomplete_details_reason_ToString(run_object_incomplete_details->reason)) == NULL)
    {
    goto fail; //Enum
    }
    }
...
run_object_incomplete_details_t *run_object_incomplete_details_parseFromJSON(cJSON *run_object_incomplete_detailsJSON){
    ...
    run_object_incomplete_details_local_var = run_object_incomplete_details_create_internal (
