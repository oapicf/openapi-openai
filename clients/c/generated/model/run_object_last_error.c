...
cJSON *run_object_last_error_convertToJSON(run_object_last_error_t *run_object_last_error) {
    ...
    if(cJSON_AddStringToObject(item, "code", coderun_object_last_error_ToString(run_object_last_error->code)) == NULL)
    {
    goto fail; //Enum
    }
...
run_object_last_error_t *run_object_last_error_parseFromJSON(cJSON *run_object_last_errorJSON){
    ...
    run_object_last_error_local_var = run_object_last_error_create (
        codeVariable,
