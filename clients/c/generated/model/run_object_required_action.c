...
static run_object_required_action_t *run_object_required_action_create_internal(
    ...
    run_object_required_action_local_var->_library_owned = 1;
    return run_object_required_action_local_var;
}

__attribute__((deprecated)) run_object_required_action_t *run_object_required_action_create(
    openai_api_run_object_required_action_TYPE_e type,
    run_object_required_action_submit_tool_outputs_t *submit_tool_outputs
    ) {
    return run_object_required_action_create_internal (
        type,
        submit_tool_outputs
        );
}
...
void run_object_required_action_free(run_object_required_action_t *run_object_required_action) {
    ...
    if(run_object_required_action->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_object_required_action_free");
        return ;
    }
...
cJSON *run_object_required_action_convertToJSON(run_object_required_action_t *run_object_required_action) {
    ...
    if(cJSON_AddStringToObject(item, "type", run_object_required_action_type_ToString(run_object_required_action->type)) == NULL)
    {
    goto fail; //Enum
    }
...
run_object_required_action_t *run_object_required_action_parseFromJSON(cJSON *run_object_required_actionJSON){
    ...
    if (cJSON_IsNull(submit_tool_outputs)) {
    ...
    run_object_required_action_local_var = run_object_required_action_create_internal (
        typeVariable,
