...
run_step_delta_object_t *run_step_delta_object_create(
    char *id,
...
cJSON *run_step_delta_object_convertToJSON(run_step_delta_object_t *run_step_delta_object) {
    ...
    if(cJSON_AddStringToObject(item, "object", objectrun_step_delta_object_ToString(run_step_delta_object->object)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_delta_object_t *run_step_delta_object_parseFromJSON(cJSON *run_step_delta_objectJSON){
    ...
    run_step_delta_object_local_var = run_step_delta_object_create (
