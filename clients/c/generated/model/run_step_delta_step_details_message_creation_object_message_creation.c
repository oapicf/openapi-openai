...
run_step_delta_step_details_message_creation_object_message_creation_t *run_step_delta_step_details_message_creation_object_message_creation_create(
    char *message_id
    ) {
...
run_step_delta_step_details_message_creation_object_message_creation_t *run_step_delta_step_details_message_creation_object_message_creation_parseFromJSON(cJSON *run_step_delta_step_details_message_creation_object_message_creationJSON){
    ...
    run_step_delta_step_details_message_creation_object_message_creation_local_var = run_step_delta_step_details_message_creation_object_message_creation_create (
