...
run_step_delta_step_details_tool_calls_code_object_code_interpreter_t *run_step_delta_step_details_tool_calls_code_object_code_interpreter_create(
    char *input,
    list_t *outputs
    ) {
...
run_step_delta_step_details_tool_calls_code_object_code_interpreter_t *run_step_delta_step_details_tool_calls_code_object_code_interpreter_parseFromJSON(cJSON *run_step_delta_step_details_tool_calls_code_object_code_interpreterJSON){
    ...
    run_step_delta_step_details_tool_calls_code_object_code_interpreter_local_var = run_step_delta_step_details_tool_calls_code_object_code_interpreter_create (
