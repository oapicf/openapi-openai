/*
 * run_step_delta_step_details_tool_calls_code_object_code_interpreter.h
 *
 * The Code Interpreter tool call definition.
 */

#ifndef _run_step_delta_step_details_tool_calls_code_object_code_interpreter_H_
#define _run_step_delta_step_details_tool_calls_code_object_code_interpreter_H_
...
typedef struct run_step_delta_step_details_tool_calls_code_object_code_interpreter_t run_step_delta_step_details_tool_calls_code_object_code_interpreter_t;

#include "run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner.h"



typedef struct run_step_delta_step_details_tool_calls_code_object_code_interpreter_t {
    char *input; // string
    list_t *outputs; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} run_step_delta_step_details_tool_calls_code_object_code_interpreter_t;
...
#endif /* _run_step_delta_step_details_tool_calls_code_object_code_interpreter_H_ */
