/*
 * run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner.h
 *
 * 
 */

#ifndef _run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_H_
#define _run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_H_
...
typedef struct run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_t run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_t;
...
// Enum TYPE for run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner

typedef enum  { openai_api_run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_TYPE_NULL = 0, openai_api_run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_TYPE_logs, openai_api_run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_TYPE_image } openai_api_run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_TYPE_e;
...
typedef struct run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_t {
    int index; //numeric
    openai_api_run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_TYPE_e type; //enum
    char *logs; // string
...
#endif /* _run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs_inner_H_ */
