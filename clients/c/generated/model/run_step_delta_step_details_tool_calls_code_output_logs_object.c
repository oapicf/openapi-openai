...
run_step_delta_step_details_tool_calls_code_output_logs_object_t *run_step_delta_step_details_tool_calls_code_output_logs_object_create(
    int index,
...
cJSON *run_step_delta_step_details_tool_calls_code_output_logs_object_convertToJSON(run_step_delta_step_details_tool_calls_code_output_logs_object_t *run_step_delta_step_details_tool_calls_code_output_logs_object) {
    ...
    if(cJSON_AddStringToObject(item, "type", typerun_step_delta_step_details_tool_calls_code_output_logs_object_ToString(run_step_delta_step_details_tool_calls_code_output_logs_object->type)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_delta_step_details_tool_calls_code_output_logs_object_t *run_step_delta_step_details_tool_calls_code_output_logs_object_parseFromJSON(cJSON *run_step_delta_step_details_tool_calls_code_output_logs_objectJSON){
    ...
    run_step_delta_step_details_tool_calls_code_output_logs_object_local_var = run_step_delta_step_details_tool_calls_code_output_logs_object_create (
        index->valuedouble,
        typeVariable,
