...
run_step_delta_step_details_tool_calls_function_object_t *run_step_delta_step_details_tool_calls_function_object_create(
    int index,
    char *id,
...
cJSON *run_step_delta_step_details_tool_calls_function_object_convertToJSON(run_step_delta_step_details_tool_calls_function_object_t *run_step_delta_step_details_tool_calls_function_object) {
    ...
    if(cJSON_AddStringToObject(item, "type", typerun_step_delta_step_details_tool_calls_function_object_ToString(run_step_delta_step_details_tool_calls_function_object->type)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_delta_step_details_tool_calls_function_object_t *run_step_delta_step_details_tool_calls_function_object_parseFromJSON(cJSON *run_step_delta_step_details_tool_calls_function_objectJSON){
    ...
    run_step_delta_step_details_tool_calls_function_object_local_var = run_step_delta_step_details_tool_calls_function_object_create (
        index->valuedouble,
