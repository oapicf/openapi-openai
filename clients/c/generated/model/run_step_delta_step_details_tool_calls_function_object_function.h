/*
 * run_step_delta_step_details_tool_calls_function_object_function.h
 *
 * The definition of the function that was called.
 */

#ifndef _run_step_delta_step_details_tool_calls_function_object_function_H_
#define _run_step_delta_step_details_tool_calls_function_object_function_H_
...
typedef struct run_step_delta_step_details_tool_calls_function_object_function_t run_step_delta_step_details_tool_calls_function_object_function_t;




typedef struct run_step_delta_step_details_tool_calls_function_object_function_t {
    char *name; // string
    char *arguments; // string
    char *output; // string

} run_step_delta_step_details_tool_calls_function_object_function_t;
...
#endif /* _run_step_delta_step_details_tool_calls_function_object_function_H_ */
