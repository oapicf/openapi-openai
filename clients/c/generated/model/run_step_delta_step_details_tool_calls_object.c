...
static run_step_delta_step_details_tool_calls_object_t *run_step_delta_step_details_tool_calls_object_create_internal(
    ...
    run_step_delta_step_details_tool_calls_object_local_var->_library_owned = 1;
    return run_step_delta_step_details_tool_calls_object_local_var;
}

__attribute__((deprecated)) run_step_delta_step_details_tool_calls_object_t *run_step_delta_step_details_tool_calls_object_create(
    openai_api_run_step_delta_step_details_tool_calls_object_TYPE_e type,
    list_t *tool_calls
    ) {
    return run_step_delta_step_details_tool_calls_object_create_internal (
        type,
        tool_calls
        );
}
...
void run_step_delta_step_details_tool_calls_object_free(run_step_delta_step_details_tool_calls_object_t *run_step_delta_step_details_tool_calls_object) {
    ...
    if(run_step_delta_step_details_tool_calls_object->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_step_delta_step_details_tool_calls_object_free");
        return ;
    }
...
cJSON *run_step_delta_step_details_tool_calls_object_convertToJSON(run_step_delta_step_details_tool_calls_object_t *run_step_delta_step_details_tool_calls_object) {
    ...
    if(cJSON_AddStringToObject(item, "type", run_step_delta_step_details_tool_calls_object_type_ToString(run_step_delta_step_details_tool_calls_object->type)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_delta_step_details_tool_calls_object_t *run_step_delta_step_details_tool_calls_object_parseFromJSON(cJSON *run_step_delta_step_details_tool_calls_objectJSON){
    ...
    run_step_delta_step_details_tool_calls_object_local_var = run_step_delta_step_details_tool_calls_object_create_internal (
        typeVariable,
