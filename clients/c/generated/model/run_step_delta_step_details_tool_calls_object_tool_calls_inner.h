...
typedef enum  { openai_api_run_step_delta_step_details_tool_calls_object_tool_calls_inner_TYPE_NULL = 0, openai_api_run_step_delta_step_details_tool_calls_object_tool_calls_inner_TYPE_code_interpreter, openai_api_run_step_delta_step_details_tool_calls_object_tool_calls_inner_TYPE_file_search, openai_api_run_step_delta_step_details_tool_calls_object_tool_calls_inner_TYPE_function } openai_api_run_step_delta_step_details_tool_calls_object_tool_calls_inner_TYPE_e;
