/*
 * run_step_details_message_creation_object.h
 *
 * Details of the message creation by the run step.
 */

#ifndef _run_step_details_message_creation_object_H_
#define _run_step_details_message_creation_object_H_
...
typedef struct run_step_details_message_creation_object_t run_step_details_message_creation_object_t;

#include "run_step_details_message_creation_object_message_creation.h"

// Enum TYPE for run_step_details_message_creation_object

typedef enum  { openai_api_run_step_details_message_creation_object_TYPE_NULL = 0, openai_api_run_step_details_message_creation_object_TYPE_message_creation } openai_api_run_step_details_message_creation_object_TYPE_e;
...
typedef struct run_step_details_message_creation_object_t {
    openai_api_run_step_details_message_creation_object_TYPE_e type; //enum
    struct run_step_details_message_creation_object_message_creation_t *message_creation; //model

} run_step_details_message_creation_object_t;

run_step_details_message_creation_object_t *run_step_details_message_creation_object_create(
...
#endif /* _run_step_details_message_creation_object_H_ */
