/*
 * run_step_details_tool_calls_code_output_image_object.h
 *
 * 
 */

#ifndef _run_step_details_tool_calls_code_output_image_object_H_
#define _run_step_details_tool_calls_code_output_image_object_H_
...
typedef struct run_step_details_tool_calls_code_output_image_object_t run_step_details_tool_calls_code_output_image_object_t;

#include "run_step_details_tool_calls_code_output_image_object_image.h"

// Enum TYPE for run_step_details_tool_calls_code_output_image_object

typedef enum  { openai_api_run_step_details_tool_calls_code_output_image_object_TYPE_NULL = 0, openai_api_run_step_details_tool_calls_code_output_image_object_TYPE_image } openai_api_run_step_details_tool_calls_code_output_image_object_TYPE_e;
...
typedef struct run_step_details_tool_calls_code_output_image_object_t {
    openai_api_run_step_details_tool_calls_code_output_image_object_TYPE_e type; //enum
    struct run_step_details_tool_calls_code_output_image_object_image_t *image; //model

} run_step_details_tool_calls_code_output_image_object_t;
...
#endif /* _run_step_details_tool_calls_code_output_image_object_H_ */
