...
static run_step_details_tool_calls_function_object_t *run_step_details_tool_calls_function_object_create_internal(
    char *id,
    ...
    run_step_details_tool_calls_function_object_local_var->_library_owned = 1;
...
__attribute__((deprecated)) run_step_details_tool_calls_function_object_t *run_step_details_tool_calls_function_object_create(
    ...
    return run_step_details_tool_calls_function_object_create_internal (
        id,
        type,
        function
        );
...
void run_step_details_tool_calls_function_object_free(run_step_details_tool_calls_function_object_t *run_step_details_tool_calls_function_object) {
    ...
    if(run_step_details_tool_calls_function_object->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_step_details_tool_calls_function_object_free");
        return ;
    }
...
cJSON *run_step_details_tool_calls_function_object_convertToJSON(run_step_details_tool_calls_function_object_t *run_step_details_tool_calls_function_object) {
    ...
    if(cJSON_AddStringToObject(item, "type", run_step_details_tool_calls_function_object_type_ToString(run_step_details_tool_calls_function_object->type)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_details_tool_calls_function_object_t *run_step_details_tool_calls_function_object_parseFromJSON(cJSON *run_step_details_tool_calls_function_objectJSON){
    ...
    run_step_details_tool_calls_function_object_local_var = run_step_details_tool_calls_function_object_create_internal (
