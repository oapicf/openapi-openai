/*
 * run_step_details_tool_calls_function_object.h
 *
 * 
 */

#ifndef _run_step_details_tool_calls_function_object_H_
#define _run_step_details_tool_calls_function_object_H_
...
typedef struct run_step_details_tool_calls_function_object_t run_step_details_tool_calls_function_object_t;

#include "run_step_details_tool_calls_function_object_function.h"

// Enum TYPE for run_step_details_tool_calls_function_object

typedef enum  { openai_api_run_step_details_tool_calls_function_object_TYPE_NULL = 0, openai_api_run_step_details_tool_calls_function_object_TYPE_function } openai_api_run_step_details_tool_calls_function_object_TYPE_e;
...
typedef struct run_step_details_tool_calls_function_object_t {
    char *id; // string
    openai_api_run_step_details_tool_calls_function_object_TYPE_e type; //enum
    struct run_step_details_tool_calls_function_object_function_t *function; //model

    int _library_owned; // Is the library responsible for freeing this object?
} run_step_details_tool_calls_function_object_t;

__attribute__((deprecated)) run_step_details_tool_calls_function_object_t *run_step_details_tool_calls_function_object_create(
    char *id,
...
#endif /* _run_step_details_tool_calls_function_object_H_ */
