...
static run_step_object_last_error_t *run_step_object_last_error_create_internal(
    ...
    run_step_object_last_error_local_var->_library_owned = 1;
    return run_step_object_last_error_local_var;
}

__attribute__((deprecated)) run_step_object_last_error_t *run_step_object_last_error_create(
    openai_api_run_step_object_last_error_CODE_e code,
    char *message
    ) {
    return run_step_object_last_error_create_internal (
        code,
        message
        );
}
...
void run_step_object_last_error_free(run_step_object_last_error_t *run_step_object_last_error) {
    ...
    if(run_step_object_last_error->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_step_object_last_error_free");
        return ;
    }
...
cJSON *run_step_object_last_error_convertToJSON(run_step_object_last_error_t *run_step_object_last_error) {
    ...
    if(cJSON_AddStringToObject(item, "code", run_step_object_last_error_code_ToString(run_step_object_last_error->code)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_object_last_error_t *run_step_object_last_error_parseFromJSON(cJSON *run_step_object_last_errorJSON){
    ...
    run_step_object_last_error_local_var = run_step_object_last_error_create_internal (
        codeVariable,
