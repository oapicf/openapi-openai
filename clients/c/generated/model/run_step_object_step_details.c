...
static run_step_object_step_details_t *run_step_object_step_details_create_internal(
    ...
    run_step_object_step_details_local_var->_library_owned = 1;
...
__attribute__((deprecated)) run_step_object_step_details_t *run_step_object_step_details_create(
    ...
    return run_step_object_step_details_create_internal (
        type,
        message_creation,
        tool_calls
        );
...
void run_step_object_step_details_free(run_step_object_step_details_t *run_step_object_step_details) {
    ...
    if(run_step_object_step_details->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_step_object_step_details_free");
        return ;
    }
...
cJSON *run_step_object_step_details_convertToJSON(run_step_object_step_details_t *run_step_object_step_details) {
    ...
    if(cJSON_AddStringToObject(item, "type", run_step_object_step_details_type_ToString(run_step_object_step_details->type)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_object_step_details_t *run_step_object_step_details_parseFromJSON(cJSON *run_step_object_step_detailsJSON){
    ...
    run_step_object_step_details_local_var = run_step_object_step_details_create_internal (
        typeVariable,
