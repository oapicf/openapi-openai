...
run_step_stream_event_t *run_step_stream_event_create(
...
cJSON *run_step_stream_event_convertToJSON(run_step_stream_event_t *run_step_stream_event) {
    ...
    if(cJSON_AddStringToObject(item, "event", eventrun_step_stream_event_ToString(run_step_stream_event->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_stream_event_t *run_step_stream_event_parseFromJSON(cJSON *run_step_stream_eventJSON){
    ...
    run_step_stream_event_local_var = run_step_stream_event_create (
        eventVariable,
        data_local_nonprim
        );
