...
static run_step_stream_event_one_of_t *run_step_stream_event_one_of_create_internal(
    ...
    run_step_stream_event_one_of_local_var->_library_owned = 1;
...
__attribute__((deprecated)) run_step_stream_event_one_of_t *run_step_stream_event_one_of_create(
    ...
    return run_step_stream_event_one_of_create_internal (
        event,
        data
        );
}
...
void run_step_stream_event_one_of_free(run_step_stream_event_one_of_t *run_step_stream_event_one_of) {
    ...
    if(run_step_stream_event_one_of->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_step_stream_event_one_of_free");
        return ;
    }
...
cJSON *run_step_stream_event_one_of_convertToJSON(run_step_stream_event_one_of_t *run_step_stream_event_one_of) {
    ...
    if(cJSON_AddStringToObject(item, "event", run_step_stream_event_one_of_event_ToString(run_step_stream_event_one_of->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_stream_event_one_of_t *run_step_stream_event_one_of_parseFromJSON(cJSON *run_step_stream_event_one_ofJSON){
    ...
    run_step_stream_event_one_of_local_var = run_step_stream_event_one_of_create_internal (
        eventVariable,
        data_local_nonprim
        );
