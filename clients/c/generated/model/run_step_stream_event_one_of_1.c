...
static run_step_stream_event_one_of_1_t *run_step_stream_event_one_of_1_create_internal(
    ...
    run_step_stream_event_one_of_1_local_var->_library_owned = 1;
...
__attribute__((deprecated)) run_step_stream_event_one_of_1_t *run_step_stream_event_one_of_1_create(
    ...
    return run_step_stream_event_one_of_1_create_internal (
        event,
        data
        );
}
...
void run_step_stream_event_one_of_1_free(run_step_stream_event_one_of_1_t *run_step_stream_event_one_of_1) {
    ...
    if(run_step_stream_event_one_of_1->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_step_stream_event_one_of_1_free");
        return ;
    }
...
cJSON *run_step_stream_event_one_of_1_convertToJSON(run_step_stream_event_one_of_1_t *run_step_stream_event_one_of_1) {
    ...
    if(cJSON_AddStringToObject(item, "event", run_step_stream_event_one_of_1_event_ToString(run_step_stream_event_one_of_1->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_stream_event_one_of_1_t *run_step_stream_event_one_of_1_parseFromJSON(cJSON *run_step_stream_event_one_of_1JSON){
    ...
    run_step_stream_event_one_of_1_local_var = run_step_stream_event_one_of_1_create_internal (
        eventVariable,
        data_local_nonprim
        );
