...
static run_step_stream_event_one_of_2_t *run_step_stream_event_one_of_2_create_internal(
    ...
    run_step_stream_event_one_of_2_local_var->_library_owned = 1;
    return run_step_stream_event_one_of_2_local_var;
}

__attribute__((deprecated)) run_step_stream_event_one_of_2_t *run_step_stream_event_one_of_2_create(
    openai_api_run_step_stream_event_one_of_2_EVENT_e event,
    run_step_delta_object_t *data
    ) {
    return run_step_stream_event_one_of_2_create_internal (
        event,
        data
        );
}
...
void run_step_stream_event_one_of_2_free(run_step_stream_event_one_of_2_t *run_step_stream_event_one_of_2) {
    ...
    if(run_step_stream_event_one_of_2->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_step_stream_event_one_of_2_free");
        return ;
    }
...
cJSON *run_step_stream_event_one_of_2_convertToJSON(run_step_stream_event_one_of_2_t *run_step_stream_event_one_of_2) {
    ...
    if(cJSON_AddStringToObject(item, "event", run_step_stream_event_one_of_2_event_ToString(run_step_stream_event_one_of_2->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_stream_event_one_of_2_t *run_step_stream_event_one_of_2_parseFromJSON(cJSON *run_step_stream_event_one_of_2JSON){
    ...
    run_step_stream_event_one_of_2_local_var = run_step_stream_event_one_of_2_create_internal (
        eventVariable,
        data_local_nonprim
        );
