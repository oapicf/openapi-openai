...
cJSON *run_step_stream_event_one_of_3_convertToJSON(run_step_stream_event_one_of_3_t *run_step_stream_event_one_of_3) {
    ...
    if(cJSON_AddStringToObject(item, "event", eventrun_step_stream_event_one_of_3_ToString(run_step_stream_event_one_of_3->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_stream_event_one_of_3_t *run_step_stream_event_one_of_3_parseFromJSON(cJSON *run_step_stream_event_one_of_3JSON){
    ...
    run_step_stream_event_one_of_3_local_var = run_step_stream_event_one_of_3_create (
        eventVariable,
        data_local_nonprim
        );
