...
cJSON *run_step_stream_event_one_of_5_convertToJSON(run_step_stream_event_one_of_5_t *run_step_stream_event_one_of_5) {
    ...
    if(cJSON_AddStringToObject(item, "event", eventrun_step_stream_event_one_of_5_ToString(run_step_stream_event_one_of_5->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_step_stream_event_one_of_5_t *run_step_stream_event_one_of_5_parseFromJSON(cJSON *run_step_stream_event_one_of_5JSON){
    ...
    run_step_stream_event_one_of_5_local_var = run_step_stream_event_one_of_5_create (
        eventVariable,
        data_local_nonprim
        );
