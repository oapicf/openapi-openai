...
static run_stream_event_one_of_1_t *run_stream_event_one_of_1_create_internal(
    ...
    run_stream_event_one_of_1_local_var->_library_owned = 1;
    return run_stream_event_one_of_1_local_var;
}

__attribute__((deprecated)) run_stream_event_one_of_1_t *run_stream_event_one_of_1_create(
    openai_api_run_stream_event_one_of_1_EVENT_e event,
    run_object_t *data
    ) {
    return run_stream_event_one_of_1_create_internal (
        event,
        data
        );
}
...
void run_stream_event_one_of_1_free(run_stream_event_one_of_1_t *run_stream_event_one_of_1) {
    ...
    if(run_stream_event_one_of_1->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_stream_event_one_of_1_free");
        return ;
    }
...
cJSON *run_stream_event_one_of_1_convertToJSON(run_stream_event_one_of_1_t *run_stream_event_one_of_1) {
    ...
    if(cJSON_AddStringToObject(item, "event", run_stream_event_one_of_1_event_ToString(run_stream_event_one_of_1->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_stream_event_one_of_1_t *run_stream_event_one_of_1_parseFromJSON(cJSON *run_stream_event_one_of_1JSON){
    ...
    run_stream_event_one_of_1_local_var = run_stream_event_one_of_1_create_internal (
        eventVariable,
        data_local_nonprim
        );
