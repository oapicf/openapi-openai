...
static run_stream_event_one_of_3_t *run_stream_event_one_of_3_create_internal(
    ...
    run_stream_event_one_of_3_local_var->_library_owned = 1;
    return run_stream_event_one_of_3_local_var;
}

__attribute__((deprecated)) run_stream_event_one_of_3_t *run_stream_event_one_of_3_create(
    openai_api_run_stream_event_one_of_3_EVENT_e event,
    run_object_t *data
    ) {
    return run_stream_event_one_of_3_create_internal (
        event,
        data
        );
}
...
void run_stream_event_one_of_3_free(run_stream_event_one_of_3_t *run_stream_event_one_of_3) {
    ...
    if(run_stream_event_one_of_3->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_stream_event_one_of_3_free");
        return ;
    }
...
cJSON *run_stream_event_one_of_3_convertToJSON(run_stream_event_one_of_3_t *run_stream_event_one_of_3) {
    ...
    if(cJSON_AddStringToObject(item, "event", run_stream_event_one_of_3_event_ToString(run_stream_event_one_of_3->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_stream_event_one_of_3_t *run_stream_event_one_of_3_parseFromJSON(cJSON *run_stream_event_one_of_3JSON){
    ...
    run_stream_event_one_of_3_local_var = run_stream_event_one_of_3_create_internal (
        eventVariable,
        data_local_nonprim
        );
