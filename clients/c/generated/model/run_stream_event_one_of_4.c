...
run_stream_event_one_of_4_t *run_stream_event_one_of_4_create(
...
cJSON *run_stream_event_one_of_4_convertToJSON(run_stream_event_one_of_4_t *run_stream_event_one_of_4) {
    ...
    if(cJSON_AddStringToObject(item, "event", eventrun_stream_event_one_of_4_ToString(run_stream_event_one_of_4->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_stream_event_one_of_4_t *run_stream_event_one_of_4_parseFromJSON(cJSON *run_stream_event_one_of_4JSON){
    ...
    run_stream_event_one_of_4_local_var = run_stream_event_one_of_4_create (
        eventVariable,
        data_local_nonprim
        );
