...
static run_stream_event_one_of_7_t *run_stream_event_one_of_7_create_internal(
    ...
    run_stream_event_one_of_7_local_var->_library_owned = 1;
...
__attribute__((deprecated)) run_stream_event_one_of_7_t *run_stream_event_one_of_7_create(
    ...
    return run_stream_event_one_of_7_create_internal (
        event,
        data
        );
}
...
void run_stream_event_one_of_7_free(run_stream_event_one_of_7_t *run_stream_event_one_of_7) {
    ...
    if(run_stream_event_one_of_7->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_stream_event_one_of_7_free");
        return ;
    }
...
cJSON *run_stream_event_one_of_7_convertToJSON(run_stream_event_one_of_7_t *run_stream_event_one_of_7) {
    ...
    if(cJSON_AddStringToObject(item, "event", run_stream_event_one_of_7_event_ToString(run_stream_event_one_of_7->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_stream_event_one_of_7_t *run_stream_event_one_of_7_parseFromJSON(cJSON *run_stream_event_one_of_7JSON){
    ...
    run_stream_event_one_of_7_local_var = run_stream_event_one_of_7_create_internal (
        eventVariable,
        data_local_nonprim
        );
