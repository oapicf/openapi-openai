...
typedef enum  { openai_api_run_stream_event_one_of_7_EVENT_NULL = 0, openai_api_run_stream_event_one_of_7_EVENT_thread.run.cancelling } openai_api_run_stream_event_one_of_7_EVENT_e;
