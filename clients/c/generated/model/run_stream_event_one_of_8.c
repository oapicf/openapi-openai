...
static run_stream_event_one_of_8_t *run_stream_event_one_of_8_create_internal(
    ...
    run_stream_event_one_of_8_local_var->_library_owned = 1;
...
__attribute__((deprecated)) run_stream_event_one_of_8_t *run_stream_event_one_of_8_create(
    ...
    return run_stream_event_one_of_8_create_internal (
        event,
        data
        );
}
...
void run_stream_event_one_of_8_free(run_stream_event_one_of_8_t *run_stream_event_one_of_8) {
    ...
    if(run_stream_event_one_of_8->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "run_stream_event_one_of_8_free");
        return ;
    }
...
cJSON *run_stream_event_one_of_8_convertToJSON(run_stream_event_one_of_8_t *run_stream_event_one_of_8) {
    ...
    if(cJSON_AddStringToObject(item, "event", run_stream_event_one_of_8_event_ToString(run_stream_event_one_of_8->event)) == NULL)
    {
    goto fail; //Enum
    }
...
run_stream_event_one_of_8_t *run_stream_event_one_of_8_parseFromJSON(cJSON *run_stream_event_one_of_8JSON){
    ...
    run_stream_event_one_of_8_local_var = run_stream_event_one_of_8_create_internal (
        eventVariable,
        data_local_nonprim
        );
