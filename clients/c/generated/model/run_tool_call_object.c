...
run_tool_call_object_t *run_tool_call_object_create(
    char *id,
...
cJSON *run_tool_call_object_convertToJSON(run_tool_call_object_t *run_tool_call_object) {
    ...
    if(cJSON_AddStringToObject(item, "type", typerun_tool_call_object_ToString(run_tool_call_object->type)) == NULL)
    {
    goto fail; //Enum
    }
...
run_tool_call_object_t *run_tool_call_object_parseFromJSON(cJSON *run_tool_call_objectJSON){
    ...
    run_tool_call_object_local_var = run_tool_call_object_create (
