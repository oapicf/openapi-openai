/*
 * static_chunking_strategy_response_param.h
 *
 * 
 */

#ifndef _static_chunking_strategy_response_param_H_
#define _static_chunking_strategy_response_param_H_
...
typedef struct static_chunking_strategy_response_param_t static_chunking_strategy_response_param_t;

#include "static_chunking_strategy.h"

// Enum TYPE for static_chunking_strategy_response_param

typedef enum  { openai_api_static_chunking_strategy_response_param_TYPE_NULL = 0, openai_api_static_chunking_strategy_response_param_TYPE__static } openai_api_static_chunking_strategy_response_param_TYPE_e;
...
typedef struct static_chunking_strategy_response_param_t {
    openai_api_static_chunking_strategy_response_param_TYPE_e type; //enum
    struct static_chunking_strategy_t *_static; //model

    int _library_owned; // Is the library responsible for freeing this object?
} static_chunking_strategy_response_param_t;
...
#endif /* _static_chunking_strategy_response_param_H_ */
