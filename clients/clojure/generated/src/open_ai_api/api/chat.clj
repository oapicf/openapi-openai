...
(defn-spec create-chat-completion-with-http-info any?
  "Creates a model response for the given chat conversation."
  [create-chat-completion-request create-chat-completion-request]
  (check-required-params create-chat-completion-request)
  (call-api "/chat/completions" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    create-chat-completion-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["ApiKeyAuth"]}))

(defn-spec create-chat-completion create-chat-completion-response-spec
  "Creates a model response for the given chat conversation."
  [create-chat-completion-request create-chat-completion-request]
  (let [res (:data (create-chat-completion-with-http-info create-chat-completion-request))]
    (if (:decode-models *api-context*)
       (st/decode create-chat-completion-response-spec res st/string-transformer)
       res)))
