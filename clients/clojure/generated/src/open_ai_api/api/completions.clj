(ns open-ai-api.api.completions
...
(defn-spec create-completion-with-http-info any?
  "Creates a completion for the provided prompt and parameters."
  [create-completion-request create-completion-request]
  (check-required-params create-completion-request)
  (call-api "/completions" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    create-completion-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["ApiKeyAuth"]}))

(defn-spec create-completion create-completion-response-spec
  "Creates a completion for the provided prompt and parameters."
  [create-completion-request create-completion-request]
  (let [res (:data (create-completion-with-http-info create-completion-request))]
    (if (:decode-models *api-context*)
       (st/decode create-completion-response-spec res st/string-transformer)
       res)))
