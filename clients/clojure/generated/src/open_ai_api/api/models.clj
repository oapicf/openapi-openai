...
(defn-spec delete-model-with-http-info any?
  "Delete a fine-tuned model. You must have the Owner role in your organization to delete a model."
  [model string?]
  (check-required-params model)
  (call-api "/models/{model}" :delete
            {:path-params   {"model" model }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec delete-model delete-model-response-spec
  "Delete a fine-tuned model. You must have the Owner role in your organization to delete a model."
  [model string?]
  (let [res (:data (delete-model-with-http-info model))]
    (if (:decode-models *api-context*)
       (st/decode delete-model-response-spec res st/string-transformer)
       res)))


(defn-spec list-models-with-http-info any?
...
(defn-spec list-models list-models-response-spec
  "Lists the currently available models, and provides basic information about each one such as the owner and availability."
  []
  (let [res (:data (list-models-with-http-info))]
    (if (:decode-models *api-context*)
       (st/decode list-models-response-spec res st/string-transformer)
       res)))


(defn-spec retrieve-model-with-http-info any?
  "Retrieves a model instance, providing basic information about the model such as the owner and permissioning."
  [model string?]
  (check-required-params model)
  (call-api "/models/{model}" :get
            {:path-params   {"model" model }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec retrieve-model model-spec
  "Retrieves a model instance, providing basic information about the model such as the owner and permissioning."
  [model string?]
  (let [res (:data (retrieve-model-with-http-info model))]
    (if (:decode-models *api-context*)
