(ns open-ai-api.api.moderations
...
(defn-spec create-moderation-with-http-info any?
  "Classifies if text is potentially harmful."
  [create-moderation-request create-moderation-request]
  (check-required-params create-moderation-request)
  (call-api "/moderations" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    create-moderation-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["ApiKeyAuth"]}))

(defn-spec create-moderation create-moderation-response-spec
  "Classifies if text is potentially harmful."
  [create-moderation-request create-moderation-request]
  (let [res (:data (create-moderation-with-http-info create-moderation-request))]
    (if (:decode-models *api-context*)
       (st/decode create-moderation-response-spec res st/string-transformer)
       res)))
