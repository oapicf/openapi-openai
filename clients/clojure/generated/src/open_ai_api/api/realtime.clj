...
(defn-spec create-realtime-session-with-http-info any?
...
for the Realtime API."
  [realtime-session-create-request realtime-session-create-request]
  (check-required-params realtime-session-create-request)
  (call-api "/realtime/sessions" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    realtime-session-create-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["ApiKeyAuth"]}))

(defn-spec create-realtime-session realtime-session-create-response-spec
  "Create an ephemeral API token for use in client-side applications with the
Realtime API. Can be configured with the same session parameters as the
`session.update` client event.
...
for the Realtime API."
  [realtime-session-create-request realtime-session-create-request]
  (let [res (:data (create-realtime-session-with-http-info realtime-session-create-request))]
    (if (:decode-models *api-context*)
       (st/decode realtime-session-create-response-spec res st/string-transformer)
       res)))
