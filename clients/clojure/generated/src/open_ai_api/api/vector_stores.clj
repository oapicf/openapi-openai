(ns open-ai-api.api.vector-stores
...
(defn-spec cancel-vector-store-file-batch-with-http-info any?
  "Cancel a vector store file batch. This attempts to cancel the processing of files in this batch as soon as possible."
  [vector_store_id string?, batch_id string?]
  (check-required-params vector_store_id batch_id)
  (call-api "/vector_stores/{vector_store_id}/file_batches/{batch_id}/cancel" :post
            {:path-params   {"vector_store_id" vector_store_id "batch_id" batch_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec cancel-vector-store-file-batch vector-store-file-batch-object-spec
  "Cancel a vector store file batch. This attempts to cancel the processing of files in this batch as soon as possible."
  [vector_store_id string?, batch_id string?]
  (let [res (:data (cancel-vector-store-file-batch-with-http-info vector_store_id batch_id))]
    (if (:decode-models *api-context*)
       (st/decode vector-store-file-batch-object-spec res st/string-transformer)
       res)))


(defn-spec create-vector-store-with-http-info any?
  "Create a vector store."
  [create-vector-store-request create-vector-store-request]
  (check-required-params create-vector-store-request)
  (call-api "/vector_stores" :post
            {:path-params   {}
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    create-vector-store-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["ApiKeyAuth"]}))

(defn-spec create-vector-store vector-store-object-spec
  "Create a vector store."
  [create-vector-store-request create-vector-store-request]
  (let [res (:data (create-vector-store-with-http-info create-vector-store-request))]
    (if (:decode-models *api-context*)
       (st/decode vector-store-object-spec res st/string-transformer)
       res)))


(defn-spec create-vector-store-file-with-http-info any?
  "Create a vector store file by attaching a [File](/docs/api-reference/files) to a [vector store](/docs/api-reference/vector-stores/object)."
  [vector_store_id string?, create-vector-store-file-request create-vector-store-file-request]
  (check-required-params vector_store_id create-vector-store-file-request)
  (call-api "/vector_stores/{vector_store_id}/files" :post
            {:path-params   {"vector_store_id" vector_store_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    create-vector-store-file-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["ApiKeyAuth"]}))

(defn-spec create-vector-store-file vector-store-file-object-spec
  "Create a vector store file by attaching a [File](/docs/api-reference/files) to a [vector store](/docs/api-reference/vector-stores/object)."
  [vector_store_id string?, create-vector-store-file-request create-vector-store-file-request]
  (let [res (:data (create-vector-store-file-with-http-info vector_store_id create-vector-store-file-request))]
    (if (:decode-models *api-context*)
       (st/decode vector-store-file-object-spec res st/string-transformer)
       res)))


(defn-spec create-vector-store-file-batch-with-http-info any?
  "Create a vector store file batch."
  [vector_store_id string?, create-vector-store-file-batch-request create-vector-store-file-batch-request]
  (check-required-params vector_store_id create-vector-store-file-batch-request)
  (call-api "/vector_stores/{vector_store_id}/file_batches" :post
            {:path-params   {"vector_store_id" vector_store_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    create-vector-store-file-batch-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["ApiKeyAuth"]}))

(defn-spec create-vector-store-file-batch vector-store-file-batch-object-spec
  "Create a vector store file batch."
  [vector_store_id string?, create-vector-store-file-batch-request create-vector-store-file-batch-request]
  (let [res (:data (create-vector-store-file-batch-with-http-info vector_store_id create-vector-store-file-batch-request))]
    (if (:decode-models *api-context*)
       (st/decode vector-store-file-batch-object-spec res st/string-transformer)
       res)))


(defn-spec delete-vector-store-with-http-info any?
  "Delete a vector store."
  [vector_store_id string?]
  (check-required-params vector_store_id)
  (call-api "/vector_stores/{vector_store_id}" :delete
            {:path-params   {"vector_store_id" vector_store_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec delete-vector-store delete-vector-store-response-spec
  "Delete a vector store."
  [vector_store_id string?]
  (let [res (:data (delete-vector-store-with-http-info vector_store_id))]
    (if (:decode-models *api-context*)
       (st/decode delete-vector-store-response-spec res st/string-transformer)
       res)))


(defn-spec delete-vector-store-file-with-http-info any?
  "Delete a vector store file. This will remove the file from the vector store but the file itself will not be deleted. To delete the file, use the [delete file](/docs/api-reference/files/delete) endpoint."
  [vector_store_id string?, file_id string?]
  (check-required-params vector_store_id file_id)
  (call-api "/vector_stores/{vector_store_id}/files/{file_id}" :delete
            {:path-params   {"vector_store_id" vector_store_id "file_id" file_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :content-types []
...
(defn-spec delete-vector-store-file delete-vector-store-file-response-spec
  "Delete a vector store file. This will remove the file from the vector store but the file itself will not be deleted. To delete the file, use the [delete file](/docs/api-reference/files/delete) endpoint."
  [vector_store_id string?, file_id string?]
  (let [res (:data (delete-vector-store-file-with-http-info vector_store_id file_id))]
    (if (:decode-models *api-context*)
       (st/decode delete-vector-store-file-response-spec res st/string-transformer)
       res)))


(defn-spec get-vector-store-with-http-info any?
  "Retrieves a vector store."
  [vector_store_id string?]
  (check-required-params vector_store_id)
  (call-api "/vector_stores/{vector_store_id}" :get
            {:path-params   {"vector_store_id" vector_store_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec get-vector-store vector-store-object-spec
  "Retrieves a vector store."
  [vector_store_id string?]
  (let [res (:data (get-vector-store-with-http-info vector_store_id))]
    (if (:decode-models *api-context*)
       (st/decode vector-store-object-spec res st/string-transformer)
       res)))


(defn-spec get-vector-store-file-with-http-info any?
  "Retrieves a vector store file."
  [vector_store_id string?, file_id string?]
  (check-required-params vector_store_id file_id)
  (call-api "/vector_stores/{vector_store_id}/files/{file_id}" :get
            {:path-params   {"vector_store_id" vector_store_id "file_id" file_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec get-vector-store-file vector-store-file-object-spec
  "Retrieves a vector store file."
  [vector_store_id string?, file_id string?]
  (let [res (:data (get-vector-store-file-with-http-info vector_store_id file_id))]
    (if (:decode-models *api-context*)
       (st/decode vector-store-file-object-spec res st/string-transformer)
       res)))


(defn-spec get-vector-store-file-batch-with-http-info any?
  "Retrieves a vector store file batch."
  [vector_store_id string?, batch_id string?]
  (check-required-params vector_store_id batch_id)
  (call-api "/vector_stores/{vector_store_id}/file_batches/{batch_id}" :get
            {:path-params   {"vector_store_id" vector_store_id "batch_id" batch_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
...
(defn-spec get-vector-store-file-batch vector-store-file-batch-object-spec
  "Retrieves a vector store file batch."
  [vector_store_id string?, batch_id string?]
  (let [res (:data (get-vector-store-file-batch-with-http-info vector_store_id batch_id))]
    (if (:decode-models *api-context*)
       (st/decode vector-store-file-batch-object-spec res st/string-transformer)
       res)))


(defn-spec list-files-in-vector-store-batch-with-http-info any?
  "Returns a list of vector store files in a batch."
  ([vector_store_id string?, batch_id string?, ] (list-files-in-vector-store-batch-with-http-info vector_store_id batch_id nil))
  ([vector_store_id string?, batch_id string?, {:keys [limit order after before filter]} (s/map-of keyword? any?)]
   (check-required-params vector_store_id batch_id)
   (call-api "/vector_stores/{vector_store_id}/file_batches/{batch_id}/files" :get
             {:path-params   {"vector_store_id" vector_store_id "batch_id" batch_id }
              :header-params {}
              :query-params  {"limit" limit "order" order "after" after "before" before "filter" filter }
              :form-params   {}
              :content-types []
              :accepts       ["application/json"]
              :auth-names    ["ApiKeyAuth"]})))

(defn-spec list-files-in-vector-store-batch list-vector-store-files-response-spec
  "Returns a list of vector store files in a batch."
  ([vector_store_id string?, batch_id string?, ] (list-files-in-vector-store-batch vector_store_id batch_id nil))
  ([vector_store_id string?, batch_id string?, optional-params any?]
   (let [res (:data (list-files-in-vector-store-batch-with-http-info vector_store_id batch_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode list-vector-store-files-response-spec res st/string-transformer)
        res))))


(defn-spec list-vector-store-files-with-http-info any?
  "Returns a list of vector store files."
  ([vector_store_id string?, ] (list-vector-store-files-with-http-info vector_store_id nil))
  ([vector_store_id string?, {:keys [limit order after before filter]} (s/map-of keyword? any?)]
   (check-required-params vector_store_id)
   (call-api "/vector_stores/{vector_store_id}/files" :get
             {:path-params   {"vector_store_id" vector_store_id }
              :header-params {}
              :query-params  {"limit" limit "order" order "after" after "before" before "filter" filter }
              :form-params   {}
...
(defn-spec list-vector-store-files list-vector-store-files-response-spec
  "Returns a list of vector store files."
  ([vector_store_id string?, ] (list-vector-store-files vector_store_id nil))
  ([vector_store_id string?, optional-params any?]
   (let [res (:data (list-vector-store-files-with-http-info vector_store_id optional-params))]
     (if (:decode-models *api-context*)
        (st/decode list-vector-store-files-response-spec res st/string-transformer)
        res))))


(defn-spec list-vector-stores-with-http-info any?
  "Returns a list of vector stores."
  ([] (list-vector-stores-with-http-info nil))
  ([{:keys [limit order after before]} (s/map-of keyword? any?)]
   (call-api "/vector_stores" :get
             {:path-params   {}
              :header-params {}
...
(defn-spec list-vector-stores list-vector-stores-response-spec
  "Returns a list of vector stores."
  ([] (list-vector-stores nil))
  ([optional-params any?]
   (let [res (:data (list-vector-stores-with-http-info optional-params))]
     (if (:decode-models *api-context*)
        (st/decode list-vector-stores-response-spec res st/string-transformer)
        res))))


(defn-spec modify-vector-store-with-http-info any?
  "Modifies a vector store."
  [vector_store_id string?, update-vector-store-request update-vector-store-request]
  (check-required-params vector_store_id update-vector-store-request)
  (call-api "/vector_stores/{vector_store_id}" :post
            {:path-params   {"vector_store_id" vector_store_id }
             :header-params {}
             :query-params  {}
             :form-params   {}
             :body-param    update-vector-store-request
             :content-types ["application/json"]
             :accepts       ["application/json"]
             :auth-names    ["ApiKeyAuth"]}))

(defn-spec modify-vector-store vector-store-object-spec
  "Modifies a vector store."
  [vector_store_id string?, update-vector-store-request update-vector-store-request]
  (let [res (:data (modify-vector-store-with-http-info vector_store_id update-vector-store-request))]
    (if (:decode-models *api-context*)
       (st/decode vector-store-object-spec res st/string-transformer)
       res)))
