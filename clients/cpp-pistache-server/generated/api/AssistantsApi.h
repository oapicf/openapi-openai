...
private:
    ...
    /// <param name="includeLeft_Square_BracketRight_Square_Bracket">A list of additional fields to include in the response. Currently the only supported value is &#x60;step_details.tool_calls[*].file_search.results[*].content&#x60; to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information.  (optional, default to std::vector&lt;std::shared_ptr&lt;std::string&gt;&gt;())</param>
    virtual void create_run(const HttpBearerToken &accessToken,  const std::string &threadId, const org::openapitools::server::model::CreateRunRequest &createRunRequest, const std::optional<std::vector<std::string>> &includeLeft_Square_BracketRight_Square_Bracket, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Create a thread.
    /// </summary>
    /// <remarks>
    ...
    virtual void delete_message(const HttpBearerToken &accessToken,  const std::string &threadId, const std::string &messageId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Delete a thread.
    /// </summary>
    /// <remarks>
    ...
    /// <param name="includeLeft_Square_BracketRight_Square_Bracket">A list of additional fields to include in the response. Currently the only supported value is &#x60;step_details.tool_calls[*].file_search.results[*].content&#x60; to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information.  (optional, default to std::vector&lt;std::shared_ptr&lt;std::string&gt;&gt;())</param>
    virtual void get_run_step(const HttpBearerToken &accessToken,  const std::string &threadId, const std::string &runId, const std::string &stepId, const std::optional<std::vector<std::string>> &includeLeft_Square_BracketRight_Square_Bracket, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Retrieves a thread.
    /// </summary>
    /// <remarks>
    ...
    /// <param name="before">A cursor for use in pagination. &#x60;before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with obj_foo, your subsequent call can include before&#x3D;obj_foo in order to fetch the previous page of the list.  (optional, default to &quot;&quot;)</param>
    /// <param name="includeLeft_Square_BracketRight_Square_Bracket">A list of additional fields to include in the response. Currently the only supported value is &#x60;step_details.tool_calls[*].file_search.results[*].content&#x60; to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information.  (optional, default to std::vector&lt;std::shared_ptr&lt;std::string&gt;&gt;())</param>
    virtual void list_run_steps(const HttpBearerToken &accessToken,  const std::string &threadId, const std::string &runId, const std::optional<int32_t> &limit, const std::optional<std::string> &order, const std::optional<std::string> &after, const std::optional<std::string> &before, const std::optional<std::vector<std::string>> &includeLeft_Square_BracketRight_Square_Bracket, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
