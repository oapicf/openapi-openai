...
private:
    ...
    virtual void create_speech(const HttpBearerToken &accessToken,  const org::openapitools::server::model::CreateSpeechRequest &createSpeechRequest, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
