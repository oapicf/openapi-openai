...
class  ImagesApi : public ApiBase {
public:
    explicit ImagesApi(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~ImagesApi() override = default;
    void init() override;
...
private:
    ...
    void images_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    ...
    virtual void create_image(const HttpBearerToken &accessToken,  const org::openapitools::server::model::CreateImageRequest &createImageRequest, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
