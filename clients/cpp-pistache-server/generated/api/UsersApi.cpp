...
const std::string UsersApi::base = "/v1";
...
void UsersApi::setupRoutes() {
    ...
    Routes::Delete(*router, base + "/organization/users/:user_id", Routes::bind(&UsersApi::delete_user_handler, this));
    Routes::Get(*router, base + "/organization/users", Routes::bind(&UsersApi::list_users_handler, this));
    Routes::Post(*router, base + "/organization/users/:user_id", Routes::bind(&UsersApi::modify_user_handler, this));
    Routes::Get(*router, base + "/organization/users/:user_id", Routes::bind(&UsersApi::retrieve_user_handler, this));

    // Default handler, called when a route is not found
    router->addCustomHandler(Routes::bind(&UsersApi::users_api_default_handler, this));
}

void UsersApi::handleParsingException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept {
...
void UsersApi::handleOperationException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept {
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->delete_user(bearerToken,userId, response);
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/organization/users/:user_id" 
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->list_users(bearerToken,limit, after, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/organization/users" 
    static_assert(HTTP_BASIC_AUTH_DEFINED + HTTP_BEARER_AUTH_DEFINED < 2, "Path '" REST_PATH "' has more than one security scheme specified, and the Pistache server generator does not support that.");
#undef REST_PATH
#ifdef HTTP_BEARER_AUTH_DEFINED
#undef HTTP_BEARER_AUTH_DEFINED
...
void UsersApi::modify_user_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(userRoleUpdateRequest);
            userRoleUpdateRequest.validate();
        } catch (std::exception& e) {
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->modify_user(bearerToken,userId, userRoleUpdateRequest, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void UsersApi::retrieve_user_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->retrieve_user(bearerToken,userId, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
