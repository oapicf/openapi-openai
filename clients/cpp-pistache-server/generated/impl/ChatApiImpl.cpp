...
void ChatApiImpl::create_chat_completion(const HttpBearerToken &bearerToken, const CreateChatCompletionRequest &createChatCompletionRequest, Pistache::Http::ResponseWriter &response) {
