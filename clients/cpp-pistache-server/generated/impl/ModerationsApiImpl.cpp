...
ModerationsApiImpl::ModerationsApiImpl(const std::shared_ptr<Pistache::Rest::Router>& rtr)
    : ModerationsApi(rtr)
{
...
void ModerationsApiImpl::create_moderation(const HttpBearerToken &bearerToken, const CreateModerationRequest &createModerationRequest, Pistache::Http::ResponseWriter &response) {
