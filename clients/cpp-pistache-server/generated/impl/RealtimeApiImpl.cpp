...
RealtimeApiImpl::RealtimeApiImpl(const std::shared_ptr<Pistache::Rest::Router>& rtr)
    : RealtimeApi(rtr)
{
...
void RealtimeApiImpl::create_realtime_session(const HttpBearerToken &bearerToken, const RealtimeSessionCreateRequest &realtimeSessionCreateRequest, Pistache::Http::ResponseWriter &response) {
