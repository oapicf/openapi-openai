...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::AssistantObject_tool_resources getToolResources() const;
    void setToolResources(org::openapitools::server::model::AssistantObject_tool_resources const& value);
...
protected:
    ...
    org::openapitools::server::model::AssistantObject_tool_resources m_Tool_resources;
