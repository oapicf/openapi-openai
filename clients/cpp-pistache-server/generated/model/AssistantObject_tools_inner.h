...
public:
    ...
    bool operator==(const AssistantObject_tools_inner& rhs) const;
    bool operator!=(const AssistantObject_tools_inner& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AssistantObject_tools_inner& o);
    friend  void from_json(const nlohmann::json& j, AssistantObject_tools_inner& o);
protected:
    std::string m_Type;
