...
org::openapitools::server::model::AssistantsNamedToolChoice_function AssistantsApiToolChoiceOption::getFunction() const
{
    return m_Function;
}
void AssistantsApiToolChoiceOption::setFunction(org::openapitools::server::model::AssistantsNamedToolChoice_function const& value)
{
    m_Function = value;
