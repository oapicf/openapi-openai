...
org::openapitools::server::model::AssistantsNamedToolChoice_function ChatCompletionNamedToolChoice::getFunction() const
{
    return m_Function;
}
void ChatCompletionNamedToolChoice::setFunction(org::openapitools::server::model::AssistantsNamedToolChoice_function const& value)
{
    m_Function = value;
}
