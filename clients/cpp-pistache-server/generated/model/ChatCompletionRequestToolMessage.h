...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::ChatCompletionRequestToolMessage_content getContent() const;
    void setContent(org::openapitools::server::model::ChatCompletionRequestToolMessage_content const& value);
    /// <summary>
...
protected:
    ...
    org::openapitools::server::model::ChatCompletionRequestToolMessage_content m_Content;
