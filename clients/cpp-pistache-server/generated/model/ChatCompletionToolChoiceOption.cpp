...
org::openapitools::server::model::AssistantsNamedToolChoice_function ChatCompletionToolChoiceOption::getFunction() const
{
    return m_Function;
}
void ChatCompletionToolChoiceOption::setFunction(org::openapitools::server::model::AssistantsNamedToolChoice_function const& value)
{
    m_Function = value;
}
