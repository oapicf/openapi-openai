...
org::openapitools::server::model::Object CreateAssistantRequest::getMetadata() const
{
    return m_Metadata;
}
void CreateAssistantRequest::setMetadata(org::openapitools::server::model::Object const& value)
{
    m_Metadata = value;
