...
bool CreateChatCompletionRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (seedIsSet())
    {
        ...
        {
            success = false;
            msg << currentValuePath << ": must be greater than or equal to -9223372036854776000;";
        }
        if (value > 9223372036854776000)
        {
            success = false;
            msg << currentValuePath << ": must be less than or equal to 9223372036854776000;";
        }
...
bool CreateChatCompletionRequest::operator==(const CreateChatCompletionRequest& rhs) const
{
    ...
    ((!storeIsSet() && !rhs.storeIsSet()) || (storeIsSet() && rhs.storeIsSet() && isStore() == rhs.isStore())) &&
    
    
    ((!reasoningEffortIsSet() && !rhs.reasoningEffortIsSet()) || (reasoningEffortIsSet() && rhs.reasoningEffortIsSet() && getReasoningEffort() == rhs.getReasoningEffort())) &&
    ...
    ((!predictionIsSet() && !rhs.predictionIsSet()) || (predictionIsSet() && rhs.predictionIsSet() && getPrediction() == rhs.getPrediction())) &&
    ...
    ((!serviceTierIsSet() && !rhs.serviceTierIsSet()) || (serviceTierIsSet() && rhs.serviceTierIsSet() && getServiceTier() == rhs.getServiceTier())) &&
    ...
    ((!streamOptionsIsSet() && !rhs.streamOptionsIsSet()) || (streamOptionsIsSet() && rhs.streamOptionsIsSet() && getStreamOptions() == rhs.getStreamOptions())) &&
...
void to_json(nlohmann::json& j, const CreateChatCompletionRequest& o)
{
    ...
    if(o.storeIsSet())
        j["store"] = o.m_Store;
    if(o.reasoningEffortIsSet())
        j["reasoning_effort"] = o.m_Reasoning_effort;
    ...
    if(o.predictionIsSet())
        j["prediction"] = o.m_Prediction;
    if(o.audioIsSet())
        j["audio"] = o.m_Audio;
    ...
    if(o.seedIsSet())
        j["seed"] = o.m_Seed;
    if(o.serviceTierIsSet())
        j["service_tier"] = o.m_Service_tier;
    if(o.stopIsSet())
        j["stop"] = o.m_Stop;
    if(o.streamIsSet())
        j["stream"] = o.m_Stream;
    if(o.streamOptionsIsSet())
        j["stream_options"] = o.m_Stream_options;
...
void from_json(const nlohmann::json& j, CreateChatCompletionRequest& o)
{
    ...
    if(j.find("store") != j.end())
    {
        j.at("store").get_to(o.m_Store);
        o.m_StoreIsSet = true;
    } 
    if(j.find("reasoning_effort") != j.end())
    {
        j.at("reasoning_effort").get_to(o.m_Reasoning_effort);
        o.m_Reasoning_effortIsSet = true;
    } 
    ...
    {
        j.at("prediction").get_to(o.m_Prediction);
        o.m_PredictionIsSet = true;
    } 
    ...
    if(j.find("service_tier") != j.end())
    {
        j.at("service_tier").get_to(o.m_Service_tier);
        o.m_Service_tierIsSet = true;
    } 
    ...
    if(j.find("stream_options") != j.end())
    {
        j.at("stream_options").get_to(o.m_Stream_options);
        o.m_Stream_optionsIsSet = true;
    } 
...
void CreateChatCompletionRequest::setStore(bool const value)
{
    m_Store = value;
    m_StoreIsSet = true;
}
...
void CreateChatCompletionRequest::setReasoningEffort(std::string const& value)
{
...
void CreateChatCompletionRequest::setMetadata(std::map<std::string, std::string> const& value)
{
    m_Metadata = value;
...
void CreateChatCompletionRequest::setMaxCompletionTokens(int32_t const value)
{
...
void CreateChatCompletionRequest::setModalities(std::vector<std::string> const& value)
{
    m_Modalities = value;
...
org::openapitools::server::model::PredictionContent CreateChatCompletionRequest::getPrediction() const
{
    return m_Prediction;
}
void CreateChatCompletionRequest::setPrediction(org::openapitools::server::model::PredictionContent const& value)
{
    m_Prediction = value;
    m_PredictionIsSet = true;
}
bool CreateChatCompletionRequest::predictionIsSet() const
{
    return m_PredictionIsSet;
}
void CreateChatCompletionRequest::unsetPrediction()
{
    m_PredictionIsSet = false;
}
org::openapitools::server::model::CreateChatCompletionRequest_audio CreateChatCompletionRequest::getAudio() const
{
    return m_Audio;
}
void CreateChatCompletionRequest::setAudio(org::openapitools::server::model::CreateChatCompletionRequest_audio const& value)
{
    m_Audio = value;
    m_AudioIsSet = true;
}
...
void CreateChatCompletionRequest::setServiceTier(std::string const& value)
{
...
org::openapitools::server::model::ChatCompletionStreamOptions CreateChatCompletionRequest::getStreamOptions() const
{
    return m_Stream_options;
}
void CreateChatCompletionRequest::setStreamOptions(org::openapitools::server::model::ChatCompletionStreamOptions const& value)
{
...
void CreateChatCompletionRequest::setParallelToolCalls(bool const value)
{
