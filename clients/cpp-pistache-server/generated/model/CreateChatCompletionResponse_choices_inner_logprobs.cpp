...
bool CreateChatCompletionResponse_choices_inner_logprobs::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    /* Refusal */ {
        const std::vector<org::openapitools::server::model::ChatCompletionTokenLogprob>& value = m_Refusal;
        const std::string currentValuePath = _pathPrefix + ".refusal";
        ...
        success = value.validate(msg, currentValuePath + ".refusal") && success;
...
std::vector<org::openapitools::server::model::ChatCompletionTokenLogprob> CreateChatCompletionResponse_choices_inner_logprobs::getRefusal() const
{
    return m_Refusal;
}
void CreateChatCompletionResponse_choices_inner_logprobs::setRefusal(std::vector<org::openapitools::server::model::ChatCompletionTokenLogprob> const& value)
{
    m_Refusal = value;
}
