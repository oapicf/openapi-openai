...
void CreateChatCompletionStreamResponse::setServiceTier(std::string const& value)
{
...
org::openapitools::server::model::CreateChatCompletionStreamResponse_usage CreateChatCompletionStreamResponse::getUsage() const
{
    return m_Usage;
}
void CreateChatCompletionStreamResponse::setUsage(org::openapitools::server::model::CreateChatCompletionStreamResponse_usage const& value)
{
    m_Usage = value;
    m_UsageIsSet = true;
}
