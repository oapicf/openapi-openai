...
bool CreateCompletionRequest::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_Prompt.validate(msg, _pathPrefix + ".prompt")) {
...
org::openapitools::server::model::ChatCompletionStreamOptions CreateCompletionRequest::getStreamOptions() const
{
    return m_Stream_options;
}
void CreateCompletionRequest::setStreamOptions(org::openapitools::server::model::ChatCompletionStreamOptions const& value)
{
