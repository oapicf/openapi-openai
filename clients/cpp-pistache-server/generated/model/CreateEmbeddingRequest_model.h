...
public:
    ...
    bool operator==(const CreateEmbeddingRequest_model& rhs) const;
    bool operator!=(const CreateEmbeddingRequest_model& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const CreateEmbeddingRequest_model& o);
    friend  void from_json(const nlohmann::json& j, CreateEmbeddingRequest_model& o);
protected:
