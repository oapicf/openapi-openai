...
org::openapitools::server::model::FineTuneMethod CreateFineTuningJobRequest::getMethod() const
{
    return m_Method;
}
void CreateFineTuningJobRequest::setMethod(org::openapitools::server::model::FineTuneMethod const& value)
{
    m_Method = value;
    m_MethodIsSet = true;
}
