...
bool CreateModerationResponse_results_inner::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_Categories.validate(msg, _pathPrefix + ".categories")) {
        msg << _pathPrefix << ": Categories is invalid;";
        success = false;
    }    
    if (!m_Category_scores.validate(msg, _pathPrefix + ".categoryScores")) {
        msg << _pathPrefix << ": Category_scores is invalid;";
        success = false;
    }    
    if (!m_Category_applied_input_types.validate(msg, _pathPrefix + ".categoryAppliedInputTypes")) {
        msg << _pathPrefix << ": Category_applied_input_types is invalid;";
        success = false;
    }
    return success;
}
...
bool CreateModerationResponse_results_inner::operator==(const CreateModerationResponse_results_inner& rhs) const
{
    ...
    (getCategoryAppliedInputTypes() == rhs.getCategoryAppliedInputTypes())
...
void to_json(nlohmann::json& j, const CreateModerationResponse_results_inner& o)
{
    ...
    j["category_applied_input_types"] = o.m_Category_applied_input_types;
...
void from_json(const nlohmann::json& j, CreateModerationResponse_results_inner& o)
{
    ...
    j.at("category_applied_input_types").get_to(o.m_Category_applied_input_types);
...
org::openapitools::server::model::CreateModerationResponse_results_inner_category_applied_input_types CreateModerationResponse_results_inner::getCategoryAppliedInputTypes() const
{
    return m_Category_applied_input_types;
}
void CreateModerationResponse_results_inner::setCategoryAppliedInputTypes(org::openapitools::server::model::CreateModerationResponse_results_inner_category_applied_input_types const& value)
{
