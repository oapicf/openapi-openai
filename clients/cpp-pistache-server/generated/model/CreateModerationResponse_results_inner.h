...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::CreateModerationResponse_results_inner_category_applied_input_types getCategoryAppliedInputTypes() const;
    void setCategoryAppliedInputTypes(org::openapitools::server::model::CreateModerationResponse_results_inner_category_applied_input_types const& value);
...
protected:
    ...
    org::openapitools::server::model::CreateModerationResponse_results_inner_category_applied_input_types m_Category_applied_input_types;
