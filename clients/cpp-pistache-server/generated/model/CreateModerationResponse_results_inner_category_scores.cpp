...
void CreateModerationResponse_results_inner_category_scores::setIllicit(double const value)
{
    m_Illicit = value;
}
...
void CreateModerationResponse_results_inner_category_scores::setIllicitViolent(double const value)
{
