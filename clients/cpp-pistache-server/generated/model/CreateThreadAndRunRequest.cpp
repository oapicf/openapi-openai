...
org::openapitools::server::model::Object CreateThreadAndRunRequest::getMetadata() const
{
    return m_Metadata;
}
void CreateThreadAndRunRequest::setMetadata(org::openapitools::server::model::Object const& value)
{
    m_Metadata = value;
