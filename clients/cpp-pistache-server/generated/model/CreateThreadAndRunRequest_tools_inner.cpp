...
org::openapitools::server::model::AssistantToolsFileSearch_file_search CreateThreadAndRunRequest_tools_inner::getFileSearch() const
{
    return m_File_search;
}
void CreateThreadAndRunRequest_tools_inner::setFileSearch(org::openapitools::server::model::AssistantToolsFileSearch_file_search const& value)
{
    m_File_search = value;
    m_File_searchIsSet = true;
}
bool CreateThreadAndRunRequest_tools_inner::fileSearchIsSet() const
{
    return m_File_searchIsSet;
}
void CreateThreadAndRunRequest_tools_inner::unsetFile_search()
{
    m_File_searchIsSet = false;
}
