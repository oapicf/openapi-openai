...
org::openapitools::server::model::CreateThreadRequest_tool_resources CreateThreadRequest::getToolResources() const
{
    return m_Tool_resources;
}
void CreateThreadRequest::setToolResources(org::openapitools::server::model::CreateThreadRequest_tool_resources const& value)
{
