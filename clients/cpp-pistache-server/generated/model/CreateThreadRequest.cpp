...
org::openapitools::server::model::Object CreateThreadRequest::getMetadata() const
{
    return m_Metadata;
}
void CreateThreadRequest::setMetadata(org::openapitools::server::model::Object const& value)
{
    m_Metadata = value;
