...
public:
    ...
    bool operator==(const DeleteAssistantFileResponse& rhs) const;
    bool operator!=(const DeleteAssistantFileResponse& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const DeleteAssistantFileResponse& o);
    friend  void from_json(const nlohmann::json& j, DeleteAssistantFileResponse& o);
protected:
    std::string m_Id;
