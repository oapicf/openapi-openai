...
std::map<std::string, org::openapitools::server::model::nlohmann::json> FunctionObject::getParameters() const
{
    return m_Parameters;
}
void FunctionObject::setParameters(std::map<std::string, org::openapitools::server::model::nlohmann::json> const& value)
{
    m_Parameters = value;
