...
public:
    ...
    bool operator==(const ListAssistantFilesResponse& rhs) const;
    bool operator!=(const ListAssistantFilesResponse& rhs) const;
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::AssistantFileObject> getData() const;
    void setData(std::vector<org::openapitools::server::model::AssistantFileObject> const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    friend  void to_json(nlohmann::json& j, const ListAssistantFilesResponse& o);
    friend  void from_json(const nlohmann::json& j, ListAssistantFilesResponse& o);
protected:
    std::string m_object;

    std::vector<org::openapitools::server::model::AssistantFileObject> m_Data;
