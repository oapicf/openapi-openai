...
void ListFilesResponse::setFirstId(std::string const& value)
{
    m_First_id = value;
}
...
void ListFilesResponse::setLastId(std::string const& value)
{
    m_Last_id = value;
}
...
void ListFilesResponse::setHasMore(bool const value)
{
    m_Has_more = value;
}
