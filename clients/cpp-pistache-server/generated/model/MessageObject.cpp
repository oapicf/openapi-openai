...
bool MessageObject::operator==(const MessageObject& rhs) const
{
    ...
    (getAttachments() == rhs.getAttachments())
     &&
...
std::vector<org::openapitools::server::model::CreateMessageRequest_attachments_inner> MessageObject::getAttachments() const
{
    return m_Attachments;
}
void MessageObject::setAttachments(std::vector<org::openapitools::server::model::CreateMessageRequest_attachments_inner> const& value)
{
    m_Attachments = value;
}
