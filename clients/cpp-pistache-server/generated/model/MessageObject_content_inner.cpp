...
org::openapitools::server::model::MessageContentImageUrlObject_image_url MessageObject_content_inner::getImageUrl() const
{
    return m_Image_url;
}
void MessageObject_content_inner::setImageUrl(org::openapitools::server::model::MessageContentImageUrlObject_image_url const& value)
{
    m_Image_url = value;
}
...
void MessageObject_content_inner::setRefusal(std::string const& value)
{
    m_Refusal = value;
}
