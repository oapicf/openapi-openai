...
org::openapitools::server::model::Object ModifyAssistantRequest::getMetadata() const
{
    return m_Metadata;
}
void ModifyAssistantRequest::setMetadata(org::openapitools::server::model::Object const& value)
{
    m_Metadata = value;
