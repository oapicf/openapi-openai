...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::ModifyAssistantRequest_tool_resources getToolResources() const;
    void setToolResources(org::openapitools::server::model::ModifyAssistantRequest_tool_resources const& value);
...
protected:
    ...
    bool m_ToolsIsSet;
    org::openapitools::server::model::ModifyAssistantRequest_tool_resources m_Tool_resources;
