...
org::openapitools::server::model::Object ModifyThreadRequest::getMetadata() const
{
    return m_Metadata;
}
void ModifyThreadRequest::setMetadata(org::openapitools::server::model::Object const& value)
{
    m_Metadata = value;
