...
public:
    ...
    bool operator==(const RealtimeSessionCreateRequest_turn_detection& rhs) const;
    bool operator!=(const RealtimeSessionCreateRequest_turn_detection& rhs) const;
    ...
    void setCreateResponse(bool const value);
    bool createResponseIsSet() const;
    void unsetCreate_response();

    friend  void to_json(nlohmann::json& j, const RealtimeSessionCreateRequest_turn_detection& o);
    friend  void from_json(const nlohmann::json& j, RealtimeSessionCreateRequest_turn_detection& o);
protected:
    std::string m_Type;
    bool m_TypeIsSet;
    double m_Threshold;
