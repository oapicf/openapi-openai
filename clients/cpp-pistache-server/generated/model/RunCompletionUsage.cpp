...
void RunCompletionUsage::validate() const
{
...
bool RunCompletionUsage::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool RunCompletionUsage::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "RunCompletionUsage" : pathPrefix;

                
    return success;
}

bool RunCompletionUsage::operator==(const RunCompletionUsage& rhs) const
{
    return
...
void to_json(nlohmann::json& j, const RunCompletionUsage& o)
{
...
void from_json(const nlohmann::json& j, RunCompletionUsage& o)
{
...
void RunCompletionUsage::setCompletionTokens(int32_t const value)
{
...
void RunCompletionUsage::setPromptTokens(int32_t const value)
{
...
void RunCompletionUsage::setTotalTokens(int32_t const value)
{
