...
bool RunObject::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    ...
    if (!m_Incomplete_details.validate()) {
    ...
    if (!m_Truncation_strategy.validate()) {
        msg << _pathPrefix << ": Truncation_strategy is invalid;";
        success = false;
    }    
    if (!m_Tool_choice.validate()) {
        msg << _pathPrefix << ": Tool_choice is invalid;";
        success = false;
    }    
    if (!m_Response_format.validate()) {
...
org::openapitools::server::model::Object RunObject::getMetadata() const
{
    return m_Metadata;
}
void RunObject::setMetadata(org::openapitools::server::model::Object const& value)
{
    m_Metadata = value;
}
