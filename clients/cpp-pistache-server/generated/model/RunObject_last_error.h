...
public:
    ...
    bool operator==(const RunObject_last_error& rhs) const;
    bool operator!=(const RunObject_last_error& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const RunObject_last_error& o);
    friend  void from_json(const nlohmann::json& j, RunObject_last_error& o);
protected:
    std::string m_Code;
