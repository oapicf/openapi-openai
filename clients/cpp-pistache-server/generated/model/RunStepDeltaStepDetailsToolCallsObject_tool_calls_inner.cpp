...
nlohmann::json RunStepDeltaStepDetailsToolCallsObject_tool_calls_inner::getFileSearch() const
{
    return m_File_search;
}
void RunStepDeltaStepDetailsToolCallsObject_tool_calls_inner::setFileSearch(nlohmann::json const& value)
{
    m_File_search = value;
}
