...
org::openapitools::server::model::Object RunStepDeltaStepDetailsToolCallsObject_tool_calls_inner::getRetrieval() const
{
    return m_Retrieval;
}
void RunStepDeltaStepDetailsToolCallsObject_tool_calls_inner::setRetrieval(org::openapitools::server::model::Object const& value)
{
    m_Retrieval = value;
