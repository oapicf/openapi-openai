...
org::openapitools::server::model::Object RunStepDeltaStepDetailsToolCallsRetrievalObject::getRetrieval() const
{
    return m_Retrieval;
}
void RunStepDeltaStepDetailsToolCallsRetrievalObject::setRetrieval(org::openapitools::server::model::Object const& value)
{
    m_Retrieval = value;
