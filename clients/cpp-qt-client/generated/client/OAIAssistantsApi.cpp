...
void OAIAssistantsApi::createRun(const QString &thread_id, const OAICreateRunRequest &oai_create_run_request, const ::OpenAPI::OptionalParam<QList<QString>> &include) {
...
void OAIAssistantsApi::deleteMessage(const QString &thread_id, const QString &message_id) {
    QString fullPath = QString(_serverConfigs["deleteMessage"][_serverIndices.value("deleteMessage")].URL()+"/threads/{thread_id}/messages/{message_id}");
    ...
    connect(worker, &OAIHttpRequestWorker::on_execution_finished, this, &OAIAssistantsApi::deleteMessageCallback);
    connect(this, &OAIAssistantsApi::abortRequestsSignal, worker, &QObject::deleteLater);
    connect(worker, &QObject::destroyed, this, [this] {
        if (findChildren<OAIHttpRequestWorker*>().count() == 0) {
            Q_EMIT allPendingRequestsCompleted();
...
void OAIAssistantsApi::deleteMessageCallback(OAIHttpRequestWorker *worker) {
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
...
void OAIAssistantsApi::getRunStep(const QString &thread_id, const QString &run_id, const QString &step_id, const ::OpenAPI::OptionalParam<QList<QString>> &include) {
...
void OAIAssistantsApi::listRunSteps(const QString &thread_id, const QString &run_id, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<QString> &order, const ::OpenAPI::OptionalParam<QString> &after, const ::OpenAPI::OptionalParam<QString> &before, const ::OpenAPI::OptionalParam<QList<QString>> &include) {
