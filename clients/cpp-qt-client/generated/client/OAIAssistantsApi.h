...
public:
    ...
    */
    virtual void createRun(const QString &thread_id, const OAICreateRunRequest &oai_create_run_request, const ::OpenAPI::OptionalParam<QList<QString>> &include = ::OpenAPI::OptionalParam<QList<QString>>());
    ...
    */
    virtual void deleteMessage(const QString &thread_id, const QString &message_id);
    ...
    * @param[in]  include QList<QString> [optional]
    */
    virtual void getRunStep(const QString &thread_id, const QString &run_id, const QString &step_id, const ::OpenAPI::OptionalParam<QList<QString>> &include = ::OpenAPI::OptionalParam<QList<QString>>());
