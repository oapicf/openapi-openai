...
public:
    ...
    */
    void cancelRun(const QString &thread_id, const QString &run_id);

    /**
    * @param[in]  oai_create_assistant_request OAICreateAssistantRequest [required]
    */
    void createAssistant(const OAICreateAssistantRequest &oai_create_assistant_request);

    /**
    * @param[in]  assistant_id QString [required]
    * @param[in]  oai_create_assistant_file_request OAICreateAssistantFileRequest [required]
    */
    void createAssistantFile(const QString &assistant_id, const OAICreateAssistantFileRequest &oai_create_assistant_file_request);

    /**
    * @param[in]  thread_id QString [required]
    * @param[in]  oai_create_message_request OAICreateMessageRequest [required]
    */
    void createMessage(const QString &thread_id, const OAICreateMessageRequest &oai_create_message_request);

    /**
    * @param[in]  thread_id QString [required]
    * @param[in]  oai_create_run_request OAICreateRunRequest [required]
    */
    void createRun(const QString &thread_id, const OAICreateRunRequest &oai_create_run_request);

    /**
    * @param[in]  oai_create_thread_request OAICreateThreadRequest [optional]
    */
    void createThread(const ::OpenAPI::OptionalParam<OAICreateThreadRequest> &oai_create_thread_request = ::OpenAPI::OptionalParam<OAICreateThreadRequest>());

    /**
    * @param[in]  oai_create_thread_and_run_request OAICreateThreadAndRunRequest [required]
    */
    void createThreadAndRun(const OAICreateThreadAndRunRequest &oai_create_thread_and_run_request);

    /**
    * @param[in]  assistant_id QString [required]
    */
    void deleteAssistant(const QString &assistant_id);

    /**
    * @param[in]  assistant_id QString [required]
    * @param[in]  file_id QString [required]
    */
    void deleteAssistantFile(const QString &assistant_id, const QString &file_id);

    /**
    * @param[in]  thread_id QString [required]
    */
    void deleteThread(const QString &thread_id);

    /**
    * @param[in]  assistant_id QString [required]
    */
    void getAssistant(const QString &assistant_id);

    /**
    * @param[in]  assistant_id QString [required]
    * @param[in]  file_id QString [required]
    */
    void getAssistantFile(const QString &assistant_id, const QString &file_id);

    /**
    * @param[in]  thread_id QString [required]
    * @param[in]  message_id QString [required]
    */
    void getMessage(const QString &thread_id, const QString &message_id);
    ...
    * @param[in]  file_id QString [required]
    */
    void getMessageFile(const QString &thread_id, const QString &message_id, const QString &file_id);

    /**
    * @param[in]  thread_id QString [required]
    * @param[in]  run_id QString [required]
    */
    void getRun(const QString &thread_id, const QString &run_id);
    ...
    */
    void getRunStep(const QString &thread_id, const QString &run_id, const QString &step_id);

    /**
    * @param[in]  thread_id QString [required]
    */
    void getThread(const QString &thread_id);
    ...
    * @param[in]  before QString [optional]
    */
    void listAssistants(const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &after = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &before = ::OpenAPI::OptionalParam<QString>());
    ...
    */
    void listMessages(const QString &thread_id, const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &after = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &before = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &run_id = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  before QString [optional]
    */
    void listRunSteps(const QString &thread_id, const QString &run_id, const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &after = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &before = ::OpenAPI::OptionalParam<QString>());
    ...
    * @param[in]  before QString [optional]
    */
    void listRuns(const QString &thread_id, const ::OpenAPI::OptionalParam<qint32> &limit = ::OpenAPI::OptionalParam<qint32>(), const ::OpenAPI::OptionalParam<QString> &order = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &after = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &before = ::OpenAPI::OptionalParam<QString>());

    /**
    * @param[in]  assistant_id QString [required]
    * @param[in]  oai_modify_assistant_request OAIModifyAssistantRequest [required]
    */
    void modifyAssistant(const QString &assistant_id, const OAIModifyAssistantRequest &oai_modify_assistant_request);
    ...
    */
    void modifyMessage(const QString &thread_id, const QString &message_id, const OAIModifyMessageRequest &oai_modify_message_request);
    ...
    */
    void modifyRun(const QString &thread_id, const QString &run_id, const OAIModifyRunRequest &oai_modify_run_request);

    /**
    * @param[in]  thread_id QString [required]
    * @param[in]  oai_modify_thread_request OAIModifyThreadRequest [required]
    */
    void modifyThread(const QString &thread_id, const OAIModifyThreadRequest &oai_modify_thread_request);
    ...
    */
    void submitToolOuputsToRun(const QString &thread_id, const QString &run_id, const OAISubmitToolOutputsRunRequest &oai_submit_tool_outputs_run_request);
