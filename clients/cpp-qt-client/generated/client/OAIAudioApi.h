...
public:
    ...
    */
    virtual void createSpeech(const OAICreateSpeechRequest &oai_create_speech_request);
    ...
    * @param[in]  response_format OAIAudioResponseFormat [optional]
    * @param[in]  temperature double [optional]
    * @param[in]  timestamp_granularities QList<QString> [optional]
    */
    virtual void createTranscription(const OAIHttpFileElement &file, const OAICreateTranscriptionRequest_model &model, const ::OpenAPI::OptionalParam<QString> &language = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<QString> &prompt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIAudioResponseFormat> &response_format = ::OpenAPI::OptionalParam<OAIAudioResponseFormat>(), const ::OpenAPI::OptionalParam<double> &temperature = ::OpenAPI::OptionalParam<double>(), const ::OpenAPI::OptionalParam<QList<QString>> &timestamp_granularities = ::OpenAPI::OptionalParam<QList<QString>>());
    ...
    * @param[in]  temperature double [optional]
    */
    virtual void createTranslation(const OAIHttpFileElement &file, const OAICreateTranscriptionRequest_model &model, const ::OpenAPI::OptionalParam<QString> &prompt = ::OpenAPI::OptionalParam<QString>(), const ::OpenAPI::OptionalParam<OAIAudioResponseFormat> &response_format = ::OpenAPI::OptionalParam<OAIAudioResponseFormat>(), const ::OpenAPI::OptionalParam<double> &temperature = ::OpenAPI::OptionalParam<double>());
