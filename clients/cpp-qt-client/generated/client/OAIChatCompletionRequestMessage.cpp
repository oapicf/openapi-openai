...
QString OAIChatCompletionRequestMessage::getRefusal() const {
    return m_refusal;
}
void OAIChatCompletionRequestMessage::setRefusal(const QString &refusal) {
    m_refusal = refusal;
    m_refusal_isSet = true;
}

bool OAIChatCompletionRequestMessage::is_refusal_Set() const{
    return m_refusal_isSet;
}

bool OAIChatCompletionRequestMessage::is_refusal_Valid() const{
    return m_refusal_isValid;
}

OAIChatCompletionRequestAssistantMessage_audio OAIChatCompletionRequestMessage::getAudio() const {
    return m_audio;
}
void OAIChatCompletionRequestMessage::setAudio(const OAIChatCompletionRequestAssistantMessage_audio &audio) {
    m_audio = audio;
    m_audio_isSet = true;
}

bool OAIChatCompletionRequestMessage::is_audio_Set() const{
    return m_audio_isSet;
}

bool OAIChatCompletionRequestMessage::is_audio_Valid() const{
