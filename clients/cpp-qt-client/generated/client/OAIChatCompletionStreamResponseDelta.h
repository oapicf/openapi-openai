...
namespace OpenAPI {
class OAIChatCompletionStreamResponseDelta_function_call;
...
public:
    ...
    Q_DECL_DEPRECATED OAIChatCompletionStreamResponseDelta_function_call getFunctionCall() const;
    Q_DECL_DEPRECATED void setFunctionCall(const OAIChatCompletionStreamResponseDelta_function_call &function_call);
...
private:
    ...
    OAIChatCompletionStreamResponseDelta_function_call m_function_call;
    bool m_function_call_isSet;
    bool m_function_call_isValid;

    QList<OAIChatCompletionMessageToolCallChunk> m_tool_calls;
