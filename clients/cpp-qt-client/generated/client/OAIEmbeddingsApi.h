...
#ifndef OAI_OAIEmbeddingsApi_H
#define OAI_OAIEmbeddingsApi_H
...
class OAIEmbeddingsApi : public QObject {
    Q_OBJECT

public:
    OAIEmbeddingsApi(const int timeOut = 0);
    ~OAIEmbeddingsApi();
    ...
    */
    virtual void createEmbedding(const OAICreateEmbeddingRequest &oai_create_embedding_request);
