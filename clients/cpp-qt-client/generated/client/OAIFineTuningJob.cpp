...
void OAIFineTuningJob::fromJsonObject(QJsonObject json) {
    ...
    m_estimated_finish_isValid = ::OpenAPI::fromJsonValue(m_estimated_finish, json[QString("estimated_finish")]);
...
QJsonObject OAIFineTuningJob::asJsonObject() const {
    ...
    if (m_estimated_finish_isSet) {
        obj.insert(QString("estimated_finish"), ::OpenAPI::toJsonValue(m_estimated_finish));
    }
    if (m_method.isSet()) {
...
void OAIFineTuningJob::setEstimatedFinish(const qint32 &estimated_finish) {
    m_estimated_finish = estimated_finish;
    m_estimated_finish_isSet = true;
}
