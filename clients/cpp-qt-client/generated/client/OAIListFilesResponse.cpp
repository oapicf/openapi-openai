...
QString OAIListFilesResponse::getFirstId() const {
    return m_first_id;
}
void OAIListFilesResponse::setFirstId(const QString &first_id) {
    m_first_id = first_id;
    m_first_id_isSet = true;
}

bool OAIListFilesResponse::is_first_id_Set() const{
    return m_first_id_isSet;
}

bool OAIListFilesResponse::is_first_id_Valid() const{
    return m_first_id_isValid;
}

QString OAIListFilesResponse::getLastId() const {
    return m_last_id;
}
void OAIListFilesResponse::setLastId(const QString &last_id) {
    m_last_id = last_id;
    m_last_id_isSet = true;
}

bool OAIListFilesResponse::is_last_id_Set() const{
    return m_last_id_isSet;
}

bool OAIListFilesResponse::is_last_id_Valid() const{
    return m_last_id_isValid;
}

bool OAIListFilesResponse::isHasMore() const {
    return m_has_more;
}
void OAIListFilesResponse::setHasMore(const bool &has_more) {
    m_has_more = has_more;
    m_has_more_isSet = true;
}

bool OAIListFilesResponse::is_has_more_Set() const{
    return m_has_more_isSet;
}

bool OAIListFilesResponse::is_has_more_Valid() const{
