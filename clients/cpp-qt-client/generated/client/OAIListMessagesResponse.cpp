...
QString OAIListMessagesResponse::getObject() const {
    return m_object;
}
void OAIListMessagesResponse::setObject(const QString &object) {
    m_object = object;
    m_object_isSet = true;
}

bool OAIListMessagesResponse::is_object_Set() const{
    return m_object_isSet;
}

bool OAIListMessagesResponse::is_object_Valid() const{
    return m_object_isValid;
}

QList<OAIMessageObject> OAIListMessagesResponse::getData() const {
    return m_data;
}
void OAIListMessagesResponse::setData(const QList<OAIMessageObject> &data) {
    m_data = data;
    m_data_isSet = true;
}

bool OAIListMessagesResponse::is_data_Set() const{
    return m_data_isSet;
}

bool OAIListMessagesResponse::is_data_Valid() const{
    return m_data_isValid;
}

QString OAIListMessagesResponse::getFirstId() const {
    return m_first_id;
}
void OAIListMessagesResponse::setFirstId(const QString &first_id) {
    m_first_id = first_id;
    m_first_id_isSet = true;
}

bool OAIListMessagesResponse::is_first_id_Set() const{
    return m_first_id_isSet;
}

bool OAIListMessagesResponse::is_first_id_Valid() const{
    return m_first_id_isValid;
}

QString OAIListMessagesResponse::getLastId() const {
    return m_last_id;
}
void OAIListMessagesResponse::setLastId(const QString &last_id) {
    m_last_id = last_id;
    m_last_id_isSet = true;
}

bool OAIListMessagesResponse::is_last_id_Set() const{
    return m_last_id_isSet;
}

bool OAIListMessagesResponse::is_last_id_Valid() const{
    return m_last_id_isValid;
}

bool OAIListMessagesResponse::isHasMore() const {
    return m_has_more;
}
void OAIListMessagesResponse::setHasMore(const bool &has_more) {
    m_has_more = has_more;
    m_has_more_isSet = true;
}

bool OAIListMessagesResponse::is_has_more_Set() const{
    return m_has_more_isSet;
}

bool OAIListMessagesResponse::is_has_more_Valid() const{
