...
void OAIMessageObject::fromJsonObject(QJsonObject json) {
    ...
    m_incomplete_at_isValid = ::OpenAPI::fromJsonValue(m_incomplete_at, json[QString("incomplete_at")]);
...
QJsonObject OAIMessageObject::asJsonObject() const {
    ...
    if (m_incomplete_at_isSet) {
        obj.insert(QString("incomplete_at"), ::OpenAPI::toJsonValue(m_incomplete_at));
    }
    if (m_role_isSet) {
...
void OAIMessageObject::setIncompleteAt(const qint32 &incomplete_at) {
    m_incomplete_at = incomplete_at;
    m_incomplete_at_isSet = true;
}
...
QList<OAICreateMessageRequest_attachments_inner> OAIMessageObject::getAttachments() const {
    return m_attachments;
}
void OAIMessageObject::setAttachments(const QList<OAICreateMessageRequest_attachments_inner> &attachments) {
    m_attachments = attachments;
    m_attachments_isSet = true;
}

bool OAIMessageObject::is_attachments_Set() const{
    return m_attachments_isSet;
}

bool OAIMessageObject::is_attachments_Valid() const{
...
bool OAIMessageObject::isValid() const {
    ...
    return m_id_isValid && m_object_isValid && m_created_at_isValid && m_thread_id_isValid && m_status_isValid && m_incomplete_details_isValid && m_completed_at_isValid && m_incomplete_at_isValid && m_role_isValid && m_content_isValid && m_assistant_id_isValid && m_run_id_isValid && m_attachments_isValid && m_metadata_isValid && true;
}
