...
namespace OpenAPI {
class OAIRunObject_required_action;
class OAIRunObject_last_error;
class OAIRunObject_incomplete_details;
...
private:
    ...
    OAIRunObject_required_action m_required_action;
    bool m_required_action_isSet;
    bool m_required_action_isValid;

    OAIRunObject_last_error m_last_error;
    ...
    OAIRunObject_incomplete_details m_incomplete_details;
