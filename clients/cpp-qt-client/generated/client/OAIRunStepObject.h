...
namespace OpenAPI {
class OAIRunStepObject_step_details;
class OAIRunStepObject_last_error;
...
private:
    ...
    OAIRunStepObject_step_details m_step_details;
    bool m_step_details_isSet;
    bool m_step_details_isValid;

    OAIRunStepObject_last_error m_last_error;
    ...
    OAIRunStepCompletionUsage m_usage;
    bool m_usage_isSet;
