...
OAIModifyThreadRequest_tool_resources OAIThreadObject::getToolResources() const {
    return m_tool_resources;
}
void OAIThreadObject::setToolResources(const OAIModifyThreadRequest_tool_resources &tool_resources) {
    m_tool_resources = tool_resources;
    m_tool_resources_isSet = true;
}

bool OAIThreadObject::is_tool_resources_Set() const{
    return m_tool_resources_isSet;
}

bool OAIThreadObject::is_tool_resources_Valid() const{
...
bool OAIThreadObject::isValid() const {
    ...
    return m_id_isValid && m_object_isValid && m_created_at_isValid && m_tool_resources_isValid && m_metadata_isValid && true;
}
