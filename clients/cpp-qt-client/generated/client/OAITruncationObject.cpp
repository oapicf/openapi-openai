...
void OAITruncationObject::fromJsonObject(QJsonObject json) {
    ...
    m_last_messages_isValid = ::OpenAPI::fromJsonValue(m_last_messages, json[QString("last_messages")]);
...
QJsonObject OAITruncationObject::asJsonObject() const {
    ...
    if (m_last_messages_isSet) {
        obj.insert(QString("last_messages"), ::OpenAPI::toJsonValue(m_last_messages));
    }
    return obj;
}
...
void OAITruncationObject::setLastMessages(const qint32 &last_messages) {
    m_last_messages = last_messages;
    m_last_messages_isSet = true;
}
