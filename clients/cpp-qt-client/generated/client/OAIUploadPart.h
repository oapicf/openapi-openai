...
#ifndef OAIUploadPart_H
#define OAIUploadPart_H
...
class OAIUploadPart : public OAIObject {
public:
    OAIUploadPart();
    OAIUploadPart(QString json);
    ~OAIUploadPart() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIUploadPart)

#endif // OAIUploadPart_H
