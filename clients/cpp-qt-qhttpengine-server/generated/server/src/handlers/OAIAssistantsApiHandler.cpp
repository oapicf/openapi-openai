...
void OAIAssistantsApiHandler::createRun(QString thread_id, OAICreateRunRequest oai_create_run_request, QList<QString> include) {
    Q_UNUSED(thread_id);
...
void OAIAssistantsApiHandler::deleteMessage(QString thread_id, QString message_id) {
    Q_UNUSED(thread_id);
    Q_UNUSED(message_id);
    auto reqObj = qobject_cast<OAIAssistantsApiRequest*>(sender());
    if( reqObj != nullptr )
    {
        OAIDeleteMessageResponse res;
...
void OAIAssistantsApiHandler::getRunStep(QString thread_id, QString run_id, QString step_id, QList<QString> include) {
    Q_UNUSED(thread_id);
    Q_UNUSED(run_id);
    Q_UNUSED(step_id);
    Q_UNUSED(include);
...
void OAIAssistantsApiHandler::listRunSteps(QString thread_id, QString run_id, qint32 limit, QString order, QString after, QString before, QList<QString> include) {
    Q_UNUSED(thread_id);
    Q_UNUSED(run_id);
    Q_UNUSED(limit);
    Q_UNUSED(order);
