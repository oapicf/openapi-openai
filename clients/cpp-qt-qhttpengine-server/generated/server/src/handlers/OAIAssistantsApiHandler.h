...
public Q_SLOTS:
    ...
    virtual void createRun(QString thread_id, OAICreateRunRequest oai_create_run_request, QList<QString> include);
    ...
    virtual void deleteMessage(QString thread_id, QString message_id);
    ...
    virtual void getRunStep(QString thread_id, QString run_id, QString step_id, QList<QString> include);
    ...
    virtual void listRunSteps(QString thread_id, QString run_id, qint32 limit, QString order, QString after, QString before, QList<QString> include);
