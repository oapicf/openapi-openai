...
/*
 * OAIAssistantFileObject.h
 *
 * A list of [Files](/docs/api-reference/files) attached to an &#x60;assistant&#x60;.
 */

#ifndef OAIAssistantFileObject_H
#define OAIAssistantFileObject_H
...
class OAIAssistantFileObject : public OAIObject {
public:
    OAIAssistantFileObject();
    OAIAssistantFileObject(QString json);
    ~OAIAssistantFileObject() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAssistantFileObject)

#endif // OAIAssistantFileObject_H
