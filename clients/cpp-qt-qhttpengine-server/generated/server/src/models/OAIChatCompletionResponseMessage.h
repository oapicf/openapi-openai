...
public:
    ...
    OAIChatCompletionResponseMessage_function_call getFunctionCall() const;
    void setFunctionCall(const OAIChatCompletionResponseMessage_function_call &function_call);
...
private:
    ...
    OAIChatCompletionResponseMessage_function_call function_call;
    bool m_function_call_isSet;
    bool m_function_call_isValid;

    OAIChatCompletionResponseMessage_audio audio;
    bool m_audio_isSet;
