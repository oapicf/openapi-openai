...
QString OAIChatCompletionStreamResponseDelta::getRefusal() const {
    return refusal;
}
void OAIChatCompletionStreamResponseDelta::setRefusal(const QString &refusal) {
    this->refusal = refusal;
    this->m_refusal_isSet = true;
}

bool OAIChatCompletionStreamResponseDelta::is_refusal_Set() const{
    return m_refusal_isSet;
}

bool OAIChatCompletionStreamResponseDelta::is_refusal_Valid() const{
