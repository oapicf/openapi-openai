...
void OAICreateChatCompletionRequest::fromJsonObject(QJsonObject json) {
    ...
    m_store_isValid = ::OpenAPI::fromJsonValue(store, json[QString("store")]);
    m_store_isSet = !json[QString("store")].isNull() && m_store_isValid;

    m_reasoning_effort_isValid = ::OpenAPI::fromJsonValue(reasoning_effort, json[QString("reasoning_effort")]);
    ...
    m_prediction_isValid = ::OpenAPI::fromJsonValue(prediction, json[QString("prediction")]);
    ...
    m_stream_options_isValid = ::OpenAPI::fromJsonValue(stream_options, json[QString("stream_options")]);
...
QJsonObject OAICreateChatCompletionRequest::asJsonObject() const {
    ...
    if (m_store_isSet) {
        obj.insert(QString("store"), ::OpenAPI::toJsonValue(store));
    }
    if (m_reasoning_effort_isSet) {
        obj.insert(QString("reasoning_effort"), ::OpenAPI::toJsonValue(reasoning_effort));
    }
    if (metadata.size() > 0) {
    ...
    if (prediction.isSet()) {
        obj.insert(QString("prediction"), ::OpenAPI::toJsonValue(prediction));
    }
    if (audio.isSet()) {
    ...
    if (stream_options.isSet()) {
        obj.insert(QString("stream_options"), ::OpenAPI::toJsonValue(stream_options));
    }
...
void OAICreateChatCompletionRequest::setReasoningEffort(const QString &reasoning_effort) {
    ...
    this->m_reasoning_effort_isSet = true;
}
...
void OAICreateChatCompletionRequest::setStreamOptions(const OAIChatCompletionStreamOptions &stream_options) {
    ...
    this->m_stream_options_isSet = true;
}
