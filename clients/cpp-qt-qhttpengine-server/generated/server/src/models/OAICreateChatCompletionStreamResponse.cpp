...
QString OAICreateChatCompletionStreamResponse::getServiceTier() const {
    return service_tier;
}
void OAICreateChatCompletionStreamResponse::setServiceTier(const QString &service_tier) {
    this->service_tier = service_tier;
    this->m_service_tier_isSet = true;
}

bool OAICreateChatCompletionStreamResponse::is_service_tier_Set() const{
    return m_service_tier_isSet;
}

bool OAICreateChatCompletionStreamResponse::is_service_tier_Valid() const{
...
OAICreateChatCompletionStreamResponse_usage OAICreateChatCompletionStreamResponse::getUsage() const {
    return usage;
}
void OAICreateChatCompletionStreamResponse::setUsage(const OAICreateChatCompletionStreamResponse_usage &usage) {
    this->usage = usage;
    this->m_usage_isSet = true;
}

bool OAICreateChatCompletionStreamResponse::is_usage_Set() const{
    return m_usage_isSet;
}

bool OAICreateChatCompletionStreamResponse::is_usage_Valid() const{
