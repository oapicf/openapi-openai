...
public:
    ...
    OAICreateChatCompletionStreamResponse_usage getUsage() const;
    void setUsage(const OAICreateChatCompletionStreamResponse_usage &usage);
...
private:
    ...
    QList<OAICreateChatCompletionStreamResponse_choices_inner> choices;
    ...
    OAICreateChatCompletionStreamResponse_usage usage;
    bool m_usage_isSet;
