...
OAIChatCompletionStreamOptions OAICreateCompletionRequest::getStreamOptions() const {
    return stream_options;
}
void OAICreateCompletionRequest::setStreamOptions(const OAIChatCompletionStreamOptions &stream_options) {
    this->stream_options = stream_options;
    this->m_stream_options_isSet = true;
}

bool OAICreateCompletionRequest::is_stream_options_Set() const{
    return m_stream_options_isSet;
}

bool OAICreateCompletionRequest::is_stream_options_Valid() const{
