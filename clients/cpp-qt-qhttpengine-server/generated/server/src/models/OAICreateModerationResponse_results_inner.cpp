...
void OAICreateModerationResponse_results_inner::fromJsonObject(QJsonObject json) {
    ...
    m_category_applied_input_types_isValid = ::OpenAPI::fromJsonValue(category_applied_input_types, json[QString("category_applied_input_types")]);
...
QJsonObject OAICreateModerationResponse_results_inner::asJsonObject() const {
    ...
    if (category_applied_input_types.isSet()) {
        obj.insert(QString("category_applied_input_types"), ::OpenAPI::toJsonValue(category_applied_input_types));
    }
    return obj;
}
...
void OAICreateModerationResponse_results_inner::setCategoryAppliedInputTypes(const OAICreateModerationResponse_results_inner_category_applied_input_types &category_applied_input_types) {
    ...
    this->m_category_applied_input_types_isSet = true;
}
