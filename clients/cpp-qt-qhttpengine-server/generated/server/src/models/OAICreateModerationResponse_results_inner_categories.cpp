...
bool OAICreateModerationResponse_results_inner_categories::isIllicit() const {
    return illicit;
}
void OAICreateModerationResponse_results_inner_categories::setIllicit(const bool &illicit) {
    this->illicit = illicit;
    this->m_illicit_isSet = true;
}

bool OAICreateModerationResponse_results_inner_categories::is_illicit_Set() const{
    return m_illicit_isSet;
}

bool OAICreateModerationResponse_results_inner_categories::is_illicit_Valid() const{
    return m_illicit_isValid;
}

bool OAICreateModerationResponse_results_inner_categories::isIllicitViolent() const {
    return illicit_violent;
}
void OAICreateModerationResponse_results_inner_categories::setIllicitViolent(const bool &illicit_violent) {
    this->illicit_violent = illicit_violent;
    this->m_illicit_violent_isSet = true;
}

bool OAICreateModerationResponse_results_inner_categories::is_illicit_violent_Set() const{
    return m_illicit_violent_isSet;
}

bool OAICreateModerationResponse_results_inner_categories::is_illicit_violent_Valid() const{
