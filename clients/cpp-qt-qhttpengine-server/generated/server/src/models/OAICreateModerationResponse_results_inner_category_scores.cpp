...
double OAICreateModerationResponse_results_inner_category_scores::getIllicit() const {
    return illicit;
}
void OAICreateModerationResponse_results_inner_category_scores::setIllicit(const double &illicit) {
    this->illicit = illicit;
    this->m_illicit_isSet = true;
}

bool OAICreateModerationResponse_results_inner_category_scores::is_illicit_Set() const{
    return m_illicit_isSet;
}

bool OAICreateModerationResponse_results_inner_category_scores::is_illicit_Valid() const{
    return m_illicit_isValid;
}

double OAICreateModerationResponse_results_inner_category_scores::getIllicitViolent() const {
    return illicit_violent;
}
void OAICreateModerationResponse_results_inner_category_scores::setIllicitViolent(const double &illicit_violent) {
    this->illicit_violent = illicit_violent;
    this->m_illicit_violent_isSet = true;
}

bool OAICreateModerationResponse_results_inner_category_scores::is_illicit_violent_Set() const{
    return m_illicit_violent_isSet;
}

bool OAICreateModerationResponse_results_inner_category_scores::is_illicit_violent_Valid() const{
