...
void OAIFineTuningJob::initializeModel() {
    ...
    m_estimated_finish_isSet = false;
    m_estimated_finish_isValid = false;
...
void OAIFineTuningJob::fromJsonObject(QJsonObject json) {
    ...
    m_trained_tokens_isValid = ::OpenAPI::fromJsonValue(trained_tokens, json[QString("trained_tokens")]);
    ...
    m_estimated_finish_isValid = ::OpenAPI::fromJsonValue(estimated_finish, json[QString("estimated_finish")]);
    m_estimated_finish_isSet = !json[QString("estimated_finish")].isNull() && m_estimated_finish_isValid;
...
QJsonObject OAIFineTuningJob::asJsonObject() const {
    ...
    if (m_trained_tokens_isSet) {
        obj.insert(QString("trained_tokens"), ::OpenAPI::toJsonValue(trained_tokens));
    }
    ...
    if (m_estimated_finish_isSet) {
        obj.insert(QString("estimated_finish"), ::OpenAPI::toJsonValue(estimated_finish));
    }
    if (method.isSet()) {
...
void OAIFineTuningJob::setTrainedTokens(const qint32 &trained_tokens) {
    ...
    this->m_trained_tokens_isSet = true;
}
...
qint32 OAIFineTuningJob::getEstimatedFinish() const {
    return estimated_finish;
}
void OAIFineTuningJob::setEstimatedFinish(const qint32 &estimated_finish) {
    this->estimated_finish = estimated_finish;
    this->m_estimated_finish_isSet = true;
}

bool OAIFineTuningJob::is_estimated_finish_Set() const{
    return m_estimated_finish_isSet;
}

bool OAIFineTuningJob::is_estimated_finish_Valid() const{
    return m_estimated_finish_isValid;
}

OAIFineTuneMethod OAIFineTuningJob::getMethod() const {
    return method;
}
void OAIFineTuningJob::setMethod(const OAIFineTuneMethod &method) {
    this->method = method;
    this->m_method_isSet = true;
}

bool OAIFineTuningJob::is_method_Set() const{
    return m_method_isSet;
}

bool OAIFineTuningJob::is_method_Valid() const{
