...
bool OAIThreadStreamEvent::isEnabled() const {
    return enabled;
}
void OAIThreadStreamEvent::setEnabled(const bool &enabled) {
    this->enabled = enabled;
    this->m_enabled_isSet = true;
}

bool OAIThreadStreamEvent::is_enabled_Set() const{
    return m_enabled_isSet;
}

bool OAIThreadStreamEvent::is_enabled_Valid() const{
