...
void OAITranscriptionSegment::fromJsonObject(QJsonObject json) {
    ...
    m_seek_isValid = ::OpenAPI::fromJsonValue(seek, json[QString("seek")]);
    ...
    m_avg_logprob_isValid = ::OpenAPI::fromJsonValue(avg_logprob, json[QString("avg_logprob")]);
    m_avg_logprob_isSet = !json[QString("avg_logprob")].isNull() && m_avg_logprob_isValid;

    m_compression_ratio_isValid = ::OpenAPI::fromJsonValue(compression_ratio, json[QString("compression_ratio")]);
    m_compression_ratio_isSet = !json[QString("compression_ratio")].isNull() && m_compression_ratio_isValid;

    m_no_speech_prob_isValid = ::OpenAPI::fromJsonValue(no_speech_prob, json[QString("no_speech_prob")]);
...
QJsonObject OAITranscriptionSegment::asJsonObject() const {
    ...
    if (m_seek_isSet) {
        obj.insert(QString("seek"), ::OpenAPI::toJsonValue(seek));
    }
    if (m_start_isSet) {
    ...
    if (m_avg_logprob_isSet) {
        obj.insert(QString("avg_logprob"), ::OpenAPI::toJsonValue(avg_logprob));
    }
    if (m_compression_ratio_isSet) {
        obj.insert(QString("compression_ratio"), ::OpenAPI::toJsonValue(compression_ratio));
    }
    if (m_no_speech_prob_isSet) {
        obj.insert(QString("no_speech_prob"), ::OpenAPI::toJsonValue(no_speech_prob));
    }
    return obj;
}
...
void OAITranscriptionSegment::setCompressionRatio(const float &compression_ratio) {
    ...
    this->m_compression_ratio_isSet = true;
}
...
void OAITranscriptionSegment::setNoSpeechProb(const float &no_speech_prob) {
    ...
    this->m_no_speech_prob_isSet = true;
}
