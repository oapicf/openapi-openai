...
/*
 * OAIVectorStoreFileBatchObject_file_counts.h
 *
 * 
 */

#ifndef OAIVectorStoreFileBatchObject_file_counts_H
#define OAIVectorStoreFileBatchObject_file_counts_H
...
class OAIVectorStoreFileBatchObject_file_counts : public OAIObject {
public:
    OAIVectorStoreFileBatchObject_file_counts();
    OAIVectorStoreFileBatchObject_file_counts(QString json);
    ~OAIVectorStoreFileBatchObject_file_counts() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVectorStoreFileBatchObject_file_counts)

#endif // OAIVectorStoreFileBatchObject_file_counts_H
