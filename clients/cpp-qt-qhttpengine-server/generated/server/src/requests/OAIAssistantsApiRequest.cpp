...
void OAIAssistantsApiRequest::createRunRequest(const QString& thread_idstr){
    ...
    if(socket->queryString().keys().contains("include")){
        fromStringValue(socket->queryString().values("include"), include);
    }
    ...
    Q_EMIT createRun(thread_id, oai_create_run_request, include);
}
...
void OAIAssistantsApiRequest::deleteMessageRequest(const QString& thread_idstr, const QString& message_idstr){
    qDebug() << "/v1/threads/{thread_id}/messages/{message_id}";
    connect(this, &OAIAssistantsApiRequest::deleteMessage, handler.data(), &OAIAssistantsApiHandler::deleteMessage);
    ...
    Q_EMIT deleteMessage(thread_id, message_id);
}
...
void OAIAssistantsApiRequest::getRunStepRequest(const QString& thread_idstr, const QString& run_idstr, const QString& step_idstr){
    ...
    Q_EMIT getRunStep(thread_id, run_id, step_id, include);
}
...
void OAIAssistantsApiRequest::listRunStepsRequest(const QString& thread_idstr, const QString& run_idstr){
    ...
    Q_EMIT listRunSteps(thread_id, run_id, limit, order, after, before, include);
}
...
void OAIAssistantsApiRequest::deleteMessageResponse(const OAIDeleteMessageResponse& res){
    setSocketResponseHeaders();
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
    socket->writeJson(resDoc);
    if(socket->isOpen()){
...
void OAIAssistantsApiRequest::deleteMessageError(const OAIDeleteMessageResponse& res, QNetworkReply::NetworkError error_type, QString& error_str){
    Q_UNUSED(error_type); // TODO: Remap error_type to QHttpEngine::Socket errors
    setSocketResponseHeaders();
    Q_UNUSED(error_str);  // response will be used instead of error string
    QJsonDocument resDoc(::OpenAPI::toJsonValue(res).toObject());
