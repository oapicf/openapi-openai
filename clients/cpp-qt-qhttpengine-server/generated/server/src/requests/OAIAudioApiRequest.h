...
Q_SIGNALS:
    ...
    void createTranscription(OAIHttpFileElement file, OAICreateTranscriptionRequest_model model, QString language, QString prompt, OAIAudioResponseFormat response_format, double temperature, QList<QString> timestamp_granularities);
    void createTranslation(OAIHttpFileElement file, OAICreateTranscriptionRequest_model model, QString prompt, OAIAudioResponseFormat response_format, double temperature);
