...
#ifndef OAI_OAIChatApiRequest_H
#define OAI_OAIChatApiRequest_H
...
class OAIChatApiRequest : public QObject
{
    Q_OBJECT

public:
    OAIChatApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAIChatApiHandler> handler);
    virtual ~OAIChatApiRequest();
...
private:
    ...
    QSharedPointer<OAIChatApiHandler> handler;
