...
#ifndef OAI_OAICompletionsApiRequest_H
#define OAI_OAICompletionsApiRequest_H
...
class OAICompletionsApiRequest : public QObject
{
    Q_OBJECT

public:
    OAICompletionsApiRequest(QHttpEngine::Socket *s, QSharedPointer<OAICompletionsApiHandler> handler);
    virtual ~OAICompletionsApiRequest();
...
private:
    ...
    QSharedPointer<OAICompletionsApiHandler> handler;
...
#endif // OAI_OAICompletionsApiRequest_H
