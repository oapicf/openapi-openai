...
void ThreadsThread_idRunsResource::handler_POST_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    std::string threadId = request->get_path_parameter("thread_id", "");
    // Getting the query params
    std::string includeLeft_Square_BracketRight_Square_Bracket_raw = request->get_query_parameter("includeLeft_Square_BracketRight_Square_Bracket");
    std::vector<std::string> includeLeft_Square_BracketRight_Square_Bracket;
    std::vector<std::string> includeLeft_Square_BracketRight_Square_Bracket_temp;
    boost::split(includeLeft_Square_BracketRight_Square_Bracket_temp, includeLeft_Square_BracketRight_Square_Bracket_raw, boost::is_any_of(","));
    std::copy(includeLeft_Square_BracketRight_Square_Bracket_temp.begin(), includeLeft_Square_BracketRight_Square_Bracket_temp.end(), std::inserter(includeLeft_Square_BracketRight_Square_Bracket, std::next(includeLeft_Square_BracketRight_Square_Bracket.begin())));
    ...
    try {
        std::tie(status_code, resultObject) =
            handler_POST(threadId, createRunRequest, includeLeft_Square_BracketRight_Square_Bracket);
    }
    catch(const AssistantsApiException& e) {
        std::tie(status_code, result) = handleAssistantsApiException(e);
    }
...
std::pair<int, RunObject> ThreadsThread_idRunsResource::handler_POST(
        std::string & threadId, CreateRunRequest & createRunRequest, std::vector<std::string> & includeLeft_Square_BracketRight_Square_Bracket)
{
    return handler_POST_func(threadId, createRunRequest, includeLeft_Square_BracketRight_Square_Bracket);
}
...
ThreadsThread_idMessagesMessage_idResource::ThreadsThread_idMessagesMessage_idResource(const std::string& context /* = "/v1" */)
{
	...
	this->set_method_handler("DELETE",
		std::bind(&ThreadsThread_idMessagesMessage_idResource::handler_DELETE_internal, this,
			std::placeholders::_1));
	this->set_method_handler("GET",
...
void ThreadsThread_idMessagesMessage_idResource::handler_DELETE_internal(const std::shared_ptr<restbed::Session> session)
{
    const auto request = session->get_request();
    // Getting the path params
    std::string threadId = request->get_path_parameter("thread_id", "");
    ...
    int status_code = 500;
    DeleteMessageResponse resultObject = DeleteMessageResponse{};
    std::string result = "";
    
    try {
        std::tie(status_code, resultObject) =
            handler_DELETE(threadId, messageId);
    }
    catch(const AssistantsApiException& e) {
        std::tie(status_code, result) = handleAssistantsApiException(e);
    }
...
std::pair<int, DeleteMessageResponse> ThreadsThread_idMessagesMessage_idResource::handler_DELETE(
        std::string & threadId, std::string & messageId)
{
    return handler_DELETE_func(threadId, messageId);
}
...
void ThreadsThread_idRunsRun_idStepsStep_idResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    try {
        std::tie(status_code, resultObject) =
            handler_GET(threadId, runId, stepId, includeLeft_Square_BracketRight_Square_Bracket);
    }
    catch(const AssistantsApiException& e) {
        std::tie(status_code, result) = handleAssistantsApiException(e);
    }
...
std::pair<int, RunStepObject> ThreadsThread_idRunsRun_idStepsStep_idResource::handler_GET(
        std::string & threadId, std::string & runId, std::string & stepId, std::vector<std::string> & includeLeft_Square_BracketRight_Square_Bracket)
{
    return handler_GET_func(threadId, runId, stepId, includeLeft_Square_BracketRight_Square_Bracket);
}
...
void ThreadsThread_idRunsRun_idStepsResource::handler_GET_internal(const std::shared_ptr<restbed::Session> session)
{
    ...
    try {
        std::tie(status_code, resultObject) =
            handler_GET(threadId, runId, limit, order, after, before, includeLeft_Square_BracketRight_Square_Bracket);
    }
    catch(const AssistantsApiException& e) {
        std::tie(status_code, result) = handleAssistantsApiException(e);
    }
...
std::pair<int, ListRunStepsResponse> ThreadsThread_idRunsRun_idStepsResource::handler_GET(
        std::string & threadId, std::string & runId, int32_t & limit, std::string & order, std::string & after, std::string & before, std::vector<std::string> & includeLeft_Square_BracketRight_Square_Bracket)
{
    return handler_GET_func(threadId, runId, limit, order, after, before, includeLeft_Square_BracketRight_Square_Bracket);
}
