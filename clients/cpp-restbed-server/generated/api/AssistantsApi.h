...
public:
    ...
    /////////////////////////////////////////////////////
    std::function<std::pair<int, RunObject>(
        std::string & threadId, CreateRunRequest & createRunRequest, std::vector<std::string> & includeLeft_Square_BracketRight_Square_Bracket)> handler_POST_func =
            [](std::string &, CreateRunRequest &, std::vector<std::string> &) -> std::pair<int, RunObject>
                { throw AssistantsApiException(501, "Not implemented"); };
...
public:
    ...
    // Set these to implement the server functionality //
    /////////////////////////////////////////////////////
    std::function<std::pair<int, DeleteMessageResponse>(
        std::string & threadId, std::string & messageId)> handler_DELETE_func =
            [](std::string &, std::string &) -> std::pair<int, DeleteMessageResponse>
                { throw AssistantsApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, DeleteMessageResponse> handler_DELETE(
...
public:
    ...
    std::function<std::pair<int, RunStepObject>(
        std::string & threadId, std::string & runId, std::string & stepId, std::vector<std::string> & includeLeft_Square_BracketRight_Square_Bracket)> handler_GET_func =
            [](std::string &, std::string &, std::string &, std::vector<std::string> &) -> std::pair<int, RunStepObject>
                { throw AssistantsApiException(501, "Not implemented"); };
...
public:
    ...
    std::function<std::pair<int, ListRunStepsResponse>(
        std::string & threadId, std::string & runId, int32_t & limit, std::string & order, std::string & after, std::string & before, std::vector<std::string> & includeLeft_Square_BracketRight_Square_Bracket)> handler_GET_func =
            [](std::string &, std::string &, int32_t &, std::string &, std::string &, std::string &, std::vector<std::string> &) -> std::pair<int, ListRunStepsResponse>
                { throw AssistantsApiException(501, "Not implemented"); };
