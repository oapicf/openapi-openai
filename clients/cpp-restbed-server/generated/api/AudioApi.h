...
public:
    ...
    std::function<std::pair<int, CreateTranscription_200_response>(
        std::string & file, CreateTranscriptionRequest_model & model, std::string & language, std::string & prompt, AudioResponseFormat & responseFormat, double & temperature, std::vector<std::string> & timestampGranularitiesLeft_Square_BracketRight_Square_Bracket)> handler_POST_func =
            [](std::string &, CreateTranscriptionRequest_model &, std::string &, std::string &, AudioResponseFormat &, double &, std::vector<std::string> &) -> std::pair<int, CreateTranscription_200_response>
                { throw AudioApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, CreateTranscription_200_response> handler_POST(
        std::string & file, CreateTranscriptionRequest_model & model, std::string & language, std::string & prompt, AudioResponseFormat & responseFormat, double & temperature, std::vector<std::string> & timestampGranularitiesLeft_Square_BracketRight_Square_Bracket);
...
public:
    ...
    std::function<std::pair<int, CreateTranslation_200_response>(
        std::string & file, CreateTranscriptionRequest_model & model, std::string & prompt, AudioResponseFormat & responseFormat, double & temperature)> handler_POST_func =
            [](std::string &, CreateTranscriptionRequest_model &, std::string &, AudioResponseFormat &, double &) -> std::pair<int, CreateTranslation_200_response>
                { throw AudioApiException(501, "Not implemented"); };
...
protected:
    ...
    virtual std::pair<int, CreateTranslation_200_response> handler_POST(
        std::string & file, CreateTranscriptionRequest_model & model, std::string & prompt, AudioResponseFormat & responseFormat, double & temperature);
