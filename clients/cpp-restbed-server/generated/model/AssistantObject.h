...
public:
    ...
    /// 
    /// </summary>
    AssistantObject_tool_resources getToolResources() const;
    void setToolResources(AssistantObject_tool_resources value);
...
protected:
    ...
    AssistantObject_tool_resources m_Tool_resources;
