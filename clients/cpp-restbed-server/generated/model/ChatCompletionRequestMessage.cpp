...
void ChatCompletionRequestMessage::setRefusal(std::string value)
{
    m_Refusal = value;
}


ChatCompletionRequestAssistantMessage_audio ChatCompletionRequestMessage::getAudio() const
{
    return m_Audio;
}

void ChatCompletionRequestMessage::setAudio(ChatCompletionRequestAssistantMessage_audio value)
{
    m_Audio = value;
}
