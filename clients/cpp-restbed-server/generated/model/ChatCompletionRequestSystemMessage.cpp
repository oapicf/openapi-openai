...
void ChatCompletionRequestSystemMessage::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("content")) {
        m_Content = fromPt<ChatCompletionRequestSystemMessage_content>(pt.get_child("content"));
	}
	setRole(pt.get("role", ""));
	m_Name = pt.get("name", "");
}

ChatCompletionRequestSystemMessage_content ChatCompletionRequestSystemMessage::getContent() const
{
    return m_Content;
}

void ChatCompletionRequestSystemMessage::setContent(ChatCompletionRequestSystemMessage_content value)
{
    m_Content = value;
}
