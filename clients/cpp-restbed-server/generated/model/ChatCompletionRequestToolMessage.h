...
public:
    ...
    /// 
    /// </summary>
    ChatCompletionRequestToolMessage_content getContent() const;
    void setContent(ChatCompletionRequestToolMessage_content value);
...
protected:
    std::string m_Role = "";
    ChatCompletionRequestToolMessage_content m_Content;
