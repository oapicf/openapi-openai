...
AssistantsNamedToolChoice_function ChatCompletionToolChoiceOption::getFunction() const
{
    return m_Function;
}

void ChatCompletionToolChoiceOption::setFunction(AssistantsNamedToolChoice_function value)
{
    m_Function = value;
}
