...
ResponseFormatJsonSchema_json_schema CreateChatCompletionRequest_response_format::getJsonSchema() const
{
    return m_Json_schema;
}

void CreateChatCompletionRequest_response_format::setJsonSchema(ResponseFormatJsonSchema_json_schema value)
{
    m_Json_schema = value;
}
