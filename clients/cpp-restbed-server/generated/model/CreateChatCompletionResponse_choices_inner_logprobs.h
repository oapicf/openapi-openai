...
public:
    ...
    /// </summary>
    std::vector<ChatCompletionTokenLogprob> getRefusal() const;
    void setRefusal(std::vector<ChatCompletionTokenLogprob> value);

protected:
    std::vector<ChatCompletionTokenLogprob> m_Content;
    std::vector<ChatCompletionTokenLogprob> m_Refusal;
};
