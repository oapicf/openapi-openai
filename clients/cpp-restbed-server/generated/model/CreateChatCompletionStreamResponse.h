...
public:
    ...
    /// 
    /// </summary>
    CreateChatCompletionStreamResponse_usage getUsage() const;
    void setUsage(CreateChatCompletionStreamResponse_usage value);
...
protected:
    ...
    std::string m_object = "";
    CreateChatCompletionStreamResponse_usage m_Usage;
};
