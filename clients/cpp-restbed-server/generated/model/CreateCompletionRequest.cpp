...
ChatCompletionStreamOptions CreateCompletionRequest::getStreamOptions() const
{
    return m_Stream_options;
}

void CreateCompletionRequest::setStreamOptions(ChatCompletionStreamOptions value)
{
