...
ptree CreateModerationResponse_results_inner::toPropertyTree() const
{
	...
	pt.add_child("category_applied_input_types", m_Category_applied_input_types.toPropertyTree());
	return pt;
}
...
void CreateModerationResponse_results_inner::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("category_applied_input_types")) {
        m_Category_applied_input_types = fromPt<CreateModerationResponse_results_inner_category_applied_input_types>(pt.get_child("category_applied_input_types"));
	}
}
...
CreateModerationResponse_results_inner_category_applied_input_types CreateModerationResponse_results_inner::getCategoryAppliedInputTypes() const
{
    return m_Category_applied_input_types;
}

void CreateModerationResponse_results_inner::setCategoryAppliedInputTypes(CreateModerationResponse_results_inner_category_applied_input_types value)
{
