...
public:
    ...
    /// 
    /// </summary>
    CreateModerationResponse_results_inner_category_applied_input_types getCategoryAppliedInputTypes() const;
    void setCategoryAppliedInputTypes(CreateModerationResponse_results_inner_category_applied_input_types value);
...
protected:
    ...
    CreateModerationResponse_results_inner_category_applied_input_types m_Category_applied_input_types;
};
