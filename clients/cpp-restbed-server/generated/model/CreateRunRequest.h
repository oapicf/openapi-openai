...
public:
    ...
    explicit CreateRunRequest(boost::property_tree::ptree const& pt);
    virtual ~CreateRunRequest() = default;

    CreateRunRequest(const CreateRunRequest& other) = default; // copy constructor
    CreateRunRequest(CreateRunRequest&& other) noexcept = default; // move constructor

    CreateRunRequest& operator=(const CreateRunRequest& other) = default; // copy assignment
    CreateRunRequest& operator=(CreateRunRequest&& other) noexcept = default; // move assignment
    ...
    void setAdditionalInstructions(std::string value);

    /// <summary>
    /// Adds additional messages to the thread before creating the run.
    /// </summary>
    std::vector<CreateMessageRequest> getAdditionalMessages() const;
    void setAdditionalMessages(std::vector<CreateMessageRequest> value);
...
protected:
    ...
    std::vector<CreateMessageRequest> m_Additional_messages;
...
template<>
inline boost::property_tree::ptree toPt<CreateRunRequest>(const CreateRunRequest& val) {
    return val.toPropertyTree();
}

template<>
inline CreateRunRequest fromPt<CreateRunRequest>(const boost::property_tree::ptree& pt) {
    CreateRunRequest ret;
