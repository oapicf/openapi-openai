...
void CreateThreadAndRunRequest::fromPropertyTree(ptree const &pt)
{
	...
	if (pt.get_child_optional("tool_resources")) {
        m_Tool_resources = fromPt<CreateThreadAndRunRequest_tool_resources>(pt.get_child("tool_resources"));
	}
...
CreateThreadAndRunRequest_tool_resources CreateThreadAndRunRequest::getToolResources() const
{
    return m_Tool_resources;
}

void CreateThreadAndRunRequest::setToolResources(CreateThreadAndRunRequest_tool_resources value)
{
