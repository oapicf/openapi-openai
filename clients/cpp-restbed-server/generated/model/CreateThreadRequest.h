...
public:
    ...
    /// 
    /// </summary>
    CreateThreadRequest_tool_resources getToolResources() const;
    void setToolResources(CreateThreadRequest_tool_resources value);
...
protected:
    ...
    CreateThreadRequest_tool_resources m_Tool_resources;
