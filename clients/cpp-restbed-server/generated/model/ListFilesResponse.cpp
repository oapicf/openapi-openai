...
ListFilesResponse::ListFilesResponse(boost::property_tree::ptree const& pt)
{
        fromPropertyTree(pt);
}


std::string ListFilesResponse::toJsonString(bool prettyJson /* = false */) const
{
	std::stringstream ss;
...
void ListFilesResponse::fromJsonString(std::string const& jsonString)
{
...
ptree ListFilesResponse::toPropertyTree() const
{
	ptree pt;
	ptree tmp_node;
...
std::string ListFilesResponse::getFirstId() const
{
    return m_First_id;
}

void ListFilesResponse::setFirstId(std::string value)
{
    m_First_id = value;
}


std::string ListFilesResponse::getLastId() const
{
    return m_Last_id;
}

void ListFilesResponse::setLastId(std::string value)
{
    m_Last_id = value;
}
...
std::vector<ListFilesResponse> createListFilesResponseVectorFromJsonString(const std::string& json)
{
    ...
    auto vec = std::vector<ListFilesResponse>();
    for (const auto& child: pt) {
        vec.emplace_back(ListFilesResponse(child.second));
    }
