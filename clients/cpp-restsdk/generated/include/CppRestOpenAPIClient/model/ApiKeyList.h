...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ApiKeyList_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ApiKeyList_H_
...
public:
    ...
    std::vector<std::shared_ptr<AdminApiKey>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<AdminApiKey>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<AdminApiKey>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ApiKeyList_H_ */
