...
public:
    ...
    std::shared_ptr<ChatCompletionRequestToolMessage_content> getContent() const;
    bool contentIsSet() const;
    void unsetContent();
    void setContent(const std::shared_ptr<ChatCompletionRequestToolMessage_content>& value);
...
protected:
    ...
    std::shared_ptr<ChatCompletionRequestToolMessage_content> m_Content;
    bool m_ContentIsSet;
