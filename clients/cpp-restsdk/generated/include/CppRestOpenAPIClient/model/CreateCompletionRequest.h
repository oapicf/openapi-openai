...
protected:
    ...
    boost::optional<std::shared_ptr<CreateCompletionRequest_prompt>> m_Prompt;

    boost::optional<int32_t> m_Best_of;

    boost::optional<bool> m_Echo;

    boost::optional<double> m_Frequency_penalty;

    boost::optional<std::map<utility::string_t, int32_t>> m_Logit_bias;

    boost::optional<int32_t> m_Logprobs;
    ...
    boost::optional<std::shared_ptr<CreateCompletionRequest_stop>> m_Stop;
