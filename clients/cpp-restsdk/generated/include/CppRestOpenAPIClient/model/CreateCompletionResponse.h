...
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CreateCompletionResponse_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<CreateCompletionResponse_choices_inner>> getChoices() const;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CreateCompletionResponse_H_ */
