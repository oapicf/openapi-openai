...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<CreateMessageRequest>> getAdditionalMessages() const;
...
protected:
    ...
    boost::optional<utility::string_t> m_Additional_instructions;

    boost::optional<std::vector<std::shared_ptr<CreateMessageRequest>>> m_Additional_messages;

    boost::optional<std::vector<std::shared_ptr<AssistantObject_tools_inner>>> m_Tools;
