...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<CreateMessageRequest>> getMessages() const;
    bool messagesIsSet() const;
    void unsetMessages();
    void setMessages(const std::vector<std::shared_ptr<CreateMessageRequest>>& value);

    std::shared_ptr<CreateThreadRequest_tool_resources> getToolResources() const;
    bool toolResourcesIsSet() const;
    void unsetTool_resources();
    void setToolResources(const std::shared_ptr<CreateThreadRequest_tool_resources>& value);
...
protected:
    ...
    boost::optional<std::shared_ptr<CreateThreadRequest_tool_resources>> m_Tool_resources;
