...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CreateTranscriptionResponseVerboseJson_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CreateTranscriptionResponseVerboseJson_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<TranscriptionWord>> getWords() const;
    ...
    /// </summary>
    std::vector<std::shared_ptr<TranscriptionSegment>> getSegments() const;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CreateTranscriptionResponseVerboseJson_H_ */
