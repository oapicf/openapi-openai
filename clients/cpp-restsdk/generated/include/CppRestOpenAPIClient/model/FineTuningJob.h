...
public:
    ...
    /// </summary>
    std::vector<utility::string_t> getResultFiles() const;
    ...
    /// </summary>
    std::vector<std::shared_ptr<FineTuningJob_integrations_inner>> getIntegrations() const;
    ...
    void setEstimatedFinish(int32_t value);
...
protected:
    ...
    boost::optional<std::shared_ptr<FineTuningJob_error>> m_Error;

    boost::optional<utility::string_t> m_Fine_tuned_model;
    ...
    boost::optional<int32_t> m_Trained_tokens;
    ...
    boost::optional<std::vector<std::shared_ptr<FineTuningJob_integrations_inner>>> m_Integrations;

    int32_t m_Seed;
    bool m_SeedIsSet;

    boost::optional<int32_t> m_Estimated_finish;
