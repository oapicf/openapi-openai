...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ListAssistantFilesResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ListAssistantFilesResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<AssistantFileObject>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<AssistantFileObject>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<AssistantFileObject>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ListAssistantFilesResponse_H_ */
