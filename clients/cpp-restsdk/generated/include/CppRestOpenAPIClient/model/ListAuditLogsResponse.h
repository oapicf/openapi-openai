...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ListAuditLogsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ListAuditLogsResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<AuditLog>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<AuditLog>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<AuditLog>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ListAuditLogsResponse_H_ */
