...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ListMessagesResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ListMessagesResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<MessageObject>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<MessageObject>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<MessageObject>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ListMessagesResponse_H_ */
