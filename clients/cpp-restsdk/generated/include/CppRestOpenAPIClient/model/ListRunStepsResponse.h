...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ListRunStepsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ListRunStepsResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<RunStepObject>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<RunStepObject>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<RunStepObject>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ListRunStepsResponse_H_ */
