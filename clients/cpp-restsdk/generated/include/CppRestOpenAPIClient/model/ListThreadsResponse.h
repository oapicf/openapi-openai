...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ListThreadsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ListThreadsResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<ThreadObject>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<ThreadObject>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ThreadObject>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ListThreadsResponse_H_ */
