...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ModifyAssistantRequest_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ModifyAssistantRequest_H_
...
public:
    ...
    std::shared_ptr<ModifyAssistantRequest_tool_resources> getToolResources() const;
    bool toolResourcesIsSet() const;
    void unsetTool_resources();
    void setToolResources(const std::shared_ptr<ModifyAssistantRequest_tool_resources>& value);
...
protected:
    ...
    boost::optional<std::shared_ptr<ModifyAssistantRequest_tool_resources>> m_Tool_resources;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ModifyAssistantRequest_H_ */
