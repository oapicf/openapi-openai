...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectListResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectListResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<Project>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<Project>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<Project>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectListResponse_H_ */
