...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectRateLimitListResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectRateLimitListResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<ProjectRateLimit>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<ProjectRateLimit>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ProjectRateLimit>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectRateLimitListResponse_H_ */
