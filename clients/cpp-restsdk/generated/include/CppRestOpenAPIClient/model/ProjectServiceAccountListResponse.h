...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectServiceAccountListResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectServiceAccountListResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<ProjectServiceAccount>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<ProjectServiceAccount>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ProjectServiceAccount>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectServiceAccountListResponse_H_ */
