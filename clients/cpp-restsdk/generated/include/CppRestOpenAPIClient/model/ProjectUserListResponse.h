...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectUserListResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectUserListResponse_H_
...
public:
    ...
    std::vector<std::shared_ptr<ProjectUser>> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::vector<std::shared_ptr<ProjectUser>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<ProjectUser>> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ProjectUserListResponse_H_ */
