...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_RealtimeSessionCreateRequest_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_RealtimeSessionCreateRequest_H_
...
public:
    ...
    std::shared_ptr<RealtimeSessionCreateRequest_turn_detection> getTurnDetection() const;
    bool turnDetectionIsSet() const;
    void unsetTurn_detection();
    void setTurnDetection(const std::shared_ptr<RealtimeSessionCreateRequest_turn_detection>& value);
...
protected:
    ...
    std::shared_ptr<RealtimeSessionCreateRequest_turn_detection> m_Turn_detection;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_RealtimeSessionCreateRequest_H_ */
