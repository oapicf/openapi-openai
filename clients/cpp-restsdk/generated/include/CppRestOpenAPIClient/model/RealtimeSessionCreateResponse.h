...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_RealtimeSessionCreateResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_RealtimeSessionCreateResponse_H_
...
public:
    ...
    std::shared_ptr<RealtimeSessionCreateResponse_client_secret> getClientSecret() const;
    bool clientSecretIsSet() const;
    void unsetClient_secret();
    void setClientSecret(const std::shared_ptr<RealtimeSessionCreateResponse_client_secret>& value);
    ...
    /// </summary>
    utility::string_t getInputAudioFormat() const;
    bool inputAudioFormatIsSet() const;
    void unsetInput_audio_format();
    void setInputAudioFormat(const utility::string_t& value);

    /// <summary>
    /// The format of output audio. Options are &#x60;pcm16&#x60;, &#x60;g711_ulaw&#x60;, or &#x60;g711_alaw&#x60;. 
    /// </summary>
    utility::string_t getOutputAudioFormat() const;
    bool outputAudioFormatIsSet() const;
    void unsetOutput_audio_format();
    void setOutputAudioFormat(const utility::string_t& value);
    ...
    std::shared_ptr<RealtimeSessionCreateResponse_turn_detection> getTurnDetection() const;
    bool turnDetectionIsSet() const;
    void unsetTurn_detection();
    void setTurnDetection(const std::shared_ptr<RealtimeSessionCreateResponse_turn_detection>& value);
...
protected:
    std::shared_ptr<RealtimeSessionCreateResponse_client_secret> m_Client_secret;
    ...
    utility::string_t m_Input_audio_format;
    bool m_Input_audio_formatIsSet;

    utility::string_t m_Output_audio_format;
    ...
    std::shared_ptr<RealtimeSessionCreateResponse_turn_detection> m_Turn_detection;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_RealtimeSessionCreateResponse_H_ */
