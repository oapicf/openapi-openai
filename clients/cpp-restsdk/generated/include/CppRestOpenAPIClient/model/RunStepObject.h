...
protected:
    ...
    boost::optional<std::shared_ptr<RunStepObject_last_error>> m_Last_error;

    boost::optional<int32_t> m_Expired_at;
    ...
    boost::optional<std::shared_ptr<RunStepCompletionUsage>> m_Usage;
