...
pplx::task<std::shared_ptr<CreateTranscription_200_response>> AudioApi::createTranscription(std::shared_ptr<HttpContent> file, std::shared_ptr<CreateTranscriptionRequest_model> model, boost::optional<utility::string_t> language, boost::optional<utility::string_t> prompt, boost::optional<std::shared_ptr<AudioResponseFormat>> responseFormat, boost::optional<double> temperature, boost::optional<std::vector<utility::string_t>> timestampGranularitiesLeft_Square_BracketRight_Square_Bracket) const
{
    ...
    if (responseFormat && *responseFormat != nullptr)
    {
...
pplx::task<std::shared_ptr<CreateTranslation_200_response>> AudioApi::createTranslation(std::shared_ptr<HttpContent> file, std::shared_ptr<CreateTranscriptionRequest_model> model, boost::optional<utility::string_t> prompt, boost::optional<std::shared_ptr<AudioResponseFormat>> responseFormat, boost::optional<double> temperature) const
{
