...
bool AssistantStreamEvent::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool AssistantStreamEvent::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AssistantStreamEvent::getEvent() const
{
    return m_Event;
}

void AssistantStreamEvent::setEvent(const utility::string_t& value)
{
    m_Event = value;
    m_EventIsSet = true;
}

bool AssistantStreamEvent::eventIsSet() const
{
    return m_EventIsSet;
}

void AssistantStreamEvent::unsetEvent()
{
    m_EventIsSet = false;
}
utility::string_t AssistantStreamEvent::getData() const
{
    return m_Data;
}

void AssistantStreamEvent::setData(const utility::string_t& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AssistantStreamEvent::dataIsSet() const
{
    return m_DataIsSet;
}

void AssistantStreamEvent::unsetData()
{
    m_DataIsSet = false;
}
}
