...
AssistantsApiNamedToolChoice::TypeEnum AssistantsApiNamedToolChoice::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t AssistantsApiNamedToolChoice::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
AssistantsApiNamedToolChoice::TypeEnum AssistantsApiNamedToolChoice::getType() const
{
    return m_Type;
}


void AssistantsApiNamedToolChoice::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
