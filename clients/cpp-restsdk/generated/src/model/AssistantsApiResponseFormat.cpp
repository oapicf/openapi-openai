...
void AssistantsApiResponseFormat::validate()
{
    // TODO: implement validation
}

web::json::value AssistantsApiResponseFormat::toJson() const
{
...
bool AssistantsApiResponseFormat::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AssistantsApiResponseFormat::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AssistantsApiResponseFormat::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
AssistantsApiResponseFormat::TypeEnum AssistantsApiResponseFormat::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t AssistantsApiResponseFormat::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
AssistantsApiResponseFormat::TypeEnum AssistantsApiResponseFormat::getType() const
{
    return m_Type;
}


void AssistantsApiResponseFormat::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
