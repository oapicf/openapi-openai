...
bool AssistantsApiToolChoiceOption::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool AssistantsApiToolChoiceOption::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AssistantsApiToolChoiceOption::getType() const
{
    return m_Type;
}

void AssistantsApiToolChoiceOption::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AssistantsApiToolChoiceOption::typeIsSet() const
{
    return m_TypeIsSet;
}

void AssistantsApiToolChoiceOption::unsetType()
{
    m_TypeIsSet = false;
}
std::shared_ptr<ChatCompletionNamedToolChoice_function> AssistantsApiToolChoiceOption::getFunction() const
{
    return m_Function;
}

void AssistantsApiToolChoiceOption::setFunction(const std::shared_ptr<ChatCompletionNamedToolChoice_function>& value)
{
    m_Function = value;
