...
void AuditLog_api_key_created::validate()
{
    // TODO: implement validation
}

web::json::value AuditLog_api_key_created::toJson() const
{
...
bool AuditLog_api_key_created::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<AuditLog_api_key_created_data> refVal_setData;
...
void AuditLog_api_key_created::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AuditLog_api_key_created::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AuditLog_api_key_created::getId() const
{
    return m_Id;
}


void AuditLog_api_key_created::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool AuditLog_api_key_created::idIsSet() const
{
    return m_IdIsSet;
}

void AuditLog_api_key_created::unsetId()
{
    m_IdIsSet = false;
}
std::shared_ptr<AuditLog_api_key_created_data> AuditLog_api_key_created::getData() const
{
    return m_Data;
}


void AuditLog_api_key_created::setData(const std::shared_ptr<AuditLog_api_key_created_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AuditLog_api_key_created::dataIsSet() const
{
    return m_DataIsSet;
}

void AuditLog_api_key_created::unsetData()
{
    m_DataIsSet = false;
}
