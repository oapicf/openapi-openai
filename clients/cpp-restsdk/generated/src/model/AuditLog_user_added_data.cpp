...
#include "CppRestOpenAPIClient/model/AuditLog_user_added_data.h"
...
void AuditLog_user_added_data::validate()
{
    // TODO: implement validation
}

web::json::value AuditLog_user_added_data::toJson() const
{
...
bool AuditLog_user_added_data::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AuditLog_user_added_data::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AuditLog_user_added_data::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AuditLog_user_added_data::getRole() const
{
    return m_Role;
}


void AuditLog_user_added_data::setRole(const utility::string_t& value)
{
    m_Role = value;
    m_RoleIsSet = true;
}
