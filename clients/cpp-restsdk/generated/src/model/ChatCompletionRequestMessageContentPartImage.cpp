...
ChatCompletionRequestMessageContentPartImage::TypeEnum ChatCompletionRequestMessageContentPartImage::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t ChatCompletionRequestMessageContentPartImage::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
ChatCompletionRequestMessageContentPartImage::TypeEnum ChatCompletionRequestMessageContentPartImage::getType() const
{
    return m_Type;
}


void ChatCompletionRequestMessageContentPartImage::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
