...
ChatCompletionRequestMessageContentPartText::TypeEnum ChatCompletionRequestMessageContentPartText::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t ChatCompletionRequestMessageContentPartText::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
ChatCompletionRequestMessageContentPartText::TypeEnum ChatCompletionRequestMessageContentPartText::getType() const
{
    return m_Type;
}


void ChatCompletionRequestMessageContentPartText::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
