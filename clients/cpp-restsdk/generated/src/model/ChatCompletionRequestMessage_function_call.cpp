...
void ChatCompletionRequestMessage_function_call::validate()
{
    // TODO: implement validation
}

web::json::value ChatCompletionRequestMessage_function_call::toJson() const
{
...
bool ChatCompletionRequestMessage_function_call::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ChatCompletionRequestMessage_function_call::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ChatCompletionRequestMessage_function_call::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t ChatCompletionRequestMessage_function_call::getName() const
{
    return m_Name;
}

void ChatCompletionRequestMessage_function_call::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}
...
utility::string_t ChatCompletionRequestMessage_function_call::getArguments() const
{
    return m_Arguments;
}

void ChatCompletionRequestMessage_function_call::setArguments(const utility::string_t& value)
{
    m_Arguments = value;
