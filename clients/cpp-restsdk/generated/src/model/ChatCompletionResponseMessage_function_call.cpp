...
void ChatCompletionResponseMessage_function_call::validate()
{
    // TODO: implement validation
}

web::json::value ChatCompletionResponseMessage_function_call::toJson() const
{
...
bool ChatCompletionResponseMessage_function_call::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ChatCompletionResponseMessage_function_call::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ChatCompletionResponseMessage_function_call::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ChatCompletionResponseMessage_function_call::getArguments() const
{
    return m_Arguments;
}


void ChatCompletionResponseMessage_function_call::setArguments(const utility::string_t& value)
{
    m_Arguments = value;
    m_ArgumentsIsSet = true;
}

bool ChatCompletionResponseMessage_function_call::argumentsIsSet() const
{
    return m_ArgumentsIsSet;
}

void ChatCompletionResponseMessage_function_call::unsetArguments()
{
    m_ArgumentsIsSet = false;
}
utility::string_t ChatCompletionResponseMessage_function_call::getName() const
{
    return m_Name;
}


void ChatCompletionResponseMessage_function_call::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool ChatCompletionResponseMessage_function_call::nameIsSet() const
{
    return m_NameIsSet;
}

void ChatCompletionResponseMessage_function_call::unsetName()
{
    m_NameIsSet = false;
}
