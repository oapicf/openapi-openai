...
utility::string_t ChatCompletionStreamResponseDelta::getRefusal() const
{
    return m_Refusal.get();
}


void ChatCompletionStreamResponseDelta::setRefusal(const utility::string_t& value)
{
    m_Refusal = value;
}

bool ChatCompletionStreamResponseDelta::refusalIsSet() const
{
    return m_Refusal.has_value();
}

void ChatCompletionStreamResponseDelta::unsetRefusal()
{
    m_Refusal.reset();
}
