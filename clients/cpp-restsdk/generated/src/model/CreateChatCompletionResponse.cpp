...
std::shared_ptr<CreateCompletionResponse_usage> CreateChatCompletionResponse::getUsage() const
{
    return m_Usage;
}

void CreateChatCompletionResponse::setUsage(const std::shared_ptr<CreateCompletionResponse_usage>& value)
{
    m_Usage = value;
    m_UsageIsSet = true;
}
