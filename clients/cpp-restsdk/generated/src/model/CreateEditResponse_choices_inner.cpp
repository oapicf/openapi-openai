...
#include "CppRestOpenAPIClient/model/CreateEditResponse_choices_inner.h"
...
void CreateEditResponse_choices_inner::validate()
{
    // TODO: implement validation
}

web::json::value CreateEditResponse_choices_inner::toJson() const
{
...
bool CreateEditResponse_choices_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateEditResponse_choices_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateEditResponse_choices_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateEditResponse_choices_inner::getText() const
{
    return m_Text;
}

void CreateEditResponse_choices_inner::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}
...
void CreateEditResponse_choices_inner::setIndex(int32_t value)
{
    m_Index = value;
    m_IndexIsSet = true;
}
...
std::shared_ptr<CreateCompletionResponse_choices_inner_logprobs> CreateEditResponse_choices_inner::getLogprobs() const
{
    return m_Logprobs;
}

void CreateEditResponse_choices_inner::setLogprobs(const std::shared_ptr<CreateCompletionResponse_choices_inner_logprobs>& value)
{
    m_Logprobs = value;
...
utility::string_t CreateEditResponse_choices_inner::getFinishReason() const
{
    return m_Finish_reason;
}

void CreateEditResponse_choices_inner::setFinishReason(const utility::string_t& value)
{
