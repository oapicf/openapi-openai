...
CreateEmbeddingResponse::ObjectEnum CreateEmbeddingResponse::toObjectEnum(const utility::string_t& value) const
{
...
const utility::string_t CreateEmbeddingResponse::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
...
std::vector<std::shared_ptr<Embedding>> CreateEmbeddingResponse::getData() const
{
    return m_Data;
}
...
CreateEmbeddingResponse::ObjectEnum CreateEmbeddingResponse::getObject() const
{
    return m_object;
}


void CreateEmbeddingResponse::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}
