...
bool CreateModerationResponse_results_inner_category_scores::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("illicit/violent"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            double refVal_setIllicitViolent;
...
double CreateModerationResponse_results_inner_category_scores::getIllicit() const
{
    return m_Illicit;
}

void CreateModerationResponse_results_inner_category_scores::setIllicit(double value)
{
    m_Illicit = value;
    m_IllicitIsSet = true;
}

bool CreateModerationResponse_results_inner_category_scores::illicitIsSet() const
{
    return m_IllicitIsSet;
}

void CreateModerationResponse_results_inner_category_scores::unsetIllicit()
{
    m_IllicitIsSet = false;
}
double CreateModerationResponse_results_inner_category_scores::getIllicitViolent() const
{
    return m_Illicit_violent;
}

void CreateModerationResponse_results_inner_category_scores::setIllicitViolent(double value)
{
    m_Illicit_violent = value;
    m_Illicit_violentIsSet = true;
}

bool CreateModerationResponse_results_inner_category_scores::illicitViolentIsSet() const
{
    return m_Illicit_violentIsSet;
}

void CreateModerationResponse_results_inner_category_scores::unsetIllicit_violent()
{
    m_Illicit_violentIsSet = false;
}
