...
std::vector<std::shared_ptr<TranscriptionWord>> CreateTranscriptionResponseVerboseJson::getWords() const
{
    return m_Words;
}
...
std::vector<std::shared_ptr<TranscriptionSegment>> CreateTranscriptionResponseVerboseJson::getSegments() const
{
    return m_Segments;
}
