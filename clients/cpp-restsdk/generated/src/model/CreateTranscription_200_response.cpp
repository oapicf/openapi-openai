...
bool CreateTranscription_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool CreateTranscription_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CreateTranscription_200_response::getText() const
{
    return m_Text;
}

void CreateTranscription_200_response::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool CreateTranscription_200_response::textIsSet() const
{
    return m_TextIsSet;
}

void CreateTranscription_200_response::unsetText()
{
    m_TextIsSet = false;
}
utility::string_t CreateTranscription_200_response::getLanguage() const
{
    return m_Language;
}

void CreateTranscription_200_response::setLanguage(const utility::string_t& value)
{
    m_Language = value;
    m_LanguageIsSet = true;
}

bool CreateTranscription_200_response::languageIsSet() const
{
    return m_LanguageIsSet;
}

void CreateTranscription_200_response::unsetLanguage()
{
    m_LanguageIsSet = false;
}
utility::string_t CreateTranscription_200_response::getDuration() const
{
    return m_Duration;
}

void CreateTranscription_200_response::setDuration(const utility::string_t& value)
{
    m_Duration = value;
    m_DurationIsSet = true;
}

bool CreateTranscription_200_response::durationIsSet() const
{
    return m_DurationIsSet;
}

void CreateTranscription_200_response::unsetDuration()
{
    m_DurationIsSet = false;
}
std::vector<std::shared_ptr<TranscriptionWord>>& CreateTranscription_200_response::getWords()
{
    return m_Words;
}

void CreateTranscription_200_response::setWords(const std::vector<std::shared_ptr<TranscriptionWord>>& value)
{
    m_Words = value;
    m_WordsIsSet = true;
}
...
std::vector<std::shared_ptr<TranscriptionSegment>>& CreateTranscription_200_response::getSegments()
{
    return m_Segments;
}

void CreateTranscription_200_response::setSegments(const std::vector<std::shared_ptr<TranscriptionSegment>>& value)
{
    m_Segments = value;
