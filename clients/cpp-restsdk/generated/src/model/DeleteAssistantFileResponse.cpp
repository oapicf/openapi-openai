...
void DeleteAssistantFileResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteAssistantFileResponse::toJson() const
{
...
bool DeleteAssistantFileResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteAssistantFileResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteAssistantFileResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
DeleteAssistantFileResponse::ObjectEnum DeleteAssistantFileResponse::toObjectEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("assistant.file.deleted")) {
        return ObjectEnum::ASSISTANT_FILE_DELETED;
    }
...
const utility::string_t DeleteAssistantFileResponse::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
        
        case ObjectEnum::ASSISTANT_FILE_DELETED: return utility::conversions::to_string_t("assistant.file.deleted");
        
    }
}


utility::string_t DeleteAssistantFileResponse::getId() const
{
    return m_Id;
}


void DeleteAssistantFileResponse::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DeleteAssistantFileResponse::idIsSet() const
{
    return m_IdIsSet;
}

void DeleteAssistantFileResponse::unsetId()
{
    m_IdIsSet = false;
}
...
void DeleteAssistantFileResponse::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool DeleteAssistantFileResponse::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void DeleteAssistantFileResponse::unsetDeleted()
{
    m_DeletedIsSet = false;
}
DeleteAssistantFileResponse::ObjectEnum DeleteAssistantFileResponse::getObject() const
{
    return m_object;
}


void DeleteAssistantFileResponse::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}

bool DeleteAssistantFileResponse::objectIsSet() const
{
    return m_objectIsSet;
}

void DeleteAssistantFileResponse::unsetobject()
{
    m_objectIsSet = false;
}
