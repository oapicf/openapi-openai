...
DeleteAssistantResponse::ObjectEnum DeleteAssistantResponse::toObjectEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("assistant.deleted")) {
        return ObjectEnum::ASSISTANT_DELETED;
    }
...
const utility::string_t DeleteAssistantResponse::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
        
        case ObjectEnum::ASSISTANT_DELETED: return utility::conversions::to_string_t("assistant.deleted");
...
DeleteAssistantResponse::ObjectEnum DeleteAssistantResponse::getObject() const
{
    return m_object;
}


void DeleteAssistantResponse::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}
