...
DeleteFileResponse::ObjectEnum DeleteFileResponse::toObjectEnum(const utility::string_t& value) const
{
...
const utility::string_t DeleteFileResponse::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
...
DeleteFileResponse::ObjectEnum DeleteFileResponse::getObject() const
{
    return m_object;
}


void DeleteFileResponse::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}
