...
void DeleteMessageResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteMessageResponse::toJson() const
{
...
bool DeleteMessageResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteMessageResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteMessageResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
DeleteMessageResponse::ObjectEnum DeleteMessageResponse::toObjectEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("thread.message.deleted")) {
        return ObjectEnum::THREAD_MESSAGE_DELETED;
    }
...
const utility::string_t DeleteMessageResponse::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
        
        case ObjectEnum::THREAD_MESSAGE_DELETED: return utility::conversions::to_string_t("thread.message.deleted");
        
    }
}


utility::string_t DeleteMessageResponse::getId() const
{
    return m_Id;
}


void DeleteMessageResponse::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool DeleteMessageResponse::idIsSet() const
{
    return m_IdIsSet;
}

void DeleteMessageResponse::unsetId()
{
    m_IdIsSet = false;
}
...
void DeleteMessageResponse::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool DeleteMessageResponse::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void DeleteMessageResponse::unsetDeleted()
{
    m_DeletedIsSet = false;
}
DeleteMessageResponse::ObjectEnum DeleteMessageResponse::getObject() const
{
    return m_object;
}


void DeleteMessageResponse::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}

bool DeleteMessageResponse::objectIsSet() const
{
    return m_objectIsSet;
}

void DeleteMessageResponse::unsetobject()
{
    m_objectIsSet = false;
}
