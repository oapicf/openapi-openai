...
utility::string_t DoneEvent::getEvent() const
{
    return m_Event;
}

void DoneEvent::setEvent(const utility::string_t& value)
{
    m_Event = value;
    m_EventIsSet = true;
}
...
utility::string_t DoneEvent::getData() const
{
    return m_Data;
}

void DoneEvent::setData(const utility::string_t& value)
{
    m_Data = value;
    m_DataIsSet = true;
}
