...
web::json::value FineTuningJob::toJson() const
{
    ...
    if(m_Estimated_finish.has_value())
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("estimated_finish"))] = ModelBase::toJson(m_Estimated_finish.get());
    }
    if(m_MethodIsSet)
    {
...
bool FineTuningJob::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("estimated_finish"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("estimated_finish")));
        if(!fieldValue.is_null())
        {
            int32_t refVal_setEstimatedFinish;
            ok &= ModelBase::fromJson(fieldValue, refVal_setEstimatedFinish);
            setEstimatedFinish(refVal_setEstimatedFinish);
...
void FineTuningJob::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Estimated_finish.has_value())
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("estimated_finish")), m_Estimated_finish.get()));
    }
    if(m_MethodIsSet)
    {
...
bool FineTuningJob::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("estimated_finish"))))
    {
        int32_t refVal_setEstimatedFinish;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("estimated_finish"))), refVal_setEstimatedFinish );
        setEstimatedFinish(refVal_setEstimatedFinish);
    }
...
{
    return m_Estimated_finish.get();
}

void FineTuningJob::setEstimatedFinish(int32_t value)
{
...
{
    return m_Estimated_finish.has_value();
}

void FineTuningJob::unsetEstimated_finish()
{
    m_Estimated_finish.reset();
}
std::shared_ptr<FineTuneMethod> FineTuningJob::getMethod() const
{
    return m_Method;
}


void FineTuningJob::setMethod(const std::shared_ptr<FineTuneMethod>& value)
{
    m_Method = value;
    m_MethodIsSet = true;
}
