...
web::json::value FineTuningJobCheckpoint::toJson() const
{
    ...
    if(m_Fine_tuned_model_checkpointIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("fine_tuned_model_checkpoint"))] = ModelBase::toJson(m_Fine_tuned_model_checkpoint);
    }
    if(m_Step_numberIsSet)
    {
        
        val[utility::conversions::to_string_t(_XPLATSTR("step_number"))] = ModelBase::toJson(m_Step_number);
    }
    if(m_MetricsIsSet)
    {
    ...
    if(m_Fine_tuning_job_idIsSet)
    {
        ...
        val[utility::conversions::to_string_t(_XPLATSTR("fine_tuning_job_id"))] = ModelBase::toJson(m_Fine_tuning_job_id);
    }
    if(m_objectIsSet)
    {
...
bool FineTuningJobCheckpoint::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("fine_tuned_model_checkpoint"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("fine_tuned_model_checkpoint")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("step_number"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("step_number")));
        if(!fieldValue.is_null())
        {
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("fine_tuning_job_id"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(_XPLATSTR("fine_tuning_job_id")));
        if(!fieldValue.is_null())
        {
...
void FineTuningJobCheckpoint::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Fine_tuned_model_checkpointIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("fine_tuned_model_checkpoint")), m_Fine_tuned_model_checkpoint));
    }
    if(m_Step_numberIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("step_number")), m_Step_number));
    }
    if(m_MetricsIsSet)
    {
    ...
    if(m_Fine_tuning_job_idIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(_XPLATSTR("fine_tuning_job_id")), m_Fine_tuning_job_id));
    }
    if(m_objectIsSet)
    {
...
bool FineTuningJobCheckpoint::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("fine_tuned_model_checkpoint"))))
    {
        utility::string_t refVal_setFineTunedModelCheckpoint;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("fine_tuned_model_checkpoint"))), refVal_setFineTunedModelCheckpoint );
        setFineTunedModelCheckpoint(refVal_setFineTunedModelCheckpoint);
    }
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("step_number"))))
    {
        int32_t refVal_setStepNumber;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("step_number"))), refVal_setStepNumber );
        setStepNumber(refVal_setStepNumber);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(_XPLATSTR("fine_tuning_job_id"))))
    {
        utility::string_t refVal_setFineTuningJobId;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(_XPLATSTR("fine_tuning_job_id"))), refVal_setFineTuningJobId );
        setFineTuningJobId(refVal_setFineTuningJobId);
    }
...
FineTuningJobCheckpoint::ObjectEnum FineTuningJobCheckpoint::toObjectEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("fine_tuning.job.checkpoint")) {
        return ObjectEnum::FINE_TUNING_JOB_CHECKPOINT;
    }
...
const utility::string_t FineTuningJobCheckpoint::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
        
        case ObjectEnum::FINE_TUNING_JOB_CHECKPOINT: return utility::conversions::to_string_t("fine_tuning.job.checkpoint");
...
FineTuningJobCheckpoint::ObjectEnum FineTuningJobCheckpoint::getObject() const
{
    return m_object;
}


void FineTuningJobCheckpoint::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}
