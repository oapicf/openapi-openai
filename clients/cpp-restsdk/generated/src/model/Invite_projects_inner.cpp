...
void Invite_projects_inner::validate()
{
    // TODO: implement validation
}

web::json::value Invite_projects_inner::toJson() const
{
...
bool Invite_projects_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Invite_projects_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Invite_projects_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
Invite_projects_inner::RoleEnum Invite_projects_inner::toRoleEnum(const utility::string_t& value) const
{
...
const utility::string_t Invite_projects_inner::fromRoleEnum(const RoleEnum value) const
{
    switch(value)
    {
...
utility::string_t Invite_projects_inner::getId() const
{
    return m_Id;
}


void Invite_projects_inner::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}
...
Invite_projects_inner::RoleEnum Invite_projects_inner::getRole() const
{
    return m_Role;
}


void Invite_projects_inner::setRole(const RoleEnum value)
{
    m_Role = value;
    m_RoleIsSet = true;
}
