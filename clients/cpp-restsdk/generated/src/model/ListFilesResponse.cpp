...
utility::string_t ListFilesResponse::getFirstId() const
{
    return m_First_id;
}


void ListFilesResponse::setFirstId(const utility::string_t& value)
{
    m_First_id = value;
    m_First_idIsSet = true;
}

bool ListFilesResponse::firstIdIsSet() const
{
    return m_First_idIsSet;
}

void ListFilesResponse::unsetFirst_id()
{
    m_First_idIsSet = false;
}
utility::string_t ListFilesResponse::getLastId() const
{
    return m_Last_id;
}


void ListFilesResponse::setLastId(const utility::string_t& value)
{
    m_Last_id = value;
    m_Last_idIsSet = true;
}

bool ListFilesResponse::lastIdIsSet() const
{
    return m_Last_idIsSet;
}

void ListFilesResponse::unsetLast_id()
{
    m_Last_idIsSet = false;
}
bool ListFilesResponse::isHasMore() const
{
    return m_Has_more;
}

void ListFilesResponse::setHasMore(bool value)
{
    m_Has_more = value;
    m_Has_moreIsSet = true;
}

bool ListFilesResponse::hasMoreIsSet() const
{
    return m_Has_moreIsSet;
}

void ListFilesResponse::unsetHas_more()
{
    m_Has_moreIsSet = false;
}
