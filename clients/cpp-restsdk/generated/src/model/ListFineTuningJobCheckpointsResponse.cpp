...
std::vector<std::shared_ptr<FineTuningJobCheckpoint>>& ListFineTuningJobCheckpointsResponse::getData()
{
    return m_Data;
}
...
utility::string_t ListFineTuningJobCheckpointsResponse::getObject() const
{
    return m_object;
}

void ListFineTuningJobCheckpointsResponse::setObject(const utility::string_t& value)
{
    m_object = value;
    m_objectIsSet = true;
}
