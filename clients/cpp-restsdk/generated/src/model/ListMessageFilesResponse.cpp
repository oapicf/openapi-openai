...
void ListMessageFilesResponse::validate()
{
    // TODO: implement validation
}

web::json::value ListMessageFilesResponse::toJson() const
{
...
bool ListMessageFilesResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<MessageFileObject>> refVal_setData;
...
void ListMessageFilesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ListMessageFilesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ListMessageFilesResponse::getObject() const
{
    return m_object;
}


void ListMessageFilesResponse::setObject(const utility::string_t& value)
{
    m_object = value;
    m_objectIsSet = true;
}

bool ListMessageFilesResponse::objectIsSet() const
{
    return m_objectIsSet;
}

void ListMessageFilesResponse::unsetobject()
{
    m_objectIsSet = false;
}
std::vector<std::shared_ptr<MessageFileObject>> ListMessageFilesResponse::getData() const
{
    return m_Data;
}


void ListMessageFilesResponse::setData(const std::vector<std::shared_ptr<MessageFileObject>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ListMessageFilesResponse::dataIsSet() const
{
    return m_DataIsSet;
}

void ListMessageFilesResponse::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ListMessageFilesResponse::getFirstId() const
{
    return m_First_id;
}


void ListMessageFilesResponse::setFirstId(const utility::string_t& value)
{
    m_First_id = value;
    m_First_idIsSet = true;
}

bool ListMessageFilesResponse::firstIdIsSet() const
{
    return m_First_idIsSet;
}

void ListMessageFilesResponse::unsetFirst_id()
{
    m_First_idIsSet = false;
}
utility::string_t ListMessageFilesResponse::getLastId() const
{
    return m_Last_id;
}


void ListMessageFilesResponse::setLastId(const utility::string_t& value)
{
    m_Last_id = value;
    m_Last_idIsSet = true;
}

bool ListMessageFilesResponse::lastIdIsSet() const
{
    return m_Last_idIsSet;
}

void ListMessageFilesResponse::unsetLast_id()
{
    m_Last_idIsSet = false;
}
...
bool ListMessageFilesResponse::hasMoreIsSet() const
{
    return m_Has_moreIsSet;
}

void ListMessageFilesResponse::unsetHas_more()
{
    m_Has_moreIsSet = false;
}
