...
void ListMessagesResponse::validate()
{
    // TODO: implement validation
}

web::json::value ListMessagesResponse::toJson() const
{
...
bool ListMessagesResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<MessageObject>> refVal_setData;
...
void ListMessagesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ListMessagesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t ListMessagesResponse::getObject() const
{
    return m_object;
}


void ListMessagesResponse::setObject(const utility::string_t& value)
{
    m_object = value;
    m_objectIsSet = true;
}

bool ListMessagesResponse::objectIsSet() const
{
    return m_objectIsSet;
}

void ListMessagesResponse::unsetobject()
{
    m_objectIsSet = false;
}
std::vector<std::shared_ptr<MessageObject>> ListMessagesResponse::getData() const
{
    return m_Data;
}


void ListMessagesResponse::setData(const std::vector<std::shared_ptr<MessageObject>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ListMessagesResponse::dataIsSet() const
{
    return m_DataIsSet;
}

void ListMessagesResponse::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ListMessagesResponse::getFirstId() const
{
    return m_First_id;
}


void ListMessagesResponse::setFirstId(const utility::string_t& value)
{
    m_First_id = value;
    m_First_idIsSet = true;
}

bool ListMessagesResponse::firstIdIsSet() const
{
    return m_First_idIsSet;
}

void ListMessagesResponse::unsetFirst_id()
{
    m_First_idIsSet = false;
}
utility::string_t ListMessagesResponse::getLastId() const
{
    return m_Last_id;
}


void ListMessagesResponse::setLastId(const utility::string_t& value)
{
    m_Last_id = value;
    m_Last_idIsSet = true;
}

bool ListMessagesResponse::lastIdIsSet() const
{
    return m_Last_idIsSet;
}

void ListMessagesResponse::unsetLast_id()
{
    m_Last_idIsSet = false;
}
...
void ListMessagesResponse::setHasMore(bool value)
{
    m_Has_more = value;
    m_Has_moreIsSet = true;
}

bool ListMessagesResponse::hasMoreIsSet() const
{
    return m_Has_moreIsSet;
}

void ListMessagesResponse::unsetHas_more()
{
    m_Has_moreIsSet = false;
}
