...
utility::string_t MessageContentTextAnnotationsFileCitationObject::getType() const
{
    return m_Type;
}

void MessageContentTextAnnotationsFileCitationObject::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
