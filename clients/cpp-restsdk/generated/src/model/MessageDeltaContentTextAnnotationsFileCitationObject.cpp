...
utility::string_t MessageDeltaContentTextAnnotationsFileCitationObject::getType() const
{
    return m_Type;
}

void MessageDeltaContentTextAnnotationsFileCitationObject::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
