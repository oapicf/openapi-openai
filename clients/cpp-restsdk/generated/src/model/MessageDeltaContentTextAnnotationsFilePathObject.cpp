...
utility::string_t MessageDeltaContentTextAnnotationsFilePathObject::getType() const
{
    return m_Type;
}

void MessageDeltaContentTextAnnotationsFilePathObject::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
