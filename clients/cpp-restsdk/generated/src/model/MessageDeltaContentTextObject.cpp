...
MessageDeltaContentTextObject::TypeEnum MessageDeltaContentTextObject::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t MessageDeltaContentTextObject::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
MessageDeltaContentTextObject::TypeEnum MessageDeltaContentTextObject::getType() const
{
    return m_Type;
}


void MessageDeltaContentTextObject::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
