...
MessageDeltaObject::ObjectEnum MessageDeltaObject::toObjectEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("thread.message.delta")) {
        return ObjectEnum::THREAD_MESSAGE_DELTA;
    }
...
const utility::string_t MessageDeltaObject::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
        
        case ObjectEnum::THREAD_MESSAGE_DELTA: return utility::conversions::to_string_t("thread.message.delta");
...
MessageDeltaObject::ObjectEnum MessageDeltaObject::getObject() const
{
    return m_object;
}


void MessageDeltaObject::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}
