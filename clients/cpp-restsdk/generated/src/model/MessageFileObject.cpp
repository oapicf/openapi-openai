...
MessageFileObject::ObjectEnum MessageFileObject::toObjectEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("thread.message.file")) {
        return ObjectEnum::THREAD_MESSAGE_FILE;
    }
...
const utility::string_t MessageFileObject::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
        
        case ObjectEnum::THREAD_MESSAGE_FILE: return utility::conversions::to_string_t("thread.message.file");
...
MessageFileObject::ObjectEnum MessageFileObject::getObject() const
{
    return m_object;
}


void MessageFileObject::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}
