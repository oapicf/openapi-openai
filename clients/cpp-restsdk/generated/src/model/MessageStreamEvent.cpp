...
bool MessageStreamEvent::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool MessageStreamEvent::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t MessageStreamEvent::getEvent() const
{
    return m_Event;
}

void MessageStreamEvent::setEvent(const utility::string_t& value)
{
    m_Event = value;
    m_EventIsSet = true;
}

bool MessageStreamEvent::eventIsSet() const
{
    return m_EventIsSet;
}

void MessageStreamEvent::unsetEvent()
{
    m_EventIsSet = false;
}
std::shared_ptr<MessageObject> MessageStreamEvent::getData() const
{
    return m_Data;
}

void MessageStreamEvent::setData(const std::shared_ptr<MessageObject>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool MessageStreamEvent::dataIsSet() const
{
    return m_DataIsSet;
}

void MessageStreamEvent::unsetData()
{
    m_DataIsSet = false;
}
}
