...
MessageStreamEvent_oneOf_1::EventEnum MessageStreamEvent_oneOf_1::toEventEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("thread.message.in_progress")) {
        return EventEnum::THREAD_MESSAGE_IN_PROGRESS;
    }
...
const utility::string_t MessageStreamEvent_oneOf_1::fromEventEnum(const EventEnum value) const
{
    switch(value)
    {
        
        case EventEnum::THREAD_MESSAGE_IN_PROGRESS: return utility::conversions::to_string_t("thread.message.in_progress");
        
    }
}


MessageStreamEvent_oneOf_1::EventEnum MessageStreamEvent_oneOf_1::getEvent() const
{
    return m_Event;
}


void MessageStreamEvent_oneOf_1::setEvent(const EventEnum value)
{
    m_Event = value;
    m_EventIsSet = true;
}
