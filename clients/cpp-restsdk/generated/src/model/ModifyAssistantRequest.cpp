...
bool ModifyAssistantRequest::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("tool_resources"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ModifyAssistantRequest_tool_resources> refVal_setToolResources;
...
std::shared_ptr<ModifyAssistantRequest_tool_resources> ModifyAssistantRequest::getToolResources() const
{
    return m_Tool_resources.get();
}


void ModifyAssistantRequest::setToolResources(const std::shared_ptr<ModifyAssistantRequest_tool_resources>& value)
{
...
std::shared_ptr<AssistantsApiResponseFormatOption> ModifyAssistantRequest::getResponseFormat() const
{
    return m_Response_format;
}


void ModifyAssistantRequest::setResponseFormat(const std::shared_ptr<AssistantsApiResponseFormatOption>& value)
{
