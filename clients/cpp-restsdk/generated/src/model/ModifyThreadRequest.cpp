...
std::shared_ptr<ModifyThreadRequest_tool_resources> ModifyThreadRequest::getToolResources() const
{
    return m_Tool_resources.get();
}


void ModifyThreadRequest::setToolResources(const std::shared_ptr<ModifyThreadRequest_tool_resources>& value)
{
