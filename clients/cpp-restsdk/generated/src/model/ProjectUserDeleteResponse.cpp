...
void ProjectUserDeleteResponse::validate()
{
    // TODO: implement validation
}

web::json::value ProjectUserDeleteResponse::toJson() const
{
...
bool ProjectUserDeleteResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ProjectUserDeleteResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ProjectUserDeleteResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
ProjectUserDeleteResponse::ObjectEnum ProjectUserDeleteResponse::toObjectEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("organization.project.user.deleted")) {
        return ObjectEnum::ORGANIZATION_PROJECT_USER_DELETED;
    }
...
const utility::string_t ProjectUserDeleteResponse::fromObjectEnum(const ObjectEnum value) const
{
    switch(value)
    {
        
        case ObjectEnum::ORGANIZATION_PROJECT_USER_DELETED: return utility::conversions::to_string_t("organization.project.user.deleted");
        
    }
}


ProjectUserDeleteResponse::ObjectEnum ProjectUserDeleteResponse::getObject() const
{
    return m_object;
}


void ProjectUserDeleteResponse::setObject(const ObjectEnum value)
{
    m_object = value;
    m_objectIsSet = true;
}

bool ProjectUserDeleteResponse::objectIsSet() const
{
    return m_objectIsSet;
}

void ProjectUserDeleteResponse::unsetobject()
{
    m_objectIsSet = false;
}
utility::string_t ProjectUserDeleteResponse::getId() const
{
    return m_Id;
}


void ProjectUserDeleteResponse::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool ProjectUserDeleteResponse::idIsSet() const
{
    return m_IdIsSet;
}

void ProjectUserDeleteResponse::unsetId()
{
    m_IdIsSet = false;
}
bool ProjectUserDeleteResponse::isDeleted() const
{
    return m_Deleted;
}

void ProjectUserDeleteResponse::setDeleted(bool value)
{
    m_Deleted = value;
    m_DeletedIsSet = true;
}

bool ProjectUserDeleteResponse::deletedIsSet() const
{
    return m_DeletedIsSet;
}

void ProjectUserDeleteResponse::unsetDeleted()
{
    m_DeletedIsSet = false;
}
