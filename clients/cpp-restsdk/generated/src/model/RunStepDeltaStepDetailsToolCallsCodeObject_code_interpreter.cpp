...
std::vector<std::shared_ptr<RunStepDeltaStepDetailsToolCallsCodeObject_code_interpreter_outputs_inner>>& RunStepDeltaStepDetailsToolCallsCodeObject_code_interpreter::getOutputs()
{
    return m_Outputs;
}
