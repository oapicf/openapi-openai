...
RunStepDetailsMessageCreationObject::TypeEnum RunStepDetailsMessageCreationObject::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t RunStepDetailsMessageCreationObject::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
RunStepDetailsMessageCreationObject::TypeEnum RunStepDetailsMessageCreationObject::getType() const
{
    return m_Type;
}


void RunStepDetailsMessageCreationObject::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
