...
bool RunStepObject_step_details::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool RunStepObject_step_details::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t RunStepObject_step_details::getType() const
{
    return m_Type;
}

void RunStepObject_step_details::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool RunStepObject_step_details::typeIsSet() const
{
    return m_TypeIsSet;
}

void RunStepObject_step_details::unsetType()
{
    m_TypeIsSet = false;
}
std::shared_ptr<RunStepDetailsMessageCreationObject_message_creation> RunStepObject_step_details::getMessageCreation() const
{
    return m_Message_creation;
}

void RunStepObject_step_details::setMessageCreation(const std::shared_ptr<RunStepDetailsMessageCreationObject_message_creation>& value)
{
    m_Message_creation = value;
    m_Message_creationIsSet = true;
}

bool RunStepObject_step_details::messageCreationIsSet() const
{
    return m_Message_creationIsSet;
}

void RunStepObject_step_details::unsetMessage_creation()
{
    m_Message_creationIsSet = false;
}
std::vector<std::shared_ptr<RunStepDetailsToolCallsObject_tool_calls_inner>>& RunStepObject_step_details::getToolCalls()
{
    return m_Tool_calls;
}

void RunStepObject_step_details::setToolCalls(const std::vector<std::shared_ptr<RunStepDetailsToolCallsObject_tool_calls_inner>>& value)
{
    m_Tool_calls = value;
    m_Tool_callsIsSet = true;
}

bool RunStepObject_step_details::toolCallsIsSet() const
{
    return m_Tool_callsIsSet;
}

void RunStepObject_step_details::unsetTool_calls()
{
    m_Tool_callsIsSet = false;
}
}
