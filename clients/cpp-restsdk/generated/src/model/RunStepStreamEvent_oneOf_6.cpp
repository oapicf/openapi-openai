...
RunStepStreamEvent_oneOf_6::EventEnum RunStepStreamEvent_oneOf_6::toEventEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("thread.run.step.expired")) {
        return EventEnum::THREAD_RUN_STEP_EXPIRED;
    }
...
const utility::string_t RunStepStreamEvent_oneOf_6::fromEventEnum(const EventEnum value) const
{
    switch(value)
    {
        
        case EventEnum::THREAD_RUN_STEP_EXPIRED: return utility::conversions::to_string_t("thread.run.step.expired");
        
    }
}


RunStepStreamEvent_oneOf_6::EventEnum RunStepStreamEvent_oneOf_6::getEvent() const
{
    return m_Event;
}


void RunStepStreamEvent_oneOf_6::setEvent(const EventEnum value)
{
    m_Event = value;
    m_EventIsSet = true;
}
