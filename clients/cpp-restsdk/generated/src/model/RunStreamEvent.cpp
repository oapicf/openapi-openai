...
bool RunStreamEvent::fromJson(const web::json::value& val)
{
    bool ok = true;
...
bool RunStreamEvent::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t RunStreamEvent::getEvent() const
{
    return m_Event;
}

void RunStreamEvent::setEvent(const utility::string_t& value)
{
    m_Event = value;
    m_EventIsSet = true;
}

bool RunStreamEvent::eventIsSet() const
{
    return m_EventIsSet;
}

void RunStreamEvent::unsetEvent()
{
    m_EventIsSet = false;
}
std::shared_ptr<RunObject> RunStreamEvent::getData() const
{
    return m_Data;
}

void RunStreamEvent::setData(const std::shared_ptr<RunObject>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool RunStreamEvent::dataIsSet() const
{
    return m_DataIsSet;
}

void RunStreamEvent::unsetData()
{
    m_DataIsSet = false;
}
}
