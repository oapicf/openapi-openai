...
RunStreamEvent_oneOf_4::EventEnum RunStreamEvent_oneOf_4::toEventEnum(const utility::string_t& value) const
{
    
    if (value == utility::conversions::to_string_t("thread.run.completed")) {
        return EventEnum::THREAD_RUN_COMPLETED;
    }
...
const utility::string_t RunStreamEvent_oneOf_4::fromEventEnum(const EventEnum value) const
{
    switch(value)
    {
        
        case EventEnum::THREAD_RUN_COMPLETED: return utility::conversions::to_string_t("thread.run.completed");
        
    }
}


RunStreamEvent_oneOf_4::EventEnum RunStreamEvent_oneOf_4::getEvent() const
{
    return m_Event;
}


void RunStreamEvent_oneOf_4::setEvent(const EventEnum value)
{
    m_Event = value;
    m_EventIsSet = true;
}
