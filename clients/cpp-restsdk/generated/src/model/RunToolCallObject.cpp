...
RunToolCallObject::TypeEnum RunToolCallObject::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t RunToolCallObject::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
RunToolCallObject::TypeEnum RunToolCallObject::getType() const
{
    return m_Type;
}


void RunToolCallObject::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}
