...
#ifndef TINY_CPP_CLIENT_AssistantObject_H_
#define TINY_CPP_CLIENT_AssistantObject_H_
...
public:
	 ...
	 */
    AssistantObject();
    AssistantObject(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AssistantObject_H_ */
