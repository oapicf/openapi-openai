...
AssistantObject_tool_resources::AssistantObject_tool_resources(std::string jsonString)
{
...
void
AssistantObject_tool_resources::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(code_interpreterKey))
    {
        ...
        AssistantObject_tool_resources_code_interpreter* obj = &code_interpreter;
