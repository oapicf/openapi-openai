...
AssistantObject_tool_resources_code_interpreter::AssistantObject_tool_resources_code_interpreter(std::string jsonString)
{
...
void
AssistantObject_tool_resources_code_interpreter::fromJson(std::string jsonObj)
{
