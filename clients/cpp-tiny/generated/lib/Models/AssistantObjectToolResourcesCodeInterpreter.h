...
#ifndef TINY_CPP_CLIENT_AssistantObject_tool_resources_code_interpreter_H_
#define TINY_CPP_CLIENT_AssistantObject_tool_resources_code_interpreter_H_
...
public:
    ...
    AssistantObject_tool_resources_code_interpreter(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~AssistantObject_tool_resources_code_interpreter();
...
#endif /* TINY_CPP_CLIENT_AssistantObject_tool_resources_code_interpreter_H_ */
