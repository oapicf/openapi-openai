...
AssistantObject_tool_resources_file_search::AssistantObject_tool_resources_file_search(std::string jsonString)
{
...
void
AssistantObject_tool_resources_file_search::fromJson(std::string jsonObj)
{
