...
#ifndef TINY_CPP_CLIENT_AssistantStreamEvent_H_
#define TINY_CPP_CLIENT_AssistantStreamEvent_H_
...
public:
    ...
    AssistantStreamEvent(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AssistantStreamEvent_H_ */
