...
#ifndef TINY_CPP_CLIENT_AssistantsApiResponseFormatOption_H_
#define TINY_CPP_CLIENT_AssistantsApiResponseFormatOption_H_
...
public:
    ...
    AssistantsApiResponseFormatOption(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AssistantsApiResponseFormatOption_H_ */
