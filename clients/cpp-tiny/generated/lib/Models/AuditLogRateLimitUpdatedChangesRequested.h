...
#ifndef TINY_CPP_CLIENT_AuditLog_rate_limit_updated_changes_requested_H_
#define TINY_CPP_CLIENT_AuditLog_rate_limit_updated_changes_requested_H_
...
public:
    ...
    AuditLog_rate_limit_updated_changes_requested(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_AuditLog_rate_limit_updated_changes_requested_H_ */
