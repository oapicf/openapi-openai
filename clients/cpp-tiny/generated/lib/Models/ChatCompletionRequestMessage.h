...
#ifndef TINY_CPP_CLIENT_ChatCompletionRequestMessage_H_
#define TINY_CPP_CLIENT_ChatCompletionRequestMessage_H_
...
public:
    ...
    ChatCompletionRequestMessage(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ChatCompletionRequestMessage_H_ */
