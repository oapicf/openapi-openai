...
ChatCompletionResponseMessage_function_call::ChatCompletionResponseMessage_function_call(std::string jsonString)
{
...
void
ChatCompletionResponseMessage_function_call::fromJson(std::string jsonObj)
{
