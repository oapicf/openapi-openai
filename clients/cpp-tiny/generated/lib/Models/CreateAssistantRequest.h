...
#ifndef TINY_CPP_CLIENT_CreateAssistantRequest_H_
#define TINY_CPP_CLIENT_CreateAssistantRequest_H_
...
public:
    ...
    CreateAssistantRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateAssistantRequest_H_ */
