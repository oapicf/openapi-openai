...
#ifndef TINY_CPP_CLIENT_CreateAssistantRequest_model_H_
#define TINY_CPP_CLIENT_CreateAssistantRequest_model_H_
...
public:
    ...
    CreateAssistantRequest_model(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateAssistantRequest_model_H_ */
