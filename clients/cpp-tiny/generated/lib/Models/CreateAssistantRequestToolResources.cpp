...
CreateAssistantRequest_tool_resources::CreateAssistantRequest_tool_resources(std::string jsonString)
{
...
void
CreateAssistantRequest_tool_resources::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(file_searchKey))
    {
        ...
        CreateAssistantRequest_tool_resources_file_search* obj = &file_search;
		obj->fromJson(value.dump());
