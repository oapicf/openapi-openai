...
#ifndef TINY_CPP_CLIENT_CreateAssistantRequest_tool_resources_H_
#define TINY_CPP_CLIENT_CreateAssistantRequest_tool_resources_H_
...
public:
    ...
    CreateAssistantRequest_tool_resources(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateAssistantRequest_tool_resources_H_ */
