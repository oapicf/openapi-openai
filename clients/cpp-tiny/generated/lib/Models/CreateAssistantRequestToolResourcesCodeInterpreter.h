...
#ifndef TINY_CPP_CLIENT_CreateAssistantRequest_tool_resources_code_interpreter_H_
#define TINY_CPP_CLIENT_CreateAssistantRequest_tool_resources_code_interpreter_H_
...
class CreateAssistantRequest_tool_resources_code_interpreter{
public:

    /*! \brief Constructor.
	 */
    CreateAssistantRequest_tool_resources_code_interpreter();
    CreateAssistantRequest_tool_resources_code_interpreter(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateAssistantRequest_tool_resources_code_interpreter_H_ */
