...
CreateAssistantRequest_tool_resources_file_search_vector_stores_inner::CreateAssistantRequest_tool_resources_file_search_vector_stores_inner(std::string jsonString)
{
...
void
CreateAssistantRequest_tool_resources_file_search_vector_stores_inner::fromJson(std::string jsonObj)
{
...
void
CreateAssistantRequest_tool_resources_file_search_vector_stores_inner::setMetadata(Object  metadata)
{
