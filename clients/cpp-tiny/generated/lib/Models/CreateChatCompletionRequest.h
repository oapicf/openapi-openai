...
#ifndef TINY_CPP_CLIENT_CreateChatCompletionRequest_H_
#define TINY_CPP_CLIENT_CreateChatCompletionRequest_H_
...
public:
    ...
    CreateChatCompletionRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateChatCompletionRequest_H_ */
