...
#ifndef TINY_CPP_CLIENT_CreateChatCompletionResponse_H_
#define TINY_CPP_CLIENT_CreateChatCompletionResponse_H_
...
public:
    ...
    CreateChatCompletionResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateChatCompletionResponse_H_ */
