...
#ifndef TINY_CPP_CLIENT_CreateChatCompletionStreamResponse_H_
#define TINY_CPP_CLIENT_CreateChatCompletionStreamResponse_H_
...
public:
    ...
    CreateChatCompletionStreamResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateChatCompletionStreamResponse_H_ */
