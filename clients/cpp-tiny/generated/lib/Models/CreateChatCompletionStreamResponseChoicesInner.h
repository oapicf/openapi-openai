...
#ifndef TINY_CPP_CLIENT_CreateChatCompletionStreamResponse_choices_inner_H_
#define TINY_CPP_CLIENT_CreateChatCompletionStreamResponse_choices_inner_H_
...
public:
    ...
    CreateChatCompletionStreamResponse_choices_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateChatCompletionStreamResponse_choices_inner_H_ */
