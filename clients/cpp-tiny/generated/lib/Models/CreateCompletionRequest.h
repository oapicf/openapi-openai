...
#ifndef TINY_CPP_CLIENT_CreateCompletionRequest_H_
#define TINY_CPP_CLIENT_CreateCompletionRequest_H_
...
public:
    ...
    CreateCompletionRequest(std::string jsonString);
	 ...
	 */
	void setFrequencyPenalty(long  frequency_penalty);
	 ...
	 */
	Map<std::string, std::string> getLogitBias();
	 ...
	 */
	void setLogitBias(Map <std::string, std::string> logit_bias);
	 ...
	 */
	void setPresencePenalty(long  presence_penalty);
    ...
    Map<std::string, std::string> logit_bias;
    int logprobs{};
    int max_tokens{};
    int n{};
...
#endif /* TINY_CPP_CLIENT_CreateCompletionRequest_H_ */
