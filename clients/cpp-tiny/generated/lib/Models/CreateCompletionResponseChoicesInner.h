...
#ifndef TINY_CPP_CLIENT_CreateCompletionResponse_choices_inner_H_
#define TINY_CPP_CLIENT_CreateCompletionResponse_choices_inner_H_
...
public:
    ...
    CreateCompletionResponse_choices_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateCompletionResponse_choices_inner_H_ */
