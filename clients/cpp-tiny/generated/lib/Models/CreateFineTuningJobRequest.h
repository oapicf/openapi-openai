...
#ifndef TINY_CPP_CLIENT_CreateFineTuningJobRequest_H_
#define TINY_CPP_CLIENT_CreateFineTuningJobRequest_H_
...
public:
    ...
    CreateFineTuningJobRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateFineTuningJobRequest_H_ */
