...
CreateFineTuningJobRequest_integrations_inner::CreateFineTuningJobRequest_integrations_inner(std::string jsonString)
{
...
void
CreateFineTuningJobRequest_integrations_inner::fromJson(std::string jsonObj)
{
