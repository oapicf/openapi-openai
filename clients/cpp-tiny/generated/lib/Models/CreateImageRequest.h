...
#ifndef TINY_CPP_CLIENT_CreateImageRequest_H_
#define TINY_CPP_CLIENT_CreateImageRequest_H_
...
public:
	 ...
	 */
    CreateImageRequest();
    CreateImageRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateImageRequest_H_ */
