...
#ifndef TINY_CPP_CLIENT_CreateModerationResponse_results_inner_category_applied_input_types_H_
#define TINY_CPP_CLIENT_CreateModerationResponse_results_inner_category_applied_input_types_H_
...
public:
    ...
    CreateModerationResponse_results_inner_category_applied_input_types(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateModerationResponse_results_inner_category_applied_input_types_H_ */
