...
#ifndef TINY_CPP_CLIENT_CreateRunRequest_H_
#define TINY_CPP_CLIENT_CreateRunRequest_H_
...
public:
	 ...
	 */
    CreateRunRequest();
    CreateRunRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateRunRequest_H_ */
