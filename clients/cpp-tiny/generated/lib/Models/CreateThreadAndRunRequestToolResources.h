...
#ifndef TINY_CPP_CLIENT_CreateThreadAndRunRequest_tool_resources_H_
#define TINY_CPP_CLIENT_CreateThreadAndRunRequest_tool_resources_H_
...
public:
    ...
    CreateThreadAndRunRequest_tool_resources(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateThreadAndRunRequest_tool_resources_H_ */
