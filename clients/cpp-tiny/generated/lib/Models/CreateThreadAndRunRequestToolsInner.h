...
#ifndef TINY_CPP_CLIENT_CreateThreadAndRunRequest_tools_inner_H_
#define TINY_CPP_CLIENT_CreateThreadAndRunRequest_tools_inner_H_
...
public:
    ...
    CreateThreadAndRunRequest_tools_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateThreadAndRunRequest_tools_inner_H_ */
