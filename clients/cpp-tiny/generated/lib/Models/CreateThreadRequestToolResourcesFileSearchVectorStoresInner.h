...
#ifndef TINY_CPP_CLIENT_CreateThreadRequest_tool_resources_file_search_vector_stores_inner_H_
#define TINY_CPP_CLIENT_CreateThreadRequest_tool_resources_file_search_vector_stores_inner_H_
...
public:
    ...
    CreateThreadRequest_tool_resources_file_search_vector_stores_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CreateThreadRequest_tool_resources_file_search_vector_stores_inner_H_ */
