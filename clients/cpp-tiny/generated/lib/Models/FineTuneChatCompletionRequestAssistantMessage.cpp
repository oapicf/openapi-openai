...
FineTuneChatCompletionRequestAssistantMessage::FineTuneChatCompletionRequestAssistantMessage(std::string jsonString)
{
...
void
FineTuneChatCompletionRequestAssistantMessage::fromJson(std::string jsonObj)
{
