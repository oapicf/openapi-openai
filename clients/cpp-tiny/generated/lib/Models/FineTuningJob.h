...
#ifndef TINY_CPP_CLIENT_FineTuningJob_H_
#define TINY_CPP_CLIENT_FineTuningJob_H_
...
public:
	 ...
	 */
    FineTuningJob();
    FineTuningJob(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_FineTuningJob_H_ */
