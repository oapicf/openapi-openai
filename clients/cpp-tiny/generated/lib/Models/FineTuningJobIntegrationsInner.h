...
#ifndef TINY_CPP_CLIENT_FineTuningJob_integrations_inner_H_
#define TINY_CPP_CLIENT_FineTuningJob_integrations_inner_H_
...
public:
    ...
    FineTuningJob_integrations_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_FineTuningJob_integrations_inner_H_ */
