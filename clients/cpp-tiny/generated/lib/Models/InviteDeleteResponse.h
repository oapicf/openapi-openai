...
#ifndef TINY_CPP_CLIENT_InviteDeleteResponse_H_
#define TINY_CPP_CLIENT_InviteDeleteResponse_H_
...
public:
    ...
    InviteDeleteResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_InviteDeleteResponse_H_ */
