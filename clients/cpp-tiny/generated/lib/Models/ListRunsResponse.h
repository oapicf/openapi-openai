...
#ifndef TINY_CPP_CLIENT_ListRunsResponse_H_
#define TINY_CPP_CLIENT_ListRunsResponse_H_
...
public:
	 ...
	 */
    ListRunsResponse();
    ListRunsResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ListRunsResponse_H_ */
