...
#ifndef TINY_CPP_CLIENT_MessageContentImageFileObject_image_file_H_
#define TINY_CPP_CLIENT_MessageContentImageFileObject_image_file_H_
...
public:
    ...
    MessageContentImageFileObject_image_file(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_MessageContentImageFileObject_image_file_H_ */
