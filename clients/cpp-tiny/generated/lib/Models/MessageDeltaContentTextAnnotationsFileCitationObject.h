...
#ifndef TINY_CPP_CLIENT_MessageDeltaContentTextAnnotationsFileCitationObject_H_
#define TINY_CPP_CLIENT_MessageDeltaContentTextAnnotationsFileCitationObject_H_
...
public:
    ...
    MessageDeltaContentTextAnnotationsFileCitationObject(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_MessageDeltaContentTextAnnotationsFileCitationObject_H_ */
