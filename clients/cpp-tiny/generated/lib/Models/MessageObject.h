...
#ifndef TINY_CPP_CLIENT_MessageObject_H_
#define TINY_CPP_CLIENT_MessageObject_H_
...
public:
	 ...
	 */
    MessageObject();
    MessageObject(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_MessageObject_H_ */
