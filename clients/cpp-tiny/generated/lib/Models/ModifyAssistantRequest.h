...
#ifndef TINY_CPP_CLIENT_ModifyAssistantRequest_H_
#define TINY_CPP_CLIENT_ModifyAssistantRequest_H_
...
public:
    ...
    ModifyAssistantRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ModifyAssistantRequest_H_ */
