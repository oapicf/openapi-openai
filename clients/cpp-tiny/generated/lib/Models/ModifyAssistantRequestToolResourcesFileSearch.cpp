...
ModifyAssistantRequest_tool_resources_file_search::ModifyAssistantRequest_tool_resources_file_search(std::string jsonString)
{
...
void
ModifyAssistantRequest_tool_resources_file_search::fromJson(std::string jsonObj)
{
