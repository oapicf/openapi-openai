...
#ifndef TINY_CPP_CLIENT_ModifyAssistantRequest_tool_resources_file_search_H_
#define TINY_CPP_CLIENT_ModifyAssistantRequest_tool_resources_file_search_H_
...
public:
    ...
    ModifyAssistantRequest_tool_resources_file_search(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ModifyAssistantRequest_tool_resources_file_search_H_ */
