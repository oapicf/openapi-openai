...
#ifndef TINY_CPP_CLIENT_ModifyMessageRequest_H_
#define TINY_CPP_CLIENT_ModifyMessageRequest_H_
...
public:
    ...
    ModifyMessageRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ModifyMessageRequest_H_ */
