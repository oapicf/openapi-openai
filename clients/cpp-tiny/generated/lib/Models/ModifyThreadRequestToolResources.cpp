...
ModifyThreadRequest_tool_resources::ModifyThreadRequest_tool_resources()
{
	...
	file_search = ModifyThreadRequest_tool_resources_file_search();
}

ModifyThreadRequest_tool_resources::ModifyThreadRequest_tool_resources(std::string jsonString)
{
...
void
ModifyThreadRequest_tool_resources::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(file_searchKey))
    {
        ...
        ModifyThreadRequest_tool_resources_file_search* obj = &file_search;
		obj->fromJson(value.dump());
