...
#ifndef TINY_CPP_CLIENT_ProjectApiKeyListResponse_H_
#define TINY_CPP_CLIENT_ProjectApiKeyListResponse_H_
...
public:
    ...
    ProjectApiKeyListResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ProjectApiKeyListResponse_H_ */
