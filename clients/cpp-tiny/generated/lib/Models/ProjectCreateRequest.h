...
#ifndef TINY_CPP_CLIENT_ProjectCreateRequest_H_
#define TINY_CPP_CLIENT_ProjectCreateRequest_H_
...
public:
    ...
    ProjectCreateRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_ProjectCreateRequest_H_ */
