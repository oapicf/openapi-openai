...
#ifndef TINY_CPP_CLIENT_RealtimeClientEventResponseCreate_H_
#define TINY_CPP_CLIENT_RealtimeClientEventResponseCreate_H_
...
public:
    ...
    RealtimeClientEventResponseCreate(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeClientEventResponseCreate_H_ */
