...
#ifndef TINY_CPP_CLIENT_RealtimeResponseCreateParams_H_
#define TINY_CPP_CLIENT_RealtimeResponseCreateParams_H_
...
public:
    ...
    RealtimeResponseCreateParams(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeResponseCreateParams_H_ */
