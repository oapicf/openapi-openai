...
#ifndef TINY_CPP_CLIENT_RealtimeResponse_usage_input_token_details_H_
#define TINY_CPP_CLIENT_RealtimeResponse_usage_input_token_details_H_
...
public:
    ...
    RealtimeResponse_usage_input_token_details(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeResponse_usage_input_token_details_H_ */
