...
#ifndef TINY_CPP_CLIENT_RealtimeServerEventConversationItemCreated_H_
#define TINY_CPP_CLIENT_RealtimeServerEventConversationItemCreated_H_
...
public:
    ...
    RealtimeServerEventConversationItemCreated(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeServerEventConversationItemCreated_H_ */
