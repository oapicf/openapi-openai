...
#ifndef TINY_CPP_CLIENT_RealtimeServerEventConversationItemInputAudioTranscriptionCompleted_H_
#define TINY_CPP_CLIENT_RealtimeServerEventConversationItemInputAudioTranscriptionCompleted_H_
...
public:
    ...
    RealtimeServerEventConversationItemInputAudioTranscriptionCompleted(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeServerEventConversationItemInputAudioTranscriptionCompleted_H_ */
