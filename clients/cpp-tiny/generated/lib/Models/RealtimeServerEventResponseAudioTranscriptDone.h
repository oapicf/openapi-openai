...
#ifndef TINY_CPP_CLIENT_RealtimeServerEventResponseAudioTranscriptDone_H_
#define TINY_CPP_CLIENT_RealtimeServerEventResponseAudioTranscriptDone_H_
...
public:
    ...
    RealtimeServerEventResponseAudioTranscriptDone(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeServerEventResponseAudioTranscriptDone_H_ */
