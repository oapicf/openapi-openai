...
RealtimeServerEventResponseContentPartDone::RealtimeServerEventResponseContentPartDone(std::string jsonString)
{
...
void
RealtimeServerEventResponseContentPartDone::fromJson(std::string jsonObj)
{
    ...
    if(object.has_key(partKey))
    {
        ...
        RealtimeServerEventResponseContentPartDone_part* obj = &part;
