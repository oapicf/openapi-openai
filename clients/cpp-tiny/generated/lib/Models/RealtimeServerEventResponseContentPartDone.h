...
#ifndef TINY_CPP_CLIENT_RealtimeServerEventResponseContentPartDone_H_
#define TINY_CPP_CLIENT_RealtimeServerEventResponseContentPartDone_H_
...
public:
    ...
    RealtimeServerEventResponseContentPartDone(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeServerEventResponseContentPartDone_H_ */
