...
RealtimeServerEventResponseTextDelta::RealtimeServerEventResponseTextDelta(std::string jsonString)
{
...
void
RealtimeServerEventResponseTextDelta::fromJson(std::string jsonObj)
{
