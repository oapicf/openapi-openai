...
#ifndef TINY_CPP_CLIENT_RealtimeSession_H_
#define TINY_CPP_CLIENT_RealtimeSession_H_
...
public:
	 ...
	 */
    RealtimeSession();
    RealtimeSession(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeSession_H_ */
