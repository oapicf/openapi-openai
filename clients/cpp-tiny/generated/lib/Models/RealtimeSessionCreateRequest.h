...
#ifndef TINY_CPP_CLIENT_RealtimeSessionCreateRequest_H_
#define TINY_CPP_CLIENT_RealtimeSessionCreateRequest_H_
...
public:
    ...
    RealtimeSessionCreateRequest(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~RealtimeSessionCreateRequest();
	...
	/*! \brief Get The Realtime model used for this session. 
	 */
	std::string getModel();

	/*! \brief Set The Realtime model used for this session. 
	 */
	...
	/*! \brief Get 
	 */
	RealtimeSessionCreateRequest_turn_detection getTurnDetection();

	/*! \brief Set 
	 */
	void setTurnDetection(RealtimeSessionCreateRequest_turn_detection  turn_detection);
    ...
    RealtimeSessionCreateRequest_turn_detection turn_detection;
...
#endif /* TINY_CPP_CLIENT_RealtimeSessionCreateRequest_H_ */
