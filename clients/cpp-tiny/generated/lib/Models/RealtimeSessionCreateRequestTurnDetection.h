...
#ifndef TINY_CPP_CLIENT_RealtimeSessionCreateRequest_turn_detection_H_
#define TINY_CPP_CLIENT_RealtimeSessionCreateRequest_turn_detection_H_
...
public:
    ...
    RealtimeSessionCreateRequest_turn_detection(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeSessionCreateRequest_turn_detection_H_ */
