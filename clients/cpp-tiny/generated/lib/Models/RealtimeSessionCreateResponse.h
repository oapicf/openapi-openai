...
#ifndef TINY_CPP_CLIENT_RealtimeSessionCreateResponse_H_
#define TINY_CPP_CLIENT_RealtimeSessionCreateResponse_H_
...
public:
    ...
    RealtimeSessionCreateResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeSessionCreateResponse_H_ */
