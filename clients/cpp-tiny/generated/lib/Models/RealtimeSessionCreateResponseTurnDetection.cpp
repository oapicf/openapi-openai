...
RealtimeSessionCreateResponse_turn_detection::RealtimeSessionCreateResponse_turn_detection(std::string jsonString)
{
...
void
RealtimeSessionCreateResponse_turn_detection::fromJson(std::string jsonObj)
{
...
void
RealtimeSessionCreateResponse_turn_detection::setThreshold(long  threshold)
{
