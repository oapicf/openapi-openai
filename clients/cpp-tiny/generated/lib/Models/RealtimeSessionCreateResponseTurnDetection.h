...
#ifndef TINY_CPP_CLIENT_RealtimeSessionCreateResponse_turn_detection_H_
#define TINY_CPP_CLIENT_RealtimeSessionCreateResponse_turn_detection_H_
...
public:
    ...
    RealtimeSessionCreateResponse_turn_detection(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RealtimeSessionCreateResponse_turn_detection_H_ */
