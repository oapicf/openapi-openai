...
#ifndef TINY_CPP_CLIENT_RunStepCompletionUsage_H_
#define TINY_CPP_CLIENT_RunStepCompletionUsage_H_
...
public:
    ...
    RunStepCompletionUsage(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RunStepCompletionUsage_H_ */
