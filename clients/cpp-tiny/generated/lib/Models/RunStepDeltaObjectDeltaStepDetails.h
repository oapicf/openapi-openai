...
#ifndef TINY_CPP_CLIENT_RunStepDeltaObject_delta_step_details_H_
#define TINY_CPP_CLIENT_RunStepDeltaObject_delta_step_details_H_
...
public:
    ...
    RunStepDeltaObject_delta_step_details(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RunStepDeltaObject_delta_step_details_H_ */
