...
#ifndef TINY_CPP_CLIENT_RunStepDeltaStepDetailsMessageCreationObject_message_creation_H_
#define TINY_CPP_CLIENT_RunStepDeltaStepDetailsMessageCreationObject_message_creation_H_
...
public:
    ...
    RunStepDeltaStepDetailsMessageCreationObject_message_creation(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RunStepDeltaStepDetailsMessageCreationObject_message_creation_H_ */
