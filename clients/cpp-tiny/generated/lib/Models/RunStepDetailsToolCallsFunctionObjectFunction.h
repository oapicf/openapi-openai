...
#ifndef TINY_CPP_CLIENT_RunStepDetailsToolCallsFunctionObject_function_H_
#define TINY_CPP_CLIENT_RunStepDetailsToolCallsFunctionObject_function_H_
...
public:
    ...
    RunStepDetailsToolCallsFunctionObject_function(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RunStepDetailsToolCallsFunctionObject_function_H_ */
