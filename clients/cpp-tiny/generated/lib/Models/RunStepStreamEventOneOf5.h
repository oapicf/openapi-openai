...
#ifndef TINY_CPP_CLIENT_RunStepStreamEvent_oneOf_5_H_
#define TINY_CPP_CLIENT_RunStepStreamEvent_oneOf_5_H_
...
public:
    ...
    RunStepStreamEvent_oneOf_5(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_RunStepStreamEvent_oneOf_5_H_ */
