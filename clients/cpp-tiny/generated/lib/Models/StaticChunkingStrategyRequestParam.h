...
#ifndef TINY_CPP_CLIENT_StaticChunkingStrategyRequestParam_H_
#define TINY_CPP_CLIENT_StaticChunkingStrategyRequestParam_H_
...
public:
    ...
    StaticChunkingStrategyRequestParam(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_StaticChunkingStrategyRequestParam_H_ */
