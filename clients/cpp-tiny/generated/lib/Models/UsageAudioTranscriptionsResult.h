...
#ifndef TINY_CPP_CLIENT_UsageAudioTranscriptionsResult_H_
#define TINY_CPP_CLIENT_UsageAudioTranscriptionsResult_H_
...
public:
    ...
    UsageAudioTranscriptionsResult(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_UsageAudioTranscriptionsResult_H_ */
