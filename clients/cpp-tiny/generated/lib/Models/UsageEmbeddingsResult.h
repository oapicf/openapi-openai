...
#ifndef TINY_CPP_CLIENT_UsageEmbeddingsResult_H_
#define TINY_CPP_CLIENT_UsageEmbeddingsResult_H_
...
public:
    ...
    UsageEmbeddingsResult(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_UsageEmbeddingsResult_H_ */
