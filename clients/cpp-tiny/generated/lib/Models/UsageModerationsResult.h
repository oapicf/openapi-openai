...
#ifndef TINY_CPP_CLIENT_UsageModerationsResult_H_
#define TINY_CPP_CLIENT_UsageModerationsResult_H_
...
/*! \brief The aggregated moderations usage details of the specific time bucket.
 *
 *  \ingroup Models
 *
 */
...
public:
    ...
    UsageModerationsResult(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~UsageModerationsResult();
...
#endif /* TINY_CPP_CLIENT_UsageModerationsResult_H_ */
