...
#ifndef TINY_CPP_CLIENT_UserListResponse_H_
#define TINY_CPP_CLIENT_UserListResponse_H_
...
public:
	 ...
	 */
    UserListResponse();
    UserListResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_UserListResponse_H_ */
