...
#ifndef TINY_CPP_CLIENT_VectorStoreFileBatchObject_file_counts_H_
#define TINY_CPP_CLIENT_VectorStoreFileBatchObject_file_counts_H_
...
public:
    ...
    VectorStoreFileBatchObject_file_counts(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_VectorStoreFileBatchObject_file_counts_H_ */
