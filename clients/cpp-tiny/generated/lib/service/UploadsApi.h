#ifndef TINY_CPP_CLIENT_UploadsApi_H_
#define TINY_CPP_CLIENT_UploadsApi_H_
...
class UploadsApi : public Service {
public:
    UploadsApi() = default;

    virtual ~UploadsApi() = default;
...
#endif /* TINY_CPP_CLIENT_UploadsApi_H_ */