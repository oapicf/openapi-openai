...
AssistantObject::__init()
{
	...
	//tool_resources = new AssistantObject_tool_resources();
	//metadata = null;
...
AssistantObject::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("AssistantObject_tool_resources")) {
			jsonToValue(&tool_resources, node, "AssistantObject_tool_resources", "AssistantObject_tool_resources");
		} else {
			
			AssistantObject_tool_resources* obj = static_cast<AssistantObject_tool_resources*> (&tool_resources);
...
AssistantObject::toJson()
{
	...
	if (isprimitive("AssistantObject_tool_resources")) {
		AssistantObject_tool_resources obj = getToolResources();
		node = converttoJson(&obj, "AssistantObject_tool_resources", "");
	}
	else {
		
		AssistantObject_tool_resources obj = static_cast<AssistantObject_tool_resources> (getToolResources());
		GError *mygerror;
		mygerror = NULL;
...
void
AssistantObject::setTemperature(long long  temperature)
{
...
void
AssistantObject::setTopP(long long  top_p)
{
	this->top_p = top_p;
}
