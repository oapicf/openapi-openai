...
void
AssistantObject_tools_inner::__init()
{
	//type = std::string();
...
void
AssistantObject_tools_inner::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
AssistantObject_tools_inner::fromJson(char* jsonStr)
{
...
AssistantObject_tools_inner::AssistantObject_tools_inner(char* json)
{
	this->fromJson(json);
}
