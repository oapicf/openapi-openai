...
void
AssistantToolsFileSearchTypeOnly::__init()
{
	//type = std::string();
}

void
AssistantToolsFileSearchTypeOnly::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
AssistantToolsFileSearchTypeOnly::fromJson(char* jsonStr)
{
...
AssistantToolsFileSearchTypeOnly::AssistantToolsFileSearchTypeOnly(char* json)
{
	this->fromJson(json);
}
