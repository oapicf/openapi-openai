...
void
AuditLogActorServiceAccount::__init()
{
	//id = std::string();
}

void
AuditLogActorServiceAccount::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
AuditLogActorServiceAccount::fromJson(char* jsonStr)
{
...
AuditLogActorServiceAccount::AuditLogActorServiceAccount(char* json)
{
	this->fromJson(json);
}
