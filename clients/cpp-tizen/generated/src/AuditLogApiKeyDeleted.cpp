...
void
AuditLog_api_key_deleted::__init()
{
	//id = std::string();
}

void
AuditLog_api_key_deleted::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
AuditLog_api_key_deleted::fromJson(char* jsonStr)
{
...
AuditLog_api_key_deleted::AuditLog_api_key_deleted(char* json)
{
	this->fromJson(json);
}
