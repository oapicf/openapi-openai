...
void
AuditLog_api_key_updated_changes_requested::__init()
{
	//new std::list()std::list> scopes;
}

void
AuditLog_api_key_updated_changes_requested::__cleanup()
{
	//if(scopes != NULL) {
...
void
AuditLog_api_key_updated_changes_requested::fromJson(char* jsonStr)
{
...
AuditLog_api_key_updated_changes_requested::AuditLog_api_key_updated_changes_requested(char* json)
{
	this->fromJson(json);
}
