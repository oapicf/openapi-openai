...
#ifndef _AuditLog_invite_sent_H_
#define _AuditLog_invite_sent_H_
...
class AuditLog_invite_sent : public Object {
public:
	/*! \brief Constructor.
	 */
	AuditLog_invite_sent();
	AuditLog_invite_sent(char* str);
...
#endif /* _AuditLog_invite_sent_H_ */
