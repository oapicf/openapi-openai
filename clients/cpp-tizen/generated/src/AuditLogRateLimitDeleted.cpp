...
void
AuditLog_rate_limit_deleted::__init()
{
	//id = std::string();
}

void
AuditLog_rate_limit_deleted::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
AuditLog_rate_limit_deleted::fromJson(char* jsonStr)
{
...
AuditLog_rate_limit_deleted::AuditLog_rate_limit_deleted(char* json)
{
	this->fromJson(json);
}
