...
#ifndef _AuditLog_rate_limit_updated_H_
#define _AuditLog_rate_limit_updated_H_
...
class AuditLog_rate_limit_updated : public Object {
public:
	/*! \brief Constructor.
	 */
	AuditLog_rate_limit_updated();
	AuditLog_rate_limit_updated(char* str);
...
#endif /* _AuditLog_rate_limit_updated_H_ */
