...
void
AuditLog_service_account_deleted::__init()
{
	//id = std::string();
}

void
AuditLog_service_account_deleted::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
AuditLog_service_account_deleted::fromJson(char* jsonStr)
{
...
AuditLog_service_account_deleted::AuditLog_service_account_deleted(char* json)
{
	this->fromJson(json);
}
