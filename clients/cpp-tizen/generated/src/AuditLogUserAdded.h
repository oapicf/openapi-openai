...
#ifndef _AuditLog_user_added_H_
#define _AuditLog_user_added_H_
...
class AuditLog_user_added : public Object {
public:
	/*! \brief Constructor.
	 */
	AuditLog_user_added();
	AuditLog_user_added(char* str);
