...
void
AuditLog_user_added_data::__init()
{
	//role = std::string();
}

void
AuditLog_user_added_data::__cleanup()
{
	//if(role != NULL) {
	//
	//delete role;
...
void
AuditLog_user_added_data::fromJson(char* jsonStr)
{
...
AuditLog_user_added_data::AuditLog_user_added_data(char* json)
{
	this->fromJson(json);
}
