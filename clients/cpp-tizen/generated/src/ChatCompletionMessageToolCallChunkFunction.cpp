...
void
ChatCompletionMessageToolCallChunk_function::__init()
{
	//name = std::string();
...
void
ChatCompletionMessageToolCallChunk_function::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
ChatCompletionMessageToolCallChunk_function::fromJson(char* jsonStr)
{
...
ChatCompletionMessageToolCallChunk_function::ChatCompletionMessageToolCallChunk_function(char* json)
{
	this->fromJson(json);
}
