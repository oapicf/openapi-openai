...
void
ChatCompletionRequestAssistantMessage_function_call::__init()
{
...
void
ChatCompletionRequestAssistantMessage_function_call::__cleanup()
{
	//if(arguments != NULL) {
	//
	//delete arguments;
...
void
ChatCompletionRequestAssistantMessage_function_call::fromJson(char* jsonStr)
{
...
ChatCompletionRequestAssistantMessage_function_call::ChatCompletionRequestAssistantMessage_function_call(char* json)
{
	this->fromJson(json);
}
