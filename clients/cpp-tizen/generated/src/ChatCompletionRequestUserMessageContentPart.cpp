...
void
ChatCompletionRequestUserMessageContentPart::__init()
{
	//type = std::string();
	//text = std::string();
...
void
ChatCompletionRequestUserMessageContentPart::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
ChatCompletionRequestUserMessageContentPart::fromJson(char* jsonStr)
{
...
ChatCompletionRequestUserMessageContentPart::ChatCompletionRequestUserMessageContentPart(char* json)
{
	this->fromJson(json);
}
