...
void
ChunkingStrategyRequestParam::__init()
{
	//type = std::string();
...
void
ChunkingStrategyRequestParam::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
ChunkingStrategyRequestParam::fromJson(char* jsonStr)
{
...
ChunkingStrategyRequestParam::ChunkingStrategyRequestParam(char* json)
{
	this->fromJson(json);
}
