...
#ifndef _CreateAssistantRequest_tool_resources_file_search_vector_stores_inner_H_
#define _CreateAssistantRequest_tool_resources_file_search_vector_stores_inner_H_
...
class CreateAssistantRequest_tool_resources_file_search_vector_stores_inner : public Object {
public:
	/*! \brief Constructor.
	 */
	CreateAssistantRequest_tool_resources_file_search_vector_stores_inner();
	CreateAssistantRequest_tool_resources_file_search_vector_stores_inner(char* str);
...
#endif /* _CreateAssistantRequest_tool_resources_file_search_vector_stores_inner_H_ */
