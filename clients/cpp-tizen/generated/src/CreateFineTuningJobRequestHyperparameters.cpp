...
void
CreateFineTuningJobRequest_hyperparameters::__init()
{
...
void
CreateFineTuningJobRequest_hyperparameters::__cleanup()
{
	//if(batch_size != NULL) {
	//
	//delete batch_size;
...
void
CreateFineTuningJobRequest_hyperparameters::fromJson(char* jsonStr)
{
...
CreateFineTuningJobRequest_hyperparameters::CreateFineTuningJobRequest_hyperparameters(char* json)
{
	this->fromJson(json);
}
