...
void
CreateThreadAndRunRequest_tool_resources::__init()
{
...
void
CreateThreadAndRunRequest_tool_resources::__cleanup()
{
...
void
CreateThreadAndRunRequest_tool_resources::fromJson(char* jsonStr)
{
...
CreateThreadAndRunRequest_tool_resources::CreateThreadAndRunRequest_tool_resources(char* json)
{
	this->fromJson(json);
}
