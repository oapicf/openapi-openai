...
void
CreateThreadRequest_tool_resources::__init()
{
	//code_interpreter = new CreateAssistantRequest_tool_resources_code_interpreter();
	//file_search = new CreateThreadRequest_tool_resources_file_search();
}

void
CreateThreadRequest_tool_resources::__cleanup()
{
...
void
CreateThreadRequest_tool_resources::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("CreateThreadRequest_tool_resources_file_search")) {
			jsonToValue(&file_search, node, "CreateThreadRequest_tool_resources_file_search", "CreateThreadRequest_tool_resources_file_search");
		} else {
			
			CreateThreadRequest_tool_resources_file_search* obj = static_cast<CreateThreadRequest_tool_resources_file_search*> (&file_search);
			obj->fromJson(json_to_string(node, false));
...
CreateThreadRequest_tool_resources::CreateThreadRequest_tool_resources(char* json)
{
	this->fromJson(json);
}
...
CreateThreadRequest_tool_resources::toJson()
{
	...
	if (isprimitive("CreateThreadRequest_tool_resources_file_search")) {
		CreateThreadRequest_tool_resources_file_search obj = getFileSearch();
		node = converttoJson(&obj, "CreateThreadRequest_tool_resources_file_search", "");
	}
	else {
		
		CreateThreadRequest_tool_resources_file_search obj = static_cast<CreateThreadRequest_tool_resources_file_search> (getFileSearch());
		GError *mygerror;
		mygerror = NULL;
		node = json_from_string(obj.toJson(), &mygerror);
