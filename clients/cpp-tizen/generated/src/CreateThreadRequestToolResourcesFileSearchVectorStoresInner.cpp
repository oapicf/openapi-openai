...
void
CreateThreadRequest_tool_resources_file_search_vector_stores_inner::__init()
{
...
void
CreateThreadRequest_tool_resources_file_search_vector_stores_inner::__cleanup()
{
	//if(file_ids != NULL) {
...
void
CreateThreadRequest_tool_resources_file_search_vector_stores_inner::fromJson(char* jsonStr)
{
...
CreateThreadRequest_tool_resources_file_search_vector_stores_inner::CreateThreadRequest_tool_resources_file_search_vector_stores_inner(char* json)
{
	this->fromJson(json);
}
...
void
CreateThreadRequest_tool_resources_file_search_vector_stores_inner::setMetadata(std::string  metadata)
{
