...
void
CreateVectorStoreRequest_chunking_strategy::__init()
{
	//type = std::string();
...
void
CreateVectorStoreRequest_chunking_strategy::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
CreateVectorStoreRequest_chunking_strategy::fromJson(char* jsonStr)
{
...
CreateVectorStoreRequest_chunking_strategy::CreateVectorStoreRequest_chunking_strategy(char* json)
{
	this->fromJson(json);
}
