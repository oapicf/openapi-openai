...
void
DeleteVectorStoreResponse::__init()
{
	//id = std::string();
	//deleted = bool(false);
	//object = std::string();
...
void
DeleteVectorStoreResponse::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
DeleteVectorStoreResponse::fromJson(char* jsonStr)
{
...
DeleteVectorStoreResponse::DeleteVectorStoreResponse(char* json)
{
	this->fromJson(json);
}
...
bool
DeleteVectorStoreResponse::getDeleted()
{
	return deleted;
}
