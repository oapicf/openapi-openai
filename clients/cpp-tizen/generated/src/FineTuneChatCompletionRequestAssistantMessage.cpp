...
void
FineTuneChatCompletionRequestAssistantMessage::__init()
{
...
void
FineTuneChatCompletionRequestAssistantMessage::__cleanup()
{
	//if(content != NULL) {
	//
	//delete content;
...
void
FineTuneChatCompletionRequestAssistantMessage::fromJson(char* jsonStr)
{
...
FineTuneChatCompletionRequestAssistantMessage::FineTuneChatCompletionRequestAssistantMessage(char* json)
{
	this->fromJson(json);
}

char*
FineTuneChatCompletionRequestAssistantMessage::toJson()
{
...
FineTuneChatCompletionRequestAssistantMessage::getContent()
{
	return content;
}

void
FineTuneChatCompletionRequestAssistantMessage::setContent(ChatCompletionRequestAssistantMessage_content  content)
{
	this->content = content;
}

std::string
FineTuneChatCompletionRequestAssistantMessage::getRefusal()
{
	return refusal;
}

void
FineTuneChatCompletionRequestAssistantMessage::setRefusal(std::string  refusal)
{
	this->refusal = refusal;
}

std::string
FineTuneChatCompletionRequestAssistantMessage::getRole()
{
	return role;
}

void
FineTuneChatCompletionRequestAssistantMessage::setRole(std::string  role)
{
	this->role = role;
}

std::string
FineTuneChatCompletionRequestAssistantMessage::getName()
{
	return name;
}

void
FineTuneChatCompletionRequestAssistantMessage::setName(std::string  name)
{
	this->name = name;
}

ChatCompletionRequestAssistantMessage_audio
FineTuneChatCompletionRequestAssistantMessage::getAudio()
{
	return audio;
}

void
FineTuneChatCompletionRequestAssistantMessage::setAudio(ChatCompletionRequestAssistantMessage_audio  audio)
{
	this->audio = audio;
}

std::list<ChatCompletionMessageToolCall>
FineTuneChatCompletionRequestAssistantMessage::getToolCalls()
{
	return tool_calls;
}

void
FineTuneChatCompletionRequestAssistantMessage::setToolCalls(std::list <ChatCompletionMessageToolCall> tool_calls)
{
	this->tool_calls = tool_calls;
}

ChatCompletionRequestAssistantMessage_function_call
FineTuneChatCompletionRequestAssistantMessage::getFunctionCall()
{
	return function_call;
}

void
FineTuneChatCompletionRequestAssistantMessage::setFunctionCall(ChatCompletionRequestAssistantMessage_function_call  function_call)
{
	this->function_call = function_call;
}

int
FineTuneChatCompletionRequestAssistantMessage::getWeight()
{
	return weight;
}

void
FineTuneChatCompletionRequestAssistantMessage::setWeight(int  weight)
{
	this->weight = weight;
}
