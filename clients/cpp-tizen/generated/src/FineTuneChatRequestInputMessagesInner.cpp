...
void
FineTuneChatRequestInput_messages_inner::__init()
{
	//content = std::string();
	//role = std::string();
	//name = std::string();
...
void
FineTuneChatRequestInput_messages_inner::__cleanup()
{
	//if(content != NULL) {
	//
	//delete content;
...
void
FineTuneChatRequestInput_messages_inner::fromJson(char* jsonStr)
{
...
FineTuneChatRequestInput_messages_inner::FineTuneChatRequestInput_messages_inner(char* json)
{
	this->fromJson(json);
}
