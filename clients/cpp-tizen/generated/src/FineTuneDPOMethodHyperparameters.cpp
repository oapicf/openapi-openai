...
void
FineTuneDPOMethod_hyperparameters::__init()
{
	//beta = new FineTuneDPOMethod_hyperparameters_beta();
...
void
FineTuneDPOMethod_hyperparameters::__cleanup()
{
	//if(beta != NULL) {
	//
	//delete beta;
...
void
FineTuneDPOMethod_hyperparameters::fromJson(char* jsonStr)
{
	JsonObject *pJsonObject = json_node_get_object(json_from_string(jsonStr,NULL));
	JsonNode *node;
	const gchar *betaKey = "beta";
	node = json_object_get_member(pJsonObject, betaKey);
	if (node !=NULL) {
	

		if (isprimitive("FineTuneDPOMethod_hyperparameters_beta")) {
			jsonToValue(&beta, node, "FineTuneDPOMethod_hyperparameters_beta", "FineTuneDPOMethod_hyperparameters_beta");
		} else {
			
			FineTuneDPOMethod_hyperparameters_beta* obj = static_cast<FineTuneDPOMethod_hyperparameters_beta*> (&beta);
...
FineTuneDPOMethod_hyperparameters::FineTuneDPOMethod_hyperparameters(char* json)
{
	this->fromJson(json);
}
...
FineTuneDPOMethod_hyperparameters::toJson()
{
	...
	JsonNode *node;
	if (isprimitive("FineTuneDPOMethod_hyperparameters_beta")) {
		FineTuneDPOMethod_hyperparameters_beta obj = getBeta();
		node = converttoJson(&obj, "FineTuneDPOMethod_hyperparameters_beta", "");
	}
	else {
		
		FineTuneDPOMethod_hyperparameters_beta obj = static_cast<FineTuneDPOMethod_hyperparameters_beta> (getBeta());
		GError *mygerror;
		mygerror = NULL;
	...
	const gchar *betaKey = "beta";
	json_object_set_member(pJsonObject, betaKey, node);
	if (isprimitive("FineTuneDPOMethod_hyperparameters_batch_size")) {
