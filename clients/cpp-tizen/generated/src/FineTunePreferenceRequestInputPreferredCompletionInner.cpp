...
void
FineTunePreferenceRequestInput_preferred_completion_inner::__init()
{
...
void
FineTunePreferenceRequestInput_preferred_completion_inner::__cleanup()
{
	//if(content != NULL) {
	//
	//delete content;
...
void
FineTunePreferenceRequestInput_preferred_completion_inner::fromJson(char* jsonStr)
{
...
FineTunePreferenceRequestInput_preferred_completion_inner::FineTunePreferenceRequestInput_preferred_completion_inner(char* json)
{
	this->fromJson(json);
}
