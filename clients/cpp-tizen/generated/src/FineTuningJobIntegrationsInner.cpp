...
void
FineTuningJob_integrations_inner::__init()
{
	//type = std::string();
...
void
FineTuningJob_integrations_inner::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
FineTuningJob_integrations_inner::fromJson(char* jsonStr)
{
...
FineTuningJob_integrations_inner::FineTuningJob_integrations_inner(char* json)
{
	this->fromJson(json);
}
