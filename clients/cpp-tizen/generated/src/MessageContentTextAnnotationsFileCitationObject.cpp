...
void
MessageContentTextAnnotationsFileCitationObject::__init()
{
	//type = std::string();
	//text = std::string();
...
void
MessageContentTextAnnotationsFileCitationObject::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
MessageContentTextAnnotationsFileCitationObject::fromJson(char* jsonStr)
{
...
MessageContentTextAnnotationsFileCitationObject::MessageContentTextAnnotationsFileCitationObject(char* json)
{
	this->fromJson(json);
}
