...
void
MessageDeltaContentImageFileObject_image_file::__cleanup()
{
	//if(file_id != NULL) {
	//
	//delete file_id;
...
void
MessageDeltaContentImageFileObject_image_file::fromJson(char* jsonStr)
{
...
MessageDeltaContentImageFileObject_image_file::MessageDeltaContentImageFileObject_image_file(char* json)
{
	this->fromJson(json);
}
