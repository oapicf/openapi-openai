...
void
MessageDeltaContentTextObject_text_annotations_inner::__init()
{
	//index = int(0);
	//type = std::string();
	//text = std::string();
...
void
MessageDeltaContentTextObject_text_annotations_inner::__cleanup()
{
	//if(index != NULL) {
	//
	//delete index;
...
void
MessageDeltaContentTextObject_text_annotations_inner::fromJson(char* jsonStr)
{
...
MessageDeltaContentTextObject_text_annotations_inner::MessageDeltaContentTextObject_text_annotations_inner(char* json)
{
	this->fromJson(json);
}
