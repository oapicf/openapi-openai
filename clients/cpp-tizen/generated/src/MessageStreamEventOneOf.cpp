...
void
MessageStreamEvent_oneOf::__init()
{
	//event = std::string();
...
void
MessageStreamEvent_oneOf::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
MessageStreamEvent_oneOf::fromJson(char* jsonStr)
{
...
MessageStreamEvent_oneOf::MessageStreamEvent_oneOf(char* json)
{
	this->fromJson(json);
}
