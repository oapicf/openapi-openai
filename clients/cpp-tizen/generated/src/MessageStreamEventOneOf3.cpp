...
void
MessageStreamEvent_oneOf_3::__init()
{
	//event = std::string();
...
void
MessageStreamEvent_oneOf_3::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
MessageStreamEvent_oneOf_3::fromJson(char* jsonStr)
{
...
MessageStreamEvent_oneOf_3::MessageStreamEvent_oneOf_3(char* json)
{
	this->fromJson(json);
}
