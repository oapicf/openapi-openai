...
void
MessageStreamEvent_oneOf_4::__init()
{
	//event = std::string();
...
void
MessageStreamEvent_oneOf_4::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
MessageStreamEvent_oneOf_4::fromJson(char* jsonStr)
{
...
MessageStreamEvent_oneOf_4::MessageStreamEvent_oneOf_4(char* json)
{
	this->fromJson(json);
}
