...
#ifndef _ModifyMessageRequest_H_
#define _ModifyMessageRequest_H_
...
class ModifyMessageRequest : public Object {
public:
	/*! \brief Constructor.
	 */
	ModifyMessageRequest();
	ModifyMessageRequest(char* str);
...
#endif /* _ModifyMessageRequest_H_ */
