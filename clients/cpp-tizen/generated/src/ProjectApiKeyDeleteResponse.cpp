...
void
ProjectApiKeyDeleteResponse::__init()
{
	//object = std::string();
	//id = std::string();
	//deleted = bool(false);
...
void
ProjectApiKeyDeleteResponse::__cleanup()
{
	//if(object != NULL) {
	//
	//delete object;
...
void
ProjectApiKeyDeleteResponse::fromJson(char* jsonStr)
{
...
ProjectApiKeyDeleteResponse::ProjectApiKeyDeleteResponse(char* json)
{
	this->fromJson(json);
}
...
bool
ProjectApiKeyDeleteResponse::getDeleted()
{
	return deleted;
}
