...
void
ProjectServiceAccountCreateRequest::__init()
{
	//name = std::string();
}

void
ProjectServiceAccountCreateRequest::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
ProjectServiceAccountCreateRequest::fromJson(char* jsonStr)
{
...
ProjectServiceAccountCreateRequest::ProjectServiceAccountCreateRequest(char* json)
{
	this->fromJson(json);
}
