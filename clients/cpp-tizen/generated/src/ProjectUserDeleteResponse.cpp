...
void
ProjectUserDeleteResponse::__init()
{
	//object = std::string();
	//id = std::string();
	//deleted = bool(false);
...
void
ProjectUserDeleteResponse::__cleanup()
{
	//if(object != NULL) {
	//
	//delete object;
...
void
ProjectUserDeleteResponse::fromJson(char* jsonStr)
{
...
ProjectUserDeleteResponse::ProjectUserDeleteResponse(char* json)
{
	this->fromJson(json);
}
...
bool
ProjectUserDeleteResponse::getDeleted()
{
	return deleted;
}
