...
void
RealtimeClientEventConversationItemDelete::__init()
{
	//event_id = std::string();
	//type = std::string();
	//item_id = std::string();
...
void
RealtimeClientEventConversationItemDelete::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeClientEventConversationItemDelete::fromJson(char* jsonStr)
{
...
RealtimeClientEventConversationItemDelete::RealtimeClientEventConversationItemDelete(char* json)
{
	this->fromJson(json);
}
