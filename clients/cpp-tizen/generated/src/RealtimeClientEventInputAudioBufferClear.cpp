...
void
RealtimeClientEventInputAudioBufferClear::__init()
{
	//event_id = std::string();
	//type = std::string();
}
...
void
RealtimeClientEventInputAudioBufferClear::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeClientEventInputAudioBufferClear::fromJson(char* jsonStr)
{
...
RealtimeClientEventInputAudioBufferClear::RealtimeClientEventInputAudioBufferClear(char* json)
{
	this->fromJson(json);
}
