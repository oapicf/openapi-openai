...
void
RealtimeResponse_usage_input_token_details::__init()
{
	//cached_tokens = int(0);
	//text_tokens = int(0);
	//audio_tokens = int(0);
...
void
RealtimeResponse_usage_input_token_details::__cleanup()
{
...
void
RealtimeResponse_usage_input_token_details::fromJson(char* jsonStr)
{
...
RealtimeResponse_usage_input_token_details::RealtimeResponse_usage_input_token_details(char* json)
{
	this->fromJson(json);
}
