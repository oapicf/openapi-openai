...
void
RealtimeServerEventConversationItemCreated::__init()
{
	//event_id = std::string();
	//type = std::string();
...
void
RealtimeServerEventConversationItemCreated::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeServerEventConversationItemCreated::fromJson(char* jsonStr)
{
...
RealtimeServerEventConversationItemCreated::RealtimeServerEventConversationItemCreated(char* json)
{
	this->fromJson(json);
}
