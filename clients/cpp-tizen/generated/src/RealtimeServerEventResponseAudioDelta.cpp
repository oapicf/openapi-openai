...
void
RealtimeServerEventResponseAudioDelta::__init()
{
	//event_id = std::string();
	//type = std::string();
...
void
RealtimeServerEventResponseAudioDelta::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeServerEventResponseAudioDelta::fromJson(char* jsonStr)
{
...
RealtimeServerEventResponseAudioDelta::RealtimeServerEventResponseAudioDelta(char* json)
{
	this->fromJson(json);
}
