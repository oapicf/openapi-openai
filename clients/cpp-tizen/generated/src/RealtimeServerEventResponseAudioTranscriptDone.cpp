...
void
RealtimeServerEventResponseAudioTranscriptDone::__init()
{
	//event_id = std::string();
	//type = std::string();
...
void
RealtimeServerEventResponseAudioTranscriptDone::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeServerEventResponseAudioTranscriptDone::fromJson(char* jsonStr)
{
...
RealtimeServerEventResponseAudioTranscriptDone::RealtimeServerEventResponseAudioTranscriptDone(char* json)
{
	this->fromJson(json);
}
