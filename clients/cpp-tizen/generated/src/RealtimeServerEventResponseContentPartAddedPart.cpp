...
void
RealtimeServerEventResponseContentPartAdded_part::__init()
{
	//type = std::string();
	//text = std::string();
	//audio = std::string();
...
void
RealtimeServerEventResponseContentPartAdded_part::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
RealtimeServerEventResponseContentPartAdded_part::fromJson(char* jsonStr)
{
...
RealtimeServerEventResponseContentPartAdded_part::RealtimeServerEventResponseContentPartAdded_part(char* json)
{
	this->fromJson(json);
}
