...
void
RealtimeServerEventResponseCreated::__init()
{
	//event_id = std::string();
	//type = std::string();
...
void
RealtimeServerEventResponseCreated::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeServerEventResponseCreated::fromJson(char* jsonStr)
{
...
RealtimeServerEventResponseCreated::RealtimeServerEventResponseCreated(char* json)
{
	this->fromJson(json);
}
