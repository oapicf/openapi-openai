...
void
RealtimeServerEventResponseOutputItemAdded::__init()
{
	//event_id = std::string();
	//type = std::string();
...
void
RealtimeServerEventResponseOutputItemAdded::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeServerEventResponseOutputItemAdded::fromJson(char* jsonStr)
{
...
RealtimeServerEventResponseOutputItemAdded::RealtimeServerEventResponseOutputItemAdded(char* json)
{
	this->fromJson(json);
}
