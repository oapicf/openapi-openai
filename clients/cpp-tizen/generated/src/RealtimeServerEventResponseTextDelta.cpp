...
void
RealtimeServerEventResponseTextDelta::__init()
{
	//event_id = std::string();
	//type = std::string();
...
void
RealtimeServerEventResponseTextDelta::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeServerEventResponseTextDelta::fromJson(char* jsonStr)
{
...
RealtimeServerEventResponseTextDelta::RealtimeServerEventResponseTextDelta(char* json)
{
	this->fromJson(json);
}
...
std::string
RealtimeServerEventResponseTextDelta::getEventId()
{
	return event_id;
}

void
RealtimeServerEventResponseTextDelta::setEventId(std::string  event_id)
{
	this->event_id = event_id;
}

std::string
RealtimeServerEventResponseTextDelta::getType()
{
	return type;
}

void
RealtimeServerEventResponseTextDelta::setType(std::string  type)
{
	this->type = type;
}

std::string
RealtimeServerEventResponseTextDelta::getResponseId()
{
	return response_id;
}

void
RealtimeServerEventResponseTextDelta::setResponseId(std::string  response_id)
{
	this->response_id = response_id;
}

std::string
RealtimeServerEventResponseTextDelta::getItemId()
{
	return item_id;
}

void
RealtimeServerEventResponseTextDelta::setItemId(std::string  item_id)
{
	this->item_id = item_id;
}

int
RealtimeServerEventResponseTextDelta::getOutputIndex()
{
	return output_index;
}

void
RealtimeServerEventResponseTextDelta::setOutputIndex(int  output_index)
{
	this->output_index = output_index;
}

int
RealtimeServerEventResponseTextDelta::getContentIndex()
{
	return content_index;
}

void
RealtimeServerEventResponseTextDelta::setContentIndex(int  content_index)
{
	this->content_index = content_index;
}

std::string
RealtimeServerEventResponseTextDelta::getDelta()
{
	return delta;
}

void
RealtimeServerEventResponseTextDelta::setDelta(std::string  delta)
{
	this->delta = delta;
}
