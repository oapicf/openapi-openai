...
void
RealtimeServerEventResponseTextDone::__init()
{
	//event_id = std::string();
	//type = std::string();
...
void
RealtimeServerEventResponseTextDone::__cleanup()
{
	//if(event_id != NULL) {
	//
	//delete event_id;
...
void
RealtimeServerEventResponseTextDone::fromJson(char* jsonStr)
{
...
RealtimeServerEventResponseTextDone::RealtimeServerEventResponseTextDone(char* json)
{
	this->fromJson(json);
}
