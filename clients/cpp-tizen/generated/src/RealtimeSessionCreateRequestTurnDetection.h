...
#ifndef _RealtimeSessionCreateRequest_turn_detection_H_
#define _RealtimeSessionCreateRequest_turn_detection_H_
...
class RealtimeSessionCreateRequest_turn_detection : public Object {
public:
	/*! \brief Constructor.
	 */
	RealtimeSessionCreateRequest_turn_detection();
	RealtimeSessionCreateRequest_turn_detection(char* str);
	...
	/*! \brief Get Whether or not to automatically generate a response when VAD is enabled. `true` by default. 
	 */
	bool getCreateResponse();

	/*! \brief Set Whether or not to automatically generate a response when VAD is enabled. `true` by default. 
	 */
	void setCreateResponse(bool  create_response);
...
#endif /* _RealtimeSessionCreateRequest_turn_detection_H_ */
