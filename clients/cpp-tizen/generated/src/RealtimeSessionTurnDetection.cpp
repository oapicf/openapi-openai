...
void
RealtimeSession_turn_detection::__init()
{
	//type = std::string();
	//threshold = double(0);
...
void
RealtimeSession_turn_detection::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
RealtimeSession_turn_detection::fromJson(char* jsonStr)
{
...
RealtimeSession_turn_detection::RealtimeSession_turn_detection(char* json)
{
	this->fromJson(json);
}
...
void
RealtimeSession_turn_detection::setThreshold(long long  threshold)
{
