...
#ifndef _RealtimeSession_turn_detection_H_
#define _RealtimeSession_turn_detection_H_
...
class RealtimeSession_turn_detection : public Object {
public:
	/*! \brief Constructor.
	 */
	RealtimeSession_turn_detection();
	RealtimeSession_turn_detection(char* str);
...
#endif /* _RealtimeSession_turn_detection_H_ */
