...
void
ResponseFormatJsonSchema::__init()
{
	//type = std::string();
...
void
ResponseFormatJsonSchema::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
ResponseFormatJsonSchema::fromJson(char* jsonStr)
{
...
ResponseFormatJsonSchema::ResponseFormatJsonSchema(char* json)
{
	this->fromJson(json);
}
