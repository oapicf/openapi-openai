...
void
RunStepCompletionUsage::__cleanup()
{
...
void
RunStepCompletionUsage::fromJson(char* jsonStr)
{
...
RunStepCompletionUsage::RunStepCompletionUsage(char* json)
{
	this->fromJson(json);
}

char*
RunStepCompletionUsage::toJson()
{
...
int
RunStepCompletionUsage::getCompletionTokens()
{
	return completion_tokens;
}

void
RunStepCompletionUsage::setCompletionTokens(int  completion_tokens)
{
	this->completion_tokens = completion_tokens;
}

int
RunStepCompletionUsage::getPromptTokens()
{
	return prompt_tokens;
}

void
RunStepCompletionUsage::setPromptTokens(int  prompt_tokens)
{
	this->prompt_tokens = prompt_tokens;
}

int
RunStepCompletionUsage::getTotalTokens()
{
	return total_tokens;
}

void
RunStepCompletionUsage::setTotalTokens(int  total_tokens)
{
