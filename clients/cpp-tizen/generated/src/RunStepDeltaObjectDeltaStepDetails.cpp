...
void
RunStepDeltaObject_delta_step_details::__init()
{
	//type = std::string();
...
void
RunStepDeltaObject_delta_step_details::__cleanup()
{
	//if(type != NULL) {
	//
	//delete type;
...
void
RunStepDeltaObject_delta_step_details::fromJson(char* jsonStr)
{
...
RunStepDeltaObject_delta_step_details::RunStepDeltaObject_delta_step_details(char* json)
{
	this->fromJson(json);
}
