...
void
RunStepDeltaStepDetailsToolCallsFunctionObject::__init()
{
	//index = int(0);
	//id = std::string();
	//type = std::string();
...
void
RunStepDeltaStepDetailsToolCallsFunctionObject::__cleanup()
{
	//if(index != NULL) {
	//
	//delete index;
...
void
RunStepDeltaStepDetailsToolCallsFunctionObject::fromJson(char* jsonStr)
{
...
RunStepDeltaStepDetailsToolCallsFunctionObject::RunStepDeltaStepDetailsToolCallsFunctionObject(char* json)
{
	this->fromJson(json);
}
