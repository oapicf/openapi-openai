...
void
RunStepDetailsMessageCreationObject_message_creation::__init()
{
	//message_id = std::string();
}

void
RunStepDetailsMessageCreationObject_message_creation::__cleanup()
{
	//if(message_id != NULL) {
	//
	//delete message_id;
...
void
RunStepDetailsMessageCreationObject_message_creation::fromJson(char* jsonStr)
{
...
RunStepDetailsMessageCreationObject_message_creation::RunStepDetailsMessageCreationObject_message_creation(char* json)
{
	this->fromJson(json);
}
