...
void
RunStepDetailsToolCallsFunctionObject_function::__init()
{
	//name = std::string();
...
void
RunStepDetailsToolCallsFunctionObject_function::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
RunStepDetailsToolCallsFunctionObject_function::fromJson(char* jsonStr)
{
...
RunStepDetailsToolCallsFunctionObject_function::RunStepDetailsToolCallsFunctionObject_function(char* json)
{
	this->fromJson(json);
}
