...
void
RunStepObject_last_error::__init()
{
	//code = std::string();
	//message = std::string();
}
...
void
RunStepObject_last_error::__cleanup()
{
	//if(code != NULL) {
	//
	//delete code;
...
void
RunStepObject_last_error::fromJson(char* jsonStr)
{
...
RunStepObject_last_error::RunStepObject_last_error(char* json)
{
	this->fromJson(json);
}
