...
void
RunStepStreamEvent_oneOf_1::__init()
{
	//event = std::string();
...
void
RunStepStreamEvent_oneOf_1::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStepStreamEvent_oneOf_1::fromJson(char* jsonStr)
{
...
RunStepStreamEvent_oneOf_1::RunStepStreamEvent_oneOf_1(char* json)
{
	this->fromJson(json);
}
