...
void
RunStepStreamEvent_oneOf_3::__init()
{
	//event = std::string();
...
void
RunStepStreamEvent_oneOf_3::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStepStreamEvent_oneOf_3::fromJson(char* jsonStr)
{
...
RunStepStreamEvent_oneOf_3::RunStepStreamEvent_oneOf_3(char* json)
{
	this->fromJson(json);
}
