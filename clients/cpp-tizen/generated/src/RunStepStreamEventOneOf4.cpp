...
void
RunStepStreamEvent_oneOf_4::__init()
{
	//event = std::string();
...
void
RunStepStreamEvent_oneOf_4::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStepStreamEvent_oneOf_4::fromJson(char* jsonStr)
{
...
RunStepStreamEvent_oneOf_4::RunStepStreamEvent_oneOf_4(char* json)
{
	this->fromJson(json);
}
