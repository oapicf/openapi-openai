...
void
RunStepStreamEvent_oneOf_6::__init()
{
	//event = std::string();
...
void
RunStepStreamEvent_oneOf_6::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStepStreamEvent_oneOf_6::fromJson(char* jsonStr)
{
...
RunStepStreamEvent_oneOf_6::RunStepStreamEvent_oneOf_6(char* json)
{
	this->fromJson(json);
}
