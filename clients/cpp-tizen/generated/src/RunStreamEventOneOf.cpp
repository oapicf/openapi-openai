...
void
RunStreamEvent_oneOf::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf::RunStreamEvent_oneOf(char* json)
{
	this->fromJson(json);
}
