...
void
RunStreamEvent_oneOf_1::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf_1::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf_1::RunStreamEvent_oneOf_1(char* json)
{
	this->fromJson(json);
}
