...
void
RunStreamEvent_oneOf_2::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf_2::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf_2::RunStreamEvent_oneOf_2(char* json)
{
	this->fromJson(json);
}

char*
RunStreamEvent_oneOf_2::toJson()
{
...
std::string
RunStreamEvent_oneOf_2::getEvent()
{
	return event;
}

void
RunStreamEvent_oneOf_2::setEvent(std::string  event)
{
	this->event = event;
}

RunObject
RunStreamEvent_oneOf_2::getData()
{
	return data;
}

void
RunStreamEvent_oneOf_2::setData(RunObject  data)
{
	this->data = data;
}
