...
void
RunStreamEvent_oneOf_4::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf_4::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf_4::RunStreamEvent_oneOf_4(char* json)
{
	this->fromJson(json);
}
