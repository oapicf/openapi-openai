...
void
RunStreamEvent_oneOf_5::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf_5::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf_5::RunStreamEvent_oneOf_5(char* json)
{
	this->fromJson(json);
}
