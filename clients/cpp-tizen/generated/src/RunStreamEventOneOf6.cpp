...
void
RunStreamEvent_oneOf_6::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf_6::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf_6::RunStreamEvent_oneOf_6(char* json)
{
	this->fromJson(json);
}
