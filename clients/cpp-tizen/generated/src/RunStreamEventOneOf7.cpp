...
void
RunStreamEvent_oneOf_7::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf_7::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf_7::RunStreamEvent_oneOf_7(char* json)
{
	this->fromJson(json);
}
