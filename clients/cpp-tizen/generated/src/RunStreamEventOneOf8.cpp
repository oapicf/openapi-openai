...
void
RunStreamEvent_oneOf_8::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf_8::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf_8::RunStreamEvent_oneOf_8(char* json)
{
	this->fromJson(json);
}
