...
void
RunStreamEvent_oneOf_9::__cleanup()
{
	//if(event != NULL) {
	//
	//delete event;
...
void
RunStreamEvent_oneOf_9::fromJson(char* jsonStr)
{
...
RunStreamEvent_oneOf_9::RunStreamEvent_oneOf_9(char* json)
{
	this->fromJson(json);
}
