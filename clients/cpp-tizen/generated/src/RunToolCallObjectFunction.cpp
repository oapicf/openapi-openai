...
void
RunToolCallObject_function::__init()
{
	//name = std::string();
...
void
RunToolCallObject_function::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
RunToolCallObject_function::fromJson(char* jsonStr)
{
...
RunToolCallObject_function::RunToolCallObject_function(char* json)
{
	this->fromJson(json);
}
