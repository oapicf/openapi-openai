...
void
UsageModerationsResult::__cleanup()
{
	//if(object != NULL) {
	//
	//delete object;
...
void
UsageModerationsResult::fromJson(char* jsonStr)
{
...
UsageModerationsResult::UsageModerationsResult(char* json)
{
	this->fromJson(json);
}
