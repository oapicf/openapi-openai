...
#ifndef _VectorStoreObject_file_counts_H_
#define _VectorStoreObject_file_counts_H_
...
class VectorStoreObject_file_counts : public Object {
public:
	/*! \brief Constructor.
	 */
	VectorStoreObject_file_counts();
	VectorStoreObject_file_counts(char* str);
...
#endif /* _VectorStoreObject_file_counts_H_ */
