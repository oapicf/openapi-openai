...
void OpenAPIBatchRequestOutputError::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIBatchRequestOutputError::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
