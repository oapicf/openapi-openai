...
FString OpenAPIChatApi::CreateChatCompletionRequest::ComputePath() const
{
	FString Path(TEXT("/chat/completions"));
	return Path;
}

void OpenAPIChatApi::CreateChatCompletionRequest::SetupHttpRequest(const FHttpRequestRef& HttpRequest) const
{
...
void OpenAPIChatApi::CreateChatCompletionResponse::SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode)
{
...
bool OpenAPIChatApi::CreateChatCompletionResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
