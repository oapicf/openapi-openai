...
void OpenAPICreateChatCompletionStreamResponseUsage::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateChatCompletionStreamResponseUsage::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
