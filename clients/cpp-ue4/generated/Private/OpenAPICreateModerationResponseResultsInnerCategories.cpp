...
void OpenAPICreateModerationResponseResultsInnerCategories::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateModerationResponseResultsInnerCategories::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
