...
void OpenAPICreateTranscriptionResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateTranscriptionResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
