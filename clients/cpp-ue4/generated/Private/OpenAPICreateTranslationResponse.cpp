...
void OpenAPICreateTranslationResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateTranslationResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
