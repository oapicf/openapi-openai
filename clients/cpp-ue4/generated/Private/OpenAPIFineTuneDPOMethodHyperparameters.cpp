...
void OpenAPIFineTuneDPOMethodHyperparameters::WriteJson(JsonWriter& Writer) const
{
	Writer->WriteObjectStart();
	if (Beta.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("beta")); WriteJsonValue(Writer, Beta.GetValue());
	}
	if (BatchSize.IsSet())
	{
...
bool OpenAPIFineTuneDPOMethodHyperparameters::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("beta"), Beta);
