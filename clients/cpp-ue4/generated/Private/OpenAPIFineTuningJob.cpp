...
void OpenAPIFineTuningJob::WriteJson(JsonWriter& Writer) const
{
	...
	if (EstimatedFinish.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("estimated_finish")); WriteJsonValue(Writer, EstimatedFinish.GetValue());
	}
	if (Method.IsSet())
	{
...
bool OpenAPIFineTuningJob::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("estimated_finish"), EstimatedFinish);
