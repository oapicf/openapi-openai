...
void OpenAPIFineTuningJob::WriteJson(JsonWriter& Writer) const
{
	...
	Writer->WriteIdentifierPrefix(TEXT("finished_at")); WriteJsonValue(Writer, FinishedAt);
	...
	Writer->WriteIdentifierPrefix(TEXT("trained_tokens")); WriteJsonValue(Writer, TrainedTokens);
	Writer->WriteIdentifierPrefix(TEXT("training_file")); WriteJsonValue(Writer, TrainingFile);
	Writer->WriteIdentifierPrefix(TEXT("validation_file")); WriteJsonValue(Writer, ValidationFile);
