...
void OpenAPIListAssistantFilesResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIListAssistantFilesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
