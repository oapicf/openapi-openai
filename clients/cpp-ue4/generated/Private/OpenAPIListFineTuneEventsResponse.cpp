...
void OpenAPIListFineTuneEventsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIListFineTuneEventsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
