...
void OpenAPIListMessageFilesResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIListMessageFilesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
