...
#include "OpenAPIListThreadsResponse.h"
...
void OpenAPIListThreadsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIListThreadsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
