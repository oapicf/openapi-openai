...
void OpenAPIListVectorStoreFilesResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIListVectorStoreFilesResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
