...
void OpenAPIListVectorStoresResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIListVectorStoresResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
