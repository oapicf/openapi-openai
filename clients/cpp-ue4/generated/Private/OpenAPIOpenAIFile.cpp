...
inline FString ToString(const OpenAPIOpenAIFile::PurposeEnum& Value)
{
	...
	case OpenAPIOpenAIFile::PurposeEnum::Batch:
		return TEXT("batch");
	case OpenAPIOpenAIFile::PurposeEnum::BatchOutput:
		return TEXT("batch_output");
	...
	case OpenAPIOpenAIFile::PurposeEnum::Vision:
		return TEXT("vision");
	}
...
inline bool FromString(const FString& EnumAsString, OpenAPIOpenAIFile::PurposeEnum& Value)
{
	static TMap<FString, OpenAPIOpenAIFile::PurposeEnum> StringToEnum = { 
		...
		{ TEXT("batch"), OpenAPIOpenAIFile::PurposeEnum::Batch },
		{ TEXT("batch_output"), OpenAPIOpenAIFile::PurposeEnum::BatchOutput },
		...
		{ TEXT("vision"), OpenAPIOpenAIFile::PurposeEnum::Vision }, };
