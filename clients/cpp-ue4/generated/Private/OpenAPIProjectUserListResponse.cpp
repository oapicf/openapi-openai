...
void OpenAPIProjectUserListResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIProjectUserListResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
