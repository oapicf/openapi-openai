...
void OpenAPIRunObject::WriteJson(JsonWriter& Writer) const
{
	...
	Writer->WriteIdentifierPrefix(TEXT("required_action")); WriteJsonValue(Writer, RequiredAction);
	...
	Writer->WriteIdentifierPrefix(TEXT("started_at")); WriteJsonValue(Writer, StartedAt);
	...
	Writer->WriteIdentifierPrefix(TEXT("incomplete_details")); WriteJsonValue(Writer, IncompleteDetails);
	...
	Writer->WriteIdentifierPrefix(TEXT("max_prompt_tokens")); WriteJsonValue(Writer, MaxPromptTokens);
	Writer->WriteIdentifierPrefix(TEXT("max_completion_tokens")); WriteJsonValue(Writer, MaxCompletionTokens);
