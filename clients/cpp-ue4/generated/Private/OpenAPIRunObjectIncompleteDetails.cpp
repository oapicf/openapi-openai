...
inline FString ToString(const OpenAPIRunObjectIncompleteDetails::ReasonEnum& Value)
{
	switch (Value)
	{
	case OpenAPIRunObjectIncompleteDetails::ReasonEnum::MaxCompletionTokens:
		return TEXT("max_completion_tokens");
	case OpenAPIRunObjectIncompleteDetails::ReasonEnum::MaxPromptTokens:
...
inline bool FromString(const FString& EnumAsString, OpenAPIRunObjectIncompleteDetails::ReasonEnum& Value)
{
	static TMap<FString, OpenAPIRunObjectIncompleteDetails::ReasonEnum> StringToEnum = { 
		{ TEXT("max_completion_tokens"), OpenAPIRunObjectIncompleteDetails::ReasonEnum::MaxCompletionTokens },
		{ TEXT("max_prompt_tokens"), OpenAPIRunObjectIncompleteDetails::ReasonEnum::MaxPromptTokens }, };
