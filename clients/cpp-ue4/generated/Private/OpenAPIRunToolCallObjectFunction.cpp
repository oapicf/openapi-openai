...
void OpenAPIRunToolCallObjectFunction::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRunToolCallObjectFunction::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
