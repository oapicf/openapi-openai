...
public:
	...
	static FString EnumToString(const IncludeEnum& EnumValue);
	static bool EnumFromString(const FString& EnumAsString, IncludeEnum& EnumValue);
	/* A list of additional fields to include in the response. Currently the only supported value is `step_details.tool_calls[*].file_search.results[*].content` to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information.  */
	TOptional<TArray<IncludeEnum>> Include;
};
...
*/
class OPENAPI_API OpenAPIAssistantsApi::DeleteMessageRequest : public Request
{
public:
...
class OPENAPI_API OpenAPIAssistantsApi::DeleteMessageResponse : public Response
{
public:
    ...
    OpenAPIDeleteMessageResponse Content;
};
