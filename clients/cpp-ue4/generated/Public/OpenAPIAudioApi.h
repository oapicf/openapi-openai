...
class OPENAPI_API OpenAPIAudioApi
{
public:
	OpenAPIAudioApi();
	~OpenAPIAudioApi();
	...
	* See also: Request::SetShouldRetry */
	...
	class CreateSpeechResponse;
	class CreateTranscriptionRequest;
	class CreateTranscriptionResponse;
	class CreateTranslationRequest;
	class CreateTranslationResponse;
	
    DECLARE_DELEGATE_OneParam(FCreateSpeechDelegate, const CreateSpeechResponse&);
    ...
    FHttpRequestPtr CreateSpeech(const CreateSpeechRequest& Request, const FCreateSpeechDelegate& Delegate = FCreateSpeechDelegate()) const;
...
private:
    void OnCreateSpeechResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FCreateSpeechDelegate Delegate) const;
