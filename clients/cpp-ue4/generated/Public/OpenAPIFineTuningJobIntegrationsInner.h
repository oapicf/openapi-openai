...
/*
 * OpenAPIFineTuningJobIntegrationsInner
 *
 * 
 */
class OPENAPI_API OpenAPIFineTuningJobIntegrationsInner : public Model
{
public:
    virtual ~OpenAPIFineTuningJobIntegrationsInner() {}
