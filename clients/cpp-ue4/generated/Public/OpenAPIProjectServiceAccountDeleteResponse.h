...
/*
 * OpenAPIProjectServiceAccountDeleteResponse
 *
 * 
 */
class OPENAPI_API OpenAPIProjectServiceAccountDeleteResponse : public Model
{
public:
    virtual ~OpenAPIProjectServiceAccountDeleteResponse() {}
