...
public:
	...
	StatusEnum Status;
	OpenAPIRunObjectRequiredAction RequiredAction;
	OpenAPIRunObjectLastError LastError;
	...
	int32 CompletedAt = 0;
	OpenAPIRunObjectIncompleteDetails IncompleteDetails;
