...
/*
 * OpenAPIRunStepDeltaStepDetailsToolCallsFunctionObject
 *
 * 
 */
class OPENAPI_API OpenAPIRunStepDeltaStepDetailsToolCallsFunctionObject : public Model
{
public:
    virtual ~OpenAPIRunStepDeltaStepDetailsToolCallsFunctionObject() {}
