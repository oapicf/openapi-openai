...
Spectator.describe "ImagesApi" do
  ...
  # @option opts [Int32] :n The number of images to generate. Must be between 1 and 10.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [CreateImageEditRequestModel] :model 
  # @option opts [Int32] :n The number of images to generate. Must be between 1 and 10. For &#x60;dall-e-3&#x60;, only &#x60;n&#x3D;1&#x60; is supported.
  # @option opts [String] :response_format The format in which the generated images are returned. Must be one of &#x60;url&#x60; or &#x60;b64_json&#x60;. URLs are only valid for 60 minutes after the image has been generated.
  # @option opts [String] :size The size of the generated images. Must be one of &#x60;256x256&#x60;, &#x60;512x512&#x60;, or &#x60;1024x1024&#x60;.
  # @option opts [String] :user A unique identifier representing your end-user, which can help OpenAI to monitor and detect abuse. [Learn more](/docs/guides/safety-best-practices/end-user-ids). 
  # @return [ImagesResponse]
