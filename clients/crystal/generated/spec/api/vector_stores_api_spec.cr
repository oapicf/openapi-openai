...
# Unit tests for OpenAPIClient::VectorStoresApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "VectorStoresApi" do
  describe "test an instance of VectorStoresApi" do
    it "should create an instance of VectorStoresApi" do
      api_instance = OpenAPIClient::VectorStoresApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::VectorStoresApi)
    end
  end
