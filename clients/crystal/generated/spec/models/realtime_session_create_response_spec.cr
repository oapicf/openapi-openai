...
# Unit tests for OpenAPIClient::RealtimeSessionCreateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::RealtimeSessionCreateResponse do

  describe "test an instance of RealtimeSessionCreateResponse" do
    skip "should create an instance of RealtimeSessionCreateResponse" do
      #instance = OpenAPIClient::RealtimeSessionCreateResponse.new
      #expect(instance).to be_instance_of(OpenAPIClient::RealtimeSessionCreateResponse)
    end
  end
