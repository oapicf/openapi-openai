...
# Unit tests for OpenAPIClient::RealtimeSession
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::RealtimeSession do

  describe "test an instance of RealtimeSession" do
    skip "should create an instance of RealtimeSession" do
      #instance = OpenAPIClient::RealtimeSession.new
      #expect(instance).to be_instance_of(OpenAPIClient::RealtimeSession)
    end
  end
