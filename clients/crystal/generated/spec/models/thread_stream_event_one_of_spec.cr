...
# Unit tests for OpenAPIClient::ThreadStreamEventOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenAPIClient::ThreadStreamEventOneOf do

  describe "test an instance of ThreadStreamEventOneOf" do
    it "should create an instance of ThreadStreamEventOneOf" do
      #instance = OpenAPIClient::ThreadStreamEventOneOf.new
      #expect(instance).to be_instance_of(OpenAPIClient::ThreadStreamEventOneOf)
    end
  end
