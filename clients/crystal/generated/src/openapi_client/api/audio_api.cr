...
module OpenAPIClient
  class AudioApi
    ...
    def create_transcription(file : ::File, model : CreateTranscriptionRequestModel, language : String? = nil, prompt : String? = nil, response_format : String? = nil, temperature : Float64? = nil, timestamp_granularities : Array(String)? = nil)
    ...
    def create_transcription_with_http_info(file : ::File, model : CreateTranscriptionRequestModel, language : String? = nil, prompt : String? = nil, response_format : String? = nil, temperature : Float64? = nil, timestamp_granularities : Array(String)? = nil)
      if @api_client.config.debugging
    ...
    def create_translation(file : ::File, model : CreateTranscriptionRequestModel, prompt : String? = nil, response_format : String? = nil, temperature : Float64? = nil)
    ...
    def create_translation_with_http_info(file : ::File, model : CreateTranscriptionRequestModel, prompt : String? = nil, response_format : String? = nil, temperature : Float64? = nil)
      if @api_client.config.debugging
