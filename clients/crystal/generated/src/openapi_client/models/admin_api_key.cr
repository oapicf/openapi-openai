...
module OpenAPIClient
  class AdminApiKey
    ...
    @[JSON::Field(key: "redacted_value", type: String?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "owner", type: AdminApiKeyOwner?, nillable: true, emit_null: false)]
    property owner : AdminApiKeyOwner?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@object : String? = nil, @id : String? = nil, @name : String? = nil, @redacted_value : String? = nil, @value : String? = nil, @created_at : Int64? = nil, @owner : AdminApiKeyOwner? = nil)
    end
    ...
    def hash
      [object, id, name, redacted_value, value, created_at, owner].hash
    end
