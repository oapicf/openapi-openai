...
module OpenAPIClient
  ...
  class AssistantObject
    ...
    def valid?
      ...
      return false if @name.to_s.size > 256
      return false if @description.to_s.size > 512
      return false if @instructions.to_s.size > 256000
      return false if @tools.size > 128
      return false if @file_ids.size > 20
      true
    end
