...
module OpenAPIClient
  ...
  class AssistantObject
    ...
    # Optional properties
    @[JSON::Field(key: "tool_resources", type: AssistantObjectToolResources?, nillable: true, emit_null: false)]
    property tool_resources : AssistantObjectToolResources?
    ...
    def initialize(@id : String, @object : String, @created_at : Int32, @name : String, @description : String, @model : String, @instructions : String, @tools : Array(AssistantObjectToolsInner), @metadata : Object, @tool_resources : AssistantObjectToolResources? = nil, @temperature : Float64? = nil, @top_p : Float64? = nil, @response_format : AssistantsApiResponseFormatOption? = nil)
    end
