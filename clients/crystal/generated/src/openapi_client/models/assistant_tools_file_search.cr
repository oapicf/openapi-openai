...
module OpenAPIClient
  class AssistantToolsFileSearch
    ...
    # Optional properties
    @[JSON::Field(key: "file_search", type: AssistantToolsFileSearchFileSearch?, nillable: true, emit_null: false)]
    property file_search : AssistantToolsFileSearchFileSearch?
    ...
    def initialize(@_type : String, @file_search : AssistantToolsFileSearchFileSearch? = nil)
    end
