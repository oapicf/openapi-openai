...
module OpenAPIClient
  class AssistantToolsFunction
    ...
    @[JSON::Field(key: "function", type: FunctionObject, nillable: false, emit_null: false)]
    property function : FunctionObject
    ...
    def initialize(@_type : String, @function : FunctionObject)
    end
