...
module OpenAPIClient
  ...
  class AssistantsApiNamedToolChoice
    ...
    # Optional properties
    @[JSON::Field(key: "function", type: ChatCompletionNamedToolChoiceFunction?, nillable: true, emit_null: false)]
    property function : ChatCompletionNamedToolChoiceFunction?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["function", "code_interpreter", "retrieval"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @function : ChatCompletionNamedToolChoiceFunction? = nil)
    end
