...
module OpenAPIClient
  ...
  class AssistantsNamedToolChoice
    ...
    # Optional properties
    @[JSON::Field(key: "function", type: AssistantsNamedToolChoiceFunction?, nillable: true, emit_null: false)]
    property function : AssistantsNamedToolChoiceFunction?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["function", "code_interpreter", "file_search"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @function : AssistantsNamedToolChoiceFunction? = nil)
    end
