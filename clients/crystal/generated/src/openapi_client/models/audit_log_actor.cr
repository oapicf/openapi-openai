...
module OpenAPIClient
  ...
  class AuditLogActor
    ...
    @[JSON::Field(key: "session", type: AuditLogActorSession?, nillable: true, emit_null: false)]
    property session : AuditLogActorSession?

    @[JSON::Field(key: "api_key", type: AuditLogActorApiKey?, nillable: true, emit_null: false)]
    property api_key : AuditLogActorApiKey?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["session", "api_key"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String? = nil, @session : AuditLogActorSession? = nil, @api_key : AuditLogActorApiKey? = nil)
    end
