...
module OpenAPIClient
  ...
  class AuditLogActorApiKey
    ...
    @[JSON::Field(key: "user", type: AuditLogActorUser?, nillable: true, emit_null: false)]
    property user : AuditLogActorUser?

    @[JSON::Field(key: "service_account", type: AuditLogActorServiceAccount?, nillable: true, emit_null: false)]
    property service_account : AuditLogActorServiceAccount?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["user", "service_account"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String? = nil, @_type : String? = nil, @user : AuditLogActorUser? = nil, @service_account : AuditLogActorServiceAccount? = nil)
    end
    ...
    def hash
      [id, _type, user, service_account].hash
    end
    ...
    def to_h
      ...
      hash["service_account"] = _to_h(service_account)
      hash.to_h
    end
