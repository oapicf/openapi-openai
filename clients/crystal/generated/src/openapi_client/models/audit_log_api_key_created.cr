...
module OpenAPIClient
  ...
  class AuditLogApiKeyCreated
    ...
    @[JSON::Field(key: "data", type: AuditLogApiKeyCreatedData?, nillable: true, emit_null: false)]
    property data : AuditLogApiKeyCreatedData?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String? = nil, @data : AuditLogApiKeyCreatedData? = nil)
    end
