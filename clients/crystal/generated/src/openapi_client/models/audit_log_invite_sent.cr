...
module OpenAPIClient
  ...
  class AuditLogInviteSent
    ...
    @[JSON::Field(key: "data", type: AuditLogInviteSentData?, nillable: true, emit_null: false)]
    property data : AuditLogInviteSentData?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String? = nil, @data : AuditLogInviteSentData? = nil)
    end
