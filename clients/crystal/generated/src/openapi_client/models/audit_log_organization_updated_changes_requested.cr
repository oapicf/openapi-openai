...
module OpenAPIClient
  ...
  class AuditLogOrganizationUpdatedChangesRequested
    ...
    @[JSON::Field(key: "settings", type: AuditLogOrganizationUpdatedChangesRequestedSettings?, nillable: true, emit_null: false)]
    property settings : AuditLogOrganizationUpdatedChangesRequestedSettings?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @description : String? = nil, @name : String? = nil, @settings : AuditLogOrganizationUpdatedChangesRequestedSettings? = nil)
    end
