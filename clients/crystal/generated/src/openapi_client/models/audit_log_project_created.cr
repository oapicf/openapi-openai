...
module OpenAPIClient
  ...
  class AuditLogProjectCreated
    ...
    @[JSON::Field(key: "data", type: AuditLogProjectCreatedData?, nillable: true, emit_null: false)]
    property data : AuditLogProjectCreatedData?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String? = nil, @data : AuditLogProjectCreatedData? = nil)
    end
