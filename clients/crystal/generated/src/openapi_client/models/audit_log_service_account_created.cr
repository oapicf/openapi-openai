...
module OpenAPIClient
  ...
  class AuditLogServiceAccountCreated
    ...
    @[JSON::Field(key: "data", type: AuditLogServiceAccountCreatedData?, nillable: true, emit_null: false)]
    property data : AuditLogServiceAccountCreatedData?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String? = nil, @data : AuditLogServiceAccountCreatedData? = nil)
    end
