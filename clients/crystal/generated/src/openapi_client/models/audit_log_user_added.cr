...
module OpenAPIClient
  ...
  class AuditLogUserAdded
    ...
    @[JSON::Field(key: "data", type: AuditLogUserAddedData?, nillable: true, emit_null: false)]
    property data : AuditLogUserAddedData?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String? = nil, @data : AuditLogUserAddedData? = nil)
    end
