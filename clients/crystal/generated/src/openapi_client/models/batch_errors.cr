...
module OpenAPIClient
  class BatchErrors
    ...
    @[JSON::Field(key: "data", type: Array(BatchErrorsDataInner)?, nillable: true, emit_null: false)]
    property data : Array(BatchErrorsDataInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@object : String? = nil, @data : Array(BatchErrorsDataInner)? = nil)
    end
