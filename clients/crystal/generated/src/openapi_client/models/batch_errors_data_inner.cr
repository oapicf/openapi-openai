...
module OpenAPIClient
  class BatchErrorsDataInner
    ...
    @[JSON::Field(key: "line", type: Int32?, nillable: true, emit_null: false)]
    property line : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@code : String? = nil, @message : String? = nil, @param : String? = nil, @line : Int32? = nil)
    end
