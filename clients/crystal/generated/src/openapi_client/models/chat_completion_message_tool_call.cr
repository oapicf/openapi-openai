...
module OpenAPIClient
  class ChatCompletionMessageToolCall
    ...
    @[JSON::Field(key: "function", type: ChatCompletionMessageToolCallFunction, nillable: false, emit_null: false)]
    property function : ChatCompletionMessageToolCallFunction
    ...
    def initialize(@id : String, @_type : String, @function : ChatCompletionMessageToolCallFunction)
    end
