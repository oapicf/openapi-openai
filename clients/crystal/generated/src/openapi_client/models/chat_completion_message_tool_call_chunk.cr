...
module OpenAPIClient
  class ChatCompletionMessageToolCallChunk
    ...
    @[JSON::Field(key: "function", type: ChatCompletionMessageToolCallChunkFunction?, nillable: true, emit_null: false)]
    property function : ChatCompletionMessageToolCallChunkFunction?
    ...
    def initialize(@index : Int32, @id : String? = nil, @_type : String? = nil, @function : ChatCompletionMessageToolCallChunkFunction? = nil)
    end
