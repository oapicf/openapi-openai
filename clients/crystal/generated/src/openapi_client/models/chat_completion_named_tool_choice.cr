...
module OpenAPIClient
  ...
  class ChatCompletionNamedToolChoice
    ...
    @[JSON::Field(key: "function", type: AssistantsNamedToolChoiceFunction, nillable: false, emit_null: false)]
    ...
    def initialize(@_type : String, @function : AssistantsNamedToolChoiceFunction)
    end
