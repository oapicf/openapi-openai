...
module OpenAPIClient
  ...
  class ChatCompletionNamedToolChoice
    ...
    @[JSON::Field(key: "function", type: ChatCompletionNamedToolChoiceFunction, nillable: false, emit_null: false)]
    ...
    def initialize(@_type : String, @function : ChatCompletionNamedToolChoiceFunction)
    end
