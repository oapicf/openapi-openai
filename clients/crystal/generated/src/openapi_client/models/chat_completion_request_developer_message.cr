...
module OpenAPIClient
  ...
  class ChatCompletionRequestDeveloperMessage
    ...
    # Required properties
    @[JSON::Field(key: "content", type: ChatCompletionRequestDeveloperMessageContent, nillable: false, emit_null: false)]
    property content : ChatCompletionRequestDeveloperMessageContent
    ...
    class EnumAttributeValidatorForRole < EnumAttributeValidator
      ...
      def initialize
        @attribute = "role"
        @allowable_values = ["developer"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@content : ChatCompletionRequestDeveloperMessageContent, @role : String, @name : String? = nil)
    end
