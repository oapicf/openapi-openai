...
module OpenAPIClient
  ...
  class ChatCompletionRequestMessageContentPartAudio
    ...
    @[JSON::Field(key: "input_audio", type: ChatCompletionRequestMessageContentPartAudioInputAudio, nillable: false, emit_null: false)]
    property input_audio : ChatCompletionRequestMessageContentPartAudioInputAudio
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["input_audio"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @input_audio : ChatCompletionRequestMessageContentPartAudioInputAudio)
    end
    ...
    def to_h
      ...
      hash["input_audio"] = _to_h(input_audio)
      hash.to_h
    end
