...
module OpenAPIClient
  class ChatCompletionRequestMessageContentPartImage
    ...
    @[JSON::Field(key: "image_url", type: ChatCompletionRequestMessageContentPartImageImageUrl, nillable: false, emit_null: false)]
    property image_url : ChatCompletionRequestMessageContentPartImageImageUrl
    ...
    def initialize(@_type : String, @image_url : ChatCompletionRequestMessageContentPartImageImageUrl)
    end
