...
module OpenAPIClient
  ...
  class ChatCompletionRequestSystemMessage
    ...
    # Required properties
    @[JSON::Field(key: "content", type: ChatCompletionRequestSystemMessageContent, nillable: false, emit_null: false)]
    property content : ChatCompletionRequestSystemMessageContent
    ...
    class EnumAttributeValidatorForRole < EnumAttributeValidator
      ...
      def initialize
        @attribute = "role"
        @allowable_values = ["system"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@content : ChatCompletionRequestSystemMessageContent, @role : String, @name : String? = nil)
    end
