...
module OpenAPIClient
  ...
  class ChatCompletionRequestUserMessage
    ...
    # Required properties
    @[JSON::Field(key: "content", type: ChatCompletionRequestUserMessageContent, nillable: false, emit_null: false)]
    property content : ChatCompletionRequestUserMessageContent
    ...
    class EnumAttributeValidatorForRole < EnumAttributeValidator
      ...
      def initialize
        @attribute = "role"
        @allowable_values = ["user"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@content : ChatCompletionRequestUserMessageContent, @role : String, @name : String? = nil)
    end
