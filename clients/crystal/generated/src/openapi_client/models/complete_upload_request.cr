...
module OpenAPIClient
  class CompleteUploadRequest
    ...
    @[JSON::Field(key: "part_ids", type: Array(String), nillable: false, emit_null: false)]
    property part_ids : Array(String)

    # Optional properties
    # The optional md5 checksum for the file contents to verify if the bytes uploaded matches what you expect. 
    @[JSON::Field(key: "md5", type: String?, nillable: true, emit_null: false)]
    property md5 : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@part_ids : Array(String), @md5 : String? = nil)
    end
