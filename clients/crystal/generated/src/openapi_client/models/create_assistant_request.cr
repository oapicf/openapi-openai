...
module OpenAPIClient
  class CreateAssistantRequest
    ...
    def initialize(@model : CreateAssistantRequestModel, @name : String? = nil, @description : String? = nil, @instructions : String? = nil, @tools : Array(AssistantObjectToolsInner)? = nil, @file_ids : Array(String)? = nil, @metadata : Object? = nil)
    end
