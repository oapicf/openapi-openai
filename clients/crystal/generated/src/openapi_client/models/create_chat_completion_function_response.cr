...
module OpenAPIClient
  ...
  class CreateChatCompletionFunctionResponse
    ...
    def initialize(@id : String, @choices : Array(CreateChatCompletionFunctionResponseChoicesInner), @created : Int32, @model : String, @object : String, @system_fingerprint : String?, @usage : CompletionUsage?)
    end
