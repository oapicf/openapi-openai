...
module OpenAPIClient
  ...
  class CreateChatCompletionFunctionResponse
    ...
    @[JSON::Field(key: "choices", type: Array(CreateChatCompletionFunctionResponseChoicesInner), nillable: false, emit_null: false)]
    property choices : Array(CreateChatCompletionFunctionResponseChoicesInner)
    ...
    def initialize(@id : String, @choices : Array(CreateChatCompletionFunctionResponseChoicesInner), @created : Int32, @model : String, @object : String, @system_fingerprint : String? = nil, @usage : CompletionUsage? = nil)
    end
