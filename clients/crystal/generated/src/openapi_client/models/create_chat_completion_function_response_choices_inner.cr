  ...
  class CreateChatCompletionFunctionResponseChoicesInner
    ...
    class EnumAttributeValidatorForFinish_reason < EnumAttributeValidator
      ...
      def initialize
        ...
        @allowable_values = ["stop", "length", "function_call", "content_filter"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@finish_reason : String, @index : Int32, @message : ChatCompletionResponseMessage)
    end
