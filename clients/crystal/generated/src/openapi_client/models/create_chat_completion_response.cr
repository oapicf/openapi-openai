...
module OpenAPIClient
  ...
  class CreateChatCompletionResponse
    ...
    @[JSON::Field(key: "choices", type: Array(CreateChatCompletionResponseChoicesInner), nillable: false, emit_null: false)]
    property choices : Array(CreateChatCompletionResponseChoicesInner)
    ...
    @[JSON::Field(key: "usage", type: CompletionUsage?, nillable: true, emit_null: false)]
    property usage : CompletionUsage?
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["chat.completion"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @choices : Array(CreateChatCompletionResponseChoicesInner), @created : Int32, @model : String, @object : String, @service_tier : String? = nil, @system_fingerprint : String? = nil, @usage : CompletionUsage? = nil)
    end
