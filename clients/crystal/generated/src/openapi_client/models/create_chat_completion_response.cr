...
module OpenAPIClient
  ...
  class CreateChatCompletionResponse
    ...
    def initialize(@id : String, @choices : Array(CreateChatCompletionResponseChoicesInner), @created : Int32, @model : String, @object : String, @system_fingerprint : String?, @usage : CompletionUsage?)
    end
