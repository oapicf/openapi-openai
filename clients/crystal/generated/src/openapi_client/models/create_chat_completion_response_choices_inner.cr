...
module OpenAPIClient
  class CreateChatCompletionResponseChoicesInner
    ...
    @[JSON::Field(key: "message", type: ChatCompletionResponseMessage, nillable: false, emit_null: false)]
    property message : ChatCompletionResponseMessage

    @[JSON::Field(key: "logprobs", type: CreateChatCompletionResponseChoicesInnerLogprobs, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorForFinish_reason < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "finish_reason"
        @allowable_values = ["stop", "length", "tool_calls", "content_filter", "function_call"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@finish_reason : String, @index : Int32, @message : ChatCompletionResponseMessage, @logprobs : CreateChatCompletionResponseChoicesInnerLogprobs)
    end
    ...
    def list_invalid_properties
      ...
      finish_reason_validator = EnumAttributeValidatorForFinish_reason.new
      if !finish_reason_validator.valid?(@finish_reason)
        message = finish_reason_validator.message
    ...
    def finish_reason=(finish_reason)
      validator = EnumAttributeValidatorForFinish_reason.new
    ...
    def to_h
      ...
      hash["finish_reason"] = _to_h(finish_reason)
