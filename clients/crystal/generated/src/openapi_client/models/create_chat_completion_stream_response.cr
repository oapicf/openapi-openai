...
module OpenAPIClient
  ...
  class CreateChatCompletionStreamResponse
    ...
    def initialize(@id : String, @choices : Array(CreateChatCompletionStreamResponseChoicesInner), @created : Int32, @model : String, @object : String, @system_fingerprint : String? = nil)
    end
