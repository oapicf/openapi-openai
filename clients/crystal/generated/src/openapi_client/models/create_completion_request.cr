...
module OpenAPIClient
  class CreateCompletionRequest
    ...
    def initialize(@model : CreateCompletionRequestModel, @prompt : CreateCompletionRequestPrompt, @best_of : Int32? = nil, @echo : Bool? = nil, @frequency_penalty : Float64? = nil, @logit_bias : Hash(String, Int32)? = nil, @logprobs : Int32? = nil, @max_tokens : Int32? = nil, @n : Int32? = nil, @presence_penalty : Float64? = nil, @seed : Int32? = nil, @stop : CreateCompletionRequestStop? = nil, @stream : Bool? = nil, @suffix : String? = nil, @temperature : Float64? = nil, @top_p : Float64? = nil, @user : String? = nil)
    end
