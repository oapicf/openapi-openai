...
module OpenAPIClient
  ...
  class CreateCompletionResponse
    ...
    @[JSON::Field(key: "choices", type: Array(CreateCompletionResponseChoicesInner), nillable: false, emit_null: false)]
    property choices : Array(CreateCompletionResponseChoicesInner)
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["text_completion"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @choices : Array(CreateCompletionResponseChoicesInner), @created : Int32, @model : String, @object : String, @system_fingerprint : String? = nil, @usage : CompletionUsage? = nil)
    end
