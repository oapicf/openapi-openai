...
module OpenAPIClient
  class CreateCompletionResponseChoicesInnerLogprobs
    ...
    def initialize(@text_offset : Array(Int32)? = nil, @token_logprobs : Array(Float64)? = nil, @tokens : Array(String)? = nil, @top_logprobs : Array(Hash(String, Float64))? = nil)
    end
    ...
    def to_h
      ...
      hash["text_offset"] = _to_h(text_offset)
      hash["token_logprobs"] = _to_h(token_logprobs)
