...
module OpenAPIClient
  class CreateEmbeddingResponse
    ...
    @[JSON::Field(key: "data", type: Array(Embedding), nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "usage", type: CreateEmbeddingResponseUsage, nillable: false, emit_null: false)]
    property usage : CreateEmbeddingResponseUsage
    ...
    def initialize(@data : Array(Embedding), @model : String, @object : String, @usage : CreateEmbeddingResponseUsage)
    end
