...
module OpenAPIClient
  class CreateFineTuningJobRequest
    ...
    def initialize(@model : CreateFineTuningJobRequestModel, @training_file : String, @hyperparameters : CreateFineTuningJobRequestHyperparameters? = nil, @suffix : String? = nil, @validation_file : String? = nil, @integrations : Array(CreateFineTuningJobRequestIntegrationsInner)? = nil, @seed : Int32? = nil, @method : FineTuneMethod? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@suffix.nil? && @suffix.try &.to_s.try &.size.try &.> 64
    ...
    def valid?
      return false if !@suffix.nil? && @suffix.try &.to_s.try &.size.try &.> 64
    ...
    def suffix=(suffix)
      if !suffix.nil? && suffix.to_s.size > 64
        raise ArgumentError.new("invalid value for \"suffix\", the character length must be smaller than or equal to 64.")
      end
