...
module OpenAPIClient
  class CreateImageRequest
    ...
    def initialize(@prompt : String, @n : Int32?, @size : String?, @response_format : String?, @user : String?)
    end
    ...
    def valid?
      ...
      size_validator = EnumAttributeValidator.new("String", ["256x256", "512x512", "1024x1024"])
    ...
    def size=(size)
      validator = EnumAttributeValidator.new("String", ["256x256", "512x512", "1024x1024"])
    ...
    def hash
      [prompt, n, size, response_format, user].hash
    end
