...
module OpenAPIClient
  ...
  class CreateModerationRequestInputOneOfInnerOneOf
    ...
    @[JSON::Field(key: "image_url", type: CreateModerationRequestInputOneOfInnerOneOfImageUrl, nillable: false, emit_null: false)]
    property image_url : CreateModerationRequestInputOneOfInnerOneOfImageUrl
    ...
    def initialize(@_type : String, @image_url : CreateModerationRequestInputOneOfInnerOneOfImageUrl)
    end
