...
module OpenAPIClient
  ...
  class CreateModerationResponseResultsInnerCategories
    ...
    @[JSON::Field(key: "illicit", type: Bool, nillable: false, emit_null: false)]
    property illicit : Bool

    # Content that includes instructions or advice that facilitate the planning or execution of wrongdoing that also includes violence, or that gives advice or instruction on the procurement of any weapon.
    @[JSON::Field(key: "illicit/violent", type: Bool, nillable: false, emit_null: false)]
    property illicit_violent : Bool
    ...
    def initialize(@hate : Bool, @hate_threatening : Bool, @harassment : Bool, @harassment_threatening : Bool, @illicit : Bool, @illicit_violent : Bool, @self_harm : Bool, @self_harm_intent : Bool, @self_harm_instructions : Bool, @sexual : Bool, @sexual_minors : Bool, @violence : Bool, @violence_graphic : Bool)
    end
