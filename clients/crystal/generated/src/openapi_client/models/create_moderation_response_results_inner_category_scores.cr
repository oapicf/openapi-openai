...
module OpenAPIClient
  ...
  class CreateModerationResponseResultsInnerCategoryScores
    ...
    @[JSON::Field(key: "illicit", type: Float64, nillable: false, emit_null: false)]
    property illicit : Float64

    # The score for the category 'illicit/violent'.
    @[JSON::Field(key: "illicit/violent", type: Float64, nillable: false, emit_null: false)]
    property illicit_violent : Float64
    ...
    def initialize(@hate : Float64, @hate_threatening : Float64, @harassment : Float64, @harassment_threatening : Float64, @illicit : Float64, @illicit_violent : Float64, @self_harm : Float64, @self_harm_intent : Float64, @self_harm_instructions : Float64, @sexual : Float64, @sexual_minors : Float64, @violence : Float64, @violence_graphic : Float64)
    end
