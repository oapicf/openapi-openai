...
module OpenAPIClient
  class CreateRunRequest
    ...
    def initialize(@assistant_id : String, @model : CreateRunRequestModel? = nil, @instructions : String? = nil, @additional_instructions : String? = nil, @additional_messages : Array(CreateMessageRequest)? = nil, @tools : Array(AssistantObjectToolsInner)? = nil, @metadata : Object? = nil, @temperature : Float64? = nil, @stream : Bool? = nil, @max_prompt_tokens : Int32? = nil, @max_completion_tokens : Int32? = nil, @truncation_strategy : TruncationObject? = nil, @tool_choice : AssistantsApiToolChoiceOption? = nil, @response_format : AssistantsApiResponseFormatOption? = nil)
    end
