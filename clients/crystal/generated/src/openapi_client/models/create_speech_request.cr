...
module OpenAPIClient
  class CreateSpeechRequest
    ...
    def initialize(@model : CreateSpeechRequestModel, @input : String, @voice : String, @response_format : String?, @speed : Float64?)
    end
    ...
    def valid?
      return false if @input.to_s.size > 4096
    ...
    def voice=(voice)
      ...
      unless validator.valid?(voice)
        raise ArgumentError.new("invalid value for \"voice\", must be one of #{validator.allowable_values}.")
      end
      @voice = voice
    end
