...
module OpenAPIClient
  class CreateThreadAndRunRequest
    ...
    def initialize(@assistant_id : String, @thread : CreateThreadRequest? = nil, @model : CreateRunRequestModel? = nil, @instructions : String? = nil, @tools : Array(CreateThreadAndRunRequestToolsInner)? = nil, @metadata : Object? = nil, @temperature : Float64? = nil, @stream : Bool? = nil, @max_prompt_tokens : Int32? = nil, @max_completion_tokens : Int32? = nil, @truncation_strategy : TruncationObject? = nil, @tool_choice : AssistantsApiToolChoiceOption? = nil, @response_format : AssistantsApiResponseFormatOption? = nil)
    end
    ...
    def hash
      [assistant_id, thread, model, instructions, tools, metadata, temperature, stream, max_prompt_tokens, max_completion_tokens, truncation_strategy, tool_choice, response_format].hash
    end
