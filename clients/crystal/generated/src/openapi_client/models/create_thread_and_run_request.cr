...
module OpenAPIClient
  class CreateThreadAndRunRequest
    ...
    def initialize(@assistant_id : String, @thread : CreateThreadRequest?, @model : CreateRunRequestModel?, @instructions : String?, @tools : Array(CreateThreadAndRunRequestToolsInner)?, @metadata : Object?, @temperature : Float64?, @stream : Bool?, @max_prompt_tokens : Int32?, @max_completion_tokens : Int32?, @truncation_strategy : TruncationObject?, @tool_choice : AssistantsApiToolChoiceOption?, @response_format : AssistantsApiResponseFormatOption?)
    end
