...
module OpenAPIClient
  class CreateThreadAndRunRequest
    ...
    # Optional properties
    @[JSON::Field(key: "thread", type: CreateThreadRequest?, nillable: true, emit_null: false)]
    property thread : CreateThreadRequest?
    ...
    @[JSON::Field(key: "tools", type: Array(CreateThreadAndRunRequestToolsInner)?, nillable: true, emit_null: false)]
    property tools : Array(CreateThreadAndRunRequestToolsInner)?

    @[JSON::Field(key: "tool_resources", type: CreateThreadAndRunRequestToolResources?, nillable: true, emit_null: false)]
    property tool_resources : CreateThreadAndRunRequestToolResources?
    ...
    def initialize(@assistant_id : String, @thread : CreateThreadRequest? = nil, @model : CreateRunRequestModel? = nil, @instructions : String? = nil, @tools : Array(CreateThreadAndRunRequestToolsInner)? = nil, @tool_resources : CreateThreadAndRunRequestToolResources? = nil, @metadata : Object? = nil, @temperature : Float64? = nil, @top_p : Float64? = nil, @stream : Bool? = nil, @max_prompt_tokens : Int32? = nil, @max_completion_tokens : Int32? = nil, @truncation_strategy : TruncationObject? = nil, @tool_choice : AssistantsApiToolChoiceOption? = nil, @parallel_tool_calls : Bool? = nil, @response_format : AssistantsApiResponseFormatOption? = nil)
    end
