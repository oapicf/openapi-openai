...
module OpenAPIClient
  class CreateUploadRequest
    ...
    @[JSON::Field(key: "mime_type", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorForPurpose < EnumAttributeValidator
      ...
      def initialize
        @attribute = "purpose"
        @allowable_values = ["assistants", "batch", "fine-tune", "vision"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@filename : String, @purpose : String, @bytes : Int32, @mime_type : String)
    end
