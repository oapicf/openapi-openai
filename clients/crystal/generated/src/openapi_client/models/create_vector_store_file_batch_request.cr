...
module OpenAPIClient
  class CreateVectorStoreFileBatchRequest
    ...
    # Optional properties
    @[JSON::Field(key: "chunking_strategy", type: ChunkingStrategyRequestParam?, nillable: true, emit_null: false)]
    property chunking_strategy : ChunkingStrategyRequestParam?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@file_ids : Array(String), @chunking_strategy : ChunkingStrategyRequestParam? = nil)
    end
    ...
    def valid?
      return false if @file_ids.try &.size.try &.> 500
      return false if @file_ids.try &.size.try &.< 1
      true
    end
