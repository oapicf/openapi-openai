...
module OpenAPIClient
  ...
  class Embedding
    ...
    @[JSON::Field(key: "embedding", type: Array(Float64), nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["embedding"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @embedding : Array(Float64), @object : String)
    end
    ...
    def to_h
      ...
      hash["embedding"] = _to_h(embedding)
