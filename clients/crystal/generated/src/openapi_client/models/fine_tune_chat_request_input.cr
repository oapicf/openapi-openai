...
module OpenAPIClient
  ...
  class FineTuneChatRequestInput
    ...
    # Optional properties
    @[JSON::Field(key: "messages", type: Array(FineTuneChatRequestInputMessagesInner)?, nillable: true, emit_null: false)]
    property messages : Array(FineTuneChatRequestInputMessagesInner)?
    ...
    def initialize(@messages : Array(FineTuneChatRequestInputMessagesInner)? = nil, @tools : Array(ChatCompletionTool)? = nil, @parallel_tool_calls : Bool? = nil, @functions : Array(ChatCompletionFunctions)? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@messages.nil? && @messages.try &.size.try &.< 1
    ...
    def valid?
      return false if !@messages.nil? && @messages.try &.size.try &.< 1
    ...
    def messages=(messages)
      if !messages.nil? && messages.size < 1
