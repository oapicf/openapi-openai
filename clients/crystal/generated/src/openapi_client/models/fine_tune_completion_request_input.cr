...
module OpenAPIClient
  ...
  class FineTuneCompletionRequestInput
    ...
    @[JSON::Field(key: "prompt", type: String?, nillable: true, emit_null: false)]
    property prompt : String?

    # The desired completion for this training example.
    @[JSON::Field(key: "completion", type: String?, nillable: true, emit_null: false)]
    property completion : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@prompt : String? = nil, @completion : String? = nil)
    end
    ...
    def to_h
      ...
      hash["completion"] = _to_h(completion)
      hash.to_h
    end
