...
module OpenAPIClient
  ...
  class FineTuneDPOMethod
    ...
    # Optional properties
    @[JSON::Field(key: "hyperparameters", type: FineTuneDPOMethodHyperparameters?, nillable: true, emit_null: false)]
    property hyperparameters : FineTuneDPOMethodHyperparameters?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@hyperparameters : FineTuneDPOMethodHyperparameters? = nil)
    end
