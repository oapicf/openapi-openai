...
module OpenAPIClient
  ...
  class FineTuneMethod
    ...
    @[JSON::Field(key: "supervised", type: FineTuneSupervisedMethod?, nillable: true, emit_null: false)]
    property supervised : FineTuneSupervisedMethod?

    @[JSON::Field(key: "dpo", type: FineTuneDPOMethod?, nillable: true, emit_null: false)]
    property dpo : FineTuneDPOMethod?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["supervised", "dpo"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String? = nil, @supervised : FineTuneSupervisedMethod? = nil, @dpo : FineTuneDPOMethod? = nil)
    end
    ...
    def to_h
      ...
      hash["supervised"] = _to_h(supervised)
      hash["dpo"] = _to_h(dpo)
      hash.to_h
    end
