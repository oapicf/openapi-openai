...
module OpenAPIClient
  class FineTunePreferenceRequestInputInput
    ...
    def initialize(@messages : Array(FineTuneChatRequestInputMessagesInner)? = nil, @tools : Array(ChatCompletionTool)? = nil, @parallel_tool_calls : Bool? = nil)
    end
    ...
    def hash
      [messages, tools, parallel_tool_calls].hash
    end
