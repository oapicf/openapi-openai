...
module OpenAPIClient
  ...
  class FineTuneSupervisedMethod
    ...
    # Optional properties
    @[JSON::Field(key: "hyperparameters", type: FineTuneSupervisedMethodHyperparameters?, nillable: true, emit_null: false)]
    property hyperparameters : FineTuneSupervisedMethodHyperparameters?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@hyperparameters : FineTuneSupervisedMethodHyperparameters? = nil)
    end
