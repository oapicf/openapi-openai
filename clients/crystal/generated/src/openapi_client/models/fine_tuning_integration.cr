...
module OpenAPIClient
  class FineTuningIntegration
    ...
    @[JSON::Field(key: "wandb", type: CreateFineTuningJobRequestIntegrationsInnerWandb, nillable: false, emit_null: false)]
    property wandb : CreateFineTuningJobRequestIntegrationsInnerWandb
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["wandb"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @wandb : CreateFineTuningJobRequestIntegrationsInnerWandb)
    end
