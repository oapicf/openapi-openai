...
module OpenAPIClient
  ...
  class FineTuningJob
    ...
    @[JSON::Field(key: "estimated_finish", type: Int32?, nillable: true, emit_null: false)]
    property estimated_finish : Int32?

    @[JSON::Field(key: "method", type: FineTuneMethod?, nillable: true, emit_null: false)]
    property method : FineTuneMethod?
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          seed == other.seed &&
          estimated_finish == other.estimated_finish &&
          method == other.method
    end
    ...
    def to_h
      ...
      hash["estimated_finish"] = _to_h(estimated_finish)
