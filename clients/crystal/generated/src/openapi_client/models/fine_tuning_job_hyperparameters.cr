...
module OpenAPIClient
  ...
  class FineTuningJobHyperparameters
    ...
    # Required properties
    @[JSON::Field(key: "n_epochs", type: FineTuningJobHyperparametersNEpochs, nillable: false, emit_null: false)]
    property n_epochs : FineTuningJobHyperparametersNEpochs

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@n_epochs : FineTuningJobHyperparametersNEpochs)
    end
