...
module OpenAPIClient
  class InviteRequest
    ...
    @[JSON::Field(key: "projects", type: Array(InviteRequestProjectsInner)?, nillable: true, emit_null: false)]
    property projects : Array(InviteRequestProjectsInner)?
    ...
    class EnumAttributeValidatorForRole < EnumAttributeValidator
      ...
      def initialize
        @attribute = "role"
        @allowable_values = ["reader", "owner"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@email : String, @role : String, @projects : Array(InviteRequestProjectsInner)? = nil)
    end
