...
module OpenAPIClient
  class ListAuditLogsEffectiveAtParameter
    ...
    @[JSON::Field(key: "gt", type: Int32?, nillable: true, emit_null: false)]
    property gt : Int32?

    # Return only events whose `effective_at` (Unix seconds) is greater than or equal to this value.
    @[JSON::Field(key: "gte", type: Int32?, nillable: true, emit_null: false)]
    property gte : Int32?

    # Return only events whose `effective_at` (Unix seconds) is less than this value.
    @[JSON::Field(key: "lt", type: Int32?, nillable: true, emit_null: false)]
    property lt : Int32?

    # Return only events whose `effective_at` (Unix seconds) is less than or equal to this value.
    @[JSON::Field(key: "lte", type: Int32?, nillable: true, emit_null: false)]
    property lte : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@gt : Int32? = nil, @gte : Int32? = nil, @lt : Int32? = nil, @lte : Int32? = nil)
    end
