...
module OpenAPIClient
  class ListFineTuningJobEventsResponse
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(FineTuningJobEvent), nillable: false, emit_null: false)]
    property data : Array(FineTuningJobEvent)
    ...
    def initialize(@data : Array(FineTuningJobEvent), @object : String)
    end
