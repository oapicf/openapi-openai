...
module OpenAPIClient
  ...
  class MessageContentImageFileObject
    ...
    @[JSON::Field(key: "image_file", type: MessageContentImageFileObjectImageFile, nillable: false, emit_null: false)]
    property image_file : MessageContentImageFileObjectImageFile
    ...
    def initialize(@_type : String, @image_file : MessageContentImageFileObjectImageFile)
    end
