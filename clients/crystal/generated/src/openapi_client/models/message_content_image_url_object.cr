...
module OpenAPIClient
  ...
  class MessageContentImageUrlObject
    ...
    @[JSON::Field(key: "image_url", type: MessageContentImageUrlObjectImageUrl, nillable: false, emit_null: false)]
    property image_url : MessageContentImageUrlObjectImageUrl
    ...
    def initialize(@_type : String, @image_url : MessageContentImageUrlObjectImageUrl)
    end
