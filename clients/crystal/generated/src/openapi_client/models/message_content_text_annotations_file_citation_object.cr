...
module OpenAPIClient
  ...
  class MessageContentTextAnnotationsFileCitationObject
    ...
    @[JSON::Field(key: "file_citation", type: MessageContentTextAnnotationsFileCitationObjectFileCitation, nillable: false, emit_null: false)]
    property file_citation : MessageContentTextAnnotationsFileCitationObjectFileCitation
    ...
    def initialize(@_type : String, @text : String, @file_citation : MessageContentTextAnnotationsFileCitationObjectFileCitation, @start_index : Int32, @end_index : Int32)
    end
    ...
    def valid?
      ...
      return false if @start_index.try &.< 0
      return false if @end_index.try &.< 0
      true
    end
    ...
    def hash
      [_type, text, file_citation, start_index, end_index].hash
    end
