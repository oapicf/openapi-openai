...
module OpenAPIClient
  ...
  class MessageContentTextObject
    ...
    @[JSON::Field(key: "text", type: MessageContentTextObjectText, nillable: false, emit_null: false)]
    property text : MessageContentTextObjectText
    ...
    def initialize(@_type : String, @text : MessageContentTextObjectText)
    end
