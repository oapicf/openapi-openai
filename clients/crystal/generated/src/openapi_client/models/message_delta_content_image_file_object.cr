...
module OpenAPIClient
  ...
  class MessageDeltaContentImageFileObject
    ...
    # Optional properties
    @[JSON::Field(key: "image_file", type: MessageDeltaContentImageFileObjectImageFile?, nillable: true, emit_null: false)]
    property image_file : MessageDeltaContentImageFileObjectImageFile?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["image_file"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @_type : String, @image_file : MessageDeltaContentImageFileObjectImageFile? = nil)
    end
    ...
    def to_h
      ...
      hash["image_file"] = _to_h(image_file)
      hash.to_h
    end
