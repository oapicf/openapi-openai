...
module OpenAPIClient
  class MessageDeltaContentImageFileObjectImageFile
    ...
    @[JSON::Field(key: "file_id", type: String?, nillable: true, emit_null: false)]
    property file_id : String?

    # Specifies the detail level of the image if specified by the user. `low` uses fewer tokens, you can opt in to high resolution using `high`.
    @[JSON::Field(key: "detail", type: String?, default: "auto", nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForDetail < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "detail"
        @allowable_values = ["auto", "low", "high"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@file_id : String? = nil, @detail : String? = nil)
    end
    ...
    def list_invalid_properties
      ...
      detail_validator = EnumAttributeValidatorForDetail.new
      if !detail_validator.valid?(@detail)
        message = detail_validator.message
    ...
    def detail=(detail)
      validator = EnumAttributeValidatorForDetail.new
