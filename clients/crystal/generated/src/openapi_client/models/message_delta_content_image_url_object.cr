...
module OpenAPIClient
  ...
  class MessageDeltaContentImageUrlObject
    ...
    # Optional properties
    @[JSON::Field(key: "image_url", type: MessageDeltaContentImageUrlObjectImageUrl?, nillable: true, emit_null: false)]
    property image_url : MessageDeltaContentImageUrlObjectImageUrl?
    ...
    def initialize(@index : Int32, @_type : String, @image_url : MessageDeltaContentImageUrlObjectImageUrl? = nil)
    end
