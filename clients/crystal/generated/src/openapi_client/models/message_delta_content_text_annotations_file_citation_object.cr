...
module OpenAPIClient
  ...
  class MessageDeltaContentTextAnnotationsFileCitationObject
    ...
    def initialize(@index : Int32, @_type : String, @text : String?, @file_citation : MessageDeltaContentTextAnnotationsFileCitationObjectFileCitation?, @start_index : Int32?, @end_index : Int32?)
    end
    ...
    def valid?
      _type_validator = EnumAttributeValidator.new("String", ["file_citation"])
