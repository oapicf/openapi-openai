...
module OpenAPIClient
  ...
  class MessageDeltaContentTextAnnotationsFileCitationObject
    ...
    @[JSON::Field(key: "file_citation", type: MessageDeltaContentTextAnnotationsFileCitationObjectFileCitation?, nillable: true, emit_null: false)]
    property file_citation : MessageDeltaContentTextAnnotationsFileCitationObjectFileCitation?

    @[JSON::Field(key: "start_index", type: Int32?, nillable: true, emit_null: false)]
    property start_index : Int32?

    @[JSON::Field(key: "end_index", type: Int32?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["file_citation"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @_type : String, @text : String? = nil, @file_citation : MessageDeltaContentTextAnnotationsFileCitationObjectFileCitation? = nil, @start_index : Int32? = nil, @end_index : Int32? = nil)
    end
    ...
    def valid?
      ...
      return false if !@start_index.nil? && @start_index.try &.< 0
      return false if !@end_index.nil? && @end_index.try &.< 0
      true
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          _type == other._type &&
          text == other.text &&
          file_citation == other.file_citation &&
    ...
    def hash
      [index, _type, text, file_citation, start_index, end_index].hash
    end
    ...
    def to_h
      ...
      hash["file_citation"] = _to_h(file_citation)
      hash["start_index"] = _to_h(start_index)
      hash["end_index"] = _to_h(end_index)
      hash.to_h
    end
