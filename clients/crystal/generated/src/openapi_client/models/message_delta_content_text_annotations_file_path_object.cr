...
module OpenAPIClient
  ...
  class MessageDeltaContentTextAnnotationsFilePathObject
    ...
    @[JSON::Field(key: "file_path", type: MessageDeltaContentTextAnnotationsFilePathObjectFilePath?, nillable: true, emit_null: false)]
    property file_path : MessageDeltaContentTextAnnotationsFilePathObjectFilePath?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["file_path"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @_type : String, @text : String? = nil, @file_path : MessageDeltaContentTextAnnotationsFilePathObjectFilePath? = nil, @start_index : Int32? = nil, @end_index : Int32? = nil)
    end
    ...
    def hash
      [index, _type, text, file_path, start_index, end_index].hash
    end
    ...
    def to_h
      ...
      hash["file_path"] = _to_h(file_path)
