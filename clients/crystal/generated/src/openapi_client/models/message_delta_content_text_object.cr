...
module OpenAPIClient
  ...
  class MessageDeltaContentTextObject
    ...
    # Optional properties
    @[JSON::Field(key: "text", type: MessageDeltaContentTextObjectText?, nillable: true, emit_null: false)]
    property text : MessageDeltaContentTextObjectText?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["text"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @_type : String, @text : MessageDeltaContentTextObjectText? = nil)
    end
