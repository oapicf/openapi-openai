...
module OpenAPIClient
  class MessageDeltaContentTextObjectText
    ...
    @[JSON::Field(key: "annotations", type: Array(MessageDeltaContentTextObjectTextAnnotationsInner)?, nillable: true, emit_null: false)]
    property annotations : Array(MessageDeltaContentTextObjectTextAnnotationsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@value : String? = nil, @annotations : Array(MessageDeltaContentTextObjectTextAnnotationsInner)? = nil)
    end
    ...
    def to_h
      ...
      hash["annotations"] = _to_h(annotations)
      hash.to_h
    end
