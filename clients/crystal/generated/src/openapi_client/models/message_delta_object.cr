...
module OpenAPIClient
  ...
  class MessageDeltaObject
    ...
    @[JSON::Field(key: "delta", type: MessageDeltaObjectDelta, nillable: false, emit_null: false)]
    property delta : MessageDeltaObjectDelta
    ...
    def initialize(@id : String, @object : String, @delta : MessageDeltaObjectDelta)
    end
