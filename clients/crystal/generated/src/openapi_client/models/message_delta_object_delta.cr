...
module OpenAPIClient
  ...
  class MessageDeltaObjectDelta
    ...
    @[JSON::Field(key: "content", type: Array(MessageDeltaObjectDeltaContentInner)?, nillable: true, emit_null: false)]
    property content : Array(MessageDeltaObjectDeltaContentInner)?
    ...
    def initialize(@role : String? = nil, @content : Array(MessageDeltaObjectDeltaContentInner)? = nil, @file_ids : Array(String)? = nil)
    end
