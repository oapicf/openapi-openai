...
module OpenAPIClient
  ...
  class MessageFileObject
    ...
    @[JSON::Field(key: "message_id", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["thread.message.file"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @object : String, @created_at : Int32, @message_id : String)
    end
    ...
    def to_h
      ...
      hash["message_id"] = _to_h(message_id)
      hash.to_h
    end
