...
module OpenAPIClient
  ...
  class MessageStreamEventOneOf1
    ...
    @[JSON::Field(key: "data", type: MessageObject, nillable: false, emit_null: false)]
    property data : MessageObject
    ...
    class EnumAttributeValidatorForEvent < EnumAttributeValidator
      ...
      def initialize
        @attribute = "event"
        @allowable_values = ["thread.message.in_progress"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event : String, @data : MessageObject)
    end
