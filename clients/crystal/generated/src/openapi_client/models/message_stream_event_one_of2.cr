...
module OpenAPIClient
  ...
  class MessageStreamEventOneOf2
    ...
    @[JSON::Field(key: "data", type: MessageDeltaObject, nillable: false, emit_null: false)]
    property data : MessageDeltaObject
    ...
    class EnumAttributeValidatorForEvent < EnumAttributeValidator
      ...
      def initialize
        @attribute = "event"
        @allowable_values = ["thread.message.delta"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event : String, @data : MessageDeltaObject)
    end
