...
module OpenAPIClient
  class ModifyAssistantRequest
    ...
    @[JSON::Field(key: "tool_resources", type: ModifyAssistantRequestToolResources?, nillable: true, emit_null: false)]
    property tool_resources : ModifyAssistantRequestToolResources?
    ...
    def initialize(@model : String? = nil, @name : String? = nil, @description : String? = nil, @instructions : String? = nil, @tools : Array(AssistantObjectToolsInner)? = nil, @tool_resources : ModifyAssistantRequestToolResources? = nil, @metadata : Object? = nil, @temperature : Float64? = nil, @top_p : Float64? = nil, @response_format : AssistantsApiResponseFormatOption? = nil)
    end
