...
module OpenAPIClient
  class ModifyAssistantRequest
    ...
    def initialize(@model : String?, @name : String?, @description : String?, @instructions : String?, @tools : Array(AssistantObjectToolsInner)?, @file_ids : Array(String)?, @metadata : Object?)
    end
