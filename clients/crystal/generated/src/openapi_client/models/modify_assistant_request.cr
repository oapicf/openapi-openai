...
module OpenAPIClient
  class ModifyAssistantRequest
    ...
    def initialize(@model : String? = nil, @name : String? = nil, @description : String? = nil, @instructions : String? = nil, @tools : Array(AssistantObjectToolsInner)? = nil, @file_ids : Array(String)? = nil, @metadata : Object? = nil)
    end
    ...
    def list_invalid_properties
      ...
      if !@file_ids.nil? && @file_ids.try &.size.try &.> 20
    ...
    def valid?
      ...
      return false if !@file_ids.nil? && @file_ids.try &.size.try &.> 20
      true
    end
