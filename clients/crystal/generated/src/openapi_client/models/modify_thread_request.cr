...
module OpenAPIClient
  class ModifyThreadRequest
    ...
    # Optional properties
    @[JSON::Field(key: "tool_resources", type: ModifyThreadRequestToolResources?, nillable: true, emit_null: false)]
    ...
    def initialize(@tool_resources : ModifyThreadRequestToolResources? = nil, @metadata : Object? = nil)
    end
