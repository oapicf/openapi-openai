...
module OpenAPIClient
  ...
  class PredictionContent
    ...
    @[JSON::Field(key: "content", type: PredictionContentContent, nillable: false, emit_null: false)]
    property content : PredictionContentContent
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["content"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @content : PredictionContentContent)
    end
