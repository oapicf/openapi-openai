...
module OpenAPIClient
  ...
  class Project
    ...
    @[JSON::Field(key: "archived_at", type: Int32?, nillable: true, emit_null: false)]
    property archived_at : Int32?
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["organization.project"].map { |value| to(String, value)}
      end
    end
    ...
    class EnumAttributeValidatorForStatus < EnumAttributeValidator
      ...
      def initialize
        @attribute = "status"
        @allowable_values = ["active", "archived"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @object : String, @name : String, @created_at : Int32, @status : String, @archived_at : Int32? = nil)
    end
    ...
    def to_h
      ...
      hash["archived_at"] = _to_h(archived_at)
