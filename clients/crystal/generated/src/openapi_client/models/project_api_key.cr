...
module OpenAPIClient
  ...
  class ProjectApiKey
    ...
    @[JSON::Field(key: "redacted_value", type: String, nillable: false, emit_null: false)]
    property redacted_value : String
    ...
    @[JSON::Field(key: "owner", type: ProjectApiKeyOwner, nillable: false, emit_null: false)]
    property owner : ProjectApiKeyOwner
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["organization.project.api_key"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@object : String, @redacted_value : String, @name : String, @created_at : Int32, @id : String, @owner : ProjectApiKeyOwner)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          object == other.object &&
          redacted_value == other.redacted_value &&
          name == other.name &&
    ...
    def to_h
      ...
      hash["redacted_value"] = _to_h(redacted_value)
