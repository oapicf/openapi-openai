...
module OpenAPIClient
  class ProjectApiKeyOwner
    ...
    @[JSON::Field(key: "user", type: ProjectUser?, nillable: true, emit_null: false)]
    property user : ProjectUser?

    @[JSON::Field(key: "service_account", type: ProjectServiceAccount?, nillable: true, emit_null: false)]
    property service_account : ProjectServiceAccount?
    ...
    def initialize(@_type : String? = nil, @user : ProjectUser? = nil, @service_account : ProjectServiceAccount? = nil)
    end
    ...
    def hash
      [_type, user, service_account].hash
    end
