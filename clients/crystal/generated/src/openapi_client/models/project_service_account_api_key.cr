...
module OpenAPIClient
  class ProjectServiceAccountApiKey
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["organization.project.service_account.api_key"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@object : String, @value : String, @name : String, @created_at : Int32, @id : String)
    end
