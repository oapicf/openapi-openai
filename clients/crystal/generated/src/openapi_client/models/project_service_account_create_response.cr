...
module OpenAPIClient
  class ProjectServiceAccountCreateResponse
    ...
    @[JSON::Field(key: "api_key", type: ProjectServiceAccountApiKey, nillable: false, emit_null: false)]
    property api_key : ProjectServiceAccountApiKey
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["organization.project.service_account"].map { |value| to(String, value)}
      end
    end
    ...
    class EnumAttributeValidatorForRole < EnumAttributeValidator
      ...
      def initialize
        @attribute = "role"
        @allowable_values = ["member"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@object : String, @id : String, @name : String, @role : String, @created_at : Int32, @api_key : ProjectServiceAccountApiKey)
    end
