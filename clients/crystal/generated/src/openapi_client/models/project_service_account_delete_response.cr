...
module OpenAPIClient
  class ProjectServiceAccountDeleteResponse
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["organization.project.service_account.deleted"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@object : String, @id : String, @deleted : Bool)
    end
