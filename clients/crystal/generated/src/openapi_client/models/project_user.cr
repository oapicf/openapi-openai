...
module OpenAPIClient
  ...
  class ProjectUser
    ...
    @[JSON::Field(key: "added_at", type: Int32, nillable: false, emit_null: false)]
    property added_at : Int32
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["organization.project.user"].map { |value| to(String, value)}
      end
    end
    ...
    class EnumAttributeValidatorForRole < EnumAttributeValidator
      ...
      def initialize
        @attribute = "role"
        @allowable_values = ["owner", "member"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@object : String, @id : String, @name : String, @email : String, @role : String, @added_at : Int32)
    end
