...
module OpenAPIClient
  ...
  class RealtimeClientEventConversationItemCreate
    ...
    @[JSON::Field(key: "item", type: RealtimeConversationItem, nillable: false, emit_null: false)]
    property item : RealtimeConversationItem
    ...
    @[JSON::Field(key: "previous_item_id", type: String?, nillable: true, emit_null: false)]
    property previous_item_id : String?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["conversation.item.create"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @item : RealtimeConversationItem, @event_id : String? = nil, @previous_item_id : String? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          _type == other._type &&
          previous_item_id == other.previous_item_id &&
          item == other.item
    end
    ...
    def hash
      [event_id, _type, previous_item_id, item].hash
    end
    ...
    def to_h
      ...
      hash["previous_item_id"] = _to_h(previous_item_id)
