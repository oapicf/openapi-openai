...
module OpenAPIClient
  ...
  class RealtimeClientEventConversationItemDelete
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["conversation.item.delete"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @item_id : String, @event_id : String? = nil)
    end
