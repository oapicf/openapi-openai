...
module OpenAPIClient
  ...
  class RealtimeClientEventInputAudioBufferAppend
    ...
    @[JSON::Field(key: "audio", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["input_audio_buffer.append"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @audio : String, @event_id : String? = nil)
    end
