...
module OpenAPIClient
  ...
  class RealtimeClientEventResponseCancel
    ...
    @[JSON::Field(key: "response_id", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["response.cancel"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @event_id : String? = nil, @response_id : String? = nil)
    end
    ...
    def hash
      [event_id, _type, response_id].hash
    end
