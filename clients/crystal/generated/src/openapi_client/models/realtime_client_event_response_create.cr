...
module OpenAPIClient
  ...
  class RealtimeClientEventResponseCreate
    ...
    @[JSON::Field(key: "response", type: RealtimeResponseCreateParams?, nillable: true, emit_null: false)]
    property response : RealtimeResponseCreateParams?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["response.create"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @event_id : String? = nil, @response : RealtimeResponseCreateParams? = nil)
    end
