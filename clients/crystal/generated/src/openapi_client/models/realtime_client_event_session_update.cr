...
module OpenAPIClient
  ...
  class RealtimeClientEventSessionUpdate
    ...
    @[JSON::Field(key: "session", type: RealtimeSessionCreateRequest, nillable: false, emit_null: false)]
    property session : RealtimeSessionCreateRequest
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["session.update"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @session : RealtimeSessionCreateRequest, @event_id : String? = nil)
    end
