...
module OpenAPIClient
  class RealtimeConversationItemContentInner
    ...
    @[JSON::Field(key: "audio", type: String?, nillable: true, emit_null: false)]
    property audio : String?

    # The transcript of the audio, used for `input_audio` content type. 
    @[JSON::Field(key: "transcript", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["input_audio", "input_text", "item_reference", "text"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String? = nil, @text : String? = nil, @id : String? = nil, @audio : String? = nil, @transcript : String? = nil)
    end
    ...
    def hash
      [_type, text, id, audio, transcript].hash
    end
