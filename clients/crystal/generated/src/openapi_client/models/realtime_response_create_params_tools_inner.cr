...
module OpenAPIClient
  class RealtimeResponseCreateParamsToolsInner
    ...
    @[JSON::Field(key: "parameters", type: Object?, nillable: true, emit_null: false)]
    ...
    def initialize(@_type : String? = nil, @name : String? = nil, @description : String? = nil, @parameters : Object? = nil)
    end
    ...
    def hash
      [_type, name, description, parameters].hash
    end
