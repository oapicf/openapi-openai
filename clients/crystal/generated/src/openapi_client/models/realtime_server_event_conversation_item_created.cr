...
module OpenAPIClient
  ...
  class RealtimeServerEventConversationItemCreated
    ...
    @[JSON::Field(key: "previous_item_id", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["conversation.item.created"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @previous_item_id : String, @item : RealtimeConversationItem)
    end
