...
module OpenAPIClient
  ...
  class RealtimeServerEventConversationItemInputAudioTranscriptionCompleted
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["conversation.item.input_audio_transcription.completed"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @item_id : String, @content_index : Int32, @transcript : String)
    end
    ...
    def hash
      [event_id, _type, item_id, content_index, transcript].hash
    end
