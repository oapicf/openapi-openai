...
module OpenAPIClient
  ...
  class RealtimeServerEventConversationItemTruncated
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["conversation.item.truncated"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @item_id : String, @content_index : Int32, @audio_end_ms : Int32)
    end
