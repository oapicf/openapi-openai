...
module OpenAPIClient
  ...
  class RealtimeServerEventError
    ...
    @[JSON::Field(key: "error", type: RealtimeServerEventErrorError, nillable: false, emit_null: false)]
    property error : RealtimeServerEventErrorError
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["error"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @error : RealtimeServerEventErrorError)
    end
