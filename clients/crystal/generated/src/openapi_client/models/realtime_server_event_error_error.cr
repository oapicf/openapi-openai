...
module OpenAPIClient
  ...
  class RealtimeServerEventErrorError
    ...
    def initialize(@_type : String, @message : String, @code : String? = nil, @param : String? = nil, @event_id : String? = nil)
    end
    ...
    def hash
      [_type, code, message, param, event_id].hash
    end
