...
module OpenAPIClient
  ...
  class RealtimeServerEventInputAudioBufferCommitted
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["input_audio_buffer.committed"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @previous_item_id : String, @item_id : String)
    end
    ...
    def hash
      [event_id, _type, previous_item_id, item_id].hash
    end
