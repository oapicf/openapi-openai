...
module OpenAPIClient
  ...
  class RealtimeServerEventInputAudioBufferSpeechStarted
    ...
    @[JSON::Field(key: "audio_start_ms", type: Int32, nillable: false, emit_null: false)]
    property audio_start_ms : Int32
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["input_audio_buffer.speech_started"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @audio_start_ms : Int32, @item_id : String)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          _type == other._type &&
          audio_start_ms == other.audio_start_ms &&
    ...
    def hash
      [event_id, _type, audio_start_ms, item_id].hash
    end
    ...
    def to_h
      ...
      hash["audio_start_ms"] = _to_h(audio_start_ms)
