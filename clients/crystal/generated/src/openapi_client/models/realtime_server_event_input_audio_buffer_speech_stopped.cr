...
module OpenAPIClient
  ...
  class RealtimeServerEventInputAudioBufferSpeechStopped
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["input_audio_buffer.speech_stopped"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @audio_end_ms : Int32, @item_id : String)
    end
    ...
    def hash
      [event_id, _type, audio_end_ms, item_id].hash
    end
