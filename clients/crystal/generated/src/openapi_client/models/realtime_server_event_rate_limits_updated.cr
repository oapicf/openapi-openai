...
module OpenAPIClient
  ...
  class RealtimeServerEventRateLimitsUpdated
    ...
    @[JSON::Field(key: "rate_limits", type: Array(RealtimeServerEventRateLimitsUpdatedRateLimitsInner), nillable: false, emit_null: false)]
    property rate_limits : Array(RealtimeServerEventRateLimitsUpdatedRateLimitsInner)
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["rate_limits.updated"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @rate_limits : Array(RealtimeServerEventRateLimitsUpdatedRateLimitsInner))
    end
    ...
    def hash
      [event_id, _type, rate_limits].hash
    end
    ...
    def to_h
      ...
      hash["rate_limits"] = _to_h(rate_limits)
      hash.to_h
    end
