...
module OpenAPIClient
  class RealtimeServerEventRateLimitsUpdatedRateLimitsInner
    ...
    @[JSON::Field(key: "limit", type: Int32?, nillable: true, emit_null: false)]
    property limit : Int32?

    # The remaining value before the limit is reached.
    @[JSON::Field(key: "remaining", type: Int32?, nillable: true, emit_null: false)]
    property remaining : Int32?

    # Seconds until the rate limit resets.
    @[JSON::Field(key: "reset_seconds", type: Float64?, nillable: true, emit_null: false)]
    property reset_seconds : Float64?
    ...
    class EnumAttributeValidatorForName < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "name"
        @allowable_values = ["requests", "tokens"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@name : String? = nil, @limit : Int32? = nil, @remaining : Int32? = nil, @reset_seconds : Float64? = nil)
    end
    ...
    def list_invalid_properties
      ...
      name_validator = EnumAttributeValidatorForName.new
      if !name_validator.valid?(@name)
    ...
    def name=(name)
      validator = EnumAttributeValidatorForName.new
    ...
    def to_h
      ...
      hash["remaining"] = _to_h(remaining)
      hash["reset_seconds"] = _to_h(reset_seconds)
      hash.to_h
    end
