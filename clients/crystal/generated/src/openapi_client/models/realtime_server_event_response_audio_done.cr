...
module OpenAPIClient
  ...
  class RealtimeServerEventResponseAudioDone
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["response.audio.done"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @response_id : String, @item_id : String, @output_index : Int32, @content_index : Int32)
    end
    ...
    def hash
      [event_id, _type, response_id, item_id, output_index, content_index].hash
    end
