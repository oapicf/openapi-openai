...
module OpenAPIClient
  ...
  class RealtimeServerEventResponseAudioTranscriptDelta
    ...
    @[JSON::Field(key: "delta", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["response.audio_transcript.delta"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @response_id : String, @item_id : String, @output_index : Int32, @content_index : Int32, @delta : String)
    end
    ...
    def hash
      [event_id, _type, response_id, item_id, output_index, content_index, delta].hash
    end
