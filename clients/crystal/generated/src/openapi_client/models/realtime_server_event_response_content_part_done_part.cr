...
module OpenAPIClient
  ...
  class RealtimeServerEventResponseContentPartDonePart
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["audio", "text"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String? = nil, @text : String? = nil, @audio : String? = nil, @transcript : String? = nil)
    end
    ...
    def hash
      [_type, text, audio, transcript].hash
    end
