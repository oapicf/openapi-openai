...
module OpenAPIClient
  ...
  class RealtimeServerEventResponseCreated
    ...
    @[JSON::Field(key: "response", type: RealtimeResponse, nillable: false, emit_null: false)]
    property response : RealtimeResponse
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["response.created"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @response : RealtimeResponse)
    end
