...
module OpenAPIClient
  ...
  class RealtimeServerEventResponseFunctionCallArgumentsDelta
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["response.function_call_arguments.delta"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @response_id : String, @item_id : String, @output_index : Int32, @call_id : String, @delta : String)
    end
    ...
    def hash
      [event_id, _type, response_id, item_id, output_index, call_id, delta].hash
    end
