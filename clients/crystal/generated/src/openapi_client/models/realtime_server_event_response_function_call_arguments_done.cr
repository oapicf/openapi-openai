...
module OpenAPIClient
  ...
  class RealtimeServerEventResponseFunctionCallArgumentsDone
    ...
    @[JSON::Field(key: "call_id", type: String, nillable: false, emit_null: false)]
    property call_id : String

    # The final arguments as a JSON string.
    @[JSON::Field(key: "arguments", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["response.function_call_arguments.done"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @response_id : String, @item_id : String, @output_index : Int32, @call_id : String, @arguments : String)
    end
    ...
    def hash
      [event_id, _type, response_id, item_id, output_index, call_id, arguments].hash
    end
