...
module OpenAPIClient
  ...
  class RealtimeServerEventResponseOutputItemAdded
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["response.output_item.added"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @response_id : String, @output_index : Int32, @item : RealtimeConversationItem)
    end
    ...
    def hash
      [event_id, _type, response_id, output_index, item].hash
    end
