...
module OpenAPIClient
  ...
  class RealtimeServerEventSessionUpdated
    ...
    @[JSON::Field(key: "session", type: RealtimeSession, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["session.updated"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event_id : String, @_type : String, @session : RealtimeSession)
    end
