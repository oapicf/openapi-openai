...
module OpenAPIClient
  class ResponseFormatJsonSchema
    ...
    @[JSON::Field(key: "json_schema", type: ResponseFormatJsonSchemaJsonSchema, nillable: false, emit_null: false)]
    property json_schema : ResponseFormatJsonSchemaJsonSchema
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["json_schema"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @json_schema : ResponseFormatJsonSchemaJsonSchema)
    end
    ...
    def to_h
      ...
      hash["json_schema"] = _to_h(json_schema)
      hash.to_h
    end
