...
module OpenAPIClient
  class ResponseFormatJsonSchemaJsonSchema
    ...
    @[JSON::Field(key: "schema", type: Hash(String, Object)?, nillable: true, emit_null: false)]
    property schema : Hash(String, Object)?
    ...
    @[JSON::Field(key: "strict", type: Bool?, default: false, nillable: true, emit_null: false)]
    property strict : Bool?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@name : String, @description : String? = nil, @schema : Hash(String, Object)? = nil, @strict : Bool? = nil)
    end
