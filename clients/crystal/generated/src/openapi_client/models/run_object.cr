...
module OpenAPIClient
  ...
  class RunObject
    ...
    @[JSON::Field(key: "parallel_tool_calls", type: Bool, default: true, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "top_p", type: Float64?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForStatus < EnumAttributeValidator
      ...
      def initialize
        @attribute = "status"
        @allowable_values = ["queued", "in_progress", "requires_action", "cancelling", "cancelled", "failed", "completed", "incomplete", "expired"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @object : String, @created_at : Int32, @thread_id : String, @assistant_id : String, @status : String, @required_action : RunObjectRequiredAction, @last_error : RunObjectLastError, @expires_at : Int32, @started_at : Int32, @cancelled_at : Int32, @failed_at : Int32, @completed_at : Int32, @incomplete_details : RunObjectIncompleteDetails, @model : String, @instructions : String, @tools : Array(AssistantObjectToolsInner), @metadata : Object, @usage : RunCompletionUsage, @max_prompt_tokens : Int32, @max_completion_tokens : Int32, @truncation_strategy : TruncationObject, @tool_choice : AssistantsApiToolChoiceOption, @parallel_tool_calls : Bool, @response_format : AssistantsApiResponseFormatOption, @temperature : Float64? = nil, @top_p : Float64? = nil)
    end
