...
module OpenAPIClient
  ...
  class RunObjectLastError
    ...
    class EnumAttributeValidatorForCode < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "code"
        @allowable_values = ["server_error", "rate_limit_exceeded", "invalid_prompt"].map { |value| to(String, value)}
      end
    end
    ...
    def list_invalid_properties
      ...
      code_validator = EnumAttributeValidatorForCode.new
      if !code_validator.valid?(@code)
        message = code_validator.message
    ...
    def code=(code)
      validator = EnumAttributeValidatorForCode.new
