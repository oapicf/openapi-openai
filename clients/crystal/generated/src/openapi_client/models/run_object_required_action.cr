...
module OpenAPIClient
  ...
  class RunObjectRequiredAction
    ...
    @[JSON::Field(key: "submit_tool_outputs", type: RunObjectRequiredActionSubmitToolOutputs, nillable: false, emit_null: false)]
    property submit_tool_outputs : RunObjectRequiredActionSubmitToolOutputs
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["submit_tool_outputs"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @submit_tool_outputs : RunObjectRequiredActionSubmitToolOutputs)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          _type == other._type &&
          submit_tool_outputs == other.submit_tool_outputs
    end
    ...
    def hash
      [_type, submit_tool_outputs].hash
    end
    ...
    def to_h
      ...
      hash["submit_tool_outputs"] = _to_h(submit_tool_outputs)
      hash.to_h
    end
