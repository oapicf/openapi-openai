...
module OpenAPIClient
  ...
  class RunObjectRequiredActionSubmitToolOutputs
    ...
    @[JSON::Field(key: "tool_calls", type: Array(RunToolCallObject), nillable: false, emit_null: false)]
    property tool_calls : Array(RunToolCallObject)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@tool_calls : Array(RunToolCallObject))
    end
