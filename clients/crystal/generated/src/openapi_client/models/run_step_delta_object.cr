...
module OpenAPIClient
  ...
  class RunStepDeltaObject
    ...
    @[JSON::Field(key: "delta", type: RunStepDeltaObjectDelta, nillable: false, emit_null: false)]
    property delta : RunStepDeltaObjectDelta
    ...
    def initialize(@id : String, @object : String, @delta : RunStepDeltaObjectDelta)
    end
