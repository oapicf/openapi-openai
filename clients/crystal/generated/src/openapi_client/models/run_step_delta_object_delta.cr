...
module OpenAPIClient
  ...
  class RunStepDeltaObjectDelta
    ...
    # Optional properties
    @[JSON::Field(key: "step_details", type: RunStepDeltaObjectDeltaStepDetails?, nillable: true, emit_null: false)]
    property step_details : RunStepDeltaObjectDeltaStepDetails?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@step_details : RunStepDeltaObjectDeltaStepDetails? = nil)
    end
