...
module OpenAPIClient
  ...
  class RunStepDeltaStepDetailsMessageCreationObject
    ...
    # Optional properties
    @[JSON::Field(key: "message_creation", type: RunStepDeltaStepDetailsMessageCreationObjectMessageCreation?, nillable: true, emit_null: false)]
    property message_creation : RunStepDeltaStepDetailsMessageCreationObjectMessageCreation?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["message_creation"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @message_creation : RunStepDeltaStepDetailsMessageCreationObjectMessageCreation? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          _type == other._type &&
          message_creation == other.message_creation
    end
    ...
    def to_h
      ...
      hash["message_creation"] = _to_h(message_creation)
      hash.to_h
    end
