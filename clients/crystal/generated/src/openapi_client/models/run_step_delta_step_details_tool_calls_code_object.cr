...
module OpenAPIClient
  ...
  class RunStepDeltaStepDetailsToolCallsCodeObject
    ...
    def initialize(@index : Int32, @_type : String, @id : String?, @code_interpreter : RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter?)
    end
    ...
    def valid?
      _type_validator = EnumAttributeValidator.new("String", ["code_interpreter"])
