...
module OpenAPIClient
  ...
  class RunStepDeltaStepDetailsToolCallsCodeObject
    ...
    @[JSON::Field(key: "code_interpreter", type: RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter?, nillable: true, emit_null: false)]
    property code_interpreter : RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["code_interpreter"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @_type : String, @id : String? = nil, @code_interpreter : RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          id == other.id &&
          _type == other._type &&
          code_interpreter == other.code_interpreter
    end
    ...
    def hash
      [index, id, _type, code_interpreter].hash
    end
    ...
    def to_h
      ...
      hash["code_interpreter"] = _to_h(code_interpreter)
      hash.to_h
    end
