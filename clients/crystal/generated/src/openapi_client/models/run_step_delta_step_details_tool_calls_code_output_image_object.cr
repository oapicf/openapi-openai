...
module OpenAPIClient
  class RunStepDeltaStepDetailsToolCallsCodeOutputImageObject
    ...
    def initialize(@index : Int32, @_type : String, @image : RunStepDeltaStepDetailsToolCallsCodeOutputImageObjectImage?)
    end
    ...
    def valid?
      _type_validator = EnumAttributeValidator.new("String", ["image"])
