...
module OpenAPIClient
  class RunStepDeltaStepDetailsToolCallsCodeOutputImageObject
    ...
    # Optional properties
    @[JSON::Field(key: "image", type: RunStepDeltaStepDetailsToolCallsCodeOutputImageObjectImage?, nillable: true, emit_null: false)]
    property image : RunStepDeltaStepDetailsToolCallsCodeOutputImageObjectImage?
    ...
    def initialize(@index : Int32, @_type : String, @image : RunStepDeltaStepDetailsToolCallsCodeOutputImageObjectImage? = nil)
    end
