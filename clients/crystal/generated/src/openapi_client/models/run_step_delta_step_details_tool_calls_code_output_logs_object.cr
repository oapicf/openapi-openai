...
module OpenAPIClient
  ...
  class RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject
    ...
    @[JSON::Field(key: "logs", type: String?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["logs"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @_type : String, @logs : String? = nil)
    end
