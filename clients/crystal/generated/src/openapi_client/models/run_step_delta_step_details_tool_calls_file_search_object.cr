...
module OpenAPIClient
  class RunStepDeltaStepDetailsToolCallsFileSearchObject
    ...
    @[JSON::Field(key: "file_search", type: Object, nillable: false, emit_null: false)]
    property file_search : Object
    ...
    def initialize(@index : Int32, @_type : String, @file_search : Object, @id : String? = nil)
    end
    ...
    def hash
      [index, id, _type, file_search].hash
    end
