...
module OpenAPIClient
  class RunStepDeltaStepDetailsToolCallsFunctionObject
    ...
    @[JSON::Field(key: "function", type: RunStepDeltaStepDetailsToolCallsFunctionObjectFunction?, nillable: true, emit_null: false)]
    property function : RunStepDeltaStepDetailsToolCallsFunctionObjectFunction?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["function"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @_type : String, @id : String? = nil, @function : RunStepDeltaStepDetailsToolCallsFunctionObjectFunction? = nil)
    end
