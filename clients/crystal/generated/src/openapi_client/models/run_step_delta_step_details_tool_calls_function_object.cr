...
module OpenAPIClient
  class RunStepDeltaStepDetailsToolCallsFunctionObject
    ...
    def initialize(@index : Int32, @_type : String, @id : String?, @function : RunStepDeltaStepDetailsToolCallsFunctionObjectFunction?)
    end
    ...
    def valid?
      _type_validator = EnumAttributeValidator.new("String", ["function"])
