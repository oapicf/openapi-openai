...
module OpenAPIClient
  ...
  class RunStepDeltaStepDetailsToolCallsObject
    ...
    @[JSON::Field(key: "tool_calls", type: Array(RunStepDeltaStepDetailsToolCallsObjectToolCallsInner)?, nillable: true, emit_null: false)]
    property tool_calls : Array(RunStepDeltaStepDetailsToolCallsObjectToolCallsInner)?
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["tool_calls"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @tool_calls : Array(RunStepDeltaStepDetailsToolCallsObjectToolCallsInner)? = nil)
    end
