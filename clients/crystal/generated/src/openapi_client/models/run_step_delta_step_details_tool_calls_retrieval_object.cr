...
module OpenAPIClient
  class RunStepDeltaStepDetailsToolCallsRetrievalObject
    ...
    @[JSON::Field(key: "retrieval", type: Object?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["retrieval"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@index : Int32, @_type : String, @id : String? = nil, @retrieval : Object? = nil)
    end
    ...
    def to_h
      ...
      hash["retrieval"] = _to_h(retrieval)
      hash.to_h
    end
