...
module OpenAPIClient
  ...
  class RunStepDetailsMessageCreationObject
    ...
    @[JSON::Field(key: "message_creation", type: RunStepDetailsMessageCreationObjectMessageCreation, nillable: false, emit_null: false)]
    property message_creation : RunStepDetailsMessageCreationObjectMessageCreation
    ...
    def initialize(@_type : String, @message_creation : RunStepDetailsMessageCreationObjectMessageCreation)
    end
