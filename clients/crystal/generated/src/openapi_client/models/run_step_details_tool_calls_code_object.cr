...
module OpenAPIClient
  ...
  class RunStepDetailsToolCallsCodeObject
    ...
    @[JSON::Field(key: "code_interpreter", type: RunStepDetailsToolCallsCodeObjectCodeInterpreter, nillable: false, emit_null: false)]
    property code_interpreter : RunStepDetailsToolCallsCodeObjectCodeInterpreter
    ...
    def initialize(@id : String, @_type : String, @code_interpreter : RunStepDetailsToolCallsCodeObjectCodeInterpreter)
    end
    ...
    def hash
      [id, _type, code_interpreter].hash
    end
