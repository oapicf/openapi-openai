...
module OpenAPIClient
  class RunStepDetailsToolCallsCodeOutputImageObject
    ...
    @[JSON::Field(key: "image", type: RunStepDetailsToolCallsCodeOutputImageObjectImage, nillable: false, emit_null: false)]
    property image : RunStepDetailsToolCallsCodeOutputImageObjectImage
    ...
    def initialize(@_type : String, @image : RunStepDetailsToolCallsCodeOutputImageObjectImage)
    end
