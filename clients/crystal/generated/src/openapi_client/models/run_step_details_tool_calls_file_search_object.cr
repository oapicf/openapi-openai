...
module OpenAPIClient
  class RunStepDetailsToolCallsFileSearchObject
    ...
    @[JSON::Field(key: "file_search", type: RunStepDetailsToolCallsFileSearchObjectFileSearch, nillable: false, emit_null: false)]
    property file_search : RunStepDetailsToolCallsFileSearchObjectFileSearch
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["file_search"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @_type : String, @file_search : RunStepDetailsToolCallsFileSearchObjectFileSearch)
    end
