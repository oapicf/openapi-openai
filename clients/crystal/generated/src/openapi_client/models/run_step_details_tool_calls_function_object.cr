...
module OpenAPIClient
  class RunStepDetailsToolCallsFunctionObject
    ...
    @[JSON::Field(key: "function", type: RunStepDetailsToolCallsFunctionObjectFunction, nillable: false, emit_null: false)]
    property function : RunStepDetailsToolCallsFunctionObjectFunction
    ...
    def initialize(@id : String, @_type : String, @function : RunStepDetailsToolCallsFunctionObjectFunction)
    end
