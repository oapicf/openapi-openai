...
module OpenAPIClient
  ...
  class RunStepDetailsToolCallsObject
    ...
    @[JSON::Field(key: "tool_calls", type: Array(RunStepDetailsToolCallsObjectToolCallsInner), nillable: false, emit_null: false)]
    property tool_calls : Array(RunStepDetailsToolCallsObjectToolCallsInner)
    ...
    def initialize(@_type : String, @tool_calls : Array(RunStepDetailsToolCallsObjectToolCallsInner))
    end
