...
module OpenAPIClient
  ...
  class RunStepObject
    ...
    @[JSON::Field(key: "step_details", type: RunStepObjectStepDetails, nillable: false, emit_null: false)]
    property step_details : RunStepObjectStepDetails

    @[JSON::Field(key: "last_error", type: RunStepObjectLastError, nillable: false, emit_null: false)]
    property last_error : RunStepObjectLastError

    # The Unix timestamp (in seconds) for when the run step expired. A step is considered expired if the parent run is expired.
    @[JSON::Field(key: "expired_at", type: Int32, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "usage", type: RunStepCompletionUsage, nillable: false, emit_null: false)]
    property usage : RunStepCompletionUsage
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["thread.run.step"].map { |value| to(String, value)}
      end
    end
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["message_creation", "tool_calls"].map { |value| to(String, value)}
      end
    end
    ...
    class EnumAttributeValidatorForStatus < EnumAttributeValidator
      ...
      def initialize
        @attribute = "status"
        @allowable_values = ["in_progress", "cancelled", "failed", "completed", "expired"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @object : String, @created_at : Int32, @assistant_id : String, @thread_id : String, @run_id : String, @_type : String, @status : String, @step_details : RunStepObjectStepDetails, @last_error : RunStepObjectLastError, @expired_at : Int32, @cancelled_at : Int32, @failed_at : Int32, @completed_at : Int32, @metadata : Object, @usage : RunStepCompletionUsage)
    end
    ...
    def hash
      [id, object, created_at, assistant_id, thread_id, run_id, _type, status, step_details, last_error, expired_at, cancelled_at, failed_at, completed_at, metadata, usage].hash
    end
    ...
    def to_h
      ...
      hash["step_details"] = _to_h(step_details)
