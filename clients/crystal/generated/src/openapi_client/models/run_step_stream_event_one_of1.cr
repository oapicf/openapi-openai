...
module OpenAPIClient
  ...
  class RunStepStreamEventOneOf1
    ...
    @[JSON::Field(key: "data", type: RunStepObject, nillable: false, emit_null: false)]
    property data : RunStepObject
    ...
    class EnumAttributeValidatorForEvent < EnumAttributeValidator
      ...
      def initialize
        @attribute = "event"
        @allowable_values = ["thread.run.step.in_progress"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event : String, @data : RunStepObject)
    end
