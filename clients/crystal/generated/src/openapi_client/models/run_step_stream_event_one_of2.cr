...
module OpenAPIClient
  ...
  class RunStepStreamEventOneOf2
    ...
    @[JSON::Field(key: "data", type: RunStepDeltaObject, nillable: false, emit_null: false)]
    property data : RunStepDeltaObject
    ...
    class EnumAttributeValidatorForEvent < EnumAttributeValidator
      ...
      def initialize
        @attribute = "event"
        @allowable_values = ["thread.run.step.delta"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event : String, @data : RunStepDeltaObject)
    end
