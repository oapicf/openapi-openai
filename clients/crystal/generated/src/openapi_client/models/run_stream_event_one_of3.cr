...
module OpenAPIClient
  ...
  class RunStreamEventOneOf3
    ...
    @[JSON::Field(key: "data", type: RunObject, nillable: false, emit_null: false)]
    property data : RunObject
    ...
    class EnumAttributeValidatorForEvent < EnumAttributeValidator
      ...
      def initialize
        @attribute = "event"
        @allowable_values = ["thread.run.requires_action"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event : String, @data : RunObject)
    end
