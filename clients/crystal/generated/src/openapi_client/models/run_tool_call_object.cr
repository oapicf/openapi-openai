...
module OpenAPIClient
  ...
  class RunToolCallObject
    ...
    @[JSON::Field(key: "function", type: RunToolCallObjectFunction, nillable: false, emit_null: false)]
    property function : RunToolCallObjectFunction
    ...
    def initialize(@id : String, @_type : String, @function : RunToolCallObjectFunction)
    end
