...
module OpenAPIClient
  class StaticChunkingStrategy
    ...
    @[JSON::Field(key: "static", type: StaticChunkingStrategyStatic, nillable: false, emit_null: false)]
    property static : StaticChunkingStrategyStatic
    ...
    class EnumAttributeValidatorFor_type < EnumAttributeValidator
      ...
      def initialize
        @attribute = "_type"
        @allowable_values = ["static"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@_type : String, @static : StaticChunkingStrategyStatic)
    end
