...
module OpenAPIClient
  class StaticChunkingStrategyResponseParam
    ...
    @[JSON::Field(key: "static", type: StaticChunkingStrategy, nillable: false, emit_null: false)]
    property static : StaticChunkingStrategy
    ...
    def initialize(@_type : String, @static : StaticChunkingStrategy)
    end
