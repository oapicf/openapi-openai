...
module OpenAPIClient
  class SubmitToolOutputsRunRequest
    ...
    @[JSON::Field(key: "tool_outputs", type: Array(SubmitToolOutputsRunRequestToolOutputsInner), nillable: false, emit_null: false)]
    property tool_outputs : Array(SubmitToolOutputsRunRequestToolOutputsInner)
    ...
    def initialize(@tool_outputs : Array(SubmitToolOutputsRunRequestToolOutputsInner), @stream : Bool? = nil)
    end
    ...
    def to_h
      ...
      hash["tool_outputs"] = _to_h(tool_outputs)
