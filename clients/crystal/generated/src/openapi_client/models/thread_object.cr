...
module OpenAPIClient
  ...
  class ThreadObject
    ...
    @[JSON::Field(key: "tool_resources", type: ModifyThreadRequestToolResources, nillable: false, emit_null: false)]
    property tool_resources : ModifyThreadRequestToolResources
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["thread"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @object : String, @created_at : Int32, @tool_resources : ModifyThreadRequestToolResources, @metadata : Object)
    end
