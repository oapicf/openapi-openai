...
module OpenAPIClient
  ...
  class ThreadStreamEvent
    ...
    @[JSON::Field(key: "data", type: ThreadObject, nillable: false, emit_null: false)]
    property data : ThreadObject
    ...
    class EnumAttributeValidatorForEvent < EnumAttributeValidator
      ...
      def initialize
        @attribute = "event"
        @allowable_values = ["thread.created"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@event : String, @data : ThreadObject, @enabled : Bool? = nil)
    end
