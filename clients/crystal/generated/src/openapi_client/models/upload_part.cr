...
module OpenAPIClient
  ...
  class UploadPart
    ...
    @[JSON::Field(key: "upload_id", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["upload.part"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @created_at : Int32, @upload_id : String, @object : String)
    end
    ...
    def to_h
      ...
      hash["upload_id"] = _to_h(upload_id)
