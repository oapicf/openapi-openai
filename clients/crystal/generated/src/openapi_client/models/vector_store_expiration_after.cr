...
module OpenAPIClient
  ...
  class VectorStoreExpirationAfter
    ...
    @[JSON::Field(key: "anchor", type: String, nillable: false, emit_null: false)]
    property anchor : String

    # The number of days after the anchor time that the vector store will expire.
    @[JSON::Field(key: "days", type: Int32, nillable: false, emit_null: false)]
    property days : Int32
    ...
    class EnumAttributeValidatorForAnchor < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "anchor"
        @allowable_values = ["last_active_at"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@anchor : String, @days : Int32)
    end
    ...
    def list_invalid_properties
      ...
      anchor_validator = EnumAttributeValidatorForAnchor.new
      if !anchor_validator.valid?(@anchor)
        message = anchor_validator.message
    ...
    def valid?
      ...
      return false if @days.try &.> 365
      return false if @days.try &.< 1
      true
    end
    ...
    def anchor=(anchor)
      validator = EnumAttributeValidatorForAnchor.new
    ...
    def days=(days)
      if days > 365
        raise ArgumentError.new("invalid value for \"days\", must be smaller than or equal to 365.")
      end

      if days < 1
        raise ArgumentError.new("invalid value for \"days\", must be greater than or equal to 1.")
      end
    ...
    def to_h
      ...
      hash["anchor"] = _to_h(anchor)
      hash["days"] = _to_h(days)
      hash.to_h
    end
