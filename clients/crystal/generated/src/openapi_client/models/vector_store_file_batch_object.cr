...
module OpenAPIClient
  ...
  class VectorStoreFileBatchObject
    ...
    @[JSON::Field(key: "file_counts", type: VectorStoreFileBatchObjectFileCounts, nillable: false, emit_null: false)]
    property file_counts : VectorStoreFileBatchObjectFileCounts
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["vector_store.files_batch"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @object : String, @created_at : Int32, @vector_store_id : String, @status : String, @file_counts : VectorStoreFileBatchObjectFileCounts)
    end
