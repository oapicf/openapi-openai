...
module OpenAPIClient
  ...
  class VectorStoreObject
    ...
    @[JSON::Field(key: "file_counts", type: VectorStoreObjectFileCounts, nillable: false, emit_null: false)]
    property file_counts : VectorStoreObjectFileCounts
    ...
    # Optional properties
    @[JSON::Field(key: "expires_after", type: VectorStoreExpirationAfter?, nillable: true, emit_null: false)]
    property expires_after : VectorStoreExpirationAfter?
    ...
    class EnumAttributeValidatorForObject < EnumAttributeValidator
      ...
      def initialize
        @attribute = "object"
        @allowable_values = ["vector_store"].map { |value| to(String, value)}
      end
    end
    ...
    class EnumAttributeValidatorForStatus < EnumAttributeValidator
      ...
      def initialize
        @attribute = "status"
        @allowable_values = ["expired", "in_progress", "completed"].map { |value| to(String, value)}
      end
    end
    ...
    def initialize(@id : String, @object : String, @created_at : Int32, @name : String, @usage_bytes : Int32, @file_counts : VectorStoreObjectFileCounts, @status : String, @last_active_at : Int32, @metadata : Object, @expires_after : VectorStoreExpirationAfter? = nil, @expires_at : Int32? = nil)
    end
    ...
    def to_h
      ...
      hash["file_counts"] = _to_h(file_counts)
      hash["status"] = _to_h(status)
      hash["expires_after"] = _to_h(expires_after)
      hash["expires_at"] = _to_h(expires_at)
      hash["last_active_at"] = _to_h(last_active_at)
