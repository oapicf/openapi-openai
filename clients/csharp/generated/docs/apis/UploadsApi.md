# Org.OpenAPITools.Api.UploadsApi
...
# **AddUploadPart**
> UploadPart AddUploadPart (string uploadId, System.IO.Stream data)
...
| **data** | **System.IO.Stream****System.IO.Stream** | The chunk of bytes for this Part.  |  |
...
# **CompleteUpload**
> Upload CompleteUpload (string uploadId, CompleteUploadRequest completeUploadRequest)
...
<a id="createupload"></a>
# **CreateUpload**
> Upload CreateUpload (CreateUploadRequest createUploadRequest)
