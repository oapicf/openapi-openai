# Org.OpenAPITools.Model.RealtimeSessionCreateResponseClientSecret
...
**ExpiresAt** | **int** | Timestamp for when the token expires. Currently, all tokens expire after one minute.  | [optional] 
