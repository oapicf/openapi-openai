...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IAssistantsApi : IApi
    {
        ...
        /// <param name="include">A list of additional fields to include in the response. Currently the only supported value is &#x60;step_details.tool_calls[*].file_search.results[*].content&#x60; to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information.  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateRunApiResponse"/>&gt;</returns>
        Task<ICreateRunApiResponse> CreateRunAsync(string threadId, CreateRunRequest createRunRequest, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateRunApiResponse"/>?&gt;</returns>
        Task<ICreateRunApiResponse?> CreateRunOrDefaultAsync(string threadId, CreateRunRequest createRunRequest, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        Task<IDeleteMessageApiResponse> DeleteMessageAsync(string threadId, string messageId, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IDeleteMessageApiResponse"/>?&gt;</returns>
        Task<IDeleteMessageApiResponse?> DeleteMessageOrDefaultAsync(string threadId, string messageId, System.Threading.CancellationToken cancellationToken = default);
        ...
        Task<IGetRunStepApiResponse> GetRunStepAsync(string threadId, string runId, string stepId, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetRunStepApiResponse"/>?&gt;</returns>
        Task<IGetRunStepApiResponse?> GetRunStepOrDefaultAsync(string threadId, string runId, string stepId, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        Task<IListRunStepsApiResponse> ListRunStepsAsync(string threadId, string runId, Option<int> limit = default, Option<string> order = default, Option<string> after = default, Option<string> before = default, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IListRunStepsApiResponse"/>?&gt;</returns>
        Task<IListRunStepsApiResponse?> ListRunStepsOrDefaultAsync(string threadId, string runId, Option<int> limit = default, Option<string> order = default, Option<string> after = default, Option<string> before = default, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IDeleteMessageApiResponse : Org.OpenAPITools.Client.IApiResponse, IOk<Org.OpenAPITools.Model.DeleteMessageResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public class AssistantsApiEvents
    {
        ...
        internal void ExecuteOnDeleteMessage(AssistantsApi.DeleteMessageApiResponse apiResponse)
        {
    ...
    public sealed partial class AssistantsApi : IAssistantsApi
    {
        ...
        partial void FormatCreateRun(ref string threadId, CreateRunRequest createRunRequest, Option<List<string>> include);
        ...
        /// <returns></returns>
        private void ValidateCreateRun(string threadId, CreateRunRequest createRunRequest, Option<List<string>> include)
        {
            if (threadId == null)
                throw new ArgumentNullException(nameof(threadId));
        ...
        /// <param name="createRunRequest"></param>
        /// <param name="include"></param>
        private void AfterCreateRunDefaultImplementation(ICreateRunApiResponse apiResponseLocalVar, string threadId, CreateRunRequest createRunRequest, Option<List<string>> include)
        {
            bool suppressDefaultLog = false;
            AfterCreateRun(ref suppressDefaultLog, apiResponseLocalVar, threadId, createRunRequest, include);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {2}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="createRunRequest"></param>
        /// <param name="include"></param>
        partial void AfterCreateRun(ref bool suppressDefaultLog, ICreateRunApiResponse apiResponseLocalVar, string threadId, CreateRunRequest createRunRequest, Option<List<string>> include);
        ...
        /// <param name="createRunRequest"></param>
        /// <param name="include"></param>
        private void OnErrorCreateRunDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string threadId, CreateRunRequest createRunRequest, Option<List<string>> include)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorCreateRun(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, threadId, createRunRequest, include);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="createRunRequest"></param>
        /// <param name="include"></param>
        partial void OnErrorCreateRun(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string threadId, CreateRunRequest createRunRequest, Option<List<string>> include);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateRunApiResponse"/>&gt;</returns>
        public async Task<ICreateRunApiResponse?> CreateRunOrDefaultAsync(string threadId, CreateRunRequest createRunRequest, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await CreateRunAsync(threadId, createRunRequest, include, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="ICreateRunApiResponse"/>&gt;</returns>
        public async Task<ICreateRunApiResponse> CreateRunAsync(string threadId, CreateRunRequest createRunRequest, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateCreateRun(threadId, createRunRequest, include);

                FormatCreateRun(ref threadId, createRunRequest, include);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterCreateRunDefaultImplementation(apiResponseLocalVar, threadId, createRunRequest, include);
            ...
            {
                OnErrorCreateRunDefaultImplementation(e, "/threads/{thread_id}/runs", uriBuilderLocalVar.Path, threadId, createRunRequest, include);
        ...
        partial void FormatDeleteMessage(ref string threadId, ref string messageId);
        ...
        /// <returns></returns>
        private void ValidateDeleteMessage(string threadId, string messageId)
        {
            if (threadId == null)
                throw new ArgumentNullException(nameof(threadId));
        ...
        /// <param name="threadId"></param>
        /// <param name="messageId"></param>
        private void AfterDeleteMessageDefaultImplementation(IDeleteMessageApiResponse apiResponseLocalVar, string threadId, string messageId)
        {
            bool suppressDefaultLog = false;
            AfterDeleteMessage(ref suppressDefaultLog, apiResponseLocalVar, threadId, messageId);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {2}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="threadId"></param>
        /// <param name="messageId"></param>
        partial void AfterDeleteMessage(ref bool suppressDefaultLog, IDeleteMessageApiResponse apiResponseLocalVar, string threadId, string messageId);
        ...
        /// <param name="threadId"></param>
        /// <param name="messageId"></param>
        private void OnErrorDeleteMessageDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string threadId, string messageId)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorDeleteMessage(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, threadId, messageId);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="threadId"></param>
        /// <param name="messageId"></param>
        partial void OnErrorDeleteMessage(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string threadId, string messageId);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IDeleteMessageApiResponse"/>&gt;</returns>
        public async Task<IDeleteMessageApiResponse?> DeleteMessageOrDefaultAsync(string threadId, string messageId, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await DeleteMessageAsync(threadId, messageId, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IDeleteMessageApiResponse"/>&gt;</returns>
        public async Task<IDeleteMessageApiResponse> DeleteMessageAsync(string threadId, string messageId, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateDeleteMessage(threadId, messageId);

                FormatDeleteMessage(ref threadId, ref messageId);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterDeleteMessageDefaultImplementation(apiResponseLocalVar, threadId, messageId);
            ...
            {
                OnErrorDeleteMessageDefaultImplementation(e, "/threads/{thread_id}/messages/{message_id}", uriBuilderLocalVar.Path, threadId, messageId);
        ...
        /// </summary>
        public partial class DeleteMessageApiResponse : Org.OpenAPITools.Client.ApiResponse, IDeleteMessageApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Org.OpenAPITools.Model.DeleteMessageResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Org.OpenAPITools.Model.DeleteMessageResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Org.OpenAPITools.Model.DeleteMessageResponse? result)
            {
                result = null;
        ...
        partial void FormatGetRunStep(ref string threadId, ref string runId, ref string stepId, Option<List<string>> include);
        ...
        /// <param name="include"></param>
        /// <returns></returns>
        private void ValidateGetRunStep(string threadId, string runId, string stepId, Option<List<string>> include)
        {
            if (threadId == null)
                throw new ArgumentNullException(nameof(threadId));
        ...
        /// <param name="stepId"></param>
        /// <param name="include"></param>
        private void AfterGetRunStepDefaultImplementation(IGetRunStepApiResponse apiResponseLocalVar, string threadId, string runId, string stepId, Option<List<string>> include)
        {
            bool suppressDefaultLog = false;
            AfterGetRunStep(ref suppressDefaultLog, apiResponseLocalVar, threadId, runId, stepId, include);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {2}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="stepId"></param>
        /// <param name="include"></param>
        partial void AfterGetRunStep(ref bool suppressDefaultLog, IGetRunStepApiResponse apiResponseLocalVar, string threadId, string runId, string stepId, Option<List<string>> include);
        ...
        /// <param name="stepId"></param>
        /// <param name="include"></param>
        private void OnErrorGetRunStepDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string threadId, string runId, string stepId, Option<List<string>> include)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetRunStep(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, threadId, runId, stepId, include);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="stepId"></param>
        /// <param name="include"></param>
        partial void OnErrorGetRunStep(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string threadId, string runId, string stepId, Option<List<string>> include);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetRunStepApiResponse"/>&gt;</returns>
        public async Task<IGetRunStepApiResponse?> GetRunStepOrDefaultAsync(string threadId, string runId, string stepId, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetRunStepAsync(threadId, runId, stepId, include, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetRunStepApiResponse"/>&gt;</returns>
        public async Task<IGetRunStepApiResponse> GetRunStepAsync(string threadId, string runId, string stepId, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateGetRunStep(threadId, runId, stepId, include);

                FormatGetRunStep(ref threadId, ref runId, ref stepId, include);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetRunStepDefaultImplementation(apiResponseLocalVar, threadId, runId, stepId, include);
            ...
            {
                OnErrorGetRunStepDefaultImplementation(e, "/threads/{thread_id}/runs/{run_id}/steps/{step_id}", uriBuilderLocalVar.Path, threadId, runId, stepId, include);
        ...
        partial void FormatListRunSteps(ref string threadId, ref string runId, ref Option<int> limit, ref Option<string> order, ref Option<string> after, ref Option<string> before, Option<List<string>> include);
        ...
        /// <param name="include"></param>
        /// <returns></returns>
        private void ValidateListRunSteps(string threadId, string runId, Option<string> order, Option<string> after, Option<string> before, Option<List<string>> include)
        {
            if (threadId == null)
                throw new ArgumentNullException(nameof(threadId));
        ...
        /// <param name="before"></param>
        /// <param name="include"></param>
        private void AfterListRunStepsDefaultImplementation(IListRunStepsApiResponse apiResponseLocalVar, string threadId, string runId, Option<int> limit, Option<string> order, Option<string> after, Option<string> before, Option<List<string>> include)
        {
            bool suppressDefaultLog = false;
            AfterListRunSteps(ref suppressDefaultLog, apiResponseLocalVar, threadId, runId, limit, order, after, before, include);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {2}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="before"></param>
        /// <param name="include"></param>
        partial void AfterListRunSteps(ref bool suppressDefaultLog, IListRunStepsApiResponse apiResponseLocalVar, string threadId, string runId, Option<int> limit, Option<string> order, Option<string> after, Option<string> before, Option<List<string>> include);
        ...
        /// <param name="before"></param>
        /// <param name="include"></param>
        private void OnErrorListRunStepsDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string threadId, string runId, Option<int> limit, Option<string> order, Option<string> after, Option<string> before, Option<List<string>> include)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorListRunSteps(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, threadId, runId, limit, order, after, before, include);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="before"></param>
        /// <param name="include"></param>
        partial void OnErrorListRunSteps(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, string threadId, string runId, Option<int> limit, Option<string> order, Option<string> after, Option<string> before, Option<List<string>> include);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IListRunStepsApiResponse"/>&gt;</returns>
        public async Task<IListRunStepsApiResponse?> ListRunStepsOrDefaultAsync(string threadId, string runId, Option<int> limit = default, Option<string> order = default, Option<string> after = default, Option<string> before = default, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await ListRunStepsAsync(threadId, runId, limit, order, after, before, include, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IListRunStepsApiResponse"/>&gt;</returns>
        public async Task<IListRunStepsApiResponse> ListRunStepsAsync(string threadId, string runId, Option<int> limit = default, Option<string> order = default, Option<string> after = default, Option<string> before = default, Option<List<string>> include = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateListRunSteps(threadId, runId, order, after, before, include);

                FormatListRunSteps(ref threadId, ref runId, ref limit, ref order, ref after, ref before, include);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterListRunStepsDefaultImplementation(apiResponseLocalVar, threadId, runId, limit, order, after, before, include);
            ...
            {
                OnErrorListRunStepsDefaultImplementation(e, "/threads/{thread_id}/runs/{run_id}/steps", uriBuilderLocalVar.Path, threadId, runId, limit, order, after, before, include);
