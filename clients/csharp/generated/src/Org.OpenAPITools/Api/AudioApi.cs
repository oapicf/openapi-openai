...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IAudioApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<System.IO.Stream> CreateSpeechAsync(CreateSpeechRequest createSpeechRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> CreateSpeechWithHttpInfoAsync(CreateSpeechRequest createSpeechRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Transcribes audio into the input language.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CreateTranscription200Response> CreateTranscriptionAsync(System.IO.Stream file, CreateTranscriptionRequestModel model, string? language = default(string?), string? prompt = default(string?), string? responseFormat = default(string?), decimal? temperature = default(decimal?), List<string>? timestampGranularities = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AudioApi : IAudioApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> CreateSpeechAsync(CreateSpeechRequest createSpeechRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<System.IO.Stream>> CreateSpeechWithHttpInfoAsync(CreateSpeechRequest createSpeechRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createSpeechRequest' is set
            if (createSpeechRequest == null)
            {
