...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IFilesApi : IApi
    {
        ...
        Task<IListFilesApiResponse> ListFilesAsync(Option<string> purpose = default, System.Threading.CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IListFilesApiResponse"/>?&gt;</returns>
        Task<IListFilesApiResponse?> ListFilesOrDefaultAsync(Option<string> purpose = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    public sealed partial class FilesApi : IFilesApi
    {
        ...
        partial void FormatListFiles(ref Option<string> purpose);
        ...
        /// <param name="purpose"></param>
        /// <returns></returns>
        private void ValidateListFiles(Option<string> purpose)
        {
        ...
        /// <param name="apiResponseLocalVar"></param>
        /// <param name="purpose"></param>
        private void AfterListFilesDefaultImplementation(IListFilesApiResponse apiResponseLocalVar, Option<string> purpose)
        {
            bool suppressDefaultLog = false;
            AfterListFiles(ref suppressDefaultLog, apiResponseLocalVar, purpose);
            if (!suppressDefaultLog)
                Logger.LogInformation("{0,-9} | {1} | {2}", (apiResponseLocalVar.DownloadedAt - apiResponseLocalVar.RequestedAt).TotalSeconds, apiResponseLocalVar.StatusCode, apiResponseLocalVar.Path);
        }
        ...
        /// <param name="apiResponseLocalVar"></param>
        /// <param name="purpose"></param>
        partial void AfterListFiles(ref bool suppressDefaultLog, IListFilesApiResponse apiResponseLocalVar, Option<string> purpose);
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="purpose"></param>
        private void OnErrorListFilesDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<string> purpose)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorListFiles(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, purpose);
            if (!suppressDefaultLogLocalVar)
                Logger.LogError(exceptionLocalVar, "An error occurred while sending the request to the server.");
        }
        ...
        /// <param name="pathLocalVar"></param>
        /// <param name="purpose"></param>
        partial void OnErrorListFiles(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<string> purpose);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IListFilesApiResponse"/>&gt;</returns>
        public async Task<IListFilesApiResponse?> ListFilesOrDefaultAsync(Option<string> purpose = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await ListFilesAsync(purpose, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IListFilesApiResponse"/>&gt;</returns>
        public async Task<IListFilesApiResponse> ListFilesAsync(Option<string> purpose = default, System.Threading.CancellationToken cancellationToken = default)
        {
            UriBuilder uriBuilderLocalVar = new UriBuilder();

            try
            {
                ValidateListFiles(purpose);

                FormatListFiles(ref purpose);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterListFilesDefaultImplementation(apiResponseLocalVar, purpose);
            ...
            {
                OnErrorListFilesDefaultImplementation(e, "/files", uriBuilderLocalVar.Path, purpose);
