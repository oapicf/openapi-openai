...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IImagesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ImagesResponse> CreateImageAsync(CreateImageRequest createImageRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ImagesResponse>> CreateImageWithHttpInfoAsync(CreateImageRequest createImageRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Creates an edited or extended image given an original image and a prompt.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ImagesResponse</returns>
        System.Threading.Tasks.Task<ImagesResponse> CreateImageEditAsync(System.IO.Stream image, string prompt, System.IO.Stream? mask = default(System.IO.Stream?), CreateImageEditRequestModel? model = default(CreateImageEditRequestModel?), int? n = default(int?), string? size = default(string?), string? responseFormat = default(string?), string? user = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ImagesResponse</returns>
        System.Threading.Tasks.Task<ImagesResponse> CreateImageVariationAsync(System.IO.Stream image, CreateImageEditRequestModel? model = default(CreateImageEditRequestModel?), int? n = default(int?), string? responseFormat = default(string?), string? size = default(string?), string? user = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class ImagesApi : IImagesApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ImagesResponse</returns>
        public async System.Threading.Tasks.Task<ImagesResponse> CreateImageAsync(CreateImageRequest createImageRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ImagesResponse)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<ImagesResponse>> CreateImageWithHttpInfoAsync(CreateImageRequest createImageRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'createImageRequest' is set
            if (createImageRequest == null)
            {
