...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AssistantStreamEvent : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(DoneEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ErrorEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(MessageStreamEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStepStreamEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(ThreadStreamEvent))
                {
                    this._actualInstance = value;
                }
                else
