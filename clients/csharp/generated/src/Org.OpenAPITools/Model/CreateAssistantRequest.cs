...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateAssistantRequest")]
    public partial class CreateAssistantRequest : IValidatableObject
    {
        ...
        public CreateAssistantRequest(CreateAssistantRequestModel model = default(CreateAssistantRequestModel), string name = default(string), string description = default(string), string instructions = default(string), List<AssistantObjectToolsInner> tools = default(List<AssistantObjectToolsInner>), List<string> fileIds = default(List<string>), Object metadata = default(Object))
        {
            // to ensure "model" is required (not null)
            if (model == null)
            {
                throw new ArgumentNullException("model is a required property for CreateAssistantRequest and cannot be null");
            }
            this.Model = model;
            this.Name = name;
