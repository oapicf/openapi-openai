...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateChatCompletionRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="messages">A list of messages comprising the conversation so far. Depending on the [model](/docs/models) you use, different message types (modalities) are supported, like [text](/docs/guides/text-generation), [images](/docs/guides/vision), and [audio](/docs/guides/audio). </param>
        /// <param name="model">model</param>
        /// <param name="store">Whether or not to store the output of this chat completion request for  use in our [model distillation](/docs/guides/distillation) or [evals](/docs/guides/evals) products.  (default to false)</param>
        /// <param name="reasoningEffort">**o1 models only**   Constrains effort on reasoning for  [reasoning models](https://platform.openai.com/docs/guides/reasoning). Currently supported values are &#x60;low&#x60;, &#x60;medium&#x60;, and &#x60;high&#x60;. Reducing reasoning effort can result in faster responses and fewer tokens used on reasoning in a response.  (default to ReasoningEffortEnum.Medium)</param>
        /// <param name="metadata">Developer-defined tags and values used for filtering completions in the [dashboard](https://platform.openai.com/chat-completions). </param>
        ...
        /// <param name="maxTokens">The maximum number of [tokens](/tokenizer) that can be generated in the chat completion. This value can be used to control [costs](https://openai.com/api/pricing/) for text generated via API.  This value is now deprecated in favor of &#x60;max_completion_tokens&#x60;, and is not compatible with [o1 series models](/docs/guides/reasoning). </param>
        /// <param name="maxCompletionTokens">An upper bound for the number of tokens that can be generated for a completion, including visible output tokens and [reasoning tokens](/docs/guides/reasoning). </param>
        ...
        /// <param name="modalities">Output types that you would like the model to generate for this request. Most models are capable of generating text, which is the default:  &#x60;[\&quot;text\&quot;]&#x60;  The &#x60;gpt-4o-audio-preview&#x60; model can also be used to [generate audio](/docs/guides/audio). To request that this model generate both text and audio responses, you can use:  &#x60;[\&quot;text\&quot;, \&quot;audio\&quot;]&#x60; </param>
        ...
        /// <param name="serviceTier">Specifies the latency tier to use for processing the request. This parameter is relevant for customers subscribed to the scale tier service:    - If set to &#39;auto&#39;, and the Project is Scale tier enabled, the system will utilize scale tier credits until they are exhausted.   - If set to &#39;auto&#39;, and the Project is not Scale tier enabled, the request will be processed using the default service tier with a lower uptime SLA and no latency guarentee.   - If set to &#39;default&#39;, the request will be processed using the default service tier with a lower uptime SLA and no latency guarentee.   - When not set, the default behavior is &#39;auto&#39;.    When this parameter is set, the response body will include the &#x60;service_tier&#x60; utilized.  (default to ServiceTierEnum.Auto)</param>
        ...
        [JsonConstructor]
        public CreateChatCompletionRequest(List<ChatCompletionRequestMessage> messages, CreateChatCompletionRequestModel model, Option<bool?> store = default, Option<ReasoningEffortEnum?> reasoningEffort = default, Option<Dictionary<string, string>?> metadata = default, Option<decimal?> frequencyPenalty = default, Option<Dictionary<string, int>?> logitBias = default, Option<bool?> logprobs = default, Option<int?> topLogprobs = default, Option<int?> maxTokens = default, Option<int?> maxCompletionTokens = default, Option<int?> n = default, Option<List<CreateChatCompletionRequest.ModalitiesEnum>?> modalities = default, Option<PredictionContent?> prediction = default, Option<CreateChatCompletionRequestAudio?> audio = default, Option<decimal?> presencePenalty = default, Option<CreateChatCompletionRequestResponseFormat?> responseFormat = default, Option<long?> seed = default, Option<ServiceTierEnum?> serviceTier = default, Option<CreateChatCompletionRequestStop?> stop = default, Option<bool?> stream = default, Option<ChatCompletionStreamOptions?> streamOptions = default, Option<decimal?> temperature = default, Option<decimal?> topP = default, Option<List<ChatCompletionTool>?> tools = default, Option<ChatCompletionToolChoiceOption?> toolChoice = default, Option<bool?> parallelToolCalls = default, Option<string?> user = default, Option<CreateChatCompletionRequestFunctionCall?> functionCall = default, Option<List<ChatCompletionFunctions>?> functions = default)
        {
            Messages = messages;
            Model = model;
            StoreOption = store;
        ...
        /// <summary>
        /// Returns a <see cref="ReasoningEffortEnum"/>
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static ReasoningEffortEnum ReasoningEffortEnumFromString(string value)
        {
            if (value.Equals("low"))
                return ReasoningEffortEnum.Low;

            if (value.Equals("medium"))
                return ReasoningEffortEnum.Medium;

            if (value.Equals("high"))
                return ReasoningEffortEnum.High;

            throw new NotImplementedException($"Could not convert value to type ReasoningEffortEnum: '{value}'");
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static ReasoningEffortEnum? ReasoningEffortEnumFromStringOrDefault(string value)
        {
            if (value.Equals("low"))
                return ReasoningEffortEnum.Low;
        ...
        /// <summary>
        /// Converts the <see cref="ReasoningEffortEnum"/> to the json value
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public static string ReasoningEffortEnumToJsonValue(ReasoningEffortEnum? value)
        {
            if (value == ReasoningEffortEnum.Low)
                return "low";

            if (value == ReasoningEffortEnum.Medium)
                return "medium";

            if (value == ReasoningEffortEnum.High)
                return "high";
        ...
        /// <summary>
        /// Used to track the state of ReasoningEffort
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ReasoningEffortEnum?> ReasoningEffortOption { get; private set; }
        ...
        public ReasoningEffortEnum? ReasoningEffort { get { return this.ReasoningEffortOption; } set { this.ReasoningEffortOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<CreateChatCompletionRequest.ModalitiesEnum>?> ModalitiesOption { get; private set; }
        ...
        public List<CreateChatCompletionRequest.ModalitiesEnum>? Modalities { get { return this.ModalitiesOption; } set { this.ModalitiesOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<PredictionContent?> PredictionOption { get; private set; }

        /// <summary>
        /// Gets or Sets Prediction
        /// </summary>
        [JsonPropertyName("prediction")]
        public PredictionContent? Prediction { get { return this.PredictionOption; } set { this.PredictionOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<CreateChatCompletionRequestAudio?> AudioOption { get; private set; }

        /// <summary>
        /// Gets or Sets Audio
        /// </summary>
        [JsonPropertyName("audio")]
        public CreateChatCompletionRequestAudio? Audio { get { return this.AudioOption; } set { this.AudioOption = new(value); } }
    ...
    public class CreateChatCompletionRequestJsonConverter : JsonConverter<CreateChatCompletionRequest>
    {
        ...
        public override CreateChatCompletionRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<CreateChatCompletionRequest.ReasoningEffortEnum?> reasoningEffort = default;
            ...
            Option<List<CreateChatCompletionRequest.ModalitiesEnum>?> modalities = default;
            Option<PredictionContent?> prediction = default;
            Option<CreateChatCompletionRequestAudio?> audio = default;
            ...
            Option<CreateChatCompletionRequest.ServiceTierEnum?> serviceTier = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "reasoning_effort":
                            string? reasoningEffortRawValue = utf8JsonReader.GetString();
                            if (reasoningEffortRawValue != null)
                                reasoningEffort = new Option<CreateChatCompletionRequest.ReasoningEffortEnum?>(CreateChatCompletionRequest.ReasoningEffortEnumFromStringOrDefault(reasoningEffortRawValue));
                            break;
                        case "metadata":
                        ...
                        case "n":
                            ...
                            break;
                        case "modalities":
                            modalities = new Option<List<CreateChatCompletionRequest.ModalitiesEnum>?>(JsonSerializer.Deserialize<List<CreateChatCompletionRequest.ModalitiesEnum>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "prediction":
                            prediction = new Option<PredictionContent?>(JsonSerializer.Deserialize<PredictionContent>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "audio":
                            audio = new Option<CreateChatCompletionRequestAudio?>(JsonSerializer.Deserialize<CreateChatCompletionRequestAudio>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        ...
                        case "service_tier":
                            ...
                            if (serviceTierRawValue != null)
                                serviceTier = new Option<CreateChatCompletionRequest.ServiceTierEnum?>(CreateChatCompletionRequest.ServiceTierEnumFromStringOrDefault(serviceTierRawValue));
                            break;
                        case "stop":
            ...
            if (reasoningEffort.IsSet && reasoningEffort.Value == null)
                throw new ArgumentNullException(nameof(reasoningEffort), "Property is not nullable for class CreateChatCompletionRequest.");
            ...
            if (parallelToolCalls.IsSet && parallelToolCalls.Value == null)
                throw new ArgumentNullException(nameof(parallelToolCalls), "Property is not nullable for class CreateChatCompletionRequest.");
            ...
            return new CreateChatCompletionRequest(messages.Value!, model.Value!, store, reasoningEffort, metadata, frequencyPenalty, logitBias, logprobs, topLogprobs, maxTokens, maxCompletionTokens, n, modalities, prediction, audio, presencePenalty, responseFormat, seed, serviceTier, stop, stream, streamOptions, temperature, topP, tools, toolChoice, parallelToolCalls, user, functionCall, functions);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateChatCompletionRequest createChatCompletionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createChatCompletionRequest.StoreOption.IsSet)
                if (createChatCompletionRequest.StoreOption.Value != null)
                    writer.WriteBoolean("store", createChatCompletionRequest.StoreOption.Value!.Value);
                else
                    writer.WriteNull("store");

            var reasoningEffortRawValue = CreateChatCompletionRequest.ReasoningEffortEnumToJsonValue(createChatCompletionRequest.ReasoningEffortOption.Value!.Value);
            writer.WriteString("reasoning_effort", reasoningEffortRawValue);
            if (createChatCompletionRequest.MetadataOption.IsSet)
                if (createChatCompletionRequest.MetadataOption.Value != null)
                {
                    writer.WritePropertyName("metadata");
                    JsonSerializer.Serialize(writer, createChatCompletionRequest.Metadata, jsonSerializerOptions);
                }
                else
            ...
            if (createChatCompletionRequest.MaxCompletionTokensOption.IsSet)
                if (createChatCompletionRequest.MaxCompletionTokensOption.Value != null)
                    writer.WriteNumber("max_completion_tokens", createChatCompletionRequest.MaxCompletionTokensOption.Value!.Value);
                else
            ...
            if (createChatCompletionRequest.ModalitiesOption.IsSet)
                if (createChatCompletionRequest.ModalitiesOption.Value != null)
                {
                    writer.WritePropertyName("modalities");
                    JsonSerializer.Serialize(writer, createChatCompletionRequest.Modalities, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("modalities");
            if (createChatCompletionRequest.PredictionOption.IsSet)
                if (createChatCompletionRequest.PredictionOption.Value != null)
                {
                    writer.WritePropertyName("prediction");
                    JsonSerializer.Serialize(writer, createChatCompletionRequest.Prediction, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("prediction");
            if (createChatCompletionRequest.AudioOption.IsSet)
                if (createChatCompletionRequest.AudioOption.Value != null)
                {
                    writer.WritePropertyName("audio");
                    JsonSerializer.Serialize(writer, createChatCompletionRequest.Audio, jsonSerializerOptions);
                }
                else
            ...
            var serviceTierRawValue = CreateChatCompletionRequest.ServiceTierEnumToJsonValue(createChatCompletionRequest.ServiceTierOption.Value!.Value);
            if (serviceTierRawValue != null)
            ...
            if (createChatCompletionRequest.StreamOptionsOption.IsSet)
                if (createChatCompletionRequest.StreamOptionsOption.Value != null)
                {
                    writer.WritePropertyName("stream_options");
                    JsonSerializer.Serialize(writer, createChatCompletionRequest.StreamOptions, jsonSerializerOptions);
                }
                else
            ...
            if (createChatCompletionRequest.ParallelToolCallsOption.IsSet)
                writer.WriteBoolean("parallel_tool_calls", createChatCompletionRequest.ParallelToolCallsOption.Value!.Value);
