...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateChatCompletionRequest : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TopLogprobs, must be a value less than or equal to 20.", new [] { "TopLogprobs" });
            }

            // TopLogprobs (int?) minimum
            if (this.TopLogprobs < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TopLogprobs, must be a value greater than or equal to 0.", new [] { "TopLogprobs" });
            }
