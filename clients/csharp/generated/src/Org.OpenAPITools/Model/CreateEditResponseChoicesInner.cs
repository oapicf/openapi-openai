...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateEditResponse_choices_inner")]
    public partial class CreateEditResponseChoicesInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEditResponseChoicesInner" /> class.
        /// </summary>
        /// <param name="text">text.</param>
        /// <param name="index">index.</param>
        /// <param name="logprobs">logprobs.</param>
        /// <param name="finishReason">finishReason.</param>
        public CreateEditResponseChoicesInner(string text = default(string), int index = default(int), CreateCompletionResponseChoicesInnerLogprobs logprobs = default(CreateCompletionResponseChoicesInnerLogprobs), FinishReasonEnum? finishReason = default(FinishReasonEnum?))
        {
            this.Text = text;
            this.Index = index;
