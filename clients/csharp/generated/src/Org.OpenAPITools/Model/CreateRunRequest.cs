...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateRunRequest : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaxPromptTokens, must be a value greater than or equal to 256.", new [] { "MaxPromptTokens" });
            }

            // MaxCompletionTokens (int?) minimum
            if (this.MaxCompletionTokens < (int?)256)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaxCompletionTokens, must be a value greater than or equal to 256.", new [] { "MaxCompletionTokens" });
            }
