...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateSpeechRequest : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Input, length must be less than 4096.", new [] { "Input" });
            }

            // Speed (decimal) maximum
            if (this.Speed > (decimal)4.0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Speed, must be a value less than or equal to 4.0.", new [] { "Speed" });
            }

            // Speed (decimal) minimum
            if (this.Speed < (decimal)0.25)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Speed, must be a value greater than or equal to 0.25.", new [] { "Speed" });
            }
