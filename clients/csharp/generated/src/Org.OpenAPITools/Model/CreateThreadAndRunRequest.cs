...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateThreadAndRunRequest")]
    public partial class CreateThreadAndRunRequest : IValidatableObject
    {
        ...
        protected CreateThreadAndRunRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateThreadAndRunRequest" /> class.
        /// </summary>
        ...
        public CreateThreadAndRunRequest(string assistantId = default(string), CreateThreadRequest thread = default(CreateThreadRequest), CreateRunRequestModel model = default(CreateRunRequestModel), string instructions = default(string), List<CreateThreadAndRunRequestToolsInner> tools = default(List<CreateThreadAndRunRequestToolsInner>), Object metadata = default(Object), decimal? temperature = 1M, bool? stream = default(bool?), int? maxPromptTokens = default(int?), int? maxCompletionTokens = default(int?), TruncationObject truncationStrategy = default(TruncationObject), AssistantsApiToolChoiceOption toolChoice = default(AssistantsApiToolChoiceOption), AssistantsApiResponseFormatOption responseFormat = default(AssistantsApiResponseFormatOption))
        {
            // to ensure "assistantId" is required (not null)
            if (assistantId == null)
            {
                throw new ArgumentNullException("assistantId is a required property for CreateThreadAndRunRequest and cannot be null");
            }
        ...
        public List<CreateThreadAndRunRequestToolsInner> Tools { get; set; }
