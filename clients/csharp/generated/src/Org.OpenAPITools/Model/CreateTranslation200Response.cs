...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateTranslation200Response : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(CreateTranslationResponseJson) || value is CreateTranslationResponseJson)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(CreateTranslationResponseVerboseJson) || value is CreateTranslationResponseVerboseJson)
                {
                    this._actualInstance = value;
                }
                else
