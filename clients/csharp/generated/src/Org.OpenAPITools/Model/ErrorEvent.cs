...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ErrorEvent : IValidatableObject
    {
        ...
        public ErrorEvent(EventEnum varEvent = default(EventEnum), Error data = default(Error))
        {
            this.VarEvent = varEvent;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for ErrorEvent and cannot be null");
            }
            this.Data = data;
        }
