...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MessageDeltaContentTextAnnotationsFilePathObject_file_path")]
    public partial class MessageDeltaContentTextAnnotationsFilePathObjectFilePath : IValidatableObject
    {
        ...
        public MessageDeltaContentTextAnnotationsFilePathObjectFilePath(string fileId = default(string))
        {
            this.FileId = fileId;
        }
