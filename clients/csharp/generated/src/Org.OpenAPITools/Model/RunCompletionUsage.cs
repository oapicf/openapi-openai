...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RunCompletionUsage")]
    public partial class RunCompletionUsage : IValidatableObject
    {
        ...
        protected RunCompletionUsage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RunCompletionUsage" /> class.
        /// </summary>
        /// <param name="completionTokens">Number of completion tokens used over the course of the run. (required).</param>
        /// <param name="promptTokens">Number of prompt tokens used over the course of the run. (required).</param>
        /// <param name="totalTokens">Total number of tokens used (prompt + completion). (required).</param>
        public RunCompletionUsage(int completionTokens = default(int), int promptTokens = default(int), int totalTokens = default(int))
        {
