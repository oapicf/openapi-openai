...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RunStepDeltaStepDetailsToolCallsFunctionObject_function")]
    public partial class RunStepDeltaStepDetailsToolCallsFunctionObjectFunction : IValidatableObject
    {
        ...
        public RunStepDeltaStepDetailsToolCallsFunctionObjectFunction(string name = default(string), string arguments = default(string), string output = default(string))
        {
            this.Name = name;
