...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RunStepStreamEvent : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(RunStepStreamEventOneOf))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStepStreamEventOneOf1))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStepStreamEventOneOf2))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStepStreamEventOneOf3))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStepStreamEventOneOf4))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStepStreamEventOneOf5))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStepStreamEventOneOf6))
                {
                    this._actualInstance = value;
                }
                else
