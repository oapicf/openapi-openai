...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class RunStreamEvent : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(RunStreamEventOneOf))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEventOneOf1))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEventOneOf2))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEventOneOf3))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEventOneOf4))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEventOneOf5))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEventOneOf6))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEventOneOf7))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(RunStreamEventOneOf8))
                {
                    this._actualInstance = value;
                }
                else
