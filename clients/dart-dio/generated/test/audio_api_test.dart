...
void main() {
  ...
  group(AudioApi, () {
    ...
    //
    //Future<CreateTranscription200Response> createTranscription(MultipartFile file, CreateTranscriptionRequestModel model, { String language, String prompt, AudioResponseFormat responseFormat, num temperature, BuiltList<String> timestampGranularitiesLeftSquareBracketRightSquareBracket }) async
