...
class AssistantObjectToolsInner {
  ...
  @override
  String toString() => 'AssistantObjectToolsInner[type=$type, fileSearch=$fileSearch, function_=$function_]';
...
class AssistantObjectToolsInnerTypeEnum {
  ...
  static const fileSearch = AssistantObjectToolsInnerTypeEnum._(r'file_search');
  ...
  AssistantObjectToolsInnerTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'file_search': return AssistantObjectToolsInnerTypeEnum.fileSearch;
