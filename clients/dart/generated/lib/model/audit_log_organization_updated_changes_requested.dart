...
class AuditLogOrganizationUpdatedChangesRequested {
  ...
  @override
  String toString() => 'AuditLogOrganizationUpdatedChangesRequested[title=$title, description=$description, name=$name, settings=$settings]';
  ...
  static AuditLogOrganizationUpdatedChangesRequested? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AuditLogOrganizationUpdatedChangesRequested(
        ...
        settings: AuditLogOrganizationUpdatedChangesRequestedSettings.fromJson(json[r'settings']),
      );
    }
    return null;
  }
