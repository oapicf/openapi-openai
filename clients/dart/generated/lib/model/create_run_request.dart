...
class CreateRunRequest {
  ...
  int get hashCode =>
    ...
    (additionalMessages == null ? 0 : additionalMessages!.hashCode) +
  ...
  @override
  String toString() => 'CreateRunRequest[assistantId=$assistantId, model=$model, instructions=$instructions, additionalInstructions=$additionalInstructions, additionalMessages=$additionalMessages, tools=$tools, metadata=$metadata, temperature=$temperature, topP=$topP, stream=$stream, maxPromptTokens=$maxPromptTokens, maxCompletionTokens=$maxCompletionTokens, truncationStrategy=$truncationStrategy, toolChoice=$toolChoice, parallelToolCalls=$parallelToolCalls, responseFormat=$responseFormat]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.additionalMessages != null) {
      ...
      json[r'additional_messages'] = null;
    }
    if (this.tools != null) {
