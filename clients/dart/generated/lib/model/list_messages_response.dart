...
class ListMessagesResponse {
  ...
  @override
  String toString() => 'ListMessagesResponse[object=$object, data=$data, firstId=$firstId, lastId=$lastId, hasMore=$hasMore]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ListMessagesResponse[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ListMessagesResponse[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ListMessagesResponse(
        ...
        data: MessageObject.listFromJson(json[r'data']),
