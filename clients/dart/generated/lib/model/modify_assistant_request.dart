...
class ModifyAssistantRequest {
  ...
  @override
  String toString() => 'ModifyAssistantRequest[model=$model, name=$name, description=$description, instructions=$instructions, tools=$tools, toolResources=$toolResources, metadata=$metadata, temperature=$temperature, topP=$topP, responseFormat=$responseFormat]';
