...
**choices** | [**LIST [CREATE_CHAT_COMPLETION_STREAM_RESPONSE_CHOICES_INNER]**](CreateChatCompletionStreamResponse_choices_inner.md) | A list of chat completion choices. Can contain more than one elements if &#x60;n&#x60; is greater than 1. Can also be empty for the last chunk if you set &#x60;stream_options: {\&quot;include_usage\&quot;: true}&#x60;.  | [default to null]
...
**usage** | [**CREATE_CHAT_COMPLETION_STREAM_RESPONSE_USAGE**](CreateChatCompletionStreamResponse_usage.md) |  | [optional] [default to null]
