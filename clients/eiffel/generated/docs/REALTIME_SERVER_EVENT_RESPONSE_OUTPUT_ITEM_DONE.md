...
**type** | [**STRING_32**](STRING_32.md) | The event type, must be &#x60;response.output_item.done&#x60;. | [default to null]
**response_id** | [**STRING_32**](STRING_32.md) | The ID of the Response to which the item belongs. | [default to null]
