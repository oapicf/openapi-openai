...
feature -- API Access
	...
	create_transcription (file: FILE; model: CREATE_TRANSCRIPTION_REQUEST_MODEL; language: STRING_32; prompt: STRING_32; response_format: detachable AUDIO_RESPONSE_FORMAT; temperature: REAL_32; timestamp_granularities: detachable LIST [STRING_32]): detachable CREATE_TRANSCRIPTION_200_RESPONSE
			...
			-- 
			-- argument: response_format  (optional, default to null)
			-- 
	...
	create_translation (file: FILE; model: CREATE_TRANSCRIPTION_REQUEST_MODEL; prompt: STRING_32; response_format: detachable AUDIO_RESPONSE_FORMAT; temperature: REAL_32): detachable CREATE_TRANSLATION_200_RESPONSE
