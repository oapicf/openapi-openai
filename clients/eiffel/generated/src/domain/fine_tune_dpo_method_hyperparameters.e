...
class FINE_TUNE_DPO_METHOD_HYPERPARAMETERS
...
feature --Access
    ...
    beta: detachable FINE_TUNE_DPO_METHOD_HYPERPARAMETERS_BETA
...
feature -- Change Element
    ...
    set_beta (a_name: like beta)
        -- Set 'beta' with 'a_name'.
      do
        beta := a_name
      ensure
        beta_set: beta = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass FINE_TUNE_DPO_METHOD_HYPERPARAMETERS%N")
        if attached beta as l_beta then
          Result.append ("%Nbeta:")
          Result.append (l_beta.out)
          Result.append ("%N")
        end
