...
feature -- Change Element
    ...
    set_estimated_finish (a_name: like estimated_finish)
        -- Set 'estimated_finish' with 'a_name'.
      do
        estimated_finish := a_name
      ensure
        estimated_finish_set: estimated_finish = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        if attached estimated_finish as l_estimated_finish then
          Result.append ("%Nestimated_finish:")
          Result.append (l_estimated_finish.out)
          Result.append ("%N")
        end
