...
class MESSAGE_DELTA_OBJECT_DELTA_CONTENT_INNER
...
feature --Access
    ...
    type: detachable STRING_32
      -- Always `image_file`.
    image_file: detachable MESSAGE_DELTA_CONTENT_IMAGE_FILE_OBJECT_IMAGE_FILE
      
    text: detachable MESSAGE_DELTA_CONTENT_TEXT_OBJECT_TEXT
      
    refusal: detachable STRING_32
      
    image_url: detachable MESSAGE_DELTA_CONTENT_IMAGE_URL_OBJECT_IMAGE_URL
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass MESSAGE_DELTA_OBJECT_DELTA_CONTENT_INNER%N")
