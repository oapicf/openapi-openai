...
module Api.Data exposing
    ...
    , CreateFineTuningJobRequestIntegrationsInner, CreateFineTuningJobRequestIntegrationsInnerType(..), createFineTuningJobRequestIntegrationsInnerTypeVariants
...
type CreateFineTuningJobRequestIntegrationsInnerType
    = CreateFineTuningJobRequestIntegrationsInnerTypeWandb


createFineTuningJobRequestIntegrationsInnerTypeVariants : List CreateFineTuningJobRequestIntegrationsInnerType
createFineTuningJobRequestIntegrationsInnerTypeVariants =
    [ CreateFineTuningJobRequestIntegrationsInnerTypeWandb
    ]
...
type RunObjectIncompleteDetailsReason
    = RunObjectIncompleteDetailsReasonMaxCompletionTokens
    | RunObjectIncompleteDetailsReasonMaxPromptTokens
...
type ThreadStreamEventEvent
    = ThreadStreamEventEventThreadCreated


threadStreamEventEventVariants : List ThreadStreamEventEvent
threadStreamEventEventVariants =
    [ ThreadStreamEventEventThreadCreated
    ]
...
stringFromCreateFineTuningJobRequestIntegrationsInnerType : CreateFineTuningJobRequestIntegrationsInnerType -> String
stringFromCreateFineTuningJobRequestIntegrationsInnerType model =
    case model of
        CreateFineTuningJobRequestIntegrationsInnerTypeWandb ->
            "wandb"
...
encodeCreateFineTuningJobRequestIntegrationsInnerType =
    Json.Encode.string << stringFromCreateFineTuningJobRequestIntegrationsInnerType
...
encodeThreadStreamEvent =
    encodeObject << encodeThreadStreamEventPairs


encodeThreadStreamEventWithTag : ( String, String ) -> ThreadStreamEvent -> Json.Encode.Value
encodeThreadStreamEventWithTag (tagField, tag) model =
    encodeObject (encodeThreadStreamEventPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeThreadStreamEventPairs : ThreadStreamEvent -> List EncodedField
encodeThreadStreamEventPairs model =
    let
        pairs =
            [ encode "event" encodeThreadStreamEventEvent model.event
            , encode "data" encodeThreadObject model.data
            ]
    in
    pairs

stringFromThreadStreamEventEvent : ThreadStreamEventEvent -> String
stringFromThreadStreamEventEvent model =
    case model of
        ThreadStreamEventEventThreadCreated ->
            "thread.created"


encodeThreadStreamEventEvent : ThreadStreamEventEvent -> Json.Encode.Value
encodeThreadStreamEventEvent =
    Json.Encode.string << stringFromThreadStreamEventEvent
    ...
    Json.Decode.string
        |> Json.Decode.andThen
            (\value ->
                case value of
                    "wandb" ->
                        Json.Decode.succeed CreateFineTuningJobRequestIntegrationsInnerTypeWandb
    ...
    Json.Decode.string
        |> Json.Decode.andThen
            (\value ->
                case value of
                    "max_completion_tokens" ->
                        Json.Decode.succeed RunObjectIncompleteDetailsReasonMaxCompletionTokens

                    "max_prompt_tokens" ->
                        Json.Decode.succeed RunObjectIncompleteDetailsReasonMaxPromptTokens
...
threadStreamEventDecoder =
    Json.Decode.succeed ThreadStreamEvent
        |> decode "event" threadStreamEventEventDecoder 
        |> decode "data" threadObjectDecoder 


threadStreamEventEventDecoder : Json.Decode.Decoder ThreadStreamEventEvent
threadStreamEventEventDecoder =
    Json.Decode.string
        |> Json.Decode.andThen
            (\value ->
                case value of
                    "thread.created" ->
                        Json.Decode.succeed ThreadStreamEventEventThreadCreated
