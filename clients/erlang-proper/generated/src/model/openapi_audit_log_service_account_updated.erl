...
-export([openapi_audit_log_service_account_updated/0]).

-export([openapi_audit_log_service_account_updated/1]).
...
openapi_audit_log_service_account_updated() ->
    openapi_audit_log_service_account_updated([]).

openapi_audit_log_service_account_updated(Fields) ->
  Default = [ {'id', binary() }
            , {'changes_requested', openapi_audit_log_service_account_updated_changes_requested:openapi_audit_log_service_account_updated_changes_requested() }
            ],
