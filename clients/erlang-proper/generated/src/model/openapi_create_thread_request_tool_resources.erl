...
-export([openapi_create_thread_request_tool_resources/0]).

-export([openapi_create_thread_request_tool_resources/1]).
...
openapi_create_thread_request_tool_resources() ->
    openapi_create_thread_request_tool_resources([]).

openapi_create_thread_request_tool_resources(Fields) ->
