...
-export([openapi_fine_tune_chat_completion_request_assistant_message/0]).

-export([openapi_fine_tune_chat_completion_request_assistant_message/1]).
...
openapi_fine_tune_chat_completion_request_assistant_message() ->
    openapi_fine_tune_chat_completion_request_assistant_message([]).

openapi_fine_tune_chat_completion_request_assistant_message(Fields) ->
