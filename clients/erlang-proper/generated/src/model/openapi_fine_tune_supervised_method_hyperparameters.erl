...
-export([openapi_fine_tune_supervised_method_hyperparameters/0]).

-export([openapi_fine_tune_supervised_method_hyperparameters/1]).
...
openapi_fine_tune_supervised_method_hyperparameters() ->
    openapi_fine_tune_supervised_method_hyperparameters([]).

openapi_fine_tune_supervised_method_hyperparameters(Fields) ->
  Default = [ {'batch_size', openapi_fine_tune_dpo_method_hyperparameters_batch_size:openapi_fine_tune_dpo_method_hyperparameters_batch_size() }
            , {'learning_rate_multiplier', openapi_fine_tune_dpo_method_hyperparameters_learning_rate_multiplier:openapi_fine_tune_dpo_method_hyperparameters_learning_rate_multiplier() }
            , {'n_epochs', openapi_fine_tune_dpo_method_hyperparameters_n_epochs:openapi_fine_tune_dpo_method_hyperparameters_n_epochs() }
            ],
