...
-export([openapi_message_delta_content_image_url_object/0]).

-export([openapi_message_delta_content_image_url_object/1]).
...
openapi_message_delta_content_image_url_object() ->
    openapi_message_delta_content_image_url_object([]).

openapi_message_delta_content_image_url_object(Fields) ->
  Default = [ {'index', integer() }
            , {'type', elements([<<"image_url">>]) }
            , {'image_url', openapi_message_delta_content_image_url_object_image_url:openapi_message_delta_content_image_url_object_image_url() }
            ],
