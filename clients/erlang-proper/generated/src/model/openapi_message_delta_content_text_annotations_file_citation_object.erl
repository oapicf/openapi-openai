...
-export([openapi_message_delta_content_text_annotations_file_citation_object/0]).

-export([openapi_message_delta_content_text_annotations_file_citation_object/1]).
...
openapi_message_delta_content_text_annotations_file_citation_object() ->
    openapi_message_delta_content_text_annotations_file_citation_object([]).

openapi_message_delta_content_text_annotations_file_citation_object(Fields) ->
  Default = [ {'index', integer() }
            , {'type', elements([<<"file_citation">>]) }
            , {'text', binary() }
            , {'file_citation', openapi_message_delta_content_text_annotations_file_citation_object_file_citation:openapi_message_delta_content_text_annotations_file_citation_object_file_citation() }
