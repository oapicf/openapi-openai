...
-export([openapi_message_delta_content_text_annotations_file_path_object/0]).

-export([openapi_message_delta_content_text_annotations_file_path_object/1]).
...
openapi_message_delta_content_text_annotations_file_path_object() ->
    openapi_message_delta_content_text_annotations_file_path_object([]).

openapi_message_delta_content_text_annotations_file_path_object(Fields) ->
  Default = [ {'index', integer() }
            , {'type', elements([<<"file_path">>]) }
            , {'text', binary() }
            , {'file_path', openapi_message_delta_content_text_annotations_file_path_object_file_path:openapi_message_delta_content_text_annotations_file_path_object_file_path() }
