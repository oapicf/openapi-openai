...
-export([openapi_message_delta_content_text_object_text_annotations_inner/0]).

-export([openapi_message_delta_content_text_object_text_annotations_inner/1]).
...
openapi_message_delta_content_text_object_text_annotations_inner() ->
    openapi_message_delta_content_text_object_text_annotations_inner([]).

openapi_message_delta_content_text_object_text_annotations_inner(Fields) ->
  Default = [ {'index', integer() }
            , {'type', elements([<<"file_citation">>, <<"file_path">>]) }
            , {'text', binary() }
            , {'file_citation', openapi_message_delta_content_text_annotations_file_citation_object_file_citation:openapi_message_delta_content_text_annotations_file_citation_object_file_citation() }
