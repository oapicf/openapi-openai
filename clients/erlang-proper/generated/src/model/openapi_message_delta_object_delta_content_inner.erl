...
-export([openapi_message_delta_object_delta_content_inner/0]).

-export([openapi_message_delta_object_delta_content_inner/1]).
...
openapi_message_delta_object_delta_content_inner() ->
    openapi_message_delta_object_delta_content_inner([]).
