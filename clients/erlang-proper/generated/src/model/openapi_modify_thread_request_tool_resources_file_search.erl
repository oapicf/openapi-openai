...
-export([openapi_modify_thread_request_tool_resources_file_search/0]).

-export([openapi_modify_thread_request_tool_resources_file_search/1]).
...
openapi_modify_thread_request_tool_resources_file_search() ->
    openapi_modify_thread_request_tool_resources_file_search([]).

openapi_modify_thread_request_tool_resources_file_search(Fields) ->
