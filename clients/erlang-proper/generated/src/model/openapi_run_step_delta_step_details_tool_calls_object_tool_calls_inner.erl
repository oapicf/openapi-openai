...
-export([openapi_run_step_delta_step_details_tool_calls_object_tool_calls_inner/0]).

-export([openapi_run_step_delta_step_details_tool_calls_object_tool_calls_inner/1]).
...
openapi_run_step_delta_step_details_tool_calls_object_tool_calls_inner() ->
    openapi_run_step_delta_step_details_tool_calls_object_tool_calls_inner([]).
