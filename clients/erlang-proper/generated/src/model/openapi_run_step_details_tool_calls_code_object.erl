...
-export([openapi_run_step_details_tool_calls_code_object/0]).

-export([openapi_run_step_details_tool_calls_code_object/1]).
...
openapi_run_step_details_tool_calls_code_object() ->
    openapi_run_step_details_tool_calls_code_object([]).

openapi_run_step_details_tool_calls_code_object(Fields) ->
  Default = [ {'id', binary() }
