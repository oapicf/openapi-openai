...
-export([openapi_run_step_details_tool_calls_code_object_code_interpreter_outputs_inner/0]).

-export([openapi_run_step_details_tool_calls_code_object_code_interpreter_outputs_inner/1]).
...
openapi_run_step_details_tool_calls_code_object_code_interpreter_outputs_inner() ->
    openapi_run_step_details_tool_calls_code_object_code_interpreter_outputs_inner([]).

openapi_run_step_details_tool_calls_code_object_code_interpreter_outputs_inner(Fields) ->
  Default = [ {'type', elements([<<"logs">>, <<"image">>]) }
            , {'logs', binary() }
            , {'image', openapi_run_step_details_tool_calls_code_output_image_object_image:openapi_run_step_details_tool_calls_code_output_image_object_image() }
            ],
