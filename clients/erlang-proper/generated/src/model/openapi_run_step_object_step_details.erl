...
-export([openapi_run_step_object_step_details/0]).

-export([openapi_run_step_object_step_details/1]).
...
openapi_run_step_object_step_details() ->
    openapi_run_step_object_step_details([]).

openapi_run_step_object_step_details(Fields) ->
