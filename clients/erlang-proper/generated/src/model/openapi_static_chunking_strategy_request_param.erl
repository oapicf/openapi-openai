...
-export([openapi_static_chunking_strategy_request_param/0]).

-export([openapi_static_chunking_strategy_request_param/1]).
...
openapi_static_chunking_strategy_request_param() ->
    openapi_static_chunking_strategy_request_param([]).

openapi_static_chunking_strategy_request_param(Fields) ->
