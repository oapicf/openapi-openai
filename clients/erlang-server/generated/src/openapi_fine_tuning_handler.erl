...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CancelFineTuningJob' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CreateFineTuningJob' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ListFineTuningEvents' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ListFineTuningJobCheckpoints' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ListPaginatedFineTuningJobs' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'RetrieveFineTuningJob' = OperationID,
        logic_handler = LogicHandler
    }
) ->
