...
module DefaultApiServiceImplementation =
    ...
    type DefaultApiServiceImpl() =
      interface IDefaultApiService with
        ...
        member this.AdminApiKeysCreate (parameters:AdminApiKeysCreateBodyParams) =
        ...
        member this.AdminApiKeysDelete () =
