...
- model/FineTuneEventModel.fs
- model/FineTuneModel.fs
- model/ListFilesResponseModel.fs
- model/ImagesResponseDataInnerModel.fs
- model/ImagesResponseModel.fs
- model/ListFineTuneEventsResponseModel.fs
- model/ListFineTunesResponseModel.fs
- model/ErrorModel.fs
- model/ErrorResponseModel.fs
- model/DeleteModelResponseModel.fs
- model/DeleteFileResponseModel.fs
- model/CreateTranslationResponseModel.fs
- model/CreateTranscriptionResponseModel.fs
...
- model/CreateFineTuneRequestModelModel.fs
- model/CreateFineTuneRequestModel.fs
- model/CreateEmbeddingResponseUsageModel.fs
- model/CreateEmbeddingResponseDataInnerModel.fs
...
- model/CreateEditResponseChoicesInnerModel.fs
- model/CreateEditRequestModelModel.fs
- model/CreateEditRequestModel.fs
- model/CreateCompletionResponseUsageModel.fs
- model/CreateEditResponseModel.fs
...
- model/CreateCompletionRequestPromptModel.fs
- model/CreateCompletionRequestModelModel.fs
- model/CreateCompletionRequestModel.fs
- model/ChatCompletionRequestMessageFunctionCallModel.fs
...
- model/CreateChatCompletionRequestFunctionCallOneOfModel.fs
...
- api/OpenAIApiServiceInterface.fs
