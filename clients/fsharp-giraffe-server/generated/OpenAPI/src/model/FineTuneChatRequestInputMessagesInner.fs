...
open OpenAPI.Model.FineTuneChatCompletionRequestAssistantMessage
open OpenAPI.Model.string option

module FineTuneChatRequestInputMessagesInner =

  //#region FineTuneChatRequestInputMessagesInner
  ...
  type FineTuneChatRequestInput_messages_inner = {
