...
func (c *Container) AddUploadPart(ctx echo.Context) error {
...
func (c *Container) CancelUpload(ctx echo.Context) error {
	return ctx.JSON(http.StatusOK, models.HelloWorld {
		Message: "Hello World",
	})
}
...
func (c *Container) CompleteUpload(ctx echo.Context) error {
	return ctx.JSON(http.StatusOK, models.HelloWorld {
		Message: "Hello World",
	})
}
...
func (c *Container) CreateUpload(ctx echo.Context) error {
	return ctx.JSON(http.StatusOK, models.HelloWorld {
		Message: "Hello World",
	})
}
