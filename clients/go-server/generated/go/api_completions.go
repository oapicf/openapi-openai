...
func NewCompletionsAPIController(s CompletionsAPIServicer, opts ...CompletionsAPIOption) *CompletionsAPIController {
...
// OrderedRoutes returns all the api routes in a deterministic order for the CompletionsAPIController
func (c *CompletionsAPIController) OrderedRoutes() []Route {
	return []Route{
		Route{
			"CreateCompletion",
			strings.ToUpper("Post"),
...
func (c *CompletionsAPIController) CreateCompletion(w http.ResponseWriter, r *http.Request) {
	var createCompletionRequestParam CreateCompletionRequest
