...
func NewEmbeddingsAPIController(s EmbeddingsAPIServicer, opts ...EmbeddingsAPIOption) *EmbeddingsAPIController {
...
// OrderedRoutes returns all the api routes in a deterministic order for the EmbeddingsAPIController
func (c *EmbeddingsAPIController) OrderedRoutes() []Route {
	return []Route{
		Route{
			"CreateEmbedding",
			strings.ToUpper("Post"),
...
func (c *EmbeddingsAPIController) CreateEmbedding(w http.ResponseWriter, r *http.Request) {
	var createEmbeddingRequestParam CreateEmbeddingRequest
