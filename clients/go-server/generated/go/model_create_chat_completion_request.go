...
func AssertCreateChatCompletionRequestRequired(obj CreateChatCompletionRequest) error {
	...
	if obj.Prediction != nil {
		if err := AssertPredictionContentRequired(*obj.Prediction); err != nil {
			return err
		}
	}
	if obj.Audio != nil {
		if err := AssertCreateChatCompletionRequestAudioRequired(*obj.Audio); err != nil {
			return err
		}
	}
	...
	if obj.StreamOptions != nil {
		if err := AssertChatCompletionStreamOptionsRequired(*obj.StreamOptions); err != nil {
			return err
		}
	}
...
func AssertCreateChatCompletionRequestConstraints(obj CreateChatCompletionRequest) error {
    ...
    if obj.Prediction != nil {
     	if err := AssertPredictionContentConstraints(*obj.Prediction); err != nil {
     		return err
     	}
    }
    if obj.Audio != nil {
     	if err := AssertCreateChatCompletionRequestAudioConstraints(*obj.Audio); err != nil {
     		return err
     	}
    }
	...
	if obj.Seed != nil && *obj.Seed < -9223372036854776000 {
    ...
    if obj.StreamOptions != nil {
     	if err := AssertChatCompletionStreamOptionsConstraints(*obj.StreamOptions); err != nil {
     		return err
     	}
    }
