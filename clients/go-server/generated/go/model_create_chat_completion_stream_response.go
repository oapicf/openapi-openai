...
func AssertCreateChatCompletionStreamResponseRequired(obj CreateChatCompletionStreamResponse) error {
	...
	if obj.Usage != nil {
		if err := AssertCreateChatCompletionStreamResponseUsageRequired(*obj.Usage); err != nil {
			return err
		}
	}
	return nil
...
func AssertCreateChatCompletionStreamResponseConstraints(obj CreateChatCompletionStreamResponse) error {
	for _, el := range obj.Choices {
		if err := AssertCreateChatCompletionStreamResponseChoicesInnerConstraints(el); err != nil {
			return err
		}
	}
    if obj.Usage != nil {
     	if err := AssertCreateChatCompletionStreamResponseUsageConstraints(*obj.Usage); err != nil {
     		return err
     	}
    }
	return nil
