...
func AssertCreateCompletionRequestConstraints(obj CreateCompletionRequest) error {
	if err := AssertCreateCompletionRequestModelConstraints(obj.Model); err != nil {
		return err
	}
    if obj.Prompt != nil {
     	if err := AssertCreateCompletionRequestPromptConstraints(*obj.Prompt); err != nil {
     		return err
     	}
    }
	if obj.BestOf != nil && *obj.BestOf < 0 {
		return &ParsingError{Param: "BestOf", Err: errors.New(errMsgMinValueConstraint)}
	}
	if obj.BestOf != nil && *obj.BestOf > 20 {
		return &ParsingError{Param: "BestOf", Err: errors.New(errMsgMaxValueConstraint)}
	}
	...
	if obj.Logprobs != nil && *obj.Logprobs < 0 {
		return &ParsingError{Param: "Logprobs", Err: errors.New(errMsgMinValueConstraint)}
	}
	if obj.Logprobs != nil && *obj.Logprobs > 5 {
		return &ParsingError{Param: "Logprobs", Err: errors.New(errMsgMaxValueConstraint)}
	}
	if obj.MaxTokens != nil && *obj.MaxTokens < 0 {
		return &ParsingError{Param: "MaxTokens", Err: errors.New(errMsgMinValueConstraint)}
	}
    ...
    if obj.Stop != nil {
     	if err := AssertCreateCompletionRequestStopConstraints(*obj.Stop); err != nil {
     		return err
     	}
    }
    if obj.StreamOptions != nil {
