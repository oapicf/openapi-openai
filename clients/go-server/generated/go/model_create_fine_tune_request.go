...
// AssertCreateFineTuneRequestRequired checks if the required fields are not zero-ed
func AssertCreateFineTuneRequestRequired(obj CreateFineTuneRequest) error {
	...
	if obj.Model != nil {
		if err := AssertCreateFineTuneRequestModelRequired(*obj.Model); err != nil {
			return err
		}
	}
	return nil
...
// AssertCreateFineTuneRequestConstraints checks if the values respects the defined constraints
func AssertCreateFineTuneRequestConstraints(obj CreateFineTuneRequest) error {
	return nil
}
