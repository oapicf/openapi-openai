...
// AssertProjectRateLimitUpdateRequestRequired checks if the required fields are not zero-ed
func AssertProjectRateLimitUpdateRequestRequired(obj ProjectRateLimitUpdateRequest) error {
	return nil
}

// AssertProjectRateLimitUpdateRequestConstraints checks if the values respects the defined constraints
func AssertProjectRateLimitUpdateRequestConstraints(obj ProjectRateLimitUpdateRequest) error {
	return nil
}
