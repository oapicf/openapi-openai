...
// AssertRealtimeServerEventInputAudioBufferSpeechStartedRequired checks if the required fields are not zero-ed
func AssertRealtimeServerEventInputAudioBufferSpeechStartedRequired(obj RealtimeServerEventInputAudioBufferSpeechStarted) error {
	elements := map[string]interface{}{
		"event_id": obj.EventId,
		"type": obj.Type,
		"audio_start_ms": obj.AudioStartMs,
		"item_id": obj.ItemId,
	}
...
// AssertRealtimeServerEventInputAudioBufferSpeechStartedConstraints checks if the values respects the defined constraints
func AssertRealtimeServerEventInputAudioBufferSpeechStartedConstraints(obj RealtimeServerEventInputAudioBufferSpeechStarted) error {
	return nil
}
