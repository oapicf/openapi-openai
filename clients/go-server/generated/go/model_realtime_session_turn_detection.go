...
// AssertRealtimeSessionTurnDetectionRequired checks if the required fields are not zero-ed
func AssertRealtimeSessionTurnDetectionRequired(obj RealtimeSessionTurnDetection) error {
	return nil
}

// AssertRealtimeSessionTurnDetectionConstraints checks if the values respects the defined constraints
func AssertRealtimeSessionTurnDetectionConstraints(obj RealtimeSessionTurnDetection) error {
	return nil
}
