...
func AssertRunObjectRequired(obj RunObject) error {
	elements := map[string]interface{}{
		...
		"parallel_tool_calls": obj.ParallelToolCalls,
...
func AssertRunObjectConstraints(obj RunObject) error {
    if obj.RequiredAction != nil {
     	if err := AssertRunObjectRequiredActionConstraints(*obj.RequiredAction); err != nil {
     		return err
     	}
    }
    if obj.LastError != nil {
     	if err := AssertRunObjectLastErrorConstraints(*obj.LastError); err != nil {
     		return err
     	}
    }
    if obj.IncompleteDetails != nil {
     	if err := AssertRunObjectIncompleteDetailsConstraints(*obj.IncompleteDetails); err != nil {
     		return err
     	}
    }
	for _, el := range obj.Tools {
    ...
    if obj.Usage != nil {
     	if err := AssertRunCompletionUsageConstraints(*obj.Usage); err != nil {
     		return err
     	}
    }
