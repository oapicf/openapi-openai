...
`func NewCreateFineTuningJobRequestIntegrationsInner(type_ string, wandb CreateFineTuningJobRequestIntegrationsInnerWandb, ) *CreateFineTuningJobRequestIntegrationsInner`
...
`func (o *CreateFineTuningJobRequestIntegrationsInner) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *CreateFineTuningJobRequestIntegrationsInner) GetTypeOk() (*string, bool)`
...
`func (o *CreateFineTuningJobRequestIntegrationsInner) SetType(v string)`
