...
**Type_** | **String!** | The event type, must be &#x60;response.content_part.added&#x60;. | [default to null]
**responseId** | **String!** | The ID of the response. | [default to null]
**itemId** | **String!** | The ID of the item to which the content part was added. | [default to null]
...
**part** | [***RealtimeServerEventResponseContentPartAddedPart**](RealtimeServerEventResponseContentPartAdded_part.md) |  | [default to null]
