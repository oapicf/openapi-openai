## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `OpenAI API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the OpenAI API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | OpenAI                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | openai                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | OpenAIConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | OpenAIRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| OpenAI.Client    | use the "dispatch" functions to send requests       |
| OpenAI.Core      | core functions, config and request types            |
| OpenAI.API       | construct api requests                              |
| OpenAI.Model     | describes api models                                |
| OpenAI.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| OpenAI.ModelLens | lenses for model fields                             |
| OpenAI.Logging   | logging functions and utils                         |
