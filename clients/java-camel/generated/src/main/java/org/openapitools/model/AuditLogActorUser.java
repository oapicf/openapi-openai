...
@Schema(name = "AuditLogActorUser", description = "The user who performed the audit logged action.")
...
public class AuditLogActorUser {
  ...
  @Schema(name = "email", description = "The user email.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("email")
