...
@Schema(name = "RealtimeServerEventResponseAudioDelta", description = "Returned when the model-generated audio is updated.")
...
public class RealtimeServerEventResponseAudioDelta {
   ...
   */
  public RealtimeServerEventResponseAudioDelta(String eventId, TypeEnum type, String responseId, String itemId, Integer outputIndex, Integer contentIndex, String delta) {
   ...
   */
  @NotNull 
  @Schema(name = "type", description = "The event type, must be `response.audio.delta`.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("type")
   ...
   */
  @NotNull 
  @Schema(name = "delta", description = "Base64-encoded audio data delta.", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("delta")
