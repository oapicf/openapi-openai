...
@Schema(name = "RunStreamEvent_oneOf", description = "Occurs when a new [run](/docs/api-reference/runs/object) is created.")
...
public class RunStreamEventOneOf implements RunStreamEvent {
