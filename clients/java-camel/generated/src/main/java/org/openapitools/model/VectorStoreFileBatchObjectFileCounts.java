...
public class VectorStoreFileBatchObjectFileCounts {
   ...
   */
  @NotNull 
  @Schema(name = "completed", description = "The number of files that have been processed.", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull 
  @Schema(name = "cancelled", description = "The number of files that where cancelled.", requiredMode = Schema.RequiredMode.REQUIRED)
