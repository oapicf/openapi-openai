...
@Schema(name = "VectorStoreFileObject_last_error", description = "The last error associated with this vector store file. Will be `null` if there are no errors.")
@JsonTypeName("VectorStoreFileObject_last_error")
