...
To initiate an instance of `UploadsApi`, you can use micronaut's `ApplicationContext`:
```java
/* imports
import io.micronaut.runtime.Micronaut;
import io.micronaut.context.ApplicationContext;
import org.openapitools.api.UploadsApi;
*/

ApplicationContext context = Micronaut.run(/* ... */);
PetApi apiInstance = context.getBean(UploadsApi.class);
```
...
# **addUploadPart**
```java
Mono<UploadPart> UploadsApi.addUploadPart(uploadIddata)
```
...
# **cancelUpload**
```java
Mono<Upload> UploadsApi.cancelUpload(uploadId)
```
...
# **completeUpload**
```java
Mono<Upload> UploadsApi.completeUpload(uploadIdcompleteUploadRequest)
```
...
# **createUpload**
```java
Mono<Upload> UploadsApi.createUpload(createUploadRequest)
```
