...
The class is defined in **[VectorStoreObject.java](../../src/main/java/org/openapitools/model/VectorStoreObject.java)**
...
**expiresAt** | `Integer` | The Unix timestamp (in seconds) for when the vector store will expire. |  [optional property]
