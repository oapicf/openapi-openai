...
@JsonPropertyOrder({
  ...
  RealtimeSessionCreateRequestTurnDetection.JSON_PROPERTY_THRESHOLD,
  RealtimeSessionCreateRequestTurnDetection.JSON_PROPERTY_PREFIX_PADDING_MS,
  RealtimeSessionCreateRequestTurnDetection.JSON_PROPERTY_SILENCE_DURATION_MS,
...
public class RealtimeSessionCreateRequestTurnDetection {
    ...
    public static final String JSON_PROPERTY_CREATE_RESPONSE = "create_response";
     ...
     */
    @Nullable
    @JsonProperty(JSON_PROPERTY_CREATE_RESPONSE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
