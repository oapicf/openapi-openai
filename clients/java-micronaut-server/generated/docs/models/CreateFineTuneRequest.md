...
The class is defined in **[CreateFineTuneRequest.java](../../src/main/java/org/openapitools/model/CreateFineTuneRequest.java)**
...
**suffix** | `String` | A string of up to 40 characters that will be added to your fine-tuned model name.  For example, a &#x60;suffix&#x60; of \&quot;custom-model-name\&quot; would produce a model name like &#x60;ada:ft-your-org:custom-model-name-2022-02-15-04-21-04&#x60;.  |  [optional property]
