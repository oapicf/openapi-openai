...
public class AssistantsController {
    ...
    public Mono<RunObject> createRun(
        ...
        @QueryValue(value="include[]") @Nullable List<String> include
    ) {
    ...
    @Operation(
        ...
        parameters = {
            ...
            @Parameter(name = "messageId", description = "The ID of the message to delete.", required = true)
        },
        security = {
            @SecurityRequirement(name = "ApiKeyAuth")
        }
    )
    @Delete(uri="/threads/{thread_id}/messages/{message_id}")
    @Produces(value = {"application/json"})
    @Secured({SecurityRule.IS_AUTHENTICATED})
    public Mono<DeleteMessageResponse> deleteMessage(
        @PathVariable(value="thread_id") @NotNull String threadId, 
