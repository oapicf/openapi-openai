 ...
 */
@Schema(name = "VectorStoreFileObject_chunking_strategy", description = "The strategy used to chunk the file.")
@JsonPropertyOrder({
  VectorStoreFileObjectChunkingStrategy.JSON_PROPERTY_TYPE,
  VectorStoreFileObjectChunkingStrategy.JSON_PROPERTY_STATIC
})
