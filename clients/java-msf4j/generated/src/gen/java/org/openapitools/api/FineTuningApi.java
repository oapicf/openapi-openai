...
public class FineTuningApi  {
   private final FineTuningApiService delegate = FineTuningApiServiceFactory.getFineTuningApi();
    ...
    throws NotFoundException {
        return delegate.cancelFineTuningJob(fineTuningJobId);
    }
    @POST
    ...
    throws NotFoundException {
        return delegate.createFineTuningJob(createFineTuningJobRequest);
    }
    @GET
    ...
    public Response listFineTuningEvents(@ApiParam(value = "The ID of the fine-tuning job to get events for. ",required=true) @PathParam("fine_tuning_job_id") String fineTuningJobId
,@ApiParam(value = "Identifier for the last event from the previous pagination request.") @QueryParam("after") String after
,@ApiParam(value = "Number of events to retrieve.", defaultValue="20") @DefaultValue("20") @QueryParam("limit") Integer limit
)
    throws NotFoundException {
        return delegate.listFineTuningEvents(fineTuningJobId,after,limit);
    }
    @GET
    ...
    public Response listFineTuningJobCheckpoints(@ApiParam(value = "The ID of the fine-tuning job to get checkpoints for. ",required=true) @PathParam("fine_tuning_job_id") String fineTuningJobId
,@ApiParam(value = "Identifier for the last checkpoint ID from the previous pagination request.") @QueryParam("after") String after
,@ApiParam(value = "Number of checkpoints to retrieve.", defaultValue="10") @DefaultValue("10") @QueryParam("limit") Integer limit
)
    throws NotFoundException {
        return delegate.listFineTuningJobCheckpoints(fineTuningJobId,after,limit);
    }
    @GET
    ...
    public Response listPaginatedFineTuningJobs(@ApiParam(value = "Identifier for the last job from the previous pagination request.") @QueryParam("after") String after
,@ApiParam(value = "Number of fine-tuning jobs to retrieve.", defaultValue="20") @DefaultValue("20") @QueryParam("limit") Integer limit
)
    throws NotFoundException {
        return delegate.listPaginatedFineTuningJobs(after,limit);
    }
    @GET
    ...
    throws NotFoundException {
        return delegate.retrieveFineTuningJob(fineTuningJobId);
    }
}
