...
,@ApiParam(value = "" ,required=true) CreateRunRequest createRunRequest
    ...
    throws NotFoundException {
        return delegate.createRun(threadId,createRunRequest);
    }
    @POST
...
,@ApiParam(value = "The ID of the message to retrieve.",required=true) @PathParam("message_id") String messageId
    ...
    public Response getMessageFile(@ApiParam(value = "The ID of the thread to which the message and File belong.",required=true) @PathParam("thread_id") String threadId
,@ApiParam(value = "The ID of the message the file belongs to.",required=true) @PathParam("message_id") String messageId
,@ApiParam(value = "The ID of the file being retrieved.",required=true) @PathParam("file_id") String fileId
)
    throws NotFoundException {
        return delegate.getMessageFile(threadId,messageId,fileId);
    }
    @GET
...
,@ApiParam(value = "The ID of the run step to retrieve.",required=true) @PathParam("step_id") String stepId
    ...
    throws NotFoundException {
        return delegate.getRunStep(threadId,runId,stepId);
    }
    @GET
    @Path("/{thread_id}")
    ...
    public Response listMessageFiles(@ApiParam(value = "The ID of the thread that the message and files belong to.",required=true) @PathParam("thread_id") String threadId
,@ApiParam(value = "The ID of the message that the files belongs to.",required=true) @PathParam("message_id") String messageId
...
,@ApiParam(value = "A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. ") @QueryParam("before") String before
    ...
    throws NotFoundException {
        return delegate.listMessageFiles(threadId,messageId,limit,order,after,before);
    }
    @GET
    @Path("/{thread_id}/messages")
...
,@ApiParam(value = "A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. ") @QueryParam("before") String before
    ...
    throws NotFoundException {
        return delegate.listRunSteps(threadId,runId,limit,order,after,before);
    }
    @GET
    @Path("/{thread_id}/runs")
