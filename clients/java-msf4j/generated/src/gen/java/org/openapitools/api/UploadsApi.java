...
public class UploadsApi  {
   private final UploadsApiService delegate = UploadsApiServiceFactory.getUploadsApi();
    ...
    public Response addUploadPart(@ApiParam(value = "The ID of the Upload. ",required=true) @PathParam("upload_id") String uploadId
,
            @FormDataParam("data") InputStream dataInputStream,
            @FormDataParam("data") FileInfo dataDetail
)
    throws NotFoundException {
        return delegate.addUploadPart(uploadId,dataInputStream, dataDetail);
    }
    @POST
    ...
    throws NotFoundException {
        return delegate.cancelUpload(uploadId);
    }
    @POST
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK", response = Upload.class) })
    public Response completeUpload(@ApiParam(value = "The ID of the Upload. ",required=true) @PathParam("upload_id") String uploadId
,@ApiParam(value = "" ,required=true) CompleteUploadRequest completeUploadRequest
)
    throws NotFoundException {
        return delegate.completeUpload(uploadId,completeUploadRequest);
    }
    @POST
    ...
    throws NotFoundException {
        return delegate.createUpload(createUploadRequest);
    }
}
