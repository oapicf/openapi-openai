...
public class OrganizationApiServiceImpl extends OrganizationApiService {
    @Override
    public Response adminApiKeysCreate(AdminApiKeysCreateRequest adminApiKeysCreateRequest
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response adminApiKeysDelete(String keyId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response adminApiKeysGet(String keyId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response adminApiKeysList(String after
, String order
, Integer limit
 ) throws NotFoundException {
        // do some magic!
    ...
    @Override
    public Response archiveProject(String projectId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response createProject(ProjectCreateRequest projectCreateRequest
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response createProjectServiceAccount(String projectId
, ProjectServiceAccountCreateRequest projectServiceAccountCreateRequest
    ...
    @Override
    public Response createProjectUser(String projectId
, ProjectUserCreateRequest projectUserCreateRequest
    ...
    @Override
    public Response deleteInvite(String inviteId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response deleteProjectApiKey(String projectId
, String keyId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    ...
    @Override
    public Response deleteProjectServiceAccount(String projectId
, String serviceAccountId
    ...
    @Override
    public Response deleteProjectUser(String projectId
, String userId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    ...
    @Override
    public Response inviteUser(InviteRequest inviteRequest
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response listAuditLogs(ListAuditLogsEffectiveAtParameter effectiveAt
...
, String before
    ...
    @Override
    public Response listInvites(Integer limit
, String after
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    ...
    @Override
    public Response listProjectApiKeys(String projectId
, Integer limit
, String after
 ) throws NotFoundException {
        // do some magic!
    ...
    @Override
    public Response listProjectRateLimits(String projectId
, Integer limit
, String after
, String before
 ) throws NotFoundException {
    ...
    @Override
    public Response listProjectServiceAccounts(String projectId
, Integer limit
, String after
 ) throws NotFoundException {
        // do some magic!
    ...
    @Override
    public Response listProjectUsers(String projectId
, Integer limit
, String after
 ) throws NotFoundException {
        // do some magic!
    ...
    @Override
    public Response listProjects(Integer limit
, String after
...
, String after
    ...
    @Override
    public Response modifyProject(String projectId
, ProjectUpdateRequest projectUpdateRequest
    ...
    @Override
    public Response modifyProjectUser(String projectId
, String userId
, ProjectUserUpdateRequest projectUserUpdateRequest
    ...
    @Override
    public Response modifyUser(String userId
, UserRoleUpdateRequest userRoleUpdateRequest
    ...
    @Override
    public Response retrieveInvite(String inviteId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response retrieveProject(String projectId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response retrieveProjectApiKey(String projectId
, String keyId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    ...
    @Override
    public Response retrieveProjectServiceAccount(String projectId
, String serviceAccountId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    ...
    @Override
    public Response retrieveProjectUser(String projectId
, String userId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    ...
    @Override
    public Response retrieveUser(String userId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response updateProjectRateLimits(String projectId
, String rateLimitId
, ProjectRateLimitUpdateRequest projectRateLimitUpdateRequest
    ...
    @Override
    public Response usageAudioSpeeches(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> projectIds
, List<String> userIds
...
, String page
    ...
    @Override
    public Response usageAudioTranscriptions(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> projectIds
, List<String> userIds
...
, String page
    ...
    @Override
    public Response usageCodeInterpreterSessions(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> projectIds
, List<String> groupBy
...
, String page
    ...
    @Override
    public Response usageCompletions(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> projectIds
, List<String> userIds
...
, String page
    ...
    @Override
    public Response usageCosts(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> projectIds
, List<String> groupBy
...
, String page
    ...
    @Override
    public Response usageEmbeddings(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> projectIds
, List<String> userIds
...
, String page
    ...
    @Override
    public Response usageImages(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> sources
, List<String> sizes
...
, String page
    ...
    @Override
    public Response usageModerations(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> projectIds
, List<String> userIds
...
, String page
    ...
    @Override
    public Response usageVectorStores(Integer startTime
, Integer endTime
, String bucketWidth
, List<String> projectIds
, List<String> groupBy
