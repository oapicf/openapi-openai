...
, String runId
    ...
    @Override
    public Response createMessage(String threadId
...
, CreateRunRequest createRunRequest
    ...
    @Override
    public Response createThread(CreateThreadRequest createThreadRequest
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    ...
    @Override
    public Response deleteThread(String threadId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
    public Response getMessage(String threadId
, String messageId
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
...
, String before
    ...
    @Override
    public Response listMessages(String threadId
, Integer limit
, String order
, String after
, String before
, String runId
    ...
    @Override
    public Response listRunSteps(String threadId
, String runId
, Integer limit
, String order
, String after
, String before
    ...
    @Override
    public Response listRuns(String threadId
, Integer limit
, String order
, String after
, String before
    ...
    @Override
    public Response modifyMessage(String threadId
, String messageId
, ModifyMessageRequest modifyMessageRequest
    ...
    @Override
    public Response modifyRun(String threadId
, String runId
, ModifyRunRequest modifyRunRequest
    ...
    @Override
    public Response modifyThread(String threadId
, ModifyThreadRequest modifyThreadRequest
    ...
    @Override
    public Response submitToolOuputsToRun(String threadId
, String runId
