...
public class UploadsApiServiceImpl extends UploadsApiService {
    @Override
    public Response addUploadPart(String uploadId
, InputStream dataInputStream, FileInfo dataDetail
    ...
    @Override
    public Response completeUpload(String uploadId
, CompleteUploadRequest completeUploadRequest
    ...
    @Override
    public Response createUpload(CreateUploadRequest createUploadRequest
 ) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
