...
public interface AssistantsApi {
    ...
    ResponseEntity<RunObject> createRun(@ApiParam(value = "The ID of the thread to run.",required=true ) @PathVariable("thread_id") String threadId,@ApiParam(value = "" ,required=true )   @RequestBody CreateRunRequest createRunRequest,@ApiParam(value = "A list of additional fields to include in the response. Currently the only supported value is `step_details.tool_calls[*].file_search.results[*].content` to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information. ", allowableValues = "step_details.tool_calls[*].file_search.results[*].content")  @RequestParam(value = "include[]", required = false) List<String> include, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
    ...
    ResponseEntity<DeleteMessageResponse> deleteMessage(@ApiParam(value = "The ID of the thread to which this message belongs.",required=true ) @PathVariable("thread_id") String threadId,@ApiParam(value = "The ID of the message to delete.",required=true ) @PathVariable("message_id") String messageId, @RequestHeader(value = "Accept", required = false) String accept) throws Exception;
