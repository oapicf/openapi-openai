...
@Autowired
    ...
    public ResponseEntity<CreateTranscription200Response> createTranscription(@ApiParam(value = "file detail")  @RequestPart("file") MultipartFile file,
        ...
        @ApiParam(value = "", allowableValues="json, text, srt, verbose_json, vtt", defaultValue="json") @RequestPart(value="response_format", required=false)  AudioResponseFormat responseFormat,
