...
public class AssistantsApiTest {
    ...
    ResponseEntity<RunObject> response = api.createRun(threadId, createRunRequest, include , accept);
    ...
    ResponseEntity<DeleteMessageResponse> response = api.deleteMessage(threadId, messageId , accept);
    ...
    public void getRunStepTest() throws Exception {
        ...
        String stepId = null;
        List<String> include = null;
    ResponseEntity<RunStepObject> response = api.getRunStep(threadId, runId, stepId, include , accept);
    ...
    public void listRunStepsTest() throws Exception {
        ...
        String before = null;
        List<String> include = null;
    ResponseEntity<ListRunStepsResponse> response = api.listRunSteps(threadId, runId, limit, order, after, before, include , accept);
