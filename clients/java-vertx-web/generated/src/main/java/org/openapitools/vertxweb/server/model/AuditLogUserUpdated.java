...
import org.openapitools.vertxweb.server.model.AuditLogUserUpdatedChangesRequested;
...
public class AuditLogUserUpdated   {
  ...
  public AuditLogUserUpdated (String id, AuditLogUserUpdatedChangesRequested changesRequested) {
    this.id = id;
