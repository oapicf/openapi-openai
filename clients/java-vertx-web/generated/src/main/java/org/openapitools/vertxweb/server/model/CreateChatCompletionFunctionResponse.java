...
import org.openapitools.vertxweb.server.model.CreateChatCompletionFunctionResponseChoicesInner;
...
public class CreateChatCompletionFunctionResponse   {
  ...
  public CreateChatCompletionFunctionResponse (String id, List<CreateChatCompletionFunctionResponseChoicesInner> choices, Integer created, String model, String systemFingerprint, ObjectEnum _object, CompletionUsage usage) {
    this.id = id;
