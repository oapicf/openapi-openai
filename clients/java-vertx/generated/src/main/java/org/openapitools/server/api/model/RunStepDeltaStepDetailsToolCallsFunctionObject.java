...
public class RunStepDeltaStepDetailsToolCallsFunctionObject   {
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObject (Integer index, String id, TypeEnum type, RunStepDeltaStepDetailsToolCallsFunctionObjectFunction function) {
    this.index = index;
    this.id = id;
    this.type = type;
