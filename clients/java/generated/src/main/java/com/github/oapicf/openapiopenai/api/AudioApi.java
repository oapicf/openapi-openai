...
public class AudioApi {
     ...
     */
    public CreateTranscription200Response createTranscription(@javax.annotation.Nonnull File _file, @javax.annotation.Nonnull CreateTranscriptionRequestModel model, @javax.annotation.Nullable String language, @javax.annotation.Nullable String prompt, @javax.annotation.Nullable String responseFormat, @javax.annotation.Nullable BigDecimal temperature, @javax.annotation.Nullable List<String> timestampGranularities) throws ApiException {
     ...
     */
    public okhttp3.Call createTranscriptionAsync(@javax.annotation.Nonnull File _file, @javax.annotation.Nonnull CreateTranscriptionRequestModel model, @javax.annotation.Nullable String language, @javax.annotation.Nullable String prompt, @javax.annotation.Nullable String responseFormat, @javax.annotation.Nullable BigDecimal temperature, @javax.annotation.Nullable List<String> timestampGranularities, final ApiCallback<CreateTranscription200Response> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call createTranslationAsync(@javax.annotation.Nonnull File _file, @javax.annotation.Nonnull CreateTranscriptionRequestModel model, @javax.annotation.Nullable String prompt, @javax.annotation.Nullable String responseFormat, @javax.annotation.Nullable BigDecimal temperature, final ApiCallback<CreateTranslation200Response> _callback) throws ApiException {
