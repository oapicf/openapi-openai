...
public class ChatApi {
     ...
     */
    public okhttp3.Call createChatCompletionCall(@javax.annotation.Nonnull CreateChatCompletionRequest createChatCompletionRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createChatCompletionValidateBeforeCall(@javax.annotation.Nonnull CreateChatCompletionRequest createChatCompletionRequest, final ApiCallback _callback) throws ApiException {
     ...
     */
    public CreateChatCompletionResponse createChatCompletion(@javax.annotation.Nonnull CreateChatCompletionRequest createChatCompletionRequest) throws ApiException {
     ...
     */
    public ApiResponse<CreateChatCompletionResponse> createChatCompletionWithHttpInfo(@javax.annotation.Nonnull CreateChatCompletionRequest createChatCompletionRequest) throws ApiException {
    ...
    /**
     * Creates a model response for the given chat conversation. Learn more in the [text generation](/docs/guides/text-generation), [vision](/docs/guides/vision), and [audio](/docs/guides/audio) guides.  Parameter support can differ depending on the model used to generate the response, particularly for newer reasoning models. Parameters that are only supported for reasoning models are noted below. For the current state of  unsupported parameters in reasoning models,  [refer to the reasoning guide](/docs/guides/reasoning).  (asynchronously)
     * 
     * @param createChatCompletionRequest  (required)
     ...
     */
    public okhttp3.Call createChatCompletionAsync(@javax.annotation.Nonnull CreateChatCompletionRequest createChatCompletionRequest, final ApiCallback<CreateChatCompletionResponse> _callback) throws ApiException {
