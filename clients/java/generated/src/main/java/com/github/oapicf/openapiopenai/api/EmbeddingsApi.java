...
public class EmbeddingsApi {
     ...
     */
    public okhttp3.Call createEmbeddingCall(@javax.annotation.Nonnull CreateEmbeddingRequest createEmbeddingRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createEmbeddingValidateBeforeCall(@javax.annotation.Nonnull CreateEmbeddingRequest createEmbeddingRequest, final ApiCallback _callback) throws ApiException {
     ...
     */
    public CreateEmbeddingResponse createEmbedding(@javax.annotation.Nonnull CreateEmbeddingRequest createEmbeddingRequest) throws ApiException {
     ...
     */
    public ApiResponse<CreateEmbeddingResponse> createEmbeddingWithHttpInfo(@javax.annotation.Nonnull CreateEmbeddingRequest createEmbeddingRequest) throws ApiException {
     ...
     */
    public okhttp3.Call createEmbeddingAsync(@javax.annotation.Nonnull CreateEmbeddingRequest createEmbeddingRequest, final ApiCallback<CreateEmbeddingResponse> _callback) throws ApiException {
