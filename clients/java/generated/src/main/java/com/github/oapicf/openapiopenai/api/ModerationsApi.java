...
public class ModerationsApi {
     ...
     */
    public okhttp3.Call createModerationCall(@javax.annotation.Nonnull CreateModerationRequest createModerationRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createModerationValidateBeforeCall(@javax.annotation.Nonnull CreateModerationRequest createModerationRequest, final ApiCallback _callback) throws ApiException {
     ...
     */
    public CreateModerationResponse createModeration(@javax.annotation.Nonnull CreateModerationRequest createModerationRequest) throws ApiException {
     ...
     */
    public ApiResponse<CreateModerationResponse> createModerationWithHttpInfo(@javax.annotation.Nonnull CreateModerationRequest createModerationRequest) throws ApiException {
    ...
    /**
     * Classifies if text and/or image inputs are potentially harmful. Learn more in the [moderation guide](/docs/guides/moderation).  (asynchronously)
     * 
     * @param createModerationRequest  (required)
     ...
     */
    public okhttp3.Call createModerationAsync(@javax.annotation.Nonnull CreateModerationRequest createModerationRequest, final ApiCallback<CreateModerationResponse> _callback) throws ApiException {
