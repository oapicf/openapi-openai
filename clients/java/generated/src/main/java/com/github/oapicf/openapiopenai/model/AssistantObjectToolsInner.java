...
public class AssistantObjectToolsInner extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<AssistantObjectToolsInner>() {
                ...
                public AssistantObjectToolsInner read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for AssistantObjectToolsInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AssistantObjectToolsInner(AssistantToolsCode o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AssistantObjectToolsInner(AssistantToolsFunction o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AssistantObjectToolsInner(AssistantToolsRetrieval o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for AssistantObjectToolsInner with oneOf schemas: AssistantToolsCode, AssistantToolsFunction, AssistantToolsRetrieval. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
    }
  }
