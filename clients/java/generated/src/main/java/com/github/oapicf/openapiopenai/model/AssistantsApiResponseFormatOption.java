...
public class AssistantsApiResponseFormatOption extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<AssistantsApiResponseFormatOption>() {
                ...
                public AssistantsApiResponseFormatOption read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for AssistantsApiResponseFormat failed with `%s`.", e.getMessage()));
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for AssistantsApiResponseFormatOption with oneOf schemas: AssistantsApiResponseFormat, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
