...
import com.github.oapicf.openapiopenai.model.AssistantsNamedToolChoice;
...
public class AssistantsApiToolChoiceOption extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<AssistantsApiToolChoiceOption>() {
                ...
                public AssistantsApiToolChoiceOption read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for AssistantsNamedToolChoice failed with `%s`.", e.getMessage()));
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for AssistantsApiToolChoiceOption with oneOf schemas: AssistantsNamedToolChoice, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
