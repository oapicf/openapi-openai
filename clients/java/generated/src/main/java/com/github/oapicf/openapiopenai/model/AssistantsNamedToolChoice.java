...
public class AssistantsNamedToolChoice {
  ...
  public AssistantsNamedToolChoice type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AssistantsNamedToolChoice function(@javax.annotation.Nullable AssistantsNamedToolChoiceFunction function) {
  ...
  public void setFunction(@javax.annotation.Nullable AssistantsNamedToolChoiceFunction function) {
    this.function = function;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssistantsNamedToolChoice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AssistantsNamedToolChoice is not found in the empty JSON string", AssistantsNamedToolChoice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssistantsNamedToolChoice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AssistantsNamedToolChoice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
