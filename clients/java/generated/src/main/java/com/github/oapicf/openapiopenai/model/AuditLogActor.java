...
public class AuditLogActor {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "session", "api_key"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuditLogActor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuditLogActor is not found in the empty JSON string", AuditLogActor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuditLogActor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuditLogActor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
