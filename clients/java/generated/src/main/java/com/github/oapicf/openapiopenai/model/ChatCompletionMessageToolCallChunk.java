...
public class ChatCompletionMessageToolCallChunk {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("index"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCompletionMessageToolCallChunk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCompletionMessageToolCallChunk is not found in the empty JSON string", ChatCompletionMessageToolCallChunk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatCompletionMessageToolCallChunk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatCompletionMessageToolCallChunk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
