...
public class ChatCompletionNamedToolChoiceFunction {
  ...
  public ChatCompletionNamedToolChoiceFunction name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCompletionNamedToolChoiceFunction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCompletionNamedToolChoiceFunction is not found in the empty JSON string", ChatCompletionNamedToolChoiceFunction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatCompletionNamedToolChoiceFunction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatCompletionNamedToolChoiceFunction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
