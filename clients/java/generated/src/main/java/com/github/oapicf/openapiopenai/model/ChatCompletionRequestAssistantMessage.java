...
public class ChatCompletionRequestAssistantMessage {
  ...
  public ChatCompletionRequestAssistantMessage content(@javax.annotation.Nullable String content) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "role", "name", "tool_calls", "function_call"));
