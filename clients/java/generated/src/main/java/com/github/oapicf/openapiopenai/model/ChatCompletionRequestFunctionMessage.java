...
public class ChatCompletionRequestFunctionMessage {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("role", "content", "name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("role", "content", "name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCompletionRequestFunctionMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCompletionRequestFunctionMessage is not found in the empty JSON string", ChatCompletionRequestFunctionMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatCompletionRequestFunctionMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatCompletionRequestFunctionMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
