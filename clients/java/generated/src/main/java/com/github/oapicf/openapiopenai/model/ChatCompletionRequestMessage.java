...
public class ChatCompletionRequestMessage extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<ChatCompletionRequestDeveloperMessage> adapterChatCompletionRequestDeveloperMessage = gson.getDelegateAdapter(this, TypeToken.get(ChatCompletionRequestDeveloperMessage.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<ChatCompletionRequestMessage>() {
                ...
                public void write(JsonWriter out, ChatCompletionRequestMessage value) throws IOException {
                    ...
                    // check if the actual instance is of the type `ChatCompletionRequestDeveloperMessage`
                    if (value.getActualInstance() instanceof ChatCompletionRequestDeveloperMessage) {
                        JsonElement element = adapterChatCompletionRequestDeveloperMessage.toJsonTree((ChatCompletionRequestDeveloperMessage)value.getActualInstance());
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage");
                }
                ...
                public ChatCompletionRequestMessage read(JsonReader in) throws IOException {
                    ...
                    // deserialize ChatCompletionRequestDeveloperMessage
                    try {
                        // validate the JSON object to see if any exception is thrown
                        ChatCompletionRequestDeveloperMessage.validateJsonElement(jsonElement);
                        actualAdapter = adapterChatCompletionRequestDeveloperMessage;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'ChatCompletionRequestDeveloperMessage'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChatCompletionRequestDeveloperMessage failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'ChatCompletionRequestDeveloperMessage'", e);
                    }
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChatCompletionRequestSystemMessage failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChatCompletionRequestUserMessage failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChatCompletionRequestAssistantMessage failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChatCompletionRequestToolMessage failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChatCompletionRequestFunctionMessage failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ChatCompletionRequestMessage: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ChatCompletionRequestMessage(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("ChatCompletionRequestDeveloperMessage", ChatCompletionRequestDeveloperMessage.class);
     ...
     * ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage
     *
     * It could be an instance of the 'oneOf' schemas.
     */
    @Override
    public void setActualInstance(Object instance) {
        if (instance instanceof ChatCompletionRequestDeveloperMessage) {
        ...
        throw new RuntimeException("Invalid instance type. Must be ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage");
    }
     ...
     * ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage
     *
     * @return The actual instance (ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `ChatCompletionRequestDeveloperMessage`. If the actual instance is not `ChatCompletionRequestDeveloperMessage`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `ChatCompletionRequestDeveloperMessage`
     * @throws ClassCastException if the instance is not `ChatCompletionRequestDeveloperMessage`
     */
    public ChatCompletionRequestDeveloperMessage getChatCompletionRequestDeveloperMessage() throws ClassCastException {
        return (ChatCompletionRequestDeveloperMessage)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        int validCount = 0;
        ArrayList<String> errorMessages = new ArrayList<>();
        // validate the json string with ChatCompletionRequestDeveloperMessage
        try {
            ChatCompletionRequestDeveloperMessage.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ChatCompletionRequestMessage with oneOf schemas: ChatCompletionRequestAssistantMessage, ChatCompletionRequestDeveloperMessage, ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
