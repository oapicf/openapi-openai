...
public class ChatCompletionRequestMessageContentPartImage {
  ...
  public ChatCompletionRequestMessageContentPartImage type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ChatCompletionRequestMessageContentPartImage imageUrl(@javax.annotation.Nonnull ChatCompletionRequestMessageContentPartImageImageUrl imageUrl) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCompletionRequestMessageContentPartImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCompletionRequestMessageContentPartImage is not found in the empty JSON string", ChatCompletionRequestMessageContentPartImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatCompletionRequestMessageContentPartImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatCompletionRequestMessageContentPartImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
