...
public class ChatCompletionRequestMessageContentPartImageImageUrl {
  ...
  public ChatCompletionRequestMessageContentPartImageImageUrl url(@javax.annotation.Nonnull URI url) {
    this.url = url;
    return this;
  }
  ...
  public ChatCompletionRequestMessageContentPartImageImageUrl detail(@javax.annotation.Nullable DetailEnum detail) {
    this.detail = detail;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCompletionRequestMessageContentPartImageImageUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCompletionRequestMessageContentPartImageImageUrl is not found in the empty JSON string", ChatCompletionRequestMessageContentPartImageImageUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatCompletionRequestMessageContentPartImageImageUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatCompletionRequestMessageContentPartImageImageUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
