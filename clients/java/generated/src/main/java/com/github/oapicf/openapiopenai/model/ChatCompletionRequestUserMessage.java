...
import com.github.oapicf.openapiopenai.model.ChatCompletionRequestUserMessageContent;
...
public class ChatCompletionRequestUserMessage {
  ...
  public ChatCompletionRequestUserMessage content(@javax.annotation.Nonnull ChatCompletionRequestUserMessageContent content) {
  ...
  public void setContent(@javax.annotation.Nonnull ChatCompletionRequestUserMessageContent content) {
    this.content = content;
  }


  public ChatCompletionRequestUserMessage role(@javax.annotation.Nonnull RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCompletionRequestUserMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCompletionRequestUserMessage is not found in the empty JSON string", ChatCompletionRequestUserMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatCompletionRequestUserMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatCompletionRequestUserMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
