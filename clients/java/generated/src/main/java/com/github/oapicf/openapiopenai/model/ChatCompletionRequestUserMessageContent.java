...
public class ChatCompletionRequestUserMessageContent extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final Type typeInstance = new TypeToken<List<ChatCompletionRequestMessageContentPart>>(){}.getType();
            final TypeAdapter<List<ChatCompletionRequestMessageContentPart>> adapterChatCompletionRequestMessageContentPartList = (TypeAdapter<List<ChatCompletionRequestMessageContentPart>>) gson.getDelegateAdapter(this, TypeToken.get(typeInstance));
            ...
            return (TypeAdapter<T>) new TypeAdapter<ChatCompletionRequestUserMessageContent>() {
                    ...
                    if (value.getActualInstance() instanceof List<?>) {
                      List<?> list = (List<?>) value.getActualInstance();
        	            if(list.get(0) instanceof ChatCompletionRequestMessageContentPart) {
        		            JsonArray array = adapterChatCompletionRequestMessageContentPartList.toJsonTree((List<ChatCompletionRequestMessageContentPart>)value.getActualInstance()).getAsJsonArray();
                ...
                public ChatCompletionRequestUserMessageContent read(JsonReader in) throws IOException {
                    ...
                    try {
                      ...
                      actualAdapter = adapterChatCompletionRequestMessageContentPartList;
                      match++;
    ...
    public ChatCompletionRequestUserMessageContent(List<ChatCompletionRequestMessageContentPart> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ChatCompletionRequestUserMessageContent(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     */
    public List<ChatCompletionRequestMessageContentPart> getChatCompletionRequestMessageContentPartList() throws ClassCastException {
