...
import com.github.oapicf.openapiopenai.model.ChatCompletionResponseMessageAudio;
import com.github.oapicf.openapiopenai.model.ChatCompletionResponseMessageFunctionCall;
...
public class ChatCompletionResponseMessage {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "refusal", "tool_calls", "role", "function_call", "audio"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("content", "refusal", "role"));
  }
