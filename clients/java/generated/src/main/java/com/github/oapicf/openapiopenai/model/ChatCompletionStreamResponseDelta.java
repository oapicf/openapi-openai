...
public class ChatCompletionStreamResponseDelta {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "function_call", "tool_calls", "role", "refusal"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCompletionStreamResponseDelta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCompletionStreamResponseDelta is not found in the empty JSON string", ChatCompletionStreamResponseDelta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatCompletionStreamResponseDelta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatCompletionStreamResponseDelta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
