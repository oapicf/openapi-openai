...
public class ChatCompletionStreamResponseDeltaFunctionCall {
  ...
  public ChatCompletionStreamResponseDeltaFunctionCall arguments(@javax.annotation.Nullable String arguments) {
  ...
  public ChatCompletionStreamResponseDeltaFunctionCall name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatCompletionStreamResponseDeltaFunctionCall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ChatCompletionStreamResponseDeltaFunctionCall is not found in the empty JSON string", ChatCompletionStreamResponseDeltaFunctionCall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatCompletionStreamResponseDeltaFunctionCall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatCompletionStreamResponseDeltaFunctionCall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
