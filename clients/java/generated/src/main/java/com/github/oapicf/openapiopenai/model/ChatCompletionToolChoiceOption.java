...
public class ChatCompletionToolChoiceOption extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ChatCompletionToolChoiceOption>() {
                ...
                public ChatCompletionToolChoiceOption read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChatCompletionNamedToolChoice failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ChatCompletionToolChoiceOption: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ChatCompletionToolChoiceOption with oneOf schemas: ChatCompletionNamedToolChoice, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
