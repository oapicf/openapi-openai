...
import com.github.oapicf.openapiopenai.model.CreateAssistantRequestToolResourcesFileSearchVectorStoresInner;
...
public class CreateAssistantRequestToolResourcesFileSearch {
  ...
  public CreateAssistantRequestToolResourcesFileSearch vectorStoreIds(@javax.annotation.Nullable List<String> vectorStoreIds) {
  ...
  public CreateAssistantRequestToolResourcesFileSearch vectorStores(@javax.annotation.Nullable List<CreateAssistantRequestToolResourcesFileSearchVectorStoresInner> vectorStores) {
  ...
  public void setVectorStores(@javax.annotation.Nullable List<CreateAssistantRequestToolResourcesFileSearchVectorStoresInner> vectorStores) {
    this.vectorStores = vectorStores;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAssistantRequestToolResourcesFileSearch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAssistantRequestToolResourcesFileSearch is not found in the empty JSON string", CreateAssistantRequestToolResourcesFileSearch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAssistantRequestToolResourcesFileSearch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateAssistantRequestToolResourcesFileSearch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
