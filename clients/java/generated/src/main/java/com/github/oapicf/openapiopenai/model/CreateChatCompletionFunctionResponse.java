...
import com.github.oapicf.openapiopenai.model.CreateChatCompletionFunctionResponseChoicesInner;
...
public class CreateChatCompletionFunctionResponse {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateChatCompletionFunctionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateChatCompletionFunctionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateChatCompletionFunctionResponse is not found in the empty JSON string", CreateChatCompletionFunctionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateChatCompletionFunctionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateChatCompletionFunctionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateChatCompletionFunctionResponse.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArraychoices.size(); i++) {
        CreateChatCompletionFunctionResponseChoicesInner.validateJsonElement(jsonArraychoices.get(i));
      };
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateChatCompletionFunctionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateChatCompletionFunctionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateChatCompletionFunctionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateChatCompletionFunctionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateChatCompletionFunctionResponse>() {
           @Override
           public void write(JsonWriter out, CreateChatCompletionFunctionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateChatCompletionFunctionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateChatCompletionFunctionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateChatCompletionFunctionResponse
   * @throws IOException if the JSON string is invalid with respect to CreateChatCompletionFunctionResponse
   */
  public static CreateChatCompletionFunctionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateChatCompletionFunctionResponse.class);
  }

  /**
   * Convert an instance of CreateChatCompletionFunctionResponse to an JSON string
   *
   * @return JSON string
   */
