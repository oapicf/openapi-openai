...
public class CreateChatCompletionRequestFunctionCall extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateChatCompletionRequestFunctionCall>() {
                ...
                public CreateChatCompletionRequestFunctionCall read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for ChatCompletionFunctionCallOption failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateChatCompletionRequestFunctionCall: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateChatCompletionRequestFunctionCall(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CreateChatCompletionRequestFunctionCall with oneOf schemas: ChatCompletionFunctionCallOption, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
