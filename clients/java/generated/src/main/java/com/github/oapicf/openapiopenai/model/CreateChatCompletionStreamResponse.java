...
import com.github.oapicf.openapiopenai.model.CreateChatCompletionStreamResponseUsage;
...
public class CreateChatCompletionStreamResponse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("usage") != null && !jsonObj.get("usage").isJsonNull()) {
        CreateChatCompletionStreamResponseUsage.validateJsonElement(jsonObj.get("usage"));
      }
  }
