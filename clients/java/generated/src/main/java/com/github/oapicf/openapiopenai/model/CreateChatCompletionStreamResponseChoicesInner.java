...
public class CreateChatCompletionStreamResponseChoicesInner {
  ...
  public CreateChatCompletionStreamResponseChoicesInner delta(@javax.annotation.Nonnull ChatCompletionStreamResponseDelta delta) {
    this.delta = delta;
    return this;
  }
  ...
  public CreateChatCompletionStreamResponseChoicesInner logprobs(@javax.annotation.Nullable CreateChatCompletionResponseChoicesInnerLogprobs logprobs) {
  ...
  public CreateChatCompletionStreamResponseChoicesInner finishReason(@javax.annotation.Nullable FinishReasonEnum finishReason) {
  ...
  public CreateChatCompletionStreamResponseChoicesInner index(@javax.annotation.Nonnull Integer index) {
    this.index = index;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delta", "logprobs", "finish_reason", "index"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("delta", "finish_reason", "index"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateChatCompletionStreamResponseChoicesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateChatCompletionStreamResponseChoicesInner is not found in the empty JSON string", CreateChatCompletionStreamResponseChoicesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateChatCompletionStreamResponseChoicesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateChatCompletionStreamResponseChoicesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
