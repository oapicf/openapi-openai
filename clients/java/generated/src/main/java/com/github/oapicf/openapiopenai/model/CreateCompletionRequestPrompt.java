...
public class CreateCompletionRequestPrompt extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final Type typeInstanceListListInteger = new TypeToken<List<List<Integer>>>(){}.getType();
            final TypeAdapter<List<List<Integer>>> adapterListListInteger = (TypeAdapter<List<List<Integer>>>) gson.getDelegateAdapter(this, TypeToken.get(typeInstanceListListInteger));
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCompletionRequestPrompt>() {
                ...
                public CreateCompletionRequestPrompt read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateCompletionRequestPrompt: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateCompletionRequestPrompt(Object o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
     ...
     */
    public List<List<Integer>> getListListInteger() throws ClassCastException {
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreateCompletionRequestPrompt
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for CreateCompletionRequestPrompt with oneOf schemas: List<Integer>, List<List<Integer>>, List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
