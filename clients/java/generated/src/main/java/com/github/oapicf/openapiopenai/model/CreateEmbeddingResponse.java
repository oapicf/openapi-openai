...
public class CreateEmbeddingResponse {
  ...
  public CreateEmbeddingResponse data(@javax.annotation.Nonnull List<Embedding> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<Embedding> data) {
    this.data = data;
  }


  public CreateEmbeddingResponse model(@javax.annotation.Nonnull String model) {
    this.model = model;
    return this;
  }
  ...
  public CreateEmbeddingResponse _object(@javax.annotation.Nonnull ObjectEnum _object) {
  ...
  public CreateEmbeddingResponse usage(@javax.annotation.Nonnull CreateEmbeddingResponseUsage usage) {
    this.usage = usage;
    return this;
  }
  ...
  public void setUsage(@javax.annotation.Nonnull CreateEmbeddingResponseUsage usage) {
    this.usage = usage;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("data", "model", "object", "usage"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEmbeddingResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateEmbeddingResponse is not found in the empty JSON string", CreateEmbeddingResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEmbeddingResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateEmbeddingResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
