...
public class CreateFineTuningJobRequestIntegrationsInner {
  ...
  public CreateFineTuningJobRequestIntegrationsInner type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CreateFineTuningJobRequestIntegrationsInner wandb(@javax.annotation.Nonnull CreateFineTuningJobRequestIntegrationsInnerWandb wandb) {
    this.wandb = wandb;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "wandb"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "wandb"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFineTuningJobRequestIntegrationsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateFineTuningJobRequestIntegrationsInner is not found in the empty JSON string", CreateFineTuningJobRequestIntegrationsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFineTuningJobRequestIntegrationsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateFineTuningJobRequestIntegrationsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
