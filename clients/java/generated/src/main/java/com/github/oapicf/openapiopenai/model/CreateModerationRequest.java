...
public class CreateModerationRequest {
  ...
  public CreateModerationRequest input(@javax.annotation.Nonnull CreateModerationRequestInput input) {
    this.input = input;
    return this;
  }
  ...
  public void setInput(@javax.annotation.Nonnull CreateModerationRequestInput input) {
    this.input = input;
  }


  public CreateModerationRequest model(@javax.annotation.Nullable CreateModerationRequestModel model) {
    this.model = model;
    return this;
  }
  ...
  public void setModel(@javax.annotation.Nullable CreateModerationRequestModel model) {
    this.model = model;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("input", "model"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateModerationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateModerationRequest is not found in the empty JSON string", CreateModerationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateModerationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateModerationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
