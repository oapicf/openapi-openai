...
public class CreateModerationRequestInputOneOfInnerOneOf {
  ...
  public CreateModerationRequestInputOneOfInnerOneOf type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CreateModerationRequestInputOneOfInnerOneOf imageUrl(@javax.annotation.Nonnull CreateModerationRequestInputOneOfInnerOneOfImageUrl imageUrl) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateModerationRequestInputOneOfInnerOneOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateModerationRequestInputOneOfInnerOneOf is not found in the empty JSON string", CreateModerationRequestInputOneOfInnerOneOf.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateModerationRequestInputOneOfInnerOneOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateModerationRequestInputOneOfInnerOneOf` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
