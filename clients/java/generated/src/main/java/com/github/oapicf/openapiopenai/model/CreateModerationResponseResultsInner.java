...
public class CreateModerationResponseResultsInner {
  ...
  public static final String SERIALIZED_NAME_CATEGORY_APPLIED_INPUT_TYPES = "category_applied_input_types";
  @SerializedName(SERIALIZED_NAME_CATEGORY_APPLIED_INPUT_TYPES)
  @javax.annotation.Nonnull
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("flagged", "categories", "category_scores", "category_applied_input_types"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("flagged", "categories", "category_scores", "category_applied_input_types"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the required field `category_applied_input_types`
      CreateModerationResponseResultsInnerCategoryAppliedInputTypes.validateJsonElement(jsonObj.get("category_applied_input_types"));
  }
