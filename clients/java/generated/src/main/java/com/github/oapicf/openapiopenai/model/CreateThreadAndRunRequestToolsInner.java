...
public class CreateThreadAndRunRequestToolsInner extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateThreadAndRunRequestToolsInner>() {
                ...
                public CreateThreadAndRunRequestToolsInner read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateThreadAndRunRequestToolsInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateThreadAndRunRequestToolsInner(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
