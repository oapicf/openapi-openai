...
import com.github.oapicf.openapiopenai.model.CreateThreadRequestToolResources;
...
public class CreateThreadRequest {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("messages", "tool_resources", "metadata"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateThreadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateThreadRequest is not found in the empty JSON string", CreateThreadRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateThreadRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateThreadRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("tool_resources") != null && !jsonObj.get("tool_resources").isJsonNull()) {
        CreateThreadRequestToolResources.validateJsonElement(jsonObj.get("tool_resources"));
      }
  }
