...
public class CreateTranslationResponseVerboseJson {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("language", "duration", "text", "segments"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTranslationResponseVerboseJson.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateTranslationResponseVerboseJson is not found in the empty JSON string", CreateTranslationResponseVerboseJson.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTranslationResponseVerboseJson.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateTranslationResponseVerboseJson` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
