...
public class DeleteModelResponse {
  ...
  public DeleteModelResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public DeleteModelResponse deleted(@javax.annotation.Nonnull Boolean deleted) {
  ...
  public DeleteModelResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteModelResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteModelResponse is not found in the empty JSON string", DeleteModelResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteModelResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteModelResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
