...
public class FineTuneChatCompletionRequestAssistantMessage {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("content", "refusal", "role", "name", "audio", "tool_calls", "function_call", "weight"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FineTuneChatCompletionRequestAssistantMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FineTuneChatCompletionRequestAssistantMessage is not found in the empty JSON string", FineTuneChatCompletionRequestAssistantMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FineTuneChatCompletionRequestAssistantMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FineTuneChatCompletionRequestAssistantMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
