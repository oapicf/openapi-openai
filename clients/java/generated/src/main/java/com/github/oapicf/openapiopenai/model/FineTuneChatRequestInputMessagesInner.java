            ...
            return (TypeAdapter<T>) new TypeAdapter<FineTuneChatRequestInputMessagesInner>() {
                ...
                public FineTuneChatRequestInputMessagesInner read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for FineTuneChatCompletionRequestAssistantMessage failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for FineTuneChatRequestInputMessagesInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
