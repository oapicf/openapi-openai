...
public class Image {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("b64_json", "url", "revised_prompt"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("b64_json") != null && !jsonObj.get("b64_json").isJsonNull()) && !jsonObj.get("b64_json").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `b64_json` to be a primitive type in the JSON string but got `%s`", jsonObj.get("b64_json").toString()));
      }
      ...
      if ((jsonObj.get("revised_prompt") != null && !jsonObj.get("revised_prompt").isJsonNull()) && !jsonObj.get("revised_prompt").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `revised_prompt` to be a primitive type in the JSON string but got `%s`", jsonObj.get("revised_prompt").toString()));
      }
  }
