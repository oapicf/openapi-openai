...
public class ListAssistantFilesResponse {
  ...
  public ListAssistantFilesResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public ListAssistantFilesResponse data(@javax.annotation.Nonnull List<AssistantFileObject> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<AssistantFileObject> data) {
    this.data = data;
  }


  public ListAssistantFilesResponse firstId(@javax.annotation.Nonnull String firstId) {
  ...
  public ListAssistantFilesResponse lastId(@javax.annotation.Nonnull String lastId) {
    this.lastId = lastId;
    return this;
  }
  ...
  public ListAssistantFilesResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAssistantFilesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListAssistantFilesResponse is not found in the empty JSON string", ListAssistantFilesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAssistantFilesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListAssistantFilesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
