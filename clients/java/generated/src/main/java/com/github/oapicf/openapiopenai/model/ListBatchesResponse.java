...
public class ListBatchesResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "first_id", "last_id", "has_more", "object"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListBatchesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListBatchesResponse is not found in the empty JSON string", ListBatchesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListBatchesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListBatchesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
