...
public class ListMessageFilesResponse {
  ...
  public ListMessageFilesResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public ListMessageFilesResponse data(@javax.annotation.Nonnull List<MessageFileObject> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<MessageFileObject> data) {
    this.data = data;
  }


  public ListMessageFilesResponse firstId(@javax.annotation.Nonnull String firstId) {
  ...
  public ListMessageFilesResponse lastId(@javax.annotation.Nonnull String lastId) {
    this.lastId = lastId;
    return this;
  }
  ...
  public ListMessageFilesResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListMessageFilesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListMessageFilesResponse is not found in the empty JSON string", ListMessageFilesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListMessageFilesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListMessageFilesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
