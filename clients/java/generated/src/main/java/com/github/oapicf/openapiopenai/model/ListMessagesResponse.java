...
public class ListMessagesResponse {
  ...
  public ListMessagesResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public ListMessagesResponse data(@javax.annotation.Nonnull List<MessageObject> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<MessageObject> data) {
    this.data = data;
  }


  public ListMessagesResponse firstId(@javax.annotation.Nonnull String firstId) {
  ...
  public ListMessagesResponse lastId(@javax.annotation.Nonnull String lastId) {
    this.lastId = lastId;
    return this;
  }
  ...
  public ListMessagesResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListMessagesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListMessagesResponse is not found in the empty JSON string", ListMessagesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListMessagesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListMessagesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
