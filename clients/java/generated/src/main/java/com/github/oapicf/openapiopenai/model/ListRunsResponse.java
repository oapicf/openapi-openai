...
public class ListRunsResponse {
  ...
  public ListRunsResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public ListRunsResponse data(@javax.annotation.Nonnull List<RunObject> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<RunObject> data) {
    this.data = data;
  }


  public ListRunsResponse firstId(@javax.annotation.Nonnull String firstId) {
  ...
  public ListRunsResponse lastId(@javax.annotation.Nonnull String lastId) {
    this.lastId = lastId;
    return this;
  }
  ...
  public ListRunsResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRunsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListRunsResponse is not found in the empty JSON string", ListRunsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRunsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListRunsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
