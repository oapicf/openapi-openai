...
public class ListThreadsResponse {
  ...
  public ListThreadsResponse _object(@javax.annotation.Nonnull String _object) {
  ...
  public ListThreadsResponse data(@javax.annotation.Nonnull List<ThreadObject> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<ThreadObject> data) {
    this.data = data;
  }


  public ListThreadsResponse firstId(@javax.annotation.Nonnull String firstId) {
  ...
  public ListThreadsResponse lastId(@javax.annotation.Nonnull String lastId) {
    this.lastId = lastId;
    return this;
  }
  ...
  public ListThreadsResponse hasMore(@javax.annotation.Nonnull Boolean hasMore) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListThreadsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListThreadsResponse is not found in the empty JSON string", ListThreadsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListThreadsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListThreadsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
