...
public class MessageContentImageFileObjectImageFile {
  ...
  public MessageContentImageFileObjectImageFile fileId(@javax.annotation.Nonnull String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public MessageContentImageFileObjectImageFile detail(@javax.annotation.Nullable DetailEnum detail) {
    this.detail = detail;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageContentImageFileObjectImageFile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageContentImageFileObjectImageFile is not found in the empty JSON string", MessageContentImageFileObjectImageFile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageContentImageFileObjectImageFile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageContentImageFileObjectImageFile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
