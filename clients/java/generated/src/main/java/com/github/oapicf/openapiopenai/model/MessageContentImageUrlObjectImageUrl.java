...
public class MessageContentImageUrlObjectImageUrl {
  ...
  public MessageContentImageUrlObjectImageUrl url(@javax.annotation.Nonnull URI url) {
    this.url = url;
    return this;
  }
  ...
  public MessageContentImageUrlObjectImageUrl detail(@javax.annotation.Nullable DetailEnum detail) {
    this.detail = detail;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageContentImageUrlObjectImageUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageContentImageUrlObjectImageUrl is not found in the empty JSON string", MessageContentImageUrlObjectImageUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageContentImageUrlObjectImageUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageContentImageUrlObjectImageUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
