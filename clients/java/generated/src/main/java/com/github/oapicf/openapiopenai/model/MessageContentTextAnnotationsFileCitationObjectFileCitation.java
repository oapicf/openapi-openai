...
public class MessageContentTextAnnotationsFileCitationObjectFileCitation {
  ...
  public MessageContentTextAnnotationsFileCitationObjectFileCitation quote(@javax.annotation.Nonnull String quote) {
    this.quote = quote;
    return this;
  }
  ...
  public void setQuote(@javax.annotation.Nonnull String quote) {
    this.quote = quote;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("file_id", "quote"));
  }
