...
public class MessageContentTextAnnotationsFilePathObject {
  ...
  public MessageContentTextAnnotationsFilePathObject type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public MessageContentTextAnnotationsFilePathObject text(@javax.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
  ...
  public MessageContentTextAnnotationsFilePathObject filePath(@javax.annotation.Nonnull MessageContentTextAnnotationsFilePathObjectFilePath filePath) {
  ...
  public MessageContentTextAnnotationsFilePathObject startIndex(@javax.annotation.Nonnull Integer startIndex) {
  ...
  public MessageContentTextAnnotationsFilePathObject endIndex(@javax.annotation.Nonnull Integer endIndex) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "text", "file_path", "start_index", "end_index"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "text", "file_path", "start_index", "end_index"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageContentTextAnnotationsFilePathObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageContentTextAnnotationsFilePathObject is not found in the empty JSON string", MessageContentTextAnnotationsFilePathObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageContentTextAnnotationsFilePathObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageContentTextAnnotationsFilePathObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
