...
public class MessageContentTextAnnotationsFilePathObjectFilePath {
  ...
  public MessageContentTextAnnotationsFilePathObjectFilePath fileId(@javax.annotation.Nonnull String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageContentTextAnnotationsFilePathObjectFilePath.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageContentTextAnnotationsFilePathObjectFilePath is not found in the empty JSON string", MessageContentTextAnnotationsFilePathObjectFilePath.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageContentTextAnnotationsFilePathObjectFilePath.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageContentTextAnnotationsFilePathObjectFilePath` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
