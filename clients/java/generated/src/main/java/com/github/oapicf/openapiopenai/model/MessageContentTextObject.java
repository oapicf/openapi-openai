...
public class MessageContentTextObject {
  ...
  public MessageContentTextObject type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public MessageContentTextObject text(@javax.annotation.Nonnull MessageContentTextObjectText text) {
    this.text = text;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageContentTextObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageContentTextObject is not found in the empty JSON string", MessageContentTextObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageContentTextObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageContentTextObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
