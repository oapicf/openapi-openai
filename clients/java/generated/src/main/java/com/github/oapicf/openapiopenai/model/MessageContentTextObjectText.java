...
public class MessageContentTextObjectText {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("value", "annotations"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageContentTextObjectText.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageContentTextObjectText is not found in the empty JSON string", MessageContentTextObjectText.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageContentTextObjectText.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageContentTextObjectText` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
