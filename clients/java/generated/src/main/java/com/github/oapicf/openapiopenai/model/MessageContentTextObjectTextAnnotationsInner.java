...
public class MessageContentTextObjectTextAnnotationsInner extends AbstractOpenApiSchema {
    ...
    public MessageContentTextObjectTextAnnotationsInner(MessageContentTextAnnotationsFileCitationObject o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MessageContentTextObjectTextAnnotationsInner(MessageContentTextAnnotationsFilePathObject o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
