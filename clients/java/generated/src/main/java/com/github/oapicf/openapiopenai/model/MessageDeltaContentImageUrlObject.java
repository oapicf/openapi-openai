...
public class MessageDeltaContentImageUrlObject {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("index", "type", "image_url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageDeltaContentImageUrlObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageDeltaContentImageUrlObject is not found in the empty JSON string", MessageDeltaContentImageUrlObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageDeltaContentImageUrlObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageDeltaContentImageUrlObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
