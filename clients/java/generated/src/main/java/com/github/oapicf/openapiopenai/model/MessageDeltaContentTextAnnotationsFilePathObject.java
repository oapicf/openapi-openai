...
public class MessageDeltaContentTextAnnotationsFilePathObject {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("index", "type", "text", "file_path", "start_index", "end_index"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageDeltaContentTextAnnotationsFilePathObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageDeltaContentTextAnnotationsFilePathObject is not found in the empty JSON string", MessageDeltaContentTextAnnotationsFilePathObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageDeltaContentTextAnnotationsFilePathObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageDeltaContentTextAnnotationsFilePathObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
