...
public class MessageDeltaContentTextObjectTextAnnotationsInner extends AbstractOpenApiSchema {
    ...
    public MessageDeltaContentTextObjectTextAnnotationsInner(MessageDeltaContentTextAnnotationsFileCitationObject o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MessageDeltaContentTextObjectTextAnnotationsInner(MessageDeltaContentTextAnnotationsFilePathObject o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
