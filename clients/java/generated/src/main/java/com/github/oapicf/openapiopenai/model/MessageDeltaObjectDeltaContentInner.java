...
public class MessageDeltaObjectDeltaContentInner extends AbstractOpenApiSchema {
    ...
    public MessageDeltaObjectDeltaContentInner(MessageDeltaContentImageFileObject o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public MessageDeltaObjectDeltaContentInner(MessageDeltaContentTextObject o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
