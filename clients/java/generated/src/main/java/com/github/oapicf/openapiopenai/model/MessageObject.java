...
public class MessageObject {
  ...
  public MessageObject fileIds(@javax.annotation.Nonnull List<String> fileIds) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "object", "created_at", "thread_id", "status", "incomplete_details", "completed_at", "incomplete_at", "role", "content", "assistant_id", "run_id", "file_ids", "metadata"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "object", "created_at", "thread_id", "status", "incomplete_details", "completed_at", "incomplete_at", "role", "content", "assistant_id", "run_id", "file_ids", "metadata"));
  }
