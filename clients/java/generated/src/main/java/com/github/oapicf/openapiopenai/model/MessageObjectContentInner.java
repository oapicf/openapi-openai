...
import com.github.oapicf.openapiopenai.model.MessageContentRefusalObject;
...
public class MessageObjectContentInner extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<MessageContentRefusalObject> adapterMessageContentRefusalObject = gson.getDelegateAdapter(this, TypeToken.get(MessageContentRefusalObject.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<MessageObjectContentInner>() {
                ...
                public void write(JsonWriter out, MessageObjectContentInner value) throws IOException {
                    ...
                    // check if the actual instance is of the type `MessageContentRefusalObject`
                    if (value.getActualInstance() instanceof MessageContentRefusalObject) {
                        JsonElement element = adapterMessageContentRefusalObject.toJsonTree((MessageContentRefusalObject)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentRefusalObject, MessageContentTextObject");
                }
                ...
                public MessageObjectContentInner read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for MessageContentImageFileObject failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for MessageContentImageUrlObject failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for MessageContentTextObject failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'MessageContentTextObject'", e);
                    }
                    // deserialize MessageContentRefusalObject
                    try {
                        // validate the JSON object to see if any exception is thrown
                        MessageContentRefusalObject.validateJsonElement(jsonElement);
                        actualAdapter = adapterMessageContentRefusalObject;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'MessageContentRefusalObject'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format(java.util.Locale.ROOT, "Deserialization for MessageContentRefusalObject failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'MessageContentRefusalObject'", e);
                    }
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for MessageObjectContentInner: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    static {
        ...
        schemas.put("MessageContentRefusalObject", MessageContentRefusalObject.class);
    }
     ...
     * MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentRefusalObject, MessageContentTextObject
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof MessageContentRefusalObject) {
            super.setActualInstance(instance);
            return;
        }

        throw new RuntimeException("Invalid instance type. Must be MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentRefusalObject, MessageContentTextObject");
    }
     ...
     * MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentRefusalObject, MessageContentTextObject
     *
     * @return The actual instance (MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentRefusalObject, MessageContentTextObject)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    /**
     * Get the actual instance of `MessageContentRefusalObject`. If the actual instance is not `MessageContentRefusalObject`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `MessageContentRefusalObject`
     * @throws ClassCastException if the instance is not `MessageContentRefusalObject`
     */
    public MessageContentRefusalObject getMessageContentRefusalObject() throws ClassCastException {
        return (MessageContentRefusalObject)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with MessageContentRefusalObject
        try {
            MessageContentRefusalObject.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for MessageObjectContentInner with oneOf schemas: MessageContentImageFileObject, MessageContentImageUrlObject, MessageContentRefusalObject, MessageContentTextObject. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
