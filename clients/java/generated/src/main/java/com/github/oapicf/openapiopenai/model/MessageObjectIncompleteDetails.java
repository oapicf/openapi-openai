...
public class MessageObjectIncompleteDetails {
  ...
  public MessageObjectIncompleteDetails reason(@javax.annotation.Nonnull ReasonEnum reason) {
    this.reason = reason;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageObjectIncompleteDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageObjectIncompleteDetails is not found in the empty JSON string", MessageObjectIncompleteDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageObjectIncompleteDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageObjectIncompleteDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
