...
public class MessageRequestContentTextObject {
  ...
  public MessageRequestContentTextObject type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public MessageRequestContentTextObject text(@javax.annotation.Nonnull String text) {
    this.text = text;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageRequestContentTextObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageRequestContentTextObject is not found in the empty JSON string", MessageRequestContentTextObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageRequestContentTextObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageRequestContentTextObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
