...
public class MessageStreamEventOneOf4 {
  ...
  public MessageStreamEventOneOf4 event(@javax.annotation.Nonnull EventEnum event) {
    this.event = event;
    return this;
  }
  ...
  public MessageStreamEventOneOf4 data(@javax.annotation.Nonnull MessageObject data) {
    this.data = data;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageStreamEventOneOf4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageStreamEventOneOf4 is not found in the empty JSON string", MessageStreamEventOneOf4.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageStreamEventOneOf4.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageStreamEventOneOf4` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
