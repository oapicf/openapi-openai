...
import com.github.oapicf.openapiopenai.model.ModifyAssistantRequestToolResourcesCodeInterpreter;
import com.github.oapicf.openapiopenai.model.ModifyAssistantRequestToolResourcesFileSearch;
...
public class ModifyAssistantRequestToolResources {
  ...
  public ModifyAssistantRequestToolResources codeInterpreter(@javax.annotation.Nullable ModifyAssistantRequestToolResourcesCodeInterpreter codeInterpreter) {
  ...
  public void setCodeInterpreter(@javax.annotation.Nullable ModifyAssistantRequestToolResourcesCodeInterpreter codeInterpreter) {
    this.codeInterpreter = codeInterpreter;
  }


  public ModifyAssistantRequestToolResources fileSearch(@javax.annotation.Nullable ModifyAssistantRequestToolResourcesFileSearch fileSearch) {
  ...
  public void setFileSearch(@javax.annotation.Nullable ModifyAssistantRequestToolResourcesFileSearch fileSearch) {
    this.fileSearch = fileSearch;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyAssistantRequestToolResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModifyAssistantRequestToolResources is not found in the empty JSON string", ModifyAssistantRequestToolResources.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyAssistantRequestToolResources.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModifyAssistantRequestToolResources` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
