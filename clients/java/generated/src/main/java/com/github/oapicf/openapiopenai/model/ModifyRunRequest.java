...
public class ModifyRunRequest {
  ...
  public ModifyRunRequest metadata(@javax.annotation.Nullable Object metadata) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyRunRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModifyRunRequest is not found in the empty JSON string", ModifyRunRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyRunRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModifyRunRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
