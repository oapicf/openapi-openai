...
public class Project {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "object", "name", "created_at", "archived_at", "status"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "object", "name", "created_at", "status"));
  }
