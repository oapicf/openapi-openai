...
public class RealtimeServerEventConversationItemCreated {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("event_id", "type", "previous_item_id", "item"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RealtimeServerEventConversationItemCreated.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RealtimeServerEventConversationItemCreated is not found in the empty JSON string", RealtimeServerEventConversationItemCreated.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RealtimeServerEventConversationItemCreated.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RealtimeServerEventConversationItemCreated` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
