...
public class RealtimeServerEventInputAudioBufferCleared {
  ...
  public RealtimeServerEventInputAudioBufferCleared eventId(@javax.annotation.Nonnull String eventId) {
  ...
  public RealtimeServerEventInputAudioBufferCleared type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("event_id", "type"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RealtimeServerEventInputAudioBufferCleared.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RealtimeServerEventInputAudioBufferCleared is not found in the empty JSON string", RealtimeServerEventInputAudioBufferCleared.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RealtimeServerEventInputAudioBufferCleared.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RealtimeServerEventInputAudioBufferCleared` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
