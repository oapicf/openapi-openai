...
public class RunObjectRequiredAction {
  ...
  public RunObjectRequiredAction type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public RunObjectRequiredAction submitToolOutputs(@javax.annotation.Nonnull RunObjectRequiredActionSubmitToolOutputs submitToolOutputs) {
  ...
  public void setSubmitToolOutputs(@javax.annotation.Nonnull RunObjectRequiredActionSubmitToolOutputs submitToolOutputs) {
    this.submitToolOutputs = submitToolOutputs;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "submit_tool_outputs"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "submit_tool_outputs"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunObjectRequiredAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunObjectRequiredAction is not found in the empty JSON string", RunObjectRequiredAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunObjectRequiredAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunObjectRequiredAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
