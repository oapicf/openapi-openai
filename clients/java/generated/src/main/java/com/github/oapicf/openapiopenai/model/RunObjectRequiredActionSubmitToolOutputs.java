...
public class RunObjectRequiredActionSubmitToolOutputs {
  ...
  public RunObjectRequiredActionSubmitToolOutputs toolCalls(@javax.annotation.Nonnull List<RunToolCallObject> toolCalls) {
  ...
  public void setToolCalls(@javax.annotation.Nonnull List<RunToolCallObject> toolCalls) {
    this.toolCalls = toolCalls;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("tool_calls"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("tool_calls"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunObjectRequiredActionSubmitToolOutputs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunObjectRequiredActionSubmitToolOutputs is not found in the empty JSON string", RunObjectRequiredActionSubmitToolOutputs.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunObjectRequiredActionSubmitToolOutputs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunObjectRequiredActionSubmitToolOutputs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
