...
public class RunStepCompletionUsage {
  ...
  public RunStepCompletionUsage completionTokens(@javax.annotation.Nonnull Integer completionTokens) {
  ...
  public RunStepCompletionUsage promptTokens(@javax.annotation.Nonnull Integer promptTokens) {
  ...
  public RunStepCompletionUsage totalTokens(@javax.annotation.Nonnull Integer totalTokens) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunStepCompletionUsage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunStepCompletionUsage is not found in the empty JSON string", RunStepCompletionUsage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunStepCompletionUsage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunStepCompletionUsage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
