...
public class RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter {
  ...
  public RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter input(@javax.annotation.Nullable String input) {
    this.input = input;
    return this;
  }
  ...
  public RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter outputs(@javax.annotation.Nullable List<RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner> outputs) {
  ...
  public void setOutputs(@javax.annotation.Nullable List<RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner> outputs) {
    this.outputs = outputs;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter is not found in the empty JSON string", RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
