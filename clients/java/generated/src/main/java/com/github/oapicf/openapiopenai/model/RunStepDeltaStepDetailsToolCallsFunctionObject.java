...
public class RunStepDeltaStepDetailsToolCallsFunctionObject {
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObject index(@javax.annotation.Nonnull Integer index) {
    this.index = index;
    return this;
  }
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObject id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObject type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObject function(@javax.annotation.Nullable RunStepDeltaStepDetailsToolCallsFunctionObjectFunction function) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("index", "id", "type", "function"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunStepDeltaStepDetailsToolCallsFunctionObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunStepDeltaStepDetailsToolCallsFunctionObject is not found in the empty JSON string", RunStepDeltaStepDetailsToolCallsFunctionObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunStepDeltaStepDetailsToolCallsFunctionObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunStepDeltaStepDetailsToolCallsFunctionObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
