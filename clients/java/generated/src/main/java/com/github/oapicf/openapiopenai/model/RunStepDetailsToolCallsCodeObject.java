...
public class RunStepDetailsToolCallsCodeObject {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "type", "code_interpreter"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "type", "code_interpreter"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunStepDetailsToolCallsCodeObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunStepDetailsToolCallsCodeObject is not found in the empty JSON string", RunStepDetailsToolCallsCodeObject.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunStepDetailsToolCallsCodeObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunStepDetailsToolCallsCodeObject` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
