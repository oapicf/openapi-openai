...
public class RunStepDetailsToolCallsCodeOutputImageObjectImage {
  ...
  public RunStepDetailsToolCallsCodeOutputImageObjectImage fileId(@javax.annotation.Nonnull String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunStepDetailsToolCallsCodeOutputImageObjectImage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunStepDetailsToolCallsCodeOutputImageObjectImage is not found in the empty JSON string", RunStepDetailsToolCallsCodeOutputImageObjectImage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunStepDetailsToolCallsCodeOutputImageObjectImage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunStepDetailsToolCallsCodeOutputImageObjectImage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
