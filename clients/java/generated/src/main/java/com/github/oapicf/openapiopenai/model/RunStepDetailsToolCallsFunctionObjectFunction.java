...
public class RunStepDetailsToolCallsFunctionObjectFunction {
  ...
  public RunStepDetailsToolCallsFunctionObjectFunction name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RunStepDetailsToolCallsFunctionObjectFunction arguments(@javax.annotation.Nonnull String arguments) {
  ...
  public RunStepDetailsToolCallsFunctionObjectFunction output(@javax.annotation.Nullable String output) {
    this.output = output;
    return this;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "arguments", "output"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunStepDetailsToolCallsFunctionObjectFunction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RunStepDetailsToolCallsFunctionObjectFunction is not found in the empty JSON string", RunStepDetailsToolCallsFunctionObjectFunction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunStepDetailsToolCallsFunctionObjectFunction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RunStepDetailsToolCallsFunctionObjectFunction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
