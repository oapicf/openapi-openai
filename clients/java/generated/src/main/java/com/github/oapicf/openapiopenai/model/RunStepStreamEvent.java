...
public class RunStepStreamEvent extends AbstractOpenApiSchema {
    ...
    public RunStepStreamEvent(RunStepStreamEventOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStepStreamEvent(RunStepStreamEventOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStepStreamEvent(RunStepStreamEventOneOf2 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStepStreamEvent(RunStepStreamEventOneOf3 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStepStreamEvent(RunStepStreamEventOneOf4 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStepStreamEvent(RunStepStreamEventOneOf5 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStepStreamEvent(RunStepStreamEventOneOf6 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
