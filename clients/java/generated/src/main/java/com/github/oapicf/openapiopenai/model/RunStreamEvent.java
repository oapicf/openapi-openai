...
public class RunStreamEvent extends AbstractOpenApiSchema {
    ...
    public RunStreamEvent(RunStreamEventOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStreamEvent(RunStreamEventOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStreamEvent(RunStreamEventOneOf2 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStreamEvent(RunStreamEventOneOf3 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStreamEvent(RunStreamEventOneOf4 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStreamEvent(RunStreamEventOneOf5 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStreamEvent(RunStreamEventOneOf6 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStreamEvent(RunStreamEventOneOf7 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public RunStreamEvent(RunStreamEventOneOf8 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
