...
public class StaticChunkingStrategy {
  ...
  public StaticChunkingStrategy type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public StaticChunkingStrategy _static(@javax.annotation.Nonnull StaticChunkingStrategyStatic _static) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StaticChunkingStrategy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StaticChunkingStrategy is not found in the empty JSON string", StaticChunkingStrategy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StaticChunkingStrategy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StaticChunkingStrategy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
