...
public class StaticChunkingStrategyRequestParam {
  ...
  public StaticChunkingStrategyRequestParam type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public StaticChunkingStrategyRequestParam _static(@javax.annotation.Nonnull StaticChunkingStrategy _static) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StaticChunkingStrategyRequestParam.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StaticChunkingStrategyRequestParam is not found in the empty JSON string", StaticChunkingStrategyRequestParam.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StaticChunkingStrategyRequestParam.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StaticChunkingStrategyRequestParam` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
