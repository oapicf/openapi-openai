...
public class SubmitToolOutputsRunRequestToolOutputsInner {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("tool_call_id", "output"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubmitToolOutputsRunRequestToolOutputsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SubmitToolOutputsRunRequestToolOutputsInner is not found in the empty JSON string", SubmitToolOutputsRunRequestToolOutputsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubmitToolOutputsRunRequestToolOutputsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SubmitToolOutputsRunRequestToolOutputsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
