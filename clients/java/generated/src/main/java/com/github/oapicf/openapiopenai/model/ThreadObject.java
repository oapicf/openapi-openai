...
public class ThreadObject {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "object", "created_at", "metadata"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "object", "created_at", "metadata"));
  }
