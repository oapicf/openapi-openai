...
public class ThreadStreamEvent {
  ...
  public ThreadStreamEvent enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public ThreadStreamEvent event(@javax.annotation.Nonnull EventEnum event) {
    this.event = event;
    return this;
  }
  ...
  public ThreadStreamEvent data(@javax.annotation.Nonnull ThreadObject data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull ThreadObject data) {
    this.data = data;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("enabled", "event", "data"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ThreadStreamEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ThreadStreamEvent is not found in the empty JSON string", ThreadStreamEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ThreadStreamEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ThreadStreamEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThreadStreamEvent.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ThreadStreamEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThreadStreamEvent.class));
