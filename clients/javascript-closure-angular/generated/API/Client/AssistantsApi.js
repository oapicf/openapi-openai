...
goog.require('API.Client.DeleteMessageResponse');
 ...
 * @param {!Array<!string>=} opt_include A list of additional fields to include in the response. Currently the only supported value is &#x60;step_details.tool_calls[*].file_search.results[*].content&#x60; to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information. 
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.RunObject>}
 */
API.Client.AssistantsApi.prototype.createRun = function(threadId, createRunRequest, opt_include, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 * @param {!angular.$http.Config=} opt_extraHttpRequestParams Extra HTTP parameters to send.
 * @return {!angular.$q.Promise<!API.Client.DeleteMessageResponse>}
 */
API.Client.AssistantsApi.prototype.deleteMessage = function(threadId, messageId, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  // verify required parameter 'threadId' is set
  if (!threadId) {
    throw new Error('Missing required parameter threadId when calling deleteMessage');
  }
 ...
 */
API.Client.AssistantsApi.prototype.getRunStep = function(threadId, runId, stepId, opt_include, opt_extraHttpRequestParams) {
  /** @const {string} */
 ...
 */
API.Client.AssistantsApi.prototype.listRunSteps = function(threadId, runId, opt_limit, opt_order, opt_after, opt_before, opt_include, opt_extraHttpRequestParams) {
  /** @const {string} */
