goog.provide('API.Client.CreateChatCompletionRequest_response_format');
 ...
 * @record
 */
API.Client.CreateChatCompletionRequestResponseFormat = function() {}
 ...
 * @export
 */
API.Client.CreateChatCompletionRequestResponseFormat.prototype.type;

/**
 * @type {!API.Client.ResponseFormatJsonSchema_json_schema}
 * @export
 */
API.Client.CreateChatCompletionRequestResponseFormat.prototype.jsonSchema;

/** @enum {string} */
API.Client.CreateChatCompletionRequestResponseFormat.TypeEnum = { 
  text: 'text',
