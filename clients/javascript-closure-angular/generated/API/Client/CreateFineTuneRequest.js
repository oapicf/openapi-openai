goog.provide('API.Client.CreateFineTuneRequest');

/**
 * @record
 */
API.Client.CreateFineTuneRequest = function() {}
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.trainingFile;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.validationFile;

/**
 * @type {!API.Client.CreateFineTuneRequest_model}
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.model;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.nEpochs;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.batchSize;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.learningRateMultiplier;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.promptLossWeight;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.computeClassificationMetrics;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.classificationNClasses;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.classificationPositiveClass;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.classificationBetas;
 ...
 * @export
 */
API.Client.CreateFineTuneRequest.prototype.suffix;
