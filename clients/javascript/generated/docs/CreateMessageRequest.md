# OpenapiOpenai.CreateMessageRequest
...
**attachments** | [**[CreateMessageRequestAttachmentsInner]**](CreateMessageRequestAttachmentsInner.md) | A list of files attached to the message, and the tools they should be added to. | [optional] 
