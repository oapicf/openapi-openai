# OpenapiOpenai.RealtimeServerEventResponseFunctionCallArgumentsDone
...
**_arguments** | **String** | The final arguments as a JSON string. | 
...
* `response.function_call_arguments.done` (value: `"response.function_call_arguments.done"`)
