# OpenapiOpenai.RealtimeSessionCreateResponseClientSecret
...
**expiresAt** | **Number** | Timestamp for when the token expires. Currently, all tokens expire after one minute.  | [optional] 
