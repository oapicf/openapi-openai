...
**createdAt** | **Number** | The Unix timestamp (in seconds) for when the Upload was created. | 
**filename** | **String** | The name of the file to be uploaded. | 
**bytes** | **Number** | The intended number of bytes to be uploaded. | 
...
**expiresAt** | **Number** | The Unix timestamp (in seconds) for when the Upload was created. | 
