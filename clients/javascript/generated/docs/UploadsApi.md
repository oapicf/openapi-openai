...
let apiInstance = new OpenapiOpenai.UploadsApi();
let uploadId = "upload_abc123"; // String | The ID of the Upload. 
let data = "/path/to/file"; // File | The chunk of bytes for this Part. 
apiInstance.addUploadPart(uploadId, data, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new OpenapiOpenai.UploadsApi();
let uploadId = "upload_abc123"; // String | The ID of the Upload. 
apiInstance.cancelUpload(uploadId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OpenapiOpenai.UploadsApi();
let uploadId = "upload_abc123"; // String | The ID of the Upload. 
let completeUploadRequest = new OpenapiOpenai.CompleteUploadRequest(); // CompleteUploadRequest | 
apiInstance.completeUpload(uploadId, completeUploadRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new OpenapiOpenai.UploadsApi();
let createUploadRequest = new OpenapiOpenai.CreateUploadRequest(); // CreateUploadRequest | 
apiInstance.createUpload(createUploadRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
