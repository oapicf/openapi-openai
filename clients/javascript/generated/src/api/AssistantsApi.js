...
export default class AssistantsApi {
    ...
    */
     ...
     * @param {Array.<module:model/String>} [include] A list of additional fields to include in the response. Currently the only supported value is `step_details.tool_calls[*].file_search.results[*].content` to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information. 
     ...
     * data is of type: {@link module:model/RunObject}
     */
    createRun(threadId, createRunRequest, opts, callback) {
      opts = opts || {};
     ...
     * @callback module:api/AssistantsApi~deleteMessageCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/AssistantsApi~deleteMessageCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    deleteMessage(threadId, messageId, callback) {
      ...
      // verify the required parameter 'threadId' is set
      if (threadId === undefined || threadId === null) {
        throw new Error("Missing the required parameter 'threadId' when calling deleteMessage");
      }
     ...
     */
    getRunStep(threadId, runId, stepId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'threadId' is set
      if (threadId === undefined || threadId === null) {
