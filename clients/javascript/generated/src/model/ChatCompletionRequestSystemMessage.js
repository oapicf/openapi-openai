...
class ChatCompletionRequestSystemMessage {
     ...
     * @param content {module:model/ChatCompletionRequestSystemMessageContent} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ChatCompletionRequestSystemMessageContent.constructFromObject(data['content']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['content']) { // data not null
          ChatCompletionRequestSystemMessageContent.validateJSON(data['content']);
        }
...
/**
 * @member {module:model/ChatCompletionRequestSystemMessageContent} content
 */
