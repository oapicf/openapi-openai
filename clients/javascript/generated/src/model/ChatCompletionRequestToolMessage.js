...
class ChatCompletionRequestToolMessage {
     ...
     * @param content {module:model/ChatCompletionRequestToolMessageContent} 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('content')) {
                obj['content'] = ChatCompletionRequestToolMessageContent.constructFromObject(data['content']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['content']) { // data not null
          ChatCompletionRequestToolMessageContent.validateJSON(data['content']);
        }
        // ensure the json data is a string
...
/**
 * @member {module:model/ChatCompletionRequestToolMessageContent} content
 */
