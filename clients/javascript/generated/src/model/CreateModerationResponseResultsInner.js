...
class CreateModerationResponseResultsInner {
     ...
     * @param categoryAppliedInputTypes {module:model/CreateModerationResponseResultsInnerCategoryAppliedInputTypes} 
     */
    constructor(flagged, categories, categoryScores, categoryAppliedInputTypes) { 
        
        CreateModerationResponseResultsInner.initialize(this, flagged, categories, categoryScores, categoryAppliedInputTypes);
    }
     ...
     */
    static initialize(obj, flagged, categories, categoryScores, categoryAppliedInputTypes) { 
        obj['flagged'] = flagged;
        obj['categories'] = categories;
        obj['category_scores'] = categoryScores;
        obj['category_applied_input_types'] = categoryAppliedInputTypes;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('category_applied_input_types')) {
                obj['category_applied_input_types'] = CreateModerationResponseResultsInnerCategoryAppliedInputTypes.constructFromObject(data['category_applied_input_types']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // validate the optional field `category_applied_input_types`
        if (data['category_applied_input_types']) { // data not null
          CreateModerationResponseResultsInnerCategoryAppliedInputTypes.validateJSON(data['category_applied_input_types']);
        }
...
CreateModerationResponseResultsInner.RequiredProperties = ["flagged", "categories", "category_scores", "category_applied_input_types"];
...
/**
 * @member {module:model/CreateModerationResponseResultsInnerCategoryAppliedInputTypes} category_applied_input_types
 */
CreateModerationResponseResultsInner.prototype['category_applied_input_types'] = undefined;
