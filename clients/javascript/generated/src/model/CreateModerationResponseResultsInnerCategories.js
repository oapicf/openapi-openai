...
class CreateModerationResponseResultsInnerCategories {
     ...
     * @param illicit {Boolean} Content that includes instructions or advice that facilitate the planning or execution of wrongdoing, or that gives advice or instruction on how to commit illicit acts. For example, \"how to shoplift\" would fit this category.
     * @param illicitViolent {Boolean} Content that includes instructions or advice that facilitate the planning or execution of wrongdoing that also includes violence, or that gives advice or instruction on the procurement of any weapon.
    ...
    constructor(hate, hateThreatening, harassment, harassmentThreatening, illicit, illicitViolent, selfHarm, selfHarmIntent, selfHarmInstructions, sexual, sexualMinors, violence, violenceGraphic) { 
        ...
        CreateModerationResponseResultsInnerCategories.initialize(this, hate, hateThreatening, harassment, harassmentThreatening, illicit, illicitViolent, selfHarm, selfHarmIntent, selfHarmInstructions, sexual, sexualMinors, violence, violenceGraphic);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('illicit')) {
                obj['illicit'] = ApiClient.convertToType(data['illicit'], 'Boolean');
            }
            if (data.hasOwnProperty('illicit/violent')) {
                obj['illicit/violent'] = ApiClient.convertToType(data['illicit/violent'], 'Boolean');
            }
...
CreateModerationResponseResultsInnerCategories.RequiredProperties = ["hate", "hate/threatening", "harassment", "harassment/threatening", "illicit", "illicit/violent", "self-harm", "self-harm/intent", "self-harm/instructions", "sexual", "sexual/minors", "violence", "violence/graphic"];
 ...
 * @member {Boolean} illicit
 */
CreateModerationResponseResultsInnerCategories.prototype['illicit'] = undefined;

/**
 * Content that includes instructions or advice that facilitate the planning or execution of wrongdoing that also includes violence, or that gives advice or instruction on the procurement of any weapon.
 * @member {Boolean} illicit/violent
 */
CreateModerationResponseResultsInnerCategories.prototype['illicit/violent'] = undefined;
