...
class CreateThreadAndRunRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tool_resources')) {
                obj['tool_resources'] = CreateThreadAndRunRequestToolResources.constructFromObject(data['tool_resources']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['tool_resources']) { // data not null
          CreateThreadAndRunRequestToolResources.validateJSON(data['tool_resources']);
        }
...
/**
 * @member {module:model/CreateThreadAndRunRequestToolResources} tool_resources
 */
CreateThreadAndRunRequest.prototype['tool_resources'] = undefined;
 ...
 * @default 1
 */
CreateThreadAndRunRequest.prototype['top_p'] = 1;
 ...
 * @default true
 */
CreateThreadAndRunRequest.prototype['parallel_tool_calls'] = true;
