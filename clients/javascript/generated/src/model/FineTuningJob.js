...
class FineTuningJob {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('estimated_finish')) {
                obj['estimated_finish'] = ApiClient.convertToType(data['estimated_finish'], 'Number');
            }
            if (data.hasOwnProperty('method')) {
                obj['method'] = FineTuneMethod.constructFromObject(data['method']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['method']) { // data not null
          FineTuneMethod.validateJSON(data['method']);
        }
 ...
 * @member {Number} estimated_finish
 */
FineTuningJob.prototype['estimated_finish'] = undefined;

/**
 * @member {module:model/FineTuneMethod} method
 */
FineTuningJob.prototype['method'] = undefined;
