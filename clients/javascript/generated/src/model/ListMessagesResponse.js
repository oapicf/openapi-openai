...
class ListMessagesResponse {
    ...
    constructor(object, data, firstId, lastId, hasMore) { 
        ...
        ListMessagesResponse.initialize(this, object, data, firstId, lastId, hasMore);
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                MessageObject.validateJSON(item);
            };
        }
        // ensure the json data is a string
...
ListMessagesResponse.RequiredProperties = ["object", "data", "first_id", "last_id", "has_more"];

/**
 * @member {String} object
 */
ListMessagesResponse.prototype['object'] = undefined;
 ...
 */
ListMessagesResponse.prototype['first_id'] = undefined;

/**
 * @member {String} last_id
 */
ListMessagesResponse.prototype['last_id'] = undefined;

/**
 * @member {Boolean} has_more
 */
ListMessagesResponse.prototype['has_more'] = undefined;
