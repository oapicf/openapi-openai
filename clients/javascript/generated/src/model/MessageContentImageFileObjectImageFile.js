...
class MessageContentImageFileObjectImageFile {
     ...
     * @param fileId {String} The [File](/docs/api-reference/files) ID of the image in the message content. Set `purpose=\"vision\"` when uploading the File if you need to later display the file content.
     */
    constructor(fileId) { 
 ...
 * @member {module:model/MessageContentImageFileObjectImageFile.DetailEnum} detail
 * @default 'auto'
 */
MessageContentImageFileObjectImageFile.prototype['detail'] = 'auto';
 ...
 * @readonly
 */
MessageContentImageFileObjectImageFile['DetailEnum'] = {
