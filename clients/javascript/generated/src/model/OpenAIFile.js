...
class OpenAIFile {
     ...
     * @param purpose {module:model/OpenAIFile.PurposeEnum} The intended purpose of the file. Supported values are `assistants`, `assistants_output`, `batch`, `batch_output`, `fine-tune`, `fine-tune-results` and `vision`.
