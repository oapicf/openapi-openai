...
class RunObject {
     ...
     * @param status {module:model/RunObject.StatusEnum} The status of the run, which can be either `queued`, `in_progress`, `requires_action`, `cancelling`, `cancelled`, `failed`, `completed`, `incomplete`, or `expired`.
     ...
     * @param parallelToolCalls {Boolean} Whether to enable [parallel function calling](/docs/guides/function-calling#configuring-parallel-function-calling) during tool use.
     * @param responseFormat {module:model/AssistantsApiResponseFormatOption} 
     */
    constructor(id, object, createdAt, threadId, assistantId, status, requiredAction, lastError, expiresAt, startedAt, cancelledAt, failedAt, completedAt, incompleteDetails, model, instructions, tools, metadata, usage, maxPromptTokens, maxCompletionTokens, truncationStrategy, toolChoice, parallelToolCalls, responseFormat) { 
        
        RunObject.initialize(this, id, object, createdAt, threadId, assistantId, status, requiredAction, lastError, expiresAt, startedAt, cancelledAt, failedAt, completedAt, incompleteDetails, model, instructions, tools, metadata, usage, maxPromptTokens, maxCompletionTokens, truncationStrategy, toolChoice, parallelToolCalls, responseFormat);
    }
     ...
     */
    static initialize(obj, id, object, createdAt, threadId, assistantId, status, requiredAction, lastError, expiresAt, startedAt, cancelledAt, failedAt, completedAt, incompleteDetails, model, instructions, tools, metadata, usage, maxPromptTokens, maxCompletionTokens, truncationStrategy, toolChoice, parallelToolCalls, responseFormat) { 
        obj['id'] = id;
        obj['object'] = object;
        ...
        obj['parallel_tool_calls'] = parallelToolCalls || true;
 ...
 * @member {Number} top_p
 */
RunObject.prototype['top_p'] = undefined;
 ...
 * @default true
 */
RunObject.prototype['parallel_tool_calls'] = true;
