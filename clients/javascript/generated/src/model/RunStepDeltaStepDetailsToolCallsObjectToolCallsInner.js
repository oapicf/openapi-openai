...
class RunStepDeltaStepDetailsToolCallsObjectToolCallsInner {
     ...
     * @param {(module:model/RunStepDeltaStepDetailsToolCallsCodeObject|module:model/RunStepDeltaStepDetailsToolCallsFileSearchObject|module:model/RunStepDeltaStepDetailsToolCallsFunctionObject)} instance The actual instance to initialize RunStepDeltaStepDetailsToolCallsObjectToolCallsInner.
     */
    constructor(instance = null) {
        ...
        try {
            if (typeof instance === "RunStepDeltaStepDetailsToolCallsFileSearchObject") {
                this.actualInstance = instance;
            } else {
                // plain JS object
                // validate the object
                RunStepDeltaStepDetailsToolCallsFileSearchObject.validateJSON(instance); // throw an exception if no match
                // create RunStepDeltaStepDetailsToolCallsFileSearchObject from JS object
                this.actualInstance = RunStepDeltaStepDetailsToolCallsFileSearchObject.constructFromObject(instance);
            }
            match++;
        } catch(err) {
            // json data failed to deserialize into RunStepDeltaStepDetailsToolCallsFileSearchObject
            errorMessages.push("Failed to construct RunStepDeltaStepDetailsToolCallsFileSearchObject: " + err)
        }
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `RunStepDeltaStepDetailsToolCallsObjectToolCallsInner` with oneOf schemas RunStepDeltaStepDetailsToolCallsCodeObject, RunStepDeltaStepDetailsToolCallsFileSearchObject, RunStepDeltaStepDetailsToolCallsFunctionObject. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `RunStepDeltaStepDetailsToolCallsObjectToolCallsInner` with oneOf schemas RunStepDeltaStepDetailsToolCallsCodeObject, RunStepDeltaStepDetailsToolCallsFileSearchObject, RunStepDeltaStepDetailsToolCallsFunctionObject. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Gets the actual instance, which can be <code>RunStepDeltaStepDetailsToolCallsCodeObject</code>, <code>RunStepDeltaStepDetailsToolCallsFileSearchObject</code>, <code>RunStepDeltaStepDetailsToolCallsFunctionObject</code>.
     * @return {(module:model/RunStepDeltaStepDetailsToolCallsCodeObject|module:model/RunStepDeltaStepDetailsToolCallsFileSearchObject|module:model/RunStepDeltaStepDetailsToolCallsFunctionObject)} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>RunStepDeltaStepDetailsToolCallsCodeObject</code>, <code>RunStepDeltaStepDetailsToolCallsFileSearchObject</code>, <code>RunStepDeltaStepDetailsToolCallsFunctionObject</code>.
     * @param {(module:model/RunStepDeltaStepDetailsToolCallsCodeObject|module:model/RunStepDeltaStepDetailsToolCallsFileSearchObject|module:model/RunStepDeltaStepDetailsToolCallsFunctionObject)} obj The actual instance.
     */
 ...
 */
RunStepDeltaStepDetailsToolCallsObjectToolCallsInner.prototype['file_search'] = undefined;
...
RunStepDeltaStepDetailsToolCallsObjectToolCallsInner.OneOf = ["RunStepDeltaStepDetailsToolCallsCodeObject", "RunStepDeltaStepDetailsToolCallsFileSearchObject", "RunStepDeltaStepDetailsToolCallsFunctionObject"];
