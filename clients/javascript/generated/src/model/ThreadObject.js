...
class ThreadObject {
     ...
     * @param toolResources {module:model/ModifyThreadRequestToolResources} 
     ...
     */
    constructor(id, object, createdAt, toolResources, metadata) { 
        
        ThreadObject.initialize(this, id, object, createdAt, toolResources, metadata);
    }
     ...
     */
    static initialize(obj, id, object, createdAt, toolResources, metadata) { 
        obj['id'] = id;
        obj['object'] = object;
        obj['created_at'] = createdAt;
        obj['tool_resources'] = toolResources;
...
ThreadObject.RequiredProperties = ["id", "object", "created_at", "tool_resources", "metadata"];
 ...
 */
ThreadObject.prototype['tool_resources'] = undefined;
