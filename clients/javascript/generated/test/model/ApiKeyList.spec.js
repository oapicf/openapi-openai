...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ApiKeyList();
  });
  ...
  describe('ApiKeyList', function() {
    it('should create an instance of ApiKeyList', function() {
      // uncomment below and update the code to test ApiKeyList
      //var instance = new OpenapiOpenai.ApiKeyList();
      //expect(instance).to.be.a(OpenapiOpenai.ApiKeyList);
    });
