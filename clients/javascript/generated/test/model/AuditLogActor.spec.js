...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.AuditLogActor();
  });
  ...
  describe('AuditLogActor', function() {
    it('should create an instance of AuditLogActor', function() {
      // uncomment below and update the code to test AuditLogActor
      //var instance = new OpenapiOpenai.AuditLogActor();
      //expect(instance).to.be.a(OpenapiOpenai.AuditLogActor);
    });
