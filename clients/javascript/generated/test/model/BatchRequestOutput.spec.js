...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.BatchRequestOutput();
  });
  ...
  describe('BatchRequestOutput', function() {
    it('should create an instance of BatchRequestOutput', function() {
      // uncomment below and update the code to test BatchRequestOutput
      //var instance = new OpenapiOpenai.BatchRequestOutput();
      //expect(instance).to.be.a(OpenapiOpenai.BatchRequestOutput);
    });
