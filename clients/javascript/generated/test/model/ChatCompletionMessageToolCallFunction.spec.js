...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ChatCompletionMessageToolCallFunction();
  });
  ...
  describe('ChatCompletionMessageToolCallFunction', function() {
    it('should create an instance of ChatCompletionMessageToolCallFunction', function() {
      // uncomment below and update the code to test ChatCompletionMessageToolCallFunction
      //var instance = new OpenapiOpenai.ChatCompletionMessageToolCallFunction();
      //expect(instance).to.be.a(OpenapiOpenai.ChatCompletionMessageToolCallFunction);
    });
