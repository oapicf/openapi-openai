...
(function(root, factory) {
  ...
  describe('ChatCompletionRole', function() {
    it('should create an instance of ChatCompletionRole', function() {
      // uncomment below and update the code to test ChatCompletionRole
      //var instance = new OpenapiOpenai.ChatCompletionRole();
      //expect(instance).to.be.a(OpenapiOpenai.ChatCompletionRole);
    });
