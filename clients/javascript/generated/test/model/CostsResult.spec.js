...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CostsResult();
  });
  ...
  describe('CostsResult', function() {
    it('should create an instance of CostsResult', function() {
      // uncomment below and update the code to test CostsResult
      //var instance = new OpenapiOpenai.CostsResult();
      //expect(instance).to.be.a(OpenapiOpenai.CostsResult);
    });
