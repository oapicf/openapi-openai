...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateAssistantFileRequest();
  });
  ...
  describe('CreateAssistantFileRequest', function() {
    it('should create an instance of CreateAssistantFileRequest', function() {
      ...
      //var instance = new OpenapiOpenai.CreateAssistantFileRequest();
      //expect(instance).to.be.a(OpenapiOpenai.CreateAssistantFileRequest);
    });
