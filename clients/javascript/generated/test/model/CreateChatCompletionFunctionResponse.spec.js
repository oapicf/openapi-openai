...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateChatCompletionFunctionResponse();
  });
  ...
  describe('CreateChatCompletionFunctionResponse', function() {
    it('should create an instance of CreateChatCompletionFunctionResponse', function() {
      // uncomment below and update the code to test CreateChatCompletionFunctionResponse
      //var instance = new OpenapiOpenai.CreateChatCompletionFunctionResponse();
      //expect(instance).to.be.a(OpenapiOpenai.CreateChatCompletionFunctionResponse);
    });
