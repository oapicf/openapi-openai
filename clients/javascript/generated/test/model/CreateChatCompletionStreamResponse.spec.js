...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateChatCompletionStreamResponse();
  });
  ...
  describe('CreateChatCompletionStreamResponse', function() {
    it('should create an instance of CreateChatCompletionStreamResponse', function() {
      // uncomment below and update the code to test CreateChatCompletionStreamResponse
      //var instance = new OpenapiOpenai.CreateChatCompletionStreamResponse();
      //expect(instance).to.be.a(OpenapiOpenai.CreateChatCompletionStreamResponse);
    });
