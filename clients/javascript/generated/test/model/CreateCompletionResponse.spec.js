...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateCompletionResponse();
  });
  ...
  describe('CreateCompletionResponse', function() {
    it('should create an instance of CreateCompletionResponse', function() {
      // uncomment below and update the code to test CreateCompletionResponse
      //var instance = new OpenapiOpenai.CreateCompletionResponse();
      //expect(instance).to.be.a(OpenapiOpenai.CreateCompletionResponse);
    });
