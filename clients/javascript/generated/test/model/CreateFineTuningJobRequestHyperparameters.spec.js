...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateFineTuningJobRequestHyperparameters();
  });
  ...
  describe('CreateFineTuningJobRequestHyperparameters', function() {
    it('should create an instance of CreateFineTuningJobRequestHyperparameters', function() {
      // uncomment below and update the code to test CreateFineTuningJobRequestHyperparameters
      //var instance = new OpenapiOpenai.CreateFineTuningJobRequestHyperparameters();
      //expect(instance).to.be.a(OpenapiOpenai.CreateFineTuningJobRequestHyperparameters);
    });
