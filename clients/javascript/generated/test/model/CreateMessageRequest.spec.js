...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateMessageRequest();
  });
  ...
  describe('CreateMessageRequest', function() {
    it('should create an instance of CreateMessageRequest', function() {
      ...
      //var instance = new OpenapiOpenai.CreateMessageRequest();
      //expect(instance).to.be.a(OpenapiOpenai.CreateMessageRequest);
    });
