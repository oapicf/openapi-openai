...
(function(root, factory) {
  ...
  describe('CreateModerationResponseResultsInner', function() {
    ...
    it('should have the property categoryAppliedInputTypes (base name: "category_applied_input_types")', function() {
      // uncomment below and update the code to test the property categoryAppliedInputTypes
      //var instance = new OpenapiOpenai.CreateModerationResponseResultsInner();
      //expect(instance).to.be();
    });
