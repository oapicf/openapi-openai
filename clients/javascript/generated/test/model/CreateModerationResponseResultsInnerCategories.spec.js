...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateModerationResponseResultsInnerCategories();
  });
  ...
  describe('CreateModerationResponseResultsInnerCategories', function() {
    it('should create an instance of CreateModerationResponseResultsInnerCategories', function() {
      // uncomment below and update the code to test CreateModerationResponseResultsInnerCategories
      //var instance = new OpenapiOpenai.CreateModerationResponseResultsInnerCategories();
      //expect(instance).to.be.a(OpenapiOpenai.CreateModerationResponseResultsInnerCategories);
    });
