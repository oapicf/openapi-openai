...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateModerationResponseResultsInnerCategoryScores();
  });
  ...
  describe('CreateModerationResponseResultsInnerCategoryScores', function() {
    it('should create an instance of CreateModerationResponseResultsInnerCategoryScores', function() {
      // uncomment below and update the code to test CreateModerationResponseResultsInnerCategoryScores
      //var instance = new OpenapiOpenai.CreateModerationResponseResultsInnerCategoryScores();
      //expect(instance).to.be.a(OpenapiOpenai.CreateModerationResponseResultsInnerCategoryScores);
    });
