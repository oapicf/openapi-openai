...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.CreateSpeechRequest();
  });
  ...
  describe('CreateSpeechRequest', function() {
    it('should create an instance of CreateSpeechRequest', function() {
      // uncomment below and update the code to test CreateSpeechRequest
      //var instance = new OpenapiOpenai.CreateSpeechRequest();
      //expect(instance).to.be.a(OpenapiOpenai.CreateSpeechRequest);
    });
