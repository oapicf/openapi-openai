...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.FineTuneChatRequestInputMessagesInner();
  });
  ...
  describe('FineTuneChatRequestInputMessagesInner', function() {
    it('should create an instance of FineTuneChatRequestInputMessagesInner', function() {
      // uncomment below and update the code to test FineTuneChatRequestInputMessagesInner
      //var instance = new OpenapiOpenai.FineTuneChatRequestInputMessagesInner();
      //expect(instance).to.be.a(OpenapiOpenai.FineTuneChatRequestInputMessagesInner);
    });
