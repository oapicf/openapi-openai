...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.FineTuneSupervisedMethodHyperparameters();
  });
  ...
  describe('FineTuneSupervisedMethodHyperparameters', function() {
    it('should create an instance of FineTuneSupervisedMethodHyperparameters', function() {
      // uncomment below and update the code to test FineTuneSupervisedMethodHyperparameters
      //var instance = new OpenapiOpenai.FineTuneSupervisedMethodHyperparameters();
      //expect(instance).to.be.a(OpenapiOpenai.FineTuneSupervisedMethodHyperparameters);
    });
