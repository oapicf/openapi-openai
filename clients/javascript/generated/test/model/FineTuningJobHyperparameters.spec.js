...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.FineTuningJobHyperparameters();
  });
  ...
  describe('FineTuningJobHyperparameters', function() {
    it('should create an instance of FineTuningJobHyperparameters', function() {
      // uncomment below and update the code to test FineTuningJobHyperparameters
      //var instance = new OpenapiOpenai.FineTuningJobHyperparameters();
      //expect(instance).to.be.a(OpenapiOpenai.FineTuningJobHyperparameters);
    });
