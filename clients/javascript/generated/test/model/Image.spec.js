...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.Image();
  });
  ...
  describe('Image', function() {
    it('should create an instance of Image', function() {
      ...
      //var instance = new OpenapiOpenai.Image();
      //expect(instance).to.be.a(OpenapiOpenai.Image);
    });
    ...
    it('should have the property revisedPrompt (base name: "revised_prompt")', function() {
      // uncomment below and update the code to test the property revisedPrompt
      //var instance = new OpenapiOpenai.Image();
      //expect(instance).to.be();
    });
