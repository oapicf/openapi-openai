...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.InviteListResponse();
  });
  ...
  describe('InviteListResponse', function() {
    it('should create an instance of InviteListResponse', function() {
      // uncomment below and update the code to test InviteListResponse
      //var instance = new OpenapiOpenai.InviteListResponse();
      //expect(instance).to.be.a(OpenapiOpenai.InviteListResponse);
    });
