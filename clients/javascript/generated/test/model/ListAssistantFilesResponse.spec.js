...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListAssistantFilesResponse();
  });
  ...
  describe('ListAssistantFilesResponse', function() {
    it('should create an instance of ListAssistantFilesResponse', function() {
      // uncomment below and update the code to test ListAssistantFilesResponse
      //var instance = new OpenapiOpenai.ListAssistantFilesResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListAssistantFilesResponse);
    });
