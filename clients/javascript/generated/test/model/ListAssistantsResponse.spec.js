...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListAssistantsResponse();
  });
  ...
  describe('ListAssistantsResponse', function() {
    it('should create an instance of ListAssistantsResponse', function() {
      ...
      //var instance = new OpenapiOpenai.ListAssistantsResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListAssistantsResponse);
    });
