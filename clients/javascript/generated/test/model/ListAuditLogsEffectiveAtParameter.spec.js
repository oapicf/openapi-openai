...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListAuditLogsEffectiveAtParameter();
  });
  ...
  describe('ListAuditLogsEffectiveAtParameter', function() {
    it('should create an instance of ListAuditLogsEffectiveAtParameter', function() {
      // uncomment below and update the code to test ListAuditLogsEffectiveAtParameter
      //var instance = new OpenapiOpenai.ListAuditLogsEffectiveAtParameter();
      //expect(instance).to.be.a(OpenapiOpenai.ListAuditLogsEffectiveAtParameter);
    });
