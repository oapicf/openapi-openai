...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListAuditLogsResponse();
  });
  ...
  describe('ListAuditLogsResponse', function() {
    it('should create an instance of ListAuditLogsResponse', function() {
      // uncomment below and update the code to test ListAuditLogsResponse
      //var instance = new OpenapiOpenai.ListAuditLogsResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListAuditLogsResponse);
    });
