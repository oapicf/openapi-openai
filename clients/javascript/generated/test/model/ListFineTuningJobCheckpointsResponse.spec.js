...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListFineTuningJobCheckpointsResponse();
  });
  ...
  describe('ListFineTuningJobCheckpointsResponse', function() {
    it('should create an instance of ListFineTuningJobCheckpointsResponse', function() {
      // uncomment below and update the code to test ListFineTuningJobCheckpointsResponse
      //var instance = new OpenapiOpenai.ListFineTuningJobCheckpointsResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListFineTuningJobCheckpointsResponse);
    });
