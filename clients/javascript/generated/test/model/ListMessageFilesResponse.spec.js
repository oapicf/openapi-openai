...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListMessageFilesResponse();
  });
  ...
  describe('ListMessageFilesResponse', function() {
    it('should create an instance of ListMessageFilesResponse', function() {
      // uncomment below and update the code to test ListMessageFilesResponse
      //var instance = new OpenapiOpenai.ListMessageFilesResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListMessageFilesResponse);
    });
