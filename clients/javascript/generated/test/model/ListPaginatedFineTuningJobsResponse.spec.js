...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListPaginatedFineTuningJobsResponse();
  });
  ...
  describe('ListPaginatedFineTuningJobsResponse', function() {
    it('should create an instance of ListPaginatedFineTuningJobsResponse', function() {
      // uncomment below and update the code to test ListPaginatedFineTuningJobsResponse
      //var instance = new OpenapiOpenai.ListPaginatedFineTuningJobsResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListPaginatedFineTuningJobsResponse);
    });
