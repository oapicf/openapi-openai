...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListRunStepsResponse();
  });
  ...
  describe('ListRunStepsResponse', function() {
    it('should create an instance of ListRunStepsResponse', function() {
      // uncomment below and update the code to test ListRunStepsResponse
      //var instance = new OpenapiOpenai.ListRunStepsResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListRunStepsResponse);
    });
