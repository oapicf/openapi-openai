...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListThreadsResponse();
  });
  ...
  describe('ListThreadsResponse', function() {
    it('should create an instance of ListThreadsResponse', function() {
      ...
      //var instance = new OpenapiOpenai.ListThreadsResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListThreadsResponse);
    });
