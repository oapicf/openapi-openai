...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListVectorStoreFilesResponse();
  });
  ...
  describe('ListVectorStoreFilesResponse', function() {
    it('should create an instance of ListVectorStoreFilesResponse', function() {
      // uncomment below and update the code to test ListVectorStoreFilesResponse
      //var instance = new OpenapiOpenai.ListVectorStoreFilesResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListVectorStoreFilesResponse);
    });
