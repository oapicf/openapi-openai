...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ListVectorStoresResponse();
  });
  ...
  describe('ListVectorStoresResponse', function() {
    it('should create an instance of ListVectorStoresResponse', function() {
      // uncomment below and update the code to test ListVectorStoresResponse
      //var instance = new OpenapiOpenai.ListVectorStoresResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ListVectorStoresResponse);
    });
