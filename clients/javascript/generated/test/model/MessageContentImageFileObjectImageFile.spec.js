...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.MessageContentImageFileObjectImageFile();
  });
  ...
  describe('MessageContentImageFileObjectImageFile', function() {
    it('should create an instance of MessageContentImageFileObjectImageFile', function() {
      // uncomment below and update the code to test MessageContentImageFileObjectImageFile
      //var instance = new OpenapiOpenai.MessageContentImageFileObjectImageFile();
      //expect(instance).to.be.a(OpenapiOpenai.MessageContentImageFileObjectImageFile);
    });
