...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.MessageFileObject();
  });
  ...
  describe('MessageFileObject', function() {
    it('should create an instance of MessageFileObject', function() {
      // uncomment below and update the code to test MessageFileObject
      //var instance = new OpenapiOpenai.MessageFileObject();
      //expect(instance).to.be.a(OpenapiOpenai.MessageFileObject);
    });
