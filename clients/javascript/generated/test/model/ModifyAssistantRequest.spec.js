...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ModifyAssistantRequest();
  });
  ...
  describe('ModifyAssistantRequest', function() {
    it('should create an instance of ModifyAssistantRequest', function() {
      // uncomment below and update the code to test ModifyAssistantRequest
      //var instance = new OpenapiOpenai.ModifyAssistantRequest();
      //expect(instance).to.be.a(OpenapiOpenai.ModifyAssistantRequest);
    });
