...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ProjectListResponse();
  });
  ...
  describe('ProjectListResponse', function() {
    it('should create an instance of ProjectListResponse', function() {
      // uncomment below and update the code to test ProjectListResponse
      //var instance = new OpenapiOpenai.ProjectListResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ProjectListResponse);
    });
