...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ProjectServiceAccountListResponse();
  });
  ...
  describe('ProjectServiceAccountListResponse', function() {
    it('should create an instance of ProjectServiceAccountListResponse', function() {
      // uncomment below and update the code to test ProjectServiceAccountListResponse
      //var instance = new OpenapiOpenai.ProjectServiceAccountListResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ProjectServiceAccountListResponse);
    });
