...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ProjectUser();
  });
  ...
  describe('ProjectUser', function() {
    it('should create an instance of ProjectUser', function() {
      // uncomment below and update the code to test ProjectUser
      //var instance = new OpenapiOpenai.ProjectUser();
      //expect(instance).to.be.a(OpenapiOpenai.ProjectUser);
    });
