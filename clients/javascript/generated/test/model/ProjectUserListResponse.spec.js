...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.ProjectUserListResponse();
  });
  ...
  describe('ProjectUserListResponse', function() {
    it('should create an instance of ProjectUserListResponse', function() {
      // uncomment below and update the code to test ProjectUserListResponse
      //var instance = new OpenapiOpenai.ProjectUserListResponse();
      //expect(instance).to.be.a(OpenapiOpenai.ProjectUserListResponse);
    });
