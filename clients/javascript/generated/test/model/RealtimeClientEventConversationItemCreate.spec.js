...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeClientEventConversationItemCreate();
  });
  ...
  describe('RealtimeClientEventConversationItemCreate', function() {
    it('should create an instance of RealtimeClientEventConversationItemCreate', function() {
      // uncomment below and update the code to test RealtimeClientEventConversationItemCreate
      //var instance = new OpenapiOpenai.RealtimeClientEventConversationItemCreate();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeClientEventConversationItemCreate);
    });
