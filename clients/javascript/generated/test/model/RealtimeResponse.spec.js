...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeResponse();
  });
  ...
  describe('RealtimeResponse', function() {
    it('should create an instance of RealtimeResponse', function() {
      // uncomment below and update the code to test RealtimeResponse
      //var instance = new OpenapiOpenai.RealtimeResponse();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeResponse);
    });
