...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventConversationItemCreated();
  });
  ...
  describe('RealtimeServerEventConversationItemCreated', function() {
    it('should create an instance of RealtimeServerEventConversationItemCreated', function() {
      // uncomment below and update the code to test RealtimeServerEventConversationItemCreated
      //var instance = new OpenapiOpenai.RealtimeServerEventConversationItemCreated();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventConversationItemCreated);
    });
