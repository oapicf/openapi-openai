...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventInputAudioBufferCommitted();
  });
  ...
  describe('RealtimeServerEventInputAudioBufferCommitted', function() {
    it('should create an instance of RealtimeServerEventInputAudioBufferCommitted', function() {
      // uncomment below and update the code to test RealtimeServerEventInputAudioBufferCommitted
      //var instance = new OpenapiOpenai.RealtimeServerEventInputAudioBufferCommitted();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventInputAudioBufferCommitted);
    });
