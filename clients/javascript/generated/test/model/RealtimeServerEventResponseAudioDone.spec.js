...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseAudioDone();
  });
  ...
  describe('RealtimeServerEventResponseAudioDone', function() {
    it('should create an instance of RealtimeServerEventResponseAudioDone', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseAudioDone
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseAudioDone();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseAudioDone);
    });
