...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseAudioTranscriptDelta();
  });
  ...
  describe('RealtimeServerEventResponseAudioTranscriptDelta', function() {
    it('should create an instance of RealtimeServerEventResponseAudioTranscriptDelta', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseAudioTranscriptDelta
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseAudioTranscriptDelta();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseAudioTranscriptDelta);
    });
