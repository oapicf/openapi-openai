...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseAudioTranscriptDone();
  });
  ...
  describe('RealtimeServerEventResponseAudioTranscriptDone', function() {
    it('should create an instance of RealtimeServerEventResponseAudioTranscriptDone', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseAudioTranscriptDone
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseAudioTranscriptDone();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseAudioTranscriptDone);
    });
