...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseContentPartAdded();
  });
  ...
  describe('RealtimeServerEventResponseContentPartAdded', function() {
    it('should create an instance of RealtimeServerEventResponseContentPartAdded', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseContentPartAdded
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseContentPartAdded();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseContentPartAdded);
    });
