...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseFunctionCallArgumentsDone();
  });
  ...
  describe('RealtimeServerEventResponseFunctionCallArgumentsDone', function() {
    it('should create an instance of RealtimeServerEventResponseFunctionCallArgumentsDone', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseFunctionCallArgumentsDone
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseFunctionCallArgumentsDone();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseFunctionCallArgumentsDone);
    });
