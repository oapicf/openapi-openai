...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseOutputItemAdded();
  });
  ...
  describe('RealtimeServerEventResponseOutputItemAdded', function() {
    it('should create an instance of RealtimeServerEventResponseOutputItemAdded', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseOutputItemAdded
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseOutputItemAdded();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseOutputItemAdded);
    });
