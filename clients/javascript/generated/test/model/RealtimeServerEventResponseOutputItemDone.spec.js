...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseOutputItemDone();
  });
  ...
  describe('RealtimeServerEventResponseOutputItemDone', function() {
    it('should create an instance of RealtimeServerEventResponseOutputItemDone', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseOutputItemDone
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseOutputItemDone();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseOutputItemDone);
    });
