...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseTextDelta();
  });
  ...
  describe('RealtimeServerEventResponseTextDelta', function() {
    it('should create an instance of RealtimeServerEventResponseTextDelta', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseTextDelta
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseTextDelta();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseTextDelta);
    });
