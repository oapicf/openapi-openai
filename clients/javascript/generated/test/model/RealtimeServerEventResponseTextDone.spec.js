...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RealtimeServerEventResponseTextDone();
  });
  ...
  describe('RealtimeServerEventResponseTextDone', function() {
    it('should create an instance of RealtimeServerEventResponseTextDone', function() {
      // uncomment below and update the code to test RealtimeServerEventResponseTextDone
      //var instance = new OpenapiOpenai.RealtimeServerEventResponseTextDone();
      //expect(instance).to.be.a(OpenapiOpenai.RealtimeServerEventResponseTextDone);
    });
