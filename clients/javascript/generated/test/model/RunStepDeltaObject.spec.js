...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.RunStepDeltaObject();
  });
  ...
  describe('RunStepDeltaObject', function() {
    it('should create an instance of RunStepDeltaObject', function() {
      // uncomment below and update the code to test RunStepDeltaObject
      //var instance = new OpenapiOpenai.RunStepDeltaObject();
      //expect(instance).to.be.a(OpenapiOpenai.RunStepDeltaObject);
    });
