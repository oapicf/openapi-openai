...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.UsageAudioSpeechesResult();
  });
  ...
  describe('UsageAudioSpeechesResult', function() {
    it('should create an instance of UsageAudioSpeechesResult', function() {
      // uncomment below and update the code to test UsageAudioSpeechesResult
      //var instance = new OpenapiOpenai.UsageAudioSpeechesResult();
      //expect(instance).to.be.a(OpenapiOpenai.UsageAudioSpeechesResult);
    });
