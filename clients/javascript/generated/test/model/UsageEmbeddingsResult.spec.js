...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.UsageEmbeddingsResult();
  });
  ...
  describe('UsageEmbeddingsResult', function() {
    it('should create an instance of UsageEmbeddingsResult', function() {
      // uncomment below and update the code to test UsageEmbeddingsResult
      //var instance = new OpenapiOpenai.UsageEmbeddingsResult();
      //expect(instance).to.be.a(OpenapiOpenai.UsageEmbeddingsResult);
    });
