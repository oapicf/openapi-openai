...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.UsageModerationsResult();
  });
  ...
  describe('UsageModerationsResult', function() {
    it('should create an instance of UsageModerationsResult', function() {
      // uncomment below and update the code to test UsageModerationsResult
      //var instance = new OpenapiOpenai.UsageModerationsResult();
      //expect(instance).to.be.a(OpenapiOpenai.UsageModerationsResult);
    });
