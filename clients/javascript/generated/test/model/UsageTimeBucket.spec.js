...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.UsageTimeBucket();
  });
  ...
  describe('UsageTimeBucket', function() {
    it('should create an instance of UsageTimeBucket', function() {
      // uncomment below and update the code to test UsageTimeBucket
      //var instance = new OpenapiOpenai.UsageTimeBucket();
      //expect(instance).to.be.a(OpenapiOpenai.UsageTimeBucket);
    });
