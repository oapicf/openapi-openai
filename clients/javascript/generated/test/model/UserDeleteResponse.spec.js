...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.UserDeleteResponse();
  });
  ...
  describe('UserDeleteResponse', function() {
    it('should create an instance of UserDeleteResponse', function() {
      ...
      //var instance = new OpenapiOpenai.UserDeleteResponse();
      //expect(instance).to.be.a(OpenapiOpenai.UserDeleteResponse);
    });
