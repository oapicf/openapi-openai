...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiOpenai.VectorStoreObjectFileCounts();
  });
  ...
  describe('VectorStoreObjectFileCounts', function() {
    it('should create an instance of VectorStoreObjectFileCounts', function() {
      // uncomment below and update the code to test VectorStoreObjectFileCounts
      //var instance = new OpenapiOpenai.VectorStoreObjectFileCounts();
      //expect(instance).to.be.a(OpenapiOpenai.VectorStoreObjectFileCounts);
    });
