...
public enum StatusEnum {
    ...
    @JsonProperty("validating") VALIDATING(String.valueOf("validating")), @JsonProperty("failed") FAILED(String.valueOf("failed")), @JsonProperty("in_progress") IN_PROGRESS(String.valueOf("in_progress")), @JsonProperty("finalizing") FINALIZING(String.valueOf("finalizing")), @JsonProperty("completed") COMPLETED(String.valueOf("completed")), @JsonProperty("expired") EXPIRED(String.valueOf("expired")), @JsonProperty("cancelling") CANCELLING(String.valueOf("cancelling")), @JsonProperty("cancelled") CANCELLED(String.valueOf("cancelled"));
