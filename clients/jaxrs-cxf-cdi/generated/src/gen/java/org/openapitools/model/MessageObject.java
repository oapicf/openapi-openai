...
public enum StatusEnum {
    ...
    @JsonProperty("in_progress") IN_PROGRESS(String.valueOf("in_progress")), @JsonProperty("incomplete") INCOMPLETE(String.valueOf("incomplete")), @JsonProperty("completed") COMPLETED(String.valueOf("completed"));
