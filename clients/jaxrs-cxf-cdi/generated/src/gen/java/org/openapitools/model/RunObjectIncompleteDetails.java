...
public enum ReasonEnum {
    ...
    @JsonProperty("max_completion_tokens") MAX_COMPLETION_TOKENS(String.valueOf("max_completion_tokens")), @JsonProperty("max_prompt_tokens") MAX_PROMPT_TOKENS(String.valueOf("max_prompt_tokens"));
