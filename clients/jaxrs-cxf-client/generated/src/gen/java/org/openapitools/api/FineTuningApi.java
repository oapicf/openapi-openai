...
public interface FineTuningApi  {
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Creates a fine-tuning job which begins the process of creating a new model from a given dataset.  Response includes details of the enqueued job including job status and the name of the fine-tuned models once complete.  [Learn more about fine-tuning](/docs/guides/fine-tuning) ", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = FineTuningJob.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get status updates for a fine-tuning job. ", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List checkpoints for a fine-tuning job. ", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get info about a fine-tuning job.  [Learn more about fine-tuning](/docs/guides/fine-tuning) ", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = FineTuningJob.class) })
