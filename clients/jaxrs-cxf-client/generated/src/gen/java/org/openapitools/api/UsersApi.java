...
public interface UsersApi  {
    ...
    @ApiOperation(value = "Deletes a user from the organization.", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Lists all of the users in the organization.", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Modifies a user's role in the organization.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "User role updated successfully.", response = User.class) })
    public User modifyUser(@PathParam("user_id") String userId, UserRoleUpdateRequest userRoleUpdateRequest);
    ...
    @Path("/{user_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves a user by their identifier.", tags={  })
    @ApiResponses(value = { 
