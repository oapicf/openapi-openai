...
public interface VectorStoresApi  {
    ...
    @ApiOperation(value = "Cancel a vector store file batch. This attempts to cancel the processing of files in this batch as soon as possible.", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Create a vector store.", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Create a vector store file by attaching a [File](/docs/api-reference/files) to a [vector store](/docs/api-reference/vector-stores/object).", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = VectorStoreFileObject.class) })
    public VectorStoreFileObject createVectorStoreFile(@PathParam("vector_store_id") String vectorStoreId, CreateVectorStoreFileRequest createVectorStoreFileRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Create a vector store file batch.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = VectorStoreFileBatchObject.class) })
    public VectorStoreFileBatchObject createVectorStoreFileBatch(@PathParam("vector_store_id") String vectorStoreId, CreateVectorStoreFileBatchRequest createVectorStoreFileBatchRequest);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete a vector store.", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Delete a vector store file. This will remove the file from the vector store but the file itself will not be deleted. To delete the file, use the [delete file](/docs/api-reference/files/delete) endpoint.", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{vector_store_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves a vector store.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = VectorStoreObject.class) })
    ...
    @Path("/{vector_store_id}/files/{file_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves a vector store file.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = VectorStoreFileObject.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves a vector store file batch.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = VectorStoreFileBatchObject.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns a list of vector store files in a batch.", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{vector_store_id}/files")
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns a list of vector store files.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = ListVectorStoreFilesResponse.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns a list of vector stores.", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Modifies a vector store.", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = VectorStoreObject.class) })
    public VectorStoreObject modifyVectorStore(@PathParam("vector_store_id") String vectorStoreId, UpdateVectorStoreRequest updateVectorStoreRequest);
}
