...
public interface AssistantsApi  {
    ...
    public AssistantObject createAssistant(@Valid CreateAssistantRequest createAssistantRequest);
    ...
    public AssistantFileObject createAssistantFile(@PathParam("assistant_id") String assistantId, @Valid CreateAssistantFileRequest createAssistantFileRequest);
    ...
    public MessageObject createMessage(@PathParam("thread_id") String threadId, @Valid CreateMessageRequest createMessageRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = RunObject.class) })
    public RunObject createRun(@PathParam("thread_id") String threadId, @Valid CreateRunRequest createRunRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = RunObject.class) })
    public RunObject createThreadAndRun(@Valid CreateThreadAndRunRequest createThreadAndRunRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = AssistantObject.class) })
    public AssistantObject modifyAssistant(@PathParam("assistant_id") String assistantId, @Valid ModifyAssistantRequest modifyAssistantRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = MessageObject.class) })
    public MessageObject modifyMessage(@PathParam("thread_id") String threadId, @PathParam("message_id") String messageId, @Valid ModifyMessageRequest modifyMessageRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = RunObject.class) })
    public RunObject modifyRun(@PathParam("thread_id") String threadId, @PathParam("run_id") String runId, @Valid ModifyRunRequest modifyRunRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = ThreadObject.class) })
    public ThreadObject modifyThread(@PathParam("thread_id") String threadId, @Valid ModifyThreadRequest modifyThreadRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = RunObject.class) })
    public RunObject submitToolOuputsToRun(@PathParam("thread_id") String threadId, @PathParam("run_id") String runId, @Valid SubmitToolOutputsRunRequest submitToolOutputsRunRequest);
}
