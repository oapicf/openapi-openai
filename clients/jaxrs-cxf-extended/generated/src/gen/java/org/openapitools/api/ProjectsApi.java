...
public interface ProjectsApi  {
    ...
    public Project createProject(@Valid ProjectCreateRequest projectCreateRequest);
    ...
    public ProjectServiceAccountCreateResponse createProjectServiceAccount(@PathParam("project_id") String projectId, @Valid ProjectServiceAccountCreateRequest projectServiceAccountCreateRequest);
    ...
    public ProjectUser createProjectUser(@PathParam("project_id") String projectId, @Valid ProjectUserCreateRequest projectUserCreateRequest);
    ...
    public Project modifyProject(@PathParam("project_id") String projectId, @Valid ProjectUpdateRequest projectUpdateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Error response for various conditions.", response = ErrorResponse.class) })
    public ProjectUser modifyProjectUser(@PathParam("project_id") String projectId, @PathParam("user_id") String userId, @Valid ProjectUserUpdateRequest projectUserUpdateRequest);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Error response for various conditions.", response = ErrorResponse.class) })
    public ProjectRateLimit updateProjectRateLimits(@PathParam("project_id") String projectId, @PathParam("rate_limit_id") String rateLimitId, @Valid ProjectRateLimitUpdateRequest projectRateLimitUpdateRequest);
}
