...
public interface UploadsApi  {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = Upload.class) })
    public Upload completeUpload(@PathParam("upload_id") String uploadId, @Valid CompleteUploadRequest completeUploadRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = Upload.class) })
    public Upload createUpload(@Valid CreateUploadRequest createUploadRequest);
}
