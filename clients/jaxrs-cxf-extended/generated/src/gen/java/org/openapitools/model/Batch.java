...
public enum StatusEnum {
    ...
    @JsonProperty("validating") VALIDATING(String.valueOf("validating")),
    @JsonProperty("failed") FAILED(String.valueOf("failed")),
    @JsonProperty("in_progress") IN_PROGRESS(String.valueOf("in_progress")),
    @JsonProperty("finalizing") FINALIZING(String.valueOf("finalizing")),
  ...
  */
  ...
  /**
   * Sets the <code>outputFileId</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>errorFileId</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>inProgressAt</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>finalizingAt</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>cancellingAt</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>requestCounts</code> property.
   */
