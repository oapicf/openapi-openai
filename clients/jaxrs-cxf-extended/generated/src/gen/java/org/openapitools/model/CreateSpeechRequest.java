...
public enum VoiceEnum {
    ...
    @JsonProperty("fable") FABLE(String.valueOf("fable")),
    @JsonProperty("onyx") ONYX(String.valueOf("onyx")),
    @JsonProperty("nova") NOVA(String.valueOf("nova")),
...
public enum ResponseFormatEnum {
 ...
 @DecimalMin("0.25") @DecimalMax("4.0")  public BigDecimal getSpeed() {
  ...
  /**
   * Sets the <code>speed</code> property.
   */
