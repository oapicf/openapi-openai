...
public enum TypeEnum {
    ...
    @JsonProperty("supervised") SUPERVISED(String.valueOf("supervised")),
    @JsonProperty("dpo") DPO(String.valueOf("dpo"));
  ...
  */
  ...
  /**
   * Sets the <code>supervised</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>dpo</code> property.
   */
