...
public enum StatusEnum {
    ...
    @JsonProperty("accepted") ACCEPTED(String.valueOf("accepted")),
  ...
  */
  ...
  /**
   * Sets the <code>invitedAt</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>acceptedAt</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>projects</code> property.
   */
 public void setProjects(List<@Valid InviteProjectsInner> projects) {
  ...
  /**
   * Adds a new item to the <code>projects</code> list.
   */
