...
public enum TypeEnum {
    ...
    @JsonProperty("conversation.item.input_audio_transcription.completed") CONVERSATION_ITEM_INPUT_AUDIO_TRANSCRIPTION_COMPLETED(String.valueOf("conversation.item.input_audio_transcription.completed"));
