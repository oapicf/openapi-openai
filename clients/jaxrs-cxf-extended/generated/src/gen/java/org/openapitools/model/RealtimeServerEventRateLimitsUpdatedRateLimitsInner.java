...
public enum NameEnum {
    ...
    @JsonProperty("requests") REQUESTS(String.valueOf("requests")),
    @JsonProperty("tokens") TOKENS(String.valueOf("tokens"));
  ...
  */
  ...
  /**
   * Sets the <code>limit</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>remaining</code> property.
   */
  ...
  */
  ...
  /**
   * Sets the <code>resetSeconds</code> property.
   */
