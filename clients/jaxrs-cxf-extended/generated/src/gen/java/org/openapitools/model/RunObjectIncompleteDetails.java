...
public enum ReasonEnum {
    ...
    @JsonProperty("max_completion_tokens") COMPLETION_TOKENS(String.valueOf("max_completion_tokens")),
    @JsonProperty("max_prompt_tokens") PROMPT_TOKENS(String.valueOf("max_prompt_tokens"));
