...
public enum ObjectEnum {
    ...
    @JsonProperty("organization.usage.audio_transcriptions.result") ORGANIZATION_USAGE_AUDIO_TRANSCRIPTIONS_RESULT(String.valueOf("organization.usage.audio_transcriptions.result"));
