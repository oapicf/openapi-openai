...
public interface InvitesApi  {
    ...
    @ApiOperation(value = "Delete an invite. If the invite has already been accepted, it cannot be deleted.", tags={ "Invites" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Create an invite for a user to the organization. The invite must be accepted by the user before they have access to the organization.", tags={ "Invites" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "User invited successfully.", response = Invite.class) })
    public Invite inviteUser(@Valid @NotNull InviteRequest inviteRequest);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns a list of invites in the organization.", tags={ "Invites" })
    @ApiResponses(value = { 
    ...
    @Path("/{invite_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves an invite.", tags={ "Invites" })
    @ApiResponses(value = { 
