...
public interface ModerationsApi  {
    ...
    @ApiOperation(value = "Classifies if text and/or image inputs are potentially harmful. Learn more in the [moderation guide](/docs/guides/moderation). ", tags={ "Moderations" })
    @ApiResponses(value = { 
