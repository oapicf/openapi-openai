...
public interface OpenAiApi  {
    ...
    public CreateChatCompletionResponse createChatCompletion(@Valid @NotNull CreateChatCompletionRequest createChatCompletionRequest);
    ...
    public CreateEditResponse createEdit(@Valid @NotNull CreateEditRequest createEditRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = FineTune.class) })
    public FineTune createFineTune(@Valid @NotNull CreateFineTuneRequest createFineTuneRequest);
    ...
    public ImagesResponse createImage(@Valid @NotNull CreateImageRequest createImageRequest);
