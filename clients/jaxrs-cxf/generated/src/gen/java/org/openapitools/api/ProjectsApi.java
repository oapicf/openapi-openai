...
public interface ProjectsApi  {
    ...
    @ApiOperation(value = "Archives a project in the organization. Archived projects cannot be used or updated.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Create a new project in the organization. Projects can be created and archived, but cannot be deleted.", tags={ "Projects" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Project created successfully.", response = Project.class) })
    public Project createProject(@Valid @NotNull ProjectCreateRequest projectCreateRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Creates a new service account in the project. This also returns an unredacted API key for the service account.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    public ProjectServiceAccountCreateResponse createProjectServiceAccount(@PathParam("project_id") String projectId, @Valid @NotNull ProjectServiceAccountCreateRequest projectServiceAccountCreateRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Adds a user to the project. Users must already be members of the organization to be added to a project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    public ProjectUser createProjectUser(@PathParam("project_id") String projectId, @Valid @NotNull ProjectUserCreateRequest projectUserCreateRequest);
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Deletes an API key from the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Deletes a service account from the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Deletes a user from the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns a list of API keys in the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns the rate limits per model for a project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Path("/{project_id}/service_accounts")
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns a list of service accounts in the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Path("/{project_id}/users")
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns a list of users in the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Returns a list of projects.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Modifies a project in the organization.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    public Project modifyProject(@PathParam("project_id") String projectId, @Valid @NotNull ProjectUpdateRequest projectUpdateRequest);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Modifies a user's role in the project.", tags={ "Projects" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Project user's role updated successfully.", response = ProjectUser.class),
        @ApiResponse(code = 400, message = "Error response for various conditions.", response = ErrorResponse.class) })
    public ProjectUser modifyProjectUser(@PathParam("project_id") String projectId, @PathParam("user_id") String userId, @Valid @NotNull ProjectUserUpdateRequest projectUserUpdateRequest);
    ...
    @Path("/{project_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves a project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Path("/{project_id}/api_keys/{key_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves an API key in the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Path("/{project_id}/service_accounts/{service_account_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves a service account in the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Path("/{project_id}/users/{user_id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Retrieves a user in the project.", tags={ "Projects" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Updates a project rate limit.", tags={ "Projects" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Project rate limit updated successfully.", response = ProjectRateLimit.class),
        @ApiResponse(code = 400, message = "Error response for various conditions.", response = ErrorResponse.class) })
    public ProjectRateLimit updateProjectRateLimits(@PathParam("project_id") String projectId, @PathParam("rate_limit_id") String rateLimitId, @Valid @NotNull ProjectRateLimitUpdateRequest projectRateLimitUpdateRequest);
}
