...
public interface VectorStoresApi  {
    ...
    public VectorStoreObject createVectorStore(@Valid @NotNull CreateVectorStoreRequest createVectorStoreRequest);
    ...
    public VectorStoreFileObject createVectorStoreFile(@PathParam("vector_store_id") String vectorStoreId, @Valid @NotNull CreateVectorStoreFileRequest createVectorStoreFileRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = VectorStoreFileBatchObject.class) })
    public VectorStoreFileBatchObject createVectorStoreFileBatch(@PathParam("vector_store_id") String vectorStoreId, @Valid @NotNull CreateVectorStoreFileBatchRequest createVectorStoreFileBatchRequest);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = VectorStoreObject.class) })
    public VectorStoreObject modifyVectorStore(@PathParam("vector_store_id") String vectorStoreId, @Valid @NotNull UpdateVectorStoreRequest updateVectorStoreRequest);
}
