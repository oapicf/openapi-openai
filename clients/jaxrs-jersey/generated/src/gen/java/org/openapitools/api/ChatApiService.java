...
public abstract class ChatApiService {
    public abstract Response createChatCompletion(CreateChatCompletionRequest createChatCompletionRequest,SecurityContext securityContext) throws NotFoundException;
}
