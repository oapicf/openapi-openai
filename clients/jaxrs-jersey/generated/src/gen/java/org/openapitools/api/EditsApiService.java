...
public abstract class EditsApiService {
    public abstract Response createEdit(CreateEditRequest createEditRequest,SecurityContext securityContext) throws NotFoundException;
}
