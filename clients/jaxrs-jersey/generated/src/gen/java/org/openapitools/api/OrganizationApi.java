   ...
   public OrganizationApi(@Context ServletConfig servletContext) {
      ...
      if (servletContext != null) {
         ...
         if (implClass != null && !"".equals(implClass.trim())) {
            try {
               delegate = (OrganizationApiService) Class.forName(implClass).getDeclaredConstructor().newInstance();
            } catch (Exception e) {
    ...
    public Response adminApiKeysDelete(@ApiParam(value = "", required = true) @PathParam("key_id") @NotNull  String keyId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response adminApiKeysGet(@ApiParam(value = "", required = true) @PathParam("key_id") @NotNull  String keyId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response adminApiKeysList(@ApiParam(value = "") @QueryParam("after")  String after,@ApiParam(value = "", allowableValues="asc, desc", defaultValue = "asc") @DefaultValue("asc") @QueryParam("order")  String order,@ApiParam(value = "", defaultValue = "20") @DefaultValue("20") @QueryParam("limit")  Integer limit,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response archiveProject(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response createProjectServiceAccount(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The project service account create request payload.", required = true) @NotNull @Valid  ProjectServiceAccountCreateRequest projectServiceAccountCreateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response createProjectUser(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The project user create request payload.", required = true) @NotNull @Valid  ProjectUserCreateRequest projectUserCreateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response deleteInvite(@ApiParam(value = "The ID of the invite to delete.", required = true) @PathParam("invite_id") @NotNull  String inviteId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response deleteProjectApiKey(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The ID of the API key.", required = true) @PathParam("key_id") @NotNull  String keyId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response deleteProjectServiceAccount(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The ID of the service account.", required = true) @PathParam("service_account_id") @NotNull  String serviceAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response deleteProjectUser(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The ID of the user.", required = true) @PathParam("user_id") @NotNull  String userId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response deleteUser(@ApiParam(value = "The ID of the user.", required = true) @PathParam("user_id") @NotNull  String userId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response listProjectApiKeys(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. ", defaultValue = "20") @DefaultValue("20") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. `after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include after=obj_foo in order to fetch the next page of the list. ") @QueryParam("after")  String after,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response listProjectRateLimits(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "A limit on the number of objects to be returned. The default is 100. ", defaultValue = "100") @DefaultValue("100") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. `after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include after=obj_foo in order to fetch the next page of the list. ") @QueryParam("after")  String after,@ApiParam(value = "A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, beginning with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. ") @QueryParam("before")  String before,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response listProjectServiceAccounts(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. ", defaultValue = "20") @DefaultValue("20") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. `after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include after=obj_foo in order to fetch the next page of the list. ") @QueryParam("after")  String after,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response listProjectUsers(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. ", defaultValue = "20") @DefaultValue("20") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. `after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include after=obj_foo in order to fetch the next page of the list. ") @QueryParam("after")  String after,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response listProjects(@ApiParam(value = "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. ", defaultValue = "20") @DefaultValue("20") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. `after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include after=obj_foo in order to fetch the next page of the list. ") @QueryParam("after")  String after,@ApiParam(value = "If `true` returns all projects including those that have been `archived`. Archived projects are not included by default.", defaultValue = "false") @DefaultValue("false") @QueryParam("include_archived")  Boolean includeArchived,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response modifyProject(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The project update request payload.", required = true) @NotNull @Valid  ProjectUpdateRequest projectUpdateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response modifyProjectUser(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The ID of the user.", required = true) @PathParam("user_id") @NotNull  String userId,@ApiParam(value = "The project user update request payload.", required = true) @NotNull @Valid  ProjectUserUpdateRequest projectUserUpdateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response modifyUser(@ApiParam(value = "The ID of the user.", required = true) @PathParam("user_id") @NotNull  String userId,@ApiParam(value = "The new user role to modify. This must be one of `owner` or `member`.", required = true) @NotNull @Valid  UserRoleUpdateRequest userRoleUpdateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response retrieveInvite(@ApiParam(value = "The ID of the invite to retrieve.", required = true) @PathParam("invite_id") @NotNull  String inviteId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response retrieveProject(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response retrieveProjectApiKey(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The ID of the API key.", required = true) @PathParam("key_id") @NotNull  String keyId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response retrieveProjectServiceAccount(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The ID of the service account.", required = true) @PathParam("service_account_id") @NotNull  String serviceAccountId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response retrieveProjectUser(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The ID of the user.", required = true) @PathParam("user_id") @NotNull  String userId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response retrieveUser(@ApiParam(value = "The ID of the user.", required = true) @PathParam("user_id") @NotNull  String userId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response updateProjectRateLimits(@ApiParam(value = "The ID of the project.", required = true) @PathParam("project_id") @NotNull  String projectId,@ApiParam(value = "The ID of the rate limit.", required = true) @PathParam("rate_limit_id") @NotNull  String rateLimitId,@ApiParam(value = "The project rate limit update request payload.", required = true) @NotNull @Valid  ProjectRateLimitUpdateRequest projectRateLimitUpdateRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response usageAudioTranscriptions(@ApiParam(value = "Start time (Unix seconds) of the query time range, inclusive.", required = true) @QueryParam("start_time") @NotNull  Integer startTime,@ApiParam(value = "End time (Unix seconds) of the query time range, exclusive.") @QueryParam("end_time")  Integer endTime,@ApiParam(value = "Width of each time bucket in response. Currently `1m`, `1h` and `1d` are supported, default to `1d`.", allowableValues="1m, 1h, 1d", defaultValue = "1d") @DefaultValue("1d") @QueryParam("bucket_width")  String bucketWidth,@ApiParam(value = "Return only usage for these projects.") @QueryParam("project_ids")  List<String> projectIds,@ApiParam(value = "Return only usage for these users.") @QueryParam("user_ids")  List<String> userIds,@ApiParam(value = "Return only usage for these API keys.") @QueryParam("api_key_ids")  List<String> apiKeyIds,@ApiParam(value = "Return only usage for these models.") @QueryParam("models")  List<String> models,@ApiParam(value = "Group the usage data by the specified fields. Support fields include `project_id`, `user_id`, `api_key_id`, `model` or any combination of them.") @QueryParam("group_by")  List<String> groupBy,@ApiParam(value = "Specifies the number of buckets to return. - `bucket_width=1d`: default: 7, max: 31 - `bucket_width=1h`: default: 24, max: 168 - `bucket_width=1m`: default: 60, max: 1440 ") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. Corresponding to the `next_page` field from the previous response.") @QueryParam("page")  String page,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response usageEmbeddings(@ApiParam(value = "Start time (Unix seconds) of the query time range, inclusive.", required = true) @QueryParam("start_time") @NotNull  Integer startTime,@ApiParam(value = "End time (Unix seconds) of the query time range, exclusive.") @QueryParam("end_time")  Integer endTime,@ApiParam(value = "Width of each time bucket in response. Currently `1m`, `1h` and `1d` are supported, default to `1d`.", allowableValues="1m, 1h, 1d", defaultValue = "1d") @DefaultValue("1d") @QueryParam("bucket_width")  String bucketWidth,@ApiParam(value = "Return only usage for these projects.") @QueryParam("project_ids")  List<String> projectIds,@ApiParam(value = "Return only usage for these users.") @QueryParam("user_ids")  List<String> userIds,@ApiParam(value = "Return only usage for these API keys.") @QueryParam("api_key_ids")  List<String> apiKeyIds,@ApiParam(value = "Return only usage for these models.") @QueryParam("models")  List<String> models,@ApiParam(value = "Group the usage data by the specified fields. Support fields include `project_id`, `user_id`, `api_key_id`, `model` or any combination of them.") @QueryParam("group_by")  List<String> groupBy,@ApiParam(value = "Specifies the number of buckets to return. - `bucket_width=1d`: default: 7, max: 31 - `bucket_width=1h`: default: 24, max: 168 - `bucket_width=1m`: default: 60, max: 1440 ") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. Corresponding to the `next_page` field from the previous response.") @QueryParam("page")  String page,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response usageModerations(@ApiParam(value = "Start time (Unix seconds) of the query time range, inclusive.", required = true) @QueryParam("start_time") @NotNull  Integer startTime,@ApiParam(value = "End time (Unix seconds) of the query time range, exclusive.") @QueryParam("end_time")  Integer endTime,@ApiParam(value = "Width of each time bucket in response. Currently `1m`, `1h` and `1d` are supported, default to `1d`.", allowableValues="1m, 1h, 1d", defaultValue = "1d") @DefaultValue("1d") @QueryParam("bucket_width")  String bucketWidth,@ApiParam(value = "Return only usage for these projects.") @QueryParam("project_ids")  List<String> projectIds,@ApiParam(value = "Return only usage for these users.") @QueryParam("user_ids")  List<String> userIds,@ApiParam(value = "Return only usage for these API keys.") @QueryParam("api_key_ids")  List<String> apiKeyIds,@ApiParam(value = "Return only usage for these models.") @QueryParam("models")  List<String> models,@ApiParam(value = "Group the usage data by the specified fields. Support fields include `project_id`, `user_id`, `api_key_id`, `model` or any combination of them.") @QueryParam("group_by")  List<String> groupBy,@ApiParam(value = "Specifies the number of buckets to return. - `bucket_width=1d`: default: 7, max: 31 - `bucket_width=1h`: default: 24, max: 168 - `bucket_width=1m`: default: 60, max: 1440 ") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. Corresponding to the `next_page` field from the previous response.") @QueryParam("page")  String page,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response usageVectorStores(@ApiParam(value = "Start time (Unix seconds) of the query time range, inclusive.", required = true) @QueryParam("start_time") @NotNull  Integer startTime,@ApiParam(value = "End time (Unix seconds) of the query time range, exclusive.") @QueryParam("end_time")  Integer endTime,@ApiParam(value = "Width of each time bucket in response. Currently `1m`, `1h` and `1d` are supported, default to `1d`.", allowableValues="1m, 1h, 1d", defaultValue = "1d") @DefaultValue("1d") @QueryParam("bucket_width")  String bucketWidth,@ApiParam(value = "Return only usage for these projects.") @QueryParam("project_ids")  List<String> projectIds,@ApiParam(value = "Group the usage data by the specified fields. Support fields include `project_id`.") @QueryParam("group_by")  List<String> groupBy,@ApiParam(value = "Specifies the number of buckets to return. - `bucket_width=1d`: default: 7, max: 31 - `bucket_width=1h`: default: 24, max: 168 - `bucket_width=1m`: default: 60, max: 1440 ") @QueryParam("limit")  Integer limit,@ApiParam(value = "A cursor for use in pagination. Corresponding to the `next_page` field from the previous response.") @QueryParam("page")  String page,@Context SecurityContext securityContext)
    throws NotFoundException {
