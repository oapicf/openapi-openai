...
public abstract class ThreadsApiService {
    ...
    public abstract Response createRun(String threadId,CreateRunRequest createRunRequest,List<String> include,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response deleteMessage(String threadId,String messageId,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getRunStep(String threadId,String runId,String stepId,List<String> include,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response listRunSteps(String threadId,String runId,Integer limit,String order,String after,String before,List<String> include,SecurityContext securityContext) throws NotFoundException;
