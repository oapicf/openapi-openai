...
import org.openapitools.api.factories.UploadsApiServiceFactory;
...
public class UploadsApi  {
   private final UploadsApiService delegate;

   public UploadsApi(@Context ServletConfig servletContext) {
      UploadsApiService delegate = null;

      if (servletContext != null) {
         String implClass = servletContext.getInitParameter("UploadsApi.implementation");
         if (implClass != null && !"".equals(implClass.trim())) {
            try {
               delegate = (UploadsApiService) Class.forName(implClass).getDeclaredConstructor().newInstance();
            } catch (Exception e) {
      ...
      if (delegate == null) {
         delegate = UploadsApiServiceFactory.getUploadsApi();
      }
    ...
    public Response addUploadPart(@ApiParam(value = "The ID of the Upload. ", required = true) @PathParam("upload_id") @NotNull  String uploadId,
 @FormDataParam("data") FormDataBodyPart dataBodypart ,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.addUploadPart(uploadId, dataBodypart, securityContext);
    }
    @javax.ws.rs.POST
    ...
    public Response cancelUpload(@ApiParam(value = "The ID of the Upload. ", required = true) @PathParam("upload_id") @NotNull  String uploadId,@Context SecurityContext securityContext)
    throws NotFoundException {
    ...
    public Response completeUpload(@ApiParam(value = "The ID of the Upload. ", required = true) @PathParam("upload_id") @NotNull  String uploadId,@ApiParam(value = "", required = true) @NotNull @Valid  CompleteUploadRequest completeUploadRequest,@Context SecurityContext securityContext)
    throws NotFoundException {
