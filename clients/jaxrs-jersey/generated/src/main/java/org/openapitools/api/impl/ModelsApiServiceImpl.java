...
public class ModelsApiServiceImpl extends ModelsApiService {
    @Override
    public Response deleteModel(String model, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
    ...
    @Override
    public Response retrieveModel(String model, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
}
