...
public class OrganizationApi  {
    ...
    throws NotFoundException {
        return service.adminApiKeysCreate(adminApiKeysCreateRequest,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.adminApiKeysDelete(keyId,securityContext);
    }
    @GET
    @Path("/admin_api_keys/{key_id}")
    ...
    throws NotFoundException {
        return service.adminApiKeysGet(keyId,securityContext);
    }
    @GET
    @Path("/admin_api_keys")
    ...
    throws NotFoundException {
        return service.adminApiKeysList(after,order,limit,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.archiveProject(projectId,securityContext);
    }
    @POST
    @Path("/projects")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.createProject(projectCreateRequest,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.createProjectServiceAccount(projectId,projectServiceAccountCreateRequest,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.createProjectUser(projectId,projectUserCreateRequest,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.deleteInvite(inviteId,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.deleteProjectApiKey(projectId,keyId,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.deleteProjectServiceAccount(projectId,serviceAccountId,securityContext);
    }
    @DELETE
    ...
    throws NotFoundException {
        return service.deleteProjectUser(projectId,userId,securityContext);
    }
    @DELETE
    @Path("/users/{user_id}")
    ...
    throws NotFoundException {
        return service.inviteUser(inviteRequest,securityContext);
    }
    @GET
    @Path("/audit_logs")
    ...
    throws NotFoundException {
        return service.listAuditLogs(effectiveAt,projectIds,eventTypes,actorIds,actorEmails,resourceIds,limit,after,before,securityContext);
    }
    @GET
    @Path("/invites")
    ...
    throws NotFoundException {
        return service.listInvites(limit,after,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.listProjectApiKeys(projectId,limit,after,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.listProjectRateLimits(projectId,limit,after,before,securityContext);
    }
    @GET
    @Path("/projects/{project_id}/service_accounts")
    ...
    throws NotFoundException {
        return service.listProjectServiceAccounts(projectId,limit,after,securityContext);
    }
    @GET
    @Path("/projects/{project_id}/users")
    ...
    throws NotFoundException {
        return service.listProjectUsers(projectId,limit,after,securityContext);
    }
    @GET
    @Path("/projects")
    ...
    throws NotFoundException {
        return service.listProjects(limit,after,includeArchived,securityContext);
    }
    @GET
    @Path("/users")
    ...
    throws NotFoundException {
        return service.listUsers(limit,after,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.modifyProject(projectId,projectUpdateRequest,securityContext);
    }
    @POST
    @Path("/projects/{project_id}/users/{user_id}")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.modifyProjectUser(projectId,userId,projectUserUpdateRequest,securityContext);
    }
    @POST
    @Path("/users/{user_id}")
    @Consumes({ "application/json" })
    ...
    throws NotFoundException {
        return service.modifyUser(userId,userRoleUpdateRequest,securityContext);
    }
    @GET
    @Path("/invites/{invite_id}")
    ...
    throws NotFoundException {
        return service.retrieveInvite(inviteId,securityContext);
    }
    @GET
    @Path("/projects/{project_id}")
    ...
    throws NotFoundException {
        return service.retrieveProject(projectId,securityContext);
    }
    @GET
    @Path("/projects/{project_id}/api_keys/{key_id}")
    ...
    throws NotFoundException {
        return service.retrieveProjectApiKey(projectId,keyId,securityContext);
    }
    @GET
    @Path("/projects/{project_id}/service_accounts/{service_account_id}")
    ...
    throws NotFoundException {
        return service.retrieveProjectServiceAccount(projectId,serviceAccountId,securityContext);
    }
    @GET
    @Path("/projects/{project_id}/users/{user_id}")
    ...
    throws NotFoundException {
        return service.retrieveProjectUser(projectId,userId,securityContext);
    }
    @GET
    @Path("/users/{user_id}")
    ...
    throws NotFoundException {
        return service.retrieveUser(userId,securityContext);
    }
    @POST
    ...
    throws NotFoundException {
        return service.updateProjectRateLimits(projectId,rateLimitId,projectRateLimitUpdateRequest,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.usageAudioSpeeches(startTime,endTime,bucketWidth,projectIds,userIds,apiKeyIds,models,groupBy,limit,page,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.usageAudioTranscriptions(startTime,endTime,bucketWidth,projectIds,userIds,apiKeyIds,models,groupBy,limit,page,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.usageCodeInterpreterSessions(startTime,endTime,bucketWidth,projectIds,groupBy,limit,page,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.usageCompletions(startTime,endTime,bucketWidth,projectIds,userIds,apiKeyIds,models,batch,groupBy,limit,page,securityContext);
    }
    @GET
    @Path("/costs")
    ...
    throws NotFoundException {
        return service.usageCosts(startTime,endTime,bucketWidth,projectIds,groupBy,limit,page,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.usageEmbeddings(startTime,endTime,bucketWidth,projectIds,userIds,apiKeyIds,models,groupBy,limit,page,securityContext);
    }
    @GET
    @Path("/usage/images")
    ...
    throws NotFoundException {
        return service.usageImages(startTime,endTime,bucketWidth,sources,sizes,projectIds,userIds,apiKeyIds,models,groupBy,limit,page,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.usageModerations(startTime,endTime,bucketWidth,projectIds,userIds,apiKeyIds,models,groupBy,limit,page,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.usageVectorStores(startTime,endTime,bucketWidth,projectIds,groupBy,limit,page,securityContext);
    }
}
