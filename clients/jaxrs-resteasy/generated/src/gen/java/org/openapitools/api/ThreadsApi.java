...
public class ThreadsApi  {
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK", response = RunObject.class) })
    public Response createRun( @PathParam("thread_id") String threadId,@ApiParam(value = "" ,required=true) @NotNull @Valid CreateRunRequest createRunRequest, @QueryParam("include[]") List<String> include,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.createRun(threadId,createRunRequest,include,securityContext);
    }
    @POST
    ...
    public Response deleteMessage( @PathParam("thread_id") String threadId, @PathParam("message_id") String messageId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteMessage(threadId,messageId,securityContext);
    }
    @DELETE
    @Path("/{thread_id}")
    ...
    public Response getRunStep( @PathParam("thread_id") String threadId, @PathParam("run_id") String runId, @PathParam("step_id") String stepId, @QueryParam("include[]") List<String> include,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getRunStep(threadId,runId,stepId,include,securityContext);
    }
    @GET
    @Path("/{thread_id}")
    ...
    public Response listRunSteps( @PathParam("thread_id") String threadId, @PathParam("run_id") String runId, @DefaultValue("20") @QueryParam("limit") Integer limit,, allowableValues="asc, desc" @DefaultValue("desc") @QueryParam("order") String order, @QueryParam("after") String after, @QueryParam("before") String before, @QueryParam("include[]") List<String> include,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.listRunSteps(threadId,runId,limit,order,after,before,include,securityContext);
    }
    @GET
    @Path("/{thread_id}/runs")
