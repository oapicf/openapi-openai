...
@ApiModel(description="Occurs when a [run](/docs/api-reference/runs/object) moves to an `in_progress` status.")@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaResteasyServerCodegen", date = "2024-04-14T13:41:51.736364282Z[Etc/UTC]", comments = "Generator version: 7.4.0")
