...
public class ApiKeyList   {
  ...
  private @Valid List<@Valid AdminApiKey> data = new ArrayList<>();
  ...
  @JsonProperty("data")
  @Valid public List<@Valid AdminApiKey> getData() {
    return data;
  }
  ...
  public ApiKeyList removeDataItem(AdminApiKey dataItem) {
