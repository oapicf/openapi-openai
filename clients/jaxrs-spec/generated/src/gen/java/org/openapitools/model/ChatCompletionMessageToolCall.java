...
public class ChatCompletionMessageToolCall   {
  ...
  public ChatCompletionMessageToolCall(
    ...
    @JsonProperty(required = true, value = "function") ChatCompletionMessageToolCallFunction function
  ) {
    this.id = id;
    this.type = type;
  ...
  @NotNull @Valid public ChatCompletionMessageToolCallFunction getFunction() {
    return function;
  }
