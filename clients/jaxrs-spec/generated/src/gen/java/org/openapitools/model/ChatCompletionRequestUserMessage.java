...
public class ChatCompletionRequestUserMessage   {
  ...
  @JsonCreator
  public ChatCompletionRequestUserMessage(
    @JsonProperty(required = true, value = "content") ChatCompletionRequestUserMessageContent content,
  ...
  @NotNull @Valid public ChatCompletionRequestUserMessageContent getContent() {
    return content;
  }
