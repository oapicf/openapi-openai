...
public class ChatCompletionStreamResponseDelta   {
  ...
  private @Valid List<@Valid ChatCompletionMessageToolCallChunk> toolCalls = new ArrayList<>();
  ...
  @Valid public ChatCompletionStreamResponseDeltaFunctionCall getFunctionCall() {
    return functionCall;
  }
  ...
  @Valid public List<@Valid ChatCompletionMessageToolCallChunk> getToolCalls() {
    return toolCalls;
  }
