...
public class CreateChatCompletionResponse   {
  ...
  public CreateChatCompletionResponse(
    ...
    @JsonProperty(required = true, value = "choices") List<@Valid CreateChatCompletionResponseChoicesInner> choices,
  ...
  @NotNull @Valid public List<@Valid CreateChatCompletionResponseChoicesInner> getChoices() {
    return choices;
  }
