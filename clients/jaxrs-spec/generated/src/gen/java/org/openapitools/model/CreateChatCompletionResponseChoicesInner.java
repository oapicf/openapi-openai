...
public class CreateChatCompletionResponseChoicesInner   {
  ...
  public CreateChatCompletionResponseChoicesInner(
    ...
    @JsonProperty(required = true, value = "message") ChatCompletionResponseMessage message,
    @JsonProperty(required = true, value = "logprobs") CreateChatCompletionResponseChoicesInnerLogprobs logprobs
  ) {
