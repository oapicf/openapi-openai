...
public class CreateCompletionRequest   {
  ...
  @JsonCreator
  public CreateCompletionRequest(
    @JsonProperty(required = true, value = "model") CreateCompletionRequestModel model,
    @JsonProperty(required = true, value = "prompt") CreateCompletionRequestPrompt prompt
  ) {
    this.model = model;
    this.prompt = prompt;
  }
  ...
  @NotNull @Valid public CreateCompletionRequestModel getModel() {
    return model;
  }
  ...
  @NotNull @Valid public CreateCompletionRequestPrompt getPrompt() {
    return prompt;
  }
  ...
  public CreateCompletionRequest removeLogitBiasItem(String key) {
    if (this.logitBias != null) {
  ...
  @JsonProperty("stop")
  @Valid public CreateCompletionRequestStop getStop() {
    return stop;
  }
