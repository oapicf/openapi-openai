...
public class CreateEmbeddingResponse   {
  ...
  private @Valid List<@Valid CreateEmbeddingResponseDataInner> data = new ArrayList<>();
  ...
  public CreateEmbeddingResponse removeDataItem(CreateEmbeddingResponseDataInner dataItem) {
