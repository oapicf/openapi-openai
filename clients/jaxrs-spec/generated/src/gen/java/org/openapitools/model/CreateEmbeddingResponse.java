...
public class CreateEmbeddingResponse   {
  ...
  @JsonCreator
  public CreateEmbeddingResponse(
    @JsonProperty(required = true, value = "data") List<@Valid Embedding> data,
    @JsonProperty(required = true, value = "model") String model,
    @JsonProperty(required = true, value = "object") ObjectEnum _object,
    @JsonProperty(required = true, value = "usage") CreateEmbeddingResponseUsage usage
  ) {
    this.data = data;
    this.model = model;
  ...
  @NotNull @Valid public List<@Valid Embedding> getData() {
    return data;
  }
  ...
  @NotNull @Valid public CreateEmbeddingResponseUsage getUsage() {
    return usage;
  }
