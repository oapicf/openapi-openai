...
public class CreateFineTuningJobRequest   {
  ...
  @JsonCreator
  public CreateFineTuningJobRequest(
    @JsonProperty(required = true, value = "model") CreateFineTuningJobRequestModel model,
  ...
  @NotNull @Valid public CreateFineTuningJobRequestModel getModel() {
    return model;
  }
  ...
  @Valid public CreateFineTuningJobRequestHyperparameters getHyperparameters() {
  ...
  @Valid public List<@Valid CreateFineTuningJobRequestIntegrationsInner> getIntegrations() {
    return integrations;
  }
