...
public class CreateModerationRequestInputOneOfInnerOneOf   {
  ...
  public CreateModerationRequestInputOneOfInnerOneOf(
    ...
    @JsonProperty(required = true, value = "image_url") CreateModerationRequestInputOneOfInnerOneOfImageUrl imageUrl
  ) {
    this.type = type;
  ...
  @NotNull @Valid public CreateModerationRequestInputOneOfInnerOneOfImageUrl getImageUrl() {
    return imageUrl;
  }
