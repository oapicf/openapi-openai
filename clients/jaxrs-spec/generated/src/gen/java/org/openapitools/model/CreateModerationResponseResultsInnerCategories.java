...
public class CreateModerationResponseResultsInnerCategories   {
  ...
  @JsonCreator
  public CreateModerationResponseResultsInnerCategories(
    @JsonProperty(required = true, value = "hate") Boolean hate,
    ...
    @JsonProperty(required = true, value = "sexual") Boolean sexual,
    @JsonProperty(required = true, value = "sexual/minors") Boolean sexualMinors,
    @JsonProperty(required = true, value = "violence") Boolean violence,
    @JsonProperty(required = true, value = "violence/graphic") Boolean violenceGraphic
  ) {
    this.hate = hate;
  ...
  @NotNull public Boolean getHate() {
    return hate;
  }
  ...
  @NotNull public Boolean getHateThreatening() {
  ...
  @NotNull public Boolean getHarassment() {
    return harassment;
  }
  ...
  @NotNull public Boolean getHarassmentThreatening() {
  ...
  @NotNull public Boolean getSelfHarm() {
    return selfHarm;
  }
  ...
  @NotNull public Boolean getSelfHarmIntent() {
  ...
  @NotNull public Boolean getSelfHarmInstructions() {
  ...
  @NotNull public Boolean getSexual() {
    return sexual;
  }
  ...
  @NotNull public Boolean getSexualMinors() {
    return sexualMinors;
  }
  ...
  @NotNull public Boolean getViolence() {
    return violence;
  }
  ...
  @NotNull public Boolean getViolenceGraphic() {
