...
public class FineTuningJobCheckpoint   {
  ...
  public FineTuningJobCheckpoint(
    ...
    @JsonProperty(required = true, value = "fine_tuned_model_checkpoint") String fineTunedModelCheckpoint,
    @JsonProperty(required = true, value = "step_number") Integer stepNumber,
    @JsonProperty(required = true, value = "metrics") FineTuningJobCheckpointMetrics metrics,
    @JsonProperty(required = true, value = "fine_tuning_job_id") String fineTuningJobId,
  ...
  @JsonProperty(required = true, value = "fine_tuned_model_checkpoint")
  ...
  @JsonProperty(required = true, value = "step_number")
  ...
  @JsonProperty(required = true, value = "fine_tuning_job_id")
