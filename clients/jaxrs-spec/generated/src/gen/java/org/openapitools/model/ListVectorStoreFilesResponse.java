...
public class ListVectorStoreFilesResponse   {
  ...
  private @Valid List<@Valid VectorStoreFileObject> data = new ArrayList<>();
  ...
  public ListVectorStoreFilesResponse(
    ...
    @JsonProperty(required = true, value = "data") List<@Valid VectorStoreFileObject> data,
  ...
  @NotNull @Valid public List<@Valid VectorStoreFileObject> getData() {
    return data;
  }
  ...
  public ListVectorStoreFilesResponse removeDataItem(VectorStoreFileObject dataItem) {
