...
@JsonTypeName("ListVectorStoresResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaJAXRSSpecServerCodegen", date = "2026-01-29T14:09:36.506419692Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class ListVectorStoresResponse   {
  private String _object;
  private @Valid List<@Valid VectorStoreObject> data = new ArrayList<>();
  ...
  public ListVectorStoresResponse(
    ...
    @JsonProperty(required = true, value = "data") List<@Valid VectorStoreObject> data,
  ...
  @NotNull @Valid public List<@Valid VectorStoreObject> getData() {
    return data;
  }
  ...
  public ListVectorStoresResponse removeDataItem(VectorStoreObject dataItem) {
