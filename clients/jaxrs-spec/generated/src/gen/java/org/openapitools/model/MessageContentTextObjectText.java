...
public class MessageContentTextObjectText   {
  ...
  public MessageContentTextObjectText(
    ...
    @JsonProperty(required = true, value = "annotations") List<@Valid MessageContentTextObjectTextAnnotationsInner> annotations
  ) {
    this.value = value;
  ...
  @JsonProperty(required = true, value = "annotations")
