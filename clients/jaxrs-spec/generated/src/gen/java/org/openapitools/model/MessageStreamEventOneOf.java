...
public class MessageStreamEventOneOf   {
  public enum EventEnum {
    ...
    THREAD_MESSAGE_CREATED(String.valueOf("thread.message.created"));
  ...
  public MessageStreamEventOneOf(
    ...
    @JsonProperty(required = true, value = "data") MessageObject data
  ) {
    this.event = event;
    this.data = data;
  }
  ...
  @NotNull @Valid public MessageObject getData() {
    return data;
  }
