...
@JsonTypeName("ProjectListResponse")
...
public class ProjectListResponse   {
  ...
  private @Valid List<@Valid Project> data = new ArrayList<>();
  ...
  public ProjectListResponse(
    ...
    @JsonProperty(required = true, value = "data") List<@Valid Project> data,
  ...
  @NotNull @Valid public List<@Valid Project> getData() {
    return data;
  }
  ...
  public ProjectListResponse removeDataItem(Project dataItem) {
