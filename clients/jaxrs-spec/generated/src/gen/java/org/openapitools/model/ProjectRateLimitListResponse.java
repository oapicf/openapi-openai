...
public class ProjectRateLimitListResponse   {
  ...
  private @Valid List<@Valid ProjectRateLimit> data = new ArrayList<>();
  ...
  public ProjectRateLimitListResponse(
    ...
    @JsonProperty(required = true, value = "data") List<@Valid ProjectRateLimit> data,
  ...
  @NotNull @Valid public List<@Valid ProjectRateLimit> getData() {
    return data;
  }
  ...
  public ProjectRateLimitListResponse removeDataItem(ProjectRateLimit dataItem) {
