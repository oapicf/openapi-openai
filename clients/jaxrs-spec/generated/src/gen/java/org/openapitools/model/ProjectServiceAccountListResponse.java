...
public class ProjectServiceAccountListResponse   {
  ...
  private @Valid List<@Valid ProjectServiceAccount> data = new ArrayList<>();
  ...
  public ProjectServiceAccountListResponse(
    ...
    @JsonProperty(required = true, value = "data") List<@Valid ProjectServiceAccount> data,
  ...
  @NotNull @Valid public List<@Valid ProjectServiceAccount> getData() {
    return data;
  }
  ...
  public ProjectServiceAccountListResponse removeDataItem(ProjectServiceAccount dataItem) {
