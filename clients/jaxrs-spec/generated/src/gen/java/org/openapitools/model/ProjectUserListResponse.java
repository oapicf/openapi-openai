...
public class ProjectUserListResponse   {
  ...
  private @Valid List<@Valid ProjectUser> data = new ArrayList<>();
  ...
  public ProjectUserListResponse(
    ...
    @JsonProperty(required = true, value = "data") List<@Valid ProjectUser> data,
  ...
  @NotNull @Valid public List<@Valid ProjectUser> getData() {
    return data;
  }
  ...
  public ProjectUserListResponse removeDataItem(ProjectUser dataItem) {
