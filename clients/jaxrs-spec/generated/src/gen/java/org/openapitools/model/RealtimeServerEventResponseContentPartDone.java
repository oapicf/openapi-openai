...
public class RealtimeServerEventResponseContentPartDone   {
  ...
  public RealtimeServerEventResponseContentPartDone(
    ...
    @JsonProperty(required = true, value = "part") RealtimeServerEventResponseContentPartDonePart part
  ) {
  ...
  @NotNull @Valid public RealtimeServerEventResponseContentPartDonePart getPart() {
    return part;
  }
