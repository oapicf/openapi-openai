...
public class RunObjectRequiredAction   {
  ...
  public RunObjectRequiredAction(
    ...
    @JsonProperty(required = true, value = "submit_tool_outputs") RunObjectRequiredActionSubmitToolOutputs submitToolOutputs
  ) {
    this.type = type;
  ...
  @JsonProperty(required = true, value = "submit_tool_outputs")
  @NotNull @Valid public RunObjectRequiredActionSubmitToolOutputs getSubmitToolOutputs() {
