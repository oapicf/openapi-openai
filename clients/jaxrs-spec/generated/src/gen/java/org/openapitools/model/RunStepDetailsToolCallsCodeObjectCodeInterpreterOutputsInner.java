...
public class RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner   {
  ...
  public RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner(
    ...
    @JsonProperty(required = true, value = "logs") String logs,
    @JsonProperty(required = true, value = "image") RunStepDetailsToolCallsCodeOutputImageObjectImage image
  ) {
    this.type = type;
    this.logs = logs;
    this.image = image;
