...
public class RunStepObject   {
  ...
  public RunStepObject(
    ...
    @JsonProperty(required = true, value = "step_details") RunStepObjectStepDetails stepDetails,
    @JsonProperty(required = true, value = "last_error") RunStepObjectLastError lastError,
    @JsonProperty(required = true, value = "expired_at") Integer expiredAt,
    ...
    @JsonProperty(required = true, value = "usage") RunStepCompletionUsage usage
  ) {
    this.id = id;
  ...
  @JsonProperty(required = true, value = "step_details")
  @NotNull @Valid public RunStepObjectStepDetails getStepDetails() {
    return stepDetails;
  }
  ...
  @NotNull @Valid public RunStepObjectLastError getLastError() {
    return lastError;
  }
  ...
  @JsonProperty(required = true, value = "expired_at")
  @NotNull public Integer getExpiredAt() {
    return expiredAt;
  }
  ...
  @NotNull @Valid public RunStepCompletionUsage getUsage() {
    return usage;
  }
