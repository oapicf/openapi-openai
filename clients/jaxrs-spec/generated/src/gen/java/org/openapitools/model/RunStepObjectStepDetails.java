...
public class RunStepObjectStepDetails   {
  ...
  public RunStepObjectStepDetails(
    ...
    @JsonProperty(required = true, value = "message_creation") RunStepDetailsMessageCreationObjectMessageCreation messageCreation,
    @JsonProperty(required = true, value = "tool_calls") List<@Valid RunStepDetailsToolCallsObjectToolCallsInner> toolCalls
  ) {
    this.type = type;
  ...
  @JsonProperty(required = true, value = "message_creation")
