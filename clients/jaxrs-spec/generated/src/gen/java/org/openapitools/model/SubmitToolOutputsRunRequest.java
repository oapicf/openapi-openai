...
public class SubmitToolOutputsRunRequest   {
  ...
  @JsonCreator
  public SubmitToolOutputsRunRequest(
    @JsonProperty(required = true, value = "tool_outputs") List<@Valid SubmitToolOutputsRunRequestToolOutputsInner> toolOutputs
  ) {
  ...
  @JsonProperty(required = true, value = "tool_outputs")
