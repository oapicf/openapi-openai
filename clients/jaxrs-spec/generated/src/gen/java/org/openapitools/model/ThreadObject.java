...
public class ThreadObject   {
  ...
  public ThreadObject(
    ...
    @JsonProperty(required = true, value = "tool_resources") ModifyThreadRequestToolResources toolResources,
  ...
  @JsonProperty(required = true, value = "tool_resources")
  @NotNull @Valid public ModifyThreadRequestToolResources getToolResources() {
