...
public class TranscriptionSegment   {
  ...
  private @Valid Integer seek;
  private @Valid Float start;
  private @Valid Float end;
  private @Valid String text;
  private @Valid List<Integer> tokens = new ArrayList<>();
  private @Valid Float temperature;
  private @Valid Float avgLogprob;
  private @Valid Float compressionRatio;
  private @Valid Float noSpeechProb;
