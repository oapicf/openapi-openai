...
public class UserListResponse   {
  ...
  private @Valid List<@Valid User> data = new ArrayList<>();
  ...
  public UserListResponse(
    ...
    @JsonProperty(required = true, value = "data") List<@Valid User> data,
  ...
  @NotNull @Valid public List<@Valid User> getData() {
    return data;
  }
  ...
  public UserListResponse removeDataItem(User dataItem) {
