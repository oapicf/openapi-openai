...
public class VectorStoreObject   {
  ...
  public VectorStoreObject(
    ...
    @JsonProperty(required = true, value = "file_counts") VectorStoreObjectFileCounts fileCounts,
    @JsonProperty(required = true, value = "status") StatusEnum status,
    @JsonProperty(required = true, value = "last_active_at") Integer lastActiveAt,
  ...
  @NotNull @Valid public VectorStoreObjectFileCounts getFileCounts() {
    return fileCounts;
  }
  ...
  @JsonProperty(required = true, value = "last_active_at")
  @NotNull public Integer getLastActiveAt() {
    return lastActiveAt;
  }
