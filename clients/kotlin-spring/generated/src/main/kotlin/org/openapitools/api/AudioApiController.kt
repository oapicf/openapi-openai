...
class AudioApiController() {
    ...
    fun createSpeech(@Parameter(description = "", required = true) @Valid @RequestBody createSpeechRequest: CreateSpeechRequest): ResponseEntity<org.springframework.core.io.Resource> {
