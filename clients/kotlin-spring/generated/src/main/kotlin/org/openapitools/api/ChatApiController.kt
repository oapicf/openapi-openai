...
import org.openapitools.api.ChatApiController.Companion.BASE_PATH
...
class ChatApiController() {
    ...
    @RequestMapping(
        ...
        value = [PATH_CREATE_CHAT_COMPLETION /* "/chat/completions" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun createChatCompletion(
        @Parameter(description = "", required = true) @Valid @RequestBody createChatCompletionRequest: CreateChatCompletionRequest
    ): ResponseEntity<CreateChatCompletionResponse> {
    ...
    companion object {
        ...
        const val PATH_CREATE_CHAT_COMPLETION: String = "/chat/completions"
    }
}
