...
import org.openapitools.api.ThreadsApiController.Companion.BASE_PATH
...
class ThreadsApiController() {
    ...
    @RequestMapping(
        ...
        value = [PATH_CANCEL_RUN /* "/threads/{thread_id}/runs/{run_id}/cancel" */],
        produces = ["application/json"]
    )
    fun cancelRun(
        @Parameter(description = "The ID of the thread to which this run belongs.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "The ID of the run to cancel.", required = true) @PathVariable("run_id") runId: kotlin.String
    ...
    @RequestMapping(
        method = [RequestMethod.POST],
        value = [PATH_CREATE_MESSAGE /* "/threads/{thread_id}/messages" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun createMessage(
        @Parameter(description = "The ID of the [thread](/docs/api-reference/threads) to create a message for.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "", required = true) @Valid @RequestBody createMessageRequest: CreateMessageRequest
    ): ResponseEntity<MessageObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        method = [RequestMethod.POST],
        value = [PATH_CREATE_RUN /* "/threads/{thread_id}/runs" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun createRun(
    ...
    @RequestMapping(
        method = [RequestMethod.POST],
        value = [PATH_CREATE_THREAD /* "/threads" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun createThread(
        @Parameter(description = "") @Valid @RequestBody(required = false) createThreadRequest: CreateThreadRequest?
    ): ResponseEntity<ThreadObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        method = [RequestMethod.POST],
        value = [PATH_CREATE_THREAD_AND_RUN /* "/threads/runs" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun createThreadAndRun(
        @Parameter(description = "", required = true) @Valid @RequestBody createThreadAndRunRequest: CreateThreadAndRunRequest
    ): ResponseEntity<RunObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        ...
        value = [PATH_DELETE_THREAD /* "/threads/{thread_id}" */],
        produces = ["application/json"]
    )
    fun deleteThread(
        @Parameter(description = "The ID of the thread to delete.", required = true) @PathVariable("thread_id") threadId: kotlin.String
    ...
    @RequestMapping(
        ...
        value = [PATH_GET_MESSAGE /* "/threads/{thread_id}/messages/{message_id}" */],
        produces = ["application/json"]
    )
    fun getMessage(
        @Parameter(description = "The ID of the [thread](/docs/api-reference/threads) to which this message belongs.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "The ID of the message to retrieve.", required = true) @PathVariable("message_id") messageId: kotlin.String
    ): ResponseEntity<MessageObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        method = [RequestMethod.GET],
        value = [PATH_GET_RUN /* "/threads/{thread_id}/runs/{run_id}" */],
        produces = ["application/json"]
    )
    fun getRun(
        @Parameter(description = "The ID of the [thread](/docs/api-reference/threads) that was run.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "The ID of the run to retrieve.", required = true) @PathVariable("run_id") runId: kotlin.String
    ): ResponseEntity<RunObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        method = [RequestMethod.GET],
        value = [PATH_GET_RUN_STEP /* "/threads/{thread_id}/runs/{run_id}/steps/{step_id}" */],
        produces = ["application/json"]
    )
    fun getRunStep(
    ...
    @RequestMapping(
        method = [RequestMethod.GET],
        value = [PATH_GET_THREAD /* "/threads/{thread_id}" */],
        produces = ["application/json"]
    )
    fun getThread(
        @Parameter(description = "The ID of the thread to retrieve.", required = true) @PathVariable("thread_id") threadId: kotlin.String
    ): ResponseEntity<ThreadObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        method = [RequestMethod.GET],
        value = [PATH_LIST_MESSAGES /* "/threads/{thread_id}/messages" */],
        produces = ["application/json"]
    )
    fun listMessages(
        @Parameter(description = "The ID of the [thread](/docs/api-reference/threads) the messages belong to.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. ", schema = Schema(defaultValue = "20")) @Valid @RequestParam(value = "limit", required = false, defaultValue = "20") limit: kotlin.Int,
        @Parameter(description = "Sort order by the `created_at` timestamp of the objects. `asc` for ascending order and `desc` for descending order. ", schema = Schema(allowableValues = ["asc", "desc"], defaultValue = "desc")) @Valid @RequestParam(value = "order", required = false, defaultValue = "desc") order: kotlin.String,
        @Parameter(description = "A cursor for use in pagination. `after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include after=obj_foo in order to fetch the next page of the list. ") @Valid @RequestParam(value = "after", required = false) after: kotlin.String?,
        @Parameter(description = "A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. ") @Valid @RequestParam(value = "before", required = false) before: kotlin.String?,
    ...
    @RequestMapping(
        method = [RequestMethod.GET],
        value = [PATH_LIST_RUN_STEPS /* "/threads/{thread_id}/runs/{run_id}/steps" */],
        produces = ["application/json"]
    )
    fun listRunSteps(
        @Parameter(description = "The ID of the thread the run and run steps belong to.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "The ID of the run the run steps belong to.", required = true) @PathVariable("run_id") runId: kotlin.String,
        @Parameter(description = "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. ", schema = Schema(defaultValue = "20")) @Valid @RequestParam(value = "limit", required = false, defaultValue = "20") limit: kotlin.Int,
        @Parameter(description = "Sort order by the `created_at` timestamp of the objects. `asc` for ascending order and `desc` for descending order. ", schema = Schema(allowableValues = ["asc", "desc"], defaultValue = "desc")) @Valid @RequestParam(value = "order", required = false, defaultValue = "desc") order: kotlin.String,
        @Parameter(description = "A cursor for use in pagination. `after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include after=obj_foo in order to fetch the next page of the list. ") @Valid @RequestParam(value = "after", required = false) after: kotlin.String?,
        @Parameter(description = "A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. ") @Valid @RequestParam(value = "before", required = false) before: kotlin.String?
    ...
    @RequestMapping(
        method = [RequestMethod.GET],
        value = [PATH_LIST_RUNS /* "/threads/{thread_id}/runs" */],
        produces = ["application/json"]
    )
    fun listRuns(
        @Parameter(description = "The ID of the thread the run belongs to.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 20. ", schema = Schema(defaultValue = "20")) @Valid @RequestParam(value = "limit", required = false, defaultValue = "20") limit: kotlin.Int,
        @Parameter(description = "Sort order by the `created_at` timestamp of the objects. `asc` for ascending order and `desc` for descending order. ", schema = Schema(allowableValues = ["asc", "desc"], defaultValue = "desc")) @Valid @RequestParam(value = "order", required = false, defaultValue = "desc") order: kotlin.String,
        @Parameter(description = "A cursor for use in pagination. `after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include after=obj_foo in order to fetch the next page of the list. ") @Valid @RequestParam(value = "after", required = false) after: kotlin.String?,
        @Parameter(description = "A cursor for use in pagination. `before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before=obj_foo in order to fetch the previous page of the list. ") @Valid @RequestParam(value = "before", required = false) before: kotlin.String?
    ...
    @RequestMapping(
        method = [RequestMethod.POST],
        value = [PATH_MODIFY_MESSAGE /* "/threads/{thread_id}/messages/{message_id}" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun modifyMessage(
        ...
        @Parameter(description = "The ID of the message to modify.", required = true) @PathVariable("message_id") messageId: kotlin.String,
        @Parameter(description = "", required = true) @Valid @RequestBody modifyMessageRequest: ModifyMessageRequest
    ): ResponseEntity<MessageObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        method = [RequestMethod.POST],
        value = [PATH_MODIFY_RUN /* "/threads/{thread_id}/runs/{run_id}" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun modifyRun(
        @Parameter(description = "The ID of the [thread](/docs/api-reference/threads) that was run.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "The ID of the run to modify.", required = true) @PathVariable("run_id") runId: kotlin.String,
        @Parameter(description = "", required = true) @Valid @RequestBody modifyRunRequest: ModifyRunRequest
    ): ResponseEntity<RunObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        method = [RequestMethod.POST],
        value = [PATH_MODIFY_THREAD /* "/threads/{thread_id}" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun modifyThread(
        @Parameter(description = "The ID of the thread to modify. Only the `metadata` can be modified.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "", required = true) @Valid @RequestBody modifyThreadRequest: ModifyThreadRequest
    ): ResponseEntity<ThreadObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    @RequestMapping(
        method = [RequestMethod.POST],
        value = [PATH_SUBMIT_TOOL_OUPUTS_TO_RUN /* "/threads/{thread_id}/runs/{run_id}/submit_tool_outputs" */],
        produces = ["application/json"],
        consumes = ["application/json"]
    )
    fun submitToolOuputsToRun(
        @Parameter(description = "The ID of the [thread](/docs/api-reference/threads) to which this run belongs.", required = true) @PathVariable("thread_id") threadId: kotlin.String,
        @Parameter(description = "The ID of the run that requires the tool output submission.", required = true) @PathVariable("run_id") runId: kotlin.String,
        @Parameter(description = "", required = true) @Valid @RequestBody submitToolOutputsRunRequest: SubmitToolOutputsRunRequest
    ): ResponseEntity<RunObject> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    companion object {
        ...
        const val PATH_CANCEL_RUN: String = "/threads/{thread_id}/runs/{run_id}/cancel"
        const val PATH_CREATE_MESSAGE: String = "/threads/{thread_id}/messages"
        ...
        const val PATH_MODIFY_MESSAGE: String = "/threads/{thread_id}/messages/{message_id}"
        const val PATH_MODIFY_RUN: String = "/threads/{thread_id}/runs/{run_id}"
        const val PATH_MODIFY_THREAD: String = "/threads/{thread_id}"
        const val PATH_SUBMIT_TOOL_OUPUTS_TO_RUN: String = "/threads/{thread_id}/runs/{run_id}/submit_tool_outputs"
    }
}
