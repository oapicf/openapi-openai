...
data class ChatCompletionStreamResponseDelta(
    ...
    @Schema(example = "null", description = "The refusal message generated by the model.")
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Role {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'ChatCompletionStreamResponseDelta'")
            }
        }
    }
