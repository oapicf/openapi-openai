...
data class CreateThreadAndRunRequestToolsInner(
    ...
    @get:JsonProperty("type", required = true) val type: CreateThreadAndRunRequestToolsInner.Type,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Type {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'CreateThreadAndRunRequestToolsInner'")
            }
        }
    }
