...
data class DeleteThreadResponse(
    ...
    @Schema(example = "null", required = true, description = "")
    @get:JsonProperty("object", required = true) val `object`: DeleteThreadResponse.`Object`
) {
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): `Object` {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'DeleteThreadResponse'")
            }
        }
    }
