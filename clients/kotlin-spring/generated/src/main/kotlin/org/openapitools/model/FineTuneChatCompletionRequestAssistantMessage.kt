...
data class FineTuneChatCompletionRequestAssistantMessage(
    ...
    @get:JsonProperty("role", required = true) val role: FineTuneChatCompletionRequestAssistantMessage.Role,
    ...
    @get:JsonProperty("weight") val weight: FineTuneChatCompletionRequestAssistantMessage.Weight? = null
) {
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Role {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'FineTuneChatCompletionRequestAssistantMessage'")
            }
        }
    }
