...
data class InviteDeleteResponse(
    ...
    @Schema(example = "null", required = true, description = "The object type, which is always `organization.invite.deleted`")
    @get:JsonProperty("object", required = true) val `object`: InviteDeleteResponse.`Object`,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): `Object` {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'InviteDeleteResponse'")
            }
        }
    }
