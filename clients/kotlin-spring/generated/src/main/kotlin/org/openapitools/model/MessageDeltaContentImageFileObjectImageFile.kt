...
data class MessageDeltaContentImageFileObjectImageFile(
    ...
    @Schema(example = "null", description = "The [File](/docs/api-reference/files) ID of the image in the message content. Set `purpose=\"vision\"` when uploading the File if you need to later display the file content.")
    ...
    @get:JsonProperty("detail") val detail: MessageDeltaContentImageFileObjectImageFile.Detail? = Detail.auto
) {
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Detail {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'MessageDeltaContentImageFileObjectImageFile'")
            }
        }
    }
