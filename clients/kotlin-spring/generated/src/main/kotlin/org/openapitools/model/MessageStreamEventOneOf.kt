...
data class MessageStreamEventOneOf(
    ...
    @get:JsonProperty("event", required = true) val event: MessageStreamEventOneOf.Event,
    ...
    */
    enum class Event(val value: kotlin.String) {
        ...
        @JsonProperty("thread.message.created") threadPeriodMessagePeriodCreated("thread.message.created")
    }
