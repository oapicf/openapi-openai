...
data class OpenAIFile(
    ...
    */
    enum class Purpose(val value: kotlin.String) {
        ...
        @JsonProperty("fine-tune") fineMinusTune("fine-tune"),
        @JsonProperty("fine-tune-results") fineMinusTuneMinusResults("fine-tune-results"),
        @JsonProperty("assistants") assistants("assistants"),
        @JsonProperty("assistants_output") assistants_output("assistants_output")
    }
    ...
    */
    enum class Status(val value: kotlin.String) {
        ...
        @JsonProperty("uploaded") uploaded("uploaded"),
