...
data class RealtimeServerEventResponseContentPartAdded(
    ...
    @Schema(example = "null", required = true, description = "The event type, must be `response.content_part.added`.")
    @get:JsonProperty("type", required = true) val type: RealtimeServerEventResponseContentPartAdded.Type,
    ...
    @Schema(example = "null", required = true, description = "The ID of the item to which the content part was added.")
    ...
    @get:JsonProperty("part", required = true) val part: RealtimeServerEventResponseContentPartAddedPart
) {
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Type {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'RealtimeServerEventResponseContentPartAdded'")
            }
        }
    }
