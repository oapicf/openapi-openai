...
data class RealtimeServerEventResponseCreated(
    ...
    @Schema(example = "null", required = true, description = "The event type, must be `response.created`.")
    @get:JsonProperty("type", required = true) val type: RealtimeServerEventResponseCreated.Type,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Type {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'RealtimeServerEventResponseCreated'")
            }
        }
    }
