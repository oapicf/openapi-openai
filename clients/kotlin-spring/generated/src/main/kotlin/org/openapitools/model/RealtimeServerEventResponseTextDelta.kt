...
data class RealtimeServerEventResponseTextDelta(
    ...
    @Schema(example = "null", required = true, description = "The event type, must be `response.text.delta`.")
    @get:JsonProperty("type", required = true) val type: RealtimeServerEventResponseTextDelta.Type,
    ...
    @Schema(example = "null", required = true, description = "The text delta.")
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Type {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'RealtimeServerEventResponseTextDelta'")
            }
        }
    }
