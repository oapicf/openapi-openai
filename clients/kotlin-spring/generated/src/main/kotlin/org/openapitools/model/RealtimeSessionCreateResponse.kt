...
data class RealtimeSessionCreateResponse(
    ...
    @get:JsonProperty("client_secret") val clientSecret: RealtimeSessionCreateResponseClientSecret? = null,

    @Schema(example = "null", description = "The set of modalities the model can respond with. To disable audio, set this to [\"text\"]. ")
    @get:JsonProperty("modalities") val modalities: kotlin.collections.List<RealtimeSessionCreateResponse.Modalities>? = null,
    ...
    @get:JsonProperty("voice") val voice: RealtimeSessionCreateResponse.Voice? = null,

    @Schema(example = "null", description = "The format of input audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`. ")
    @get:JsonProperty("input_audio_format") val inputAudioFormat: kotlin.String? = null,

    @Schema(example = "null", description = "The format of output audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`. ")
    @get:JsonProperty("output_audio_format") val outputAudioFormat: kotlin.String? = null,
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("turn_detection") val turnDetection: RealtimeSessionCreateResponseTurnDetection? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Modalities {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'RealtimeSessionCreateResponse'")
            }
        }
    }
