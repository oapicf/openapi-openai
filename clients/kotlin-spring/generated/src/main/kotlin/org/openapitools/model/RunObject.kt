...
data class RunObject(
    ...
    */
    enum class `Object`(val value: kotlin.String) {
        ...
        @JsonProperty("thread.run") threadPeriodRun("thread.run")
    }
    ...
    */
    enum class Status(val value: kotlin.String) {
        ...
        @JsonProperty("queued") queued("queued"),
        @JsonProperty("in_progress") in_progress("in_progress"),
        @JsonProperty("requires_action") requires_action("requires_action"),
        @JsonProperty("cancelling") cancelling("cancelling"),
