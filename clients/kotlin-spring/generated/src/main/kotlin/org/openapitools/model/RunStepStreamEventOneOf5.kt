...
data class RunStepStreamEventOneOf5(
    ...
    @get:JsonProperty("event", required = true) val event: RunStepStreamEventOneOf5.Event,
    ...
    */
    enum class Event(val value: kotlin.String) {
        ...
        @JsonProperty("thread.run.step.cancelled") threadPeriodRunPeriodStepPeriodCancelled("thread.run.step.cancelled")
    }
