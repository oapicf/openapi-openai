...
data class RunStepStreamEventOneOf6(
    ...
    @get:JsonProperty("event", required = true) val event: RunStepStreamEventOneOf6.Event,
    ...
    */
    enum class Event(val value: kotlin.String) {
        ...
        @JsonProperty("thread.run.step.expired") threadPeriodRunPeriodStepPeriodExpired("thread.run.step.expired")
    }
