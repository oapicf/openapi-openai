...
data class RunStreamEventOneOf8(
    ...
    @get:JsonProperty("event", required = true) val event: RunStreamEventOneOf8.Event,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Event {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'RunStreamEventOneOf8'")
            }
        }
    }
