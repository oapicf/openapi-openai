...
data class ThreadStreamEvent(
    ...
    @get:JsonProperty("event", required = true) val event: ThreadStreamEvent.Event,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Event {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'ThreadStreamEvent'")
            }
        }
    }
