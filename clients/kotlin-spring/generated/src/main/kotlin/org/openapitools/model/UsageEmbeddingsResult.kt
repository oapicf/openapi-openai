...
data class UsageEmbeddingsResult(
    ...
    @get:JsonProperty("object", required = true) val `object`: UsageEmbeddingsResult.`Object`,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): `Object` {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'UsageEmbeddingsResult'")
            }
        }
    }
