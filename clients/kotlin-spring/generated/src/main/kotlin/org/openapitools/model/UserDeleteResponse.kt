...
data class UserDeleteResponse(
    ...
    @get:JsonProperty("object", required = true) val `object`: UserDeleteResponse.`Object`,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): `Object` {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'UserDeleteResponse'")
            }
        }
    }
