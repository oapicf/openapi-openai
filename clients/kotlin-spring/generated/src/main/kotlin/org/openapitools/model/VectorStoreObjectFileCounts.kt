...
data class VectorStoreObjectFileCounts(
    ...
    @Schema(example = "null", required = true, description = "The number of files that have been successfully processed.")
    ...
    @Schema(example = "null", required = true, description = "The number of files that were cancelled.")
