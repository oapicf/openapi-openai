...
import org.openapitools.server.api.model.AuditLog
...
data class ListAuditLogsResponse (
    @SerializedName("`object`") private val _`object`: ListAuditLogsResponse.&#x60;Object&#x60;?,
    @SerializedName("`data`") private val _`data`: kotlin.Array<AuditLog>?,
