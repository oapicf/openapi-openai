...
interface AssistantsApi  {
    ...
    /* createRun
     * Create a run. */
    suspend fun createRun(threadId:kotlin.String?,createRunRequest:CreateRunRequest?,include:kotlin.Array<kotlin.String>?,context:OperationRequest):Response<RunObject>
    /* createThread
     * Create a thread. */
    ...
    /* deleteMessage
     * Deletes a message. */
    suspend fun deleteMessage(threadId:kotlin.String?,messageId:kotlin.String?,context:OperationRequest):Response<DeleteMessageResponse>
    /* deleteThread
     * Delete a thread. */
    ...
    suspend fun getRunStep(threadId:kotlin.String?,runId:kotlin.String?,stepId:kotlin.String?,include:kotlin.Array<kotlin.String>?,context:OperationRequest):Response<RunStepObject>
    /* getThread
     * Retrieves a thread. */
    ...
    suspend fun listRunSteps(threadId:kotlin.String?,runId:kotlin.String?,limit:kotlin.Int?,order:kotlin.String?,after:kotlin.String?,before:kotlin.String?,include:kotlin.Array<kotlin.String>?,context:OperationRequest):Response<ListRunStepsResponse>
    /* listRuns
