...
interface CompletionsApi  {
    ...
    companion object {
        const val address = "CompletionsApi-service"
        suspend fun createRouterFactory(vertx: Vertx,path:String): io.vertx.ext.web.api.contract.openapi3.OpenAPI3RouterFactory {
            ...
            for (m in CompletionsApi::class.java.methods) {
            ...
            routerFactory.mountServiceInterface(CompletionsApi::class.java, address)
