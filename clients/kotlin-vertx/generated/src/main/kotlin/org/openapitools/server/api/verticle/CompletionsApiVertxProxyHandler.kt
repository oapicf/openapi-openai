...
class CompletionsApiVertxProxyHandler(private val vertx: Vertx, private val service: CompletionsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
