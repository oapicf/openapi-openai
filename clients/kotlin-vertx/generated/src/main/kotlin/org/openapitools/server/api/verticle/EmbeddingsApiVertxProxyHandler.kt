...
class EmbeddingsApiVertxProxyHandler(private val vertx: Vertx, private val service: EmbeddingsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
