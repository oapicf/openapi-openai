...
class ModerationsApiVertxProxyHandler(private val vertx: Vertx, private val service: ModerationsApi, topLevel: Boolean, private val timeoutSeconds: Long) : ProxyHandler() {
