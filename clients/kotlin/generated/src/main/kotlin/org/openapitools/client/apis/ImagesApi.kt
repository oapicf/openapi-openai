...
import org.openapitools.client.models.CreateImageEditRequestModel
...
class ImagesApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createImageEdit(image: java.io.File, prompt: kotlin.String, mask: java.io.File? = null, model: CreateImageEditRequestModel? = null, n: kotlin.Int? = 1, size: PropertySizeCreateImageEdit? = PropertySizeCreateImageEdit._1024x1024, responseFormat: ResponseFormatCreateImageEdit? = ResponseFormatCreateImageEdit.url, user: kotlin.String? = null) : ImagesResponse {
        val localVarResponse = createImageEditWithHttpInfo(image = image, prompt = prompt, mask = mask, model = model, n = n, size = size, responseFormat = responseFormat, user = user)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createImageEditWithHttpInfo(image: java.io.File, prompt: kotlin.String, mask: java.io.File?, model: CreateImageEditRequestModel?, n: kotlin.Int?, size: PropertySizeCreateImageEdit?, responseFormat: ResponseFormatCreateImageEdit?, user: kotlin.String?) : ApiResponse<ImagesResponse?> {
        val localVariableConfig = createImageEditRequestConfig(image = image, prompt = prompt, mask = mask, model = model, n = n, size = size, responseFormat = responseFormat, user = user)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createImageVariation(image: java.io.File, model: CreateImageEditRequestModel? = null, n: kotlin.Int? = 1, responseFormat: ResponseFormatCreateImageVariation? = ResponseFormatCreateImageVariation.url, size: PropertySizeCreateImageVariation? = PropertySizeCreateImageVariation._1024x1024, user: kotlin.String? = null) : ImagesResponse {
        val localVarResponse = createImageVariationWithHttpInfo(image = image, model = model, n = n, responseFormat = responseFormat, size = size, user = user)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createImageVariationWithHttpInfo(image: java.io.File, model: CreateImageEditRequestModel?, n: kotlin.Int?, responseFormat: ResponseFormatCreateImageVariation?, size: PropertySizeCreateImageVariation?, user: kotlin.String?) : ApiResponse<ImagesResponse?> {
        val localVariableConfig = createImageVariationRequestConfig(image = image, model = model, n = n, responseFormat = responseFormat, size = size, user = user)
