...
class CreateChatCompletionStreamResponseTest : ShouldSpec() {
    init {
        ...
        // to test the property `id` - A unique identifier for the chat completion. Each chunk has the same ID.
        should("test id") {
        ...
        // to test the property `created` - The Unix timestamp (in seconds) of when the chat completion was created. Each chunk has the same timestamp.
        should("test created") {
            // uncomment below to test the property
