...
class OpenAIFileTest : ShouldSpec() {
    init {
        ...
        // to test the property `id` - The file identifier, which can be referenced in the API endpoints.
        should("test id") {
        ...
        // to test the property `createdAt` - The Unix timestamp (in seconds) for when the file was created.
        ...
        // to test the property `status` - Deprecated. The current status of the file, which can be either `uploaded`, `processed`, or `error`.
        should("test status") {
            // uncomment below to test the property
            //modelInstance.status shouldBe ("TODO")
        }

        // to test the property `statusDetails` - Deprecated. For details on why a fine-tuning training file failed validation, see the `error` field on `fine_tuning.job`.
