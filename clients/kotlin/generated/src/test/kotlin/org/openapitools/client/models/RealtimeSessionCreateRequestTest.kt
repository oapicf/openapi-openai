...
class RealtimeSessionCreateRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of RealtimeSessionCreateRequest
        //val modelInstance = RealtimeSessionCreateRequest()

        // to test the property `model` - The Realtime model used for this session. 
        should("test model") {
