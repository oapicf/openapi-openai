...
class VectorStoreFileBatchObjectFileCountsTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of VectorStoreFileBatchObjectFileCounts
        //val modelInstance = VectorStoreFileBatchObjectFileCounts()
        ...
        // to test the property `completed` - The number of files that have been processed.
        ...
        // to test the property `cancelled` - The number of files that where cancelled.
