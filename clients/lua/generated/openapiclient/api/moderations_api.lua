...
local moderations_api = {}
local moderations_api_mt = {
	__name = "moderations_api";
	__index = moderations_api;
}

local function new_moderations_api(authority, basePath, schemes)
	local schemes_map = {}
...
function moderations_api:create_moderation(create_moderation_request)
