...
|------------ | ------------- | ------------- | -------------|
| **id** | **String** | Unique identifier for the session object.  | [optional] [default to null] |
...
| **model** | [**RealtimeSession_model**](RealtimeSession_model.md) |  | [optional] [default to null] |
