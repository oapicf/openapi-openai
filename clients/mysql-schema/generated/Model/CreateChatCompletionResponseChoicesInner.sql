...
--
SELECT `index`, `message`, `finish_reason` FROM `CreateChatCompletionResponse_choices_inner` WHERE 1;

--
-- INSERT template for table `CreateChatCompletionResponse_choices_inner`
--
INSERT INTO `CreateChatCompletionResponse_choices_inner`(`index`, `message`, `finish_reason`) VALUES (?, ?, ?);

--
-- UPDATE template for table `CreateChatCompletionResponse_choices_inner`
--
UPDATE `CreateChatCompletionResponse_choices_inner` SET `index` = ?, `message` = ?, `finish_reason` = ? WHERE 1;
