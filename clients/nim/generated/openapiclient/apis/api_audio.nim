...
import ../models/model_audio_response_format
import ../models/model_create_speech_request
import ../models/model_create_transcription_request_model
import ../models/model_create_transcription200response
import ../models/model_create_translation200response
...
proc createTranscription*(httpClient: HttpClient, file: string, model: CreateTranscriptionRequest_model, language: string, prompt: string, responseFormat: AudioResponseFormat, temperature: float, timestampGranularities: seq[TimestampGranularities]): (Option[createTranscription_200_response], Response) =
  ...
  let response = httpClient.post(basepath & "/audio/transcriptions", multipart=multipart_data)
  constructResult[createTranscription_200_response](response)


proc createTranslation*(httpClient: HttpClient, file: string, model: CreateTranscriptionRequest_model, prompt: string, responseFormat: AudioResponseFormat, temperature: float): (Option[createTranslation_200_response], Response) =
  ...
  let response = httpClient.post(basepath & "/audio/translations", multipart=multipart_data)
