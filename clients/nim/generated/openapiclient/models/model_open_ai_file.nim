...
type OpenAIFile* = object
  ...
  purpose*: Purpose ## The intended purpose of the file. Supported values are `assistants`, `assistants_output`, `batch`, `batch_output`, `fine-tune`, `fine-tune-results` and `vision`.
...
func `%`*(v: Purpose): JsonNode =
  result = case v:
    ...
    of Purpose.BatchOutput: %"batch_output"
