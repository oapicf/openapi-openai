...
type UserDeleteResponse* = object
  ## 
  `object`*: `Object`
  id*: string
  deleted*: bool
...
func `%`*(v: `Object`): JsonNode =
  result = case v:
    of `Object`.OrganizationUserDeleted: %"organization.user.deleted"
...
proc to*(node: JsonNode, T: typedesc[`Object`]): `Object` =
  ...
  case strVal:
  of $("organization.user.deleted"):
    return `Object`.OrganizationUserDeleted
  else:
