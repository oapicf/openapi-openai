...
@protocol OAICreateChatCompletionStreamResponseUsage;
@class OAICreateChatCompletionStreamResponseUsage;
...
/* The service tier used for processing the request. This field is only included if the `service_tier` parameter is specified in the request. [optional]
 */
...
@property(nonatomic) OAICreateChatCompletionStreamResponseUsage* usage;
