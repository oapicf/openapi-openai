...
@protocol OAIListFineTuningJobCheckpointsResponse
@end

@interface OAIListFineTuningJobCheckpointsResponse : OAIObject


@property(nonatomic) NSArray<OAIFineTuningJobCheckpoint>* data;
