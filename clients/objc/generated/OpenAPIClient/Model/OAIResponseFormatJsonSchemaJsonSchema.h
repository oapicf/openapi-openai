...
@interface OAIResponseFormatJsonSchemaJsonSchema : OAIObject
...
/* The schema for the response format, described as a JSON Schema object. [optional]
 */
@property(nonatomic) NSDictionary<OAIAnyType>* schema;
 ...
 */
@property(nonatomic) NSNumber* strict;
