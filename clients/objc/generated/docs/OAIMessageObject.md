...
**attachments** | [**NSArray&lt;OAICreateMessageRequestAttachmentsInner&gt;***](OAICreateMessageRequestAttachmentsInner.md) | A list of files attached to the message, and the tools they were added to. | 
