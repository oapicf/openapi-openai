...
------------ | ------------- | ------------- | -------------
**_id** | **NSString*** | Unique identifier for the session object.  | [optional] 
**modalities** | **NSArray&lt;NSString*&gt;*** | The set of modalities the model can respond with. To disable audio, set this to [\&quot;text\&quot;].  | [optional] 
**model** | [**OAIRealtimeSessionModel***](OAIRealtimeSessionModel.md) |  | [optional] 
...
**turnDetection** | [**OAIRealtimeSessionTurnDetection***](OAIRealtimeSessionTurnDetection.md) |  | [optional] 
