# OAIRealtimeSessionCreateRequest
...
**model** | **NSString*** | The Realtime model used for this session.  | 
...
**turnDetection** | [**OAIRealtimeSessionCreateRequestTurnDetection***](OAIRealtimeSessionCreateRequestTurnDetection.md) |  | [optional] 
