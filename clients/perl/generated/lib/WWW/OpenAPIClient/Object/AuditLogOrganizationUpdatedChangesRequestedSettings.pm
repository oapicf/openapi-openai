...
#
package WWW::OpenAPIClient::Object::AuditLogOrganizationUpdatedChangesRequestedSettings;
...
__PACKAGE__->method_documentation({
    'threads_ui_visibility' => {
        datatype => 'string',
        base_name => 'threads_ui_visibility',
    ...
    'usage_dashboard_visibility' => {
        datatype => 'string',
        base_name => 'usage_dashboard_visibility',
