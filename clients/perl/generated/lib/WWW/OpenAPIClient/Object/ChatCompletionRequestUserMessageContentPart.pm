...
#
package WWW::OpenAPIClient::Object::ChatCompletionRequestUserMessageContentPart;
...
__PACKAGE__->method_documentation({
    ...
    'image_url' => {
        datatype => 'ChatCompletionRequestMessageContentPartImageImageUrl',
        base_name => 'image_url',
        description => '',
        format => '',
        read_only => '',
    ...
    'input_audio' => {
        datatype => 'ChatCompletionRequestMessageContentPartAudioInputAudio',
        base_name => 'input_audio',
        description => '',
        format => '',
        read_only => '',
            },
