...
#
package WWW::OpenAPIClient::Object::CompletionUsageCompletionTokensDetails;
...
__PACKAGE__->class_documentation({description => 'Breakdown of tokens used in a completion.',
...
__PACKAGE__->method_documentation({
    'accepted_prediction_tokens' => {
        datatype => 'int',
        base_name => 'accepted_prediction_tokens',
    ...
    'rejected_prediction_tokens' => {
        datatype => 'int',
        base_name => 'rejected_prediction_tokens',
