...
#
package WWW::OpenAPIClient::Object::CreateChatCompletionResponse;
...
__PACKAGE__->class_documentation({description => 'Represents a chat completion response returned by model, based on the provided input.',
...
__PACKAGE__->method_documentation({
    ...
    'choices' => {
        datatype => 'ARRAY[CreateChatCompletionResponseChoicesInner]',
        base_name => 'choices',
