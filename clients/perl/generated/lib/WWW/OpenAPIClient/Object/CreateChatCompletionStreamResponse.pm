...
#
package WWW::OpenAPIClient::Object::CreateChatCompletionStreamResponse;
...
__PACKAGE__->class_documentation({description => 'Represents a streamed chunk of a chat completion response returned by model, based on the provided input.',
...
__PACKAGE__->method_documentation({
    ...
    'choices' => {
        datatype => 'ARRAY[CreateChatCompletionStreamResponseChoicesInner]',
        base_name => 'choices',
    ...
    'usage' => {
        datatype => 'CreateChatCompletionStreamResponseUsage',
        base_name => 'usage',
        description => '',
        format => '',
        read_only => '',
