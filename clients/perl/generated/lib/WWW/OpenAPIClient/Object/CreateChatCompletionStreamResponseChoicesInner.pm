...
#
package WWW::OpenAPIClient::Object::CreateChatCompletionStreamResponseChoicesInner;
...
__PACKAGE__->method_documentation({
    'delta' => {
        datatype => 'ChatCompletionStreamResponseDelta',
        base_name => 'delta',
        description => '',
        format => '',
        read_only => '',
    ...
    'logprobs' => {
        datatype => 'CreateChatCompletionResponseChoicesInnerLogprobs',
        base_name => 'logprobs',
        description => '',
        format => '',
        read_only => '',
