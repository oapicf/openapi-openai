...
#
package WWW::OpenAPIClient::Object::CreateCompletionResponse;
...
__PACKAGE__->class_documentation({description => 'Represents a completion response from the API. Note: both the streamed and non-streamed response objects share the same shape (unlike the chat endpoint). ',
...
__PACKAGE__->method_documentation({
    ...
    'choices' => {
        datatype => 'ARRAY[CreateCompletionResponseChoicesInner]',
        base_name => 'choices',
