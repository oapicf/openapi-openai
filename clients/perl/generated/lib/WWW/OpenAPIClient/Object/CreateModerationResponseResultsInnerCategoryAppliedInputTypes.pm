...
#
package WWW::OpenAPIClient::Object::CreateModerationResponseResultsInnerCategoryAppliedInputTypes;
...
__PACKAGE__->class_documentation({description => 'A list of the categories along with the input type(s) that the score applies to.',
...
__PACKAGE__->openapi_types( {
    ...
    'self_harm/intent' => 'ARRAY[string]',
    'self_harm/instructions' => 'ARRAY[string]',
    'sexual' => 'ARRAY[string]',
