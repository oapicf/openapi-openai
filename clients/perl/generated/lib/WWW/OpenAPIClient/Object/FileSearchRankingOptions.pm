...
#
package WWW::OpenAPIClient::Object::FileSearchRankingOptions;
...
__PACKAGE__->class_documentation({description => 'The ranking options for the file search. If not specified, the file search tool will use the &#x60;auto&#x60; ranker and a score_threshold of 0.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information. ',
