...
#
package WWW::OpenAPIClient::Object::FineTuneChatRequestInput;
...
__PACKAGE__->class_documentation({description => 'The per-line training example of a fine-tuning input file for chat models using the supervised method.',
...
__PACKAGE__->method_documentation({
    'messages' => {
        datatype => 'ARRAY[FineTuneChatRequestInputMessagesInner]',
        base_name => 'messages',
        description => '',
        format => '',
        read_only => '',
