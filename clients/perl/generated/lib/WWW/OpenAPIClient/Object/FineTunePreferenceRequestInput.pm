...
#
package WWW::OpenAPIClient::Object::FineTunePreferenceRequestInput;
...
__PACKAGE__->class_documentation({description => 'The per-line training example of a fine-tuning input file for chat models using the dpo method.',
...
__PACKAGE__->method_documentation({
    'input' => {
        datatype => 'FineTunePreferenceRequestInputInput',
        base_name => 'input',
        description => '',
        format => '',
        read_only => '',
    ...
    'preferred_completion' => {
        datatype => 'ARRAY[FineTunePreferenceRequestInputPreferredCompletionInner]',
        base_name => 'preferred_completion',
    ...
    'non_preferred_completion' => {
        datatype => 'ARRAY[FineTunePreferenceRequestInputPreferredCompletionInner]',
        base_name => 'non_preferred_completion',
