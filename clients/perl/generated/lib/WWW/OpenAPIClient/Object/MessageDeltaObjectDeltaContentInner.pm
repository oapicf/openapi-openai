...
#
package WWW::OpenAPIClient::Object::MessageDeltaObjectDeltaContentInner;
...
__PACKAGE__->method_documentation({
    ...
    'image_file' => {
        datatype => 'MessageDeltaContentImageFileObjectImageFile',
    ...
    'text' => {
        datatype => 'MessageDeltaContentTextObjectText',
        base_name => 'text',
        description => '',
        format => '',
        read_only => '',
    ...
    'image_url' => {
        datatype => 'MessageDeltaContentImageUrlObjectImageUrl',
        base_name => 'image_url',
        description => '',
        format => '',
        read_only => '',
