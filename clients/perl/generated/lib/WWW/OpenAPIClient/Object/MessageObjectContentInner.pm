...
#
package WWW::OpenAPIClient::Object::MessageObjectContentInner;
...
__PACKAGE__->method_documentation({
    ...
    'image_file' => {
        datatype => 'MessageContentImageFileObjectImageFile',
    ...
    'image_url' => {
        datatype => 'MessageContentImageUrlObjectImageUrl',
        base_name => 'image_url',
        description => '',
        format => '',
        read_only => '',
    ...
    'text' => {
        datatype => 'MessageContentTextObjectText',
        base_name => 'text',
        description => '',
        format => '',
        read_only => '',
