...
#
package WWW::OpenAPIClient::Object::ProjectServiceAccount;
...
__PACKAGE__->class_documentation({description => 'Represents an individual service account in a project.',
