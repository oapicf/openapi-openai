...
#
package WWW::OpenAPIClient::Object::RealtimeConversationItem;
...
__PACKAGE__->class_documentation({description => 'The item to add to the conversation.',
...
__PACKAGE__->method_documentation({
    ...
    'content' => {
        datatype => 'ARRAY[RealtimeConversationItemContentInner]',
        base_name => 'content',
