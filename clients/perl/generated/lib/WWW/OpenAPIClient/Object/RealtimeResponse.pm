...
#
package WWW::OpenAPIClient::Object::RealtimeResponse;
...
__PACKAGE__->class_documentation({description => 'The response resource.',
...
__PACKAGE__->method_documentation({
    ...
    'status_details' => {
        datatype => 'RealtimeResponseStatusDetails',
        base_name => 'status_details',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'usage' => {
        datatype => 'RealtimeResponseUsage',
        base_name => 'usage',
        description => '',
        format => '',
        read_only => '',
