...
#
package WWW::OpenAPIClient::Object::RealtimeServerEventInputAudioBufferSpeechStopped;
...
__PACKAGE__->class_documentation({description => 'Returned in &#x60;server_vad&#x60; mode when the server detects the end of speech in  the audio buffer. The server will also send an &#x60;conversation.item.created&#x60;  event with the user message item that is created from the audio buffer. ',
