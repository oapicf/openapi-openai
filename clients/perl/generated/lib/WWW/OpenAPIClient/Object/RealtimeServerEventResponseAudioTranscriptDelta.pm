...
#
package WWW::OpenAPIClient::Object::RealtimeServerEventResponseAudioTranscriptDelta;
...
__PACKAGE__->class_documentation({description => 'Returned when the model-generated transcription of audio output is updated. ',
