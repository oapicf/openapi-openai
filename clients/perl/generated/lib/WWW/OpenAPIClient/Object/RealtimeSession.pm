...
#
package WWW::OpenAPIClient::Object::RealtimeSession;
...
__PACKAGE__->class_documentation({description => 'Realtime session object configuration.',
...
__PACKAGE__->method_documentation({
    ...
    'turn_detection' => {
        datatype => 'RealtimeSessionTurnDetection',
