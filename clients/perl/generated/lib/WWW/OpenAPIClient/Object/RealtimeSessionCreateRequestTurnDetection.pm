...
#
package WWW::OpenAPIClient::Object::RealtimeSessionCreateRequestTurnDetection;
...
__PACKAGE__->class_documentation({description => 'Configuration for turn detection. Can be set to &#x60;null&#x60; to turn off. Server  VAD means that the model will detect the start and end of speech based on  audio volume and respond at the end of user speech. ',
