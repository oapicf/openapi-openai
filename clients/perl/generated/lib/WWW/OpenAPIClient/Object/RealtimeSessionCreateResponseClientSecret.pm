...
#
package WWW::OpenAPIClient::Object::RealtimeSessionCreateResponseClientSecret;
...
__PACKAGE__->class_documentation({description => 'Ephemeral key returned by the API.',
