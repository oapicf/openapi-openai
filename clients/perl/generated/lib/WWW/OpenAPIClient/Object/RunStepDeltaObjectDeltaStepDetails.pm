...
#
package WWW::OpenAPIClient::Object::RunStepDeltaObjectDeltaStepDetails;
...
__PACKAGE__->class_documentation({description => 'The details of the run step.',
...
__PACKAGE__->method_documentation({
    ...
    'message_creation' => {
        datatype => 'RunStepDeltaStepDetailsMessageCreationObjectMessageCreation',
        base_name => 'message_creation',
        description => '',
        format => '',
        read_only => '',
            },
    'tool_calls' => {
        datatype => 'ARRAY[RunStepDeltaStepDetailsToolCallsObjectToolCallsInner]',
