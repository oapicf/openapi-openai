...
#
package WWW::OpenAPIClient::Object::RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter;
...
__PACKAGE__->class_documentation({description => 'The Code Interpreter tool call definition.',
...
__PACKAGE__->method_documentation({
    ...
    'outputs' => {
        datatype => 'ARRAY[RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner]',
        base_name => 'outputs',
