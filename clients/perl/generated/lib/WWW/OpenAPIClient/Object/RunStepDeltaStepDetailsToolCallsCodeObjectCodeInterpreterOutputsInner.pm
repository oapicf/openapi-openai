...
#
package WWW::OpenAPIClient::Object::RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner;
...
__PACKAGE__->method_documentation({
    ...
    'image' => {
        datatype => 'RunStepDeltaStepDetailsToolCallsCodeOutputImageObjectImage',
        base_name => 'image',
        description => '',
        format => '',
        read_only => '',
