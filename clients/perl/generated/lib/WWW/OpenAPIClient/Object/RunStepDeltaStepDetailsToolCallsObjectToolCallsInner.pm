...
#
package WWW::OpenAPIClient::Object::RunStepDeltaStepDetailsToolCallsObjectToolCallsInner;
...
__PACKAGE__->method_documentation({
    ...
    'code_interpreter' => {
        datatype => 'RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter',
    ...
    'function' => {
        datatype => 'RunStepDeltaStepDetailsToolCallsFunctionObjectFunction',
        base_name => 'function',
        description => '',
        format => '',
        read_only => '',
