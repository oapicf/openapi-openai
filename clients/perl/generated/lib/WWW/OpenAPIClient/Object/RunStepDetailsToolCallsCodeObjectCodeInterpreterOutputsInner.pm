...
#
package WWW::OpenAPIClient::Object::RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner;
...
__PACKAGE__->method_documentation({
    ...
    'image' => {
        datatype => 'RunStepDetailsToolCallsCodeOutputImageObjectImage',
        base_name => 'image',
        description => '',
        format => '',
        read_only => '',
