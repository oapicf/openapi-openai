...
#
package WWW::OpenAPIClient::Object::RunStepDetailsToolCallsFileSearchResultObject;
...
__PACKAGE__->class_documentation({description => 'A result instance of the file search.',
...
__PACKAGE__->method_documentation({
    ...
    'content' => {
        datatype => 'ARRAY[RunStepDetailsToolCallsFileSearchResultObjectContentInner]',
        base_name => 'content',
