...
#
package WWW::OpenAPIClient::Object::ThreadObject;
...
__PACKAGE__->class_documentation({description => 'Represents a thread that contains [messages](/docs/api-reference/messages).',
                                  class => 'ThreadObject',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'tool_resources' => {
        datatype => 'ModifyThreadRequestToolResources',
