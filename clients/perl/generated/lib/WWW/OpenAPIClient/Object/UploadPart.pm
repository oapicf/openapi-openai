...
#
package WWW::OpenAPIClient::Object::UploadPart;
...
__PACKAGE__->class_documentation({description => 'The upload Part represents a chunk of bytes we can add to an Upload object. ',
                                  class => 'UploadPart',
                                  required => [], # TODO
}                                 );
