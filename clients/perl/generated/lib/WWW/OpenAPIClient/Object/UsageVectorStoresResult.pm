...
#
package WWW::OpenAPIClient::Object::UsageVectorStoresResult;
...
__PACKAGE__->class_documentation({description => 'The aggregated vector stores usage details of the specific time bucket.',
