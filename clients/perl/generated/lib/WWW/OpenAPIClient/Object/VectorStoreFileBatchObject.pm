...
#
package WWW::OpenAPIClient::Object::VectorStoreFileBatchObject;
...
__PACKAGE__->class_documentation({description => 'A batch of files attached to a vector store.',
...
__PACKAGE__->method_documentation({
    ...
    'file_counts' => {
        datatype => 'VectorStoreFileBatchObjectFileCounts',
