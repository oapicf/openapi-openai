...
#
package WWW::OpenAPIClient::Object::VectorStoreFileObject;
...
__PACKAGE__->class_documentation({description => 'A list of files attached to a vector store.',
...
__PACKAGE__->method_documentation({
    ...
    'last_error' => {
        datatype => 'VectorStoreFileObjectLastError',
    ...
    'chunking_strategy' => {
        datatype => 'VectorStoreFileObjectChunkingStrategy',
        base_name => 'chunking_strategy',
        description => '',
        format => '',
        read_only => '',
            },
