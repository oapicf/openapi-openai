...
#
package WWW::OpenAPIClient::Object::VectorStoreObject;
...
__PACKAGE__->class_documentation({description => 'A vector store is a collection of processed files can be used by the &#x60;file_search&#x60; tool.',
...
__PACKAGE__->method_documentation({
    ...
    'file_counts' => {
        datatype => 'VectorStoreObjectFileCounts',
        base_name => 'file_counts',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'expires_after' => {
        datatype => 'VectorStoreExpirationAfter',
