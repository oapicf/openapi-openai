...
class Batch
{
     ...
     */
    public ?\App\DTO\BatchErrors $errors = null;
     ...
     * @DTA\Validator(name="Scalar", options={"type":"string"})
     */
    public ?string $error_file_id = null;
     ...
     * @DTA\Validator(name="Scalar", options={"type":"int"})
     */
    public ?int $in_progress_at = null;
     ...
     */
    public ?\App\DTO\BatchRequestCounts $request_counts = null;
