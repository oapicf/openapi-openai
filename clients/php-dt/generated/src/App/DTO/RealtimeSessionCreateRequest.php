...
class RealtimeSessionCreateRequest
{
     ...
     */
    public ?\App\DTO\Collection121 $modalities = null;
     ...
     * @DTA\Strategy(name="Object", options={"type":\App\DTO\RealtimeSessionCreateRequestTurnDetection::class})
     * @DTA\Validator(name="TypeCompliant", options={"type":\App\DTO\RealtimeSessionCreateRequestTurnDetection::class})
     */
    public ?\App\DTO\RealtimeSessionCreateRequestTurnDetection $turn_detection = null;
     ...
     */
    public ?\App\DTO\Collection122 $tools = null;
