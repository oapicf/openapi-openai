...
interface AudioApiInterface
{
     ...
     * @param  \OpenAPI\Server\Model\OpenAPI\Server\Model\AudioResponseFormat|null $responseFormat   (optional)
    ...
    public function createTranscription(
        ...
        ?string $language,
        ?string $prompt,
        ?\OpenAPI\Server\Model\OpenAPI\Server\Model\AudioResponseFormat $responseFormat,
        float $temperature,
