...
/**
 * Class representing the ApiKeyList model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ApiKeyList 
{
    ...
    */
     ...
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\AdminApiKey>")
    */
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\AdminApiKey"),
    ])]
