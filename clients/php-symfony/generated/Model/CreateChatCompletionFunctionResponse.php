...
/**
 * Class representing the CreateChatCompletionFunctionResponse model.
 *
...
class CreateChatCompletionFunctionResponse 
{
    ...
    */
     ...
     *
     * @var CreateChatCompletionFunctionResponseChoicesInner[]|null
     * @SerializedName("choices")
     * @Type("array<OpenAPI\Server\Model\CreateChatCompletionFunctionResponseChoicesInner>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\CreateChatCompletionFunctionResponseChoicesInner"),
    ])]
    ...
    */
     ...
     * Gets choices.
     *
     * @return CreateChatCompletionFunctionResponseChoicesInner[]|null
     */
    ...
    * Sets choices.
    *
    * @param CreateChatCompletionFunctionResponseChoicesInner[]|null $choices  A list of chat completion choices. Can be more than one if `n` is greater than 1.
    *
    * @return $this
    */
