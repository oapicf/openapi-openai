...
class CreateModerationResponseResultsInner 
{
    ...
    */
    ...
    /**
     * @var CreateModerationResponseResultsInnerCategoryAppliedInputTypes|null
     * @SerializedName("category_applied_input_types")
     * @Type("OpenAPI\Server\Model\CreateModerationResponseResultsInnerCategoryAppliedInputTypes")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\Type("OpenAPI\Server\Model\CreateModerationResponseResultsInnerCategoryAppliedInputTypes")]
    protected ?CreateModerationResponseResultsInnerCategoryAppliedInputTypes $categoryAppliedInputTypes = null;
    ...
    public function __construct(?array $data = null)
    {
        if (is_array($data)) {
            ...
            $this->categoryAppliedInputTypes = array_key_exists('categoryAppliedInputTypes', $data) ? $data['categoryAppliedInputTypes'] : $this->categoryAppliedInputTypes;
        }
    }
    ...
    */
    ...
    /**
     * Gets categoryAppliedInputTypes.
     *
     * @return CreateModerationResponseResultsInnerCategoryAppliedInputTypes|null
     */
    public function getCategoryAppliedInputTypes(): ?CreateModerationResponseResultsInnerCategoryAppliedInputTypes
    {
        return $this->categoryAppliedInputTypes;
    }

    /**
    * Sets categoryAppliedInputTypes.
    *
    * @param CreateModerationResponseResultsInnerCategoryAppliedInputTypes|null $categoryAppliedInputTypes
    *
    * @return $this
    */
    public function setCategoryAppliedInputTypes(?CreateModerationResponseResultsInnerCategoryAppliedInputTypes $categoryAppliedInputTypes): self
    {
