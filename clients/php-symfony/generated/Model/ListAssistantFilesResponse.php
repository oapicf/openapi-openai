...
/**
 * Class representing the ListAssistantFilesResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ListAssistantFilesResponse 
{
    ...
    */
    ...
    /**
     * @var AssistantFileObject[]|null
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\AssistantFileObject>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\AssistantFileObject"),
    ])]
    ...
    */
     ...
     * Gets data.
     *
     * @return AssistantFileObject[]|null
     */
    ...
    * Sets data.
    *
    * @param AssistantFileObject[]|null $data
    *
    * @return $this
    */
