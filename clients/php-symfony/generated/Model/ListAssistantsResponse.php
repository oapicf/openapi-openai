...
/**
 * Class representing the ListAssistantsResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ListAssistantsResponse 
{
    ...
    */
    ...
    /**
     * @var AssistantObject[]|null
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\AssistantObject>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\AssistantObject"),
    ])]
    ...
    * Sets data.
    *
    * @param AssistantObject[]|null $data
    *
    * @return $this
    */
