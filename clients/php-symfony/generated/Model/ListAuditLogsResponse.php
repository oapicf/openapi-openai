...
/**
 * Class representing the ListAuditLogsResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ListAuditLogsResponse 
{
    ...
    */
     ...
     * @var AuditLog[]|null
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\AuditLog>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\AuditLog"),
    ])]
