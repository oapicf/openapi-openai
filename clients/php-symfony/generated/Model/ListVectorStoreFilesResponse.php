...
/**
 * Class representing the ListVectorStoreFilesResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ListVectorStoreFilesResponse 
{
    ...
    */
    ...
    /**
     * @var VectorStoreFileObject[]|null
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\VectorStoreFileObject>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\VectorStoreFileObject"),
    ])]
    ...
    */
     ...
     * Gets data.
     *
     * @return VectorStoreFileObject[]|null
     */
    ...
    * Sets data.
    *
    * @param VectorStoreFileObject[]|null $data
    *
    * @return $this
    */
