...
/**
 * Class representing the ListVectorStoresResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ListVectorStoresResponse 
{
    ...
    */
    ...
    /**
     * @var VectorStoreObject[]|null
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\VectorStoreObject>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\VectorStoreObject"),
    ])]
    ...
    * Sets data.
    *
    * @param VectorStoreObject[]|null $data
    *
    * @return $this
    */
