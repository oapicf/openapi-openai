...
/**
 * Class representing the ProjectApiKeyListResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ProjectApiKeyListResponse 
{
    ...
    */
    ...
    /**
     * @var ProjectApiKey[]|null
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\ProjectApiKey>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\ProjectApiKey"),
    ])]
