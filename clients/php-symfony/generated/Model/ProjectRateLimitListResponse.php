...
/**
 * Class representing the ProjectRateLimitListResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ProjectRateLimitListResponse 
{
    ...
    */
    ...
    /**
     * @var ProjectRateLimit[]|null
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\ProjectRateLimit>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\ProjectRateLimit"),
    ])]
    ...
    * Sets data.
    *
    * @param ProjectRateLimit[]|null $data
    *
    * @return $this
    */
