...
/**
 * Class representing the ProjectServiceAccountListResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ProjectServiceAccountListResponse 
{
    ...
    */
     ...
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\ProjectServiceAccount>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\ProjectServiceAccount"),
    ])]
    ...
    * Sets data.
    *
    * @param ProjectServiceAccount[]|null $data
    *
    * @return $this
    */
