...
/**
 * Class representing the ProjectUserListResponse model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class ProjectUserListResponse 
{
    ...
    */
     ...
     * @SerializedName("data")
     * @Type("array<OpenAPI\Server\Model\ProjectUser>")
    */
    #[Assert\NotNull]
    #[Assert\Valid]
    #[Assert\All([
        new Assert\Type("OpenAPI\Server\Model\ProjectUser"),
    ])]
