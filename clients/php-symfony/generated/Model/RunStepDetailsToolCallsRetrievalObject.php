...
/**
 * Class representing the RunStepDetailsToolCallsRetrievalObject model.
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
...
class RunStepDetailsToolCallsRetrievalObject 
{
    ...
    * Sets type.
    *
    * @param string|null $type  The type of tool call. This is always going to be `retrieval` for this type of tool call.
    *
    * @return $this
    */
