...
class User 
{
    ...
    * Sets object.
    *
    * @param string|null $object  The object type, which is always `organization.user`
    *
    * @return $this
    */
    ...
    * Sets addedAt.
    *
    * @param int|null $addedAt  The Unix timestamp (in seconds) of when the user was added.
    *
    * @return $this
    */
