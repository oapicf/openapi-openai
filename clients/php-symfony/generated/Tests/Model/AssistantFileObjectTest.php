 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\AssistantFileObject
 */
class AssistantFileObjectTest extends TestCase
{
    protected AssistantFileObject|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(AssistantFileObject::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(AssistantFileObject::class));
        $this->assertInstanceOf(AssistantFileObject::class, $this->object);
    }
