 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CreateCompletionResponse
 */
class CreateCompletionResponseTest extends TestCase
{
    protected CreateCompletionResponse|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CreateCompletionResponse::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CreateCompletionResponse::class));
        $this->assertInstanceOf(CreateCompletionResponse::class, $this->object);
    }
