 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CreateEditRequest
 */
class CreateEditRequestTest extends TestCase
{
    protected CreateEditRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CreateEditRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CreateEditRequest::class));
        $this->assertInstanceOf(CreateEditRequest::class, $this->object);
    }
