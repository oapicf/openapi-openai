<?php
/**
 * CreateFineTuningJobRequestHyperparametersTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CreateFineTuningJobRequestHyperparameters;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CreateFineTuningJobRequestHyperparameters
 */
class CreateFineTuningJobRequestHyperparametersTest extends TestCase
{
    protected CreateFineTuningJobRequestHyperparameters|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CreateFineTuningJobRequestHyperparameters::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CreateFineTuningJobRequestHyperparameters::class));
        $this->assertInstanceOf(CreateFineTuningJobRequestHyperparameters::class, $this->object);
    }
