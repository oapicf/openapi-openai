 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CreateMessageRequest
 */
class CreateMessageRequestTest extends TestCase
{
    protected CreateMessageRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CreateMessageRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CreateMessageRequest::class));
        $this->assertInstanceOf(CreateMessageRequest::class, $this->object);
    }
