<?php
/**
 * CreateModerationResponseResultsInnerCategoryAppliedInputTypesTest
 *
 * PHP version 8.1.1
 *
 * @category Class
...
use OpenAPI\Server\Model\CreateModerationResponseResultsInnerCategoryAppliedInputTypes;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CreateModerationResponseResultsInnerCategoryAppliedInputTypes
 */
class CreateModerationResponseResultsInnerCategoryAppliedInputTypesTest extends TestCase
{
    protected CreateModerationResponseResultsInnerCategoryAppliedInputTypes|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CreateModerationResponseResultsInnerCategoryAppliedInputTypes::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CreateModerationResponseResultsInnerCategoryAppliedInputTypes::class));
        $this->assertInstanceOf(CreateModerationResponseResultsInnerCategoryAppliedInputTypes::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyIllicit(): void
    {
        $this->markTestSkipped('Test for property illicit not implemented');
    }
     ...
     * @small
     */
    public function testPropertyIllicitViolent(): void
    {
        $this->markTestSkipped('Test for property illicitViolent not implemented');
    }
