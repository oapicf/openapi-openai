 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\CreateRunRequest
 */
class CreateRunRequestTest extends TestCase
{
    protected CreateRunRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(CreateRunRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(CreateRunRequest::class));
        $this->assertInstanceOf(CreateRunRequest::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyAdditionalInstructions(): void
    {
        $this->markTestSkipped('Test for property additionalInstructions not implemented');
    }
     ...
     * @small
     */
    public function testPropertyAdditionalMessages(): void
    {
        $this->markTestSkipped('Test for property additionalMessages not implemented');
    }
