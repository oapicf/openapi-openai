<?php
/**
 * ListFineTuningJobEventsResponseTest
 *
 * PHP version 8.1.1
 *
 * @category Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ListFineTuningJobEventsResponse
 */
class ListFineTuningJobEventsResponseTest extends TestCase
{
    protected ListFineTuningJobEventsResponse|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ListFineTuningJobEventsResponse::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ListFineTuningJobEventsResponse::class));
        $this->assertInstanceOf(ListFineTuningJobEventsResponse::class, $this->object);
    }
