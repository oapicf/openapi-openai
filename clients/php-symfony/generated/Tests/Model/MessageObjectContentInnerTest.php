...
use OpenAPI\Server\Model\MessageObjectContentInner;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\MessageObjectContentInner
 */
class MessageObjectContentInnerTest extends TestCase
{
    protected MessageObjectContentInner|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(MessageObjectContentInner::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(MessageObjectContentInner::class));
        $this->assertInstanceOf(MessageObjectContentInner::class, $this->object);
    }
