 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ModifyAssistantRequest
 */
class ModifyAssistantRequestTest extends TestCase
{
    protected ModifyAssistantRequest|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(ModifyAssistantRequest::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ModifyAssistantRequest::class));
        $this->assertInstanceOf(ModifyAssistantRequest::class, $this->object);
    }
