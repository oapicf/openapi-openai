...
use OpenAPI\Server\Model\RealtimeResponse;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\RealtimeResponse
 */
class RealtimeResponseTest extends TestCase
{
    protected RealtimeResponse|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(RealtimeResponse::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(RealtimeResponse::class));
        $this->assertInstanceOf(RealtimeResponse::class, $this->object);
    }
