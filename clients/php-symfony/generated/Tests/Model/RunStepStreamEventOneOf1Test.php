...
use OpenAPI\Server\Model\RunStepStreamEventOneOf1;
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\RunStepStreamEventOneOf1
 */
class RunStepStreamEventOneOf1Test extends TestCase
{
    protected RunStepStreamEventOneOf1|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(RunStepStreamEventOneOf1::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(RunStepStreamEventOneOf1::class));
        $this->assertInstanceOf(RunStepStreamEventOneOf1::class, $this->object);
    }
