...
use OpenAPI\Server\Model\UsageTimeBucket;
 ...
 *
 * @category    Class
 * @description UsageTimeBucket
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\UsageTimeBucket
 */
class UsageTimeBucketTest extends TestCase
{
    protected UsageTimeBucket|MockObject $object;
    ...
    {
        $this->object = $this->getMockBuilder(UsageTimeBucket::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(UsageTimeBucket::class));
        $this->assertInstanceOf(UsageTimeBucket::class, $this->object);
    }
