...
**attachments** | [**OpenAPI\Server\Model\CreateMessageRequestAttachmentsInner**](CreateMessageRequestAttachmentsInner.md) | A list of files attached to the message, and the tools they were added to. | 
