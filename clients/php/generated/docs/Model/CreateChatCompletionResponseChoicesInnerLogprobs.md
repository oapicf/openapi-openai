...
**refusal** | [**\OpenAPI\Client\Model\ChatCompletionTokenLogprob[]**](ChatCompletionTokenLogprob.md) | A list of message refusal tokens with log probability information. |
