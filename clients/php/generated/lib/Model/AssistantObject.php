...
/**
 * AssistantObject Class Doc Comment
 *
 * @category Class
 ...
 */
class AssistantObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssistantObject';
    ...
    protected static $openAPITypes = [
        ...
        'tool_resources' => '\OpenAPI\Client\Model\AssistantObjectToolResources',
        'metadata' => 'object',
        'temperature' => 'float',
        'top_p' => 'float',
    ...
    public const OBJECT_ASSISTANT = 'assistant';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['instructions'] === null && !$this->isNullableSetToNull('instructions')) {
            $invalidProperties[] = "'instructions' can't be null";
        }
        if ((mb_strlen($this->container['instructions']) > 256000)) {
        ...
        if ((count($this->container['tools']) > 128)) {
     ...
     * Sets created_at
     *
     * @param int $created_at The Unix timestamp (in seconds) for when the assistant was created.
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AssistantObject., must be smaller than or equal to 256.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 512)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AssistantObject., must be smaller than or equal to 512.');
        }
     ...
     * Sets model
     *
     * @param string $model ID of the model to use. You can use the [List models](/docs/api-reference/models/list) API to see all of your available models, or see our [Model overview](/docs/models) for descriptions of them.
     *
     * @return self
     */
    ...
    public function setInstructions($instructions)
    {
        ...
        if (!is_null($instructions) && (mb_strlen($instructions) > 256000)) {
            throw new \InvalidArgumentException('invalid length for $instructions when calling AssistantObject., must be smaller than or equal to 256000.');
        }
     ...
     * Sets tools
     *
     * @param \OpenAPI\Client\Model\AssistantObjectToolsInner[] $tools A list of tool enabled on the assistant. There can be a maximum of 128 tools per assistant. Tools can be of types `code_interpreter`, `file_search`, or `function`.
     *
     * @return self
     */
    public function setTools($tools)
    {
        ...
        if ((count($tools) > 128)) {
            throw new \InvalidArgumentException('invalid value for $tools when calling AssistantObject., number of items must be less than or equal to 128.');
        }
     ...
     * Gets tool_resources
     *
     * @return \OpenAPI\Client\Model\AssistantObjectToolResources|null
     */
     ...
     * Sets tool_resources
     *
     * @param \OpenAPI\Client\Model\AssistantObjectToolResources|null $tool_resources tool_resources
     *
     * @return self
     */
    ...
    public function setTemperature($temperature)
    {
        ...
        if (!is_null($temperature) && ($temperature > 2)) {
            throw new \InvalidArgumentException('invalid value for $temperature when calling AssistantObject., must be smaller than or equal to 2.');
        }
        if (!is_null($temperature) && ($temperature < 0)) {
            throw new \InvalidArgumentException('invalid value for $temperature when calling AssistantObject., must be bigger than or equal to 0.');
        }
    ...
    public function setTopP($top_p)
    {
        ...
        if (!is_null($top_p) && ($top_p > 1)) {
            throw new \InvalidArgumentException('invalid value for $top_p when calling AssistantObject., must be smaller than or equal to 1.');
        }
        if (!is_null($top_p) && ($top_p < 0)) {
            throw new \InvalidArgumentException('invalid value for $top_p when calling AssistantObject., must be bigger than or equal to 0.');
        }
