...
/**
 * CreateChatCompletionFunctionResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateChatCompletionFunctionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateChatCompletionFunctionResponse';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'choices' => '\OpenAPI\Client\Model\CreateChatCompletionFunctionResponseChoicesInner[]',
        'created' => 'int',
        'model' => 'string',
    ...
    public const OBJECT_CHAT_COMPLETION = 'chat.completion';
    ...
    */
     ...
     * Gets choices
     *
     * @return \OpenAPI\Client\Model\CreateChatCompletionFunctionResponseChoicesInner[]
     */
     ...
     * Sets choices
     *
     * @param \OpenAPI\Client\Model\CreateChatCompletionFunctionResponseChoicesInner[] $choices A list of chat completion choices. Can be more than one if `n` is greater than 1.
     *
     * @return self
     */
