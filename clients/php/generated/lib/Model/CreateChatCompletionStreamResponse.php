...
/**
 * CreateChatCompletionStreamResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateChatCompletionStreamResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateChatCompletionStreamResponse';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'choices' => '\OpenAPI\Client\Model\CreateChatCompletionStreamResponseChoicesInner[]',
        'created' => 'int',
        'model' => 'string',
        'service_tier' => 'string',
        'system_fingerprint' => 'string',
        'object' => 'string',
        'usage' => '\OpenAPI\Client\Model\CreateChatCompletionStreamResponseUsage'
    ];
    ...
    public const SERVICE_TIER_SCALE = 'scale';
    ...
    */
     ...
     * Gets choices
     *
     * @return \OpenAPI\Client\Model\CreateChatCompletionStreamResponseChoicesInner[]
     */
     ...
     * Sets choices
     *
     * @param \OpenAPI\Client\Model\CreateChatCompletionStreamResponseChoicesInner[] $choices A list of chat completion choices. Can contain more than one elements if `n` is greater than 1. Can also be empty for the last chunk if you set `stream_options: {\"include_usage\": true}`.
     *
     * @return self
     */
     ...
     * Sets service_tier
     *
     * @param string|null $service_tier The service tier used for processing the request. This field is only included if the `service_tier` parameter is specified in the request.
     *
     * @return self
     */
     ...
     * Gets usage
     *
     * @return \OpenAPI\Client\Model\CreateChatCompletionStreamResponseUsage|null
     */
     ...
     * Sets usage
     *
     * @param \OpenAPI\Client\Model\CreateChatCompletionStreamResponseUsage|null $usage usage
     *
     * @return self
     */
