...
/**
 * CreateThreadRequestToolResourcesFileSearch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateThreadRequestToolResourcesFileSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateThreadRequest_tool_resources_file_search';
    ...
    protected static $openAPITypes = [
        ...
        'vector_stores' => '\OpenAPI\Client\Model\CreateThreadRequestToolResourcesFileSearchVectorStoresInner[]'
    ];
    ...
    */
     ...
     *
     * @param string[]|null $vector_store_ids The [vector store](/docs/api-reference/vector-stores/object) attached to this thread. There can be a maximum of 1 vector store attached to the thread.
     *
     * @return self
     */
    public function setVectorStoreIds($vector_store_ids)
    {
        ...
        if ((count($vector_store_ids) > 1)) {
            throw new \InvalidArgumentException('invalid value for $vector_store_ids when calling CreateThreadRequestToolResourcesFileSearch., number of items must be less than or equal to 1.');
        }
     ...
     * Gets vector_stores
     *
     * @return \OpenAPI\Client\Model\CreateThreadRequestToolResourcesFileSearchVectorStoresInner[]|null
     */
     ...
     * Sets vector_stores
     *
     * @param \OpenAPI\Client\Model\CreateThreadRequestToolResourcesFileSearchVectorStoresInner[]|null $vector_stores A helper to create a [vector store](/docs/api-reference/vector-stores/object) with file_ids and attach it to this thread. There can be a maximum of 1 vector store attached to the thread.
     *
     * @return self
     */
    public function setVectorStores($vector_stores)
    {
        ...
        if ((count($vector_stores) > 1)) {
            throw new \InvalidArgumentException('invalid value for $vector_stores when calling CreateThreadRequestToolResourcesFileSearch., number of items must be less than or equal to 1.');
        }
