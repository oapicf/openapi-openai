...
/**
 * InviteListResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InviteListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InviteListResponse';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\OpenAPI\Client\Model\Invite[]',
        'first_id' => 'string',
        'last_id' => 'string',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Invite[] $data data
     *
     * @return self
     */
     ...
     * Sets first_id
     *
     * @param string|null $first_id The first `invite_id` in the retrieved `list`
     *
     * @return self
     */
     ...
     * Sets last_id
     *
     * @param string|null $last_id The last `invite_id` in the retrieved `list`
     *
     * @return self
     */
     ...
     * Sets has_more
     *
     * @param bool|null $has_more The `has_more` property is used for pagination to indicate there are additional results.
     *
     * @return self
     */
