...
/**
 * ListAssistantsResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListAssistantsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListAssistantsResponse';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\OpenAPI\Client\Model\AssistantObject[]',
        'first_id' => 'string',
        'last_id' => 'string',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\AssistantObject[] $data data
     *
     * @return self
     */
