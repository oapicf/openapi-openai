...
/**
 * ListBatchesResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListBatchesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\Batch[]',
        'first_id' => 'string',
        'last_id' => 'string',
        'has_more' => 'bool',
        'object' => 'string'
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\Batch[] $data data
     *
     * @return self
     */
