...
/**
 * ListVectorStoresResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListVectorStoresResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListVectorStoresResponse';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\OpenAPI\Client\Model\VectorStoreObject[]',
        'first_id' => 'string',
        'last_id' => 'string',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\VectorStoreObject[] $data data
     *
     * @return self
     */
