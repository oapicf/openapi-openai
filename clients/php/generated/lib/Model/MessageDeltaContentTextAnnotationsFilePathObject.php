...
/**
 * MessageDeltaContentTextAnnotationsFilePathObject Class Doc Comment
 *
 * @category Class
 ...
 */
class MessageDeltaContentTextAnnotationsFilePathObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageDeltaContentTextAnnotationsFilePathObject';
    ...
    */
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (($start_index < 0)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling MessageDeltaContentTextAnnotationsFilePathObject., must be bigger than or equal to 0.');
        }
    ...
    public function setEndIndex($end_index)
    {
        ...
        if (($end_index < 0)) {
            throw new \InvalidArgumentException('invalid value for $end_index when calling MessageDeltaContentTextAnnotationsFilePathObject., must be bigger than or equal to 0.');
        }
