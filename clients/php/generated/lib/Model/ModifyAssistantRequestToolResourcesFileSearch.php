...
/**
 * ModifyAssistantRequestToolResourcesFileSearch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModifyAssistantRequestToolResourcesFileSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModifyAssistantRequest_tool_resources_file_search';
    ...
    */
     ...
     *
     * @param string[]|null $vector_store_ids Overrides the [vector store](/docs/api-reference/vector-stores/object) attached to this assistant. There can be a maximum of 1 vector store attached to the assistant.
     *
     * @return self
     */
    public function setVectorStoreIds($vector_store_ids)
    {
        ...
        if ((count($vector_store_ids) > 1)) {
            throw new \InvalidArgumentException('invalid value for $vector_store_ids when calling ModifyAssistantRequestToolResourcesFileSearch., number of items must be less than or equal to 1.');
        }
