...
/**
 * ModifyThreadRequestToolResourcesFileSearch Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModifyThreadRequestToolResourcesFileSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModifyThreadRequest_tool_resources_file_search';
    ...
    */
    ...
    public function setVectorStoreIds($vector_store_ids)
    {
        ...
        if ((count($vector_store_ids) > 1)) {
            throw new \InvalidArgumentException('invalid value for $vector_store_ids when calling ModifyThreadRequestToolResourcesFileSearch., number of items must be less than or equal to 1.');
        }
