...
/**
 * ProjectApiKeyListResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectApiKeyListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectApiKeyListResponse';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\OpenAPI\Client\Model\ProjectApiKey[]',
        'first_id' => 'string',
        'last_id' => 'string',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ProjectApiKey[] $data data
     *
     * @return self
     */
