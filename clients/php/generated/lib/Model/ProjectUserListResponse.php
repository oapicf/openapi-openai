...
/**
 * ProjectUserListResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectUserListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectUserListResponse';
    ...
    protected static $openAPITypes = [
        'object' => 'string',
        'data' => '\OpenAPI\Client\Model\ProjectUser[]',
        'first_id' => 'string',
        'last_id' => 'string',
        'has_more' => 'bool'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ProjectUser[] $data data
     *
     * @return self
     */
