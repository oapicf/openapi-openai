...
/**
 * RealtimeClientEventConversationItemDelete Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeClientEventConversationItemDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeClientEventConversationItemDelete';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `conversation.item.delete`.
     *
     * @return self
     */
