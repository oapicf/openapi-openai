...
/**
 * RealtimeClientEventConversationItemTruncate Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeClientEventConversationItemTruncate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeClientEventConversationItemTruncate';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `conversation.item.truncate`.
     *
     * @return self
     */
