...
/**
 * RealtimeClientEventInputAudioBufferCommit Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeClientEventInputAudioBufferCommit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeClientEventInputAudioBufferCommit';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `input_audio_buffer.commit`.
     *
     * @return self
     */
