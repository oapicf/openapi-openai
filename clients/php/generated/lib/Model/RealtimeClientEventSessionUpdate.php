...
/**
 * RealtimeClientEventSessionUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeClientEventSessionUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeClientEventSessionUpdate';
    ...
    protected static $openAPITypes = [
        'event_id' => 'string',
        'type' => 'string',
        'session' => '\OpenAPI\Client\Model\RealtimeSessionCreateRequest'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `session.update`.
     *
     * @return self
     */
     ...
     * Gets session
     *
     * @return \OpenAPI\Client\Model\RealtimeSessionCreateRequest
     */
     ...
     * Sets session
     *
     * @param \OpenAPI\Client\Model\RealtimeSessionCreateRequest $session session
     *
     * @return self
     */
