...
class RealtimeResponseCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'conversation' => '\OpenAPI\Client\Model\RealtimeResponseCreateParamsConversation',
        'metadata' => 'object',
        'input' => '\OpenAPI\Client\Model\RealtimeConversationItem[]'
    ];
    ...
    */
     ...
     * Gets conversation
     *
     * @return \OpenAPI\Client\Model\RealtimeResponseCreateParamsConversation|null
     */
     ...
     * Sets conversation
     *
     * @param \OpenAPI\Client\Model\RealtimeResponseCreateParamsConversation|null $conversation conversation
     *
     * @return self
     */
     ...
     * Sets input
     *
     * @param \OpenAPI\Client\Model\RealtimeConversationItem[]|null $input Input items to include in the prompt for the model. Creates a new context for this response, without including the default conversation. Can include references to items from the default conversation.
     *
     * @return self
     */
