...
/**
 * RealtimeServerEventConversationItemCreated Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventConversationItemCreated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventConversationItemCreated';
    ...
    protected static $openAPITypes = [
        ...
        'item' => '\OpenAPI\Client\Model\RealtimeConversationItem'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `conversation.item.created`.
     *
     * @return self
     */
     ...
     *
     * @param string $previous_item_id The ID of the preceding item in the Conversation context, allows the  client to understand the order of the conversation.
     *
     * @return self
     */
     ...
     * Gets item
     *
     * @return \OpenAPI\Client\Model\RealtimeConversationItem
     */
     ...
     * Sets item
     *
     * @param \OpenAPI\Client\Model\RealtimeConversationItem $item item
     *
     * @return self
     */
