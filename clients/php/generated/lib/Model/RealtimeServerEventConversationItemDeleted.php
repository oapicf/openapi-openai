...
/**
 * RealtimeServerEventConversationItemDeleted Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventConversationItemDeleted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventConversationItemDeleted';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `conversation.item.deleted`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the item that was deleted.
     *
     * @return self
     */
