...
/**
 * RealtimeServerEventConversationItemInputAudioTranscriptionCompleted Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventConversationItemInputAudioTranscriptionCompleted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventConversationItemInputAudioTranscriptionCompleted';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `conversation.item.input_audio_transcription.completed`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the user message item containing the audio.
     *
     * @return self
     */
