...
/**
 * RealtimeServerEventConversationItemTruncated Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventConversationItemTruncated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventConversationItemTruncated';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `conversation.item.truncated`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the assistant message item that was truncated.
     *
     * @return self
     */
     ...
     * Sets content_index
     *
     * @param int $content_index The index of the content part that was truncated.
     *
     * @return self
     */
     ...
     * Sets audio_end_ms
     *
     * @param int $audio_end_ms The duration up to which the audio was truncated, in milliseconds.
     *
     * @return self
     */
