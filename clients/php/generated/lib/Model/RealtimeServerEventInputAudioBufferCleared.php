...
/**
 * RealtimeServerEventInputAudioBufferCleared Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventInputAudioBufferCleared implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventInputAudioBufferCleared';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `input_audio_buffer.cleared`.
     *
     * @return self
     */
