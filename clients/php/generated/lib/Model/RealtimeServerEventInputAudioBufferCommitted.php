...
/**
 * RealtimeServerEventInputAudioBufferCommitted Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventInputAudioBufferCommitted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventInputAudioBufferCommitted';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `input_audio_buffer.committed`.
     *
     * @return self
     */
