...
/**
 * RealtimeServerEventInputAudioBufferSpeechStarted Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventInputAudioBufferSpeechStarted implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventInputAudioBufferSpeechStarted';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `input_audio_buffer.speech_started`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the user message item that will be created when speech stops.
     *
     * @return self
     */
