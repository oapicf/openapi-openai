...
/**
 * RealtimeServerEventInputAudioBufferSpeechStopped Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventInputAudioBufferSpeechStopped implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventInputAudioBufferSpeechStopped';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `input_audio_buffer.speech_stopped`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the user message item that will be created.
     *
     * @return self
     */
