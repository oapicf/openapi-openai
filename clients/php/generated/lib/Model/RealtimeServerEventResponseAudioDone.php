...
/**
 * RealtimeServerEventResponseAudioDone Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseAudioDone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseAudioDone';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.audio.done`.
     *
     * @return self
     */
