...
/**
 * RealtimeServerEventResponseAudioTranscriptDelta Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseAudioTranscriptDelta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseAudioTranscriptDelta';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.audio_transcript.delta`.
     *
     * @return self
     */
     ...
     * Sets delta
     *
     * @param string $delta The transcript delta.
     *
     * @return self
     */
