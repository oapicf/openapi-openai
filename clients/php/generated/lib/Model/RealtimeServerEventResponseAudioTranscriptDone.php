...
/**
 * RealtimeServerEventResponseAudioTranscriptDone Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseAudioTranscriptDone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseAudioTranscriptDone';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.audio_transcript.done`.
     *
     * @return self
     */
