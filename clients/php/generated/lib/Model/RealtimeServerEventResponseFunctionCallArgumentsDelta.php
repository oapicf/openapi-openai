...
/**
 * RealtimeServerEventResponseFunctionCallArgumentsDelta Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseFunctionCallArgumentsDelta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseFunctionCallArgumentsDelta';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.function_call_arguments.delta`.
     *
     * @return self
     */
     ...
     * Sets item_id
     *
     * @param string $item_id The ID of the function call item.
     *
     * @return self
     */
     ...
     * Sets delta
     *
     * @param string $delta The arguments delta as a JSON string.
     *
     * @return self
     */
