...
/**
 * RealtimeServerEventResponseFunctionCallArgumentsDone Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseFunctionCallArgumentsDone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseFunctionCallArgumentsDone';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.function_call_arguments.done`.
     *
     * @return self
     */
