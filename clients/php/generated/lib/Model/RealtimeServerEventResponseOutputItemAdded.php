...
/**
 * RealtimeServerEventResponseOutputItemAdded Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseOutputItemAdded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseOutputItemAdded';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.output_item.added`.
     *
     * @return self
     */
     ...
     * Sets response_id
     *
     * @param string $response_id The ID of the Response to which the item belongs.
     *
     * @return self
     */
