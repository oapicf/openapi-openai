...
/**
 * RealtimeServerEventResponseOutputItemDone Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseOutputItemDone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseOutputItemDone';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.output_item.done`.
     *
     * @return self
     */
