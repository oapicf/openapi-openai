...
/**
 * RealtimeServerEventResponseTextDelta Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseTextDelta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseTextDelta';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.text.delta`.
     *
     * @return self
     */
