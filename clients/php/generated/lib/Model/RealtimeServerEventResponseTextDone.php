...
/**
 * RealtimeServerEventResponseTextDone Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeServerEventResponseTextDone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeServerEventResponseTextDone';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The event type, must be `response.text.done`.
     *
     * @return self
     */
