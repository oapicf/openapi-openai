...
/**
 * RealtimeSession Class Doc Comment
 *
 * @category Class
 ...
 */
class RealtimeSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealtimeSession';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'modalities' => 'string[]',
        'model' => '\OpenAPI\Client\Model\RealtimeSessionModel',
        'instructions' => 'string',
        'voice' => 'string',
        'input_audio_format' => 'string',
        'output_audio_format' => 'string',
        'input_audio_transcription' => '\OpenAPI\Client\Model\RealtimeSessionInputAudioTranscription',
        'turn_detection' => '\OpenAPI\Client\Model\RealtimeSessionTurnDetection',
    ...
    */
     ...
     * Gets model
     *
     * @return \OpenAPI\Client\Model\RealtimeSessionModel|null
     */
     ...
     * Sets model
     *
     * @param \OpenAPI\Client\Model\RealtimeSessionModel|null $model model
     *
     * @return self
     */
     ...
     * Gets turn_detection
     *
     * @return \OpenAPI\Client\Model\RealtimeSessionTurnDetection|null
     */
     ...
     * Sets turn_detection
     *
     * @param \OpenAPI\Client\Model\RealtimeSessionTurnDetection|null $turn_detection turn_detection
     *
     * @return self
     */
    public function setTurnDetection($turn_detection)
    {
        if (is_null($turn_detection)) {
            array_push($this->openAPINullablesSetToNull, 'turn_detection');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('turn_detection', $nullablesSetToNull);
            if ($index !== FALSE) {
