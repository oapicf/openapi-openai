...
/**
 * RunCompletionUsage Class Doc Comment
 *
 * @category Class
 ...
 */
class RunCompletionUsage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RunCompletionUsage';
    ...
    */
     ...
     *
     * @param int $completion_tokens Number of completion tokens used over the course of the run.
     *
     * @return self
     */
     ...
     * Sets prompt_tokens
     *
     * @param int $prompt_tokens Number of prompt tokens used over the course of the run.
     *
     * @return self
     */
