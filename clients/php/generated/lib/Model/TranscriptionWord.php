...
/**
 * TranscriptionWord Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TranscriptionWord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TranscriptionWord';
    ...
    */
     ...
     * Sets start
     *
     * @param float $start Start time of the word in seconds.
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param float $end End time of the word in seconds.
     *
     * @return self
     */
