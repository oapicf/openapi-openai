...
class UploadPart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const OBJECT_UPLOAD_PART = 'upload.part';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The upload Part unique identifier, which can be referenced in API endpoints.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param int $created_at The Unix timestamp (in seconds) for when the Part was created.
     *
     * @return self
     */
     ...
     * Sets upload_id
     *
     * @param string $upload_id The ID of the Upload object that this Part was added to.
     *
     * @return self
     */
     ...
     * Sets object
     *
     * @param string $object The object type, which is always `upload.part`.
     *
     * @return self
     */
