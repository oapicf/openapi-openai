...
/**
 * UsageCodeInterpreterSessionsResult Class Doc Comment
 *
 * @category Class
 ...
 */
class UsageCodeInterpreterSessionsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsageCodeInterpreterSessionsResult';
    ...
    public const OBJECT_ORGANIZATION_USAGE_CODE_INTERPRETER_SESSIONS_RESULT = 'organization.usage.code_interpreter_sessions.result';
    ...
    {
        return [
            self::OBJECT_ORGANIZATION_USAGE_CODE_INTERPRETER_SESSIONS_RESULT,
        ];
    }
