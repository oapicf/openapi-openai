...
/**
 * VectorStoreObjectFileCounts Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VectorStoreObjectFileCounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VectorStoreObject_file_counts';
    ...
    */
     ...
     * Sets completed
     *
     * @param int $completed The number of files that have been successfully processed.
     *
     * @return self
     */
     ...
     * Sets cancelled
     *
     * @param int $cancelled The number of files that were cancelled.
     *
     * @return self
     */
