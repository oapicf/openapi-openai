...
**Metadata** | **System.Collections.Hashtable** | Optional custom metadata for the batch. | [optional] 

## Examples

- Prepare the resource
```powershell
$CreateBatchRequest = Initialize-PSOpenAPIToolsCreateBatchRequest  -InputFileId null `
 -Endpoint null `
...
```powershell
$CreateBatchRequest | ConvertTo-JSON
```
