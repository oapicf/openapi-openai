...
```powershell
$CreateThreadRequestToolResourcesFileSearchVectorStoresInner = Initialize-PSOpenAPIToolsCreateThreadRequestToolResourcesFileSearchVectorStoresInner  -FileIds null `
...
```powershell
$CreateThreadRequestToolResourcesFileSearchVectorStoresInner | ConvertTo-JSON
```
