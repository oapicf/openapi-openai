...
```powershell
$ProjectRateLimitUpdateRequest = Initialize-PSOpenAPIToolsProjectRateLimitUpdateRequest  -MaxRequestsPer1Minute null `
...
```powershell
$ProjectRateLimitUpdateRequest | ConvertTo-JSON
```
