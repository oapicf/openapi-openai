...
**VarError** | [**RealtimeResponseStatusDetailsError**](RealtimeResponseStatusDetailsError.md) |  | [optional] 

## Examples

- Prepare the resource
```powershell
$RealtimeResponseStatusDetails = Initialize-PSOpenAPIToolsRealtimeResponseStatusDetails  -Type null `
 -Reason null `
 -VarError null
```
...
```powershell
$RealtimeResponseStatusDetails | ConvertTo-JSON
```
