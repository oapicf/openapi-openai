...
```powershell
$RealtimeServerEventResponseContentPartDone = Initialize-PSOpenAPIToolsRealtimeServerEventResponseContentPartDone  -EventId null `
 -Type null `
 -ResponseId null `
 -ItemId null `
 -OutputIndex null `
...
```powershell
$RealtimeServerEventResponseContentPartDone | ConvertTo-JSON
```
