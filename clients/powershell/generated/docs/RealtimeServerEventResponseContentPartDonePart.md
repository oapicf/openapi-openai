...
```powershell
$RealtimeServerEventResponseContentPartDonePart = Initialize-PSOpenAPIToolsRealtimeServerEventResponseContentPartDonePart  -Type null `
 -Text null `
 -Audio null `
 -Transcript null
```
...
```powershell
$RealtimeServerEventResponseContentPartDonePart | ConvertTo-JSON
```
