...
```powershell
$RealtimeSessionCreateRequestTurnDetection = Initialize-PSOpenAPIToolsRealtimeSessionCreateRequestTurnDetection  -Type null `
 -Threshold null `
...
```powershell
$RealtimeSessionCreateRequestTurnDetection | ConvertTo-JSON
```
