...
CreateAssistantRequestModel<PSCustomObject>
#>
function ConvertFrom-JsonToCreateAssistantRequestModel {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'String' defined in anyOf (CreateAssistantRequestModel). Proceeding to the next one if any."
            }
        }
