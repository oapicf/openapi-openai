...
CreateChatCompletionFunctionResponse<PSCustomObject>
#>

function Initialize-CreateChatCompletionFunctionResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateChatCompletionFunctionResponse' | Write-Debug
...
Convert from JSON to CreateChatCompletionFunctionResponse<PSCustomObject>
...
CreateChatCompletionFunctionResponse<PSCustomObject>
#>
function ConvertFrom-JsonToCreateChatCompletionFunctionResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateChatCompletionFunctionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateChatCompletionFunctionResponse
