...
CreateChatCompletionStreamResponseUsage<PSCustomObject>
#>

function Initialize-CreateChatCompletionStreamResponseUsage {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateChatCompletionStreamResponseUsage' | Write-Debug
...
Convert from JSON to CreateChatCompletionStreamResponseUsage<PSCustomObject>
...
CreateChatCompletionStreamResponseUsage<PSCustomObject>
#>
function ConvertFrom-JsonToCreateChatCompletionStreamResponseUsage {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateChatCompletionStreamResponseUsage' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateChatCompletionStreamResponseUsage
