...
CreateImageEditRequestModel<PSCustomObject>
#>
function ConvertFrom-JsonToCreateImageEditRequestModel {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'String' defined in anyOf (CreateImageEditRequestModel). Proceeding to the next one if any."
            }
        }
