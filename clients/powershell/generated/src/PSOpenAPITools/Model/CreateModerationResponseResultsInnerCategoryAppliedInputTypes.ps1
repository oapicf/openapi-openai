...
CreateModerationResponseResultsInnerCategoryAppliedInputTypes<PSCustomObject>
#>

function Initialize-CreateModerationResponseResultsInnerCategoryAppliedInputTypes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateModerationResponseResultsInnerCategoryAppliedInputTypes' | Write-Debug
...
Convert from JSON to CreateModerationResponseResultsInnerCategoryAppliedInputTypes<PSCustomObject>
...
CreateModerationResponseResultsInnerCategoryAppliedInputTypes<PSCustomObject>
#>
function ConvertFrom-JsonToCreateModerationResponseResultsInnerCategoryAppliedInputTypes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateModerationResponseResultsInnerCategoryAppliedInputTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateModerationResponseResultsInnerCategoryAppliedInputTypes
