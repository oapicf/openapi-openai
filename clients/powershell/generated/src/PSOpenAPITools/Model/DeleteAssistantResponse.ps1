...
DeleteAssistantResponse<PSCustomObject>
#>

function Initialize-DeleteAssistantResponse {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("assistant.deleted")]
        [String]
        ${Object}
    )

    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeleteAssistantResponse' | Write-Debug
...
Convert from JSON to DeleteAssistantResponse<PSCustomObject>
...
DeleteAssistantResponse<PSCustomObject>
#>
function ConvertFrom-JsonToDeleteAssistantResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeleteAssistantResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteAssistantResponse
