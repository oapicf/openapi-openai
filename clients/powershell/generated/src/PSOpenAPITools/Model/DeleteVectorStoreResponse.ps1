...
DeleteVectorStoreResponse<PSCustomObject>
#>

function Initialize-DeleteVectorStoreResponse {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("vector_store.deleted")]
        [String]
        ${Object}
    )

    Process {
        'Creating PSCustomObject: PSOpenAPITools => DeleteVectorStoreResponse' | Write-Debug
...
Convert from JSON to DeleteVectorStoreResponse<PSCustomObject>
...
DeleteVectorStoreResponse<PSCustomObject>
#>
function ConvertFrom-JsonToDeleteVectorStoreResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DeleteVectorStoreResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DeleteVectorStoreResponse
