...
function Initialize-ErrorEvent {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ErrorEvent' | Write-Debug
...
Convert from JSON to ErrorEvent<PSCustomObject>
...
ErrorEvent<PSCustomObject>
#>
function ConvertFrom-JsonToErrorEvent {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ErrorEvent' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ErrorEvent
