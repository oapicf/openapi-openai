...
ListAssistantFilesResponse<PSCustomObject>
#>

function Initialize-ListAssistantFilesResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListAssistantFilesResponse' | Write-Debug
...
Convert from JSON to ListAssistantFilesResponse<PSCustomObject>
...
ListAssistantFilesResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListAssistantFilesResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListAssistantFilesResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListAssistantFilesResponse
