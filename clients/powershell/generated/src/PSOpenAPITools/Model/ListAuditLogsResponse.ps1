...
ListAuditLogsResponse<PSCustomObject>
#>

function Initialize-ListAuditLogsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListAuditLogsResponse' | Write-Debug
...
Convert from JSON to ListAuditLogsResponse<PSCustomObject>
...
ListAuditLogsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListAuditLogsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListAuditLogsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListAuditLogsResponse
