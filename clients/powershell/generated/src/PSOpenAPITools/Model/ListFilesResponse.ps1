...
ListFilesResponse<PSCustomObject>
#>

function Initialize-ListFilesResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListFilesResponse' | Write-Debug
...
Convert from JSON to ListFilesResponse<PSCustomObject>
...
ListFilesResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListFilesResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListFilesResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListFilesResponse
