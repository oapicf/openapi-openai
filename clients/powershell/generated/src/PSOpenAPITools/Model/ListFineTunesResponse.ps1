...
ListFineTunesResponse<PSCustomObject>
#>

function Initialize-ListFineTunesResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListFineTunesResponse' | Write-Debug
...
Convert from JSON to ListFineTunesResponse<PSCustomObject>
...
ListFineTunesResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListFineTunesResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListFineTunesResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListFineTunesResponse
