...
ListFineTuningJobCheckpointsResponse<PSCustomObject>
#>

function Initialize-ListFineTuningJobCheckpointsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListFineTuningJobCheckpointsResponse' | Write-Debug
...
Convert from JSON to ListFineTuningJobCheckpointsResponse<PSCustomObject>
...
ListFineTuningJobCheckpointsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListFineTuningJobCheckpointsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListFineTuningJobCheckpointsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListFineTuningJobCheckpointsResponse
        $AllProperties = ("data", "object", "first_id", "last_id", "has_more")
