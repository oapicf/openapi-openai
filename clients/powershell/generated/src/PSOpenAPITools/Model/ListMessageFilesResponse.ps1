...
ListMessageFilesResponse<PSCustomObject>
#>

function Initialize-ListMessageFilesResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListMessageFilesResponse' | Write-Debug
...
Convert from JSON to ListMessageFilesResponse<PSCustomObject>
...
ListMessageFilesResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListMessageFilesResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListMessageFilesResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListMessageFilesResponse
