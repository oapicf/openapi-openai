...
ListModelsResponse<PSCustomObject>
#>

function Initialize-ListModelsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListModelsResponse' | Write-Debug
...
Convert from JSON to ListModelsResponse<PSCustomObject>
...
ListModelsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListModelsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListModelsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListModelsResponse
