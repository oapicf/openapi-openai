...
ListRunStepsResponse<PSCustomObject>
#>

function Initialize-ListRunStepsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListRunStepsResponse' | Write-Debug
...
Convert from JSON to ListRunStepsResponse<PSCustomObject>
...
ListRunStepsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListRunStepsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListRunStepsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListRunStepsResponse
