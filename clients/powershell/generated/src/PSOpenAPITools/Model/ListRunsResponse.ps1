...
ListRunsResponse<PSCustomObject>
#>

function Initialize-ListRunsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListRunsResponse' | Write-Debug
...
Convert from JSON to ListRunsResponse<PSCustomObject>
...
ListRunsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListRunsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListRunsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListRunsResponse
