...
ListThreadsResponse<PSCustomObject>
#>

function Initialize-ListThreadsResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListThreadsResponse' | Write-Debug
...
Convert from JSON to ListThreadsResponse<PSCustomObject>
...
ListThreadsResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListThreadsResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListThreadsResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListThreadsResponse
