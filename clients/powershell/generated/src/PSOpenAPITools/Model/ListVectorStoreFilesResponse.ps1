...
ListVectorStoreFilesResponse<PSCustomObject>
#>

function Initialize-ListVectorStoreFilesResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListVectorStoreFilesResponse' | Write-Debug
...
Convert from JSON to ListVectorStoreFilesResponse<PSCustomObject>
...
ListVectorStoreFilesResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListVectorStoreFilesResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListVectorStoreFilesResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListVectorStoreFilesResponse
