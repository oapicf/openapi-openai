...
ListVectorStoresResponse<PSCustomObject>
#>

function Initialize-ListVectorStoresResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ListVectorStoresResponse' | Write-Debug
...
Convert from JSON to ListVectorStoresResponse<PSCustomObject>
...
ListVectorStoresResponse<PSCustomObject>
#>
function ConvertFrom-JsonToListVectorStoresResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ListVectorStoresResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ListVectorStoresResponse
