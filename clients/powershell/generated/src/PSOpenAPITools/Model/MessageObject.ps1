...
function ConvertFrom-JsonToMessageObject {
    ...
    Process {
        ...
        $AllProperties = ("id", "object", "created_at", "thread_id", "status", "incomplete_details", "completed_at", "incomplete_at", "role", "content", "assistant_id", "run_id", "attachments", "metadata")
