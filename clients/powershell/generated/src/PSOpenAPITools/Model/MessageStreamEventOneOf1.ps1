...
MessageStreamEventOneOf1<PSCustomObject>
#>

function Initialize-MessageStreamEventOneOf1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.message.in_progress")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MessageStreamEventOneOf1' | Write-Debug
...
Convert from JSON to MessageStreamEventOneOf1<PSCustomObject>
...
MessageStreamEventOneOf1<PSCustomObject>
#>
function ConvertFrom-JsonToMessageStreamEventOneOf1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MessageStreamEventOneOf1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MessageStreamEventOneOf1
