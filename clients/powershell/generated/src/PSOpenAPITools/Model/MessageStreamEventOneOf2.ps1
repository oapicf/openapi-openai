...
MessageStreamEventOneOf2<PSCustomObject>
#>

function Initialize-MessageStreamEventOneOf2 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MessageStreamEventOneOf2' | Write-Debug
...
Convert from JSON to MessageStreamEventOneOf2<PSCustomObject>
...
MessageStreamEventOneOf2<PSCustomObject>
#>
function ConvertFrom-JsonToMessageStreamEventOneOf2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MessageStreamEventOneOf2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MessageStreamEventOneOf2
