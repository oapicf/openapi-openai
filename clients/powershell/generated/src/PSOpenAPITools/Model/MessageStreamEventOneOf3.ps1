...
MessageStreamEventOneOf3<PSCustomObject>
#>

function Initialize-MessageStreamEventOneOf3 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.message.completed")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MessageStreamEventOneOf3' | Write-Debug
...
Convert from JSON to MessageStreamEventOneOf3<PSCustomObject>
...
MessageStreamEventOneOf3<PSCustomObject>
#>
function ConvertFrom-JsonToMessageStreamEventOneOf3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MessageStreamEventOneOf3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MessageStreamEventOneOf3
