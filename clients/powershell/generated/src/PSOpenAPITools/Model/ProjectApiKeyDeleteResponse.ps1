...
ProjectApiKeyDeleteResponse<PSCustomObject>
#>

function Initialize-ProjectApiKeyDeleteResponse {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("organization.project.api_key.deleted")]
        [String]
        ${Object},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectApiKeyDeleteResponse' | Write-Debug
...
Convert from JSON to ProjectApiKeyDeleteResponse<PSCustomObject>
...
ProjectApiKeyDeleteResponse<PSCustomObject>
#>
function ConvertFrom-JsonToProjectApiKeyDeleteResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectApiKeyDeleteResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectApiKeyDeleteResponse
