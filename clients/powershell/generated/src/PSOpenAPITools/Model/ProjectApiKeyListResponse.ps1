...
ProjectApiKeyListResponse<PSCustomObject>
#>

function Initialize-ProjectApiKeyListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectApiKeyListResponse' | Write-Debug
...
Convert from JSON to ProjectApiKeyListResponse<PSCustomObject>
...
ProjectApiKeyListResponse<PSCustomObject>
#>
function ConvertFrom-JsonToProjectApiKeyListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectApiKeyListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectApiKeyListResponse
