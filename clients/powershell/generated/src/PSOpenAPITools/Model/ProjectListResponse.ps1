...
ProjectListResponse<PSCustomObject>
#>

function Initialize-ProjectListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectListResponse' | Write-Debug
...
Convert from JSON to ProjectListResponse<PSCustomObject>
...
ProjectListResponse<PSCustomObject>
#>
function ConvertFrom-JsonToProjectListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectListResponse
