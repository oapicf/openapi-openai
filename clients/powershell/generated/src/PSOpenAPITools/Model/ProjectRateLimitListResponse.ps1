...
ProjectRateLimitListResponse<PSCustomObject>
#>

function Initialize-ProjectRateLimitListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectRateLimitListResponse' | Write-Debug
...
Convert from JSON to ProjectRateLimitListResponse<PSCustomObject>
...
ProjectRateLimitListResponse<PSCustomObject>
#>
function ConvertFrom-JsonToProjectRateLimitListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectRateLimitListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectRateLimitListResponse
