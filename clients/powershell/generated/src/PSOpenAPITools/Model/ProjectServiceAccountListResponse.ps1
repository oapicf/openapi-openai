...
ProjectServiceAccountListResponse<PSCustomObject>
#>

function Initialize-ProjectServiceAccountListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectServiceAccountListResponse' | Write-Debug
...
Convert from JSON to ProjectServiceAccountListResponse<PSCustomObject>
...
ProjectServiceAccountListResponse<PSCustomObject>
#>
function ConvertFrom-JsonToProjectServiceAccountListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectServiceAccountListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectServiceAccountListResponse
