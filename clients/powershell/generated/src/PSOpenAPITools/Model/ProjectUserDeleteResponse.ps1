...
ProjectUserDeleteResponse<PSCustomObject>
#>

function Initialize-ProjectUserDeleteResponse {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("organization.project.user.deleted")]
        [String]
        ${Object},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectUserDeleteResponse' | Write-Debug
...
Convert from JSON to ProjectUserDeleteResponse<PSCustomObject>
...
ProjectUserDeleteResponse<PSCustomObject>
#>
function ConvertFrom-JsonToProjectUserDeleteResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectUserDeleteResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectUserDeleteResponse
