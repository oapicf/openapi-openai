...
ProjectUserListResponse<PSCustomObject>
#>

function Initialize-ProjectUserListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProjectUserListResponse' | Write-Debug
...
Convert from JSON to ProjectUserListResponse<PSCustomObject>
...
ProjectUserListResponse<PSCustomObject>
#>
function ConvertFrom-JsonToProjectUserListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProjectUserListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProjectUserListResponse
