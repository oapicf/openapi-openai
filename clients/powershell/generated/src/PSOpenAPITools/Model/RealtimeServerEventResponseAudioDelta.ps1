...
RealtimeServerEventResponseAudioDelta<PSCustomObject>
#>

function Initialize-RealtimeServerEventResponseAudioDelta {
    [CmdletBinding()]
    Param (
        ...
        [ValidateSet("response.audio.delta")]
        [String]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RealtimeServerEventResponseAudioDelta' | Write-Debug
...
Convert from JSON to RealtimeServerEventResponseAudioDelta<PSCustomObject>
...
RealtimeServerEventResponseAudioDelta<PSCustomObject>
#>
function ConvertFrom-JsonToRealtimeServerEventResponseAudioDelta {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RealtimeServerEventResponseAudioDelta' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RealtimeServerEventResponseAudioDelta
