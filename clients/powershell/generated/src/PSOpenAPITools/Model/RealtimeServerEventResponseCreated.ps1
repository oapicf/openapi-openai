...
RealtimeServerEventResponseCreated<PSCustomObject>
#>

function Initialize-RealtimeServerEventResponseCreated {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RealtimeServerEventResponseCreated' | Write-Debug
...
Convert from JSON to RealtimeServerEventResponseCreated<PSCustomObject>
...
RealtimeServerEventResponseCreated<PSCustomObject>
#>
function ConvertFrom-JsonToRealtimeServerEventResponseCreated {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RealtimeServerEventResponseCreated' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RealtimeServerEventResponseCreated
