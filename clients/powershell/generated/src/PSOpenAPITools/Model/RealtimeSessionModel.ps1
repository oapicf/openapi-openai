...
RealtimeSessionModel<PSCustomObject>
#>
function ConvertFrom-JsonToRealtimeSessionModel {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        if ($match -ne 0) { # no match yet
            ...
            try {
                ...
                Write-Debug "Failed to match 'String' defined in anyOf (RealtimeSessionModel). Proceeding to the next one if any."
            }
        }
