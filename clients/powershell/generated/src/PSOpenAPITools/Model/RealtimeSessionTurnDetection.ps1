...
RealtimeSessionTurnDetection<PSCustomObject>
#>

function Initialize-RealtimeSessionTurnDetection {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("server_vad")]
        [String]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RealtimeSessionTurnDetection' | Write-Debug
...
Convert from JSON to RealtimeSessionTurnDetection<PSCustomObject>
...
RealtimeSessionTurnDetection<PSCustomObject>
#>
function ConvertFrom-JsonToRealtimeSessionTurnDetection {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RealtimeSessionTurnDetection' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RealtimeSessionTurnDetection
