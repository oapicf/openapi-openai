...
RunStepStreamEventOneOf<PSCustomObject>
#>

function Initialize-RunStepStreamEventOneOf {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.step.created")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf' | Write-Debug
...
Convert from JSON to RunStepStreamEventOneOf<PSCustomObject>
...
RunStepStreamEventOneOf<PSCustomObject>
#>
function ConvertFrom-JsonToRunStepStreamEventOneOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStepStreamEventOneOf
