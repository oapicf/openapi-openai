...
RunStepStreamEventOneOf3<PSCustomObject>
#>

function Initialize-RunStepStreamEventOneOf3 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.step.completed")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf3' | Write-Debug
...
Convert from JSON to RunStepStreamEventOneOf3<PSCustomObject>
...
RunStepStreamEventOneOf3<PSCustomObject>
#>
function ConvertFrom-JsonToRunStepStreamEventOneOf3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStepStreamEventOneOf3
