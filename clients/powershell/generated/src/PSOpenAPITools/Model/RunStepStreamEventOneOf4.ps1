...
RunStepStreamEventOneOf4<PSCustomObject>
#>

function Initialize-RunStepStreamEventOneOf4 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.step.failed")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf4' | Write-Debug
...
Convert from JSON to RunStepStreamEventOneOf4<PSCustomObject>
...
RunStepStreamEventOneOf4<PSCustomObject>
#>
function ConvertFrom-JsonToRunStepStreamEventOneOf4 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf4' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStepStreamEventOneOf4
