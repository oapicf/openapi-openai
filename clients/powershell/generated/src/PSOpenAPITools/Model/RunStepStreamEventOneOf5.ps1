...
RunStepStreamEventOneOf5<PSCustomObject>
#>

function Initialize-RunStepStreamEventOneOf5 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.step.cancelled")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf5' | Write-Debug
...
Convert from JSON to RunStepStreamEventOneOf5<PSCustomObject>
...
RunStepStreamEventOneOf5<PSCustomObject>
#>
function ConvertFrom-JsonToRunStepStreamEventOneOf5 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf5' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStepStreamEventOneOf5
