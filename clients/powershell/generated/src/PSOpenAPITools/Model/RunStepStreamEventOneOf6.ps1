...
RunStepStreamEventOneOf6<PSCustomObject>
#>

function Initialize-RunStepStreamEventOneOf6 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.step.expired")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf6' | Write-Debug
...
Convert from JSON to RunStepStreamEventOneOf6<PSCustomObject>
...
RunStepStreamEventOneOf6<PSCustomObject>
#>
function ConvertFrom-JsonToRunStepStreamEventOneOf6 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStepStreamEventOneOf6' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStepStreamEventOneOf6
