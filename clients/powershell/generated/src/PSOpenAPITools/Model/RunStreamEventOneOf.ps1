...
RunStreamEventOneOf<PSCustomObject>
#>

function Initialize-RunStreamEventOneOf {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.created")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStreamEventOneOf' | Write-Debug
...
Convert from JSON to RunStreamEventOneOf<PSCustomObject>
...
RunStreamEventOneOf<PSCustomObject>
#>
function ConvertFrom-JsonToRunStreamEventOneOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStreamEventOneOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStreamEventOneOf
