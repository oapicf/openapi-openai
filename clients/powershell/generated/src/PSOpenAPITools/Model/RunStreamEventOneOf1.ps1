...
RunStreamEventOneOf1<PSCustomObject>
#>

function Initialize-RunStreamEventOneOf1 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.queued")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStreamEventOneOf1' | Write-Debug
...
Convert from JSON to RunStreamEventOneOf1<PSCustomObject>
...
RunStreamEventOneOf1<PSCustomObject>
#>
function ConvertFrom-JsonToRunStreamEventOneOf1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStreamEventOneOf1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStreamEventOneOf1
