...
RunStreamEventOneOf2<PSCustomObject>
#>

function Initialize-RunStreamEventOneOf2 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.in_progress")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStreamEventOneOf2' | Write-Debug
...
Convert from JSON to RunStreamEventOneOf2<PSCustomObject>
...
RunStreamEventOneOf2<PSCustomObject>
#>
function ConvertFrom-JsonToRunStreamEventOneOf2 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStreamEventOneOf2' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStreamEventOneOf2
