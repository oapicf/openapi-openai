...
RunStreamEventOneOf3<PSCustomObject>
#>

function Initialize-RunStreamEventOneOf3 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.requires_action")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStreamEventOneOf3' | Write-Debug
...
Convert from JSON to RunStreamEventOneOf3<PSCustomObject>
...
RunStreamEventOneOf3<PSCustomObject>
#>
function ConvertFrom-JsonToRunStreamEventOneOf3 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStreamEventOneOf3' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStreamEventOneOf3
