...
RunStreamEventOneOf5<PSCustomObject>
#>

function Initialize-RunStreamEventOneOf5 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.incomplete")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStreamEventOneOf5' | Write-Debug
...
Convert from JSON to RunStreamEventOneOf5<PSCustomObject>
...
RunStreamEventOneOf5<PSCustomObject>
#>
function ConvertFrom-JsonToRunStreamEventOneOf5 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStreamEventOneOf5' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStreamEventOneOf5
