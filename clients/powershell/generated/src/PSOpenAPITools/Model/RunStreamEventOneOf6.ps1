...
RunStreamEventOneOf6<PSCustomObject>
#>

function Initialize-RunStreamEventOneOf6 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.cancelling")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStreamEventOneOf6' | Write-Debug
...
Convert from JSON to RunStreamEventOneOf6<PSCustomObject>
...
RunStreamEventOneOf6<PSCustomObject>
#>
function ConvertFrom-JsonToRunStreamEventOneOf6 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStreamEventOneOf6' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStreamEventOneOf6
