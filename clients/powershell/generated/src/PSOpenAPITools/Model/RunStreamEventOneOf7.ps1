...
RunStreamEventOneOf7<PSCustomObject>
#>

function Initialize-RunStreamEventOneOf7 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStreamEventOneOf7' | Write-Debug
...
Convert from JSON to RunStreamEventOneOf7<PSCustomObject>
...
RunStreamEventOneOf7<PSCustomObject>
#>
function ConvertFrom-JsonToRunStreamEventOneOf7 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStreamEventOneOf7' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStreamEventOneOf7
