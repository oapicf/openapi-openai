...
RunStreamEventOneOf9<PSCustomObject>
#>

function Initialize-RunStreamEventOneOf9 {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("thread.run.expired")]
        [String]
        ${VarEvent},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => RunStreamEventOneOf9' | Write-Debug
...
Convert from JSON to RunStreamEventOneOf9<PSCustomObject>
...
RunStreamEventOneOf9<PSCustomObject>
#>
function ConvertFrom-JsonToRunStreamEventOneOf9 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => RunStreamEventOneOf9' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in RunStreamEventOneOf9
