...
ThreadStreamEventOneOf<PSCustomObject>
#>

function Initialize-ThreadStreamEventOneOf {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ThreadStreamEventOneOf' | Write-Debug
...
Convert from JSON to ThreadStreamEventOneOf<PSCustomObject>
...
ThreadStreamEventOneOf<PSCustomObject>
#>
function ConvertFrom-JsonToThreadStreamEventOneOf {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ThreadStreamEventOneOf' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ThreadStreamEventOneOf
