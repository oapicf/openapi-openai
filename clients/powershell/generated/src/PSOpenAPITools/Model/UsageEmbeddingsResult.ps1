...
UsageEmbeddingsResult<PSCustomObject>
#>

function Initialize-UsageEmbeddingsResult {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("organization.usage.embeddings.result")]
        [String]
        ${Object},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UsageEmbeddingsResult' | Write-Debug
...
Convert from JSON to UsageEmbeddingsResult<PSCustomObject>
...
UsageEmbeddingsResult<PSCustomObject>
#>
function ConvertFrom-JsonToUsageEmbeddingsResult {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UsageEmbeddingsResult' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UsageEmbeddingsResult
