...
UserDeleteResponse<PSCustomObject>
#>

function Initialize-UserDeleteResponse {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("organization.user.deleted")]
        [String]
        ${Object},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserDeleteResponse' | Write-Debug
...
Convert from JSON to UserDeleteResponse<PSCustomObject>
...
UserDeleteResponse<PSCustomObject>
#>
function ConvertFrom-JsonToUserDeleteResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserDeleteResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserDeleteResponse
