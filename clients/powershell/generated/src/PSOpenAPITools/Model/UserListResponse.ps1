...
UserListResponse<PSCustomObject>
#>

function Initialize-UserListResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserListResponse' | Write-Debug
...
Convert from JSON to UserListResponse<PSCustomObject>
...
UserListResponse<PSCustomObject>
#>
function ConvertFrom-JsonToUserListResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserListResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserListResponse
