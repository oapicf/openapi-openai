...
async def list_audit_logs(request: web.Request, effective_at=None, project_ids=None, event_types=None, actor_ids=None, actor_emails=None, resource_ids=None, limit=None, after=None, before=None) -> web.Response:
    ...
    """
    effective_at = .from_dict(effective_at)
    event_types = [AuditLogEventType.from_dict(d) for d in event_types]
