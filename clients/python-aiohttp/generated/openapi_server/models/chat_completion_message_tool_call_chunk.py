...
class ChatCompletionMessageToolCallChunk(Model):
    ...
    def __init__(self, index: int=None, id: str=None, type: str=None, function: ChatCompletionMessageToolCallChunkFunction=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ChatCompletionMessageToolCallChunk':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ChatCompletionMessageToolCallChunk of this ChatCompletionMessageToolCallChunk.
        """
