...
class ChatCompletionTokenLogprob(Model):
    ...
    def __init__(self, token: str=None, logprob: float=None, bytes: List[int]=None, top_logprobs: List[ChatCompletionTokenLogprobTopLogprobsInner]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ChatCompletionTokenLogprob':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ChatCompletionTokenLogprob of this ChatCompletionTokenLogprob.
        """
    ...
    def top_logprobs(self, top_logprobs):
        ...
        if top_logprobs is None:
            raise ValueError("Invalid value for `top_logprobs`, must not be `None`")
