...
class CreateEditResponse(Model):
    ...
    def __init__(self, object: str=None, created: int=None, choices: List[CreateEditResponseChoicesInner]=None, usage: CreateCompletionResponseUsage=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateEditResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateEditResponse of this CreateEditResponse.
        """
