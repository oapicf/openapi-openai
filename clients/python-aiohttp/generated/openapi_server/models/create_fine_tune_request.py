...
class CreateFineTuneRequest(Model):
    ...
    def __init__(self, training_file: str=None, validation_file: str=None, model: CreateFineTuneRequestModel=None, n_epochs: int=4, batch_size: int=None, learning_rate_multiplier: float=None, prompt_loss_weight: float=0.01, compute_classification_metrics: bool=False, classification_n_classes: int=None, classification_positive_class: str=None, classification_betas: List[float]=None, suffix: str=None):
        """CreateFineTuneRequest - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'CreateFineTuneRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The CreateFineTuneRequest of this CreateFineTuneRequest.
        """
    ...
    def prompt_loss_weight(self, prompt_loss_weight):
    ...
    def compute_classification_metrics(self, compute_classification_metrics):
    ...
    @property
    def classification_n_classes(self):
    ...
    def classification_n_classes(self, classification_n_classes):
    ...
    @property
    def classification_positive_class(self):
    ...
    def classification_positive_class(self, classification_positive_class):
    ...
    def classification_betas(self, classification_betas):
