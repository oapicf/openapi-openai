...
class FineTune(Model):
    ...
    def __init__(self, id: str=None, object: str=None, created_at: int=None, updated_at: int=None, model: str=None, fine_tuned_model: str=None, organization_id: str=None, status: str=None, hyperparams: object=None, training_files: List[OpenAIFile]=None, validation_files: List[OpenAIFile]=None, result_files: List[OpenAIFile]=None, events: List[FineTuneEvent]=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FineTune':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FineTune of this FineTune.
        """
    ...
    def hyperparams(self, hyperparams):
        ...
        if hyperparams is None:
            raise ValueError("Invalid value for `hyperparams`, must not be `None`")
    ...
    def training_files(self, training_files):
        ...
        if training_files is None:
            raise ValueError("Invalid value for `training_files`, must not be `None`")
    ...
    def validation_files(self, validation_files):
        ...
        if validation_files is None:
            raise ValueError("Invalid value for `validation_files`, must not be `None`")
