...
class FineTuningJob(Model):
    ...
    def __init__(self, id: str=None, created_at: int=None, error: FineTuningJobError=None, fine_tuned_model: str=None, finished_at: int=None, hyperparameters: FineTuningJobHyperparameters=None, model: str=None, object: str=None, organization_id: str=None, result_files: List[str]=None, status: str=None, trained_tokens: int=None, training_file: str=None, validation_file: str=None, integrations: List[FineTuningJobIntegrationsInner]=None, seed: int=None, estimated_finish: int=None, method: FineTuneMethod=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'FineTuningJob':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The FineTuningJob of this FineTuningJob.
        """
    ...
    def fine_tuned_model(self, fine_tuned_model):
        ...
        if fine_tuned_model is None:
            raise ValueError("Invalid value for `fine_tuned_model`, must not be `None`")
    ...
    def hyperparameters(self, hyperparameters):
        ...
        if hyperparameters is None:
            raise ValueError("Invalid value for `hyperparameters`, must not be `None`")
    ...
    def result_files(self, result_files):
        ...
        if result_files is None:
            raise ValueError("Invalid value for `result_files`, must not be `None`")
    ...
    def trained_tokens(self, trained_tokens):
        ...
        if trained_tokens is None:
            raise ValueError("Invalid value for `trained_tokens`, must not be `None`")
    ...
    def validation_file(self, validation_file):
        ...
        if validation_file is None:
            raise ValueError("Invalid value for `validation_file`, must not be `None`")
    ...
    def integrations(self, integrations):
        ...
        if integrations is not None and len(integrations) > 5:
            raise ValueError("Invalid value for `integrations`, number of items must be less than or equal to `5`")
