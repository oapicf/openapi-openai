...
class ListAssistantFilesResponse(Model):
    ...
    def __init__(self, object: str=None, data: List[AssistantFileObject]=None, first_id: str=None, last_id: str=None, has_more: bool=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'ListAssistantFilesResponse':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The ListAssistantFilesResponse of this ListAssistantFilesResponse.
        """
