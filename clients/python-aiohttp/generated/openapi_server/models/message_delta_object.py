...
class MessageDeltaObject(Model):
    ...
    def __init__(self, id: str=None, object: str=None, delta: MessageDeltaObjectDelta=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'MessageDeltaObject':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The MessageDeltaObject of this MessageDeltaObject.
        """
