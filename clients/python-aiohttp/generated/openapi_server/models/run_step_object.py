...
class RunStepObject(Model):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'RunStepObject':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The RunStepObject of this RunStepObject.
        """
    ...
    def step_details(self, step_details):
        ...
        if step_details is None:
            raise ValueError("Invalid value for `step_details`, must not be `None`")
