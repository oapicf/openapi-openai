...
class StaticChunkingStrategyStatic(Model):
    ...
    def __init__(self, max_chunk_size_tokens: int=None, chunk_overlap_tokens: int=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'StaticChunkingStrategyStatic':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Static_Chunking_Strategy_static of this StaticChunkingStrategyStatic.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def max_chunk_size_tokens(self):
    ...
    def max_chunk_size_tokens(self, max_chunk_size_tokens):
        ...
        if max_chunk_size_tokens is None:
            raise ValueError("Invalid value for `max_chunk_size_tokens`, must not be `None`")
        if max_chunk_size_tokens is not None and max_chunk_size_tokens > 4096:
            raise ValueError("Invalid value for `max_chunk_size_tokens`, must be a value less than or equal to `4096`")
        if max_chunk_size_tokens is not None and max_chunk_size_tokens < 100:
            raise ValueError("Invalid value for `max_chunk_size_tokens`, must be a value greater than or equal to `100`")

        self._max_chunk_size_tokens = max_chunk_size_tokens

    @property
    def chunk_overlap_tokens(self):
    ...
    def chunk_overlap_tokens(self, chunk_overlap_tokens):
        ...
        if chunk_overlap_tokens is None:
            raise ValueError("Invalid value for `chunk_overlap_tokens`, must not be `None`")
