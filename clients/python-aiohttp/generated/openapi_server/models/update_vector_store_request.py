...
class UpdateVectorStoreRequest(Model):
    ...
    def __init__(self, name: str=None, expires_after: VectorStoreExpirationAfter=None, metadata: object=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'UpdateVectorStoreRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The UpdateVectorStoreRequest of this UpdateVectorStoreRequest.
        """
