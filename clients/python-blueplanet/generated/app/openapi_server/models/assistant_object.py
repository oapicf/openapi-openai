...
from app.openapi_server.models.assistant_object_tool_resources import AssistantObjectToolResources  # noqa: F401,E501
...
class AssistantObject(Model):
    ...
    def __init__(self, id: str=None, object: str=None, created_at: int=None, name: str=None, description: str=None, model: str=None, instructions: str=None, tools: List[AssistantObjectToolsInner]=[], tool_resources: AssistantObjectToolResources=None, metadata: object=None, temperature: float=1, top_p: float=1, response_format: AssistantsApiResponseFormatOption=None):  # noqa: E501
        """AssistantObject - a model defined in Swagger
    ...
    def model(self) -> str:
        ...
        ID of the model to use. You can use the [List models](/docs/api-reference/models/list) API to see all of your available models, or see our [Model overview](/docs/models) for descriptions of them.   # noqa: E501
