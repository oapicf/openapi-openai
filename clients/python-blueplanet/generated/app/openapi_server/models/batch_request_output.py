...
from app.openapi_server.models.batch_request_output_error import BatchRequestOutputError  # noqa: F401,E501
from app.openapi_server.models.batch_request_output_response import BatchRequestOutputResponse  # noqa: F401,E501
...
class BatchRequestOutput(Model):
    ...
    def __init__(self, id: str=None, custom_id: str=None, response: BatchRequestOutputResponse=None, error: BatchRequestOutputError=None):  # noqa: E501
        """BatchRequestOutput - a model defined in Swagger
