...
class ChatCompletionRequestMessageContentPart(Model):
    ...
    def __init__(self, type: str=None, text: str=None, image_url: ChatCompletionRequestMessageContentPartImageImageUrl=None):  # noqa: E501
        """ChatCompletionRequestMessageContentPart - a model defined in Swagger
