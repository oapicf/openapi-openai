...
class ChatCompletionRequestMessageFunctionCall(Model):
    ...
    def __init__(self, name: str=None, arguments: str=None):  # noqa: E501
        """ChatCompletionRequestMessageFunctionCall - a model defined in Swagger

        :param name: The name of this ChatCompletionRequestMessageFunctionCall.  # noqa: E501
        :type name: str
        :param arguments: The arguments of this ChatCompletionRequestMessageFunctionCall.  # noqa: E501
        :type arguments: str
        """
        self.swagger_types = {
            'name': str,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ChatCompletionRequestMessageFunctionCall':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The ChatCompletionRequestMessage_function_call of this ChatCompletionRequestMessageFunctionCall.  # noqa: E501
