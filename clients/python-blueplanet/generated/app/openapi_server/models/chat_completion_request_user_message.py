...
from app.openapi_server.models.chat_completion_request_user_message_content import ChatCompletionRequestUserMessageContent  # noqa: F401,E501
...
class ChatCompletionRequestUserMessage(Model):
    ...
    def __init__(self, content: ChatCompletionRequestUserMessageContent=None, role: str=None, name: str=None):  # noqa: E501
        """ChatCompletionRequestUserMessage - a model defined in Swagger
