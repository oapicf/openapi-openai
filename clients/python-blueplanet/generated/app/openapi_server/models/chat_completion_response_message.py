...
from app.openapi_server.models.chat_completion_response_message_audio import ChatCompletionResponseMessageAudio  # noqa: F401,E501
from app.openapi_server.models.chat_completion_response_message_function_call import ChatCompletionResponseMessageFunctionCall  # noqa: F401,E501
...
class ChatCompletionResponseMessage(Model):
    ...
    def __init__(self, content: str=None, refusal: str=None, tool_calls: List[ChatCompletionMessageToolCall]=None, role: str=None, function_call: ChatCompletionResponseMessageFunctionCall=None, audio: ChatCompletionResponseMessageAudio=None):  # noqa: E501
        """ChatCompletionResponseMessage - a model defined in Swagger
