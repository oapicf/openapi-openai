...
class ChatCompletionResponseMessage(Model):
    ...
    def __init__(self, content: str=None, tool_calls: List[ChatCompletionMessageToolCall]=None, role: str=None, function_call: ChatCompletionRequestAssistantMessageFunctionCall=None):  # noqa: E501
