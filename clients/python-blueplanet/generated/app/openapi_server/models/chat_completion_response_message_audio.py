...
class ChatCompletionResponseMessageAudio(Model):
    ...
    def __init__(self, id: str=None, expires_at: int=None, data: str=None, transcript: str=None):  # noqa: E501
        """ChatCompletionResponseMessageAudio - a model defined in Swagger
