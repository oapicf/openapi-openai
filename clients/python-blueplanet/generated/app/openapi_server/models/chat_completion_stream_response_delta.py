...
class ChatCompletionStreamResponseDelta(Model):
    ...
    def __init__(self, content: str=None, function_call: ChatCompletionStreamResponseDeltaFunctionCall=None, tool_calls: List[ChatCompletionMessageToolCallChunk]=None, role: str=None, refusal: str=None):  # noqa: E501
