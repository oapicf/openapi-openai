...
class ChatCompletionTokenLogprobTopLogprobsInner(Model):
    ...
    def __init__(self, token: str=None, logprob: float=None, bytes: List[int]=None):  # noqa: E501
        """ChatCompletionTokenLogprobTopLogprobsInner - a model defined in Swagger
