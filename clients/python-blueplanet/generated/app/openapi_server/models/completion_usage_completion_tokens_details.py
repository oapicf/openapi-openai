...
class CompletionUsageCompletionTokensDetails(Model):
    ...
    def __init__(self, accepted_prediction_tokens: int=None, audio_tokens: int=None, reasoning_tokens: int=None, rejected_prediction_tokens: int=None):  # noqa: E501
        """CompletionUsageCompletionTokensDetails - a model defined in Swagger
