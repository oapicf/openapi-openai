...
from app.openapi_server.models.create_assistant_request_tool_resources_file_search_vector_stores_inner import CreateAssistantRequestToolResourcesFileSearchVectorStoresInner  # noqa: F401,E501
...
class CreateAssistantRequestToolResourcesFileSearch(Model):
    ...
    def __init__(self, vector_store_ids: List[str]=None, vector_stores: List[CreateAssistantRequestToolResourcesFileSearchVectorStoresInner]=None):  # noqa: E501
        """CreateAssistantRequestToolResourcesFileSearch - a model defined in Swagger
