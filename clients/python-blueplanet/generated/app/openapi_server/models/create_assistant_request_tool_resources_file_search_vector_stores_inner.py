...
from app.openapi_server.models.create_assistant_request_tool_resources_file_search_vector_stores_inner_chunking_strategy import CreateAssistantRequestToolResourcesFileSearchVectorStoresInnerChunkingStrategy  # noqa: F401,E501
...
class CreateAssistantRequestToolResourcesFileSearchVectorStoresInner(Model):
    ...
    def __init__(self, file_ids: List[str]=None, chunking_strategy: CreateAssistantRequestToolResourcesFileSearchVectorStoresInnerChunkingStrategy=None, metadata: object=None):  # noqa: E501
        """CreateAssistantRequestToolResourcesFileSearchVectorStoresInner - a model defined in Swagger
    ...
    def metadata(self) -> object:
        ...
        Set of 16 key-value pairs that can be attached to a vector store. This can be useful for storing additional information about the vector store in a structured format. Keys can be a maximum of 64 characters long and values can be a maximum of 512 characters long.   # noqa: E501
