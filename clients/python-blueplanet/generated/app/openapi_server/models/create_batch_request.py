...
class CreateBatchRequest(Model):
    ...
    def __init__(self, input_file_id: str=None, endpoint: str=None, completion_window: str=None, metadata: Dict[str, str]=None):  # noqa: E501
        """CreateBatchRequest - a model defined in Swagger
