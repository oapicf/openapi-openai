...
class CreateChatCompletionStreamResponse(Model):
    ...
    def __init__(self, id: str=None, object: str=None, created: int=None, model: str=None, choices: List[CreateChatCompletionStreamResponseChoicesInner]=None):  # noqa: E501
