...
class CreateCompletionRequest(Model):
    ...
    def __init__(self, model: CreateCompletionRequestModel=None, prompt: CreateCompletionRequestPrompt=None, suffix: str=None, max_tokens: int=16, temperature: float=1, top_p: float=1, n: int=1, stream: bool=False, logprobs: int=None, echo: bool=False, stop: CreateCompletionRequestStop=None, presence_penalty: float=0, frequency_penalty: float=0, best_of: int=1, logit_bias: object=None, user: str=None):  # noqa: E501
