...
class CreateCompletionResponseChoicesInnerLogprobs(Model):
    ...
    def __init__(self, text_offset: List[int]=None, token_logprobs: List[float]=None, tokens: List[str]=None, top_logprobs: List[Dict[str, float]]=None):  # noqa: E501
        """CreateCompletionResponseChoicesInnerLogprobs - a model defined in Swagger
