...
from app.openapi_server.models.create_edit_request_model import CreateEditRequestModel  # noqa: F401,E501
...
class CreateEditRequest(Model):
    ...
    def __init__(self, model: CreateEditRequestModel=None, input: str='', instruction: str=None, n: int=1, temperature: float=1, top_p: float=1):  # noqa: E501
        """CreateEditRequest - a model defined in Swagger

        :param model: The model of this CreateEditRequest.  # noqa: E501
        :type model: CreateEditRequestModel
        :param input: The input of this CreateEditRequest.  # noqa: E501
        :type input: str
        :param instruction: The instruction of this CreateEditRequest.  # noqa: E501
        :type instruction: str
        :param n: The n of this CreateEditRequest.  # noqa: E501
        :type n: int
        :param temperature: The temperature of this CreateEditRequest.  # noqa: E501
        :type temperature: float
        :param top_p: The top_p of this CreateEditRequest.  # noqa: E501
        :type top_p: float
        """
        self.swagger_types = {
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CreateEditRequest':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CreateEditRequest of this CreateEditRequest.  # noqa: E501
        :rtype: CreateEditRequest
        """
        return util.deserialize_model(dikt, cls)

    @property
    def model(self) -> CreateEditRequestModel:
    ...
    @model.setter
    def model(self, model: CreateEditRequestModel):
    ...
    def input(self) -> str:
        ...
        The input text to use as a starting point for the edit.  # noqa: E501
    ...
    def instruction(self) -> str:
        ...
        The instruction that tells the model how to edit the prompt.  # noqa: E501
    ...
    def n(self) -> int:
        ...
        How many edits to generate for the input and instruction.  # noqa: E501
    ...
    def n(self, n: int):
        ...
        :type n: int
        """
        if n is not None and n > 20:  # noqa: E501
            raise ValueError("Invalid value for `n`, must be a value less than or equal to `20`")  # noqa: E501
