...
from app.openapi_server.models.create_edit_response_choices_inner import CreateEditResponseChoicesInner  # noqa: F401,E501
...
class CreateEditResponse(Model):
    ...
    def __init__(self, object: str=None, created: int=None, choices: List[CreateEditResponseChoicesInner]=None, usage: CreateCompletionResponseUsage=None):  # noqa: E501
        """CreateEditResponse - a model defined in Swagger
