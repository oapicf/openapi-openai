...
class CreateEmbeddingRequest(Model):
    ...
    def __init__(self, input: CreateEmbeddingRequestInput=None, model: CreateEmbeddingRequestModel=None, encoding_format: str='float', dimensions: int=None, user: str=None):  # noqa: E501
