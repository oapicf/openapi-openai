...
from app.openapi_server.models.create_image_request_model import CreateImageRequestModel  # noqa: F401,E501
...
class CreateImageRequest(Model):
    ...
    def __init__(self, prompt: str=None, model: CreateImageRequestModel=None, n: int=1, quality: str='standard', response_format: str='url', size: str='1024x1024', style: str='vivid', user: str=None):  # noqa: E501
        """CreateImageRequest - a model defined in Swagger
