...
from app.openapi_server.models.create_message_request_content import CreateMessageRequestContent  # noqa: F401,E501
...
class CreateMessageRequest(Model):
    ...
    def __init__(self, role: str=None, content: CreateMessageRequestContent=None, attachments: List[CreateMessageRequestAttachmentsInner]=None, metadata: object=None):  # noqa: E501
