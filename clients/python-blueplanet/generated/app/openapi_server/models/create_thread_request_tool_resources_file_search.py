...
from app.openapi_server.models.create_thread_request_tool_resources_file_search_vector_stores_inner import CreateThreadRequestToolResourcesFileSearchVectorStoresInner  # noqa: F401,E501
...
class CreateThreadRequestToolResourcesFileSearch(Model):
    ...
    def __init__(self, vector_store_ids: List[str]=None, vector_stores: List[CreateThreadRequestToolResourcesFileSearchVectorStoresInner]=None):  # noqa: E501
        """CreateThreadRequestToolResourcesFileSearch - a model defined in Swagger
