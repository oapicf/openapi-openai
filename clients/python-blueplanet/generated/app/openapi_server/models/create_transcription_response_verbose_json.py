...
class CreateTranscriptionResponseVerboseJson(Model):
    ...
    def __init__(self, language: str=None, duration: str=None, text: str=None, words: List[TranscriptionWord]=None, segments: List[TranscriptionSegment]=None):  # noqa: E501
        """CreateTranscriptionResponseVerboseJson - a model defined in Swagger
