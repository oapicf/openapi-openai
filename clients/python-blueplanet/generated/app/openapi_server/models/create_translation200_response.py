...
from app.openapi_server.models.create_translation_response_json import CreateTranslationResponseJson  # noqa: F401,E501
from app.openapi_server.models.create_translation_response_verbose_json import CreateTranslationResponseVerboseJson  # noqa: F401,E501
...
class CreateTranslation200Response(Model):
    ...
    def __init__(self, text: str=None, language: str=None, duration: str=None, segments: List[TranscriptionSegment]=None):  # noqa: E501
        """CreateTranslation200Response - a model defined in Swagger
