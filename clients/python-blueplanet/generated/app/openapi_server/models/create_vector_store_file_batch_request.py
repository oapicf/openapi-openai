...
class CreateVectorStoreFileBatchRequest(Model):
    ...
    def __init__(self, file_ids: List[str]=None, chunking_strategy: ChunkingStrategyRequestParam=None):  # noqa: E501
        """CreateVectorStoreFileBatchRequest - a model defined in Swagger
