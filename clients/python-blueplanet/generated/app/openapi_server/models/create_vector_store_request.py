...
from app.openapi_server.models.create_vector_store_request_chunking_strategy import CreateVectorStoreRequestChunkingStrategy  # noqa: F401,E501
...
class CreateVectorStoreRequest(Model):
    ...
    def __init__(self, file_ids: List[str]=None, name: str=None, expires_after: VectorStoreExpirationAfter=None, chunking_strategy: CreateVectorStoreRequestChunkingStrategy=None, metadata: object=None):  # noqa: E501
        """CreateVectorStoreRequest - a model defined in Swagger
