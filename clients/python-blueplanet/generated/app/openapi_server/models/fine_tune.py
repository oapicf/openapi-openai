...
class FineTune(Model):
    ...
    def __init__(self, id: str=None, object: str=None, created_at: int=None, updated_at: int=None, model: str=None, fine_tuned_model: str=None, organization_id: str=None, status: str=None, hyperparams: object=None, training_files: List[OpenAIFile]=None, validation_files: List[OpenAIFile]=None, result_files: List[OpenAIFile]=None, events: List[FineTuneEvent]=None):  # noqa: E501
        """FineTune - a model defined in Swagger
