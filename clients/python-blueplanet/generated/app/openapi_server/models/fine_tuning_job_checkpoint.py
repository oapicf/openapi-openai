...
from app.openapi_server.models.fine_tuning_job_checkpoint_metrics import FineTuningJobCheckpointMetrics  # noqa: F401,E501
...
class FineTuningJobCheckpoint(Model):
    ...
    def __init__(self, id: str=None, created_at: int=None, fine_tuned_model_checkpoint: str=None, step_number: int=None, metrics: FineTuningJobCheckpointMetrics=None, fine_tuning_job_id: str=None, object: str=None):  # noqa: E501
        """FineTuningJobCheckpoint - a model defined in Swagger
