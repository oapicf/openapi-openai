...
class FineTuningJobCheckpointMetrics(Model):
    ...
    def __init__(self, step: float=None, train_loss: float=None, train_mean_token_accuracy: float=None, valid_loss: float=None, valid_mean_token_accuracy: float=None, full_valid_loss: float=None, full_valid_mean_token_accuracy: float=None):  # noqa: E501
        """FineTuningJobCheckpointMetrics - a model defined in Swagger
