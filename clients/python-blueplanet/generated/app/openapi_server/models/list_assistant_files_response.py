...
from app.openapi_server.models.assistant_file_object import AssistantFileObject  # noqa: F401,E501
...
class ListAssistantFilesResponse(Model):
    ...
    def __init__(self, object: str=None, data: List[AssistantFileObject]=None, first_id: str=None, last_id: str=None, has_more: bool=None):  # noqa: E501
        """ListAssistantFilesResponse - a model defined in Swagger
