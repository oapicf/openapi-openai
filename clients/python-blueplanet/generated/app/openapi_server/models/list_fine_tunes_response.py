...
from app.openapi_server.models.fine_tune import FineTune  # noqa: F401,E501
...
class ListFineTunesResponse(Model):
    ...
    def __init__(self, object: str=None, data: List[FineTune]=None):  # noqa: E501
        """ListFineTunesResponse - a model defined in Swagger
