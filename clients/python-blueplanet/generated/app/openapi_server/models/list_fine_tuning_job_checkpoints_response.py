...
from app.openapi_server.models.fine_tuning_job_checkpoint import FineTuningJobCheckpoint  # noqa: F401,E501
...
class ListFineTuningJobCheckpointsResponse(Model):
    ...
    def __init__(self, data: List[FineTuningJobCheckpoint]=None, object: str=None, first_id: str=None, last_id: str=None, has_more: bool=None):  # noqa: E501
        """ListFineTuningJobCheckpointsResponse - a model defined in Swagger
