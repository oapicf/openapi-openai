...
class ListRunStepsResponse(Model):
    ...
    def __init__(self, object: str=None, data: List[RunStepObject]=None, first_id: str=None, last_id: str=None, has_more: bool=None):  # noqa: E501
        """ListRunStepsResponse - a model defined in Swagger
