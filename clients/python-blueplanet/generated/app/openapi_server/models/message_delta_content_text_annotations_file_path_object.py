...
class MessageDeltaContentTextAnnotationsFilePathObject(Model):
    ...
    def __init__(self, index: int=None, type: str=None, text: str=None, file_path: MessageDeltaContentTextAnnotationsFilePathObjectFilePath=None, start_index: int=None, end_index: int=None):  # noqa: E501
        """MessageDeltaContentTextAnnotationsFilePathObject - a model defined in Swagger
