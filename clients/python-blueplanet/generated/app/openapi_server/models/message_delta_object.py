...
from app.openapi_server.models.message_delta_object_delta import MessageDeltaObjectDelta  # noqa: F401,E501
...
class MessageDeltaObject(Model):
    ...
    def __init__(self, id: str=None, object: str=None, delta: MessageDeltaObjectDelta=None):  # noqa: E501
        """MessageDeltaObject - a model defined in Swagger
