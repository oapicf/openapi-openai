...
class RunStepDeltaStepDetailsToolCallsCodeObject(Model):
    ...
    def __init__(self, index: int=None, id: str=None, type: str=None, code_interpreter: RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter=None):  # noqa: E501
        """RunStepDeltaStepDetailsToolCallsCodeObject - a model defined in Swagger
