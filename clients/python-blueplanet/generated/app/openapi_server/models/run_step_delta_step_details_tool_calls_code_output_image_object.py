...
class RunStepDeltaStepDetailsToolCallsCodeOutputImageObject(Model):
    ...
    def __init__(self, index: int=None, type: str=None, image: RunStepDeltaStepDetailsToolCallsCodeOutputImageObjectImage=None):  # noqa: E501
        """RunStepDeltaStepDetailsToolCallsCodeOutputImageObject - a model defined in Swagger
