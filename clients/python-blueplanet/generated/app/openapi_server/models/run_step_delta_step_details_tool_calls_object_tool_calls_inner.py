...
from app.openapi_server.models.run_step_delta_step_details_tool_calls_file_search_object import RunStepDeltaStepDetailsToolCallsFileSearchObject  # noqa: F401,E501
...
class RunStepDeltaStepDetailsToolCallsObjectToolCallsInner(Model):
    ...
    def __init__(self, index: int=None, id: str=None, type: str=None, code_interpreter: RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter=None, file_search: object=None, function: RunStepDeltaStepDetailsToolCallsFunctionObjectFunction=None):  # noqa: E501
