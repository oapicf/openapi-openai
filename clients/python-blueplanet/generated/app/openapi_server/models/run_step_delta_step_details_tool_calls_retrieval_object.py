...
class RunStepDeltaStepDetailsToolCallsRetrievalObject(Model):
    ...
    def __init__(self, index: int=None, id: str=None, type: str=None, retrieval: object=None):  # noqa: E501
        """RunStepDeltaStepDetailsToolCallsRetrievalObject - a model defined in Swagger
