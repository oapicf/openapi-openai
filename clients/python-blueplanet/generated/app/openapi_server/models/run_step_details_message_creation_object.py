...
class RunStepDetailsMessageCreationObject(Model):
    ...
    def __init__(self, type: str=None, message_creation: RunStepDetailsMessageCreationObjectMessageCreation=None):  # noqa: E501
        """RunStepDetailsMessageCreationObject - a model defined in Swagger
