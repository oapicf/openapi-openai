...
class RunStepDetailsToolCallsObject(Model):
    ...
    def __init__(self, type: str=None, tool_calls: List[RunStepDetailsToolCallsObjectToolCallsInner]=None):  # noqa: E501
        """RunStepDetailsToolCallsObject - a model defined in Swagger
