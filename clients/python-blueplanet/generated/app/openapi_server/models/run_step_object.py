...
from app.openapi_server.models.run_step_completion_usage import RunStepCompletionUsage  # noqa: F401,E501
from app.openapi_server.models.run_step_object_last_error import RunStepObjectLastError  # noqa: F401,E501
from app.openapi_server.models.run_step_object_step_details import RunStepObjectStepDetails  # noqa: F401,E501
...
class RunStepObject(Model):
    ...
    def __init__(self, id: str=None, object: str=None, created_at: int=None, assistant_id: str=None, thread_id: str=None, run_id: str=None, type: str=None, status: str=None, step_details: RunStepObjectStepDetails=None, last_error: RunStepObjectLastError=None, expired_at: int=None, cancelled_at: int=None, failed_at: int=None, completed_at: int=None, metadata: object=None, usage: RunStepCompletionUsage=None):  # noqa: E501
        """RunStepObject - a model defined in Swagger
