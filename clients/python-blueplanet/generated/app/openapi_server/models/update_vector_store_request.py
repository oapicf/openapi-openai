...
class UpdateVectorStoreRequest(Model):
    ...
    def __init__(self, name: str=None, expires_after: VectorStoreExpirationAfter=None, metadata: object=None):  # noqa: E501
        """UpdateVectorStoreRequest - a model defined in Swagger
