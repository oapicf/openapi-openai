...
from app.openapi_server.models.vector_store_file_batch_object_file_counts import VectorStoreFileBatchObjectFileCounts  # noqa: F401,E501
...
class VectorStoreFileBatchObject(Model):
    ...
    def __init__(self, id: str=None, object: str=None, created_at: int=None, vector_store_id: str=None, status: str=None, file_counts: VectorStoreFileBatchObjectFileCounts=None):  # noqa: E501
        """VectorStoreFileBatchObject - a model defined in Swagger
