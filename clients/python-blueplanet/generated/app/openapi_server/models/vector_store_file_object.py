...
from app.openapi_server.models.vector_store_file_object_chunking_strategy import VectorStoreFileObjectChunkingStrategy  # noqa: F401,E501
from app.openapi_server.models.vector_store_file_object_last_error import VectorStoreFileObjectLastError  # noqa: F401,E501
...
class VectorStoreFileObject(Model):
    ...
    def __init__(self, id: str=None, object: str=None, usage_bytes: int=None, created_at: int=None, vector_store_id: str=None, status: str=None, last_error: VectorStoreFileObjectLastError=None, chunking_strategy: VectorStoreFileObjectChunkingStrategy=None):  # noqa: E501
        """VectorStoreFileObject - a model defined in Swagger
