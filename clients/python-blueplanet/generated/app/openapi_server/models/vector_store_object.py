...
from app.openapi_server.models.vector_store_expiration_after import VectorStoreExpirationAfter  # noqa: F401,E501
from app.openapi_server.models.vector_store_object_file_counts import VectorStoreObjectFileCounts  # noqa: F401,E501
...
class VectorStoreObject(Model):
    ...
    def __init__(self, id: str=None, object: str=None, created_at: int=None, name: str=None, usage_bytes: int=None, file_counts: VectorStoreObjectFileCounts=None, status: str=None, expires_after: VectorStoreExpirationAfter=None, expires_at: int=None, last_active_at: int=None, metadata: object=None):  # noqa: E501
        """VectorStoreObject - a model defined in Swagger
