...
class ChatCompletionResponseMessage(BaseModel):
    ...
    def role_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('system', 'user', 'assistant', 'function'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "function_call": ChatCompletionRequestMessageFunctionCall.from_dict(obj.get("function_call")) if obj.get("function_call") is not None else None
        })
        return _obj
