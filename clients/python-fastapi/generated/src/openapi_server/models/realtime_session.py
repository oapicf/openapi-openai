...
class RealtimeSession(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the session object. ")
    ...
    model: Optional[RealtimeSessionModel] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "modalities", "model", "instructions", "voice", "input_audio_format", "output_audio_format", "input_audio_transcription", "turn_detection", "tools", "tool_choice", "temperature", "max_response_output_tokens"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if turn_detection (nullable) is None
        # and model_fields_set contains the field
        if self.turn_detection is None and "turn_detection" in self.model_fields_set:
            _dict['turn_detection'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "model": RealtimeSessionModel.from_dict(obj.get("model")) if obj.get("model") is not None else None,
