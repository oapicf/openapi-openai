...
class RunStepDeltaStepDetailsToolCallsRetrievalObject(BaseModel):
    ...
    type: StrictStr = Field(description="The type of tool call. This is always going to be `retrieval` for this type of tool call.")
    retrieval: Optional[Dict[str, Any]] = Field(default=None, description="For now, this is always going to be an empty object.")
    __properties: ClassVar[List[str]] = ["index", "id", "type", "retrieval"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('retrieval',):
