...
def delete_invite(invite_id):  # noqa: E501
    ...
    :rtype: Union[InviteDeleteResponse, Tuple[InviteDeleteResponse, int], Tuple[InviteDeleteResponse, int, Dict[str, str]]
    """
...
def invite_user(body):  # noqa: E501
    ...
    :type invite_request: dict | bytes

    :rtype: Union[Invite, Tuple[Invite, int], Tuple[Invite, int, Dict[str, str]]
    """
    invite_request = body
    if connexion.request.is_json:
        invite_request = InviteRequest.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'
...
def list_invites(limit=None, after=None):  # noqa: E501
    ...
    :rtype: Union[InviteListResponse, Tuple[InviteListResponse, int], Tuple[InviteListResponse, int, Dict[str, str]]
    """
    return 'do some magic!'
