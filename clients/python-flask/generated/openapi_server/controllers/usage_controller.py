...
def usage_audio_speeches(start_time, end_time=None, bucket_width=None, project_ids=None, user_ids=None, api_key_ids=None, models=None, group_by=None, limit=None, page=None):  # noqa: E501
    ...
    :rtype: Union[UsageResponse, Tuple[UsageResponse, int], Tuple[UsageResponse, int, Dict[str, str]]
    """
    return 'do some magic!'


def usage_audio_transcriptions(start_time, end_time=None, bucket_width=None, project_ids=None, user_ids=None, api_key_ids=None, models=None, group_by=None, limit=None, page=None):  # noqa: E501
...
def usage_code_interpreter_sessions(start_time, end_time=None, bucket_width=None, project_ids=None, group_by=None, limit=None, page=None):  # noqa: E501
...
def usage_completions(start_time, end_time=None, bucket_width=None, project_ids=None, user_ids=None, api_key_ids=None, models=None, batch=None, group_by=None, limit=None, page=None):  # noqa: E501
...
def usage_costs(start_time, end_time=None, bucket_width=None, project_ids=None, group_by=None, limit=None, page=None):  # noqa: E501
...
def usage_embeddings(start_time, end_time=None, bucket_width=None, project_ids=None, user_ids=None, api_key_ids=None, models=None, group_by=None, limit=None, page=None):  # noqa: E501
...
def usage_images(start_time, end_time=None, bucket_width=None, sources=None, sizes=None, project_ids=None, user_ids=None, api_key_ids=None, models=None, group_by=None, limit=None, page=None):  # noqa: E501
...
def usage_moderations(start_time, end_time=None, bucket_width=None, project_ids=None, user_ids=None, api_key_ids=None, models=None, group_by=None, limit=None, page=None):  # noqa: E501
...
def usage_vector_stores(start_time, end_time=None, bucket_width=None, project_ids=None, group_by=None, limit=None, page=None):  # noqa: E501
