...
def delete_user(user_id):  # noqa: E501
    ...
    :rtype: Union[UserDeleteResponse, Tuple[UserDeleteResponse, int], Tuple[UserDeleteResponse, int, Dict[str, str]]
    """
...
def modify_user(user_id, body):  # noqa: E501
    ...
    :type user_role_update_request: dict | bytes

    :rtype: Union[User, Tuple[User, int], Tuple[User, int, Dict[str, str]]
    """
    user_role_update_request = body
    if connexion.request.is_json:
        user_role_update_request = UserRoleUpdateRequest.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'
