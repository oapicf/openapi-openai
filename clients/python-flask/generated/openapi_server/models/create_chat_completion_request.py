...
class CreateChatCompletionRequest(Model):
    ...
    def __init__(self, model=None, messages=None, functions=None, function_call=None, temperature=1, top_p=1, n=1, stream=False, stop=None, max_tokens=None, presence_penalty=0, frequency_penalty=0, logit_bias=None, user=None):  # noqa: E501
