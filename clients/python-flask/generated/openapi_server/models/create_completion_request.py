...
from openapi_server.models.create_completion_request_stop import CreateCompletionRequestStop  # noqa: E501
...
class CreateCompletionRequest(Model):
    ...
    def __init__(self, model=None, prompt=None, suffix=None, max_tokens=16, temperature=1, top_p=1, n=1, stream=False, logprobs=None, echo=False, stop=None, presence_penalty=0, frequency_penalty=0, best_of=1, logit_bias=None, user=None):  # noqa: E501
    ...
    def suffix(self) -> str:
        ...
        The suffix that comes after a completion of inserted text.  # noqa: E501
