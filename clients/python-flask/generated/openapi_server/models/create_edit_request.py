...
from openapi_server.models.create_edit_request_model import CreateEditRequestModel  # noqa: E501
...
class CreateEditRequest(Model):
    ...
    def __init__(self, model=None, input='', instruction=None, n=1, temperature=1, top_p=1):  # noqa: E501
