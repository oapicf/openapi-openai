...
from openapi_server.models.create_fine_tune_request_model import CreateFineTuneRequestModel  # noqa: E501
...
class CreateFineTuneRequest(Model):
    ...
    def __init__(self, training_file=None, validation_file=None, model=None, n_epochs=4, batch_size=None, learning_rate_multiplier=None, prompt_loss_weight=0.01, compute_classification_metrics=False, classification_n_classes=None, classification_positive_class=None, classification_betas=None, suffix=None):  # noqa: E501
