...
class TestProjectsController(BaseTestCase):
    ...
    def test_create_project_service_account(self):
        ...
        response = self.client.open(
            ...
            method='POST',
            headers=headers,
            data=json.dumps(project_service_account_create_request),
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_create_project_user(self):
        ...
        response = self.client.open(
            ...
            method='POST',
            headers=headers,
            data=json.dumps(project_user_create_request),
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_modify_project(self):
        ...
        response = self.client.open(
            ...
            method='POST',
            headers=headers,
            data=json.dumps(project_update_request),
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_modify_project_user(self):
        ...
        response = self.client.open(
            ...
            method='POST',
            headers=headers,
            data=json.dumps(project_user_update_request),
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_update_project_rate_limits(self):
        ...
        response = self.client.open(
            ...
            method='POST',
            headers=headers,
            data=json.dumps(project_rate_limit_update_request),
            content_type='application/json')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
