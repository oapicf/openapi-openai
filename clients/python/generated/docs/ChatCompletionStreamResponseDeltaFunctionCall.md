...
chat_completion_stream_response_delta_function_call_form_dict = chat_completion_stream_response_delta_function_call.from_dict(chat_completion_stream_response_delta_function_call_dict)
```
