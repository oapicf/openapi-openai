...
class ChatCompletionRequestAssistantMessage(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The contents of the assistant message. Required unless `tool_calls` or `function_call` is specified. ")
    ...
    __properties: ClassVar[List[str]] = ["content", "role", "name", "tool_calls", "function_call"]
