...
class RealtimeSessionCreateRequestTurnDetection(BaseModel):
    ...
    create_response: Optional[StrictBool] = Field(default=True, description="Whether or not to automatically generate a response when VAD is enabled. `true` by default. ")
    __properties: ClassVar[List[str]] = ["type", "threshold", "prefix_padding_ms", "silence_duration_ms", "create_response"]
