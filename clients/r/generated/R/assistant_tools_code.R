...
AssistantToolsCode <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return AssistantToolsCode as a base R list.
    #' @examples
    #' # convert array of AssistantToolsCode (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AssistantToolsCode to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(AssistantToolsCodeObject)
    },
