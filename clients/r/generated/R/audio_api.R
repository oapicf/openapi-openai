...
#' @section Methods:
#' \describe{
#' \strong{ CreateSpeech } \emph{ Generates audio from the input text. }
#'
#' \itemize{
#' \item \emph{ @param } create_speech_request \link{CreateSpeechRequest}
#'
#'
...
#'
#' \tabular{ll}{
#' Transfer-Encoding \tab chunked \cr
#' }
#' }
#'
...
#' \item \emph{ @param } response_format Enum < [json, text, srt, verbose_json, vtt] >
#' \item \emph{ @param } temperature numeric
#' \item \emph{ @param } timestamp_granularities Enum < [word, segment] >
#' \item \emph{ @returnType } \link{CreateTranscription200Response} \cr
#'
#'
#' \item status code : 200 | OK
#'
#' \item return type : CreateTranscription200Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
...
#' \item \emph{ @param } temperature numeric
#' \item \emph{ @returnType } \link{CreateTranslation200Response} \cr
#'
#'
#' \item status code : 200 | OK
#'
#' \item return type : CreateTranslation200Response
#' \item response headers :
#'
#' \tabular{ll}{
#' }
  ...
  public = list(
    ...
    CreateTranscriptionWithHttpInfo = function(file, model, language = NULL, prompt = NULL, response_format = "json", temperature = 0, timestamp_granularities = NULL, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "CreateTranscription200Response", loadNamespace("openapi")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
    ...
    CreateTranslationWithHttpInfo = function(file, model, prompt = NULL, response_format = "json", temperature = 0, data_file = NULL, ...) {
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$deserialize(local_var_resp$response_as_text(), "CreateTranslation200Response", loadNamespace("openapi")),
          error = function(e) {
            stop("Failed to deserialize response")
          }
        )
