#' Create a new AuditLogRateLimitUpdatedChangesRequested
#'
#' @description
#' The payload used to update the rate limits.
#'
#' @docType class
#' @title AuditLogRateLimitUpdatedChangesRequested
#' @description AuditLogRateLimitUpdatedChangesRequested Class
...
#' @export
AuditLogRateLimitUpdatedChangesRequested <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new AuditLogRateLimitUpdatedChangesRequested class.
    #'
    ...
    #'
    #' @return AuditLogRateLimitUpdatedChangesRequested as a base R list.
    #' @examples
    #' # convert array of AuditLogRateLimitUpdatedChangesRequested (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert AuditLogRateLimitUpdatedChangesRequested to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      AuditLogRateLimitUpdatedChangesRequestedObject <- list()
      if (!is.null(self$`max_requests_per_1_minute`)) {
        AuditLogRateLimitUpdatedChangesRequestedObject[["max_requests_per_1_minute"]] <-
          self$`max_requests_per_1_minute`
      }
      if (!is.null(self$`max_tokens_per_1_minute`)) {
        AuditLogRateLimitUpdatedChangesRequestedObject[["max_tokens_per_1_minute"]] <-
          self$`max_tokens_per_1_minute`
      }
      if (!is.null(self$`max_images_per_1_minute`)) {
        AuditLogRateLimitUpdatedChangesRequestedObject[["max_images_per_1_minute"]] <-
          self$`max_images_per_1_minute`
      }
      if (!is.null(self$`max_audio_megabytes_per_1_minute`)) {
        AuditLogRateLimitUpdatedChangesRequestedObject[["max_audio_megabytes_per_1_minute"]] <-
          self$`max_audio_megabytes_per_1_minute`
      }
      if (!is.null(self$`max_requests_per_1_day`)) {
        AuditLogRateLimitUpdatedChangesRequestedObject[["max_requests_per_1_day"]] <-
          self$`max_requests_per_1_day`
      }
      if (!is.null(self$`batch_1_day_max_input_tokens`)) {
        AuditLogRateLimitUpdatedChangesRequestedObject[["batch_1_day_max_input_tokens"]] <-
          self$`batch_1_day_max_input_tokens`
      }
      return(AuditLogRateLimitUpdatedChangesRequestedObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of AuditLogRateLimitUpdatedChangesRequested
    #'
    #' @param input_json the JSON input
    #' @return the instance of AuditLogRateLimitUpdatedChangesRequested
    ...
    #' @return AuditLogRateLimitUpdatedChangesRequested in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to AuditLogRateLimitUpdatedChangesRequested and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of AuditLogRateLimitUpdatedChangesRequested
    toString = function() {
      self$toJSONString()
    },
...
# AuditLogRateLimitUpdatedChangesRequested$unlock()
#
## Below is an example to define the print function
# AuditLogRateLimitUpdatedChangesRequested$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# AuditLogRateLimitUpdatedChangesRequested$lock()
