...
ChatApi <- R6::R6Class(
  ...
  public = list(
    ...
    CreateChatCompletionWithHttpInfo = function(create_chat_completion_request, data_file = NULL, ...) {
      ...
      if (!missing(`create_chat_completion_request`) && is.null(`create_chat_completion_request`)) {
        stop("Invalid value for `create_chat_completion_request` when calling ChatApi$CreateChatCompletion, `create_chat_completion_request` is not nullable")
      }
      ...
      if (local_var_resp$status_code >= 200 && local_var_resp$status_code <= 299) {
        ...
        deserialized_resp_obj <- tryCatch(
          self$api_client$DeserializeResponse(local_var_resp, "CreateChatCompletionResponse"),
          error = function(e) {
