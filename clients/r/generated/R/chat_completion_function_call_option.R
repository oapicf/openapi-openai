...
ChatCompletionFunctionCallOption <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ChatCompletionFunctionCallOption as a base R list.
    #' @examples
    #' # convert array of ChatCompletionFunctionCallOption (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ChatCompletionFunctionCallOption to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ChatCompletionFunctionCallOptionObject)
    },
