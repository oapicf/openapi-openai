...
ChatCompletionMessageToolCall <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ChatCompletionMessageToolCall as a base R list.
    #' @examples
    #' # convert array of ChatCompletionMessageToolCall (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ChatCompletionMessageToolCall to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ChatCompletionMessageToolCallObject)
    },
