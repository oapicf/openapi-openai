...
ChatCompletionNamedToolChoice <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ChatCompletionNamedToolChoice as a base R list.
    #' @examples
    #' # convert array of ChatCompletionNamedToolChoice (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ChatCompletionNamedToolChoice to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ChatCompletionNamedToolChoiceObject)
    },
