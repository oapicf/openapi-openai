...
ChatCompletionNamedToolChoiceFunction <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ChatCompletionNamedToolChoiceFunction as a base R list.
    #' @examples
    #' # convert array of ChatCompletionNamedToolChoiceFunction (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ChatCompletionNamedToolChoiceFunction to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ChatCompletionNamedToolChoiceFunctionObject)
    },
