...
ChatCompletionRequestFunctionMessage <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ChatCompletionRequestFunctionMessage as a base R list.
    #' @examples
    #' # convert array of ChatCompletionRequestFunctionMessage (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ChatCompletionRequestFunctionMessage to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ChatCompletionRequestFunctionMessageObject)
    },
