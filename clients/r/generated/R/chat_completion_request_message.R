...
ChatCompletionRequestMessage <- R6::R6Class(
  ...
  public = list(
    ...
    #' Serialize ChatCompletionRequestMessage to JSON.
    #'
    #' @description
    #' Serialize ChatCompletionRequestMessage to JSON.
    #'
    #' @return JSON representation of the ChatCompletionRequestMessage.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to ChatCompletionRequestMessage.
    #'
    #' @description
