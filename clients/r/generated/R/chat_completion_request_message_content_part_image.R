...
ChatCompletionRequestMessageContentPartImage <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ChatCompletionRequestMessageContentPartImage as a base R list.
    #' @examples
    #' # convert array of ChatCompletionRequestMessageContentPartImage (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ChatCompletionRequestMessageContentPartImage to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ChatCompletionRequestMessageContentPartImageObject)
    },
