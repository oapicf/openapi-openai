...
#'
#' @description ChatCompletionRequestUserMessageContent Class
#'
...
#' @export
ChatCompletionRequestUserMessageContent <- R6::R6Class(
  ...
  public = list(
    ...
    #' Deserialize JSON string into an instance of ChatCompletionRequestUserMessageContent.
    #'
    #' @description
    #' Deserialize JSON string into an instance of ChatCompletionRequestUserMessageContent.
    ...
    #' Serialize ChatCompletionRequestUserMessageContent to JSON string.
    #'
    #' @description
    #' Serialize ChatCompletionRequestUserMessageContent to JSON string.
    #'
    #' @return JSON string representation of the ChatCompletionRequestUserMessageContent.
    #' @export
    ...
    #' Serialize ChatCompletionRequestUserMessageContent to JSON.
    #'
    #' @description
    #' Serialize ChatCompletionRequestUserMessageContent to JSON.
    #'
    #' @return JSON representation of the ChatCompletionRequestUserMessageContent.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to ChatCompletionRequestUserMessageContent.
    #'
    #' @description
    #' Validate the input JSON with respect to ChatCompletionRequestUserMessageContent and
...
#ChatCompletionRequestUserMessageContent$unlock()
#
## Below is an example to define the print function
#ChatCompletionRequestUserMessageContent$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#ChatCompletionRequestUserMessageContent$lock()
