...
ChatCompletionTokenLogprobTopLogprobsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ChatCompletionTokenLogprobTopLogprobsInner as a base R list.
    #' @examples
    #' # convert array of ChatCompletionTokenLogprobTopLogprobsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ChatCompletionTokenLogprobTopLogprobsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ChatCompletionTokenLogprobTopLogprobsInnerObject)
    },
