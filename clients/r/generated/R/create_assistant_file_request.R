...
CreateAssistantFileRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateAssistantFileRequest as a base R list.
    #' @examples
    #' # convert array of CreateAssistantFileRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateAssistantFileRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateAssistantFileRequestObject)
    },
