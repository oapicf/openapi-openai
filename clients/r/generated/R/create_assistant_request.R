...
CreateAssistantRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateAssistantRequest as a base R list.
    #' @examples
    #' # convert array of CreateAssistantRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateAssistantRequest to a base R type
    #'
