#' Create a new CreateChatCompletionFunctionResponse
#'
#' @description
...
#' @description CreateChatCompletionFunctionResponse Class
#' @format An \code{R6Class} generator object
#' @field id A unique identifier for the chat completion. character
#' @field choices A list of chat completion choices. Can be more than one if `n` is greater than 1. list(\link{CreateChatCompletionFunctionResponseChoicesInner})
...
#' @export
CreateChatCompletionFunctionResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CreateChatCompletionFunctionResponse class.
    #'
    ...
    #'
    #' @return CreateChatCompletionFunctionResponse as a base R list.
    #' @examples
    #' # convert array of CreateChatCompletionFunctionResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateChatCompletionFunctionResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CreateChatCompletionFunctionResponseObject <- list()
      if (!is.null(self$`id`)) {
        CreateChatCompletionFunctionResponseObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`choices`)) {
        CreateChatCompletionFunctionResponseObject[["choices"]] <-
          lapply(self$`choices`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`created`)) {
        CreateChatCompletionFunctionResponseObject[["created"]] <-
          self$`created`
      }
      if (!is.null(self$`model`)) {
        CreateChatCompletionFunctionResponseObject[["model"]] <-
          self$`model`
      }
      if (!is.null(self$`system_fingerprint`)) {
        CreateChatCompletionFunctionResponseObject[["system_fingerprint"]] <-
      ...
      if (!is.null(self$`usage`)) {
        CreateChatCompletionFunctionResponseObject[["usage"]] <-
          self$`usage`$toSimpleType()
      }
      return(CreateChatCompletionFunctionResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CreateChatCompletionFunctionResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of CreateChatCompletionFunctionResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`choices`)) {
        self$`choices` <- ApiClient$new()$deserializeObj(this_object$`choices`, "array[CreateChatCompletionFunctionResponseChoicesInner]", loadNamespace("openapi"))
      }
    ...
    #' @return CreateChatCompletionFunctionResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CreateChatCompletionFunctionResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateChatCompletionFunctionResponse: the required field `id` is missing."))
      }
      ...
      if (!is.null(input_json$`choices`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateChatCompletionFunctionResponse: the required field `choices` is missing."))
      }
      ...
      if (!is.null(input_json$`created`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateChatCompletionFunctionResponse: the required field `created` is missing."))
      }
      ...
      if (!is.null(input_json$`model`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateChatCompletionFunctionResponse: the required field `model` is missing."))
      }
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for CreateChatCompletionFunctionResponse: the required field `object` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of CreateChatCompletionFunctionResponse
    toString = function() {
      self$toJSONString()
    },
...
# CreateChatCompletionFunctionResponse$unlock()
#
## Below is an example to define the print function
# CreateChatCompletionFunctionResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CreateChatCompletionFunctionResponse$lock()
