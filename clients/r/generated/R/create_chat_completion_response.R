...
CreateChatCompletionResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateChatCompletionResponse as a base R list.
    #' @examples
    #' # convert array of CreateChatCompletionResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateChatCompletionResponse to a base R type
    #'
