...
CreateChatCompletionResponseChoicesInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateChatCompletionResponseChoicesInner as a base R list.
    #' @examples
    #' # convert array of CreateChatCompletionResponseChoicesInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateChatCompletionResponseChoicesInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateChatCompletionResponseChoicesInnerObject)
    },
