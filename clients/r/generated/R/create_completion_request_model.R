#' @docType class
#' @title CreateCompletionRequestModel
#'
#' @description CreateCompletionRequestModel Class
#'
...
#' @export
CreateCompletionRequestModel <- R6::R6Class(
  ...
  public = list(
    ...
    #' Serialize CreateCompletionRequestModel to JSON string.
    #'
    #' @return JSON string representation of the CreateCompletionRequestModel.
    #' @export
    ...
    #' Serialize CreateCompletionRequestModel to JSON.
    #'
    #' @description
    #' Serialize CreateCompletionRequestModel to JSON.
    #'
    #' @return JSON representation of the CreateCompletionRequestModel.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to CreateCompletionRequestModel.
    #'
    #' @description
    #' Validate the input JSON with respect to CreateCompletionRequestModel and
...
#CreateCompletionRequestModel$unlock()
#
## Below is an example to define the print function
#CreateCompletionRequestModel$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CreateCompletionRequestModel$lock()
