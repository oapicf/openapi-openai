#' @docType class
#' @title CreateCompletionRequestPrompt
#'
#' @description CreateCompletionRequestPrompt Class
#'
...
#' @export
CreateCompletionRequestPrompt <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new CreateCompletionRequestPrompt.
    #'
    #' @description
    #' Initialize a new CreateCompletionRequestPrompt.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CreateCompletionRequestPrompt with oneOf schemas array[array[integer]], array[character], array[integer], character. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },
    #' Deserialize JSON string into an instance of CreateCompletionRequestPrompt.
    #'
    #' @description
    #' Deserialize JSON string into an instance of CreateCompletionRequestPrompt.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CreateCompletionRequestPrompt with oneOf schemas array[array[integer]], array[character], array[integer], character. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CreateCompletionRequestPrompt with oneOf schemas array[array[integer]], array[character], array[integer], character. Details: >>",
                   paste(error_messages, collapse = " >> ")))
      }

      self
    },
    #' Serialize CreateCompletionRequestPrompt to JSON string.
    #'
    #' @description
    #' Serialize CreateCompletionRequestPrompt to JSON string.
    #'
    #' @return JSON string representation of the CreateCompletionRequestPrompt.
    #' @export
    ...
    #' Serialize CreateCompletionRequestPrompt to JSON.
    #'
    #' @description
    #' Serialize CreateCompletionRequestPrompt to JSON.
    #'
    #' @return JSON representation of the CreateCompletionRequestPrompt.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to CreateCompletionRequestPrompt.
    #'
    #' @description
    #' Validate the input JSON with respect to CreateCompletionRequestPrompt and
...
#CreateCompletionRequestPrompt$unlock()
#
## Below is an example to define the print function
#CreateCompletionRequestPrompt$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CreateCompletionRequestPrompt$lock()
