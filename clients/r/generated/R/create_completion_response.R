...
CreateCompletionResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateCompletionResponse as a base R list.
    #' @examples
    #' # convert array of CreateCompletionResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateCompletionResponse to a base R type
    #'
