...
#' @field data The list of embeddings generated by the model. list(\link{Embedding})
#' @field model The name of the model used to generate the embedding. character
...
CreateEmbeddingResponse <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`data`, `model`, `object`, `usage`, ...) {
      if (!missing(`data`)) {
    ...
    #'
    #' @return CreateEmbeddingResponse as a base R list.
    #' @examples
    #' # convert array of CreateEmbeddingResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateEmbeddingResponse to a base R type
    #'
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Embedding]", loadNamespace("openapi"))
      }
