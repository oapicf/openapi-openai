...
CreateFineTuningJobRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateFineTuningJobRequest as a base R list.
    #' @examples
    #' # convert array of CreateFineTuningJobRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateFineTuningJobRequest to a base R type
    #'
