...
CreateFineTuningJobRequestHyperparameters <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateFineTuningJobRequestHyperparameters as a base R list.
    #' @examples
    #' # convert array of CreateFineTuningJobRequestHyperparameters (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateFineTuningJobRequestHyperparameters to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateFineTuningJobRequestHyperparametersObject)
    },
