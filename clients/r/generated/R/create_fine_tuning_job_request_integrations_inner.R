...
CreateFineTuningJobRequestIntegrationsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateFineTuningJobRequestIntegrationsInner as a base R list.
    #' @examples
    #' # convert array of CreateFineTuningJobRequestIntegrationsInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateFineTuningJobRequestIntegrationsInner to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateFineTuningJobRequestIntegrationsInnerObject)
    },
