...
CreateImageRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateImageRequest as a base R list.
    #' @examples
    #' # convert array of CreateImageRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateImageRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateImageRequestObject)
    },
