#' @docType class
#' @title CreateModerationRequestInput
#'
#' @description CreateModerationRequestInput Class
#'
...
#' @export
CreateModerationRequestInput <- R6::R6Class(
  ...
  public = list(
    ...
    #' Deserialize JSON string into an instance of CreateModerationRequestInput.
    #'
    #' @description
    #' Deserialize JSON string into an instance of CreateModerationRequestInput.
    ...
    #' Serialize CreateModerationRequestInput to JSON string.
    #'
    #' @description
    #' Serialize CreateModerationRequestInput to JSON string.
    #'
    #' @return JSON string representation of the CreateModerationRequestInput.
    #' @export
    ...
    #' Serialize CreateModerationRequestInput to JSON.
    #'
    #' @description
    #' Serialize CreateModerationRequestInput to JSON.
    #'
    #' @return JSON representation of the CreateModerationRequestInput.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to CreateModerationRequestInput.
    #'
    #' @description
    #' Validate the input JSON with respect to CreateModerationRequestInput and
...
#CreateModerationRequestInput$unlock()
#
## Below is an example to define the print function
#CreateModerationRequestInput$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CreateModerationRequestInput$lock()
