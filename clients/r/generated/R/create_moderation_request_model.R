  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CreateModerationRequestModel with oneOf schemas character. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CreateModerationRequestModel with oneOf schemas character. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CreateModerationRequestModel with oneOf schemas character. Details: >>",
    ...
    #' Serialize CreateModerationRequestModel to JSON.
    #'
    #' @description
    #' Serialize CreateModerationRequestModel to JSON.
    #'
    #' @return JSON representation of the CreateModerationRequestModel.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to CreateModerationRequestModel.
    #'
    #' @description
