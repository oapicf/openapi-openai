...
CreateModerationResponseResultsInnerCategories <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateModerationResponseResultsInnerCategories as a base R list.
    #' @examples
    #' # convert array of CreateModerationResponseResultsInnerCategories (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateModerationResponseResultsInnerCategories to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateModerationResponseResultsInnerCategoriesObject)
    },
