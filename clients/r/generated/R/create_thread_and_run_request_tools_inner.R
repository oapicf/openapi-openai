...
#'
#' @description CreateThreadAndRunRequestToolsInner Class
#'
...
#' @export
CreateThreadAndRunRequestToolsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #' Initialize a new CreateThreadAndRunRequestToolsInner.
    #'
    #' @description
    #' Initialize a new CreateThreadAndRunRequestToolsInner.
    #'
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CreateThreadAndRunRequestToolsInner with oneOf schemas AssistantToolsCode, AssistantToolsFunction, AssistantToolsRetrieval. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },
    #' Deserialize JSON string into an instance of CreateThreadAndRunRequestToolsInner.
    #'
    #' @description
    #' Deserialize JSON string into an instance of CreateThreadAndRunRequestToolsInner.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CreateThreadAndRunRequestToolsInner with oneOf schemas AssistantToolsCode, AssistantToolsFunction, AssistantToolsRetrieval. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CreateThreadAndRunRequestToolsInner with oneOf schemas AssistantToolsCode, AssistantToolsFunction, AssistantToolsRetrieval. Details: >>",
                   paste(error_messages, collapse = " >> ")))
      }

      self
    },
    #' Serialize CreateThreadAndRunRequestToolsInner to JSON string.
    #'
    #' @description
    #' Serialize CreateThreadAndRunRequestToolsInner to JSON string.
    #'
    #' @return JSON string representation of the CreateThreadAndRunRequestToolsInner.
    #' @export
    ...
    #' Serialize CreateThreadAndRunRequestToolsInner to JSON.
    #'
    #' @description
    #' Serialize CreateThreadAndRunRequestToolsInner to JSON.
    #'
    #' @return JSON representation of the CreateThreadAndRunRequestToolsInner.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to CreateThreadAndRunRequestToolsInner.
    #'
    #' @description
    #' Validate the input JSON with respect to CreateThreadAndRunRequestToolsInner and
...
#CreateThreadAndRunRequestToolsInner$unlock()
#
## Below is an example to define the print function
#CreateThreadAndRunRequestToolsInner$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#CreateThreadAndRunRequestToolsInner$lock()
