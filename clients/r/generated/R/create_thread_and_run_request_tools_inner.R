  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize CreateThreadAndRunRequestToolsInner with oneOf schemas AssistantToolsCode, AssistantToolsFileSearch, AssistantToolsFunction. Provided class name: ",
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into CreateThreadAndRunRequestToolsInner with oneOf schemas AssistantToolsCode, AssistantToolsFileSearch, AssistantToolsFunction. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into CreateThreadAndRunRequestToolsInner with oneOf schemas AssistantToolsCode, AssistantToolsFileSearch, AssistantToolsFunction. Details: >>",
    ...
    #' @description
    #' Convert CreateThreadAndRunRequestToolsInner to a base R type
    #'
