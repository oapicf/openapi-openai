#' Create a new CreateThreadRequestToolResourcesFileSearchVectorStoresInner
#'
#' @description
#' CreateThreadRequestToolResourcesFileSearchVectorStoresInner Class
#'
#' @docType class
#' @title CreateThreadRequestToolResourcesFileSearchVectorStoresInner
#' @description CreateThreadRequestToolResourcesFileSearchVectorStoresInner Class
...
#' @export
CreateThreadRequestToolResourcesFileSearchVectorStoresInner <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new CreateThreadRequestToolResourcesFileSearchVectorStoresInner class.
    #'
    ...
    #'
    #' @return CreateThreadRequestToolResourcesFileSearchVectorStoresInner as a base R list.
    #' @examples
    #' # convert array of CreateThreadRequestToolResourcesFileSearchVectorStoresInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateThreadRequestToolResourcesFileSearchVectorStoresInner to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      CreateThreadRequestToolResourcesFileSearchVectorStoresInnerObject <- list()
      if (!is.null(self$`file_ids`)) {
        CreateThreadRequestToolResourcesFileSearchVectorStoresInnerObject[["file_ids"]] <-
          self$`file_ids`
      }
      if (!is.null(self$`chunking_strategy`)) {
        CreateThreadRequestToolResourcesFileSearchVectorStoresInnerObject[["chunking_strategy"]] <-
          self$`chunking_strategy`$toSimpleType()
      }
      if (!is.null(self$`metadata`)) {
        CreateThreadRequestToolResourcesFileSearchVectorStoresInnerObject[["metadata"]] <-
          self$`metadata`
      }
      return(CreateThreadRequestToolResourcesFileSearchVectorStoresInnerObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of CreateThreadRequestToolResourcesFileSearchVectorStoresInner
    #'
    #' @param input_json the JSON input
    #' @return the instance of CreateThreadRequestToolResourcesFileSearchVectorStoresInner
    ...
    #' @return CreateThreadRequestToolResourcesFileSearchVectorStoresInner in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to CreateThreadRequestToolResourcesFileSearchVectorStoresInner and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of CreateThreadRequestToolResourcesFileSearchVectorStoresInner
    toString = function() {
      self$toJSONString()
    },
...
# CreateThreadRequestToolResourcesFileSearchVectorStoresInner$unlock()
#
## Below is an example to define the print function
# CreateThreadRequestToolResourcesFileSearchVectorStoresInner$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# CreateThreadRequestToolResourcesFileSearchVectorStoresInner$lock()
