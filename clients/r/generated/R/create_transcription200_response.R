...
CreateTranscription200Response <- R6::R6Class(
  ...
  public = list(
    ...
    #' Serialize CreateTranscription200Response to JSON.
    #'
    #' @description
    #' Serialize CreateTranscription200Response to JSON.
    #'
    #' @return JSON representation of the CreateTranscription200Response.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to CreateTranscription200Response.
    #'
    #' @description
