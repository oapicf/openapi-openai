...
CreateTranscriptionResponseJson <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateTranscriptionResponseJson as a base R list.
    #' @examples
    #' # convert array of CreateTranscriptionResponseJson (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateTranscriptionResponseJson to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateTranscriptionResponseJsonObject)
    },
