...
CreateTranslationResponseVerboseJson <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return CreateTranslationResponseVerboseJson as a base R list.
    #' @examples
    #' # convert array of CreateTranslationResponseVerboseJson (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert CreateTranslationResponseVerboseJson to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(CreateTranslationResponseVerboseJsonObject)
    },
