...
DeleteAssistantFileResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeleteAssistantFileResponse as a base R list.
    #' @examples
    #' # convert array of DeleteAssistantFileResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeleteAssistantFileResponse to a base R type
    #'
