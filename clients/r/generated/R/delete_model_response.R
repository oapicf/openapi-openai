...
DeleteModelResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return DeleteModelResponse as a base R list.
    #' @examples
    #' # convert array of DeleteModelResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DeleteModelResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(DeleteModelResponseObject)
    },
