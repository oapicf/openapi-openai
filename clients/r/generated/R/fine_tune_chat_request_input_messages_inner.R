#' @docType class
#' @title FineTuneChatRequestInputMessagesInner
#'
#' @description FineTuneChatRequestInputMessagesInner Class
#'
...
#' @export
FineTuneChatRequestInputMessagesInner <- R6::R6Class(
  ...
  public = list(
    ...
    one_of = list("ChatCompletionRequestFunctionMessage", "ChatCompletionRequestSystemMessage", "ChatCompletionRequestToolMessage", "ChatCompletionRequestUserMessage", "FineTuneChatCompletionRequestAssistantMessage"),

    #' @description
    #' Initialize a new FineTuneChatRequestInputMessagesInner.
    #'
    #' @param instance an instance of the object defined in the oneOf schemas: "ChatCompletionRequestFunctionMessage", "ChatCompletionRequestSystemMessage", "ChatCompletionRequestToolMessage", "ChatCompletionRequestUserMessage", "FineTuneChatCompletionRequestAssistantMessage"
    initialize = function(instance = NULL) {
      ...
      } else if (get(class(instance)[[1]], pos = -1)$classname ==  "FineTuneChatCompletionRequestAssistantMessage") {
        self$actual_instance <- instance
        self$actual_type <- "FineTuneChatCompletionRequestAssistantMessage"
      } else {
        stop(paste("Failed to initialize FineTuneChatRequestInputMessagesInner with oneOf schemas ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage, FineTuneChatCompletionRequestAssistantMessage. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of FineTuneChatRequestInputMessagesInner.
    ...
    fromJSON = function(input) {
      ...
      `FineTuneChatCompletionRequestAssistantMessage_result` <- tryCatch({
          `FineTuneChatCompletionRequestAssistantMessage`$public_methods$validateJSON(input)
          `FineTuneChatCompletionRequestAssistantMessage_instance` <- `FineTuneChatCompletionRequestAssistantMessage`$new()
          instance <- `FineTuneChatCompletionRequestAssistantMessage_instance`$fromJSON(input)
          instance_type <- "FineTuneChatCompletionRequestAssistantMessage"
          matched_schemas <- append(matched_schemas, "FineTuneChatCompletionRequestAssistantMessage")
          matched <- matched + 1
        },
        error = function(err) err
      )

      if (!is.null(`FineTuneChatCompletionRequestAssistantMessage_result`["error"])) {
        error_messages <- append(error_messages, `FineTuneChatCompletionRequestAssistantMessage_result`["message"])
      }
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into FineTuneChatRequestInputMessagesInner with oneOf schemas ChatCompletionRequestFunctionMessage, ChatCompletionRequestSystemMessage, ChatCompletionRequestToolMessage, ChatCompletionRequestUserMessage, FineTuneChatCompletionRequestAssistantMessage. Matched schemas: ",
    ...
    #' @description
    #' Serialize FineTuneChatRequestInputMessagesInner to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the FineTuneChatRequestInputMessagesInner.
    ...
    #' @description
    #' Convert FineTuneChatRequestInputMessagesInner to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to FineTuneChatRequestInputMessagesInner and
...
#FineTuneChatRequestInputMessagesInner$unlock()
#
## Below is an example to define the print function
#FineTuneChatRequestInputMessagesInner$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
## Uncomment below to lock the class to prevent modifications to the method or field
#FineTuneChatRequestInputMessagesInner$lock()
