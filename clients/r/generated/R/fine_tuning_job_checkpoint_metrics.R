...
FineTuningJobCheckpointMetrics <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return FineTuningJobCheckpointMetrics as a base R list.
    #' @examples
    #' # convert array of FineTuningJobCheckpointMetrics (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert FineTuningJobCheckpointMetrics to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(FineTuningJobCheckpointMetricsObject)
    },
