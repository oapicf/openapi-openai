...
FineTuningJobError <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return FineTuningJobError as a base R list.
    #' @examples
    #' # convert array of FineTuningJobError (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert FineTuningJobError to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(FineTuningJobErrorObject)
    },
