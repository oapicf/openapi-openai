#' Create a new ListAssistantsResponse
#'
#' @description
...
#' @description ListAssistantsResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{AssistantObject})
...
#' @export
ListAssistantsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListAssistantsResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ListAssistantsResponse as a base R list.
    #' @examples
    #' # convert array of ListAssistantsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListAssistantsResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListAssistantsResponseObject <- list()
      if (!is.null(self$`object`)) {
        ListAssistantsResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ListAssistantsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ListAssistantsResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ListAssistantsResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ListAssistantsResponseObject[["has_more"]] <-
          self$`has_more`
      }
      return(ListAssistantsResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ListAssistantsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListAssistantsResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[AssistantObject]", loadNamespace("openapi"))
      }
    ...
    #' @return ListAssistantsResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListAssistantsResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAssistantsResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAssistantsResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAssistantsResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAssistantsResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAssistantsResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ListAssistantsResponse
    toString = function() {
      self$toJSONString()
    },
...
# ListAssistantsResponse$unlock()
#
## Below is an example to define the print function
# ListAssistantsResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListAssistantsResponse$lock()
