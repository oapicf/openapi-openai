#' Create a new ListAuditLogsResponse
#'
#' @description
...
#' @description ListAuditLogsResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{AuditLog})
...
#' @export
ListAuditLogsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListAuditLogsResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ListAuditLogsResponse as a base R list.
    #' @examples
    #' # convert array of ListAuditLogsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListAuditLogsResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListAuditLogsResponseObject <- list()
      if (!is.null(self$`object`)) {
        ListAuditLogsResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ListAuditLogsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ListAuditLogsResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ListAuditLogsResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ListAuditLogsResponseObject[["has_more"]] <-
          self$`has_more`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ListAuditLogsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListAuditLogsResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[AuditLog]", loadNamespace("openapi"))
      }
    ...
    #' @return ListAuditLogsResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListAuditLogsResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAuditLogsResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAuditLogsResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAuditLogsResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAuditLogsResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListAuditLogsResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ListAuditLogsResponse
    toString = function() {
      self$toJSONString()
    },
...
# ListAuditLogsResponse$unlock()
#
## Below is an example to define the print function
# ListAuditLogsResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListAuditLogsResponse$lock()
