#' Create a new ListBatchesResponse
#'
#' @description
...
#' @description ListBatchesResponse Class
#' @format An \code{R6Class} generator object
#' @field data  list(\link{Batch})
...
#' @export
ListBatchesResponse <- R6::R6Class(
  "ListBatchesResponse",
  public = list(
    `data` = NULL,
    `first_id` = NULL,
    ...
    #' @description
    #' Initialize a new ListBatchesResponse class.
    #'
    #' @param data data
    ...
    initialize = function(`data`, `has_more`, `object`, `first_id` = NULL, `last_id` = NULL, ...) {
      if (!missing(`data`)) {
    ...
    #'
    #' @return ListBatchesResponse as a base R list.
    #' @examples
    #' # convert array of ListBatchesResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListBatchesResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListBatchesResponseObject <- list()
      if (!is.null(self$`data`)) {
        ListBatchesResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ListBatchesResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ListBatchesResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ListBatchesResponseObject[["has_more"]] <-
          self$`has_more`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ListBatchesResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListBatchesResponse
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Batch]", loadNamespace("openapi"))
      }
    ...
    #' @return ListBatchesResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListBatchesResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListBatchesResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListBatchesResponse: the required field `has_more` is missing."))
      }
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListBatchesResponse: the required field `object` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ListBatchesResponse
    toString = function() {
      self$toJSONString()
    },
...
# ListBatchesResponse$unlock()
#
## Below is an example to define the print function
# ListBatchesResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListBatchesResponse$lock()
