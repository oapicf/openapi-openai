...
ListFineTuningJobEventsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ListFineTuningJobEventsResponse as a base R list.
    #' @examples
    #' # convert array of ListFineTuningJobEventsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListFineTuningJobEventsResponse to a base R type
    #'
