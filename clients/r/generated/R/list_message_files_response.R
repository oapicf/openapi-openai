#' Create a new ListMessageFilesResponse
#'
#' @description
...
#' @description ListMessageFilesResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{MessageFileObject})
...
#' @export
ListMessageFilesResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListMessageFilesResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ListMessageFilesResponse as a base R list.
    #' @examples
    #' # convert array of ListMessageFilesResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListMessageFilesResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListMessageFilesResponseObject <- list()
      if (!is.null(self$`object`)) {
        ListMessageFilesResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ListMessageFilesResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ListMessageFilesResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ListMessageFilesResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ListMessageFilesResponseObject[["has_more"]] <-
          self$`has_more`
      }
      return(ListMessageFilesResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ListMessageFilesResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListMessageFilesResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[MessageFileObject]", loadNamespace("openapi"))
      }
    ...
    #' @return ListMessageFilesResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListMessageFilesResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessageFilesResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessageFilesResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessageFilesResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessageFilesResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessageFilesResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ListMessageFilesResponse
    toString = function() {
      self$toJSONString()
    },
...
# ListMessageFilesResponse$unlock()
#
## Below is an example to define the print function
# ListMessageFilesResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListMessageFilesResponse$lock()
