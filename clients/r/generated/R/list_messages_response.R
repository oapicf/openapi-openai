#' Create a new ListMessagesResponse
#'
#' @description
...
#' @description ListMessagesResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{MessageObject})
...
#' @export
ListMessagesResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListMessagesResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ListMessagesResponse as a base R list.
    #' @examples
    #' # convert array of ListMessagesResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListMessagesResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListMessagesResponseObject <- list()
      if (!is.null(self$`object`)) {
        ListMessagesResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ListMessagesResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ListMessagesResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ListMessagesResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ListMessagesResponseObject[["has_more"]] <-
          self$`has_more`
      }
      return(ListMessagesResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ListMessagesResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListMessagesResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[MessageObject]", loadNamespace("openapi"))
      }
    ...
    #' @return ListMessagesResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListMessagesResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessagesResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessagesResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessagesResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessagesResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListMessagesResponse: the required field `has_more` is missing."))
      }
    },
...
# ListMessagesResponse$unlock()
#
## Below is an example to define the print function
# ListMessagesResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListMessagesResponse$lock()
