...
ListPaginatedFineTuningJobsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ListPaginatedFineTuningJobsResponse as a base R list.
    #' @examples
    #' # convert array of ListPaginatedFineTuningJobsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListPaginatedFineTuningJobsResponse to a base R type
    #'
