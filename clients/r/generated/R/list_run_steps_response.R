...
ListRunStepsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ListRunStepsResponse as a base R list.
    #' @examples
    #' # convert array of ListRunStepsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListRunStepsResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ListRunStepsResponseObject)
    },
