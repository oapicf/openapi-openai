...
#' @description ListRunsResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{RunObject})
...
ListRunsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListRunsResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ListRunsResponse as a base R list.
    #' @examples
    #' # convert array of ListRunsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListRunsResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListRunsResponseObject <- list()
      if (!is.null(self$`object`)) {
        ListRunsResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ListRunsResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ListRunsResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ListRunsResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ListRunsResponseObject[["has_more"]] <-
          self$`has_more`
      }
      return(ListRunsResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ListRunsResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListRunsResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[RunObject]", loadNamespace("openapi"))
      }
    ...
    #' @return ListRunsResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListRunsResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListRunsResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListRunsResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListRunsResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListRunsResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListRunsResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ListRunsResponse
    toString = function() {
      self$toJSONString()
    },
...
# ListRunsResponse$unlock()
#
## Below is an example to define the print function
# ListRunsResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListRunsResponse$lock()
