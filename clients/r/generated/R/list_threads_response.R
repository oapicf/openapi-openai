...
ListThreadsResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ListThreadsResponse as a base R list.
    #' @examples
    #' # convert array of ListThreadsResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListThreadsResponse to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ListThreadsResponseObject)
    },
