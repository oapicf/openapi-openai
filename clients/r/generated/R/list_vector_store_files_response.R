#' Create a new ListVectorStoreFilesResponse
#'
#' @description
...
#' @description ListVectorStoreFilesResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{VectorStoreFileObject})
...
#' @export
ListVectorStoreFilesResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListVectorStoreFilesResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ListVectorStoreFilesResponse as a base R list.
    #' @examples
    #' # convert array of ListVectorStoreFilesResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListVectorStoreFilesResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListVectorStoreFilesResponseObject <- list()
      if (!is.null(self$`object`)) {
        ListVectorStoreFilesResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ListVectorStoreFilesResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ListVectorStoreFilesResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ListVectorStoreFilesResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ListVectorStoreFilesResponseObject[["has_more"]] <-
          self$`has_more`
      }
      return(ListVectorStoreFilesResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ListVectorStoreFilesResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListVectorStoreFilesResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[VectorStoreFileObject]", loadNamespace("openapi"))
      }
    ...
    #' @return ListVectorStoreFilesResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListVectorStoreFilesResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoreFilesResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoreFilesResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoreFilesResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoreFilesResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoreFilesResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ListVectorStoreFilesResponse
    toString = function() {
      self$toJSONString()
    },
...
# ListVectorStoreFilesResponse$unlock()
#
## Below is an example to define the print function
# ListVectorStoreFilesResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListVectorStoreFilesResponse$lock()
