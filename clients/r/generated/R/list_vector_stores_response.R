#' Create a new ListVectorStoresResponse
#'
#' @description
...
#' @description ListVectorStoresResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{VectorStoreObject})
...
#' @export
ListVectorStoresResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListVectorStoresResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ListVectorStoresResponse as a base R list.
    #' @examples
    #' # convert array of ListVectorStoresResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListVectorStoresResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListVectorStoresResponseObject <- list()
      if (!is.null(self$`object`)) {
        ListVectorStoresResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ListVectorStoresResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ListVectorStoresResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ListVectorStoresResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ListVectorStoresResponseObject[["has_more"]] <-
          self$`has_more`
      }
      return(ListVectorStoresResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ListVectorStoresResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListVectorStoresResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[VectorStoreObject]", loadNamespace("openapi"))
      }
    ...
    #' @return ListVectorStoresResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListVectorStoresResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoresResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoresResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoresResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoresResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ListVectorStoresResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ListVectorStoresResponse
    toString = function() {
      self$toJSONString()
    },
...
# ListVectorStoresResponse$unlock()
#
## Below is an example to define the print function
# ListVectorStoresResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListVectorStoresResponse$lock()
