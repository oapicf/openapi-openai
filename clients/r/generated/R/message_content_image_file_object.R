...
MessageContentImageFileObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageContentImageFileObject as a base R list.
    #' @examples
    #' # convert array of MessageContentImageFileObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageContentImageFileObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageContentImageFileObjectObject)
    },
