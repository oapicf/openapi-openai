...
MessageContentTextAnnotationsFileCitationObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageContentTextAnnotationsFileCitationObject as a base R list.
    #' @examples
    #' # convert array of MessageContentTextAnnotationsFileCitationObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageContentTextAnnotationsFileCitationObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageContentTextAnnotationsFileCitationObjectObject)
    },
