...
MessageContentTextAnnotationsFilePathObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageContentTextAnnotationsFilePathObject as a base R list.
    #' @examples
    #' # convert array of MessageContentTextAnnotationsFilePathObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageContentTextAnnotationsFilePathObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageContentTextAnnotationsFilePathObjectObject)
    },
