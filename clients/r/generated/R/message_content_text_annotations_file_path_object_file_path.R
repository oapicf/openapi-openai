...
MessageContentTextAnnotationsFilePathObjectFilePath <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageContentTextAnnotationsFilePathObjectFilePath as a base R list.
    #' @examples
    #' # convert array of MessageContentTextAnnotationsFilePathObjectFilePath (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageContentTextAnnotationsFilePathObjectFilePath to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageContentTextAnnotationsFilePathObjectFilePathObject)
    },
