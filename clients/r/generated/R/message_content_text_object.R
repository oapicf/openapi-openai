...
MessageContentTextObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageContentTextObject as a base R list.
    #' @examples
    #' # convert array of MessageContentTextObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageContentTextObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageContentTextObjectObject)
    },
