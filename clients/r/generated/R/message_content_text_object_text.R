...
MessageContentTextObjectText <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageContentTextObjectText as a base R list.
    #' @examples
    #' # convert array of MessageContentTextObjectText (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageContentTextObjectText to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageContentTextObjectTextObject)
    },
