...
MessageDeltaContentTextAnnotationsFilePathObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageDeltaContentTextAnnotationsFilePathObject as a base R list.
    #' @examples
    #' # convert array of MessageDeltaContentTextAnnotationsFilePathObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageDeltaContentTextAnnotationsFilePathObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageDeltaContentTextAnnotationsFilePathObjectObject)
    },
