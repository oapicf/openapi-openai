...
MessageDeltaContentTextObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageDeltaContentTextObject as a base R list.
    #' @examples
    #' # convert array of MessageDeltaContentTextObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageDeltaContentTextObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`text`)) {
        MessageDeltaContentTextObjectObject[["text"]] <-
          self$`text`$toSimpleType()
      }
      return(MessageDeltaContentTextObjectObject)
    },
