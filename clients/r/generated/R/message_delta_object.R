...
MessageDeltaObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageDeltaObject as a base R list.
    #' @examples
    #' # convert array of MessageDeltaObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageDeltaObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageDeltaObjectObject)
    },
