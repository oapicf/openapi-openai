...
MessageObjectContentInner <- R6::R6Class(
  ...
  public = list(
    ...
    #' Serialize MessageObjectContentInner to JSON.
    #'
    #' @description
    #' Serialize MessageObjectContentInner to JSON.
    #'
    #' @return JSON representation of the MessageObjectContentInner.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to MessageObjectContentInner.
    #'
    #' @description
