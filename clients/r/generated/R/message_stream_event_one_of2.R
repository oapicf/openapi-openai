...
MessageStreamEventOneOf2 <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return MessageStreamEventOneOf2 as a base R list.
    #' @examples
    #' # convert array of MessageStreamEventOneOf2 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MessageStreamEventOneOf2 to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(MessageStreamEventOneOf2Object)
    },
