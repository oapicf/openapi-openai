...
ModifyMessageRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ModifyMessageRequest as a base R list.
    #' @examples
    #' # convert array of ModifyMessageRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModifyMessageRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(ModifyMessageRequestObject)
    },
