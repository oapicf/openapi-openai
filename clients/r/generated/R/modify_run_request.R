...
ModifyRunRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ModifyRunRequest as a base R list.
    #' @examples
    #' # convert array of ModifyRunRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ModifyRunRequest to a base R type
    #'
