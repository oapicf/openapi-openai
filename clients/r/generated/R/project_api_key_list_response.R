#' Create a new ProjectApiKeyListResponse
#'
#' @description
...
#' @description ProjectApiKeyListResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{ProjectApiKey})
...
#' @export
ProjectApiKeyListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProjectApiKeyListResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ProjectApiKeyListResponse as a base R list.
    #' @examples
    #' # convert array of ProjectApiKeyListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProjectApiKeyListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProjectApiKeyListResponseObject <- list()
      if (!is.null(self$`object`)) {
        ProjectApiKeyListResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ProjectApiKeyListResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ProjectApiKeyListResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ProjectApiKeyListResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ProjectApiKeyListResponseObject[["has_more"]] <-
          self$`has_more`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProjectApiKeyListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProjectApiKeyListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[ProjectApiKey]", loadNamespace("openapi"))
      }
    ...
    #' @return ProjectApiKeyListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProjectApiKeyListResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectApiKeyListResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectApiKeyListResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectApiKeyListResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectApiKeyListResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectApiKeyListResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProjectApiKeyListResponse
    toString = function() {
      self$toJSONString()
    },
...
# ProjectApiKeyListResponse$unlock()
#
## Below is an example to define the print function
# ProjectApiKeyListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProjectApiKeyListResponse$lock()
