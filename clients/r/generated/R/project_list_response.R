...
#' @description ProjectListResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{Project})
...
#' @export
ProjectListResponse <- R6::R6Class(
  "ProjectListResponse",
  public = list(
    `object` = NULL,
    `data` = NULL,
    ...
    #' @description
    #' Initialize a new ProjectListResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ProjectListResponse as a base R list.
    #' @examples
    #' # convert array of ProjectListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProjectListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProjectListResponseObject <- list()
      if (!is.null(self$`object`)) {
        ProjectListResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ProjectListResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ProjectListResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ProjectListResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ProjectListResponseObject[["has_more"]] <-
          self$`has_more`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProjectListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProjectListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[Project]", loadNamespace("openapi"))
      }
    ...
    #' @return ProjectListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProjectListResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectListResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectListResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectListResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectListResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectListResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProjectListResponse
    toString = function() {
      self$toJSONString()
    },
...
# ProjectListResponse$unlock()
#
## Below is an example to define the print function
# ProjectListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProjectListResponse$lock()
