#' Create a new ProjectRateLimitListResponse
#'
#' @description
#' ProjectRateLimitListResponse Class
#'
#' @docType class
#' @title ProjectRateLimitListResponse
#' @description ProjectRateLimitListResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{ProjectRateLimit})
...
#' @export
ProjectRateLimitListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProjectRateLimitListResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ProjectRateLimitListResponse as a base R list.
    #' @examples
    #' # convert array of ProjectRateLimitListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProjectRateLimitListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProjectRateLimitListResponseObject <- list()
      if (!is.null(self$`object`)) {
        ProjectRateLimitListResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ProjectRateLimitListResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ProjectRateLimitListResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ProjectRateLimitListResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ProjectRateLimitListResponseObject[["has_more"]] <-
          self$`has_more`
      }
      return(ProjectRateLimitListResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ProjectRateLimitListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProjectRateLimitListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[ProjectRateLimit]", loadNamespace("openapi"))
      }
    ...
    #' @return ProjectRateLimitListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProjectRateLimitListResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectRateLimitListResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectRateLimitListResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectRateLimitListResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectRateLimitListResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectRateLimitListResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProjectRateLimitListResponse
    toString = function() {
      self$toJSONString()
    },
...
# ProjectRateLimitListResponse$unlock()
#
## Below is an example to define the print function
# ProjectRateLimitListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProjectRateLimitListResponse$lock()
