#' Create a new ProjectServiceAccountListResponse
#'
#' @description
#' ProjectServiceAccountListResponse Class
#'
#' @docType class
#' @title ProjectServiceAccountListResponse
#' @description ProjectServiceAccountListResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{ProjectServiceAccount})
...
#' @export
ProjectServiceAccountListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProjectServiceAccountListResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ProjectServiceAccountListResponse as a base R list.
    #' @examples
    #' # convert array of ProjectServiceAccountListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProjectServiceAccountListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProjectServiceAccountListResponseObject <- list()
      if (!is.null(self$`object`)) {
        ProjectServiceAccountListResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ProjectServiceAccountListResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ProjectServiceAccountListResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ProjectServiceAccountListResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ProjectServiceAccountListResponseObject[["has_more"]] <-
          self$`has_more`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of ProjectServiceAccountListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProjectServiceAccountListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[ProjectServiceAccount]", loadNamespace("openapi"))
      }
    ...
    #' @return ProjectServiceAccountListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProjectServiceAccountListResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectServiceAccountListResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectServiceAccountListResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectServiceAccountListResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectServiceAccountListResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectServiceAccountListResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProjectServiceAccountListResponse
    toString = function() {
      self$toJSONString()
    },
...
# ProjectServiceAccountListResponse$unlock()
#
## Below is an example to define the print function
# ProjectServiceAccountListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProjectServiceAccountListResponse$lock()
