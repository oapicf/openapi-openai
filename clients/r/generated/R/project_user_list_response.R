#' Create a new ProjectUserListResponse
#'
#' @description
#' ProjectUserListResponse Class
#'
#' @docType class
#' @title ProjectUserListResponse
#' @description ProjectUserListResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{ProjectUser})
...
#' @export
ProjectUserListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ProjectUserListResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return ProjectUserListResponse as a base R list.
    #' @examples
    #' # convert array of ProjectUserListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ProjectUserListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ProjectUserListResponseObject <- list()
      if (!is.null(self$`object`)) {
        ProjectUserListResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        ProjectUserListResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        ProjectUserListResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        ProjectUserListResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        ProjectUserListResponseObject[["has_more"]] <-
          self$`has_more`
      }
      return(ProjectUserListResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ProjectUserListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of ProjectUserListResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[ProjectUser]", loadNamespace("openapi"))
      }
    ...
    #' @return ProjectUserListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ProjectUserListResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectUserListResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectUserListResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectUserListResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectUserListResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ProjectUserListResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of ProjectUserListResponse
    toString = function() {
      self$toJSONString()
    },
...
# ProjectUserListResponse$unlock()
#
## Below is an example to define the print function
# ProjectUserListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ProjectUserListResponse$lock()
