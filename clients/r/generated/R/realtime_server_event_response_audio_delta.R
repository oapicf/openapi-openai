#' Create a new RealtimeServerEventResponseAudioDelta
#'
#' @description
#' Returned when the model-generated audio is updated.
#'
#' @docType class
#' @title RealtimeServerEventResponseAudioDelta
#' @description RealtimeServerEventResponseAudioDelta Class
#' @format An \code{R6Class} generator object
#' @field event_id The unique ID of the server event. character
#' @field type The event type, must be `response.audio.delta`. character
...
#' @field delta Base64-encoded audio data delta. character
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
RealtimeServerEventResponseAudioDelta <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeServerEventResponseAudioDelta class.
    #'
    ...
    initialize = function(`event_id`, `type`, `response_id`, `item_id`, `output_index`, `content_index`, `delta`, ...) {
      ...
      if (!missing(`type`)) {
        if (!(`type` %in% c("response.audio.delta"))) {
          stop(paste("Error! \"", `type`, "\" cannot be assigned to `type`. Must be \"response.audio.delta\".", sep = ""))
        }
    ...
    #'
    #' @return RealtimeServerEventResponseAudioDelta as a base R list.
    #' @examples
    #' # convert array of RealtimeServerEventResponseAudioDelta (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeServerEventResponseAudioDelta to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeServerEventResponseAudioDeltaObject <- list()
      if (!is.null(self$`event_id`)) {
        RealtimeServerEventResponseAudioDeltaObject[["event_id"]] <-
          self$`event_id`
      }
      if (!is.null(self$`type`)) {
        RealtimeServerEventResponseAudioDeltaObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`response_id`)) {
        RealtimeServerEventResponseAudioDeltaObject[["response_id"]] <-
          self$`response_id`
      }
      if (!is.null(self$`item_id`)) {
        RealtimeServerEventResponseAudioDeltaObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`output_index`)) {
        RealtimeServerEventResponseAudioDeltaObject[["output_index"]] <-
          self$`output_index`
      }
      if (!is.null(self$`content_index`)) {
        RealtimeServerEventResponseAudioDeltaObject[["content_index"]] <-
          self$`content_index`
      }
      if (!is.null(self$`delta`)) {
        RealtimeServerEventResponseAudioDeltaObject[["delta"]] <-
          self$`delta`
      }
      return(RealtimeServerEventResponseAudioDeltaObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeServerEventResponseAudioDelta
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeServerEventResponseAudioDelta
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`type`)) {
        if (!is.null(this_object$`type`) && !(this_object$`type` %in% c("response.audio.delta"))) {
          stop(paste("Error! \"", this_object$`type`, "\" cannot be assigned to `type`. Must be \"response.audio.delta\".", sep = ""))
        }
    ...
    #' @return RealtimeServerEventResponseAudioDelta in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RealtimeServerEventResponseAudioDelta and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDelta: the required field `event_id` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDelta: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`response_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDelta: the required field `response_id` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDelta: the required field `item_id` is missing."))
      }
      ...
      if (!is.null(input_json$`output_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDelta: the required field `output_index` is missing."))
      }
      ...
      if (!is.null(input_json$`content_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDelta: the required field `content_index` is missing."))
      }
      ...
      if (!is.null(input_json$`delta`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDelta: the required field `delta` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RealtimeServerEventResponseAudioDelta
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeServerEventResponseAudioDelta$unlock()
#
## Below is an example to define the print function
# RealtimeServerEventResponseAudioDelta$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeServerEventResponseAudioDelta$lock()
