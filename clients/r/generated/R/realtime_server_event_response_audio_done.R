#' Create a new RealtimeServerEventResponseAudioDone
#'
#' @description
#' Returned when the model-generated audio is done. Also emitted when a Response is interrupted, incomplete, or cancelled. 
#'
#' @docType class
#' @title RealtimeServerEventResponseAudioDone
#' @description RealtimeServerEventResponseAudioDone Class
#' @format An \code{R6Class} generator object
#' @field event_id The unique ID of the server event. character
#' @field type The event type, must be `response.audio.done`. character
...
#' @export
RealtimeServerEventResponseAudioDone <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeServerEventResponseAudioDone class.
    #'
    ...
    initialize = function(`event_id`, `type`, `response_id`, `item_id`, `output_index`, `content_index`, ...) {
      if (!missing(`event_id`)) {
      ...
      if (!missing(`type`)) {
        if (!(`type` %in% c("response.audio.done"))) {
          stop(paste("Error! \"", `type`, "\" cannot be assigned to `type`. Must be \"response.audio.done\".", sep = ""))
        }
    ...
    #'
    #' @return RealtimeServerEventResponseAudioDone as a base R list.
    #' @examples
    #' # convert array of RealtimeServerEventResponseAudioDone (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeServerEventResponseAudioDone to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeServerEventResponseAudioDoneObject <- list()
      if (!is.null(self$`event_id`)) {
        RealtimeServerEventResponseAudioDoneObject[["event_id"]] <-
          self$`event_id`
      }
      if (!is.null(self$`type`)) {
        RealtimeServerEventResponseAudioDoneObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`response_id`)) {
        RealtimeServerEventResponseAudioDoneObject[["response_id"]] <-
          self$`response_id`
      }
      if (!is.null(self$`item_id`)) {
        RealtimeServerEventResponseAudioDoneObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`output_index`)) {
        RealtimeServerEventResponseAudioDoneObject[["output_index"]] <-
          self$`output_index`
      }
      if (!is.null(self$`content_index`)) {
        RealtimeServerEventResponseAudioDoneObject[["content_index"]] <-
          self$`content_index`
      }
      return(RealtimeServerEventResponseAudioDoneObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeServerEventResponseAudioDone
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeServerEventResponseAudioDone
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`type`)) {
        if (!is.null(this_object$`type`) && !(this_object$`type` %in% c("response.audio.done"))) {
          stop(paste("Error! \"", this_object$`type`, "\" cannot be assigned to `type`. Must be \"response.audio.done\".", sep = ""))
        }
    ...
    #' @return RealtimeServerEventResponseAudioDone in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RealtimeServerEventResponseAudioDone and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDone: the required field `event_id` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDone: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`response_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDone: the required field `response_id` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDone: the required field `item_id` is missing."))
      }
      ...
      if (!is.null(input_json$`output_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDone: the required field `output_index` is missing."))
      }
      ...
      if (!is.null(input_json$`content_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioDone: the required field `content_index` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RealtimeServerEventResponseAudioDone
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeServerEventResponseAudioDone$unlock()
#
## Below is an example to define the print function
# RealtimeServerEventResponseAudioDone$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeServerEventResponseAudioDone$lock()
