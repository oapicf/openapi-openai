#' Create a new RealtimeServerEventResponseAudioTranscriptDelta
#'
#' @description
#' Returned when the model-generated transcription of audio output is updated. 
#'
#' @docType class
#' @title RealtimeServerEventResponseAudioTranscriptDelta
#' @description RealtimeServerEventResponseAudioTranscriptDelta Class
#' @format An \code{R6Class} generator object
#' @field event_id The unique ID of the server event. character
#' @field type The event type, must be `response.audio_transcript.delta`. character
...
#' @field delta The transcript delta. character
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
RealtimeServerEventResponseAudioTranscriptDelta <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeServerEventResponseAudioTranscriptDelta class.
    #'
    ...
    initialize = function(`event_id`, `type`, `response_id`, `item_id`, `output_index`, `content_index`, `delta`, ...) {
      if (!missing(`event_id`)) {
      ...
      if (!missing(`type`)) {
        if (!(`type` %in% c("response.audio_transcript.delta"))) {
          stop(paste("Error! \"", `type`, "\" cannot be assigned to `type`. Must be \"response.audio_transcript.delta\".", sep = ""))
        }
    ...
    #'
    #' @return RealtimeServerEventResponseAudioTranscriptDelta as a base R list.
    #' @examples
    #' # convert array of RealtimeServerEventResponseAudioTranscriptDelta (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeServerEventResponseAudioTranscriptDelta to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeServerEventResponseAudioTranscriptDeltaObject <- list()
      if (!is.null(self$`event_id`)) {
        RealtimeServerEventResponseAudioTranscriptDeltaObject[["event_id"]] <-
          self$`event_id`
      }
      if (!is.null(self$`type`)) {
        RealtimeServerEventResponseAudioTranscriptDeltaObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`response_id`)) {
        RealtimeServerEventResponseAudioTranscriptDeltaObject[["response_id"]] <-
          self$`response_id`
      }
      if (!is.null(self$`item_id`)) {
        RealtimeServerEventResponseAudioTranscriptDeltaObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`output_index`)) {
        RealtimeServerEventResponseAudioTranscriptDeltaObject[["output_index"]] <-
          self$`output_index`
      }
      if (!is.null(self$`content_index`)) {
        RealtimeServerEventResponseAudioTranscriptDeltaObject[["content_index"]] <-
          self$`content_index`
      }
      if (!is.null(self$`delta`)) {
        RealtimeServerEventResponseAudioTranscriptDeltaObject[["delta"]] <-
          self$`delta`
      }
      return(RealtimeServerEventResponseAudioTranscriptDeltaObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeServerEventResponseAudioTranscriptDelta
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeServerEventResponseAudioTranscriptDelta
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`type`)) {
        if (!is.null(this_object$`type`) && !(this_object$`type` %in% c("response.audio_transcript.delta"))) {
          stop(paste("Error! \"", this_object$`type`, "\" cannot be assigned to `type`. Must be \"response.audio_transcript.delta\".", sep = ""))
        }
    ...
    #' @return RealtimeServerEventResponseAudioTranscriptDelta in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RealtimeServerEventResponseAudioTranscriptDelta and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDelta: the required field `event_id` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDelta: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`response_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDelta: the required field `response_id` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDelta: the required field `item_id` is missing."))
      }
      ...
      if (!is.null(input_json$`output_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDelta: the required field `output_index` is missing."))
      }
      ...
      if (!is.null(input_json$`content_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDelta: the required field `content_index` is missing."))
      }
      ...
      if (!is.null(input_json$`delta`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDelta: the required field `delta` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RealtimeServerEventResponseAudioTranscriptDelta
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeServerEventResponseAudioTranscriptDelta$unlock()
#
## Below is an example to define the print function
# RealtimeServerEventResponseAudioTranscriptDelta$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeServerEventResponseAudioTranscriptDelta$lock()
