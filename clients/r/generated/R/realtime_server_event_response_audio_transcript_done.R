#' Create a new RealtimeServerEventResponseAudioTranscriptDone
#'
#' @description
#' Returned when the model-generated transcription of audio output is done streaming. Also emitted when a Response is interrupted, incomplete, or cancelled. 
#'
#' @docType class
#' @title RealtimeServerEventResponseAudioTranscriptDone
#' @description RealtimeServerEventResponseAudioTranscriptDone Class
#' @format An \code{R6Class} generator object
#' @field event_id The unique ID of the server event. character
#' @field type The event type, must be `response.audio_transcript.done`. character
...
#' @field transcript The final transcript of the audio. character
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
RealtimeServerEventResponseAudioTranscriptDone <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeServerEventResponseAudioTranscriptDone class.
    #'
    ...
    initialize = function(`event_id`, `type`, `response_id`, `item_id`, `output_index`, `content_index`, `transcript`, ...) {
      if (!missing(`event_id`)) {
      ...
      if (!missing(`type`)) {
        if (!(`type` %in% c("response.audio_transcript.done"))) {
          stop(paste("Error! \"", `type`, "\" cannot be assigned to `type`. Must be \"response.audio_transcript.done\".", sep = ""))
        }
    ...
    #'
    #' @return RealtimeServerEventResponseAudioTranscriptDone as a base R list.
    #' @examples
    #' # convert array of RealtimeServerEventResponseAudioTranscriptDone (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeServerEventResponseAudioTranscriptDone to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeServerEventResponseAudioTranscriptDoneObject <- list()
      if (!is.null(self$`event_id`)) {
        RealtimeServerEventResponseAudioTranscriptDoneObject[["event_id"]] <-
          self$`event_id`
      }
      if (!is.null(self$`type`)) {
        RealtimeServerEventResponseAudioTranscriptDoneObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`response_id`)) {
        RealtimeServerEventResponseAudioTranscriptDoneObject[["response_id"]] <-
          self$`response_id`
      }
      if (!is.null(self$`item_id`)) {
        RealtimeServerEventResponseAudioTranscriptDoneObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`output_index`)) {
        RealtimeServerEventResponseAudioTranscriptDoneObject[["output_index"]] <-
          self$`output_index`
      }
      if (!is.null(self$`content_index`)) {
        RealtimeServerEventResponseAudioTranscriptDoneObject[["content_index"]] <-
          self$`content_index`
      }
      if (!is.null(self$`transcript`)) {
        RealtimeServerEventResponseAudioTranscriptDoneObject[["transcript"]] <-
          self$`transcript`
      }
      return(RealtimeServerEventResponseAudioTranscriptDoneObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeServerEventResponseAudioTranscriptDone
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeServerEventResponseAudioTranscriptDone
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`type`)) {
        if (!is.null(this_object$`type`) && !(this_object$`type` %in% c("response.audio_transcript.done"))) {
          stop(paste("Error! \"", this_object$`type`, "\" cannot be assigned to `type`. Must be \"response.audio_transcript.done\".", sep = ""))
        }
    ...
    #' @return RealtimeServerEventResponseAudioTranscriptDone in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RealtimeServerEventResponseAudioTranscriptDone and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDone: the required field `event_id` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDone: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`response_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDone: the required field `response_id` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDone: the required field `item_id` is missing."))
      }
      ...
      if (!is.null(input_json$`output_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDone: the required field `output_index` is missing."))
      }
      ...
      if (!is.null(input_json$`content_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDone: the required field `content_index` is missing."))
      }
      ...
      if (!is.null(input_json$`transcript`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseAudioTranscriptDone: the required field `transcript` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RealtimeServerEventResponseAudioTranscriptDone
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeServerEventResponseAudioTranscriptDone$unlock()
#
## Below is an example to define the print function
# RealtimeServerEventResponseAudioTranscriptDone$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeServerEventResponseAudioTranscriptDone$lock()
