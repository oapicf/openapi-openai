#' Create a new RealtimeServerEventResponseContentPartDone
#'
#' @description
#' Returned when a content part is done streaming in an assistant message item. Also emitted when a Response is interrupted, incomplete, or cancelled. 
#'
#' @docType class
#' @title RealtimeServerEventResponseContentPartDone
#' @description RealtimeServerEventResponseContentPartDone Class
#' @format An \code{R6Class} generator object
#' @field event_id The unique ID of the server event. character
#' @field type The event type, must be `response.content_part.done`. character
...
#' @field part  \link{RealtimeServerEventResponseContentPartDonePart}
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
RealtimeServerEventResponseContentPartDone <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeServerEventResponseContentPartDone class.
    #'
    ...
    initialize = function(`event_id`, `type`, `response_id`, `item_id`, `output_index`, `content_index`, `part`, ...) {
      ...
      if (!missing(`type`)) {
        if (!(`type` %in% c("response.content_part.done"))) {
          stop(paste("Error! \"", `type`, "\" cannot be assigned to `type`. Must be \"response.content_part.done\".", sep = ""))
        }
    ...
    #'
    #' @return RealtimeServerEventResponseContentPartDone as a base R list.
    #' @examples
    #' # convert array of RealtimeServerEventResponseContentPartDone (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeServerEventResponseContentPartDone to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeServerEventResponseContentPartDoneObject <- list()
      if (!is.null(self$`event_id`)) {
        RealtimeServerEventResponseContentPartDoneObject[["event_id"]] <-
          self$`event_id`
      }
      if (!is.null(self$`type`)) {
        RealtimeServerEventResponseContentPartDoneObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`response_id`)) {
        RealtimeServerEventResponseContentPartDoneObject[["response_id"]] <-
          self$`response_id`
      }
      if (!is.null(self$`item_id`)) {
        RealtimeServerEventResponseContentPartDoneObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`output_index`)) {
        RealtimeServerEventResponseContentPartDoneObject[["output_index"]] <-
          self$`output_index`
      }
      if (!is.null(self$`content_index`)) {
        RealtimeServerEventResponseContentPartDoneObject[["content_index"]] <-
          self$`content_index`
      }
      if (!is.null(self$`part`)) {
        RealtimeServerEventResponseContentPartDoneObject[["part"]] <-
          self$`part`$toSimpleType()
      }
      return(RealtimeServerEventResponseContentPartDoneObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeServerEventResponseContentPartDone
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeServerEventResponseContentPartDone
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`type`)) {
        if (!is.null(this_object$`type`) && !(this_object$`type` %in% c("response.content_part.done"))) {
          stop(paste("Error! \"", this_object$`type`, "\" cannot be assigned to `type`. Must be \"response.content_part.done\".", sep = ""))
        }
      ...
      if (!is.null(this_object$`part`)) {
        `part_object` <- RealtimeServerEventResponseContentPartDonePart$new()
    ...
    #' @return RealtimeServerEventResponseContentPartDone in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`output_index` <- this_object$`output_index`
      self$`content_index` <- this_object$`content_index`
      self$`part` <- RealtimeServerEventResponseContentPartDonePart$new()$fromJSON(jsonlite::toJSON(this_object$`part`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to RealtimeServerEventResponseContentPartDone and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseContentPartDone: the required field `event_id` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseContentPartDone: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`response_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseContentPartDone: the required field `response_id` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseContentPartDone: the required field `item_id` is missing."))
      }
      ...
      if (!is.null(input_json$`output_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseContentPartDone: the required field `output_index` is missing."))
      }
      ...
      if (!is.null(input_json$`content_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseContentPartDone: the required field `content_index` is missing."))
      }
      # check the required field `part`
      if (!is.null(input_json$`part`)) {
        stopifnot(R6::is.R6(input_json$`part`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseContentPartDone: the required field `part` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RealtimeServerEventResponseContentPartDone
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeServerEventResponseContentPartDone$unlock()
#
## Below is an example to define the print function
# RealtimeServerEventResponseContentPartDone$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeServerEventResponseContentPartDone$lock()
