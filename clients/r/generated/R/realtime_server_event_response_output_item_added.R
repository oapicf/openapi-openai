#' Create a new RealtimeServerEventResponseOutputItemAdded
#'
#' @description
#' Returned when a new Item is created during Response generation.
#'
#' @docType class
#' @title RealtimeServerEventResponseOutputItemAdded
#' @description RealtimeServerEventResponseOutputItemAdded Class
#' @format An \code{R6Class} generator object
#' @field event_id The unique ID of the server event. character
#' @field type The event type, must be `response.output_item.added`. character
...
#' @export
RealtimeServerEventResponseOutputItemAdded <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeServerEventResponseOutputItemAdded class.
    #'
    ...
    initialize = function(`event_id`, `type`, `response_id`, `output_index`, `item`, ...) {
      ...
      if (!missing(`type`)) {
        if (!(`type` %in% c("response.output_item.added"))) {
          stop(paste("Error! \"", `type`, "\" cannot be assigned to `type`. Must be \"response.output_item.added\".", sep = ""))
        }
    ...
    #'
    #' @return RealtimeServerEventResponseOutputItemAdded as a base R list.
    #' @examples
    #' # convert array of RealtimeServerEventResponseOutputItemAdded (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeServerEventResponseOutputItemAdded to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeServerEventResponseOutputItemAddedObject <- list()
      if (!is.null(self$`event_id`)) {
        RealtimeServerEventResponseOutputItemAddedObject[["event_id"]] <-
          self$`event_id`
      }
      if (!is.null(self$`type`)) {
        RealtimeServerEventResponseOutputItemAddedObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`response_id`)) {
        RealtimeServerEventResponseOutputItemAddedObject[["response_id"]] <-
          self$`response_id`
      }
      if (!is.null(self$`output_index`)) {
        RealtimeServerEventResponseOutputItemAddedObject[["output_index"]] <-
          self$`output_index`
      }
      if (!is.null(self$`item`)) {
        RealtimeServerEventResponseOutputItemAddedObject[["item"]] <-
          self$`item`$toSimpleType()
      }
      return(RealtimeServerEventResponseOutputItemAddedObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeServerEventResponseOutputItemAdded
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeServerEventResponseOutputItemAdded
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`type`)) {
        if (!is.null(this_object$`type`) && !(this_object$`type` %in% c("response.output_item.added"))) {
          stop(paste("Error! \"", this_object$`type`, "\" cannot be assigned to `type`. Must be \"response.output_item.added\".", sep = ""))
        }
    ...
    #' @return RealtimeServerEventResponseOutputItemAdded in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RealtimeServerEventResponseOutputItemAdded and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseOutputItemAdded: the required field `event_id` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseOutputItemAdded: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`response_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseOutputItemAdded: the required field `response_id` is missing."))
      }
      ...
      if (!is.null(input_json$`output_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseOutputItemAdded: the required field `output_index` is missing."))
      }
      # check the required field `item`
      if (!is.null(input_json$`item`)) {
        stopifnot(R6::is.R6(input_json$`item`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseOutputItemAdded: the required field `item` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RealtimeServerEventResponseOutputItemAdded
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeServerEventResponseOutputItemAdded$unlock()
#
## Below is an example to define the print function
# RealtimeServerEventResponseOutputItemAdded$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeServerEventResponseOutputItemAdded$lock()
