#' Create a new RealtimeServerEventResponseTextDelta
#'
#' @description
#' Returned when the text value of a \"text\" content part is updated.
#'
#' @docType class
#' @title RealtimeServerEventResponseTextDelta
#' @description RealtimeServerEventResponseTextDelta Class
#' @format An \code{R6Class} generator object
#' @field event_id The unique ID of the server event. character
#' @field type The event type, must be `response.text.delta`. character
...
#' @field delta The text delta. character
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
RealtimeServerEventResponseTextDelta <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeServerEventResponseTextDelta class.
    #'
    ...
    initialize = function(`event_id`, `type`, `response_id`, `item_id`, `output_index`, `content_index`, `delta`, ...) {
      ...
      if (!missing(`type`)) {
        if (!(`type` %in% c("response.text.delta"))) {
          stop(paste("Error! \"", `type`, "\" cannot be assigned to `type`. Must be \"response.text.delta\".", sep = ""))
        }
    ...
    #'
    #' @return RealtimeServerEventResponseTextDelta as a base R list.
    #' @examples
    #' # convert array of RealtimeServerEventResponseTextDelta (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeServerEventResponseTextDelta to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeServerEventResponseTextDeltaObject <- list()
      if (!is.null(self$`event_id`)) {
        RealtimeServerEventResponseTextDeltaObject[["event_id"]] <-
          self$`event_id`
      }
      if (!is.null(self$`type`)) {
        RealtimeServerEventResponseTextDeltaObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`response_id`)) {
        RealtimeServerEventResponseTextDeltaObject[["response_id"]] <-
          self$`response_id`
      }
      if (!is.null(self$`item_id`)) {
        RealtimeServerEventResponseTextDeltaObject[["item_id"]] <-
          self$`item_id`
      }
      if (!is.null(self$`output_index`)) {
        RealtimeServerEventResponseTextDeltaObject[["output_index"]] <-
          self$`output_index`
      }
      if (!is.null(self$`content_index`)) {
        RealtimeServerEventResponseTextDeltaObject[["content_index"]] <-
          self$`content_index`
      }
      if (!is.null(self$`delta`)) {
        RealtimeServerEventResponseTextDeltaObject[["delta"]] <-
          self$`delta`
      }
      return(RealtimeServerEventResponseTextDeltaObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeServerEventResponseTextDelta
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeServerEventResponseTextDelta
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`type`)) {
        if (!is.null(this_object$`type`) && !(this_object$`type` %in% c("response.text.delta"))) {
          stop(paste("Error! \"", this_object$`type`, "\" cannot be assigned to `type`. Must be \"response.text.delta\".", sep = ""))
        }
    ...
    #' @return RealtimeServerEventResponseTextDelta in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RealtimeServerEventResponseTextDelta and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseTextDelta: the required field `event_id` is missing."))
      }
      ...
      if (!is.null(input_json$`type`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseTextDelta: the required field `type` is missing."))
      }
      ...
      if (!is.null(input_json$`response_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseTextDelta: the required field `response_id` is missing."))
      }
      ...
      if (!is.null(input_json$`item_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseTextDelta: the required field `item_id` is missing."))
      }
      ...
      if (!is.null(input_json$`output_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseTextDelta: the required field `output_index` is missing."))
      }
      ...
      if (!is.null(input_json$`content_index`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseTextDelta: the required field `content_index` is missing."))
      }
      ...
      if (!is.null(input_json$`delta`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RealtimeServerEventResponseTextDelta: the required field `delta` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RealtimeServerEventResponseTextDelta
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeServerEventResponseTextDelta$unlock()
#
## Below is an example to define the print function
# RealtimeServerEventResponseTextDelta$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeServerEventResponseTextDelta$lock()
