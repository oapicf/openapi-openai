#' Create a new RealtimeSessionCreateResponse
#'
#' @description
...
#' @description RealtimeSessionCreateResponse Class
#' @format An \code{R6Class} generator object
#' @field client_secret  \link{RealtimeSessionCreateResponseClientSecret} [optional]
...
#' @field turn_detection  \link{RealtimeSessionCreateResponseTurnDetection} [optional]
...
#' @export
RealtimeSessionCreateResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeSessionCreateResponse class.
    #'
    ...
    initialize = function(`client_secret` = NULL, `modalities` = NULL, `instructions` = NULL, `voice` = NULL, `input_audio_format` = NULL, `output_audio_format` = NULL, `input_audio_transcription` = NULL, `turn_detection` = NULL, `tools` = NULL, `tool_choice` = NULL, `temperature` = NULL, `max_response_output_tokens` = NULL, ...) {
      if (!is.null(`client_secret`)) {
        stopifnot(R6::is.R6(`client_secret`))
    ...
    #'
    #' @return RealtimeSessionCreateResponse as a base R list.
    #' @examples
    #' # convert array of RealtimeSessionCreateResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeSessionCreateResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeSessionCreateResponseObject <- list()
      if (!is.null(self$`client_secret`)) {
        RealtimeSessionCreateResponseObject[["client_secret"]] <-
          self$`client_secret`$toSimpleType()
      }
      if (!is.null(self$`modalities`)) {
        RealtimeSessionCreateResponseObject[["modalities"]] <-
          self$`modalities`
      }
      if (!is.null(self$`instructions`)) {
        RealtimeSessionCreateResponseObject[["instructions"]] <-
          self$`instructions`
      }
      if (!is.null(self$`voice`)) {
        RealtimeSessionCreateResponseObject[["voice"]] <-
          self$`voice`
      }
      if (!is.null(self$`input_audio_format`)) {
        RealtimeSessionCreateResponseObject[["input_audio_format"]] <-
          self$`input_audio_format`
      }
      if (!is.null(self$`output_audio_format`)) {
        RealtimeSessionCreateResponseObject[["output_audio_format"]] <-
          self$`output_audio_format`
      }
      if (!is.null(self$`input_audio_transcription`)) {
        RealtimeSessionCreateResponseObject[["input_audio_transcription"]] <-
          self$`input_audio_transcription`$toSimpleType()
      }
      if (!is.null(self$`turn_detection`)) {
        RealtimeSessionCreateResponseObject[["turn_detection"]] <-
          self$`turn_detection`$toSimpleType()
      }
      if (!is.null(self$`tools`)) {
        RealtimeSessionCreateResponseObject[["tools"]] <-
          lapply(self$`tools`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`tool_choice`)) {
        RealtimeSessionCreateResponseObject[["tool_choice"]] <-
          self$`tool_choice`
      }
      if (!is.null(self$`temperature`)) {
        RealtimeSessionCreateResponseObject[["temperature"]] <-
          self$`temperature`
      }
      if (!is.null(self$`max_response_output_tokens`)) {
        RealtimeSessionCreateResponseObject[["max_response_output_tokens"]] <-
          self$`max_response_output_tokens`$toSimpleType()
      }
      return(RealtimeSessionCreateResponseObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeSessionCreateResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeSessionCreateResponse
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`client_secret`)) {
        `client_secret_object` <- RealtimeSessionCreateResponseClientSecret$new()
        `client_secret_object`$fromJSON(jsonlite::toJSON(this_object$`client_secret`, auto_unbox = TRUE, digits = NA))
        self$`client_secret` <- `client_secret_object`
      }
      ...
      if (!is.null(this_object$`turn_detection`)) {
        `turn_detection_object` <- RealtimeSessionCreateResponseTurnDetection$new()
    ...
    #' @return RealtimeSessionCreateResponse in JSON format
    ...
    fromJSONString = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      self$`client_secret` <- RealtimeSessionCreateResponseClientSecret$new()$fromJSON(jsonlite::toJSON(this_object$`client_secret`, auto_unbox = TRUE, digits = NA))
      self$`modalities` <- ApiClient$new()$deserializeObj(this_object$`modalities`, "array[character]", loadNamespace("openapi"))
      self$`instructions` <- this_object$`instructions`
      if (!is.null(this_object$`voice`) && !(this_object$`voice` %in% c("alloy", "ash", "ballad", "coral", "echo", "sage", "shimmer", "verse"))) {
        stop(paste("Error! \"", this_object$`voice`, "\" cannot be assigned to `voice`. Must be \"alloy\", \"ash\", \"ballad\", \"coral\", \"echo\", \"sage\", \"shimmer\", \"verse\".", sep = ""))
      ...
      self$`turn_detection` <- RealtimeSessionCreateResponseTurnDetection$new()$fromJSON(jsonlite::toJSON(this_object$`turn_detection`, auto_unbox = TRUE, digits = NA))
      self$`tools` <- ApiClient$new()$deserializeObj(this_object$`tools`, "array[RealtimeResponseCreateParamsToolsInner]", loadNamespace("openapi"))
      self$`tool_choice` <- this_object$`tool_choice`
      self$`temperature` <- this_object$`temperature`
    ...
    #' @description
    #' Validate JSON input with respect to RealtimeSessionCreateResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of RealtimeSessionCreateResponse
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeSessionCreateResponse$unlock()
#
## Below is an example to define the print function
# RealtimeSessionCreateResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeSessionCreateResponse$lock()
