#' Create a new RealtimeSessionCreateResponseTurnDetection
#'
#' @description
#' Configuration for turn detection. Can be set to `null` to turn off. Server  VAD means that the model will detect the start and end of speech based on  audio volume and respond at the end of user speech. 
#'
#' @docType class
#' @title RealtimeSessionCreateResponseTurnDetection
#' @description RealtimeSessionCreateResponseTurnDetection Class
...
#' @export
RealtimeSessionCreateResponseTurnDetection <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RealtimeSessionCreateResponseTurnDetection class.
    #'
    ...
    #'
    #' @return RealtimeSessionCreateResponseTurnDetection as a base R list.
    #' @examples
    #' # convert array of RealtimeSessionCreateResponseTurnDetection (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RealtimeSessionCreateResponseTurnDetection to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RealtimeSessionCreateResponseTurnDetectionObject <- list()
      if (!is.null(self$`type`)) {
        RealtimeSessionCreateResponseTurnDetectionObject[["type"]] <-
          self$`type`
      }
      if (!is.null(self$`threshold`)) {
        RealtimeSessionCreateResponseTurnDetectionObject[["threshold"]] <-
          self$`threshold`
      }
      if (!is.null(self$`prefix_padding_ms`)) {
        RealtimeSessionCreateResponseTurnDetectionObject[["prefix_padding_ms"]] <-
          self$`prefix_padding_ms`
      }
      if (!is.null(self$`silence_duration_ms`)) {
        RealtimeSessionCreateResponseTurnDetectionObject[["silence_duration_ms"]] <-
          self$`silence_duration_ms`
      }
      return(RealtimeSessionCreateResponseTurnDetectionObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RealtimeSessionCreateResponseTurnDetection
    #'
    #' @param input_json the JSON input
    #' @return the instance of RealtimeSessionCreateResponseTurnDetection
    ...
    #' @return RealtimeSessionCreateResponseTurnDetection in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RealtimeSessionCreateResponseTurnDetection and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of RealtimeSessionCreateResponseTurnDetection
    toString = function() {
      self$toJSONString()
    },
...
# RealtimeSessionCreateResponseTurnDetection$unlock()
#
## Below is an example to define the print function
# RealtimeSessionCreateResponseTurnDetection$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RealtimeSessionCreateResponseTurnDetection$lock()
