...
RunStepDeltaObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStepDeltaObject as a base R list.
    #' @examples
    #' # convert array of RunStepDeltaObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStepDeltaObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStepDeltaObjectObject)
    },
