...
RunStepDeltaStepDetailsToolCallsCodeOutputImageObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStepDeltaStepDetailsToolCallsCodeOutputImageObject as a base R list.
    #' @examples
    #' # convert array of RunStepDeltaStepDetailsToolCallsCodeOutputImageObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStepDeltaStepDetailsToolCallsCodeOutputImageObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStepDeltaStepDetailsToolCallsCodeOutputImageObjectObject)
    },
