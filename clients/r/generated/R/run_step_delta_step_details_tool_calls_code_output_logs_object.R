...
RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject as a base R list.
    #' @examples
    #' # convert array of RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStepDeltaStepDetailsToolCallsCodeOutputLogsObjectObject)
    },
