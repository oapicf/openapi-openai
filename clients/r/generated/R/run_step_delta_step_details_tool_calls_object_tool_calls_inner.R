...
RunStepDeltaStepDetailsToolCallsObjectToolCallsInner <- R6::R6Class(
  ...
  public = list(
    ...
    #' Serialize RunStepDeltaStepDetailsToolCallsObjectToolCallsInner to JSON.
    #'
    #' @description
    #' Serialize RunStepDeltaStepDetailsToolCallsObjectToolCallsInner to JSON.
    #'
    #' @return JSON representation of the RunStepDeltaStepDetailsToolCallsObjectToolCallsInner.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to RunStepDeltaStepDetailsToolCallsObjectToolCallsInner.
    #'
    #' @description
