...
RunStepDetailsToolCallsCodeObject <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStepDetailsToolCallsCodeObject as a base R list.
    #' @examples
    #' # convert array of RunStepDetailsToolCallsCodeObject (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStepDetailsToolCallsCodeObject to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStepDetailsToolCallsCodeObjectObject)
    },
