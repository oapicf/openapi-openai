...
RunStepDetailsToolCallsCodeObjectCodeInterpreter <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStepDetailsToolCallsCodeObjectCodeInterpreter as a base R list.
    #' @examples
    #' # convert array of RunStepDetailsToolCallsCodeObjectCodeInterpreter (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStepDetailsToolCallsCodeObjectCodeInterpreter to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStepDetailsToolCallsCodeObjectCodeInterpreterObject)
    },
