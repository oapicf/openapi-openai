...
RunStepDetailsToolCallsFunctionObjectFunction <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStepDetailsToolCallsFunctionObjectFunction as a base R list.
    #' @examples
    #' # convert array of RunStepDetailsToolCallsFunctionObjectFunction (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStepDetailsToolCallsFunctionObjectFunction to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStepDetailsToolCallsFunctionObjectFunctionObject)
    },
