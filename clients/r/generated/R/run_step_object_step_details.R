...
RunStepObjectStepDetails <- R6::R6Class(
  ...
  public = list(
    ...
    #' Serialize RunStepObjectStepDetails to JSON.
    #'
    #' @description
    #' Serialize RunStepObjectStepDetails to JSON.
    #'
    #' @return JSON representation of the RunStepObjectStepDetails.
    #' @export
    toJSON = function() {
      if (!is.null(self$actual_instance)) {
    ...
    #' Validate the input JSON with respect to RunStepObjectStepDetails.
    #'
    #' @description
