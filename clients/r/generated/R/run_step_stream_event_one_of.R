...
RunStepStreamEventOneOf <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStepStreamEventOneOf as a base R list.
    #' @examples
    #' # convert array of RunStepStreamEventOneOf (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStepStreamEventOneOf to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStepStreamEventOneOfObject)
    },
