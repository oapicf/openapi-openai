...
RunStepStreamEventOneOf6 <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStepStreamEventOneOf6 as a base R list.
    #' @examples
    #' # convert array of RunStepStreamEventOneOf6 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStepStreamEventOneOf6 to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStepStreamEventOneOf6Object)
    },
