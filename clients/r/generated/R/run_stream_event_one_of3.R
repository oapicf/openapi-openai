...
RunStreamEventOneOf3 <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStreamEventOneOf3 as a base R list.
    #' @examples
    #' # convert array of RunStreamEventOneOf3 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStreamEventOneOf3 to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStreamEventOneOf3Object)
    },
