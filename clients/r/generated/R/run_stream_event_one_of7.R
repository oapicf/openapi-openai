...
#' @description RunStreamEventOneOf7 Class
...
#' @export
RunStreamEventOneOf7 <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RunStreamEventOneOf7 class.
    #'
    #' @param event event
    #' @param data data
    ...
    #'
    #' @return RunStreamEventOneOf7 as a base R list.
    #' @examples
    #' # convert array of RunStreamEventOneOf7 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStreamEventOneOf7 to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RunStreamEventOneOf7Object <- list()
      if (!is.null(self$`event`)) {
        RunStreamEventOneOf7Object[["event"]] <-
          self$`event`
      }
      if (!is.null(self$`data`)) {
        RunStreamEventOneOf7Object[["data"]] <-
          self$`data`$toSimpleType()
      }
      return(RunStreamEventOneOf7Object)
    },

    #' @description
    #' Deserialize JSON string into an instance of RunStreamEventOneOf7
    #'
    ...
    #' @return RunStreamEventOneOf7 in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RunStreamEventOneOf7 and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for RunStreamEventOneOf7: the required field `event` is missing."))
      }
      # check the required field `data`
      if (!is.null(input_json$`data`)) {
        stopifnot(R6::is.R6(input_json$`data`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for RunStreamEventOneOf7: the required field `data` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of RunStreamEventOneOf7
    toString = function() {
      self$toJSONString()
    },
...
# RunStreamEventOneOf7$unlock()
#
## Below is an example to define the print function
# RunStreamEventOneOf7$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# RunStreamEventOneOf7$lock()
