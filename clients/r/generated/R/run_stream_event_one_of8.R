...
RunStreamEventOneOf8 <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return RunStreamEventOneOf8 as a base R list.
    #' @examples
    #' # convert array of RunStreamEventOneOf8 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RunStreamEventOneOf8 to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      return(RunStreamEventOneOf8Object)
    },
