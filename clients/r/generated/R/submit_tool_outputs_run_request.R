...
SubmitToolOutputsRunRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return SubmitToolOutputsRunRequest as a base R list.
    #' @examples
    #' # convert array of SubmitToolOutputsRunRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert SubmitToolOutputsRunRequest to a base R type
    #'
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`tool_outputs`)) {
        SubmitToolOutputsRunRequestObject[["tool_outputs"]] <-
          lapply(self$`tool_outputs`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`stream`)) {
        SubmitToolOutputsRunRequestObject[["stream"]] <-
          self$`stream`
      }
      return(SubmitToolOutputsRunRequestObject)
    },
