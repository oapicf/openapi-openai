#' Create a new ThreadStreamEventOneOf
#'
#' @description
...
#' @description ThreadStreamEventOneOf Class
...
#' @export
ThreadStreamEventOneOf <- R6::R6Class(
  "ThreadStreamEventOneOf",
  public = list(
    `event` = NULL,
    `data` = NULL,
    #' Initialize a new ThreadStreamEventOneOf class.
    #'
    #' @description
    #' Initialize a new ThreadStreamEventOneOf class.
    #'
    ...
    #' To JSON String
    #'
    #' @return ThreadStreamEventOneOf in JSON format
    #' @export
    toJSON = function() {
      ThreadStreamEventOneOfObject <- list()
      if (!is.null(self$`event`)) {
        ThreadStreamEventOneOfObject[["event"]] <-
          self$`event`
      }
      if (!is.null(self$`data`)) {
        ThreadStreamEventOneOfObject[["data"]] <-
          self$`data`$toJSON()
      }
      ThreadStreamEventOneOfObject
    },
    #' Deserialize JSON string into an instance of ThreadStreamEventOneOf
    #'
    #' @description
    #' Deserialize JSON string into an instance of ThreadStreamEventOneOf
    #'
    #' @param input_json the JSON input
    #' @return the instance of ThreadStreamEventOneOf
    #' @export
    ...
    #' Validate JSON input with respect to ThreadStreamEventOneOf
    #'
    #' @description
    #' Validate JSON input with respect to ThreadStreamEventOneOf and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`event`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for ThreadStreamEventOneOf: the required field `event` is missing."))
      }
      # check the required field `data`
      if (!is.null(input_json$`data`)) {
        stopifnot(R6::is.R6(input_json$`data`))
      } else {
        stop(paste("The JSON input `", input, "` is invalid for ThreadStreamEventOneOf: the required field `data` is missing."))
      }
    },
    ...
    #' To string (JSON format)
    #'
    #' @return String representation of ThreadStreamEventOneOf
    #' @export
    toString = function() {
      self$toJSONString()
    },
...
# ThreadStreamEventOneOf$unlock()
#
## Below is an example to define the print function
# ThreadStreamEventOneOf$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ThreadStreamEventOneOf$lock()
