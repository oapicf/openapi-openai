#' Create a new UsageEmbeddingsResult
#'
#' @description
#' The aggregated embeddings usage details of the specific time bucket.
#'
#' @docType class
#' @title UsageEmbeddingsResult
#' @description UsageEmbeddingsResult Class
...
#' @export
UsageEmbeddingsResult <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UsageEmbeddingsResult class.
    #'
    #' @param object object
    ...
    initialize = function(`object`, `input_tokens`, `num_model_requests`, `project_id` = NULL, `user_id` = NULL, `api_key_id` = NULL, `model` = NULL, ...) {
      if (!missing(`object`)) {
        if (!(`object` %in% c("organization.usage.embeddings.result"))) {
          stop(paste("Error! \"", `object`, "\" cannot be assigned to `object`. Must be \"organization.usage.embeddings.result\".", sep = ""))
        }
    ...
    #'
    #' @return UsageEmbeddingsResult as a base R list.
    #' @examples
    #' # convert array of UsageEmbeddingsResult (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UsageEmbeddingsResult to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      UsageEmbeddingsResultObject <- list()
      if (!is.null(self$`object`)) {
        UsageEmbeddingsResultObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`input_tokens`)) {
        UsageEmbeddingsResultObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`num_model_requests`)) {
        UsageEmbeddingsResultObject[["num_model_requests"]] <-
          self$`num_model_requests`
      }
      if (!is.null(self$`project_id`)) {
        UsageEmbeddingsResultObject[["project_id"]] <-
          self$`project_id`
      }
      if (!is.null(self$`user_id`)) {
        UsageEmbeddingsResultObject[["user_id"]] <-
          self$`user_id`
      }
      if (!is.null(self$`api_key_id`)) {
        UsageEmbeddingsResultObject[["api_key_id"]] <-
          self$`api_key_id`
      }
      if (!is.null(self$`model`)) {
        UsageEmbeddingsResultObject[["model"]] <-
          self$`model`
      }
      return(UsageEmbeddingsResultObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of UsageEmbeddingsResult
    #'
    #' @param input_json the JSON input
    #' @return the instance of UsageEmbeddingsResult
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`object`)) {
        if (!is.null(this_object$`object`) && !(this_object$`object` %in% c("organization.usage.embeddings.result"))) {
          stop(paste("Error! \"", this_object$`object`, "\" cannot be assigned to `object`. Must be \"organization.usage.embeddings.result\".", sep = ""))
        }
    ...
    #' @return UsageEmbeddingsResult in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to UsageEmbeddingsResult and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsageEmbeddingsResult: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`input_tokens`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsageEmbeddingsResult: the required field `input_tokens` is missing."))
      }
      ...
      if (!is.null(input_json$`num_model_requests`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsageEmbeddingsResult: the required field `num_model_requests` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of UsageEmbeddingsResult
    toString = function() {
      self$toJSONString()
    },
...
# UsageEmbeddingsResult$unlock()
#
## Below is an example to define the print function
# UsageEmbeddingsResult$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UsageEmbeddingsResult$lock()
