#' Create a new UsageModerationsResult
#'
#' @description
#' The aggregated moderations usage details of the specific time bucket.
#'
#' @docType class
#' @title UsageModerationsResult
#' @description UsageModerationsResult Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field input_tokens The aggregated number of input tokens used. integer
...
#' @export
UsageModerationsResult <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UsageModerationsResult class.
    #'
    #' @param object object
    #' @param input_tokens The aggregated number of input tokens used.
    ...
    initialize = function(`object`, `input_tokens`, `num_model_requests`, `project_id` = NULL, `user_id` = NULL, `api_key_id` = NULL, `model` = NULL, ...) {
      if (!missing(`object`)) {
        if (!(`object` %in% c("organization.usage.moderations.result"))) {
          stop(paste("Error! \"", `object`, "\" cannot be assigned to `object`. Must be \"organization.usage.moderations.result\".", sep = ""))
        }
    ...
    #'
    #' @return UsageModerationsResult as a base R list.
    #' @examples
    #' # convert array of UsageModerationsResult (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UsageModerationsResult to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      UsageModerationsResultObject <- list()
      if (!is.null(self$`object`)) {
        UsageModerationsResultObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`input_tokens`)) {
        UsageModerationsResultObject[["input_tokens"]] <-
          self$`input_tokens`
      }
      if (!is.null(self$`num_model_requests`)) {
        UsageModerationsResultObject[["num_model_requests"]] <-
          self$`num_model_requests`
      }
      if (!is.null(self$`project_id`)) {
        UsageModerationsResultObject[["project_id"]] <-
          self$`project_id`
      }
      if (!is.null(self$`user_id`)) {
        UsageModerationsResultObject[["user_id"]] <-
          self$`user_id`
      }
      if (!is.null(self$`api_key_id`)) {
        UsageModerationsResultObject[["api_key_id"]] <-
          self$`api_key_id`
      }
      if (!is.null(self$`model`)) {
        UsageModerationsResultObject[["model"]] <-
          self$`model`
      }
      return(UsageModerationsResultObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of UsageModerationsResult
    #'
    #' @param input_json the JSON input
    #' @return the instance of UsageModerationsResult
    fromJSON = function(input_json) {
      this_object <- jsonlite::fromJSON(input_json)
      if (!is.null(this_object$`object`)) {
        if (!is.null(this_object$`object`) && !(this_object$`object` %in% c("organization.usage.moderations.result"))) {
          stop(paste("Error! \"", this_object$`object`, "\" cannot be assigned to `object`. Must be \"organization.usage.moderations.result\".", sep = ""))
        }
    ...
    #' @return UsageModerationsResult in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to UsageModerationsResult and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsageModerationsResult: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`input_tokens`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsageModerationsResult: the required field `input_tokens` is missing."))
      }
      ...
      if (!is.null(input_json$`num_model_requests`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UsageModerationsResult: the required field `num_model_requests` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of UsageModerationsResult
    toString = function() {
      self$toJSONString()
    },
...
# UsageModerationsResult$unlock()
#
## Below is an example to define the print function
# UsageModerationsResult$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UsageModerationsResult$lock()
