...
#' @description UserListResponse Class
#' @format An \code{R6Class} generator object
#' @field object  character
#' @field data  list(\link{User})
...
UserListResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new UserListResponse class.
    #'
    #' @param object object
    #' @param data data
    ...
    #'
    #' @return UserListResponse as a base R list.
    #' @examples
    #' # convert array of UserListResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert UserListResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      UserListResponseObject <- list()
      if (!is.null(self$`object`)) {
        UserListResponseObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`data`)) {
        UserListResponseObject[["data"]] <-
          lapply(self$`data`, function(x) x$toSimpleType())
      }
      if (!is.null(self$`first_id`)) {
        UserListResponseObject[["first_id"]] <-
          self$`first_id`
      }
      if (!is.null(self$`last_id`)) {
        UserListResponseObject[["last_id"]] <-
          self$`last_id`
      }
      if (!is.null(self$`has_more`)) {
        UserListResponseObject[["has_more"]] <-
          self$`has_more`
      }
    ...
    #' @description
    #' Deserialize JSON string into an instance of UserListResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of UserListResponse
    ...
    #' @return UserListResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to UserListResponse and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`object`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserListResponse: the required field `object` is missing."))
      }
      ...
      if (!is.null(input_json$`data`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserListResponse: the required field `data` is missing."))
      }
      ...
      if (!is.null(input_json$`first_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserListResponse: the required field `first_id` is missing."))
      }
      ...
      if (!is.null(input_json$`last_id`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserListResponse: the required field `last_id` is missing."))
      }
      ...
      if (!is.null(input_json$`has_more`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for UserListResponse: the required field `has_more` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of UserListResponse
    toString = function() {
      self$toJSONString()
    },
...
# UserListResponse$unlock()
#
## Below is an example to define the print function
# UserListResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# UserListResponse$lock()
