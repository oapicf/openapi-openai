#' Create a new VectorStoreFileBatchObjectFileCounts
#'
#' @description
#' VectorStoreFileBatchObjectFileCounts Class
#'
#' @docType class
#' @title VectorStoreFileBatchObjectFileCounts
#' @description VectorStoreFileBatchObjectFileCounts Class
#' @format An \code{R6Class} generator object
#' @field in_progress The number of files that are currently being processed. integer
#' @field completed The number of files that have been processed. integer
#' @field failed The number of files that have failed to process. integer
#' @field cancelled The number of files that where cancelled. integer
#' @field total The total number of files. integer
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VectorStoreFileBatchObjectFileCounts <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new VectorStoreFileBatchObjectFileCounts class.
    #'
    ...
    #'
    #' @return VectorStoreFileBatchObjectFileCounts as a base R list.
    #' @examples
    #' # convert array of VectorStoreFileBatchObjectFileCounts (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert VectorStoreFileBatchObjectFileCounts to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      VectorStoreFileBatchObjectFileCountsObject <- list()
      if (!is.null(self$`in_progress`)) {
        VectorStoreFileBatchObjectFileCountsObject[["in_progress"]] <-
          self$`in_progress`
      }
      if (!is.null(self$`completed`)) {
        VectorStoreFileBatchObjectFileCountsObject[["completed"]] <-
          self$`completed`
      }
      if (!is.null(self$`failed`)) {
        VectorStoreFileBatchObjectFileCountsObject[["failed"]] <-
          self$`failed`
      }
      if (!is.null(self$`cancelled`)) {
        VectorStoreFileBatchObjectFileCountsObject[["cancelled"]] <-
          self$`cancelled`
      }
      if (!is.null(self$`total`)) {
        VectorStoreFileBatchObjectFileCountsObject[["total"]] <-
          self$`total`
      }
      return(VectorStoreFileBatchObjectFileCountsObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of VectorStoreFileBatchObjectFileCounts
    #'
    #' @param input_json the JSON input
    #' @return the instance of VectorStoreFileBatchObjectFileCounts
    ...
    #' @return VectorStoreFileBatchObjectFileCounts in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to VectorStoreFileBatchObjectFileCounts and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`in_progress`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VectorStoreFileBatchObjectFileCounts: the required field `in_progress` is missing."))
      }
      ...
      if (!is.null(input_json$`completed`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VectorStoreFileBatchObjectFileCounts: the required field `completed` is missing."))
      }
      ...
      if (!is.null(input_json$`failed`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VectorStoreFileBatchObjectFileCounts: the required field `failed` is missing."))
      }
      ...
      if (!is.null(input_json$`cancelled`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VectorStoreFileBatchObjectFileCounts: the required field `cancelled` is missing."))
      }
      ...
      if (!is.null(input_json$`total`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VectorStoreFileBatchObjectFileCounts: the required field `total` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of VectorStoreFileBatchObjectFileCounts
    toString = function() {
      self$toJSONString()
    },
...
# VectorStoreFileBatchObjectFileCounts$unlock()
#
## Below is an example to define the print function
# VectorStoreFileBatchObjectFileCounts$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# VectorStoreFileBatchObjectFileCounts$lock()
