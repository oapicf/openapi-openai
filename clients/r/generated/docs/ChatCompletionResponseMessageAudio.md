# openapi::ChatCompletionResponseMessageAudio
...
------------ | ------------- | ------------- | -------------
**id** | **character** | Unique identifier for this audio response. | 
...
**data** | **character** | Base64 encoded audio bytes generated by the model, in the format specified in the request.  | 
**transcript** | **character** | Transcript of the audio generated by the model. | 
