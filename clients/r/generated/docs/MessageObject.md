...
**attachments** | [**array[CreateMessageRequestAttachmentsInner]**](CreateMessageRequest_attachments_inner.md) | A list of files attached to the message, and the tools they were added to. | 
