# openapi::RealtimeServerEventInputAudioBufferSpeechStarted
...
**type** | **character** | The event type, must be &#x60;input_audio_buffer.speech_started&#x60;. | [Enum: [input_audio_buffer.speech_started]] 
...
**item_id** | **character** | The ID of the user message item that will be created when speech stops.  | 
