...
context("Test CreateChatCompletionFunctionResponse")

model_instance <- CreateChatCompletionFunctionResponse$new()
...
test_that("choices", {
  # tests for the property `choices` (array[CreateChatCompletionFunctionResponseChoicesInner])
