...
context("Test CreateRunRequest")

model_instance <- CreateRunRequest$new()
...
test_that("model", {
  # tests for the property `model` (CreateRunRequestModel)
...
test_that("additional_instructions", {
  # tests for the property `additional_instructions` (character)
  # Appends additional instructions at the end of the instructions for the run. This is useful for modifying the behavior on a per-run basis without overriding other instructions.

  # uncomment below to test the property
  #expect_equal(model.instance$`additional_instructions`, "EXPECTED_RESULT")
})

test_that("additional_messages", {
  # tests for the property `additional_messages` (array[CreateMessageRequest])
  # Adds additional messages to the thread before creating the run.

  # uncomment below to test the property
  #expect_equal(model.instance$`additional_messages`, "EXPECTED_RESULT")
})
