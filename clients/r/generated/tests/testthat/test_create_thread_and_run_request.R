...
context("Test CreateThreadAndRunRequest")

model_instance <- CreateThreadAndRunRequest$new()
...
test_that("thread", {
  # tests for the property `thread` (CreateThreadRequest)

  # uncomment below to test the property
  #expect_equal(model.instance$`thread`, "EXPECTED_RESULT")
})
...
test_that("tools", {
  # tests for the property `tools` (array[CreateThreadAndRunRequestToolsInner])
...
test_that("tool_resources", {
  # tests for the property `tool_resources` (CreateThreadAndRunRequestToolResources)
