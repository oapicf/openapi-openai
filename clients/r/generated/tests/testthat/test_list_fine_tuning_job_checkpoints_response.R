...
context("Test ListFineTuningJobCheckpointsResponse")

model_instance <- ListFineTuningJobCheckpointsResponse$new()

test_that("data", {
  # tests for the property `data` (array[FineTuningJobCheckpoint])
