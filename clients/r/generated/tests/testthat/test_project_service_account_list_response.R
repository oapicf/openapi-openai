...
context("Test ProjectServiceAccountListResponse")

model_instance <- ProjectServiceAccountListResponse$new()
...
test_that("data", {
  # tests for the property `data` (array[ProjectServiceAccount])
