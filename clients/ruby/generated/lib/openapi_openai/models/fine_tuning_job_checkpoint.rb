...
module OpenApiOpenAIClient
  ...
  class FineTuningJobCheckpoint < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenApiOpenAIClient::FineTuningJobCheckpoint`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] fine_tuned_model_checkpoint Value to be assigned
    def fine_tuned_model_checkpoint=(fine_tuned_model_checkpoint)
      if fine_tuned_model_checkpoint.nil?
        fail ArgumentError, 'fine_tuned_model_checkpoint cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] step_number Value to be assigned
    def step_number=(step_number)
      if step_number.nil?
        fail ArgumentError, 'step_number cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] fine_tuning_job_id Value to be assigned
    def fine_tuning_job_id=(fine_tuning_job_id)
      if fine_tuning_job_id.nil?
        fail ArgumentError, 'fine_tuning_job_id cannot be nil'
      end
