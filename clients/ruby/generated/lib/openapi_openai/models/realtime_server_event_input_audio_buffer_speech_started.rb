...
module OpenApiOpenAIClient
  ...
  class RealtimeServerEventInputAudioBufferSpeechStarted < ApiModelBase
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["input_audio_buffer.speech_started"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] audio_start_ms Value to be assigned
    def audio_start_ms=(audio_start_ms)
      if audio_start_ms.nil?
        fail ArgumentError, 'audio_start_ms cannot be nil'
      end
