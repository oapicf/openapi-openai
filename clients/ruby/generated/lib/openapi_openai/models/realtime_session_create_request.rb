...
module OpenApiOpenAIClient
  ...
  class RealtimeSessionCreateRequest < ApiModelBase
    ...
    def model=(model)
      validator = EnumAttributeValidator.new('String', ["gpt-4o-realtime-preview", "gpt-4o-realtime-preview-2024-10-01", "gpt-4o-realtime-preview-2024-12-17", "gpt-4o-mini-realtime-preview", "gpt-4o-mini-realtime-preview-2024-12-17"])
    ...
    def input_audio_format=(input_audio_format)
      ...
      unless validator.valid?(input_audio_format)
        fail ArgumentError, "invalid value for \"input_audio_format\", must be one of #{validator.allowable_values}."
      end
      @input_audio_format = input_audio_format
    end
