...
# Unit tests for OpenApiOpenAIClient::FineTuningJobEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenApiOpenAIClient::FineTuningJobEvent do
  #let(:instance) { OpenApiOpenAIClient::FineTuningJobEvent.new }

  describe 'test an instance of FineTuningJobEvent' do
    it 'should create an instance of FineTuningJobEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenApiOpenAIClient::FineTuningJobEvent)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["message", "metrics"])
      # validator.allowable_values.each do |value|
