...
# Unit tests for OpenApiOpenAIClient::MessageStreamEventOneOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenApiOpenAIClient::MessageStreamEventOneOf1 do
  let(:instance) { OpenApiOpenAIClient::MessageStreamEventOneOf1.new }
  ...
  describe 'test an instance of MessageStreamEventOneOf1' do
    it 'should create an instance of MessageStreamEventOneOf1' do
      ...
      #expect(instance).to be_instance_of(OpenApiOpenAIClient::MessageStreamEventOneOf1)
    end
  end
