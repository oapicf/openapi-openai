...
# Unit tests for OpenApiOpenAIClient::ProjectRateLimitUpdateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenApiOpenAIClient::ProjectRateLimitUpdateRequest do
  #let(:instance) { OpenApiOpenAIClient::ProjectRateLimitUpdateRequest.new }
  ...
  describe 'test an instance of ProjectRateLimitUpdateRequest' do
    it 'should create an instance of ProjectRateLimitUpdateRequest' do
      ...
      #expect(instance).to be_instance_of(OpenApiOpenAIClient::ProjectRateLimitUpdateRequest)
    end
  end
