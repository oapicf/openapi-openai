...
# Unit tests for OpenApiOpenAIClient::RealtimeSessionCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenApiOpenAIClient::RealtimeSessionCreateRequest do
  #let(:instance) { OpenApiOpenAIClient::RealtimeSessionCreateRequest.new }

  describe 'test an instance of RealtimeSessionCreateRequest' do
    it 'should create an instance of RealtimeSessionCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenApiOpenAIClient::RealtimeSessionCreateRequest)
    end
  end
