...
# Unit tests for OpenApiOpenAIClient::RunObjectLastError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenApiOpenAIClient::RunObjectLastError do
  #let(:instance) { OpenApiOpenAIClient::RunObjectLastError.new }

  describe 'test an instance of RunObjectLastError' do
    it 'should create an instance of RunObjectLastError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenApiOpenAIClient::RunObjectLastError)
    end
  end
