...
# Unit tests for OpenApiOpenAIClient::RunStreamEventOneOf2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenApiOpenAIClient::RunStreamEventOneOf2 do
  #let(:instance) { OpenApiOpenAIClient::RunStreamEventOneOf2.new }

  describe 'test an instance of RunStreamEventOneOf2' do
    it 'should create an instance of RunStreamEventOneOf2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenApiOpenAIClient::RunStreamEventOneOf2)
    end
  end
