...
# Unit tests for OpenApiOpenAIClient::UsageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenApiOpenAIClient::UsageResponse do
  #let(:instance) { OpenApiOpenAIClient::UsageResponse.new }

  describe 'test an instance of UsageResponse' do
    it 'should create an instance of UsageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenApiOpenAIClient::UsageResponse)
    end
  end
