...
where
    ...
    A: apis::assistants::Assistants + apis::audio::Audio + apis::chat::Chat + apis::completions::Completions + apis::embeddings::Embeddings + apis::files::Files + apis::fine_tuning::FineTuning + apis::images::Images + apis::models::Models + apis::moderations::Moderations + 'static,
{
...
where
    I: AsRef<A> + Send + Sync,
    A: apis::completions::Completions,
{
...
where
    I: AsRef<A> + Send + Sync,
    A: apis::moderations::Moderations,
{
