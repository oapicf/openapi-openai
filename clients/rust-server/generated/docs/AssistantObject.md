...
**object** | [***models::AssistantObjectObject**](AssistantObject_object.md) |  | 
**created_at** | **i32** | The Unix timestamp (in seconds) for when the assistant was created. | 
**name** | **swagger::Nullable<String>** | The name of the assistant. The maximum length is 256 characters.  | 
**description** | **swagger::Nullable<String>** | The description of the assistant. The maximum length is 512 characters.  | 
...
**instructions** | **swagger::Nullable<String>** | The system instructions that the assistant uses. The maximum length is 256,000 characters.  | 
...
**tool_resources** | [***swagger::Nullable<models::AssistantObjectToolResources>**](AssistantObject_tool_resources.md) |  | [optional] [default to None]
