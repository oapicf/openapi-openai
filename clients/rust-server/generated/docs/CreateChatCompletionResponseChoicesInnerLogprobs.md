...
**refusal** | [**swagger::Nullable<Vec<models::ChatCompletionTokenLogprob>>**](ChatCompletionTokenLogprob.md) | A list of message refusal tokens with log probability information. | 
