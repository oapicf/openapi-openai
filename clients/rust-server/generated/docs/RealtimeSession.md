...
------------ | ------------- | ------------- | -------------
**id** | **String** | Unique identifier for the session object.  | [optional] [default to None]
...
**model** | [***models::RealtimeSessionModel**](RealtimeSession_model.md) |  | [optional] [default to None]
...
**turn_detection** | [***swagger::Nullable<models::RealtimeSessionTurnDetection>**](RealtimeSession_turn_detection.md) |  | [optional] [default to None]
