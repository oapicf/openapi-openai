...
**object** | [***models::ThreadObjectObject**](ThreadObject_object.md) |  | 
**created_at** | **i32** | The Unix timestamp (in seconds) for when the thread was created. | 
**tool_resources** | [***swagger::Nullable<models::ModifyThreadRequestToolResources>**](ModifyThreadRequest_tool_resources.md) |  | 
