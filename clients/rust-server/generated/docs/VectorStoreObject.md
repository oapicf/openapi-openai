...
**object** | [***models::VectorStoreObjectObject**](VectorStoreObject_object.md) |  | 
...
**status** | [***models::VectorStoreObjectStatus**](VectorStoreObject_status.md) |  | 
**expires_after** | [***models::VectorStoreExpirationAfter**](VectorStoreExpirationAfter.md) |  | [optional] [default to None]
**expires_at** | **i32** | The Unix timestamp (in seconds) for when the vector store will expire. | [optional] [default to None]
