...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for ChatCompletionRequestMessageFunctionCall {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<ChatCompletionRequestMessageFunctionCall> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<ChatCompletionRequestMessageFunctionCall>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<ChatCompletionRequestMessageFunctionCall> {
    type Error = String;
...
pub struct CreateChatCompletionRequest {
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub n: Option<swagger::Nullable<u8>>,
...
impl std::str::FromStr for CreateChatCompletionRequest {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        struct IntermediateRep {
            ...
            pub logit_bias: Vec<serde_json::Value>,
            pub user: Vec<String>,
        }
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "logit_bias" => intermediate_rep.logit_bias.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, validator::Validate)]
#[cfg_attr(feature = "conversion", derive(frunk::LabelledGeneric))]
pub struct CreateChatCompletionRequestFunctionCall {
    /// The name of the function to call.
    #[serde(rename = "name")]
    pub name: String,
...
impl CreateChatCompletionRequestFunctionCall {
    #[allow(clippy::new_without_default)]
    pub fn new(name: String, ) -> CreateChatCompletionRequestFunctionCall {
...
impl std::str::FromStr for CreateChatCompletionRequestFunctionCall {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateChatCompletionRequestFunctionCall".to_string())
            };
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    #[allow(clippy::redundant_clone)]
                    "name" => intermediate_rep.name.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateChatCompletionRequestFunctionCall".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateChatCompletionRequestFunctionCall {
            name: intermediate_rep.name.into_iter().next().ok_or_else(|| "name missing in CreateChatCompletionRequestFunctionCall".to_string())?,
        })
    }
}
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateChatCompletionRequestFunctionCallOneOf {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<CreateChatCompletionRequestFunctionCallOneOf> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateChatCompletionRequestFunctionCallOneOf>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateChatCompletionRequestFunctionCallOneOf> {
    type Error = String;
...
impl std::str::FromStr for CreateChatCompletionRequestModel {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateChatCompletionRequestModel".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateChatCompletionRequestModel".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateChatCompletionRequestModel {
        })
    }
}
...
impl std::str::FromStr for CreateChatCompletionRequestStop {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateChatCompletionRequestStop".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateChatCompletionRequestStop".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateChatCompletionRequestStop {
        })
    }
}
...
pub struct CreateCompletionRequest {
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub max_tokens: Option<swagger::Nullable<u32>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub logprobs: Option<swagger::Nullable<u8>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub best_of: Option<swagger::Nullable<u8>>,
...
impl std::str::FromStr for CreateCompletionRequestModel {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateCompletionRequestModel".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateCompletionRequestModel".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateCompletionRequestModel {
        })
    }
}
...
impl std::str::FromStr for CreateCompletionRequestPrompt {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateCompletionRequestPrompt".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateCompletionRequestPrompt".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateCompletionRequestPrompt {
        })
    }
}
...
impl std::str::FromStr for CreateCompletionRequestStop {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateCompletionRequestStop".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateCompletionRequestStop".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateCompletionRequestStop {
        })
    }
}
...
impl CreateCompletionResponseChoicesInner {
    #[allow(clippy::new_without_default)]
    pub fn new(text: String, index: i32, logprobs: swagger::Nullable<models::CreateCompletionResponseChoicesInnerLogprobs>, finish_reason: String, ) -> CreateCompletionResponseChoicesInner {
...
impl std::str::FromStr for CreateCompletionResponseChoicesInnerLogprobs {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        struct IntermediateRep {
            ...
            pub top_logprobs: Vec<Vec<serde_json::Value>>,
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateCompletionResponseUsage {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<CreateCompletionResponseUsage> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateCompletionResponseUsage>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateCompletionResponseUsage> {
    type Error = String;
...
pub struct CreateEditRequest {
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub input: Option<swagger::Nullable<String>>,
...
impl CreateEditRequest {
    ...
    pub fn new(model: models::CreateEditRequestModel, instruction: String, ) -> CreateEditRequest {
        CreateEditRequest {
            model,
            input: Some(swagger::Nullable::Present("".to_string())),
            instruction,
            n: Some(swagger::Nullable::Present(1)),
            temperature: Some(swagger::Nullable::Present(1)),
            top_p: Some(swagger::Nullable::Present(1)),
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateEditRequest {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            // Skipping model in query parameter serialization
...
// Methods for converting between header::IntoHeaderValue<CreateEditRequest> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateEditRequest>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateEditRequest> {
    type Error = String;
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, validator::Validate)]
#[cfg_attr(feature = "conversion", derive(frunk::LabelledGeneric))]
pub struct CreateEditRequestModel {
}


impl CreateEditRequestModel {
    #[allow(clippy::new_without_default)]
    pub fn new() -> CreateEditRequestModel {
        CreateEditRequestModel {
        }
    }
}

/// Converts the CreateEditRequestModel value to the Query Parameters representation (style=form, explode=false)
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateEditRequestModel {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
        ];
...
impl std::str::FromStr for CreateEditRequestModel {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateEditRequestModel".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateEditRequestModel".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateEditRequestModel {
        })
    }
}

// Methods for converting between header::IntoHeaderValue<CreateEditRequestModel> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateEditRequestModel>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<CreateEditRequestModel>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for CreateEditRequestModel - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateEditRequestModel> {
    type Error = String;

    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CreateEditRequestModel as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into CreateEditRequestModel - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateEditResponse {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<CreateEditResponse> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateEditResponse>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateEditResponse> {
    type Error = String;
...
pub struct CreateEditResponseChoicesInner {
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub logprobs: Option<swagger::Nullable<models::CreateCompletionResponseChoicesInnerLogprobs>>,
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateEditResponseChoicesInner {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<CreateEditResponseChoicesInner> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateEditResponseChoicesInner>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateEditResponseChoicesInner> {
    type Error = String;
...
impl std::str::FromStr for CreateEmbeddingRequestInput {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateEmbeddingRequestInput".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateEmbeddingRequestInput".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateEmbeddingRequestInput {
        })
    }
}
...
impl std::str::FromStr for CreateEmbeddingRequestModel {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateEmbeddingRequestModel".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateEmbeddingRequestModel".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateEmbeddingRequestModel {
        })
    }
}
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateEmbeddingResponseDataInner {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<CreateEmbeddingResponseDataInner> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateEmbeddingResponseDataInner>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateEmbeddingResponseDataInner> {
    type Error = String;
...
pub struct CreateFineTuneRequest {
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub model: Option<swagger::Nullable<models::CreateFineTuneRequestModel>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub n_epochs: Option<swagger::Nullable<i32>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub batch_size: Option<swagger::Nullable<i32>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub learning_rate_multiplier: Option<swagger::Nullable<f64>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub prompt_loss_weight: Option<swagger::Nullable<f64>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub compute_classification_metrics: Option<swagger::Nullable<bool>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub classification_n_classes: Option<swagger::Nullable<i32>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub classification_positive_class: Option<swagger::Nullable<String>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub classification_betas: Option<swagger::Nullable<Vec<f64>>>,
...
impl CreateFineTuneRequest {
    ...
    pub fn new(training_file: String, ) -> CreateFineTuneRequest {
        CreateFineTuneRequest {
            ...
            model: None,
            n_epochs: Some(swagger::Nullable::Present(4)),
            batch_size: None,
            learning_rate_multiplier: None,
            prompt_loss_weight: Some(swagger::Nullable::Present(0.01)),
            compute_classification_metrics: Some(swagger::Nullable::Present(false)),
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateFineTuneRequest {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<CreateFineTuneRequest> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateFineTuneRequest>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateFineTuneRequest> {
    type Error = String;
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize, validator::Validate)]
#[cfg_attr(feature = "conversion", derive(frunk::LabelledGeneric))]
pub struct CreateFineTuneRequestModel {
}


impl CreateFineTuneRequestModel {
    #[allow(clippy::new_without_default)]
    pub fn new() -> CreateFineTuneRequestModel {
        CreateFineTuneRequestModel {
        }
    }
}

/// Converts the CreateFineTuneRequestModel value to the Query Parameters representation (style=form, explode=false)
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateFineTuneRequestModel {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
        ];
...
impl std::str::FromStr for CreateFineTuneRequestModel {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateFineTuneRequestModel".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateFineTuneRequestModel".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateFineTuneRequestModel {
        })
    }
}

// Methods for converting between header::IntoHeaderValue<CreateFineTuneRequestModel> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateFineTuneRequestModel>> for hyper::header::HeaderValue {
    type Error = String;

    fn try_from(hdr_value: header::IntoHeaderValue<CreateFineTuneRequestModel>) -> std::result::Result<Self, Self::Error> {
        let hdr_value = hdr_value.to_string();
        match hyper::header::HeaderValue::from_str(&hdr_value) {
             std::result::Result::Ok(value) => std::result::Result::Ok(value),
             std::result::Result::Err(e) => std::result::Result::Err(
                 format!("Invalid header value for CreateFineTuneRequestModel - value: {} is invalid {}",
                     hdr_value, e))
        }
    }
}
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateFineTuneRequestModel> {
    type Error = String;

    fn try_from(hdr_value: hyper::header::HeaderValue) -> std::result::Result<Self, Self::Error> {
        match hdr_value.to_str() {
             std::result::Result::Ok(value) => {
                    match <CreateFineTuneRequestModel as std::str::FromStr>::from_str(value) {
                        std::result::Result::Ok(value) => std::result::Result::Ok(header::IntoHeaderValue(value)),
                        std::result::Result::Err(err) => std::result::Result::Err(
                            format!("Unable to convert header value '{}' into CreateFineTuneRequestModel - {}",
                                value, err))
                    }
             },
             std::result::Result::Err(e) => std::result::Result::Err(
...
pub struct CreateImageRequest {
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub size: Option<swagger::Nullable<String>>,
    ...
    #[serde(default = "swagger::nullable_format::default_optional_nullable")]
    #[serde(skip_serializing_if="Option::is_none")]
    pub response_format: Option<swagger::Nullable<String>>,
...
impl CreateImageRequest {
    ...
    pub fn new(prompt: String, ) -> CreateImageRequest {
        CreateImageRequest {
            prompt,
            n: Some(swagger::Nullable::Present(1)),
            size: Some(swagger::Nullable::Present("1024x1024".to_string())),
            response_format: Some(swagger::Nullable::Present("url".to_string())),
            user: None,
        }
    }
}
...
impl std::str::FromStr for CreateModerationRequestInput {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateModerationRequestInput".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateModerationRequestInput".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateModerationRequestInput {
        })
    }
}
...
impl std::str::FromStr for CreateModerationRequestModel {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateModerationRequestModel".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateModerationRequestModel".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateModerationRequestModel {
        })
    }
}
...
impl std::str::FromStr for CreateTranscriptionRequestModel {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        while key_result.is_some() {
            let val = match string_iter.next() {
                Some(x) => x,
                None => return std::result::Result::Err("Missing value while parsing CreateTranscriptionRequestModel".to_string())
            };

            if let Some(key) = key_result {
                #[allow(clippy::match_single_binding)]
                match key {
                    _ => return std::result::Result::Err("Unexpected key while parsing CreateTranscriptionRequestModel".to_string())
                }
            }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(CreateTranscriptionRequestModel {
        })
    }
}
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateTranscriptionResponse {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<CreateTranscriptionResponse> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateTranscriptionResponse>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateTranscriptionResponse> {
    type Error = String;
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for CreateTranslationResponse {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<CreateTranslationResponse> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<CreateTranslationResponse>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<CreateTranslationResponse> {
    type Error = String;
...
impl Error {
    #[allow(clippy::new_without_default)]
    pub fn new(r#type: String, message: String, param: swagger::Nullable<String>, code: swagger::Nullable<String>, ) -> Error {
        Error {
            r#type,
            message,
            param,
...
impl FineTune {
    #[allow(clippy::new_without_default)]
    pub fn new(id: String, object: String, created_at: i32, updated_at: i32, model: String, fine_tuned_model: swagger::Nullable<String>, organization_id: String, status: String, hyperparams: serde_json::Value, training_files: Vec<models::OpenAiFile>, validation_files: Vec<models::OpenAiFile>, result_files: Vec<models::OpenAiFile>, ) -> FineTune {
        FineTune {
            id,
            object,
            created_at,
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for FineTune {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    #[allow(clippy::redundant_clone)]
                    "hyperparams" => intermediate_rep.hyperparams.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
...
// Methods for converting between header::IntoHeaderValue<FineTune> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<FineTune>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<FineTune> {
    type Error = String;
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for FineTuneEvent {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<FineTuneEvent> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<FineTuneEvent>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<FineTuneEvent> {
    type Error = String;
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for ImagesResponseDataInner {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<ImagesResponseDataInner> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<ImagesResponseDataInner>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<ImagesResponseDataInner> {
    type Error = String;
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for ListFineTuneEventsResponse {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<ListFineTuneEventsResponse> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<ListFineTuneEventsResponse>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<ListFineTuneEventsResponse> {
    type Error = String;
...
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
impl std::string::ToString for ListFineTunesResponse {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
...
// Methods for converting between header::IntoHeaderValue<ListFineTunesResponse> and hyper::header::HeaderValue

#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<header::IntoHeaderValue<ListFineTunesResponse>> for hyper::header::HeaderValue {
    type Error = String;
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<ListFineTunesResponse> {
    type Error = String;
...
impl std::str::FromStr for OpenAiFile {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        struct IntermediateRep {
            ...
            pub status: Vec<String>,
            pub status_details: Vec<serde_json::Value>,
        }
        ...
        while key_result.is_some() {
            ...
            if let Some(key) = key_result {
                ...
                match key {
                    ...
                    "status" => intermediate_rep.status.push(<String as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
                    #[allow(clippy::redundant_clone)]
                    "status_details" => intermediate_rep.status_details.push(<serde_json::Value as std::str::FromStr>::from_str(val).map_err(|x| x.to_string())?),
