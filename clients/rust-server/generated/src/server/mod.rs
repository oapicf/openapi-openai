                     ...
                     Ok(body) => {
                                ...
                                let param_create_assistant_file_request: Option<models::CreateAssistantFileRequest> = if !body.is_empty() {
                                    ...
                                    match serde_ignored::deserialize(deserializer, |path| {
                                        ...
                                        Err(e) => return Ok(Response::builder()
                                                        .status(StatusCode::BAD_REQUEST)
                                                        .body(BoxBody::new(format!("Couldn't parse body parameter CreateAssistantFileRequest - doesn't match schema: {e}")))
                                ...
                                let param_create_assistant_file_request = match param_create_assistant_file_request {
                                    ...
                                    None => return Ok(Response::builder()
                                                        .status(StatusCode::BAD_REQUEST)
                                                        .body(BoxBody::new("Missing required body parameter CreateAssistantFileRequest".to_string()))
                                                        .expect("Unable to create Bad Request response for missing body parameter CreateAssistantFileRequest")),
                                };
        #[cfg(not(feature = "validate"))]
                                run_validation!(param_create_assistant_file_request, "CreateAssistantFileRequest", validation);
