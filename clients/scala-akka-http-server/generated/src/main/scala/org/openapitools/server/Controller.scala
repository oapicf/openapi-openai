...
class Controller(assistants: AssistantsApi, audio: AudioApi, chat: ChatApi, completions: CompletionsApi, embeddings: EmbeddingsApi, files: FilesApi, fineTuning: FineTuningApi, images: ImagesApi, models: ModelsApi, moderations: ModerationsApi)(implicit system: ActorSystem, materializer: Materializer) {
