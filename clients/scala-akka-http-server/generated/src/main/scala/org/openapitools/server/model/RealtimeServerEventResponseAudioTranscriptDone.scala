 ...
 * @param `type` The event type, must be `response.audio_transcript.done`. for example: ''null''
 ...
 * @param transcript The final transcript of the audio. for example: ''null''
*/
final case class RealtimeServerEventResponseAudioTranscriptDone (
  eventId: String,
  `type`: String,
  responseId: String,
  itemId: String,
