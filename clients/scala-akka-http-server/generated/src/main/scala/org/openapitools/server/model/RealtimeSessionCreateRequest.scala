 ...
 * @param model The Realtime model used for this session.  for example: ''null''
...
*/
final case class RealtimeSessionCreateRequest (
  ...
  turnDetection: Option[RealtimeSessionCreateRequestTurnDetection] = None,
