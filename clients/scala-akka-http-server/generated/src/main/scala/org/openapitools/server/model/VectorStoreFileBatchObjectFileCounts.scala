 ...
 * @param completed The number of files that have been processed. for example: ''null''
 * @param failed The number of files that have failed to process. for example: ''null''
 * @param cancelled The number of files that where cancelled. for example: ''null''
 * @param total The total number of files. for example: ''null''
*/
final case class VectorStoreFileBatchObjectFileCounts (
  inProgress: Int,
  completed: Int,
  failed: Int,
  cancelled: Int,
