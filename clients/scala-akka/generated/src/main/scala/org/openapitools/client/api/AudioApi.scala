...
class AudioApi(baseUrl: String) {
   ...
   */
  def createTranscription(file: File, model: CreateTranscriptionRequestModel, language: Option[String] = None, prompt: Option[String] = None, responseFormat: Option[String] = None, temperature: Option[BigDecimal] = None, timestampGranularities: Seq[String])(implicit bearerToken: BearerToken): ApiRequest[CreateTranscription200Response] =
   ...
   * @param temperature The sampling temperature, between 0 and 1. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic. If set to 0, the model will use [log probability](https://en.wikipedia.org/wiki/Log_probability) to automatically increase the temperature until certain thresholds are hit. 
   */
  def createTranslation(file: File, model: CreateTranscriptionRequestModel, prompt: Option[String] = None, responseFormat: Option[String] = None, temperature: Option[BigDecimal] = None)(implicit bearerToken: BearerToken): ApiRequest[CreateTranslation200Response] =
