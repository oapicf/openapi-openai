...
class FilesApi(baseUrl: String) {
   ...
   */
  def listFiles(purpose: Option[String] = None, limit: Option[Int] = None, order: Option[String] = None, after: Option[String] = None)(implicit bearerToken: BearerToken): ApiRequest[ListFilesResponse] =
