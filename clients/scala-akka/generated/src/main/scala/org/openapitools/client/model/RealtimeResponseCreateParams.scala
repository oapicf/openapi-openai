...
case class RealtimeResponseCreateParams (
  ...
  modalities: Option[RealtimeResponseCreateParamsEnums.Seq[Modalities]] = None,
  ...
  voice: Option[RealtimeResponseCreateParamsEnums.Voice] = None,
  /* The format of output audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`.  */
  outputAudioFormat: Option[RealtimeResponseCreateParamsEnums.OutputAudioFormat] = None,
...
object RealtimeResponseCreateParamsEnums {
