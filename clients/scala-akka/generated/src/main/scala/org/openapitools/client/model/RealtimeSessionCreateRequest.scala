...
case class RealtimeSessionCreateRequest (
  ...
  modalities: Option[RealtimeSessionCreateRequestEnums.Seq[Modalities]] = None,
  /* The Realtime model used for this session.  */
  model: RealtimeSessionCreateRequestEnums.Model,
  ...
  voice: Option[RealtimeSessionCreateRequestEnums.Voice] = None,
  /* The format of input audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`.  */
  inputAudioFormat: Option[RealtimeSessionCreateRequestEnums.InputAudioFormat] = None,
  /* The format of output audio. Options are `pcm16`, `g711_ulaw`, or `g711_alaw`.  */
  outputAudioFormat: Option[RealtimeSessionCreateRequestEnums.OutputAudioFormat] = None,
...
object RealtimeSessionCreateRequestEnums {
