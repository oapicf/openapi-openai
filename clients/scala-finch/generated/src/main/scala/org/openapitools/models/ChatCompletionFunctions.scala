 ...
 */
case class ChatCompletionFunctions(description: Option[String],
                name: String,
...
object ChatCompletionFunctions {
    /**
     * Creates the codec for converting ChatCompletionFunctions from and to JSON.
     */
    implicit val decoder: Decoder[ChatCompletionFunctions] = deriveDecoder
    implicit val encoder: ObjectEncoder[ChatCompletionFunctions] = deriveEncoder
}
