...
import org.openapitools.models.ModifyThreadRequestToolResources
 ...
 */
case class ModifyThreadRequest(toolUnderscoreresources: Option[ModifyThreadRequestToolResources],
