...
import org.openapitools.models.RealtimeSessionCreateRequestTurnDetection
 ...
 */
case class RealtimeSessionCreateRequest(modalities: Option[Seq[String]],
                model: String,
                ...
                turnUnderscoredetection: Option[RealtimeSessionCreateRequestTurnDetection],
...
object RealtimeSessionCreateRequest {
    /**
     * Creates the codec for converting RealtimeSessionCreateRequest from and to JSON.
     */
    implicit val decoder: Decoder[RealtimeSessionCreateRequest] = deriveDecoder
    implicit val encoder: ObjectEncoder[RealtimeSessionCreateRequest] = deriveEncoder
}
