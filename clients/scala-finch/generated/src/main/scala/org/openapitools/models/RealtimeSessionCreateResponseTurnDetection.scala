 ...
 */
case class RealtimeSessionCreateResponseTurnDetection(_type: Option[String],
...
object RealtimeSessionCreateResponseTurnDetection {
    /**
     * Creates the codec for converting RealtimeSessionCreateResponseTurnDetection from and to JSON.
     */
    implicit val decoder: Decoder[RealtimeSessionCreateResponseTurnDetection] = deriveDecoder
    implicit val encoder: ObjectEncoder[RealtimeSessionCreateResponseTurnDetection] = deriveEncoder
}
