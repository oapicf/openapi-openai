...
case class CreateFineTuneRequest (
    ...
    _computeClassificationMetrics: Option[Boolean],
    /* The number of classes in a classification task.  This parameter is required for multiclass classification.  */
    _classificationNClasses: Option[Integer],
    /* The positive class in binary classification.  This parameter is needed to generate precision, recall, and F1 metrics when doing binary classification.  */
    _classificationPositiveClass: Option[String],
    /* If this is provided, we calculate F-beta scores at the specified beta values. The F-beta score is a generalization of F-1 score. This is only used for binary classification.  With a beta of 1 (i.e. the F-1 score), precision and recall are given the same weight. A larger beta score puts more weight on recall and less on precision. A smaller beta score puts more weight on precision and less on recall.  */
    _classificationBetas: Option[List[Number]],
...
object CreateFineTuneRequest {
    def toStringBody(var_trainingFile: Object, var_validationFile: Object, var_model: Object, var_nEpochs: Object, var_batchSize: Object, var_learningRateMultiplier: Object, var_promptLossWeight: Object, var_computeClassificationMetrics: Object, var_classificationNClasses: Object, var_classificationPositiveClass: Object, var_classificationBetas: Object, var_suffix: Object) =
        s"""
        | {
        | "trainingFile":$var_trainingFile,"validationFile":$var_validationFile,"model":$var_model,"nEpochs":$var_nEpochs,"batchSize":$var_batchSize,"learningRateMultiplier":$var_learningRateMultiplier,"promptLossWeight":$var_promptLossWeight,"computeClassificationMetrics":$var_computeClassificationMetrics,"classificationNClasses":$var_classificationNClasses,"classificationPositiveClass":$var_classificationPositiveClass,"classificationBetas":$var_classificationBetas,"suffix":$var_suffix
        | }
        """.stripMargin
}
