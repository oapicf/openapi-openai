...
case class RealtimeSessionCreateResponse (
    _clientSecret: Option[RealtimeSessionCreateResponseClientSecret],
    ...
    _turnDetection: Option[RealtimeSessionCreateResponseTurnDetection],
...
object RealtimeSessionCreateResponse {
    def toStringBody(var_clientSecret: Object, var_modalities: Object, var_instructions: Object, var_voice: Object, var_inputAudioFormat: Object, var_outputAudioFormat: Object, var_inputAudioTranscription: Object, var_turnDetection: Object, var_tools: Object, var_toolChoice: Object, var_temperature: Object, var_maxResponseOutputTokens: Object) =
        s"""
        | {
        | "clientSecret":$var_clientSecret,"modalities":$var_modalities,"instructions":$var_instructions,"voice":$var_voice,"inputAudioFormat":$var_inputAudioFormat,"outputAudioFormat":$var_outputAudioFormat,"inputAudioTranscription":$var_inputAudioTranscription,"turnDetection":$var_turnDetection,"tools":$var_tools,"toolChoice":$var_toolChoice,"temperature":$var_temperature,"maxResponseOutputTokens":$var_maxResponseOutputTokens
        | }
        """.stripMargin
}
