...
object AuditLogRateLimitUpdatedChangesRequested {
  implicit lazy val auditLogRateLimitUpdatedChangesRequestedJsonFormat: Format[AuditLogRateLimitUpdatedChangesRequested] = Json.format[AuditLogRateLimitUpdatedChangesRequested]
}
