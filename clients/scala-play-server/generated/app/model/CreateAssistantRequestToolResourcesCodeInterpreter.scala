...
/**
  * Represents the Swagger definition for CreateAssistantRequest_tool_resources_code_interpreter.
...
object CreateAssistantRequestToolResourcesCodeInterpreter {
  implicit lazy val createAssistantRequestToolResourcesCodeInterpreterJsonFormat: Format[CreateAssistantRequestToolResourcesCodeInterpreter] = Json.format[CreateAssistantRequestToolResourcesCodeInterpreter]
}
