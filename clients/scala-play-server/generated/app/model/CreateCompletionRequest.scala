...
/**
  * Represents the Swagger definition for CreateCompletionRequest.
...
object CreateCompletionRequest {
  implicit lazy val createCompletionRequestJsonFormat: Format[CreateCompletionRequest] = Json.format[CreateCompletionRequest]
}
