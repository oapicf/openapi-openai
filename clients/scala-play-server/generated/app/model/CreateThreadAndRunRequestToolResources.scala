...
object CreateThreadAndRunRequestToolResources {
  implicit lazy val createThreadAndRunRequestToolResourcesJsonFormat: Format[CreateThreadAndRunRequestToolResources] = Json.format[CreateThreadAndRunRequestToolResources]
}
