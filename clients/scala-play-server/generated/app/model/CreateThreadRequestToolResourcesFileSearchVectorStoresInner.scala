...
/**
  * Represents the Swagger definition for CreateThreadRequest_tool_resources_file_search_vector_stores_inner.
...
object CreateThreadRequestToolResourcesFileSearchVectorStoresInner {
  implicit lazy val createThreadRequestToolResourcesFileSearchVectorStoresInnerJsonFormat: Format[CreateThreadRequestToolResourcesFileSearchVectorStoresInner] = Json.format[CreateThreadRequestToolResourcesFileSearchVectorStoresInner]
}
