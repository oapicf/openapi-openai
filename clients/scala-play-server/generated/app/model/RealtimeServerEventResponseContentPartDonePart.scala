...
case class RealtimeServerEventResponseContentPartDonePart(
  `type`: Option[RealtimeServerEventResponseContentPartDonePart.Type.Value],
  text: Option[String],
  audio: Option[String],
...
object RealtimeServerEventResponseContentPartDonePart {
  implicit lazy val realtimeServerEventResponseContentPartDonePartJsonFormat: Format[RealtimeServerEventResponseContentPartDonePart] = Json.format[RealtimeServerEventResponseContentPartDonePart]
