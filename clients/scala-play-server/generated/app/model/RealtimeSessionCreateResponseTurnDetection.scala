...
object RealtimeSessionCreateResponseTurnDetection {
  implicit lazy val realtimeSessionCreateResponseTurnDetectionJsonFormat: Format[RealtimeSessionCreateResponseTurnDetection] = Json.format[RealtimeSessionCreateResponseTurnDetection]
}
