...
case class RealtimeSessionTurnDetection(
  `type`: Option[RealtimeSessionTurnDetection.Type.Value],
...
object RealtimeSessionTurnDetection {
  implicit lazy val realtimeSessionTurnDetectionJsonFormat: Format[RealtimeSessionTurnDetection] = Json.format[RealtimeSessionTurnDetection]

  // noinspection TypeAnnotation
  object Type extends Enumeration {
    val ServerVad = Value("server_vad")
