...
case class UsageAudioTranscriptionsResult(
  `object`: UsageAudioTranscriptionsResult.Object.Value,
  seconds: Int,
...
object UsageAudioTranscriptionsResult {
  implicit lazy val usageAudioTranscriptionsResultJsonFormat: Format[UsageAudioTranscriptionsResult] = Json.format[UsageAudioTranscriptionsResult]

  // noinspection TypeAnnotation
  object Object extends Enumeration {
    val OrganizationUsageAudioTranscriptionsResult = Value("organization.usage.audio_transcriptions.result")
