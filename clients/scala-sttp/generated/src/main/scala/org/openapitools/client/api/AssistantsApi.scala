...
class AssistantsApi(baseUrl: String) {
   ...
   */
  def createRun(bearerToken: String)(threadId: String, createRunRequest: CreateRunRequest, include: Seq[String]
): Request[Either[ResponseException[String, Exception], RunObject], Any] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/threads/${threadId}/runs?include[]=${ include }")
      .contentType("application/json")
      .auth.bearer(bearerToken)
   ...
   */
  def deleteMessage(bearerToken: String)(threadId: String, messageId: String
): Request[Either[ResponseException[String, Exception], DeleteMessageResponse], Any] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/threads/${threadId}/messages/${messageId}")
      .contentType("application/json")
      .auth.bearer(bearerToken)
      .response(asJson[DeleteMessageResponse])
   ...
   * @param include A list of additional fields to include in the response. Currently the only supported value is `step_details.tool_calls[*].file_search.results[*].content` to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information. 
   */
  def getRunStep(bearerToken: String)(threadId: String, runId: String, stepId: String, include: Seq[String]
): Request[Either[ResponseException[String, Exception], RunStepObject], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/threads/${threadId}/runs/${runId}/steps/${stepId}?include[]=${ include }")
      .contentType("application/json")
      .auth.bearer(bearerToken)
   ...
   * @param include A list of additional fields to include in the response. Currently the only supported value is `step_details.tool_calls[*].file_search.results[*].content` to fetch the file search result content.  See the [file search tool documentation](/docs/assistants/tools/file-search#customizing-file-search-settings) for more information. 
   */
  def listRunSteps(bearerToken: String)(threadId: String, runId: String, limit: Option[Int] = None, order: Option[String] = None, after: Option[String] = None, before: Option[String] = None, include: Seq[String]
): Request[Either[ResponseException[String, Exception], ListRunStepsResponse], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/threads/${threadId}/runs/${runId}/steps?limit=${ limit }&order=${ order }&after=${ after }&before=${ before }&include[]=${ include }")
      .contentType("application/json")
      .auth.bearer(bearerToken)
