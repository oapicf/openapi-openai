...
import org.openapitools.client.model.AudioResponseFormat._
...
class AudioApi(baseUrl: String) {
   ...
   */
  def createTranscription(bearerToken: String)(file: File, model: CreateTranscriptionRequestModel, language: Option[String] = None, prompt: Option[String] = None, responseFormat: Option[AudioResponseFormat] = None, temperature: Option[Double] = None, timestampGranularities: Seq[String]
...
, 
   ...
   * @param temperature The sampling temperature, between 0 and 1. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic. If set to 0, the model will use [log probability](https://en.wikipedia.org/wiki/Log_probability) to automatically increase the temperature until certain thresholds are hit. 
   */
  def createTranslation(bearerToken: String)(file: File, model: CreateTranscriptionRequestModel, prompt: Option[String] = None, responseFormat: Option[AudioResponseFormat] = None, temperature: Option[Double] = None
