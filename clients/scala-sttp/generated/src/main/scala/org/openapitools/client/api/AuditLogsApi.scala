...
class AuditLogsApi(baseUrl: String) {
   ...
   */
  def listAuditLogs(bearerToken: String)(effectiveAt: Option[ListAuditLogsEffectiveAtParameter] = None, projectIds: Seq[String], eventTypes: Seq[AuditLogEventType], actorIds: Seq[String], actorEmails: Seq[String], resourceIds: Seq[String], limit: Option[Int] = None, after: Option[String] = None, before: Option[String] = None
): Request[Either[ResponseException[String, Exception], ListAuditLogsResponse], Any] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/organization/audit_logs?effective_at=${ effectiveAt }&project_ids[]=${ projectIds }&event_types[]=${ eventTypes }&actor_ids[]=${ actorIds }&actor_emails[]=${ actorEmails }&resource_ids[]=${ resourceIds }&limit=${ limit }&after=${ after }&before=${ before }")
      .contentType("application/json")
      .auth.bearer(bearerToken)
      .response(asJson[ListAuditLogsResponse])
