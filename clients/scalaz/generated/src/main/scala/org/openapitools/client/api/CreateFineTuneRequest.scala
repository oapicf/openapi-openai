...
import CreateFineTuneRequest._
...
/* The number of classes in a classification task.  This parameter is required for multiclass classification.  */
  classificationNClasses: Option[Integer],
...
object CreateFineTuneRequest {
  ...
  implicit val CreateFineTuneRequestCodecJson: CodecJson[CreateFineTuneRequest] = CodecJson.derive[CreateFineTuneRequest]
  implicit val CreateFineTuneRequestDecoder: EntityDecoder[CreateFineTuneRequest] = jsonOf[CreateFineTuneRequest]
  implicit val CreateFineTuneRequestEncoder: EntityEncoder[CreateFineTuneRequest] = jsonEncoderOf[CreateFineTuneRequest]
}
