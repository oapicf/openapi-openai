...
import MessageContentImageUrlObjectImageUrl._
...
object MessageContentImageUrlObjectImageUrl {
  ...
  implicit val MessageContentImageUrlObjectImageUrlCodecJson: CodecJson[MessageContentImageUrlObjectImageUrl] = CodecJson.derive[MessageContentImageUrlObjectImageUrl]
  implicit val MessageContentImageUrlObjectImageUrlDecoder: EntityDecoder[MessageContentImageUrlObjectImageUrl] = jsonOf[MessageContentImageUrlObjectImageUrl]
  implicit val MessageContentImageUrlObjectImageUrlEncoder: EntityEncoder[MessageContentImageUrlObjectImageUrl] = jsonEncoderOf[MessageContentImageUrlObjectImageUrl]
}
