...
import RealtimeResponseCreateParams._
...
object RealtimeResponseCreateParams {
  ...
  implicit val RealtimeResponseCreateParamsCodecJson: CodecJson[RealtimeResponseCreateParams] = CodecJson.derive[RealtimeResponseCreateParams]
  implicit val RealtimeResponseCreateParamsDecoder: EntityDecoder[RealtimeResponseCreateParams] = jsonOf[RealtimeResponseCreateParams]
  implicit val RealtimeResponseCreateParamsEncoder: EntityEncoder[RealtimeResponseCreateParams] = jsonEncoderOf[RealtimeResponseCreateParams]
}
