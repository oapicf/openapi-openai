...
object ThreadStreamEvent {
  ...
  implicit val ThreadStreamEventCodecJson: CodecJson[ThreadStreamEvent] = CodecJson.derive[ThreadStreamEvent]
  implicit val ThreadStreamEventDecoder: EntityDecoder[ThreadStreamEvent] = jsonOf[ThreadStreamEvent]
  implicit val ThreadStreamEventEncoder: EntityEncoder[ThreadStreamEvent] = jsonEncoderOf[ThreadStreamEvent]
}
