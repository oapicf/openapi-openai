...
@Validated
@Tag(name = "Audio", description = "Turn audio into text or text into audio.")
public interface AudioApi {
    ...
    String PATH_CREATE_SPEECH = "/audio/speech";
    /**
    ...
    @RequestMapping(
        ...
        value = AudioApi.PATH_CREATE_SPEECH,
    ...
    String PATH_CREATE_TRANSCRIPTION = "/audio/transcriptions";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = AudioApi.PATH_CREATE_TRANSCRIPTION,
    ...
    default ResponseEntity<CreateTranscription200Response> createTranscription(
        ...
        @Parameter(name = "response_format", description = "") @Valid @RequestParam(value = "response_format", required = false) AudioResponseFormat responseFormat,
    ...
    String PATH_CREATE_TRANSLATION = "/audio/translations";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.POST,
        value = AudioApi.PATH_CREATE_TRANSLATION,
        produces = { "application/json" },
        consumes = { "multipart/form-data" }
    )
