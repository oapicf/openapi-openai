...
public interface ModelsApi {
    ...
    String PATH_DELETE_MODEL = "/models/{model}";
    /**
    ...
    @RequestMapping(
        ...
        value = ModelsApi.PATH_DELETE_MODEL,
        produces = { "application/json" }
    )
    default ResponseEntity<DeleteModelResponse> deleteModel(
        @NotNull @Parameter(name = "model", description = "The model to delete", required = true, in = ParameterIn.PATH) @PathVariable("model") String model
    ) {
    ...
    String PATH_LIST_MODELS = "/models";
    /**
    ...
    @RequestMapping(
        ...
        value = ModelsApi.PATH_LIST_MODELS,
        produces = { "application/json" }
    )
    ...
    String PATH_RETRIEVE_MODEL = "/models/{model}";
    /**
    ...
    @RequestMapping(
        method = RequestMethod.GET,
        value = ModelsApi.PATH_RETRIEVE_MODEL,
        produces = { "application/json" }
    )
    default ResponseEntity<Model> retrieveModel(
        @NotNull @Parameter(name = "model", description = "The ID of the model to use for this request", required = true, in = ParameterIn.PATH) @PathVariable("model") String model
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
