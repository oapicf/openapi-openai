...
@Schema(name = "AuditLog_api_key_deleted", description = "The details for events with this `type`.")
@JsonTypeName("AuditLog_api_key_deleted")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-01-29T14:17:25.623752677Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class AuditLogApiKeyDeleted {

  private @Nullable String id;

  public AuditLogApiKeyDeleted id(@Nullable String id) {
    this.id = id;
    return this;
  }
