...
public class AuditLogApiKeyUpdated {
  ...
  private @Nullable AuditLogApiKeyUpdatedChangesRequested changesRequested;

  public AuditLogApiKeyUpdated id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public AuditLogApiKeyUpdated changesRequested(@Nullable AuditLogApiKeyUpdatedChangesRequested changesRequested) {
  ...
  public @Nullable AuditLogApiKeyUpdatedChangesRequested getChangesRequested() {
    return changesRequested;
  }

  public void setChangesRequested(@Nullable AuditLogApiKeyUpdatedChangesRequested changesRequested) {
    this.changesRequested = changesRequested;
  }
