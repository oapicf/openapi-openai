...
public class AuditLogOrganizationUpdated {
  ...
  private @Nullable AuditLogOrganizationUpdatedChangesRequested changesRequested;

  public AuditLogOrganizationUpdated id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public AuditLogOrganizationUpdated changesRequested(@Nullable AuditLogOrganizationUpdatedChangesRequested changesRequested) {
  ...
  public @Nullable AuditLogOrganizationUpdatedChangesRequested getChangesRequested() {
    return changesRequested;
  }

  public void setChangesRequested(@Nullable AuditLogOrganizationUpdatedChangesRequested changesRequested) {
    this.changesRequested = changesRequested;
  }
