...
public class AuditLogOrganizationUpdatedChangesRequestedSettings {
  ...
  private @Nullable String threadsUiVisibility;

  private @Nullable String usageDashboardVisibility;

  public AuditLogOrganizationUpdatedChangesRequestedSettings threadsUiVisibility(@Nullable String threadsUiVisibility) {
  ...
  @Schema(name = "threads_ui_visibility", description = "Visibility of the threads page which shows messages created with the Assistants API and Playground. One of `ANY_ROLE`, `OWNERS`, or `NONE`.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("threads_ui_visibility")
  public @Nullable String getThreadsUiVisibility() {
    return threadsUiVisibility;
  }

  public void setThreadsUiVisibility(@Nullable String threadsUiVisibility) {
    this.threadsUiVisibility = threadsUiVisibility;
  }

  public AuditLogOrganizationUpdatedChangesRequestedSettings usageDashboardVisibility(@Nullable String usageDashboardVisibility) {
  ...
  @Schema(name = "usage_dashboard_visibility", description = "Visibility of the usage dashboard which shows activity and costs for your organization. One of `ANY_ROLE` or `OWNERS`.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("usage_dashboard_visibility")
  public @Nullable String getUsageDashboardVisibility() {
    return usageDashboardVisibility;
  }

  public void setUsageDashboardVisibility(@Nullable String usageDashboardVisibility) {
    this.usageDashboardVisibility = usageDashboardVisibility;
  }
