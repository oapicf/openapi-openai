...
public class AuditLogProjectCreated {
  ...
  private @Nullable AuditLogProjectCreatedData data;

  public AuditLogProjectCreated id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public AuditLogProjectCreated data(@Nullable AuditLogProjectCreatedData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty("data")
  public @Nullable AuditLogProjectCreatedData getData() {
    return data;
  }

  public void setData(@Nullable AuditLogProjectCreatedData data) {
    this.data = data;
  }
