...
public class AuditLogProjectUpdated {
  ...
  private @Nullable AuditLogProjectUpdatedChangesRequested changesRequested;

  public AuditLogProjectUpdated id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public AuditLogProjectUpdated changesRequested(@Nullable AuditLogProjectUpdatedChangesRequested changesRequested) {
  ...
  public @Nullable AuditLogProjectUpdatedChangesRequested getChangesRequested() {
    return changesRequested;
  }

  public void setChangesRequested(@Nullable AuditLogProjectUpdatedChangesRequested changesRequested) {
    this.changesRequested = changesRequested;
  }
