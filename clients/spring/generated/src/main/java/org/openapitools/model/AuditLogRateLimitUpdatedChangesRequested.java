...
public class AuditLogRateLimitUpdatedChangesRequested {
  ...
  public AuditLogRateLimitUpdatedChangesRequested maxRequestsPer1Minute(@Nullable Integer maxRequestsPer1Minute) {
  ...
  public AuditLogRateLimitUpdatedChangesRequested maxTokensPer1Minute(@Nullable Integer maxTokensPer1Minute) {
  ...
  public AuditLogRateLimitUpdatedChangesRequested maxImagesPer1Minute(@Nullable Integer maxImagesPer1Minute) {
  ...
  public AuditLogRateLimitUpdatedChangesRequested maxAudioMegabytesPer1Minute(@Nullable Integer maxAudioMegabytesPer1Minute) {
  ...
  public AuditLogRateLimitUpdatedChangesRequested maxRequestsPer1Day(@Nullable Integer maxRequestsPer1Day) {
  ...
  public AuditLogRateLimitUpdatedChangesRequested batch1DayMaxInputTokens(@Nullable Integer batch1DayMaxInputTokens) {
