...
@Schema(name = "AuditLog_service_account_updated", description = "The details for events with this `type`.")
...
public class AuditLogServiceAccountUpdated {
  ...
  private @Nullable AuditLogServiceAccountUpdatedChangesRequested changesRequested;

  public AuditLogServiceAccountUpdated id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public AuditLogServiceAccountUpdated changesRequested(@Nullable AuditLogServiceAccountUpdatedChangesRequested changesRequested) {
  ...
  public @Nullable AuditLogServiceAccountUpdatedChangesRequested getChangesRequested() {
    return changesRequested;
  }

  public void setChangesRequested(@Nullable AuditLogServiceAccountUpdatedChangesRequested changesRequested) {
    this.changesRequested = changesRequested;
  }
