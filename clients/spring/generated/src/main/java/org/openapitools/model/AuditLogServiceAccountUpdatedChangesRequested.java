...
@Schema(name = "AuditLog_service_account_updated_changes_requested", description = "The payload used to updated the service account.")
...
public class AuditLogServiceAccountUpdatedChangesRequested {
  ...
  public AuditLogServiceAccountUpdatedChangesRequested role(@Nullable String role) {
    this.role = role;
    return this;
  }
