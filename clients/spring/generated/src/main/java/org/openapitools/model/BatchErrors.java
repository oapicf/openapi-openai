...
public class BatchErrors {
  ...
  public BatchErrors _object(@Nullable String _object) {
  ...
  @Schema(name = "object", description = "The object type, which is always `list`.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("object")
