...
public class BatchRequestInput {
  ...
  public BatchRequestInput customId(@Nullable String customId) {
  ...
  public BatchRequestInput method(@Nullable MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public BatchRequestInput url(@Nullable String url) {
    this.url = url;
    return this;
  }
