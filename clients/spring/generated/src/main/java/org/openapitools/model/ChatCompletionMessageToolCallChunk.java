...
public class ChatCompletionMessageToolCallChunk {
  ...
  private @Nullable ChatCompletionMessageToolCallChunkFunction function;
  ...
  public ChatCompletionMessageToolCallChunk id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ChatCompletionMessageToolCallChunk type(@Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ChatCompletionMessageToolCallChunk function(@Nullable ChatCompletionMessageToolCallChunkFunction function) {
  ...
  public @Nullable ChatCompletionMessageToolCallChunkFunction getFunction() {
    return function;
  }

  public void setFunction(@Nullable ChatCompletionMessageToolCallChunkFunction function) {
    this.function = function;
  }
