...
public class ChatCompletionMessageToolCallChunkFunction {
  ...
  public ChatCompletionMessageToolCallChunkFunction name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ChatCompletionMessageToolCallChunkFunction arguments(@Nullable String arguments) {
