...
public class ChatCompletionStreamResponseDelta {
  ...
  @Deprecated
  private @Nullable ChatCompletionStreamResponseDeltaFunctionCall functionCall;
  ...
  public ChatCompletionStreamResponseDelta functionCall(@Nullable ChatCompletionStreamResponseDeltaFunctionCall functionCall) {
  ...
  @Deprecated
  public @Nullable ChatCompletionStreamResponseDeltaFunctionCall getFunctionCall() {
    return functionCall;
  }
   ...
   */
  @Deprecated
  public void setFunctionCall(@Nullable ChatCompletionStreamResponseDeltaFunctionCall functionCall) {
    this.functionCall = functionCall;
  }
  ...
  public ChatCompletionStreamResponseDelta role(@Nullable RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  @Schema(name = "refusal", description = "The refusal message generated by the model.", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
