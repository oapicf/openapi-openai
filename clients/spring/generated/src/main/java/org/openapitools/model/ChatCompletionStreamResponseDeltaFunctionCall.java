...
public class ChatCompletionStreamResponseDeltaFunctionCall {
  ...
  public ChatCompletionStreamResponseDeltaFunctionCall arguments(@Nullable String arguments) {
  ...
  public ChatCompletionStreamResponseDeltaFunctionCall name(@Nullable String name) {
    this.name = name;
    return this;
  }
