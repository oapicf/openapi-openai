...
public class CompletionUsagePromptTokensDetails {
  ...
  public CompletionUsagePromptTokensDetails audioTokens(@Nullable Integer audioTokens) {
  ...
  public CompletionUsagePromptTokensDetails cachedTokens(@Nullable Integer cachedTokens) {
