...
public class CreateAssistantRequestToolResourcesFileSearch {
   ...
   */
  @Size(max = 1) 
  @Schema(name = "vector_store_ids", description = "The [vector store](/docs/api-reference/vector-stores/object) attached to this assistant. There can be a maximum of 1 vector store attached to the assistant. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
   ...
   */
  @Valid @Size(max = 1) 
  @Schema(name = "vector_stores", description = "A helper to create a [vector store](/docs/api-reference/vector-stores/object) with file_ids and attach it to this assistant. There can be a maximum of 1 vector store attached to the assistant. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
