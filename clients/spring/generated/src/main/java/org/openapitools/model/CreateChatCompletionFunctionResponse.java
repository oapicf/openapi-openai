...
public class CreateChatCompletionFunctionResponse {
  ...
  public CreateChatCompletionFunctionResponse systemFingerprint(@Nullable String systemFingerprint) {
  ...
  public CreateChatCompletionFunctionResponse usage(@Nullable CompletionUsage usage) {
    this.usage = usage;
    return this;
  }
