...
public class CreateCompletionResponse {
  ...
  public CreateCompletionResponse systemFingerprint(@Nullable String systemFingerprint) {
  ...
  public CreateCompletionResponse usage(@Nullable CompletionUsage usage) {
    this.usage = usage;
    return this;
  }
