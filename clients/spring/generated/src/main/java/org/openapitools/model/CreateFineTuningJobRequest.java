...
public class CreateFineTuningJobRequest {
  ...
  public CreateFineTuningJobRequest hyperparameters(@Nullable CreateFineTuningJobRequestHyperparameters hyperparameters) {
  ...
  @JsonProperty("seed")
  public JsonNullable<@Min(value = 0) @Max(value = 2147483647) Integer> getSeed() {
    return seed;
  }
