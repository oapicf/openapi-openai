...
public class FineTuneMethod {
  ...
  private @Nullable FineTuneSupervisedMethod supervised;

  private @Nullable FineTuneDPOMethod dpo;

  public FineTuneMethod type(@Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public FineTuneMethod supervised(@Nullable FineTuneSupervisedMethod supervised) {
  ...
  public @Nullable FineTuneSupervisedMethod getSupervised() {
    return supervised;
  }

  public void setSupervised(@Nullable FineTuneSupervisedMethod supervised) {
    this.supervised = supervised;
  }

  public FineTuneMethod dpo(@Nullable FineTuneDPOMethod dpo) {
    this.dpo = dpo;
    return this;
  }
  ...
  @JsonProperty("dpo")
  public @Nullable FineTuneDPOMethod getDpo() {
    return dpo;
  }

  public void setDpo(@Nullable FineTuneDPOMethod dpo) {
    this.dpo = dpo;
  }
