...
public class Image {
  ...
  private @Nullable String revisedPrompt;

  public Image b64Json(@Nullable String b64Json) {
  ...
  public void setB64Json(@Nullable String b64Json) {
    this.b64Json = b64Json;
  }

  public Image url(@Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public Image revisedPrompt(@Nullable String revisedPrompt) {
  ...
  public void setRevisedPrompt(@Nullable String revisedPrompt) {
    this.revisedPrompt = revisedPrompt;
  }
