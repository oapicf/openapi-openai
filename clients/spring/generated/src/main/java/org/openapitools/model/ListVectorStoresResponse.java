...
public class ListVectorStoresResponse {
   ...
   */
  public ListVectorStoresResponse(String _object, List<@Valid VectorStoreObject> data, String firstId, String lastId, Boolean hasMore) {
   ...
   */
  @NotNull 
  @Schema(name = "first_id", example = "vs_abc123", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   */
  @NotNull 
  @Schema(name = "last_id", example = "vs_abc456", requiredMode = Schema.RequiredMode.REQUIRED)
