...
public class MessageDeltaContentImageFileObject implements MessageDeltaObjectDeltaContentInner {
  ...
  private @Nullable MessageDeltaContentImageFileObjectImageFile imageFile;
  ...
  public MessageDeltaContentImageFileObject imageFile(@Nullable MessageDeltaContentImageFileObjectImageFile imageFile) {
  ...
  public @Nullable MessageDeltaContentImageFileObjectImageFile getImageFile() {
    return imageFile;
  }

  public void setImageFile(@Nullable MessageDeltaContentImageFileObjectImageFile imageFile) {
    this.imageFile = imageFile;
  }
