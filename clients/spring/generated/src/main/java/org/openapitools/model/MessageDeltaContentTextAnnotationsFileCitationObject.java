...
@Schema(name = "MessageDeltaContentTextAnnotationsFileCitationObject", description = "A citation within the message that points to a specific quote from a specific File associated with the assistant or the message. Generated when the assistant uses the \"file_search\" tool to search files.")
...
public class MessageDeltaContentTextAnnotationsFileCitationObject implements MessageDeltaContentTextObjectTextAnnotationsInner {
  ...
  private @Nullable MessageDeltaContentTextAnnotationsFileCitationObjectFileCitation fileCitation;
  ...
  public MessageDeltaContentTextAnnotationsFileCitationObject text(@Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public MessageDeltaContentTextAnnotationsFileCitationObject fileCitation(@Nullable MessageDeltaContentTextAnnotationsFileCitationObjectFileCitation fileCitation) {
  ...
  public @Nullable MessageDeltaContentTextAnnotationsFileCitationObjectFileCitation getFileCitation() {
    return fileCitation;
  }

  public void setFileCitation(@Nullable MessageDeltaContentTextAnnotationsFileCitationObjectFileCitation fileCitation) {
    this.fileCitation = fileCitation;
  }

  public MessageDeltaContentTextAnnotationsFileCitationObject startIndex(@Nullable Integer startIndex) {
  ...
  public MessageDeltaContentTextAnnotationsFileCitationObject endIndex(@Nullable Integer endIndex) {
