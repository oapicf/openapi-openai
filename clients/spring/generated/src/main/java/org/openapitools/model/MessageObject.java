...
public class MessageObject {
   ...
   */
  @NotNull @Valid 
  @Schema(name = "attachments", description = "A list of files attached to the message, and the tools they were added to.", requiredMode = Schema.RequiredMode.REQUIRED)
