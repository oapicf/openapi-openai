...
public class ModifyAssistantRequestToolResources {
  ...
  private @Nullable ModifyAssistantRequestToolResourcesCodeInterpreter codeInterpreter;

  private @Nullable ModifyAssistantRequestToolResourcesFileSearch fileSearch;

  public ModifyAssistantRequestToolResources codeInterpreter(@Nullable ModifyAssistantRequestToolResourcesCodeInterpreter codeInterpreter) {
  ...
  public @Nullable ModifyAssistantRequestToolResourcesCodeInterpreter getCodeInterpreter() {
    return codeInterpreter;
  }

  public void setCodeInterpreter(@Nullable ModifyAssistantRequestToolResourcesCodeInterpreter codeInterpreter) {
    this.codeInterpreter = codeInterpreter;
  }

  public ModifyAssistantRequestToolResources fileSearch(@Nullable ModifyAssistantRequestToolResourcesFileSearch fileSearch) {
  ...
  public @Nullable ModifyAssistantRequestToolResourcesFileSearch getFileSearch() {
    return fileSearch;
  }

  public void setFileSearch(@Nullable ModifyAssistantRequestToolResourcesFileSearch fileSearch) {
    this.fileSearch = fileSearch;
  }
