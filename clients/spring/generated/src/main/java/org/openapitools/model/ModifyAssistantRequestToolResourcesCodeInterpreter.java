...
public class ModifyAssistantRequestToolResourcesCodeInterpreter {
   ...
   */
  @Size(max = 20) 
  @Schema(name = "file_ids", description = "Overrides the list of [file](/docs/api-reference/files) IDs made available to the `code_interpreter` tool. There can be a maximum of 20 files associated with the tool. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
