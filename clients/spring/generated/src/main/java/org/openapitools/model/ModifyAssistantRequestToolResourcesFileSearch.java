...
public class ModifyAssistantRequestToolResourcesFileSearch {
   ...
   */
  @Size(max = 1) 
  @Schema(name = "vector_store_ids", description = "Overrides the [vector store](/docs/api-reference/vector-stores/object) attached to this assistant. There can be a maximum of 1 vector store attached to the assistant. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
