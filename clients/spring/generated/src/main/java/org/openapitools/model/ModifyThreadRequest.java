...
public class ModifyThreadRequest {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.toolResources, modifyThreadRequest.toolResources) &&
        equalsNullable(this.metadata, modifyThreadRequest.metadata);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(toolResources), hashCodeNullable(metadata));
  }
