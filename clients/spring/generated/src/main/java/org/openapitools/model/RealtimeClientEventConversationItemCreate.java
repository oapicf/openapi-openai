...
public class RealtimeClientEventConversationItemCreate {
  ...
  private @Nullable String previousItemId;
  ...
  public RealtimeClientEventConversationItemCreate eventId(@Nullable String eventId) {
  ...
  public RealtimeClientEventConversationItemCreate previousItemId(@Nullable String previousItemId) {
  ...
  public @Nullable String getPreviousItemId() {
    return previousItemId;
  }

  public void setPreviousItemId(@Nullable String previousItemId) {
    this.previousItemId = previousItemId;
  }
