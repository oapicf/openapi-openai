...
public class RealtimeResponseStatusDetails {
  ...
  private @Nullable RealtimeResponseStatusDetailsError error;

  public RealtimeResponseStatusDetails type(@Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public RealtimeResponseStatusDetails reason(@Nullable ReasonEnum reason) {
    this.reason = reason;
    return this;
  }
  ...
  public RealtimeResponseStatusDetails error(@Nullable RealtimeResponseStatusDetailsError error) {
    this.error = error;
    return this;
  }
  ...
  @JsonProperty("error")
  public @Nullable RealtimeResponseStatusDetailsError getError() {
    return error;
  }

  public void setError(@Nullable RealtimeResponseStatusDetailsError error) {
    this.error = error;
  }
