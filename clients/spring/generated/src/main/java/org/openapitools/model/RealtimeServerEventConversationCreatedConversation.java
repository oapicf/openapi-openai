...
public class RealtimeServerEventConversationCreatedConversation {
  ...
  public RealtimeServerEventConversationCreatedConversation id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public RealtimeServerEventConversationCreatedConversation _object(@Nullable String _object) {
