...
public class RealtimeServerEventRateLimitsUpdatedRateLimitsInner {
  ...
  private @Nullable NameEnum name;

  private @Nullable Integer limit;

  private @Nullable Integer remaining;

  private @Nullable BigDecimal resetSeconds;

  public RealtimeServerEventRateLimitsUpdatedRateLimitsInner name(@Nullable NameEnum name) {
    this.name = name;
    return this;
  }
  ...
  @JsonProperty("name")
  public @Nullable NameEnum getName() {
    return name;
  }

  public void setName(@Nullable NameEnum name) {
    this.name = name;
  }

  public RealtimeServerEventRateLimitsUpdatedRateLimitsInner limit(@Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public RealtimeServerEventRateLimitsUpdatedRateLimitsInner remaining(@Nullable Integer remaining) {
  ...
  public RealtimeServerEventRateLimitsUpdatedRateLimitsInner resetSeconds(@Nullable BigDecimal resetSeconds) {
  ...
  public @Nullable BigDecimal getResetSeconds() {
    return resetSeconds;
  }

  public void setResetSeconds(@Nullable BigDecimal resetSeconds) {
    this.resetSeconds = resetSeconds;
  }
