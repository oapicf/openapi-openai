...
public class RealtimeServerEventResponseContentPartDonePart {
  ...
  public RealtimeServerEventResponseContentPartDonePart type(@Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public RealtimeServerEventResponseContentPartDonePart text(@Nullable String text) {
    this.text = text;
    return this;
  }
  ...
  public RealtimeServerEventResponseContentPartDonePart audio(@Nullable String audio) {
    this.audio = audio;
    return this;
  }
  ...
  public RealtimeServerEventResponseContentPartDonePart transcript(@Nullable String transcript) {
