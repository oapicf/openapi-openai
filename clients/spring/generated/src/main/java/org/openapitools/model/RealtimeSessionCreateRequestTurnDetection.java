...
public class RealtimeSessionCreateRequestTurnDetection {
  ...
  public RealtimeSessionCreateRequestTurnDetection type(@Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public RealtimeSessionCreateRequestTurnDetection threshold(@Nullable BigDecimal threshold) {
  ...
  public RealtimeSessionCreateRequestTurnDetection prefixPaddingMs(@Nullable Integer prefixPaddingMs) {
  ...
  public RealtimeSessionCreateRequestTurnDetection silenceDurationMs(@Nullable Integer silenceDurationMs) {
