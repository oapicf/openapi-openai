...
public class RunStepDeltaStepDetailsMessageCreationObject implements RunStepDeltaObjectDeltaStepDetails {
  ...
  private @Nullable RunStepDeltaStepDetailsMessageCreationObjectMessageCreation messageCreation;
  ...
  public RunStepDeltaStepDetailsMessageCreationObject messageCreation(@Nullable RunStepDeltaStepDetailsMessageCreationObjectMessageCreation messageCreation) {
  ...
  public @Nullable RunStepDeltaStepDetailsMessageCreationObjectMessageCreation getMessageCreation() {
    return messageCreation;
  }

  public void setMessageCreation(@Nullable RunStepDeltaStepDetailsMessageCreationObjectMessageCreation messageCreation) {
    this.messageCreation = messageCreation;
  }
