...
public class RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject implements RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputsInner {
  ...
  public RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject logs(@Nullable String logs) {
    this.logs = logs;
    return this;
  }
  ...
  @JsonProperty("logs")
  public @Nullable String getLogs() {
    return logs;
  }

  public void setLogs(@Nullable String logs) {
    this.logs = logs;
  }
