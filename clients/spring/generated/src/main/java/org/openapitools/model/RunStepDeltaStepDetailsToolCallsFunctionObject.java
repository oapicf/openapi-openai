...
public class RunStepDeltaStepDetailsToolCallsFunctionObject implements RunStepDeltaStepDetailsToolCallsObjectToolCallsInner {
  ...
  private @Nullable RunStepDeltaStepDetailsToolCallsFunctionObjectFunction function;
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObject id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObject function(@Nullable RunStepDeltaStepDetailsToolCallsFunctionObjectFunction function) {
  ...
  public @Nullable RunStepDeltaStepDetailsToolCallsFunctionObjectFunction getFunction() {
    return function;
  }

  public void setFunction(@Nullable RunStepDeltaStepDetailsToolCallsFunctionObjectFunction function) {
    this.function = function;
  }
