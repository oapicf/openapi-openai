...
public class RunStepDeltaStepDetailsToolCallsFunctionObjectFunction {
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObjectFunction name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RunStepDeltaStepDetailsToolCallsFunctionObjectFunction arguments(@Nullable String arguments) {
