...
@Schema(name = "RunStepStreamEvent_oneOf_5", description = "Occurs when a [run step](/docs/api-reference/run-steps/step-object) is cancelled.")
@JsonTypeName("RunStepStreamEvent_oneOf_5")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-01-29T14:17:25.623752677Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class RunStepStreamEventOneOf5 implements RunStepStreamEvent {
