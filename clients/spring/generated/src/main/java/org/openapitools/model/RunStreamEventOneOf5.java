...
@Schema(name = "RunStreamEvent_oneOf_5", description = "Occurs when a [run](/docs/api-reference/runs/object) ends with status `incomplete`.")
@JsonTypeName("RunStreamEvent_oneOf_5")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-01-29T14:17:25.623752677Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class RunStreamEventOneOf5 implements RunStreamEvent {
