...
public class SubmitToolOutputsRunRequestToolOutputsInner {
  ...
  public SubmitToolOutputsRunRequestToolOutputsInner toolCallId(@Nullable String toolCallId) {
  ...
  public SubmitToolOutputsRunRequestToolOutputsInner output(@Nullable String output) {
    this.output = output;
    return this;
  }
