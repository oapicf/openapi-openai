...
@Schema(name = "UsageModerationsResult", description = "The aggregated moderations usage details of the specific time bucket.")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-01-29T14:17:25.623752677Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class UsageModerationsResult implements UsageTimeBucketResultInner {
   ...
   */
  public UsageModerationsResult(ObjectEnum _object, Integer inputTokens, Integer numModelRequests) {
   ...
   */
  @NotNull 
  @Schema(name = "input_tokens", description = "The aggregated number of input tokens used.", requiredMode = Schema.RequiredMode.REQUIRED)
