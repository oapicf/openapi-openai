...
public struct CreateCompletionRequest: Codable, JSONEncodable, Hashable {
    ...
    public static let bestOfRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: 20, exclusiveMaximum: false, multipleOf: nil)
    ...
    public static let logprobsRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: 5, exclusiveMaximum: false, multipleOf: nil)
