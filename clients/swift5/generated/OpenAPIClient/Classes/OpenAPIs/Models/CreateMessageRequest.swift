...
public struct CreateMessageRequest: Codable, JSONEncodable, Hashable {
    ...
    public static let contentRule = StringRule(minLength: 1, maxLength: 256000, pattern: nil)
    public static let fileIdsRule = ArrayRule(minItems: 1, maxItems: 10, uniqueItems: false)
