...
public struct RealtimeServerEventResponseAudioDone: Codable, JSONEncodable, Hashable {
    ...
    public enum ModelType: String, Codable, CaseIterable {
        case responsePeriodAudioPeriodDone = "response.audio.done"
    }
    ...
    public init(eventId: String, type: ModelType, responseId: String, itemId: String, outputIndex: Int, contentIndex: Int) {
