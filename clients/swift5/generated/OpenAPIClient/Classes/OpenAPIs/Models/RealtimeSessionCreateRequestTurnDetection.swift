//
// RealtimeSessionCreateRequestTurnDetection.swift
//
...
public struct RealtimeSessionCreateRequestTurnDetection: Codable, JSONEncodable, Hashable {
    ...
    public var createResponse: Bool? = true

    public init(type: String? = nil, threshold: Double? = nil, prefixPaddingMs: Int? = nil, silenceDurationMs: Int? = nil, createResponse: Bool? = true) {
        self.type = type
