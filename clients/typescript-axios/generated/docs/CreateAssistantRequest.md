...
------------ | ------------- | ------------- | -------------
**model** | [**CreateAssistantRequestModel**](CreateAssistantRequestModel.md) |  | [default to undefined]
...
**file_ids** | **Array&lt;string&gt;** | A list of [file](/docs/api-reference/files) IDs attached to this assistant. There can be a maximum of 20 files attached to the assistant. Files are ordered by their creation date in ascending order.  | [optional] [default to undefined]
...
```typescript
import { CreateAssistantRequest } from './api';

const instance: CreateAssistantRequest = {
    model,
    name,
    description,
    instructions,
