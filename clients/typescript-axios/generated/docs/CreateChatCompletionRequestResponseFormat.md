...
------------ | ------------- | ------------- | -------------
**type** | **string** | The type of response format being defined: &#x60;text&#x60; | [default to undefined]
**json_schema** | [**ResponseFormatJsonSchemaJsonSchema**](ResponseFormatJsonSchemaJsonSchema.md) |  | [default to undefined]

## Example

```typescript
import { CreateChatCompletionRequestResponseFormat } from './api';

const instance: CreateChatCompletionRequestResponseFormat = {
    type,
    json_schema,
};
```
