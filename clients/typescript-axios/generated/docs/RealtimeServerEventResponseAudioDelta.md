...
**type** | **string** | The event type, must be &#x60;response.audio.delta&#x60;. | [default to undefined]
...
**delta** | **string** | Base64-encoded audio data delta. | [default to undefined]

## Example

```typescript
import { RealtimeServerEventResponseAudioDelta } from './api';

const instance: RealtimeServerEventResponseAudioDelta = {
    event_id,
    type,
    response_id,
    item_id,
