...
**type** | **string** | The event type, must be &#x60;response.audio.done&#x60;. | [default to undefined]
...
```typescript
import { RealtimeServerEventResponseAudioDone } from './api';

const instance: RealtimeServerEventResponseAudioDone = {
    event_id,
    type,
    response_id,
    item_id,
