...
**type** | **string** | The event type, must be &#x60;response.content_part.done&#x60;. | [default to undefined]
...
**part** | [**RealtimeServerEventResponseContentPartDonePart**](RealtimeServerEventResponseContentPartDonePart.md) |  | [default to undefined]

## Example

```typescript
import { RealtimeServerEventResponseContentPartDone } from './api';

const instance: RealtimeServerEventResponseContentPartDone = {
    event_id,
    type,
    response_id,
    item_id,
