...
**type** | **string** | The event type, must be &#x60;response.text.done&#x60;. | [default to undefined]
...
**text** | **string** | The final text content. | [default to undefined]

## Example

```typescript
import { RealtimeServerEventResponseTextDone } from './api';

const instance: RealtimeServerEventResponseTextDone = {
    event_id,
    type,
    response_id,
    item_id,
