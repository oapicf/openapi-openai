...
**schema** | **{ [key: string]: any; }** | The schema for the response format, described as a JSON Schema object. | [optional] [default to undefined]
...
```typescript
import { ResponseFormatJsonSchemaJsonSchema } from './api';

const instance: ResponseFormatJsonSchemaJsonSchema = {
    description,
    name,
    schema,
    strict,
