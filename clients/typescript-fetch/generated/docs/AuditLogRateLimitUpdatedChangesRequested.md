...
```typescript
import type { AuditLogRateLimitUpdatedChangesRequested } from ''
...
} satisfies AuditLogRateLimitUpdatedChangesRequested
...
const exampleParsed = JSON.parse(exampleJSON) as AuditLogRateLimitUpdatedChangesRequested
