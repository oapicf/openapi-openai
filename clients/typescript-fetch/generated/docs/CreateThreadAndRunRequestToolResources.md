...
```typescript
import type { CreateThreadAndRunRequestToolResources } from ''

// TODO: Update the object below with actual values
const example = {
  "codeInterpreter": null,
  "fileSearch": null,
} satisfies CreateThreadAndRunRequestToolResources
...
const exampleParsed = JSON.parse(exampleJSON) as CreateThreadAndRunRequestToolResources
