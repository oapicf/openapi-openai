...
```typescript
import type { FineTunePreferenceRequestInputPreferredCompletionInner } from ''
...
const example = {
  ...
  "toolCalls": null,
  "functionCall": null,
} satisfies FineTunePreferenceRequestInputPreferredCompletionInner
...
const exampleParsed = JSON.parse(exampleJSON) as FineTunePreferenceRequestInputPreferredCompletionInner
