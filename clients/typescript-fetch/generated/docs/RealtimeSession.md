...
`model` | [RealtimeSessionModel](RealtimeSessionModel.md)
`instructions` | string
`voice` | string
`inputAudioFormat` | string
`outputAudioFormat` | string
`inputAudioTranscription` | [RealtimeSessionInputAudioTranscription](RealtimeSessionInputAudioTranscription.md)
`turnDetection` | [RealtimeSessionTurnDetection](RealtimeSessionTurnDetection.md)
...
```typescript
import type { RealtimeSession } from ''
...
const exampleParsed = JSON.parse(exampleJSON) as RealtimeSession
