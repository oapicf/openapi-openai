...
export function AssistantStreamEventFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssistantStreamEvent {
    ...
    return { ...DoneEventFromJSONTyped(json, true), ...ErrorEventFromJSONTyped(json, true), ...MessageStreamEventFromJSONTyped(json, true), ...RunStepStreamEventFromJSONTyped(json, true), ...RunStreamEventFromJSONTyped(json, true), ...ThreadStreamEventFromJSONTyped(json, true) };
}
