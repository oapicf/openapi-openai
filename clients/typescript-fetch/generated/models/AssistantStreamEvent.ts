...
export function AssistantStreamEventToJSON(json: any): any {
    return AssistantStreamEventToJSONTyped(json, false);
}

export function AssistantStreamEventToJSONTyped(value?: AssistantStreamEvent | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
