 ...
 */
export function instanceOfAssistantToolsFunction(value: object): boolean {
...
export function AssistantToolsFunctionToJSON(value?: AssistantToolsFunction | null): any {
    if (value == null) {
        return value;
    }
    return {
