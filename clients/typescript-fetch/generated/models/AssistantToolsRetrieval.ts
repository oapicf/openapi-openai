 ...
 */
export function instanceOfAssistantToolsRetrieval(value: object): boolean {
...
export function AssistantToolsRetrievalToJSON(value?: AssistantToolsRetrieval | null): any {
    if (value == null) {
        return value;
    }
    return {
