 ...
 */
export function instanceOfAssistantsApiResponseFormat(value: object): value is AssistantsApiResponseFormat {
    return true;
}
...
export function AssistantsApiResponseFormatToJSON(json: any): AssistantsApiResponseFormat {
    return AssistantsApiResponseFormatToJSONTyped(json, false);
}

export function AssistantsApiResponseFormatToJSONTyped(value?: AssistantsApiResponseFormat | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
