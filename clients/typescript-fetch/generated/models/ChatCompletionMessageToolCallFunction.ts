 ...
 */
export function instanceOfChatCompletionMessageToolCallFunction(value: object): boolean {
...
export function ChatCompletionMessageToolCallFunctionToJSON(value?: ChatCompletionMessageToolCallFunction | null): any {
    if (value == null) {
        return value;
    }
    return {
