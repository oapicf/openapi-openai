 ...
 */
export function instanceOfChatCompletionNamedToolChoice(value: object): boolean {
...
export function ChatCompletionNamedToolChoiceToJSON(value?: ChatCompletionNamedToolChoice | null): any {
    if (value == null) {
        return value;
    }
    return {
