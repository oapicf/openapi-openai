...
export function ChatCompletionRequestMessageContentPartToJSON(json: any): any {
    return ChatCompletionRequestMessageContentPartToJSONTyped(json, false);
}

export function ChatCompletionRequestMessageContentPartToJSONTyped(value?: ChatCompletionRequestMessageContentPart | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
