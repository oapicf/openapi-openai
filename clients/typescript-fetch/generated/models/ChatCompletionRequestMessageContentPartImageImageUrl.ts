 ...
 */
export function instanceOfChatCompletionRequestMessageContentPartImageImageUrl(value: object): boolean {
...
export function ChatCompletionRequestMessageContentPartImageImageUrlToJSON(value?: ChatCompletionRequestMessageContentPartImageImageUrl | null): any {
    if (value == null) {
        return value;
    }
    return {
