 ...
 */
export function instanceOfChatCompletionRequestMessageContentPartText(value: object): boolean {
...
export function ChatCompletionRequestMessageContentPartTextToJSON(value?: ChatCompletionRequestMessageContentPartText | null): any {
    if (value == null) {
        return value;
    }
    return {
