 ...
 */
export function instanceOfChatCompletionStreamResponseDeltaFunctionCall(value: object): boolean {
    return true;
}
...
export function ChatCompletionStreamResponseDeltaFunctionCallToJSON(value?: ChatCompletionStreamResponseDeltaFunctionCall | null): any {
    if (value == null) {
        return value;
    }
    return {
