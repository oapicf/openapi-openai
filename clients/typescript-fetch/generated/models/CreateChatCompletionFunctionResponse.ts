...
import {
    ...
    CreateChatCompletionFunctionResponseChoicesInnerToJSONTyped,
 ...
 */
export function instanceOfCreateChatCompletionFunctionResponse(value: object): value is CreateChatCompletionFunctionResponse {
...
export function CreateChatCompletionFunctionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateChatCompletionFunctionResponse {
  ...
  export function CreateChatCompletionFunctionResponseToJSON(json: any): CreateChatCompletionFunctionResponse {
      return CreateChatCompletionFunctionResponseToJSONTyped(json, false);
  }

  export function CreateChatCompletionFunctionResponseToJSONTyped(value?: CreateChatCompletionFunctionResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
