 ...
 */
export function instanceOfCreateChatCompletionRequestResponseFormat(value: object): boolean {
    return true;
}
...
export function CreateChatCompletionRequestResponseFormatToJSON(value?: CreateChatCompletionRequestResponseFormat | null): any {
    if (value == null) {
        return value;
    }
    return {
