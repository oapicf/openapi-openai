 ...
 */
export function instanceOfCreateFineTuningJobRequestIntegrationsInnerWandb(value: object): boolean {
...
export function CreateFineTuningJobRequestIntegrationsInnerWandbToJSON(value?: CreateFineTuningJobRequestIntegrationsInnerWandb | null): any {
    if (value == null) {
        return value;
    }
    return {
