 ...
 */
export function instanceOfCreateImageEditRequestModel(value: object): value is CreateImageEditRequestModel {
    return true;
}
...
export function CreateImageEditRequestModelToJSON(json: any): CreateImageEditRequestModel {
    return CreateImageEditRequestModelToJSONTyped(json, false);
}

export function CreateImageEditRequestModelToJSONTyped(value?: CreateImageEditRequestModel | null, ignoreDiscriminator: boolean = false): any {
    return value;
}
