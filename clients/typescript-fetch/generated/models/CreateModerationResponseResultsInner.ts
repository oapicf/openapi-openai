 ...
 */
export function instanceOfCreateModerationResponseResultsInner(value: object): boolean {
    if (!('flagged' in value)) return false;
    if (!('categories' in value)) return false;
    if (!('categoryScores' in value)) return false;
    return true;
}
...
export function CreateModerationResponseResultsInnerToJSON(value?: CreateModerationResponseResultsInner | null): any {
    if (value == null) {
        return value;
    }
    return {
