 ...
 */
export function instanceOfCreateSpeechRequest(value: object): boolean {
    if (!('model' in value)) return false;
    if (!('input' in value)) return false;
    if (!('voice' in value)) return false;
    return true;
}
...
export function CreateSpeechRequestToJSON(value?: CreateSpeechRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
