 ...
 */
export function instanceOfCreateTranscriptionRequestModel(value: object): value is CreateTranscriptionRequestModel {
    return true;
}
...
export function CreateTranscriptionRequestModelToJSON(json: any): CreateTranscriptionRequestModel {
    return CreateTranscriptionRequestModelToJSONTyped(json, false);
}

export function CreateTranscriptionRequestModelToJSONTyped(value?: CreateTranscriptionRequestModel | null, ignoreDiscriminator: boolean = false): any {
    return value;
}
