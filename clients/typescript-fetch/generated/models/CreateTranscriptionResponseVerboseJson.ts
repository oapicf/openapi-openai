 ...
 */
export function instanceOfCreateTranscriptionResponseVerboseJson(value: object): boolean {
...
export function CreateTranscriptionResponseVerboseJsonToJSON(value?: CreateTranscriptionResponseVerboseJson | null): any {
    if (value == null) {
        return value;
    }
    return {
