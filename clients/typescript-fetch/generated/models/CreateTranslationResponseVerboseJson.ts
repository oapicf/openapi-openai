 ...
 */
export function instanceOfCreateTranslationResponseVerboseJson(value: object): value is CreateTranslationResponseVerboseJson {
...
export function CreateTranslationResponseVerboseJsonToJSON(json: any): CreateTranslationResponseVerboseJson {
    return CreateTranslationResponseVerboseJsonToJSONTyped(json, false);
}

export function CreateTranslationResponseVerboseJsonToJSONTyped(value?: CreateTranslationResponseVerboseJson | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
