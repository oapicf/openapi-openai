...
/**
 * Check if a given object implements the FineTune interface.
 */
export function instanceOfFineTune(value: object): boolean {
    ...
    if (!('hyperparams' in value)) return false;
    if (!('trainingFiles' in value)) return false;
    if (!('validationFiles' in value)) return false;
    if (!('resultFiles' in value)) return false;
    return true;
}

export function FineTuneFromJSON(json: any): FineTune {
    return FineTuneFromJSONTyped(json, false);
}

export function FineTuneFromJSONTyped(json: any, ignoreDiscriminator: boolean): FineTune {
    if (json == null) {
        return json;
    }
    return {
        ...
        'events': json['events'] == null ? undefined : ((json['events'] as Array<any>).map(FineTuneEventFromJSON)),
    };
}

export function FineTuneToJSON(value?: FineTune | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'events': value['events'] == null ? undefined : ((value['events'] as Array<any>).map(FineTuneEventToJSON)),
    };
}
