...
import {
    ...
    FineTuneMethodFromJSONTyped,
    FineTuneMethodToJSON,
    FineTuneMethodToJSONTyped,
} from './FineTuneMethod';
...
export function FineTuningJobFromJSONTyped(json: any, ignoreDiscriminator: boolean): FineTuningJob {
    ...
    return {
        ...
        'seed': json['seed'],
        'estimatedFinish': json['estimated_finish'] == null ? undefined : json['estimated_finish'],
        'method': json['method'] == null ? undefined : FineTuneMethodFromJSON(json['method']),
    };
}
