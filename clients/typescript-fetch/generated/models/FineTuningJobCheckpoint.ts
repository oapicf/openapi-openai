...
import {
    ...
    FineTuningJobCheckpointMetricsToJSONTyped,
 ...
 */
export function instanceOfFineTuningJobCheckpoint(value: object): value is FineTuningJobCheckpoint {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('createdAt' in value) || value['createdAt'] === undefined) return false;
    if (!('fineTunedModelCheckpoint' in value) || value['fineTunedModelCheckpoint'] === undefined) return false;
...
export function FineTuningJobCheckpointToJSON(json: any): FineTuningJobCheckpoint {
    return FineTuningJobCheckpointToJSONTyped(json, false);
}

export function FineTuningJobCheckpointToJSONTyped(value?: FineTuningJobCheckpoint | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
