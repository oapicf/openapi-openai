 ...
 */
export function instanceOfFineTuningJobCheckpointMetrics(value: object): boolean {
    return true;
}
...
export function FineTuningJobCheckpointMetricsToJSON(value?: FineTuningJobCheckpointMetrics | null): any {
    if (value == null) {
        return value;
    }
    return {
