 ...
 */
export function instanceOfListFineTuningJobCheckpointsResponse(value: object): boolean {
...
export function ListFineTuningJobCheckpointsResponseToJSON(value?: ListFineTuningJobCheckpointsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
