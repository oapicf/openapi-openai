 ...
 */
export function instanceOfListPaginatedFineTuningJobsResponse(value: object): boolean {
...
export function ListPaginatedFineTuningJobsResponseToJSON(value?: ListPaginatedFineTuningJobsResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
