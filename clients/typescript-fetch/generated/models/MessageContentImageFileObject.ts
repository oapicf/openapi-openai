 ...
 */
export function instanceOfMessageContentImageFileObject(value: object): boolean {
    if (!('type' in value)) return false;
    if (!('imageFile' in value)) return false;
    return true;
}
...
export function MessageContentImageFileObjectToJSON(value?: MessageContentImageFileObject | null): any {
    if (value == null) {
        return value;
    }
    return {
