 ...
 */
export function instanceOfMessageContentTextAnnotationsFilePathObject(value: object): boolean {
...
export function MessageContentTextAnnotationsFilePathObjectToJSON(value?: MessageContentTextAnnotationsFilePathObject | null): any {
    if (value == null) {
        return value;
    }
    return {
