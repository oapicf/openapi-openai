...
import {
    ...
    MessageContentTextObjectTextAnnotationsInnerToJSONTyped,
 ...
 */
export function instanceOfMessageContentTextObjectText(value: object): value is MessageContentTextObjectText {
...
export function MessageContentTextObjectTextFromJSONTyped(json: any, ignoreDiscriminator: boolean): MessageContentTextObjectText {
  ...
  export function MessageContentTextObjectTextToJSON(json: any): MessageContentTextObjectText {
      return MessageContentTextObjectTextToJSONTyped(json, false);
  }

  export function MessageContentTextObjectTextToJSONTyped(value?: MessageContentTextObjectText | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
