...
export function MessageContentTextObjectTextAnnotationsInnerToJSON(json: any): any {
    return MessageContentTextObjectTextAnnotationsInnerToJSONTyped(json, false);
}

export function MessageContentTextObjectTextAnnotationsInnerToJSONTyped(value?: MessageContentTextObjectTextAnnotationsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
