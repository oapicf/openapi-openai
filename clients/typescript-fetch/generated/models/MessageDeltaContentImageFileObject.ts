 ...
 */
export function instanceOfMessageDeltaContentImageFileObject(value: object): boolean {
...
export function MessageDeltaContentImageFileObjectToJSON(value?: MessageDeltaContentImageFileObject | null): any {
    if (value == null) {
        return value;
    }
    return {
