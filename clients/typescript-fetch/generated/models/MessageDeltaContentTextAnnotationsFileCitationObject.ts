 ...
 */
export function instanceOfMessageDeltaContentTextAnnotationsFileCitationObject(value: object): boolean {
...
export function MessageDeltaContentTextAnnotationsFileCitationObjectToJSON(value?: MessageDeltaContentTextAnnotationsFileCitationObject | null): any {
    if (value == null) {
        return value;
    }
    return {
