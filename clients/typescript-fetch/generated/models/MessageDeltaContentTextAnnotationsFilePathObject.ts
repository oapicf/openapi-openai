 ...
 */
export function instanceOfMessageDeltaContentTextAnnotationsFilePathObject(value: object): boolean {
...
export function MessageDeltaContentTextAnnotationsFilePathObjectToJSON(value?: MessageDeltaContentTextAnnotationsFilePathObject | null): any {
    if (value == null) {
        return value;
    }
    return {
