 ...
 */
export function instanceOfMessageDeltaContentTextObjectText(value: object): boolean {
    return true;
}
...
export function MessageDeltaContentTextObjectTextToJSON(value?: MessageDeltaContentTextObjectText | null): any {
    if (value == null) {
        return value;
    }
    return {
