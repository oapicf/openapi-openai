...
export function MessageObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): MessageObject {
    ...
    return {
        ...
        'runId': json['run_id'],
        'attachments': (json['attachments'] == null ? null : (json['attachments'] as Array<any>).map(CreateMessageRequestAttachmentsInnerFromJSON)),
...
export function MessageObjectToJSONTyped(value?: MessageObject | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'run_id': value['runId'],
        'attachments': (value['attachments'] == null ? null : (value['attachments'] as Array<any>).map(CreateMessageRequestAttachmentsInnerToJSON)),
