 ...
 */
export function instanceOfMessageStreamEventOneOf1(value: object): boolean {
...
export function MessageStreamEventOneOf1ToJSON(value?: MessageStreamEventOneOf1 | null): any {
    if (value == null) {
        return value;
    }
    return {
