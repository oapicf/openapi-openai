 ...
 */
export function instanceOfMessageStreamEventOneOf3(value: object): value is MessageStreamEventOneOf3 {
...
export function MessageStreamEventOneOf3ToJSON(json: any): MessageStreamEventOneOf3 {
    return MessageStreamEventOneOf3ToJSONTyped(json, false);
}

export function MessageStreamEventOneOf3ToJSONTyped(value?: MessageStreamEventOneOf3 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
