 ...
 */
export function instanceOfMessageStreamEventOneOf4(value: object): value is MessageStreamEventOneOf4 {
...
export function MessageStreamEventOneOf4ToJSON(json: any): MessageStreamEventOneOf4 {
    return MessageStreamEventOneOf4ToJSONTyped(json, false);
}

export function MessageStreamEventOneOf4ToJSONTyped(value?: MessageStreamEventOneOf4 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
