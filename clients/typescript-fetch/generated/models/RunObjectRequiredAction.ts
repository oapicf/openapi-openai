 ...
 */
export function instanceOfRunObjectRequiredAction(value: object): boolean {
    if (!('type' in value)) return false;
    if (!('submitToolOutputs' in value)) return false;
    return true;
}
...
export function RunObjectRequiredActionToJSON(value?: RunObjectRequiredAction | null): any {
    if (value == null) {
        return value;
    }
    return {
