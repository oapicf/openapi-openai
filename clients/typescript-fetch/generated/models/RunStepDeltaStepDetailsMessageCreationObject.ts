 ...
 */
export function instanceOfRunStepDeltaStepDetailsMessageCreationObject(value: object): boolean {
...
export function RunStepDeltaStepDetailsMessageCreationObjectToJSON(value?: RunStepDeltaStepDetailsMessageCreationObject | null): any {
    if (value == null) {
        return value;
    }
    return {
