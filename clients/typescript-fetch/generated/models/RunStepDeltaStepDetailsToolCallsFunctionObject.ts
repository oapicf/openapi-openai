 ...
 */
export function instanceOfRunStepDeltaStepDetailsToolCallsFunctionObject(value: object): boolean {
...
export function RunStepDeltaStepDetailsToolCallsFunctionObjectToJSON(value?: RunStepDeltaStepDetailsToolCallsFunctionObject | null): any {
    if (value == null) {
        return value;
    }
    return {
