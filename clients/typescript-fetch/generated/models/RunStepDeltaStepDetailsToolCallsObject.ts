 ...
 */
export function instanceOfRunStepDeltaStepDetailsToolCallsObject(value: object): boolean {
...
export function RunStepDeltaStepDetailsToolCallsObjectToJSON(value?: RunStepDeltaStepDetailsToolCallsObject | null): any {
    if (value == null) {
        return value;
    }
    return {
