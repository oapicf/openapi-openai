 ...
 */
export function instanceOfRunStepDetailsToolCallsCodeOutputImageObject(value: object): boolean {
...
export function RunStepDetailsToolCallsCodeOutputImageObjectToJSON(value?: RunStepDetailsToolCallsCodeOutputImageObject | null): any {
    if (value == null) {
        return value;
    }
    return {
