...
import {
    ...
    RunStepCompletionUsageToJSONTyped,
...
import {
    ...
    RunStepObjectStepDetailsToJSONTyped,
...
import {
    ...
    RunStepObjectLastErrorToJSONTyped,
 ...
 */
export function instanceOfRunStepObject(value: object): value is RunStepObject {
    ...
    if (!('stepDetails' in value) || value['stepDetails'] === undefined) return false;
...
export function RunStepObjectToJSON(json: any): RunStepObject {
    return RunStepObjectToJSONTyped(json, false);
}

export function RunStepObjectToJSONTyped(value?: RunStepObject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
