 ...
 */
export function instanceOfRunStepStreamEventOneOf1(value: object): boolean {
...
export function RunStepStreamEventOneOf1ToJSON(value?: RunStepStreamEventOneOf1 | null): any {
    if (value == null) {
        return value;
    }
    return {
