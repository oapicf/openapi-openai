 ...
 */
export function instanceOfRunStepStreamEventOneOf2(value: object): boolean {
...
export function RunStepStreamEventOneOf2ToJSON(value?: RunStepStreamEventOneOf2 | null): any {
    if (value == null) {
        return value;
    }
    return {
