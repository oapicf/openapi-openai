 ...
 */
export function instanceOfRunStepStreamEventOneOf3(value: object): boolean {
...
export function RunStepStreamEventOneOf3ToJSON(value?: RunStepStreamEventOneOf3 | null): any {
    if (value == null) {
        return value;
    }
    return {
