 ...
 */
export function instanceOfRunStepStreamEventOneOf4(value: object): boolean {
...
export function RunStepStreamEventOneOf4ToJSON(value?: RunStepStreamEventOneOf4 | null): any {
    if (value == null) {
        return value;
    }
    return {
