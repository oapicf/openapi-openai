 ...
 */
export function instanceOfSubmitToolOutputsRunRequestToolOutputsInner(value: object): value is SubmitToolOutputsRunRequestToolOutputsInner {
    return true;
}
...
export function SubmitToolOutputsRunRequestToolOutputsInnerToJSON(json: any): SubmitToolOutputsRunRequestToolOutputsInner {
    return SubmitToolOutputsRunRequestToolOutputsInnerToJSONTyped(json, false);
}

export function SubmitToolOutputsRunRequestToolOutputsInnerToJSONTyped(value?: SubmitToolOutputsRunRequestToolOutputsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
