...
export namespace RealtimeConversationItem {
    export type TypeEnum = 'message' | 'function_call' | 'function_call_output';
    export const TypeEnum = {
        Message: 'message' as TypeEnum,
        FunctionCall: 'function_call' as TypeEnum,
        FunctionCallOutput: 'function_call_output' as TypeEnum
    }
    export type ObjectEnum = 'realtime.item';
    export const ObjectEnum = {
        RealtimeItem: 'realtime.item' as ObjectEnum
    }
    export type StatusEnum = 'completed' | 'incomplete';
