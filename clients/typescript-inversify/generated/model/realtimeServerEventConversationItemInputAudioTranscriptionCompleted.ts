...
export namespace RealtimeServerEventConversationItemInputAudioTranscriptionCompleted {
    export type TypeEnum = 'conversation.item.input_audio_transcription.completed';
    export const TypeEnum = {
        ConversationItemInputAudioTranscriptionCompleted: 'conversation.item.input_audio_transcription.completed' as TypeEnum
    }
}
