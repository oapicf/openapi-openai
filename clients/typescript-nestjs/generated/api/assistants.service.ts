...
export class AssistantsService {
     ...
     */
    public createRun(threadId: string, createRunRequest: CreateRunRequest, include?: Array<'step_details.tool_calls[*].file_search.results[*].content'>, createRunOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<RunObject>>;
    public createRun(threadId: string, createRunRequest: CreateRunRequest, include?: Array<'step_details.tool_calls[*].file_search.results[*].content'>, createRunOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (threadId === null || threadId === undefined) {
        ...
        if (include) {
            include.forEach((element) => {
                queryParameters.append('include[]', <any>element);
            })
        }
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [deleteMessageOpts.config] Override http request option.
     */
    public deleteMessage(threadId: string, messageId: string, deleteMessageOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<DeleteMessageResponse>>;
    public deleteMessage(threadId: string, messageId: string, deleteMessageOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (threadId === null || threadId === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.delete<DeleteMessageResponse>(`${this.basePath}/threads/${encodeURIComponent(String(thread_id))}/messages/${encodeURIComponent(String(message_id))}`,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...deleteMessageOpts?.config,
                        headers: {...headers, ...deleteMessageOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public getRunStep(threadId: string, runId: string, stepId: string, include?: Array<'step_details.tool_calls[*].file_search.results[*].content'>, getRunStepOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<RunStepObject>>;
    public getRunStep(threadId: string, runId: string, stepId: string, include?: Array<'step_details.tool_calls[*].file_search.results[*].content'>, getRunStepOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (threadId === null || threadId === undefined) {
     ...
     */
    public listRunSteps(threadId: string, runId: string, limit?: number, order?: 'asc' | 'desc', after?: string, before?: string, include?: Array<'step_details.tool_calls[*].file_search.results[*].content'>, listRunStepsOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<ListRunStepsResponse>>;
    public listRunSteps(threadId: string, runId: string, limit?: number, order?: 'asc' | 'desc', after?: string, before?: string, include?: Array<'step_details.tool_calls[*].file_search.results[*].content'>, listRunStepsOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (threadId === null || threadId === undefined) {
