...
export class AudioService {
     ...
     */
    public createTranscription(file: Blob, model: CreateTranscriptionRequestModel, language?: string, prompt?: string, responseFormat?: string, temperature?: number, timestampGranularities?: Array<string>, createTranscriptionOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateTranscription200Response>>;
    public createTranscription(file: Blob, model: CreateTranscriptionRequestModel, language?: string, prompt?: string, responseFormat?: string, temperature?: number, timestampGranularities?: Array<string>, createTranscriptionOpts?: { config?: AxiosRequestConfig }): Observable<any> {
     ...
     */
    public createTranslation(file: Blob, model: CreateTranscriptionRequestModel, prompt?: string, responseFormat?: string, temperature?: number, createTranslationOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateTranslation200Response>>;
    public createTranslation(file: Blob, model: CreateTranscriptionRequestModel, prompt?: string, responseFormat?: string, temperature?: number, createTranslationOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (file === null || file === undefined) {
