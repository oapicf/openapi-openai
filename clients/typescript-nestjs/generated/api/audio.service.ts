...
export class AudioService {
     ...
     * @param {*} [createSpeechOpts.config] Override http request option.
     */
    public createSpeech(createSpeechRequest: CreateSpeechRequest, createSpeechOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<Blob>>;
    public createSpeech(createSpeechRequest: CreateSpeechRequest, createSpeechOpts?: { config?: AxiosRequestConfig }): Observable<any> {
            ...
            switchMap((accessToken) => {
                ...
                return this.httpClient.post(`${this.basePath}/audio/speech`,
                    createSpeechRequest,
                    {
                        ...
                        ...createSpeechOpts?.config,
                        headers: {...headers, ...createSpeechOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [createTranscriptionOpts.config] Override http request option.
     */
    public createTranscription(file: Blob, model: CreateTranscriptionRequestModel, language?: string, prompt?: string, responseFormat?: AudioResponseFormat, temperature?: number, timestampGranularities?: Array<string>, createTranscriptionOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateTranscription200Response>>;
    public createTranscription(file: Blob, model: CreateTranscriptionRequestModel, language?: string, prompt?: string, responseFormat?: AudioResponseFormat, temperature?: number, timestampGranularities?: Array<string>, createTranscriptionOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateTranscription200Response>(`${this.basePath}/audio/transcriptions`,
                    ...
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...createTranscriptionOpts?.config,
                        headers: {...headers, ...createTranscriptionOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     * @param {*} [createTranslationOpts.config] Override http request option.
     */
    public createTranslation(file: Blob, model: CreateTranscriptionRequestModel, prompt?: string, responseFormat?: AudioResponseFormat, temperature?: number, createTranslationOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateTranslation200Response>>;
    public createTranslation(file: Blob, model: CreateTranscriptionRequestModel, prompt?: string, responseFormat?: AudioResponseFormat, temperature?: number, createTranslationOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (file === null || file === undefined) {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateTranslation200Response>(`${this.basePath}/audio/translations`,
                    ...
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...createTranslationOpts?.config,
                        headers: {...headers, ...createTranslationOpts?.config?.headers},
                    }
                );
            })
        );
