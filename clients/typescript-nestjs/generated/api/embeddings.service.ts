...
export class EmbeddingsService {
     ...
     * @param {*} [createEmbeddingOpts.config] Override http request option.
     */
    public createEmbedding(createEmbeddingRequest: CreateEmbeddingRequest, createEmbeddingOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<CreateEmbeddingResponse>>;
    public createEmbedding(createEmbeddingRequest: CreateEmbeddingRequest, createEmbeddingOpts?: { config?: AxiosRequestConfig }): Observable<any> {
            ...
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<CreateEmbeddingResponse>(`${this.basePath}/embeddings`,
                    createEmbeddingRequest,
                    {
                        ...
                        ...createEmbeddingOpts?.config,
                        headers: {...headers, ...createEmbeddingOpts?.config?.headers},
                    }
                );
            })
        );
