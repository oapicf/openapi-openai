...
export enum EmbeddingsApiApiKeys {
}
...
export class EmbeddingsApi {
    ...
    public setApiKey(key: EmbeddingsApiApiKeys, value: string) {
        (this.authentications as any)[EmbeddingsApiApiKeys[key]].apiKey = value;
    }
