...
export function CreateFineTuneRequestFromJSON(json: any): CreateFineTuneRequest {
    return {
        ...
        'model': !exists(json, 'model') ? undefined : CreateFineTuneRequestModelFromJSON(json['model']),
        'nEpochs': !exists(json, 'n_epochs') ? undefined : json['n_epochs'],
        'batchSize': !exists(json, 'batch_size') ? undefined : json['batch_size'],
        'learningRateMultiplier': !exists(json, 'learning_rate_multiplier') ? undefined : json['learning_rate_multiplier'],
        'promptLossWeight': !exists(json, 'prompt_loss_weight') ? undefined : json['prompt_loss_weight'],
        'computeClassificationMetrics': !exists(json, 'compute_classification_metrics') ? undefined : json['compute_classification_metrics'],
        'classificationNClasses': !exists(json, 'classification_n_classes') ? undefined : json['classification_n_classes'],
        'classificationPositiveClass': !exists(json, 'classification_positive_class') ? undefined : json['classification_positive_class'],
        'classificationBetas': !exists(json, 'classification_betas') ? undefined : json['classification_betas'],
        'suffix': !exists(json, 'suffix') ? undefined : json['suffix'],
    };
}

export function CreateFineTuneRequestToJSON(value?: CreateFineTuneRequest): any {
    if (value === undefined) {
        return undefined;
    }
    return {
