...
export function RealtimeClientEventConversationItemCreateFromJSON(json: any): RealtimeClientEventConversationItemCreate {
    return {
        ...
        'type': json['type'],
        'previousItemId': !exists(json, 'previous_item_id') ? undefined : json['previous_item_id'],
        'item': RealtimeConversationItemFromJSON(json['item']),
    };
}

export function RealtimeClientEventConversationItemCreateToJSON(value?: RealtimeClientEventConversationItemCreate): any {
    if (value === undefined) {
        return undefined;
    }
    return {
