...
export function SubmitToolOutputsRunRequestToolOutputsInnerFromJSON(json: any): SubmitToolOutputsRunRequestToolOutputsInner {
    return {
        'toolCallId': !exists(json, 'tool_call_id') ? undefined : json['tool_call_id'],
        'output': !exists(json, 'output') ? undefined : json['output'],
    };
}

export function SubmitToolOutputsRunRequestToolOutputsInnerToJSON(value?: SubmitToolOutputsRunRequestToolOutputsInner): any {
    if (value === undefined) {
        return undefined;
    }
    return {
