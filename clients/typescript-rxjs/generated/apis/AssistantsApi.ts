...
export class AssistantsApi extends BaseAPI {
     ...
     * Create a run.
     */
    createRun({ threadId, createRunRequest, include }: CreateRunRequest): Observable<RunObject>
    createRun({ threadId, createRunRequest, include }: CreateRunRequest, opts?: OperationOpts): Observable<AjaxResponse<RunObject>>
    createRun({ threadId, createRunRequest, include }: CreateRunRequest, opts?: OperationOpts): Observable<RunObject | AjaxResponse<RunObject>> {
     ...
     * Deletes a message.
     */
    deleteMessage({ threadId, messageId }: DeleteMessageRequest): Observable<DeleteMessageResponse>
    deleteMessage({ threadId, messageId }: DeleteMessageRequest, opts?: OperationOpts): Observable<AjaxResponse<DeleteMessageResponse>>
    deleteMessage({ threadId, messageId }: DeleteMessageRequest, opts?: OperationOpts): Observable<DeleteMessageResponse | AjaxResponse<DeleteMessageResponse>> {
        throwIfNullOrUndefined(threadId, 'threadId', 'deleteMessage');
     ...
     */
    getRunStep({ threadId, runId, stepId, include }: GetRunStepRequest): Observable<RunStepObject>
    getRunStep({ threadId, runId, stepId, include }: GetRunStepRequest, opts?: OperationOpts): Observable<AjaxResponse<RunStepObject>>
    getRunStep({ threadId, runId, stepId, include }: GetRunStepRequest, opts?: OperationOpts): Observable<RunStepObject | AjaxResponse<RunStepObject>> {
     ...
     */
    listRunSteps({ threadId, runId, limit, order, after, before, include }: ListRunStepsRequest): Observable<ListRunStepsResponse>
    listRunSteps({ threadId, runId, limit, order, after, before, include }: ListRunStepsRequest, opts?: OperationOpts): Observable<AjaxResponse<ListRunStepsResponse>>
    listRunSteps({ threadId, runId, limit, order, after, before, include }: ListRunStepsRequest, opts?: OperationOpts): Observable<ListRunStepsResponse | AjaxResponse<ListRunStepsResponse>> {
