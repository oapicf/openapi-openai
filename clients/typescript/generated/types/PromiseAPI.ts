...
export class PromiseAssistantsApi {
     ...
     */
    public createAssistantFileWithHttpInfo(assistantId: string, createAssistantFileRequest: CreateAssistantFileRequest, _options?: PromiseConfigurationOptions): Promise<HttpInfo<AssistantFileObject>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.createAssistantFileWithHttpInfo(assistantId, createAssistantFileRequest, observableOptions);
        return result.toPromise();
    }
     ...
     * @param createAssistantFileRequest
     */
    public createAssistantFile(assistantId: string, createAssistantFileRequest: CreateAssistantFileRequest, _options?: PromiseConfigurationOptions): Promise<AssistantFileObject> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.createAssistantFile(assistantId, createAssistantFileRequest, observableOptions);
        return result.toPromise();
    }
     ...
     */
    public createRunWithHttpInfo(threadId: string, createRunRequest: CreateRunRequest, _options?: PromiseConfigurationOptions): Promise<HttpInfo<RunObject>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.createRunWithHttpInfo(threadId, createRunRequest, observableOptions);
        return result.toPromise();
    }
     ...
     * @param createRunRequest
     */
    public createRun(threadId: string, createRunRequest: CreateRunRequest, _options?: PromiseConfigurationOptions): Promise<RunObject> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.createRun(threadId, createRunRequest, observableOptions);
        return result.toPromise();
    }
     ...
     */
    public deleteAssistantFileWithHttpInfo(assistantId: string, fileId: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<DeleteAssistantFileResponse>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.deleteAssistantFileWithHttpInfo(assistantId, fileId, observableOptions);
        return result.toPromise();
    }
     ...
     * @param fileId The ID of the file to delete.
     */
    public deleteAssistantFile(assistantId: string, fileId: string, _options?: PromiseConfigurationOptions): Promise<DeleteAssistantFileResponse> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.deleteAssistantFile(assistantId, fileId, observableOptions);
        return result.toPromise();
    }
     ...
     */
    public getAssistantFileWithHttpInfo(assistantId: string, fileId: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<AssistantFileObject>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.getAssistantFileWithHttpInfo(assistantId, fileId, observableOptions);
        return result.toPromise();
    }
     ...
     * @param fileId The ID of the file we\&#39;re getting.
     */
    public getAssistantFile(assistantId: string, fileId: string, _options?: PromiseConfigurationOptions): Promise<AssistantFileObject> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.getAssistantFile(assistantId, fileId, observableOptions);
        return result.toPromise();
    }
     ...
     */
    public getMessageFileWithHttpInfo(threadId: string, messageId: string, fileId: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<MessageFileObject>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.getMessageFileWithHttpInfo(threadId, messageId, fileId, observableOptions);
        return result.toPromise();
    }
     ...
     * @param fileId The ID of the file being retrieved.
     */
    public getMessageFile(threadId: string, messageId: string, fileId: string, _options?: PromiseConfigurationOptions): Promise<MessageFileObject> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.getMessageFile(threadId, messageId, fileId, observableOptions);
        return result.toPromise();
    }
     ...
     */
    public getRunStepWithHttpInfo(threadId: string, runId: string, stepId: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<RunStepObject>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.getRunStepWithHttpInfo(threadId, runId, stepId, observableOptions);
        return result.toPromise();
    }
     ...
     * @param stepId The ID of the run step to retrieve.
     */
    public getRunStep(threadId: string, runId: string, stepId: string, _options?: PromiseConfigurationOptions): Promise<RunStepObject> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.getRunStep(threadId, runId, stepId, observableOptions);
        return result.toPromise();
    }
     ...
     */
    public listAssistantFilesWithHttpInfo(assistantId: string, limit?: number, order?: 'asc' | 'desc', after?: string, before?: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<ListAssistantFilesResponse>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.listAssistantFilesWithHttpInfo(assistantId, limit, order, after, before, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [before] A cursor for use in pagination. &#x60;before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before&#x3D;obj_foo in order to fetch the previous page of the list. 
     */
    public listAssistantFiles(assistantId: string, limit?: number, order?: 'asc' | 'desc', after?: string, before?: string, _options?: PromiseConfigurationOptions): Promise<ListAssistantFilesResponse> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.listAssistantFiles(assistantId, limit, order, after, before, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [before] A cursor for use in pagination. &#x60;before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before&#x3D;obj_foo in order to fetch the previous page of the list. 
     */
    public listMessageFilesWithHttpInfo(threadId: string, messageId: string, limit?: number, order?: 'asc' | 'desc', after?: string, before?: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<ListMessageFilesResponse>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.listMessageFilesWithHttpInfo(threadId, messageId, limit, order, after, before, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [before] A cursor for use in pagination. &#x60;before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before&#x3D;obj_foo in order to fetch the previous page of the list. 
     */
    public listMessageFiles(threadId: string, messageId: string, limit?: number, order?: 'asc' | 'desc', after?: string, before?: string, _options?: PromiseConfigurationOptions): Promise<ListMessageFilesResponse> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.listMessageFiles(threadId, messageId, limit, order, after, before, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [before] A cursor for use in pagination. &#x60;before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before&#x3D;obj_foo in order to fetch the previous page of the list. 
     */
    public listRunStepsWithHttpInfo(threadId: string, runId: string, limit?: number, order?: 'asc' | 'desc', after?: string, before?: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<ListRunStepsResponse>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.listRunStepsWithHttpInfo(threadId, runId, limit, order, after, before, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [before] A cursor for use in pagination. &#x60;before&#x60; is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with obj_foo, your subsequent call can include before&#x3D;obj_foo in order to fetch the previous page of the list. 
     */
    public listRunSteps(threadId: string, runId: string, limit?: number, order?: 'asc' | 'desc', after?: string, before?: string, _options?: PromiseConfigurationOptions): Promise<ListRunStepsResponse> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.listRunSteps(threadId, runId, limit, order, after, before, observableOptions);
        return result.toPromise();
    }
...
export class PromiseAudioApi {
     ...
     */
    public createTranscriptionWithHttpInfo(file: HttpFile, model: CreateTranscriptionRequestModel, language?: string, prompt?: string, responseFormat?: string, temperature?: number, timestampGranularities?: Array<string>, _options?: PromiseConfigurationOptions): Promise<HttpInfo<CreateTranscription200Response>> {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [timestampGranularities] The timestamp granularities to populate for this transcription. &#x60;response_format&#x60; must be set &#x60;verbose_json&#x60; to use timestamp granularities. Either or both of these options are supported: &#x60;word&#x60;, or &#x60;segment&#x60;. Note: There is no additional latency for segment timestamps, but generating word timestamps incurs additional latency. 
     */
    public createTranscription(file: HttpFile, model: CreateTranscriptionRequestModel, language?: string, prompt?: string, responseFormat?: string, temperature?: number, timestampGranularities?: Array<string>, _options?: PromiseConfigurationOptions): Promise<CreateTranscription200Response> {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [temperature] The sampling temperature, between 0 and 1. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic. If set to 0, the model will use [log probability](https://en.wikipedia.org/wiki/Log_probability) to automatically increase the temperature until certain thresholds are hit. 
     */
    public createTranslationWithHttpInfo(file: HttpFile, model: CreateTranscriptionRequestModel, prompt?: string, responseFormat?: string, temperature?: number, _options?: PromiseConfigurationOptions): Promise<HttpInfo<CreateTranslation200Response>> {
        const observableOptions = wrapOptions(_options);
     ...
     * @param [temperature] The sampling temperature, between 0 and 1. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic. If set to 0, the model will use [log probability](https://en.wikipedia.org/wiki/Log_probability) to automatically increase the temperature until certain thresholds are hit. 
     */
    public createTranslation(file: HttpFile, model: CreateTranscriptionRequestModel, prompt?: string, responseFormat?: string, temperature?: number, _options?: PromiseConfigurationOptions): Promise<CreateTranslation200Response> {
        const observableOptions = wrapOptions(_options);
...
export class PromiseFilesApi {
     ...
     */
    public listFilesWithHttpInfo(purpose?: string, _options?: PromiseConfigurationOptions): Promise<HttpInfo<ListFilesResponse>> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.listFilesWithHttpInfo(purpose, observableOptions);
        return result.toPromise();
    }
     ...
     * @param [purpose] Only return files with the given purpose.
     */
    public listFiles(purpose?: string, _options?: PromiseConfigurationOptions): Promise<ListFilesResponse> {
        const observableOptions = wrapOptions(_options);
        const result = this.api.listFiles(purpose, observableOptions);
        return result.toPromise();
    }
