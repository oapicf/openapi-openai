...
Protected Class ChatApi
	#tag Method, Flags = &h0
		Sub CreateChatCompletion(, createChatCompletionRequest As OpenAPIClient.Models.CreateChatCompletionRequest)
		  ...
		  //
		  // Invokes ChatApiCallbackHandler.CreateChatCompletionCallback(CreateChatCompletionResponse) on completion. 
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.ChatApiCallbackHandler
	#tag EndProperty
