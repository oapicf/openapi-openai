#tag Class
Protected Class CompletionsApi
	#tag Method, Flags = &h0
		Sub CreateCompletion(, createCompletionRequest As OpenAPIClient.Models.CreateCompletionRequest)
		  ...
		  //
		  // Invokes CompletionsApiCallbackHandler.CreateCompletionCallback(CreateCompletionResponse) on completion. 
		  //
		  // - POST /completions
		  // - defaultResponse: Nil
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.CompletionsApiCallbackHandler
	#tag EndProperty
