...
Protected Class EmbeddingsApi
	#tag Method, Flags = &h0
		Sub CreateEmbedding(, createEmbeddingRequest As OpenAPIClient.Models.CreateEmbeddingRequest)
		  ...
		  //
		  // Invokes EmbeddingsApiCallbackHandler.CreateEmbeddingCallback(CreateEmbeddingResponse) on completion. 
		  //
		  // - POST /embeddings
		  // - defaultResponse: Nil
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.EmbeddingsApiCallbackHandler
	#tag EndProperty
