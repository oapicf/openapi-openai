...
Protected Class ModelsApi
	#tag Method, Flags = &h0
		Sub DeleteModel(, model As String)
		  ...
		  //
		  // Invokes ModelsApiCallbackHandler.DeleteModelCallback(DeleteModelResponse) on completion. 
		  //
		  // - DELETE /models/{model}
		  // - defaultResponse: Nil
		  //
	...
	#tag Method, Flags = &h0
		Sub ListModels()
		  ...
		  // - 
		  //
		  // Invokes ModelsApiCallbackHandler.ListModelsCallback(ListModelsResponse) on completion. 
		  //
		  // - GET /models
		  // - defaultResponse: Nil
		  //
	...
	#tag Method, Flags = &h0
		Sub RetrieveModel(, model As String)
		  ...
		  //
		  // Invokes ModelsApiCallbackHandler.RetrieveModelCallback(Model) on completion. 
		  //
		  // - GET /models/{model}
		  // - defaultResponse: Nil
		  //
