#tag Class
Protected Class ModerationsApi
	#tag Method, Flags = &h0
		Sub CreateModeration(, createModerationRequest As OpenAPIClient.Models.CreateModerationRequest)
		  ...
		  //
		  // Invokes ModerationsApiCallbackHandler.CreateModerationCallback(CreateModerationResponse) on completion. 
		  //
		  // - POST /moderations
		  // - defaultResponse: Nil
		  //
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.ModerationsApiCallbackHandler
	#tag EndProperty
