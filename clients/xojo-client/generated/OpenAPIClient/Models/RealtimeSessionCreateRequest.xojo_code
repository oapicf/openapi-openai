#tag Class
Protected Class RealtimeSessionCreateRequest
	...
	#tag Property, Flags = &h0
		turn_detection As OpenAPIClient.Models.RealtimeSessionCreateRequestTurnDetection
	#tag EndProperty
    ...
    #tag Enum, Name = ModelEnum, Type = Integer, Flags = &h0
    ...
    #tag Enum, Name = Input_audio_formatEnum, Type = Integer, Flags = &h0
	...
	#tag EndMethod
	#tag Method, Flags = &h0
		Shared Function ModelEnumToString(value As ModelEnum) As String
		  Select Case value
		    
		    Case ModelEnum.Gpt4oRealtimePreview
		      Return "gpt-4o-realtime-preview"
		    Case ModelEnum.Gpt4oRealtimePreview20241001
		      Return "gpt-4o-realtime-preview-2024-10-01"
		    Case ModelEnum.Gpt4oRealtimePreview20241217
		      Return "gpt-4o-realtime-preview-2024-12-17"
		    Case ModelEnum.Gpt4oMiniRealtimePreview
		      Return "gpt-4o-mini-realtime-preview"
		    Case ModelEnum.Gpt4oMiniRealtimePreview20241217
	...
	#tag EndMethod
	#tag Method, Flags = &h0
		Shared Function Input_audio_formatEnumToString(value As Input_audio_formatEnum) As String
		  Select Case value
		    
		    Case Input_audio_formatEnum.Pcm16
		      Return "pcm16"
		    Case Input_audio_formatEnum.G711Ulaw
		      Return "g711_ulaw"
		    Case Input_audio_formatEnum.G711Alaw
		      Return "g711_alaw"
