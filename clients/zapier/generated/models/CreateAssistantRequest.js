...
const CreateAssistantRequest_model = require('../models/CreateAssistantRequest_model');
const CreateAssistantRequest_tool_resources = require('../models/CreateAssistantRequest_tool_resources');

module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        const {keyPrefix, labelPrefix} = utils.buildKeyAndLabel(prefix, isInput, isArrayChild)
        return [
            ...CreateAssistantRequest_model.fields(`${keyPrefix}model`, isInput),
            {
                key: `${keyPrefix}name`,
            ...
            ...CreateAssistantRequest_tool_resources.fields(`${keyPrefix}tool_resources`, isInput),
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            'model': utils.removeIfEmpty(CreateAssistantRequest_model.mapping(bundle, `${keyPrefix}model`)),
            ...
            'tool_resources': utils.removeIfEmpty(CreateAssistantRequest_tool_resources.mapping(bundle, `${keyPrefix}tool_resources`)),
