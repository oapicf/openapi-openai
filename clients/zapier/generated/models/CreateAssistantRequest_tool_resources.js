...
const CreateAssistantRequest_tool_resources_file_search = require('../models/CreateAssistantRequest_tool_resources_file_search');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ...CreateAssistantRequest_tool_resources_file_search.fields(`${keyPrefix}file_search`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'file_search': utils.removeIfEmpty(CreateAssistantRequest_tool_resources_file_search.mapping(bundle, `${keyPrefix}file_search`)),
        }
    },
}
