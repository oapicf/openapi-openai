...
const FineTuningIntegration = require('../models/FineTuningIntegration');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            {
                key: `${keyPrefix}type`,
                label: `The type of the integration being enabled for the fine-tuning job - [${labelPrefix}type]`,
                required: true,
                type: 'string',
                choices: [
                    'wandb',
