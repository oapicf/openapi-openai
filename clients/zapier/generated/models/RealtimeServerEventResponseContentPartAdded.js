...
const RealtimeServerEventResponseContentPartAdded_part = require('../models/RealtimeServerEventResponseContentPartAdded_part');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}type`,
                label: `The event type, must be `response.content_part.added`. - [${labelPrefix}type]`,
                required: true,
                type: 'string',
                choices: [
            ...
            },
            {
                ...
                label: `The ID of the item to which the content part was added. - [${labelPrefix}item_id]`,
                required: true,
                type: 'string',
            },
            {
            ...
            ...RealtimeServerEventResponseContentPartAdded_part.fields(`${keyPrefix}part`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'part': utils.removeIfEmpty(RealtimeServerEventResponseContentPartAdded_part.mapping(bundle, `${keyPrefix}part`)),
        }
    },
}
