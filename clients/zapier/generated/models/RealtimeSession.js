...
const RealtimeSession_model = require('../models/RealtimeSession_model');
const RealtimeSession_turn_detection = require('../models/RealtimeSession_turn_detection');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            {
                key: `${keyPrefix}id`,
                label: `Unique identifier for the session object.  - [${labelPrefix}id]`,
                type: 'string',
            },
            {
            ...
            ...RealtimeSession_model.fields(`${keyPrefix}model`, isInput),
            {
            ...
            ...RealtimeSession_turn_detection.fields(`${keyPrefix}turn_detection`, isInput),
            {
                key: `${keyPrefix}tools`,
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'model': utils.removeIfEmpty(RealtimeSession_model.mapping(bundle, `${keyPrefix}model`)),
            ...
            'turn_detection': utils.removeIfEmpty(RealtimeSession_turn_detection.mapping(bundle, `${keyPrefix}turn_detection`)),
