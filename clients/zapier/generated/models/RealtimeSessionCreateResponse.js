...
const RealtimeSessionCreateResponse_client_secret = require('../models/RealtimeSessionCreateResponse_client_secret');
const RealtimeSessionCreateResponse_turn_detection = require('../models/RealtimeSessionCreateResponse_turn_detection');
...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...RealtimeSessionCreateResponse_client_secret.fields(`${keyPrefix}client_secret`, isInput),
            {
            ...
            ...RealtimeSessionCreateResponse_turn_detection.fields(`${keyPrefix}turn_detection`, isInput),
            {
                key: `${keyPrefix}tools`,
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            'client_secret': utils.removeIfEmpty(RealtimeSessionCreateResponse_client_secret.mapping(bundle, `${keyPrefix}client_secret`)),
            ...
            'turn_detection': utils.removeIfEmpty(RealtimeSessionCreateResponse_turn_detection.mapping(bundle, `${keyPrefix}turn_detection`)),
