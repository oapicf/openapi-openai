        ...
        return [
            {
                ...
                label: `Number of completion tokens used over the course of the run. - [${labelPrefix}completion_tokens]`,
                required: true,
                type: 'integer',
            },
            {
                key: `${keyPrefix}prompt_tokens`,
                label: `Number of prompt tokens used over the course of the run. - [${labelPrefix}prompt_tokens]`,
                required: true,
                type: 'integer',
            },
            {
