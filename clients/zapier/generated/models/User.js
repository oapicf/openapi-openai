        ...
        return [
            {
                ...
                label: `The object type, which is always `organization.user` - [${labelPrefix}object]`,
                required: true,
                type: 'string',
                choices: [
                    'organization.user',
            ...
            },
            {
                ...
                label: `The Unix timestamp (in seconds) of when the user was added. - [${labelPrefix}added_at]`,
                required: true,
                type: 'integer',
            },
        ]
