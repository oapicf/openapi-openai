    ...
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                label: `The number of files that have been successfully processed. - [${labelPrefix}completed]`,
                required: true,
                type: 'integer',
            },
            {
            ...
            },
            {
                ...
                label: `The number of files that were cancelled. - [${labelPrefix}cancelled]`,
                required: true,
                type: 'integer',
            },
            {
